...
func IconFromName(name string) g.Node {
	...
	case "circleLarge":
		return CircleLarge()
	case "circleLargeFilled":
		return CircleLargeFilled()
	case "circleSlash":
		return CircleSlash()
	case "circleSmall":
		return CircleSmall()
	case "circleSmallFilled":
	...
	case "debugRestart":
		return DebugRestart()
	case "debugRestartFrame":
		return DebugRestartFrame()
	case "debugReverseContinue":
		return DebugReverseContinue()
	case "debugStackframe":
		return DebugStackframe()
	case "debugStackframeActive":
	...
	case "gitPullRequestGoToChanges":
		return GitPullRequestGoToChanges()
	case "gitPullRequestNewChanges":
	...
	case "layout":
		return Layout()
	case "layoutActivitybarLeft":
		return LayoutActivitybarLeft()
	case "layoutActivitybarRight":
	...
	case "pinnedDirty":
		return PinnedDirty()
	case "pinnedDirtySmall":
		return PinnedDirtySmall()
	case "pinnedSmall":
		return PinnedSmall()
	case "play":
		return Play()
	...
	case "typeHierarchySub":
		return TypeHierarchySub()
	case "typeHierarchySuper":
		return TypeHierarchySuper()
	case "unfold":
		return Unfold()
	case "ungroupByRefType":
