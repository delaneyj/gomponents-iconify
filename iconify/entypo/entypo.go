...
func IconFromName(name string) g.Node {
	...
	case "areaGraph":
		return AreaGraph()
	case "arrowBoldDown":
		return ArrowBoldDown()
	case "arrowBoldLeft":
		return ArrowBoldLeft()
	case "arrowBoldRight":
		return ArrowBoldRight()
	case "arrowBoldUp":
		return ArrowBoldUp()
	case "arrowDown":
		return ArrowDown()
	...
	case "arrowWithCircleDown":
		return ArrowWithCircleDown()
	case "arrowWithCircleLeft":
		return ArrowWithCircleLeft()
	case "arrowWithCircleRight":
		return ArrowWithCircleRight()
	case "arrowWithCircleUp":
		return ArrowWithCircleUp()
	case "attachment":
		return Attachment()
	case "awarenessRibbon":
		return AwarenessRibbon()
	case "back":
		return Back()
	case "backInTime":
		return BackInTime()
	...
	case "creativeCommonsSharealike":
		return CreativeCommonsSharealike()
	case "credit":
		return Credit()
	case "creditCard":
		return CreditCard()
	...
	case "resizeFullScreen":
		return ResizeFullScreen()
	case "resizeOneHundred":
		return ResizeOneHundred()
	case "retweet":
		return Retweet()
	case "rocket":
		return Rocket()
	...
	case "share":
		return Share()
	case "shareAlternitive":
		return ShareAlternitive()
	case "shareable":
		return Shareable()
	case "shield":
		return Shield()
