...
func IconFromName(name string) g.Node {
	...
	case "circleCheck":
		return CircleCheck()
	case "circleChevDown":
		return CircleChevDown()
	case "circleChevLeft":
		return CircleChevLeft()
	case "circleChevRight":
		return CircleChevRight()
	case "circleChevUp":
		return CircleChevUp()
	case "circleInfo":
		return CircleInfo()
	...
	case "desktop":
		return Desktop()
	case "desktopMouseOne":
		return DesktopMouseOne()
	case "desktopMouseTwo":
		return DesktopMouseTwo()
	case "discountOne":
		return DiscountOne()
	case "dollar":
		return Dollar()
	...
	case "linkedin":
		return Linkedin()
	case "locationArrowOne":
		return LocationArrowOne()
	case "locationOff":
		return LocationOff()
	case "locationOn":
		return LocationOn()
	...
	case "medicalCase":
		return MedicalCase()
	case "medicalClipboard":
		return MedicalClipboard()
	case "medicalCross":
		return MedicalCross()
	case "medicalMask":
		return MedicalMask()
	...
	case "repeat":
		return Repeat()
	case "rollingSuitcase":
		return RollingSuitcase()
	case "route":
		return Route()
	case "router":
		return Router()
	...
	case "squareCheck":
		return SquareCheck()
	case "squareChevDown":
		return SquareChevDown()
	case "squareChevLeft":
		return SquareChevLeft()
	case "squareChevRight":
		return SquareChevRight()
	case "squareChevUp":
		return SquareChevUp()
	case "squareInfo":
		return SquareInfo()
