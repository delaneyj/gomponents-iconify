...
func IconFromName(name string) g.Node {
	...
	case "downArrowSquare":
		return DownArrowSquare()
	case "download":
		return Download()
	case "downvote":
		return Downvote()
	...
	case "leftArrowSquare":
		return LeftArrowSquare()
	...
	case "quoteAltLeft":
		return QuoteAltLeft()
	case "quoteAltRight":
		return QuoteAltRight()
	case "quoteLeft":
		return QuoteLeft()
	case "quoteRight":
		return QuoteRight()
	case "quoteSingleLeft":
		return QuoteSingleLeft()
	case "quoteSingleRight":
		return QuoteSingleRight()
	case "radiation":
		return Radiation()
	case "radio":
		return Radio()
	...
	case "rightArrowSquare":
		return RightArrowSquare()
