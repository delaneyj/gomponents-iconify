...
func IconFromName(name string) g.Node {
	...
	case "attention":
		return Attention()
	case "attentionSolid":
		return AttentionSolid()
	case "attentionSolidSm":
		return AttentionSolidSm()
	case "autoplay":
		return Autoplay()
	case "bitbucket":
		return Bitbucket()
	...
	case "cancel":
		return Cancel()
	case "canceledCircle":
		return CanceledCircle()
	case "car":
		return Car()
	case "catalogCheckmark":
		return CatalogCheckmark()
	case "chart":
		return Chart()
	case "check":
		return Check()
	case "checkCircle":
		return CheckCircle()
	case "checkCircleDashed":
		return CheckCircleDashed()
	...
	case "chevronDoubleLgLeft":
		return ChevronDoubleLgLeft()
	case "chevronDoubleLgRight":
		return ChevronDoubleLgRight()
	case "chevronDown":
		return ChevronDown()
	case "chevronLeft":
		return ChevronLeft()
	case "chevronLgDown":
		return ChevronLgDown()
	case "chevronLgLeft":
		return ChevronLgLeft()
	case "chevronLgRight":
		return ChevronLgRight()
	case "chevronLgUp":
		return ChevronLgUp()
	case "chevronRight":
		return ChevronRight()
	...
	case "fileAddition":
		return FileAddition()
	case "fileAdditionSolid":
		return FileAdditionSolid()
	case "fileDeletion":
		return FileDeletion()
	case "fileDeletionSolid":
		return FileDeletionSolid()
	case "fileModified":
		return FileModified()
	case "fileModifiedSolid":
		return FileModifiedSolid()
	case "fileTree":
		return FileTree()
	case "filter":
		return Filter()
	...
	case "hourglass":
		return Hourglass()
	case "imageCommentDark":
		return ImageCommentDark()
	case "imageCommentLight":
		return ImageCommentLight()
	case "import":
		return Import()
	case "incognito":
		return Incognito()
	...
	case "markdownMark":
		return MarkdownMark()
	case "markdownMarkSolid":
		return MarkdownMarkSolid()
	...
	case "mergeRequest":
		return MergeRequest()
	case "mergeRequestClose":
		return MergeRequestClose()
	case "mergeRequestCloseM":
		return MergeRequestCloseM()
	case "mergeRequestOpen":
		return MergeRequestOpen()
	case "messages":
		return Messages()
	case "minimize":
		return Minimize()
	case "mobile":
		return Mobile()
	case "mobileIssueClose":
		return MobileIssueClose()
	case "monitor":
		return Monitor()
	case "monitorLines":
		return MonitorLines()
	...
	case "statusPaused":
		return StatusPaused()
	case "statusPreparingBorderless":
		return StatusPreparingBorderless()
	case "statusStopped":
