...
func IconFromName(name string) g.Node {
	...
	case "airplaneMode":
		return AirplaneMode()
	case "airplaneModeOff":
		return AirplaneModeOff()
	case "airplay":
		return Airplay()
	case "alarm":
		return Alarm()
	...
	case "arrowRight":
		return ArrowRight()
	case "arrowThickBottom":
		return ArrowThickBottom()
	case "arrowThickFromBottom":
		return ArrowThickFromBottom()
	case "arrowThickFromLeft":
		return ArrowThickFromLeft()
	case "arrowThickFromRight":
		return ArrowThickFromRight()
	case "arrowThickFromTop":
		return ArrowThickFromTop()
	case "arrowThickLeft":
		return ArrowThickLeft()
	case "arrowThickRight":
		return ArrowThickRight()
	case "arrowThickToBottom":
		return ArrowThickToBottom()
	case "arrowThickToLeft":
		return ArrowThickToLeft()
	case "arrowThickToRight":
		return ArrowThickToRight()
	case "arrowThickToTop":
		return ArrowThickToTop()
	case "arrowThickTop":
		return ArrowThickTop()
	case "arrowTop":
		return ArrowTop()
	case "assistiveListeningSystem":
		return AssistiveListeningSystem()
	case "asterisk":
		return Asterisk()
	case "asteriskCircle":
		return AsteriskCircle()
	case "at":
		return At()
	case "audio":
		return Audio()
	...
	case "chevronCircleDownAlt":
		return ChevronCircleDownAlt()
	case "chevronCircleLeftAlt":
		return ChevronCircleLeftAlt()
	case "chevronCircleRightAlt":
		return ChevronCircleRightAlt()
	case "chevronCircleUpAlt":
		return ChevronCircleUpAlt()
	...
	case "chevronDoubleUpAlt":
		return ChevronDoubleUpAlt()
	case "chevronLeft":
		return ChevronLeft()
	case "chevronRight":
		return ChevronRight()
	...
	case "door":
		return Door()
	case "doubleQuoteSansLeft":
		return DoubleQuoteSansLeft()
	case "doubleQuoteSansRight":
	...
	case "listFilter":
		return ListFilter()
	case "listHighPriority":
		return ListHighPriority()
	case "listLowPriority":
		return ListLowPriority()
	case "listNumbered":
		return ListNumbered()
	case "listNumberedRtl":
		return ListNumberedRtl()
	case "listRich":
		return ListRich()
	case "locationPin":
		return LocationPin()
	...
	case "screenSmartphone":
		return ScreenSmartphone()
	case "scrubber":
		return Scrubber()
	case "search":
		return Search()
	...
	case "signLanguage":
		return SignLanguage()
	case "signalCellularFour":
		return SignalCellularFour()
	case "signalCellularThree":
		return SignalCellularThree()
	case "signalCellularZero":
		return SignalCellularZero()
	case "sim":
		return Sim()
	case "sitemap":
		return Sitemap()
	...
	case "verticalAlignBottomOne":
		return VerticalAlignBottomOne()
	case "verticalAlignCenter":
		return VerticalAlignCenter()
	case "verticalAlignCenterOne":
		return VerticalAlignCenterOne()
	case "verticalAlignTop":
		return VerticalAlignTop()
	case "verticalAlignTopOne":
		return VerticalAlignTopOne()
	case "video":
		return Video()
	case "videogame":
		return Videogame()
	...
	case "wc":
		return Wc()
	case "weightlifitng":
		return Weightlifitng()
	case "wheelchair":
		return Wheelchair()
	case "wifiSignalFour":
		return WifiSignalFour()
	case "wifiSignalOff":
		return WifiSignalOff()
	case "wifiSignalOne":
		return WifiSignalOne()
	case "wifiSignalThree":
		return WifiSignalThree()
	case "wifiSignalTwo":
		return WifiSignalTwo()
	case "wifiSignalZero":
		return WifiSignalZero()
	case "window":
		return Window()
	case "windowMaximize":
