...
const (
	IconifyVersion              = "1.9.29"
	airPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8h7a3 3 0 1 0-3-3M4 16h11a3 3 0 1 1-3 3M2 12h17a3 3 0 1 0-3-3"/>`
	airplayAudioPath            = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m12 16l6 5H6l6-5Z"/><path d="M4 18a9.956 9.956 0 0 1-2-6C2 6.477 6.477 2 12 2s10 4.477 10 10a9.956 9.956 0 0 1-2 6"/><path d="M17.123 15.125a6 6 0 1 0-10.247-.002"/><path d="M14 12a2 2 0 1 0-4 0"/></g>`
	airplayVideoPath            = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1"/><path d="m12 16l6 5H6l6-5Z"/></g>`
	airpodsPath                 = `<g fill="none" stroke="currentColor" stroke-width="2"><path d="M14 7c0 2.21 1.644 4 4 4s4-1.79 4-4s-1.644-4-4-4s-4 1.79-4 4Zm-4 0c0 2.21-1.644 4-4 4S2 9.21 2 7s1.644-4 4-4s4 1.79 4 4Z"/><path stroke-linecap="round" d="M14 7v12a2 2 0 0 0 2 2v0a2 2 0 0 0 2-2v-8"/><path d="M14 17h4M6 17h4"/><path stroke-linecap="round" d="M10 7v12a2 2 0 0 1-2 2v0a2 2 0 0 1-2-2v-8"/><path d="M20 4a5.408 5.408 0 0 0 0 6M4 4a5.408 5.408 0 0 1 0 6"/></g>`
	alarmPath                   = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="13" r="9"/><path d="M15.5 9.5L12 13m7 6l1 3M5 19l-1 3M2 5l3-3m14 0l3 3M12 4V2"/></g>`
	alignBottomPath             = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="5.759" stroke-width="2"><path d="M21 22H3"/><path stroke-linejoin="round" d="M6 18V2h4v16H6Zm8 0V8h4v10h-4Z"/></g>`
	alignHorizontalCenterPath   = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="5.759" stroke-width="2"><path d="M12 3v18"/><path stroke-linejoin="round" d="M16 6h4v4h-4m-8 0H4V6h4m8 8h2v4h-2m-8-4H6v4h2"/></g>`
	alignLeftPath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="5.759" stroke-width="2"><path d="M2 3v18"/><path stroke-linejoin="round" d="M6 6h16v4H6zm0 8h10v4H6z"/></g>`
	alignRightPath              = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="5.759" stroke-width="2"><path d="M22 3v18"/><path stroke-linejoin="round" d="M2 6h16v4H2zm6 8h10v4H8z"/></g>`
	alignToBottomPath           = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 22h18M12 2v15m-7-7l7 7l7-7"/>`
	alignToMiddlePath           = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="M21 12H3"/><path stroke-linejoin="round" d="M12 2v6m0 14v-6M9 5l3 3l3-3M9 19l3-3l3 3"/></g>`
	alignToTopPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 22V7m-7 7l7-7l7 7M3 2h18"/>`
	alignTopPath                = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="5.759" stroke-width="2"><path d="M21 2H3"/><path stroke-linejoin="round" d="M6 22V6h4v16H6Zm8-6V6h4v10h-4Z"/></g>`
	alignVerticalCenterPath     = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="5.759" stroke-width="2"><path d="M21 12H3"/><path stroke-linejoin="round" d="M6 16v4h4v-4m4 0v2h4v-2m-4-8V6h4v2m-8 0V4H6v4"/></g>`
	androidFillPath             = `<path fill="currentColor" d="M17.532 15.106a1.003 1.003 0 1 1 .001-2.007a1.003 1.003 0 0 1 0 2.007Zm-11.044 0a1.003 1.003 0 1 1 .001-2.007a1.003 1.003 0 0 1 0 2.007Zm11.4-6.018l2.006-3.459a.413.413 0 1 0-.721-.407l-2.027 3.5a12.243 12.243 0 0 0-5.13-1.108c-1.85 0-3.595.398-5.141 1.098l-2.027-3.5a.413.413 0 1 0-.72.407l1.995 3.458C2.696 10.947.345 14.417 0 18.523h24c-.334-4.096-2.675-7.565-6.112-9.435Z"/>`
	angularFillPath             = `<path fill="currentColor" d="M10.174 12.594h3.652L12 8.095l-1.826 4.499Z"/><path fill="currentColor" d="M12 1L2 4.652l1.525 13.541L12 23l8.475-4.807L22 4.652L12 1Zm6.24 16.786h-2.33l-1.257-3.212H9.347L8.09 17.786H5.76L12 3.431l6.24 14.355Z"/>`
	arrowBackPath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m8 5l-5 5l5 5"/><path d="M3 10h8c5.523 0 10 4.477 10 10v1"/></g>`
	arrowBackThickPath          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m2 11l7-9v5c11.953 0 13.332 9.678 13 15c-.502-2.685-.735-7-13-7v5l-7-9Z"/>`
	arrowBackThickFillPath      = `<path fill="currentColor" fill-rule="evenodd" d="M10 2a1 1 0 0 0-1.79-.614l-7 9a1 1 0 0 0 0 1.228l7 9A1 1 0 0 0 10 20v-3.99c5.379.112 7.963 1.133 9.261 2.243c1.234 1.055 1.46 2.296 1.695 3.596l.061.335a1 1 0 0 0 1.981-.122c.171-2.748-.086-6.73-2.027-10.061C19.087 8.768 15.694 6.282 10 6.022V2Z" clip-rule="evenodd"/>`
	arrowClockwisePath          = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M19.734 16.06a8.923 8.923 0 0 1-3.915 3.978a8.706 8.706 0 0 1-5.471.832a8.795 8.795 0 0 1-4.887-2.64a9.067 9.067 0 0 1-2.388-5.079a9.136 9.136 0 0 1 1.044-5.53a8.904 8.904 0 0 1 4.069-3.815a8.7 8.7 0 0 1 5.5-.608c1.85.401 3.366 1.313 4.62 2.755c.151.16.735.806 1.22 1.781"/><path d="m15.069 7.813l5.04.907L21 3.59"/></g>`
	arrowCounterClockwisePath   = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M4.266 16.06a8.923 8.923 0 0 0 3.915 3.978a8.706 8.706 0 0 0 5.471.832a8.796 8.796 0 0 0 4.887-2.64a9.067 9.067 0 0 0 2.388-5.079a9.137 9.137 0 0 0-1.044-5.53a8.904 8.904 0 0 0-4.068-3.815a8.7 8.7 0 0 0-5.5-.608c-1.85.401-3.367 1.313-4.62 2.755a7.62 7.62 0 0 0-1.22 1.781"/><path d="m8.931 7.813l-5.04.907L3 3.59"/></g>`
	arrowCyclePath              = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M22 12c0 6-4.39 10-9.806 10C7.792 22 4.24 19.665 3 16m-1-4C2 6 6.39 2 11.806 2C16.209 2 19.76 4.335 21 8"/><path d="m7 17l-4-1l-1 4M17 7l4 1l1-4"/></g>`
	arrowDownPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 20V4m-7 9l7 7l7-7"/>`
	arrowDownLeftPath           = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 8v10h10"/>`
	arrowDownRightPath          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 18L6 6m2 12h10V8"/>`
	arrowDownThickPath          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m12 21l9-7h-4.99L16 3H8v11H3l9 7Z"/>`
	arrowForwardPath            = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m16 5l5 5l-5 5"/><path d="M21 10h-8C7.477 10 3 14.477 3 20v1"/></g>`
	arrowForwardThickPath       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m22 11l-7-9v5C3.047 7 1.668 16.678 2 22c.502-2.685.735-7 13-7v5l7-9Z"/>`
	arrowForwardThickFillPath   = `<path fill="currentColor" fill-rule="evenodd" d="M14.675 1.054a1 1 0 0 1 1.114.332l7 9a1 1 0 0 1 0 1.228l-7 9A1 1 0 0 1 14 20v-3.99c-5.379.112-7.963 1.133-9.261 2.243c-1.234 1.055-1.46 2.296-1.695 3.596l-.061.335a1 1 0 0 1-1.981-.122c-.172-2.748.086-6.73 2.027-10.061C4.913 8.768 8.305 6.282 14 6.022V2a1 1 0 0 1 .675-.946Z" clip-rule="evenodd"/>`
	arrowLeftPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m11 5l-7 7l7 7m-7-7h16"/>`
	arrowLeftThickPath          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m3 12l7-9v4.99L21 8v8H10v5l-7-9Z"/>`
	arrowRepeatPath             = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m18 2l3 3l-3 3M6 22l-3-3l3-3"/><path d="M21 5H10a7 7 0 0 0-7 7m0 7h11a7 7 0 0 0 7-7"/></g>`
	arrowRightPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m-7-7l7 7l-7 7"/>`
	arrowRightLeftPath          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 6H3m18 0l-4 4m4-4l-4-4M3 18h18M3 18l4 4m-4-4l4-4"/>`
	arrowRightThickPath         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 12l-7-9v4.99L3 8v8h11v5l7-9Z"/>`
	arrowShufflePath            = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M2 19h3.908a2 2 0 0 0 1.682-.919L11.5 12l3.91-6.082A2 2 0 0 1 17.091 5H22m0 14h-4.908a2 2 0 0 1-1.682-.919L13.428 15M2 5h3.908a2 2 0 0 1 1.682.918L9.571 9"/><path d="m19 2l3 3l-3 3m0 8l3 3l-3 3"/></g>`
	arrowUpPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 20V4m-7 7l7-7l7 7"/>`
	arrowUpDownPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 3v18M6 3l4 4M6 3L2 7m16 14V3m0 18l4-4m-4 4l-4-4"/>`
	arrowUpLeftPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m6 6l12 12M16 6H6v10"/>`
	arrowUpRightPath            = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 6L6 18M8 6h10v10"/>`
	arrowUpThickPath            = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m12 3l9 7h-4.99L16 21H8V10H3l9-7Z"/>`
	ascendingPath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M6 3v18M6 3l3 3.333M6 3L3 6.333"/><path stroke-miterlimit="5.759" d="M14 21h8l-1-4h-7v4Zm0-7h6l-1-4h-5v4Zm0-7h4l-1-4h-3v4Z"/></g>`
	attachPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 7.91V16a6 6 0 0 0 6 6v0a6 6 0 0 0 6-6V6a4 4 0 0 0-4-4v0a4 4 0 0 0-4 4v9.182a2 2 0 0 0 2 2v0a2 2 0 0 0 2-2V8"/>`
	...
	backspacePath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="m17 15l-6-6m6 0l-6 6"/><path stroke-linejoin="round" d="M7.4 4.8A2 2 0 0 1 9 4h11a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9a2 2 0 0 1-1.6-.8l-4.5-6a2 2 0 0 1 0-2.4l4.5-6Z"/></g>`
	backspaceFillPath           = `<path fill="currentColor" fill-rule="evenodd" d="M6.6 4.2A3 3 0 0 1 9 3h11a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H9a3 3 0 0 1-2.4-1.2l-4.5-6a3 3 0 0 1 0-3.6l4.5-6Zm11.107 5.507a1 1 0 0 0-1.414-1.414L14 10.586l-2.293-2.293a1 1 0 1 0-1.414 1.414L12.586 12l-2.293 2.293a1 1 0 0 0 1.414 1.414L14 13.414l2.293 2.293a1 1 0 0 0 1.414-1.414L15.414 12l2.293-2.293Z" clip-rule="evenodd"/>`
	bankPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 11V8l-8-5l-8 5v3h16ZM3 21h18M5 20v-5h2m10 5v-5h2m-8 5v-5h2"/>`
	basketPath                  = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linejoin="round" d="M2.31 11.242A1 1 0 0 1 3.28 10h17.44a1 1 0 0 1 .97 1.242l-1.811 7.243A2 2 0 0 1 17.939 20H6.061a2 2 0 0 1-1.94-1.515L2.31 11.243Z"/><path stroke-linecap="round" d="M9 14v2m6-2v2m-9-6l4-6m8 6l-4-6"/></g>`
	batteryChargingPath         = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="18" height="12" x="2" y="6" rx="2"/><path d="M20 10h1.5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H20v-4Zm-8.6-1L9 12h4l-2.4 3"/></g>`
	batteryEmptyPath            = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="18" height="12" x="2" y="6" rx="2"/><path d="M20 10h1.5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H20v-4Z"/></g>`
	batteryFullPath             = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="18" height="12" x="2" y="6" rx="2"/><path d="M7 10v4m4-4v4m4-4v4m5-4h1.5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H20v-4Z"/></g>`
	batteryLowPath              = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="18" height="12" x="2" y="6" rx="2"/><path d="M7 10v4m13-4h1.5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H20v-4Z"/></g>`
	batteryMediumPath           = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="18" height="12" x="2" y="6" rx="2"/><path d="M20 10h1.5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H20v-4ZM7 10v4m4-4v4"/></g>`
	behanceFillPath             = `<g fill="none"><g clip-path="url(#akarIconsBehanceFill0)"><path fill="currentColor" d="M22 7h-7V5h7v2Zm1.726 10c-.442 1.297-2.029 3-5.101 3c-3.074 0-5.564-1.729-5.564-5.675c0-3.91 2.325-5.92 5.466-5.92c3.082 0 4.964 1.782 5.375 4.426c.078.506.109 1.188.095 2.14H15.97c.13 3.211 3.483 3.312 4.588 2.029h3.168Zm-7.686-4h4.965c-.105-1.547-1.136-2.219-2.477-2.219c-1.466 0-2.277.768-2.488 2.219Zm-9.574 6.988H0V5.021h6.953c5.476.081 5.58 5.444 2.72 6.906c3.461 1.26 3.577 8.061-3.207 8.061ZM3 11h3.584c2.508 0 2.906-3-.312-3H3v3Zm3.391 3H3v3.016h3.341c3.055 0 2.868-3.016.05-3.016Z"/></g><defs><clipPath id="akarIconsBehanceFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	bellPath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12.721 5.003L11.255 5c-3.344-.008-6.247 2.709-6.27 6v3.79c0 .79-.1 1.561-.531 2.218l-.287.438C3.73 18.11 4.2 19 4.985 19h14.03c.785 0 1.254-.89.818-1.554l-.287-.438c-.43-.657-.531-1.429-.531-2.219v-3.788c-.04-3.292-2.95-5.99-6.294-5.998ZM15 19a3 3 0 1 1-6 0"/><path d="M12 2a2 2 0 0 1 2 2v1h-4V4a2 2 0 0 1 2-2Z"/></g>`
	bicyclePath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="6" cy="15" r="4"/><circle cx="18" cy="15" r="4"/><path d="m6 15l2-7h7.5M6 5h3m9 10L15 5h4m0 0h.5A1.5 1.5 0 0 1 21 6.5v0A1.5 1.5 0 0 1 19.5 8H19"/></g>`
	bitcoinFillPath             = `<g fill="none"><g fill="currentColor" clip-path="url(#akarIconsBitcoinFill0)"><path d="M11.385 15.275c1.111-.004 3.54-.013 3.512-1.558c-.027-1.58-2.36-1.485-3.497-1.438c-.127.005-.24.01-.332.011l.052 2.987c.075-.002.165-.002.265-.002Zm-.118-4.353c.927-.001 2.95-.003 2.926-1.408c-.026-1.437-1.969-1.352-2.918-1.31c-.107.005-.2.009-.278.01l.047 2.709l.223-.001Z"/><path fill-rule="evenodd" d="M9.096 23.641c6.43 1.603 12.942-2.31 14.545-8.738C25.244 8.474 21.33 1.962 14.9.36C8.474-1.244 1.962 2.67.36 9.1c-1.603 6.428 2.31 12.94 8.737 14.542Zm4.282-17.02c1.754.124 3.15.638 3.333 2.242c.136 1.174-.344 1.889-1.123 2.303c1.3.288 2.125 1.043 1.995 2.771c-.161 2.145-1.748 2.748-4.026 2.918l.038 2.25l-1.356.025l-.039-2.22c-.351.006-.711.01-1.084.008l.04 2.23l-1.356.024l-.04-2.254l-.383.003c-.194.001-.39.002-.586.006l-1.766.03l.241-1.624s1.004-.002.986-.017c.384-.008.481-.285.502-.459L8.693 11.3l.097-.002h.046a1.101 1.101 0 0 0-.144-.007l-.044-2.54c-.057-.274-.241-.59-.79-.58c.015-.02-.986.017-.986.017L6.846 6.74l1.872-.032v.007c.281-.005.57-.015.863-.026L9.543 4.46l1.356-.023l.038 2.184c.362-.013.726-.027 1.083-.033l-.038-2.17l1.357-.024l.039 2.229Z" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsBitcoinFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	blockPath                   = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M5 19L19 5"/></g>`
	bluetoothPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 7l12 10l-6 5V2l6 5L5 17"/>`
	boatPath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m16.926 19.381l-4.302 1.414a2 2 0 0 1-1.248 0L7.074 19.38a4 4 0 0 1-2.623-2.794L3 11l9 1l9-1l-1.451 5.587a4 4 0 0 1-2.623 2.794Z"/><path d="M6.497 7.257A2 2 0 0 1 8.354 6h7.292a2 2 0 0 1 1.857 1.257L19 11l-7 1l-7-1l1.497-3.743ZM12 3v3m-1-3h2m-1 9v4"/></g>`
	bookPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 6s1.5-2 5-2s5 2 5 2v14s-1.5-1-5-1s-5 1-5 1V6Zm10 0s1.5-2 5-2s5 2 5 2v14s-1.5-1-5-1s-5 1-5 1V6Z"/>`
	...
	calendarPath                = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="20" height="18" x="2" y="4" rx="4"/><path d="M8 2v4m8-4v4M2 10h20"/></g>`
	...
	cartPath                    = `<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><path d="M5 7h13.79a2 2 0 0 1 1.99 2.199l-.6 6A2 2 0 0 1 18.19 17H8.64a2 2 0 0 1-1.962-1.608L5 7Z"/><path stroke-linecap="round" d="m5 7l-.81-3.243A1 1 0 0 0 3.22 3H2m6 18h2m6 0h2"/></g>`
	chatAddPath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="M12 8v3m0 0v3m0-3h3m-3 0H9"/><path stroke-linejoin="round" d="M14 19c3.771 0 5.657 0 6.828-1.172C22 16.657 22 14.771 22 11c0-3.771 0-5.657-1.172-6.828C19.657 3 17.771 3 14 3h-4C6.229 3 4.343 3 3.172 4.172C2 5.343 2 7.229 2 11c0 3.771 0 5.657 1.172 6.828c.653.654 1.528.943 2.828 1.07"/><path d="M14 19c-1.236 0-2.598.5-3.841 1.145c-1.998 1.037-2.997 1.556-3.489 1.225c-.492-.33-.399-1.355-.212-3.404L6.5 17.5"/></g>`
	chatApprovePath             = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path stroke-linejoin="round" d="M14 19c3.771 0 5.657 0 6.828-1.172C22 16.657 22 14.771 22 11c0-3.771 0-5.657-1.172-6.828C19.657 3 17.771 3 14 3h-4C6.229 3 4.343 3 3.172 4.172C2 5.343 2 7.229 2 11c0 3.771 0 5.657 1.172 6.828c.653.654 1.528.943 2.828 1.07"/><path stroke-linejoin="round" d="m9 11l2.25 2L15 9"/><path d="M14 19c-1.236 0-2.598.5-3.841 1.145c-1.998 1.037-2.997 1.556-3.489 1.225c-.492-.33-.399-1.355-.212-3.404L6.5 17.5"/></g>`
	chatBubblePath              = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path stroke-linejoin="round" d="M14 19c3.771 0 5.657 0 6.828-1.172C22 16.657 22 14.771 22 11c0-3.771 0-5.657-1.172-6.828C19.657 3 17.771 3 14 3h-4C6.229 3 4.343 3 3.172 4.172C2 5.343 2 7.229 2 11c0 3.771 0 5.657 1.172 6.828c.653.654 1.528.943 2.828 1.07"/><path d="M14 19c-1.236 0-2.598.5-3.841 1.145c-1.998 1.037-2.997 1.556-3.489 1.225c-.492-.33-.399-1.355-.212-3.404L6.5 17.5"/></g>`
	chatDotsPath                = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path stroke-linejoin="round" d="M14 19c3.771 0 5.657 0 6.828-1.172C22 16.657 22 14.771 22 11c0-3.771 0-5.657-1.172-6.828C19.657 3 17.771 3 14 3h-4C6.229 3 4.343 3 3.172 4.172C2 5.343 2 7.229 2 11c0 3.771 0 5.657 1.172 6.828c.653.654 1.528.943 2.828 1.07"/><path d="M12 11v.01M8 11v.01m8-.01v.01M14 19c-1.236 0-2.598.5-3.841 1.145c-1.998 1.037-2.997 1.556-3.489 1.225c-.492-.33-.399-1.355-.212-3.404L6.5 17.5"/></g>`
	chatEditPath                = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M14 19c3.771 0 5.657 0 6.828-1.172C22 16.657 22 14.771 22 11c0-3.771 0-5.657-1.172-6.828C19.657 3 17.771 3 14 3h-4C6.229 3 4.343 3 3.172 4.172C2 5.343 2 7.229 2 11c0 3.771 0 5.657 1.172 6.828c.653.654 1.528.943 2.828 1.07"/><path stroke-linecap="round" stroke-linejoin="round" d="M15.207 6.793a1 1 0 0 0-1.418.003l-4.55 4.597a2 2 0 0 0-.54 1.015l-.18.896a1 1 0 0 0 1.177 1.177l.896-.18a2 2 0 0 0 1.015-.54l4.597-4.55a1 1 0 0 0 .003-1.418l-1-1Z"/><path d="m12.5 9.5l1 1"/><path stroke-linecap="round" d="M14 19c-1.236 0-2.598.5-3.841 1.145c-1.998 1.037-2.997 1.556-3.489 1.225c-.492-.33-.399-1.355-.212-3.404L6.5 17.5"/></g>`
	chatErrorPath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path stroke-linejoin="round" d="M14 19c3.771 0 5.657 0 6.828-1.172C22 16.657 22 14.771 22 11c0-3.771 0-5.657-1.172-6.828C19.657 3 17.771 3 14 3h-4C6.229 3 4.343 3 3.172 4.172C2 5.343 2 7.229 2 11c0 3.771 0 5.657 1.172 6.828c.653.654 1.528.943 2.828 1.07"/><path d="M14 19c-1.236 0-2.598.5-3.841 1.145c-1.998 1.037-2.997 1.556-3.489 1.225c-.492-.33-.399-1.355-.212-3.404L6.5 17.5m3.379-8.621L12 11m0 0l2.121 2.121M12 11l2.121-2.121M12 11l-2.121 2.121"/></g>`
	chatQuestionPath            = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path stroke-linejoin="round" d="M14 19c3.771 0 5.657 0 6.828-1.172C22 16.657 22 14.771 22 11c0-3.771 0-5.657-1.172-6.828C19.657 3 17.771 3 14 3h-4C6.229 3 4.343 3 3.172 4.172C2 5.343 2 7.229 2 11c0 3.771 0 5.657 1.172 6.828c.653.654 1.528.943 2.828 1.07"/><path d="M10 8.484C10.5 7.494 11 7 12 7c1.246 0 2 .989 2 1.978s-.5 1.033-2 2.022v1m0 2.5v.5m2 4c-1.236 0-2.598.5-3.841 1.145c-1.998 1.037-2.997 1.556-3.489 1.225c-.492-.33-.399-1.355-.212-3.404L6.5 17.5"/></g>`
	chatRemovePath              = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="M15 11H9"/><path stroke-linejoin="round" d="M14 19c3.771 0 5.657 0 6.828-1.172C22 16.657 22 14.771 22 11c0-3.771 0-5.657-1.172-6.828C19.657 3 17.771 3 14 3h-4C6.229 3 4.343 3 3.172 4.172C2 5.343 2 7.229 2 11c0 3.771 0 5.657 1.172 6.828c.653.654 1.528.943 2.828 1.07"/><path d="M14 19c-1.236 0-2.598.5-3.841 1.145c-1.998 1.037-2.997 1.556-3.489 1.225c-.492-.33-.399-1.355-.212-3.404L6.5 17.5"/></g>`
	checkPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 12l6 6L20 6"/>`
	checkBoxPath                = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="18" height="18" x="3" y="3" rx="4"/><path d="m9 12l2.25 2L15 10"/></g>`
	checkBoxFillPath            = `<path fill="currentColor" fill-rule="evenodd" d="M7 2a5 5 0 0 0-5 5v10a5 5 0 0 0 5 5h10a5 5 0 0 0 5-5V7a5 5 0 0 0-5-5H7Zm8.73 8.684a1 1 0 1 0-1.46-1.368l-3.083 3.29l-1.523-1.353a1 1 0 0 0-1.328 1.494l2.25 2a1 1 0 0 0 1.393-.063l3.75-4Z" clip-rule="evenodd"/>`
	checkInPath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 2a6 6 0 0 0-6 6c0 1.419.302 2.348 1.125 3.375L12 17l4.875-5.625C17.698 10.348 18 9.419 18 8a6 6 0 0 0-6-6Z"/><path d="M5 15.143C3.149 15.87 2 16.881 2 18c0 2.21 4.477 4 10 4s10-1.79 10-4c0-1.119-1.149-2.13-3-2.857"/><circle cx="12" cy="8" r="1"/></g>`
	chessPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.533 3.81L8 2l1 4l-5.37 4.475A1.75 1.75 0 0 0 3 11.82v0c0 .617.537 1.088 1.127.986L9 12l-2.097 7h10.614l1.283-5.745c.913-4.088-1.386-8.21-5.267-9.445ZM4 21a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v1H4v-1Z"/>`
	chevronDownPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 9l8 8l8-8"/>`
	chevronDownSmallPath        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m6 10l6 6l6-6"/>`
	chevronHorizontalPath       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m17 8l4 4l-4 4M7 8l-4 4l4 4"/>`
	chevronLeftPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 4l-8 8l8 8"/>`
	chevronLeftSmallPath        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m14 6l-6 6l6 6"/>`
	chevronRightPath            = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 4l8 8l-8 8"/>`
	chevronRightSmallPath       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 6l6 6l-6 6"/>`
	chevronUpPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 15l8-8l8 8"/>`
	chevronUpSmallPath          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m6 14l6-6l6 6"/>`
	chevronVerticalPath         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 17l4 4l4-4M8 7l4-4l4 4"/>`
	circlePath                  = `<circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="2"/>`
	circleAlertPath             = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" d="M12 7v6m0 3.5v.5"/></g>`
	circleAlertFillPath         = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1Zm1 6a1 1 0 1 0-2 0v6a1 1 0 1 0 2 0V7Zm0 9.5a1 1 0 1 0-2 0v.5a1 1 0 1 0 2 0v-.5Z" clip-rule="evenodd"/>`
	circleCheckPath             = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m8 12.5l3 3l5-6"/><circle cx="12" cy="12" r="10"/></g>`
	circleCheckFillPath         = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1Zm4.768 9.14a1 1 0 1 0-1.536-1.28l-4.3 5.159l-2.225-2.226a1 1 0 0 0-1.414 1.414l3 3a1 1 0 0 0 1.475-.067l5-6Z" clip-rule="evenodd"/>`
	circleChevronDownPath       = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" stroke-linejoin="round" d="m8 10.5l4 4l4-4"/></g>`
	circleChevronDownFillPath   = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1ZM8.707 9.793a1 1 0 0 0-1.414 1.414l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0-1.414-1.414L12 13.086L8.707 9.793Z" clip-rule="evenodd"/>`
	circleChevronLeftPath       = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" stroke-linejoin="round" d="m13.5 8l-4 4l4 4"/></g>`
	circleChevronLeftFillPath   = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1Zm2.207 7.707a1 1 0 0 0-1.414-1.414l-4 4a1 1 0 0 0 0 1.414l4 4a1 1 0 0 0 1.414-1.414L10.914 12l3.293-3.293Z" clip-rule="evenodd"/>`
	circleChevronRightPath      = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" stroke-linejoin="round" d="m10.5 8l4 4l-4 4"/></g>`
	circleChevronRightFillPath  = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1ZM9.793 8.707a1 1 0 0 1 1.414-1.414l4 4a1 1 0 0 1 0 1.414l-4 4a1 1 0 0 1-1.414-1.414L13.086 12L9.793 8.707Z" clip-rule="evenodd"/>`
	circleChevronUpPath         = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" stroke-linejoin="round" d="m8 13.5l4-4l4 4"/></g>`
	circleChevronUpFillPath     = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1ZM8.707 14.207a1 1 0 0 1-1.414-1.414l4-4a1 1 0 0 1 1.414 0l4 4a1 1 0 0 1-1.414 1.414L12 10.914l-3.293 3.293Z" clip-rule="evenodd"/>`
	circleFillPath              = `<circle cx="12" cy="12" r="11" fill="currentColor"/>`
	circleMinusPath             = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" d="M16 12H8"/><circle cx="12" cy="12" r="10"/></g>`
	circleMinusFillPath         = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1ZM8 11a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2H8Z" clip-rule="evenodd"/>`
	circlePlusPath              = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" d="M12 8v4m0 0v4m0-4h4m-4 0H8"/><circle cx="12" cy="12" r="10"/></g>`
	circlePlusFillPath          = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1Zm1 15a1 1 0 1 1-2 0v-3H8a1 1 0 1 1 0-2h3V8a1 1 0 1 1 2 0v3h3a1 1 0 1 1 0 2h-3v3Z" clip-rule="evenodd"/>`
	circleTriangleDownPath      = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" stroke-linejoin="round" d="m12 16l-4-6h8l-4 6Z"/></g>`
	circleTriangleDownFillPath  = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1Zm-3.2 9a.809.809 0 0 0-.705.396a.71.71 0 0 0 .04.77l3.2 4.5A.815.815 0 0 0 12 16a.815.815 0 0 0 .666-.334l3.2-4.5a.71.71 0 0 0 .04-.77A.809.809 0 0 0 15.2 10H8.8Z" clip-rule="evenodd"/>`
	circleTriangleLeftPath      = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" stroke-linejoin="round" d="m8 12l6-4v8l-6-4Z"/></g>`
	circleTriangleLeftFillPath  = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1Zm2 7.8a.809.809 0 0 0-.396-.705a.71.71 0 0 0-.77.04l-4.5 3.2A.815.815 0 0 0 8 12c0 .268.125.517.334.666l4.5 3.2a.71.71 0 0 0 .77.04A.809.809 0 0 0 14 15.2V8.8Z" clip-rule="evenodd"/>`
	circleTriangleRightPath     = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" stroke-linejoin="round" d="m16 12l-6-4v8l6-4Z"/></g>`
	circleTriangleRightFillPath = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1Zm-2 7.8c0-.295.152-.566.396-.705a.71.71 0 0 1 .77.04l4.5 3.2A.815.815 0 0 1 16 12a.815.815 0 0 1-.334.666l-4.5 3.2a.71.71 0 0 1-.77.04A.809.809 0 0 1 10 15.2V8.8Z" clip-rule="evenodd"/>`
	circleTriangleUpPath        = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" stroke-linejoin="round" d="m12 8l-4 6h8l-4-6Z"/></g>`
	circleTriangleUpFillPath    = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1ZM8.8 14a.809.809 0 0 1-.705-.396a.71.71 0 0 1 .04-.77l3.2-4.5A.815.815 0 0 1 12 8c.268 0 .517.125.666.334l3.2 4.5a.71.71 0 0 1 .04.77a.809.809 0 0 1-.706.396H8.8Z" clip-rule="evenodd"/>`
	circleXPath                 = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" d="M15 15L9 9m6 0l-6 6"/><circle cx="12" cy="12" r="10"/></g>`
	circleXFillPath             = `<path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1Zm3.707 8.707a1 1 0 0 0-1.414-1.414L12 10.586L9.707 8.293a1 1 0 1 0-1.414 1.414L10.586 12l-2.293 2.293a1 1 0 1 0 1.414 1.414L12 13.414l2.293 2.293a1 1 0 0 0 1.414-1.414L13.414 12l2.293-2.293Z" clip-rule="evenodd"/>`
	clipboardPath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path stroke-linejoin="round" d="M15.5 4H18a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2.5"/><path stroke-linejoin="round" d="M8.621 3.515A2 2 0 0 1 10.561 2h2.877a2 2 0 0 1 1.94 1.515L16 6H8l.621-2.485Z"/><path d="M9 12h6m-6 4h6"/></g>`
	clockPath                   = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="m15 16l-2.414-2.414A2 2 0 0 1 12 12.172V6"/></g>`
	cloudPath                   = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M5.034 11.117A4.002 4.002 0 0 0 6 19h11a5 5 0 1 0-1.17-9.862L14.5 9.5"/><path d="M15.83 9.138a5.5 5.5 0 0 0-10.796 1.98S5.187 12 5.5 12.5"/></g>`
	cloudDownloadPath           = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 22v-9m0 9l-2.5-2m2.5 2l2.5-2M5.034 9.117A4.002 4.002 0 0 0 6 17h1"/><path d="M15.83 7.138a5.5 5.5 0 0 0-10.796 1.98S5.187 10 5.5 10.5"/><path d="M17 17a5 5 0 1 0-1.17-9.862L14.5 7.5"/></g>`
	cloudUploadPath             = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 12v9m0-9l-2.5 2m2.5-2l2.5 2M5.034 9.117A4.002 4.002 0 0 0 6 17h1"/><path d="M15.83 7.138a5.5 5.5 0 0 0-10.796 1.98S5.187 10 5.5 10.5"/><path d="M17 17a5 5 0 1 0-1.17-9.862L14.5 7.5"/></g>`
	codepenFillPath             = `<g fill="none"><g clip-path="url(#akarIconsCodepenFill0)"><path fill="currentColor" fill-rule="evenodd" d="M11.372.19c.38-.253.875-.253 1.256 0L23.492 7.4c.317.21.508.565.508.946v7.308c0 .38-.19.736-.508.947l-10.864 7.21c-.38.252-.875.252-1.256 0L.508 16.6A1.136 1.136 0 0 1 0 15.654V8.346c0-.38.19-.736.508-.947L11.372.19Zm-9.1 10.273v3.058l2.288-1.54l-2.288-1.518Zm4.337 2.878L3.18 15.648l7.684 5.1v-4.583L6.61 13.341Zm6.527 2.824v4.582l7.684-5.1l-3.43-2.306l-4.254 2.824Zm6.303-4.183l2.29 1.54v-3.06l-2.29 1.52Zm1.371-3.636l-3.41 2.263l-4.264-2.868V3.253l7.674 5.093Zm-9.946-5.093V7.74l-4.263 2.868L3.19 8.346l7.674-5.093ZM12 9.715l-3.35 2.254L12 14.192l3.35-2.223L12 9.715Z" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsCodepenFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	coffeePath                  = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M11 7c4.418 0 8 .895 8 2s-3.582 2-8 2s-8-.895-8-2c0-.357.375-.693 1.033-.984"/><path d="M3 9v9.343c0 1.061.44 2.08 1.409 2.513C5.624 21.399 7.711 22 11 22c3.29 0 5.377-.601 6.591-1.144c.968-.433 1.409-1.452 1.409-2.513V9m0 1v0a3 3 0 0 1 3 3v0a3 3 0 0 1-3 3v0M7 3v4m4-5v2m4 0v3"/></g>`
	...
	commandPath                 = `<path fill="none" stroke="currentColor" stroke-width="2" d="M9.3 17.85a3.15 3.15 0 1 1-3.15-3.15h11.7a3.15 3.15 0 1 1-3.15 3.15V6.15a3.15 3.15 0 1 1 3.15 3.15H6.15A3.15 3.15 0 1 1 9.3 6.15v11.7Z"/>`
	commentPath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path stroke-linejoin="round" d="M14 19c3.771 0 5.657 0 6.828-1.172C22 16.657 22 14.771 22 11c0-3.771 0-5.657-1.172-6.828C19.657 3 17.771 3 14 3h-4C6.229 3 4.343 3 3.172 4.172C2 5.343 2 7.229 2 11c0 3.771 0 5.657 1.172 6.828c.653.654 1.528.943 2.828 1.07"/><path d="M14 19c-1.236 0-2.598.5-3.841 1.145c-1.998 1.037-2.997 1.556-3.489 1.225c-.492-.33-.399-1.355-.212-3.404L6.5 17.5"/></g>`
	commentAddPath              = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="M12 8v3m0 0v3m0-3h3m-3 0H9"/><path stroke-linejoin="round" d="M14 19c3.771 0 5.657 0 6.828-1.172C22 16.657 22 14.771 22 11c0-3.771 0-5.657-1.172-6.828C19.657 3 17.771 3 14 3h-4C6.229 3 4.343 3 3.172 4.172C2 5.343 2 7.229 2 11c0 3.771 0 5.657 1.172 6.828c.653.654 1.528.943 2.828 1.07"/><path d="M14 19c-1.236 0-2.598.5-3.841 1.145c-1.998 1.037-2.997 1.556-3.489 1.225c-.492-.33-.399-1.355-.212-3.404L6.5 17.5"/></g>`
	computingPath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="14" height="14" x="5" y="5" rx="2"/><path d="M8 5V2m8 3V3l1-1m-1 20v-3m-7 3v-3M5 8H2m20 0h-3m3 8h-3M5 16H3l-1 1"/></g>`
	copyPath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M8 4v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7.242a2 2 0 0 0-.602-1.43L16.083 2.57A2 2 0 0 0 14.685 2H10a2 2 0 0 0-2 2Z"/><path d="M16 18v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2"/></g>`
	...
	creditCardAltOnePath        = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="M6 8h2v2H6z"/></g>`
	crossPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M20 20L4 4m16 0L4 20"/>`
	crownPath                   = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m2 8l1.304 1.043a4 4 0 0 0 5.995-1.181L12 3l2.701 4.862a4 4 0 0 0 5.995 1.18L22 8l-1.754 8.77a2.564 2.564 0 0 1-1.367 1.79v0a15.381 15.381 0 0 1-13.758 0v0a2.564 2.564 0 0 1-1.367-1.79L2 8Z"/><path d="M8 15c2.596 1.333 5.404 1.333 8 0"/></g>`
	cssFillPath                 = `<path fill="currentColor" d="M7.502 0h2.578v1.078h-1.5v1.078h1.5v1.078H7.502V0Zm3.093 0h2.579v.938h-1.5v.187h1.5v2.156h-2.579v-.984h1.5v-.188h-1.5V0Zm3.095 0h2.577v.938h-1.5v.187h1.5v2.156H13.69v-.984h1.5v-.188h-1.5V0Z"/><path fill="currentColor" fill-rule="evenodd" d="m11.991 24l-6.944-1.928L3 4.717h18L18.954 22.07L11.991 24ZM7.047 12.573l.191 2.128h7.377l-.247 2.76l-2.374.642h-.002l-2.37-.64l-.152-1.697H7.333l.298 3.342l4.36 1.21l4.367-1.21l.532-5.964l.052-.571l.384-4.309H6.664l.194 2.129h8.136l-.194 2.18H7.047Z" clip-rule="evenodd"/>`
	cursorPath                  = `<path fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" d="m3 3l7 19l2.051-6.154a6 6 0 0 1 3.795-3.795L22 10L3 3Z"/>`
	cutPath                     = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="7" cy="18" r="3"/><path d="M15 15L7 3m2 12l3-4.5M17 3l-3 4.5"/><circle cx="17" cy="18" r="3"/></g>`
	dashboardPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 5a2 2 0 0 1 2-2h6v18H4a2 2 0 0 1-2-2V5Zm12-2h6a2 2 0 0 1 2 2v5h-8V3Zm0 11h8v5a2 2 0 0 1-2 2h-6v-7Z"/>`
	dataPath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><ellipse cx="12" cy="6" rx="8" ry="3"/><path d="M6.037 12C4.77 12.53 4 13.232 4 14c0 1.657 3.582 3 8 3s8-1.343 8-3c0-.768-.77-1.47-2.037-2"/><path d="M4 6v4c0 1.657 3.582 3 8 3s8-1.343 8-3V6M4 14v4c0 1.657 3.582 3 8 3s8-1.343 8-3v-4"/></g>`
	dentalPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.363C9 2.732 3 1.23 3 8.277c0 5.492 1.188 9.756 3.005 12.141c.645.847 2.216.584 2.888-.265a1.22 1.22 0 0 0 .174-.328l1.063-2.8c.654-1.72 3.086-1.72 3.74 0l1.063 2.8c.045.116.097.23.174.328c.672.85 2.243 1.112 2.888.265C19.812 18.033 21 13.77 21 8.277c0-7.046-6-5.545-9-3.914Zm0 0L15 6"/>`
	descendingPath              = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M6 21V3m0 18l3-3.333M6 21l-3-3.333"/><path stroke-miterlimit="5.759" d="M14 3h8l-1 4h-7V3Zm0 7h6l-1 4h-5v-4Zm0 7h4l-1 4h-3v-4Z"/></g>`
	desktopDevicePath           = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6Zm6 14h8"/>`
	devicesPath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M10 15H4V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v2M2 18h12"/><path d="M14 9.2c0-.663.597-1.2 1.333-1.2h5.334C21.403 8 22 8.537 22 9.2v9.6c0 .663-.597 1.2-1.333 1.2h-5.334C14.597 20 14 19.463 14 18.8V9.2Zm4 7.8h.01"/></g>`
	diamondPath                 = `<path fill="none" stroke="currentColor" stroke-width="2" d="M4.511 13.542c-.681-.852-.681-2.232 0-3.084l6.256-7.82c.68-.85 1.785-.85 2.466 0l6.256 7.82c.681.852.681 2.232 0 3.084l-6.256 7.82c-.68.85-1.785.85-2.466 0l-6.256-7.82Z"/>`
	diceFivePath                = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><rect width="18" height="18" x="3" y="3" stroke-linejoin="round" rx="2"/><path d="M8 8h.5m7 0h.5m-4 4h.5m-.25-.25v.5M8 16h.5m7 0h.5M8.25 7.75v.5m0 7.5v.5m7.5-8.5v.5m0 7.5v.5"/></g>`
	diceFourPath                = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><rect width="18" height="18" x="3" y="3" stroke-linejoin="round" rx="2"/><path d="M8 8h.5m7 0h.5m-8 8h.5m7 0h.5M8.25 7.75v.5m0 7.5v.5m7.5-8.5v.5m0 7.5v.5"/></g>`
	diceOnePath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><rect width="18" height="18" x="3" y="3" stroke-linejoin="round" rx="2"/><path d="M12.25 11.75v.5M12 12h.5"/></g>`
	diceSixPath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><rect width="18" height="18" x="3" y="3" stroke-linejoin="round" rx="2"/><path d="M8 8h.5m-.25-.25v.5m0 3.5v.5m0 3.5v.5M15.5 8h.5m-.25-.25v.5m0 3.5v.5m0 3.5v.5M8 12h.5m7 0h.5m-8 4h.5m7 0h.5"/></g>`
	diceThreePath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><rect width="18" height="18" x="3" y="3" stroke-linejoin="round" rx="2"/><path d="M12.25 11.75v.5m-4-4.5v.5m7.5 7.5v.5M8 8h.5m3.5 4h.5m3 4h.5"/></g>`
	diceTwoPath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><rect width="18" height="18" x="3" y="3" stroke-linejoin="round" rx="2"/><path d="M8.25 7.75v.5m7.5 7.5v.5M8 8h.5m7 8h.5"/></g>`
	discordFillPath             = `<path fill="currentColor" d="M20.317 4.492c-1.53-.69-3.17-1.2-4.885-1.49a.075.075 0 0 0-.079.036c-.21.369-.444.85-.608 1.23a18.566 18.566 0 0 0-5.487 0a12.36 12.36 0 0 0-.617-1.23A.077.077 0 0 0 8.562 3c-1.714.29-3.354.8-4.885 1.491a.07.07 0 0 0-.032.027C.533 9.093-.32 13.555.099 17.961a.08.08 0 0 0 .031.055a20.03 20.03 0 0 0 5.993 2.98a.078.078 0 0 0 .084-.026a13.83 13.83 0 0 0 1.226-1.963a.074.074 0 0 0-.041-.104a13.201 13.201 0 0 1-1.872-.878a.075.075 0 0 1-.008-.125c.126-.093.252-.19.372-.287a.075.075 0 0 1 .078-.01c3.927 1.764 8.18 1.764 12.061 0a.075.075 0 0 1 .079.009c.12.098.245.195.372.288a.075.075 0 0 1-.006.125c-.598.344-1.22.635-1.873.877a.075.075 0 0 0-.041.105c.36.687.772 1.341 1.225 1.962a.077.077 0 0 0 .084.028a19.963 19.963 0 0 0 6.002-2.981a.076.076 0 0 0 .032-.054c.5-5.094-.838-9.52-3.549-13.442a.06.06 0 0 0-.031-.028ZM8.02 15.278c-1.182 0-2.157-1.069-2.157-2.38c0-1.312.956-2.38 2.157-2.38c1.21 0 2.176 1.077 2.157 2.38c0 1.312-.956 2.38-2.157 2.38Zm7.975 0c-1.183 0-2.157-1.069-2.157-2.38c0-1.312.955-2.38 2.157-2.38c1.21 0 2.176 1.077 2.157 2.38c0 1.312-.946 2.38-2.157 2.38Z"/>`
	djangoFillPath              = `<path fill="currentColor" fill-rule="evenodd" d="M15.172 0h-4.176v5.932a7.21 7.21 0 0 0-1.816-.2C4.816 5.731 2 8.305 2 12.273c0 4.118 2.655 6.263 7.755 6.268c1.703 0 3.278-.15 5.417-.53V0ZM9.734 8.977c.516 0 .92.05 1.408.2v6.248c-.596.075-.972.1-1.434.1c-2.14 0-3.305-1.142-3.305-3.21c0-2.125 1.22-3.338 3.331-3.338Z" clip-rule="evenodd"/><path fill="currentColor" d="M22 15.233V6.215h-4.17v7.675c0 3.387-.188 4.674-.785 5.786c-.57 1.087-1.462 1.8-3.305 2.606L17.615 24c1.843-.862 2.735-1.643 3.412-2.88c.726-1.288.973-2.782.973-5.887ZM21.584 0H17.41v3.993h4.175V0Z"/>`
	doorPath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M5 2h11a3 3 0 0 1 3 3v14a1 1 0 0 1-1 1h-3"/><path d="m5 2l7.588 1.518A3 3 0 0 1 15 6.459V20.78a1 1 0 0 1-1.196.98l-7.196-1.438A2 2 0 0 1 5 18.36V2Zm7 10v2"/></g>`
	dotGridPath                 = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="4" cy="4" r="1" transform="rotate(90 4 4)"/><circle cx="12" cy="4" r="1" transform="rotate(90 12 4)"/><circle cx="20" cy="4" r="1" transform="rotate(90 20 4)"/><circle cx="4" cy="12" r="1" transform="rotate(90 4 12)"/><circle cx="12" cy="12" r="1" transform="rotate(90 12 12)"/><circle cx="20" cy="12" r="1" transform="rotate(90 20 12)"/><circle cx="4" cy="20" r="1" transform="rotate(90 4 20)"/><circle cx="12" cy="20" r="1" transform="rotate(90 12 20)"/><circle cx="20" cy="20" r="1" transform="rotate(90 20 20)"/></g>`
	dotGridFillPath             = `<path fill="currentColor" fill-rule="evenodd" d="M4 2a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm8 0a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm10 2a2 2 0 1 0-4 0a2 2 0 0 0 4 0ZM4 10a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm10 2a2 2 0 1 0-4 0a2 2 0 0 0 4 0Zm6-2a2 2 0 1 1 0 4a2 2 0 0 1 0-4ZM6 20a2 2 0 1 0-4 0a2 2 0 0 0 4 0Zm6-2a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm10 2a2 2 0 1 0-4 0a2 2 0 0 0 4 0Z" clip-rule="evenodd"/>`
	doubleCheckPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m2 12l5.25 5l2.625-3M8 12l5.25 5L22 7m-6 0l-3.5 4"/>`
	doubleSwordPath             = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M2 19.2L3.8 21m.9-7.2l.9 3.6m0 0l3.6.9m-3.6-.9l-2.7 2.7M16.4 3.9l-9 9l.45 2.25l2.25.45l9-9L20 3l-3.6.9Z"/><path d="M22 19.2L20.2 21m-.9-7.2l-.9 3.6m0 0l2.7 2.7m-2.7-2.7l-1.8.45l-1.8.45M9.3 11L4.9 6.6L4 3l3.6.9L12 8.3m.1 5.5l1.8 1.8l2.25-.45l.45-2.25l-1.8-1.8"/></g>`
	downloadPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15V3m0 12l-4-4m4 4l4-4M2 17l.621 2.485A2 2 0 0 0 4.561 21h14.878a2 2 0 0 0 1.94-1.515L22 17"/>`
	draftPath                   = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M13.5 6v4H16m-1.315-8H10a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7.242a2 2 0 0 0-.602-1.43L16.083 2.57A2 2 0 0 0 14.685 2Z"/><path d="M16 18v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2"/></g>`
	dragHorizontalPath          = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="20" cy="8" r="1" transform="rotate(-180 20 8)"/><circle cx="20" cy="16" r="1" transform="rotate(-180 20 16)"/><circle cx="12" cy="8" r="1" transform="rotate(-180 12 8)"/><circle cx="12" cy="16" r="1" transform="rotate(-180 12 16)"/><circle cx="4" cy="8" r="1" transform="rotate(-180 4 8)"/><circle cx="4" cy="16" r="1" transform="rotate(-180 4 16)"/></g>`
	dragHorizontalFillPath      = `<path fill="currentColor" fill-rule="evenodd" d="M22 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0Zm0 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0Zm-8 0a2 2 0 1 1-4 0a2 2 0 0 1 4 0ZM6 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0Zm0 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0Zm8-8a2 2 0 1 1-4 0a2 2 0 0 1 4 0Z" clip-rule="evenodd"/>`
	dragVerticalPath            = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="8" cy="4" r="1" transform="rotate(90 8 4)"/><circle cx="16" cy="4" r="1" transform="rotate(90 16 4)"/><circle cx="8" cy="12" r="1" transform="rotate(90 8 12)"/><circle cx="16" cy="12" r="1" transform="rotate(90 16 12)"/><circle cx="8" cy="20" r="1" transform="rotate(90 8 20)"/><circle cx="16" cy="20" r="1" transform="rotate(90 16 20)"/></g>`
	dragVerticalFillPath        = `<path fill="currentColor" fill-rule="evenodd" d="M16 2a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm0 8a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm-8 8a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm8 0a2 2 0 1 1 0 4a2 2 0 0 1 0-4ZM8 2a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm0 8a2 2 0 1 1 0 4a2 2 0 0 1 0-4Z" clip-rule="evenodd"/>`
	dribbbleFillPath            = `<g fill="none"><g clip-path="url(#akarIconsDribbbleFill0)"><path fill="currentColor" fill-rule="evenodd" d="M12 0C5.375 0 0 5.375 0 12s5.375 12 12 12c6.612 0 12-5.375 12-12S18.612 0 12 0Zm7.926 5.531a10.202 10.202 0 0 1 2.317 6.378c-.338-.065-3.722-.755-7.132-.325c-.079-.17-.144-.352-.222-.534a30.53 30.53 0 0 0-.676-1.484c3.774-1.536 5.492-3.748 5.713-4.035ZM12 1.771c2.603 0 4.985.975 6.794 2.576c-.182.26-1.731 2.33-5.375 3.696c-1.68-3.084-3.54-5.61-3.827-6A10.424 10.424 0 0 1 12 1.77Zm-4.36.962c.273.365 2.095 2.903 3.8 5.922c-4.79 1.276-9.02 1.25-9.475 1.25c.664-3.176 2.812-5.818 5.675-7.172Zm-5.896 9.28v-.312c.443.013 5.414.078 10.53-1.458c.299.573.572 1.158.832 1.744c-.13.039-.273.078-.403.117c-5.284 1.705-8.096 6.364-8.33 6.755a10.226 10.226 0 0 1-2.629-6.846ZM12 22.256a10.18 10.18 0 0 1-6.286-2.16c.182-.378 2.264-4.387 8.043-6.404c.026-.013.04-.013.065-.026c1.445 3.735 2.03 6.872 2.187 7.77c-1.237.534-2.59.82-4.009.82Zm5.714-1.757c-.104-.625-.651-3.618-1.992-7.302c3.215-.507 6.026.326 6.378.443c-.443 2.85-2.083 5.31-4.386 6.859Z" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsDribbbleFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	dropboxFillPath             = `<path fill="currentColor" d="m6 2l6 3.75L6 9.5L0 5.75L6 2Zm12 0l6 3.75l-6 3.75l-6-3.75L18 2ZM0 13.25L6 9.5l6 3.75L6 17l-6-3.75ZM18 9.5l6 3.75L18 17l-6-3.75l6-3.75ZM6 18.25l6-3.75l6 3.75L12 22l-6-3.75Z"/>`
	editPath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m16.474 5.408l2.118 2.117m-.756-3.982L12.109 9.27a2.118 2.118 0 0 0-.58 1.082L11 13l2.648-.53c.41-.082.786-.283 1.082-.579l5.727-5.727a1.853 1.853 0 1 0-2.621-2.621Z"/><path d="M19 15v3a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h3"/></g>`
	enlargePath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.5 9.5L21 3m0 0h-6m6 0v6M3 21l6.5-6.5M3 21v-6m0 6h6"/>`
	envelopePath                = `<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><path stroke-linecap="round" d="M2 6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6Z"/><path d="m2 8l7.501 6.001a4 4 0 0 0 4.998 0L22 8"/></g>`
	equalPath                   = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" d="M16 14H8m8-4H8"/><circle cx="12" cy="12" r="10"/></g>`
	equalFillPath               = `<path fill="currentColor" fill-rule="evenodd" d="M1 12C1 5.925 5.925 1 12 1s11 4.925 11 11s-4.925 11-11 11S1 18.075 1 12Zm6 2a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2H8a1 1 0 0 1-1-1Zm1-5a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2H8Z" clip-rule="evenodd"/>`
	eyePath                     = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M21.257 10.962c.474.62.474 1.457 0 2.076C19.764 14.987 16.182 19 12 19c-4.182 0-7.764-4.013-9.257-5.962a1.692 1.692 0 0 1 0-2.076C4.236 9.013 7.818 5 12 5c4.182 0 7.764 4.013 9.257 5.962Z"/><circle cx="12" cy="12" r="3"/></g>`
	eyeClosedPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 10s3.5 4 10 4s10-4 10-4M4 11.645L2 14m20 0l-1.996-2.352M8.914 13.68L8 16.5m7.063-2.812L16 16.5"/>`
	eyeOpenPath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M21.257 10.962c.474.62.474 1.457 0 2.076C19.764 14.987 16.182 19 12 19c-4.182 0-7.764-4.013-9.257-5.962a1.692 1.692 0 0 1 0-2.076C4.236 9.013 7.818 5 12 5c4.182 0 7.764 4.013 9.257 5.962Z"/><circle cx="12" cy="12" r="3"/></g>`
	eyeSlashedPath              = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M6.873 17.129c-1.845-1.31-3.305-3.014-4.13-4.09a1.693 1.693 0 0 1 0-2.077C4.236 9.013 7.818 5 12 5c1.876 0 3.63.807 5.13 1.874"/><path d="M14.13 9.887a3 3 0 1 0-4.243 4.242M4 20L20 4M10 18.704A7.124 7.124 0 0 0 12 19c4.182 0 7.764-4.013 9.257-5.962a1.694 1.694 0 0 0-.001-2.078A22.939 22.939 0 0 0 19.57 9"/></g>`
	faceHappyPath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 9.05v-.1m8 .1v-.1"/><path stroke-linejoin="round" d="M16 14c-.5 1.5-1.79 3-4 3s-3.5-1.5-4-3"/></g>`
	faceNeutralPath             = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 9.05v-.1m8 .1v-.1M8 14h8"/></g>`
	faceSadPath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 9.05v-.1m8 .1v-.1"/><path stroke-linejoin="round" d="M16 16c-.5-1.5-1.79-3-4-3s-3.5 1.5-4 3"/></g>`
	faceVeryHappyPath           = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 9.05v-.1m8 .1v-.1"/><path stroke-linejoin="round" d="M12 18a4 4 0 0 0 4-4H8a4 4 0 0 0 4 4Z"/></g>`
	faceVerySadPath             = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 9.05v-.1m8 .1v-.1"/><path stroke-linejoin="round" d="M12 13a4 4 0 0 1 4 4H8a4 4 0 0 1 4-4Z"/></g>`
	faceWinkPath                = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M7 9h2m7 .05v-.1"/><path stroke-linejoin="round" d="M16 15c-.5 1-1.79 2-4 2s-3.5-1-4-2"/></g>`
	facebookFillPath            = `<g fill="none"><g clip-path="url(#akarIconsFacebookFill0)"><path fill="currentColor" fill-rule="evenodd" d="M0 12.067C0 18.033 4.333 22.994 10 24v-8.667H7V12h3V9.333c0-3 1.933-4.666 4.667-4.666c.866 0 1.8.133 2.666.266V8H15.8c-1.467 0-1.8.733-1.8 1.667V12h3.2l-.533 3.333H14V24c5.667-1.006 10-5.966 10-11.933C24 5.43 18.6 0 12 0S0 5.43 0 12.067Z" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsFacebookFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	figmaFillPath               = `<g fill="none"><g clip-path="url(#akarIconsFigmaFill0)"><path fill="currentColor" fill-rule="evenodd" d="M8.415 0C5.968 0 4 2.053 4 4.568c0 1.529.728 2.887 1.847 3.716A4.613 4.613 0 0 0 4 12c0 1.53.728 2.887 1.847 3.716A4.613 4.613 0 0 0 4 19.432C4 21.947 5.968 24 8.415 24c2.446 0 4.415-2.053 4.415-4.568V15.57a4.307 4.307 0 0 0 2.755.999C18.032 16.568 20 14.515 20 12a4.61 4.61 0 0 0-1.847-3.716A4.613 4.613 0 0 0 20 4.568C20 2.053 18.032 0 15.585 0h-7.17ZM5.659 4.568c0-1.591 1.242-2.865 2.756-2.865h2.755v5.73H8.415c-1.514 0-2.756-1.275-2.756-2.865Zm9.926 2.864H12.83v-5.73h2.755c1.515 0 2.756 1.275 2.756 2.866c0 1.59-1.241 2.864-2.756 2.864ZM5.66 12c0-1.59 1.242-2.865 2.756-2.865h2.755v5.73H8.415C6.9 14.865 5.659 13.59 5.659 12Zm7.17 0c0-1.59 1.242-2.865 2.756-2.865c1.515 0 2.756 1.274 2.756 2.865c0 1.59-1.241 2.865-2.756 2.865c-1.514 0-2.755-1.274-2.755-2.865Zm-7.17 7.432c0-1.59 1.242-2.864 2.756-2.864h2.755v2.864c0 1.591-1.24 2.865-2.755 2.865c-1.514 0-2.756-1.274-2.756-2.865Z" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsFigmaFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	filePath                    = `<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><path stroke-linecap="round" d="M4 4v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8.342a2 2 0 0 0-.602-1.43l-4.44-4.342A2 2 0 0 0 13.56 2H6a2 2 0 0 0-2 2Zm5 9h6m-6 4h3"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/></g>`
	filterPath                  = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><ellipse cx="12" cy="5" rx="9" ry="2"/><path d="M3 5c0 2.23 3.871 6.674 5.856 8.805A4.197 4.197 0 0 1 10 16.657V19a2 2 0 0 0 2 2v0a2 2 0 0 0 2-2v-2.343c0-1.061.421-2.075 1.144-2.852C17.13 11.674 21 7.231 21 5"/></g>`
	firePath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 22c-4.97 0-9-2.582-9-7v-.088C3 12.794 4.338 11.1 6.375 10c1.949-1.052 3.101-2.99 2.813-5l-.563-3l2.086.795c3.757 1.43 6.886 3.912 8.914 7.066A8.495 8.495 0 0 1 21 14.464V15c0 1.562-.504 2.895-1.375 3.965"/><path d="M12 22c-1.657 0-3-1.433-3-3.2c0-1.4 1.016-2.521 1.91-3.548L12 14l1.09 1.252C13.984 16.28 15 17.4 15 18.8c0 1.767-1.343 3.2-3 3.2Z"/></g>`
	flagPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 15h13.865a1 1 0 0 0 .768-1.64L15 9l3.633-4.36A1 1 0 0 0 17.865 3H4v18"/>`
	flashlightPath              = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M5 4v1c0 1.636 2 4 3 5l.75 9.01A3.26 3.26 0 0 0 12 22v0a3.26 3.26 0 0 0 3.25-2.99L16 10c1-1 3-3.364 3-5V4m-7 7v2"/><ellipse cx="12" cy="4" rx="7" ry="2"/></g>`
	folderPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M22 19V9a2 2 0 0 0-2-2h-6.764a2 2 0 0 1-1.789-1.106l-.894-1.788A2 2 0 0 0 8.763 3H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2Z"/>`
	folderAddPath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path stroke-linejoin="round" d="M22 19V9a2 2 0 0 0-2-2h-6.764a2 2 0 0 1-1.789-1.106l-.894-1.788A2 2 0 0 0 8.763 3H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2Z"/><path d="M12 11v3m0 0v3m0-3h3m-3 0H9"/></g>`
	forkLeftPath                = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 3v18m0-18l-4 4m4-4l4 4M8 10l-4 4l4 4"/><path d="M15 21a7 7 0 0 0-7-7H4"/></g>`
	forkRightPath               = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3v18M9 3l4 4M9 3L5 7m11 3l4 4l-4 4"/><path d="M9 21a7 7 0 0 1 7-7h4"/></g>`
	framePath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 3v18M18 3v18M3 6h18M3 18h18"/>`
	fullScreenPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 7V2h5m15 5V2h-5M7 22H2v-5m15 5h5v-5"/>`
	gameControllerPath          = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m9 15l-2.968 2.968A2.362 2.362 0 0 1 2 16.298V15l1.357-6.784A4 4 0 0 1 7.279 5h9.442a4 4 0 0 1 3.922 3.216L22 15v1.297a2.362 2.362 0 0 1-4.032 1.67L15 15H9Z"/><path d="m9 5l1 2h4l1-2"/></g>`
	gatsbyFillPath              = `<g fill="none"><g clip-path="url(#akarIconsGatsbyFill0)"><path fill="currentColor" d="M12 0C5.323 0 0 5.317 0 12s5.317 12 12 12s12-5.323 12-12S18.683 0 12 0ZM2.608 12.101l9.29 9.286c-5.114.005-9.29-4.171-9.29-9.286Zm11.477 9.083L2.821 9.909C3.76 5.733 7.515 2.603 12 2.603a9.493 9.493 0 0 1 7.616 3.861l-1.355 1.147A7.666 7.666 0 0 0 11.9 4.267A7.57 7.57 0 0 0 4.693 9.38l9.814 9.819c2.4-.837 4.277-2.923 4.8-5.43h-4.07V12h6.155c0 4.485-3.13 8.245-7.307 9.184Z"/></g><defs><clipPath id="akarIconsGatsbyFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	gearPath                    = `<g fill="none" stroke="currentColor" stroke-width="2"><path d="M14 3.269C14 2.568 13.432 2 12.731 2H11.27C10.568 2 10 2.568 10 3.269c0 .578-.396 1.074-.935 1.286c-.085.034-.17.07-.253.106c-.531.23-1.162.16-1.572-.249a1.269 1.269 0 0 0-1.794 0L4.412 5.446a1.269 1.269 0 0 0 0 1.794c.41.41.48 1.04.248 1.572a7.946 7.946 0 0 0-.105.253c-.212.539-.708.935-1.286.935C2.568 10 2 10.568 2 11.269v1.462C2 13.432 2.568 14 3.269 14c.578 0 1.074.396 1.286.935c.034.085.07.17.105.253c.231.531.161 1.162-.248 1.572a1.269 1.269 0 0 0 0 1.794l1.034 1.034a1.269 1.269 0 0 0 1.794 0c.41-.41 1.04-.48 1.572-.249c.083.037.168.072.253.106c.539.212.935.708.935 1.286c0 .701.568 1.269 1.269 1.269h1.462c.701 0 1.269-.568 1.269-1.269c0-.578.396-1.074.935-1.287c.085-.033.17-.068.253-.104c.531-.232 1.162-.161 1.571.248a1.269 1.269 0 0 0 1.795 0l1.034-1.034a1.269 1.269 0 0 0 0-1.794c-.41-.41-.48-1.04-.249-1.572c.037-.083.072-.168.106-.253c.212-.539.708-.935 1.286-.935c.701 0 1.269-.568 1.269-1.269V11.27c0-.701-.568-1.269-1.269-1.269c-.578 0-1.074-.396-1.287-.935a7.755 7.755 0 0 0-.105-.253c-.23-.531-.16-1.162.249-1.572a1.269 1.269 0 0 0 0-1.794l-1.034-1.034a1.269 1.269 0 0 0-1.794 0c-.41.41-1.04.48-1.572.249a7.913 7.913 0 0 0-.253-.106C14.396 4.343 14 3.847 14 3.27Z"/><path d="M16 12a4 4 0 1 1-8 0a4 4 0 0 1 8 0Z"/></g>`
	giftPath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="18" height="14" x="3" y="8" rx="2"/><path d="M12 5a3 3 0 1 0-3 3m6 0a3 3 0 1 0-3-3m0 0v17m9-7H3"/></g>`
	githubFillPath              = `<g fill="none"><g clip-path="url(#akarIconsGithubFill0)"><path fill="currentColor" fill-rule="evenodd" d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385c.6.105.825-.255.825-.57c0-.285-.015-1.23-.015-2.235c-3.015.555-3.795-.735-4.035-1.41c-.135-.345-.72-1.41-1.23-1.695c-.42-.225-1.02-.78-.015-.795c.945-.015 1.62.87 1.845 1.23c1.08 1.815 2.805 1.305 3.495.99c.105-.78.42-1.305.765-1.605c-2.67-.3-5.46-1.335-5.46-5.925c0-1.305.465-2.385 1.23-3.225c-.12-.3-.54-1.53.12-3.18c0 0 1.005-.315 3.3 1.23c.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23c.66 1.65.24 2.88.12 3.18c.765.84 1.23 1.905 1.23 3.225c0 4.605-2.805 5.625-5.475 5.925c.435.375.81 1.095.81 2.22c0 1.605-.015 2.895-.015 3.3c0 .315.225.69.825.57A12.02 12.02 0 0 0 24 12c0-6.63-5.37-12-12-12Z" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsGithubFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	githubOutlineFillPath       = `<path fill="currentColor" fill-rule="evenodd" d="M12 1.545c-6.055 0-10.957 4.877-10.957 10.883c0 4.41 2.643 8.205 6.447 9.912c.398.179.787.108 1.091-.12a1.38 1.38 0 0 0 .532-1.107v-.57l-1.357-.184a.489.489 0 0 1-.03-.005c-.748-.146-1.253-.409-1.623-.788c-.311-.319-.501-.701-.662-1.025l-.056-.113a11.645 11.645 0 0 0-.487-.91c-.135-.214-.24-.324-.344-.393c-.264-.175-.518-.472-.518-.843a.72.72 0 0 1 .26-.56a.844.844 0 0 1 .546-.182c.222 0 .431.068.605.146c.178.08.355.186.52.296c.402.268.798.585 1.133.976c.349.406.596.664.968.717c.306.044.618.045.861.034a2.558 2.558 0 0 1 .166-.56a8.347 8.347 0 0 1-.877-.256c-.654-.232-1.383-.593-1.873-1.14c-.538-.602-.871-1.139-1.057-1.767c-.181-.612-.211-1.275-.211-2.091c0-1.25.541-2.303.947-2.862a8.655 8.655 0 0 1-.335-1.501a3.515 3.515 0 0 1 .001-.968c.05-.293.175-.653.504-.87c.317-.211.689-.202.979-.148c.301.057.614.182.902.325c.469.232.935.542 1.284.805c.602-.177 1.667-.405 2.63-.426h.022c.964.021 1.981.249 2.568.425c.35-.262.815-.573 1.283-.804c.288-.143.6-.268.902-.325c.29-.054.662-.063.98.147c.328.218.454.578.503.871c.051.305.039.646 0 .968a8.661 8.661 0 0 1-.334 1.501c.406.56.947 1.613.947 2.862c0 .816-.03 1.479-.21 2.09c-.187.63-.52 1.166-1.058 1.768c-.49.547-1.219.908-1.873 1.14a8.45 8.45 0 0 1-1.062.297c.123.372.167.673.167.846v3.09c0 .47.219.871.53 1.105c.302.229.69.3 1.088.126c3.84-1.692 6.514-5.497 6.514-9.93c0-6.005-4.9-10.882-10.956-10.882ZM9.476 18.71c-.26.037-.001 0-.001 0h-.003l-.008.002l-.029.004a6.523 6.523 0 0 1-.447.037a5.782 5.782 0 0 1-1.066-.043c-.791-.112-1.272-.672-1.583-1.036l-.03-.034a3.6 3.6 0 0 0-.327-.333c.103.19.21.402.325.63l.01.02l.051.104c.175.348.29.58.481.774c.186.19.476.374 1.062.49l1.794.243a.522.522 0 0 1 .452.518v1.027c0 .8-.375 1.513-.95 1.945a2.087 2.087 0 0 1-2.143.236C2.902 21.427 0 17.27 0 12.428C0 5.836 5.377.5 12 .5s12 5.336 12 11.928c0 4.867-2.939 9.035-7.137 10.886a2.09 2.09 0 0 1-2.137-.247a2.426 2.426 0 0 1-.946-1.942v-3.09c0-.07-.049-.474-.322-1.017a.524.524 0 0 1 .408-.755a7.187 7.187 0 0 0 1.504-.356c.594-.21 1.127-.498 1.444-.852c.471-.526.706-.93.835-1.367c.134-.453.168-.98.168-1.793c0-1.141-.6-2.1-.876-2.409a.523.523 0 0 1-.104-.523a7.82 7.82 0 0 0 .375-1.554c.032-.275.034-.505.006-.671a.457.457 0 0 0-.054-.173a.486.486 0 0 0-.207.009c-.17.032-.387.112-.633.234c-.49.242-1 .6-1.316.856a.52.52 0 0 1-.505.085A9.306 9.306 0 0 0 12 7.296c-1.007.024-2.169.31-2.566.453a.52.52 0 0 1-.505-.085a7.775 7.775 0 0 0-1.316-.856a2.607 2.607 0 0 0-.634-.234a.486.486 0 0 0-.206-.009a.456.456 0 0 0-.054.173c-.028.166-.026.396.006.671A7.89 7.89 0 0 0 7.1 8.963c.063.18.024.38-.104.523c-.276.309-.876 1.268-.876 2.409c0 .812.034 1.34.168 1.793c.13.437.364.84.834 1.367c.318.354.85.642 1.445.852a7.194 7.194 0 0 0 1.503.356a.522.522 0 0 1 .246.945c-.165.118-.274.33-.335.575a1.944 1.944 0 0 0-.056.385v.019a.523.523 0 0 1-.449.523Z" clip-rule="evenodd"/>`
	glassesPath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="6" cy="14" r="4"/><circle cx="18" cy="14" r="4"/><path d="m10 14l.211-.106a4 4 0 0 1 3.578 0L14 14m5-8l2.838 6.623a2 2 0 0 1 .162.788V14M5 6l-2.838 6.623A2 2 0 0 0 2 13.41V14"/></g>`
	globePath                   = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(90 12 12)"/><path d="M2 12h20"/></g>`
	googleContainedFillPath     = `<g fill="none"><g clip-path="url(#akarIconsGoogleContainedFill0)"><path fill="currentColor" fill-rule="evenodd" d="M12 0C5.372 0 0 5.373 0 12s5.372 12 12 12c6.627 0 12-5.373 12-12S18.627 0 12 0Zm.14 19.018c-3.868 0-7-3.14-7-7.018c0-3.878 3.132-7.018 7-7.018c1.89 0 3.47.697 4.682 1.829l-1.974 1.978v-.004c-.735-.702-1.667-1.062-2.708-1.062c-2.31 0-4.187 1.956-4.187 4.273c0 2.315 1.877 4.277 4.187 4.277c2.096 0 3.522-1.202 3.816-2.852H12.14v-2.737h6.585c.088.47.135.96.135 1.474c0 4.01-2.677 6.86-6.72 6.86Z" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsGoogleContainedFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	googleFillPath              = `<path fill="currentColor" d="M21.456 10.154c.123.659.19 1.348.19 2.067c0 5.624-3.764 9.623-9.449 9.623A9.841 9.841 0 0 1 2.353 12a9.841 9.841 0 0 1 9.844-9.844c2.658 0 4.879.978 6.583 2.566l-2.775 2.775V7.49c-1.033-.984-2.344-1.489-3.808-1.489c-3.248 0-5.888 2.744-5.888 5.993c0 3.248 2.64 5.998 5.888 5.998c2.947 0 4.953-1.685 5.365-3.999h-5.365v-3.839h9.26Z"/>`
	graphqlFillPath             = `<g fill="none"><g clip-path="url(#akarIconsGraphqlFill0)"><path fill="currentColor" fill-rule="evenodd" d="M11.384 4.187a2.132 2.132 0 0 0 1.171.018l6.326 11.182a2.126 2.126 0 0 0-.593 1.038H5.71a2.148 2.148 0 0 0-.64-1.079l6.313-11.159Zm-.921-.565c.018.02.038.039.057.058L4.193 14.865a2.11 2.11 0 0 0-.09-.022V9.156A2.122 2.122 0 0 0 5.481 8.14a2.142 2.142 0 0 0 .19-1.694l4.792-2.823Zm3.57-.835a2.134 2.134 0 1 0-4.079-.04L5.159 5.573A2.131 2.131 0 0 0 1.785 6a2.146 2.146 0 0 0 1.322 3.143v5.715A2.147 2.147 0 0 0 1.79 18a2.13 2.13 0 0 0 3.368.43l4.795 2.826a2.151 2.151 0 0 0-.086.605A2.134 2.134 0 0 0 12 24a2.138 2.138 0 0 0 2.012-2.848l4.751-2.8a2.128 2.128 0 0 0 3.44-.352a2.138 2.138 0 0 0-1.384-3.159v-5.68A2.147 2.147 0 0 0 22.215 6a2.133 2.133 0 0 0-3.401-.398l-4.78-2.816Zm-.599.937l.075-.072l4.808 2.833a2.142 2.142 0 0 0 .203 1.654a2.12 2.12 0 0 0 1.303 1v5.72a2.074 2.074 0 0 0-.078.023L13.434 3.724Zm4.895 13.858l-4.774 2.814a2.124 2.124 0 0 0-1.554-.674c-.606 0-1.152.252-1.54.658l-4.785-2.82c.012-.039.023-.078.032-.118H18.29c.012.047.025.094.04.14Z" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsGraphqlFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	gridPath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/></g>`
	hammerPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 22l-2-2l1-1l2 2l-1 1Zm5-9l2 2m1-3l-8 8M20 4l-1 1M9.707 7.707a1 1 0 0 1 0-1.414l4.086-4.086a1 1 0 0 1 1.414 0l6.586 6.586a1 1 0 0 1 0 1.414l-4.086 4.086a1 1 0 0 1-1.414 0L9.707 7.707Z"/>`
	...
	octagonFillPath             = `<path fill="currentColor" d="M11.235 1.317a2 2 0 0 1 1.53 0l6.248 2.588a2 2 0 0 1 1.082 1.082l2.588 6.248a2 2 0 0 1 0 1.53l-2.588 6.248a2 2 0 0 1-1.082 1.082l-6.248 2.588a2 2 0 0 1-1.53 0l-6.248-2.588a2 2 0 0 1-1.082-1.082l-2.588-6.248a2 2 0 0 1 0-1.53l2.588-6.248a2 2 0 0 1 1.082-1.082l6.248-2.588Z"/>`
	octocatFillPath             = `<path fill="currentColor" d="M8.422 20.081c0 .896.01 1.753.016 2.285a.617.617 0 0 0 .422.58c2.078.686 4.317.718 6.414.091l.292-.087a.67.67 0 0 0 .478-.638c.005-.733.017-2.017.017-3.53c0-1.372-.477-2.25-1.031-2.707c3.399-.366 6.97-1.61 6.97-7.227c0-1.61-.592-2.91-1.566-3.934c.153-.366.688-1.866-.153-3.878c0 0-1.28-.403-4.201 1.5a14.76 14.76 0 0 0-3.82-.494c-1.298 0-2.597.165-3.819.494C5.52.65 4.24 1.036 4.24 1.036c-.84 2.012-.306 3.512-.153 3.878a5.565 5.565 0 0 0-1.566 3.934c0 5.598 3.552 6.86 6.951 7.227c-.439.366-.84 1.006-.973 1.957c-.879.384-3.075 1.006-4.45-1.207c-.286-.44-1.146-1.519-2.349-1.5c-1.28.018-.516.695.02.97c.648.347 1.393 1.646 1.565 2.067c.306.823 1.299 2.396 5.137 1.72Z"/>`
	openEnvelopePath            = `<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><path stroke-linecap="round" d="M2 11.083a4 4 0 0 1 1.706-3.277l6-4.2a4 4 0 0 1 4.588 0l6 4.2A4 4 0 0 1 22 11.083V19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-7.917Z"/><path d="m2.5 9.5l7.001 5.501a4 4 0 0 0 4.998 0L21.5 9.5"/></g>`
	ovalPath                    = `<ellipse cx="12" cy="12" fill="none" stroke="currentColor" stroke-width="2" rx="8" ry="10"/>`
	panelBottomPath             = `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="18" x="2" y="3" stroke-linecap="round" stroke-linejoin="round" rx="2"/><path d="M22 15H2"/></g>`
	panelLeftPath               = `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="18" x="2" y="3" stroke-linecap="round" stroke-linejoin="round" rx="2"/><path d="M9 3v18"/></g>`
	panelRightPath              = `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="18" x="2" y="3" stroke-linecap="round" stroke-linejoin="round" rx="2"/><path d="M15 3v18"/></g>`
	panelSplitPath              = `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="18" x="2" y="3" stroke-linecap="round" stroke-linejoin="round" rx="2"/><path d="M9 3v18m13-9H9"/></g>`
	panelSplitColumnPath        = `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="18" x="2" y="3" stroke-linecap="round" stroke-linejoin="round" rx="2"/><path d="M22 12H2"/></g>`
	panelSplitRowPath           = `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="18" x="2" y="3" stroke-linecap="round" stroke-linejoin="round" rx="2"/><path d="M12 3v18"/></g>`
	panelTopPath                = `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="18" x="2" y="3" stroke-linecap="round" stroke-linejoin="round" rx="2"/><path d="M22 9H2"/></g>`
	paperPath                   = `<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><path stroke-linecap="round" d="M4 4v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8.342a2 2 0 0 0-.602-1.43l-4.44-4.342A2 2 0 0 0 13.56 2H6a2 2 0 0 0-2 2Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/></g>`
	...
	parallelogramPath           = `<path fill="none" stroke="currentColor" stroke-width="2" d="M5.586 6.45A2 2 0 0 1 7.509 5h11.84a2 2 0 0 1 1.923 2.55l-2.858 10A2 2 0 0 1 16.491 19H4.651a2 2 0 0 1-1.923-2.55l2.858-10Z"/>`
	pausePath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 5v14M17 5v14"/>`
	pencilPath                  = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4.333 16.048L16.57 3.81a2.56 2.56 0 0 1 3.62 3.619L7.951 19.667a2 2 0 0 1-1.022.547L3 21l.786-3.93a2 2 0 0 1 .547-1.022Z"/><path d="m14.5 6.5l3 3"/></g>`
	pentagonPath                = `<path fill="none" stroke="currentColor" stroke-width="2" d="M10.75 3a2 2 0 0 1 2.5 0l7.63 6.103a2 2 0 0 1 .63 2.246l-3.031 8.334A2 2 0 0 1 16.599 21H7.401a2 2 0 0 1-1.88-1.317l-3.03-8.334a2 2 0 0 1 .63-2.246L10.75 3Z"/>`
	pentagonFillPath            = `<path fill="currentColor" fill-rule="evenodd" d="M10.126 2.219a3 3 0 0 1 3.748 0l7.63 6.104a3 3 0 0 1 .945 3.367l-3.03 8.335A3 3 0 0 1 16.599 22H7.401a3 3 0 0 1-2.82-1.975l-3.03-8.334a3 3 0 0 1 .945-3.368l7.63-6.104Z" clip-rule="evenodd"/>`
	peopleGroupPath             = `<g fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m16.719 19.752l-.64-5.124A3 3 0 0 0 13.101 12h-2.204a3 3 0 0 0-2.976 2.628l-.641 5.124A2 2 0 0 0 9.266 22h5.468a2 2 0 0 0 1.985-2.248Z"/><circle cx="12" cy="5" r="3"/><circle cx="4" cy="9" r="2"/><circle cx="20" cy="9" r="2"/><path stroke-linecap="round" stroke-linejoin="round" d="M4 14h-.306a2 2 0 0 0-1.973 1.671l-.333 2A2 2 0 0 0 3.361 20H7m13-6h.306a2 2 0 0 1 1.973 1.671l.333 2A2 2 0 0 1 20.639 20H17"/></g>`
	peopleMultiplePath          = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="7" cy="5" r="3"/><path stroke-linecap="round" stroke-linejoin="round" d="M10 12H5.898a3 3 0 0 0-2.976 2.628l-.641 5.124A2 2 0 0 0 4.266 22H9m12.719-2.248l-.64-5.124A3 3 0 0 0 18.101 12h-2.204a3 3 0 0 0-2.976 2.628l-.641 5.124A2 2 0 0 0 14.266 22h5.468a2 2 0 0 0 1.985-2.248Z"/><circle cx="17" cy="5" r="3"/></g>`
	percentagePath              = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M5 19L19 5"/><circle cx="7" cy="7" r="3"/><circle cx="17" cy="17" r="3"/></g>`
	personPath                  = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="7" r="5"/><path stroke-linecap="round" stroke-linejoin="round" d="M17 14h.352a3 3 0 0 1 2.976 2.628l.391 3.124A2 2 0 0 1 18.734 22H5.266a2 2 0 0 1-1.985-2.248l.39-3.124A3 3 0 0 1 6.649 14H7"/></g>`
	personAddPath               = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="7" r="5"/><path stroke-linecap="round" stroke-linejoin="round" d="M17 22H5.266a2 2 0 0 1-1.985-2.248l.39-3.124A3 3 0 0 1 6.649 14H7m12-1v6m-3-3h6"/></g>`
	personCheckPath             = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="7" r="5"/><path stroke-linecap="round" stroke-linejoin="round" d="M17 22H5.266a2 2 0 0 1-1.985-2.248l.39-3.124A3 3 0 0 1 6.649 14H7m9 2l2.25 2L22 14"/></g>`
	personCrossPath             = `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="7" r="5"/><path stroke-linecap="round" stroke-linejoin="round" d="M17 22H5.266a2 2 0 0 1-1.985-2.248l.39-3.124A3 3 0 0 1 6.649 14H7"/><path stroke-linecap="round" d="m22 19l-5-5m5 0l-5 5"/></g>`
	...
	phpFillPath                 = `<path fill="currentColor" d="M12 5.5C5.271 5.5 0 8.355 0 12s5.271 6.5 12 6.5s12-2.855 12-6.5s-5.271-6.5-12-6.5Zm-1.246 2h1.31l-.416 2h1.17c.742 0 1.24.104 1.524.363c.277.256.361.676.25 1.248l-.52 2.389H12.74l.479-2.209c.058-.303.035-.514-.067-.625c-.101-.111-.324-.166-.658-.166h-1.049l-.633 3H9.5l1.254-6ZM5 9.5h2.666c1.271 0 2.041.852 1.74 2.123C9.056 13.1 8.12 13.5 6.396 13.5h-.824L5.311 15H3.986L5 9.5Zm10.5 0h2.666c1.271 0 2.041.852 1.74 2.123c-.35 1.477-1.287 1.877-3.01 1.877h-.824l-.261 1.5h-1.325L15.5 9.5Zm-9.365 1l-.377 2h.855c.74 0 1.428-.084 1.543-1.188c.043-.427-.135-.812-.99-.812H6.135Zm10.5 0l-.377 2h.855c.74 0 1.428-.084 1.543-1.188c.043-.427-.134-.812-.99-.812h-1.031Z"/>`
	...
	searchPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m21 21l-4.486-4.494M19 10.5a8.5 8.5 0 1 1-17 0a8.5 8.5 0 0 1 17 0Z"/>`
	sendPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.912 12H4L2.023 4.135A.662.662 0 0 1 2 3.995c-.022-.721.772-1.221 1.46-.891L22 12L3.46 20.896c-.68.327-1.464-.159-1.46-.867a.66.66 0 0 1 .033-.186L3.5 15"/>`
	settingsHorizontalPath      = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="M3 5h4m14 0H11m-8 7h12m6 0h-2M3 19h2m16 0H9"/><circle cx="9" cy="5" r="2"/><circle cx="17" cy="12" r="2"/><circle cx="7" cy="19" r="2"/></g>`
	settingsVerticalPath        = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="M19 3v4m0 14V11m-7-8v12m0 6v-2M5 3v2m0 16V9"/><circle cx="19" cy="9" r="2" transform="rotate(90 19 9)"/><circle cx="12" cy="17" r="2" transform="rotate(90 12 17)"/><circle cx="5" cy="7" r="2" transform="rotate(90 5 7)"/></g>`
	shareArrowPath              = `<g fill="none"><path d="M22 10.981L15.027 2v4.99C3.075 6.99 1.711 16.678 2.043 22l.007-.041c.502-2.685.712-6.986 12.977-6.986v4.99L22 10.98z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></g>`
	shareBoxPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v12m0-12L8 7m4-4l4 4M2 17l.621 2.485A2 2 0 0 0 4.561 21h14.878a2 2 0 0 0 1.94-1.515L22 17"/>`
	shieldPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m13.147 21.197l1.67-1.168a13.393 13.393 0 0 0 5.447-13.624a.837.837 0 0 0-.453-.586L12 2L4.19 5.819a.837.837 0 0 0-.454.586a13.393 13.393 0 0 0 5.448 13.624l1.67 1.168a2 2 0 0 0 2.293 0Z"/>`
	shippingBoxOnePath          = `<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><path stroke-linecap="round" d="M11.029 2.54a2 2 0 0 1 1.942 0l7.515 4.174a1 1 0 0 1 .514.874v8.235a2 2 0 0 1-1.029 1.748l-7 3.89a2 2 0 0 1-1.942 0l-7-3.89A2 2 0 0 1 3 15.824V7.588a1 1 0 0 1 .514-.874L11.03 2.54Z"/><path d="m3 7l9 5m0 0l9-5m-9 5v10"/><path stroke-linecap="round" d="m7.5 9.5l9-5M6 12.328L9 14"/></g>`
	shippingBoxTwoPath          = `<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><path stroke-linecap="round" d="M11.029 2.54a2 2 0 0 1 1.942 0l7.515 4.174a1 1 0 0 1 .514.874v8.235a2 2 0 0 1-1.029 1.748l-7 3.89a2 2 0 0 1-1.942 0l-7-3.89A2 2 0 0 1 3 15.824V7.588a1 1 0 0 1 .514-.874L11.03 2.54Z"/><path stroke-linecap="round" d="m7.5 4.5l9 5V13M6 12.328L9 14"/><path d="m3 7l9 5m0 0l9-5m-9 5v10"/></g>`
	shippingBoxVOnePath         = `<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><path stroke-linecap="round" d="M11.029 2.54a2 2 0 0 1 1.942 0l7.515 4.174a1 1 0 0 1 .514.874v8.235a2 2 0 0 1-1.029 1.748l-7 3.89a2 2 0 0 1-1.942 0l-7-3.89A2 2 0 0 1 3 15.824V7.588a1 1 0 0 1 .514-.874L11.03 2.54Z"/><path d="m3 7l9 5m0 0l9-5m-9 5v9.5"/><path stroke-linecap="round" d="m7.5 9.5l9-5M6 12.328L9 14"/></g>`
	shippingBoxVTwoPath         = `<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><path stroke-linecap="round" d="M11.029 2.54a2 2 0 0 1 1.942 0l7.515 4.174a1 1 0 0 1 .514.874v8.235a2 2 0 0 1-1.029 1.748l-7 3.89a2 2 0 0 1-1.942 0l-7-3.89A2 2 0 0 1 3 15.824V7.588a1 1 0 0 1 .514-.874L11.03 2.54Z"/><path stroke-linecap="round" d="m7.5 4.5l9 5V13M6 12.328L9 14"/><path d="m3 7l9 5m0 0l9-5m-9 5v9.5"/></g>`
	shoppingBagPath             = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3.977 9.84A2 2 0 0 1 5.971 8h12.058a2 2 0 0 1 1.994 1.84l.803 10A2 2 0 0 1 18.833 22H5.167a2 2 0 0 1-1.993-2.16l.803-10Z"/><path d="M16 11V6a4 4 0 0 0-4-4v0a4 4 0 0 0-4 4v5"/></g>`
	sidebarLeftPath             = `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="18" x="2" y="3" stroke-linecap="round" stroke-linejoin="round" rx="2"/><path d="M9 3v18"/></g>`
	sidebarRightPath            = `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="18" x="2" y="3" stroke-linecap="round" stroke-linejoin="round" rx="2"/><path d="M15 3v18"/></g>`
	signOutPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 12h9m0 0l-3.333-4M22 12l-3.333 4M14 7V5.174a2 2 0 0 0-2.166-1.993l-8 .666A2 2 0 0 0 2 5.84v12.32a2 2 0 0 0 1.834 1.993l8 .667A2 2 0 0 0 14 18.826V17"/>`
	slackFillPath               = `<path fill="currentColor" fill-rule="evenodd" d="M9.066 1a2.2 2.2 0 1 0 .001 4.4h2.2V3.2a2.202 2.202 0 0 0-2.2-2.2Zm0 5.867H3.2a2.2 2.2 0 0 0 0 4.4h5.866a2.2 2.2 0 1 0 0-4.4ZM23 9.066a2.2 2.2 0 0 0-4.4 0v2.2h2.2a2.2 2.2 0 0 0 2.2-2.2Zm-5.867 0V3.2a2.2 2.2 0 0 0-4.4 0v5.866a2.2 2.2 0 1 0 4.4 0ZM14.933 23a2.2 2.2 0 1 0 0-4.4h-2.2v2.2a2.201 2.201 0 0 0 2.2 2.2Zm0-5.868H20.8a2.2 2.2 0 0 0 0-4.4h-5.866a2.2 2.2 0 0 0-.001 4.4ZM1 14.933a2.2 2.2 0 0 0 4.4 0v-2.2H3.2a2.2 2.2 0 0 0-2.2 2.2Zm5.867 0v5.866a2.2 2.2 0 0 0 4.4.001v-5.866a2.2 2.2 0 0 0-4.4-.001Z" clip-rule="evenodd"/>`
	slicePath                   = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M13 21H3l10-10v10Z"/><path d="M5 19L21 3v4l-8 8"/></g>`
	snapchatFillPath            = `<g fill="none"><g clip-path="url(#akarIconsSnapchatFill0)"><path fill="currentColor" d="M5.829 4.533c-.6 1.344-.363 3.752-.267 5.436c-.648.359-1.48-.271-1.951-.271c-.49 0-1.075.322-1.167.802c-.066.346.089.85 1.201 1.289c.43.17 1.453.37 1.69.928c.333.784-1.71 4.403-4.918 4.931a.498.498 0 0 0-.416.519c.056.975 2.242 1.357 3.211 1.507c.099.134.179.7.306 1.131c.057.193.204.424.582.424c.493 0 1.312-.38 2.738-.144c1.398.233 2.712 2.215 5.235 2.215c2.345 0 3.744-1.991 5.09-2.215c.779-.129 1.448-.088 2.196.058c.515.101.977.157 1.124-.349c.129-.437.208-.992.305-1.123c.96-.149 3.156-.53 3.211-1.505a.498.498 0 0 0-.416-.519c-3.154-.52-5.259-4.128-4.918-4.931c.236-.557 1.252-.755 1.69-.928c.814-.321 1.222-.716 1.213-1.173c-.011-.585-.715-.934-1.233-.934c-.527 0-1.284.624-1.897.286c.096-1.698.332-4.095-.267-5.438C17.036 1.986 14.511.7 11.987.7C9.479.7 6.973 1.968 5.829 4.533Z"/></g><defs><clipPath id="akarIconsSnapchatFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	sortPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M3 6h18M6 12h12m-9 6h6"/>`
	soundDownPath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="M22 12h-6"/><path stroke-linejoin="round" d="M2 14.959V9.04C2 8.466 2.448 8 3 8h3.586a.98.98 0 0 0 .707-.305l3-3.388c.63-.656 1.707-.191 1.707.736v13.914c0 .934-1.09 1.395-1.716.726l-2.99-3.369A.98.98 0 0 0 6.578 16H3c-.552 0-1-.466-1-1.041Z"/></g>`
	...
	statisticDownPath           = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path stroke-miterlimit="5.759" d="M3 3v16a2 2 0 0 0 2 2h16"/><path stroke-miterlimit="5.759" d="m7 9l4 4l4-4l6 6"/><path d="M18 15h3v-3"/></g>`
	statisticUpPath             = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path stroke-miterlimit="5.759" d="M3 3v16a2 2 0 0 0 2 2h16"/><path stroke-miterlimit="5.759" d="m7 14l4-4l4 4l6-6"/><path d="M18 8h3v3"/></g>`
	stopPath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path stroke-linejoin="round" d="M8 2L2 8.156V16l6 6h8l6-6V8.156L16 2H8Z"/><path d="M16 12H8"/></g>`
	stopFillPath                = `<path fill="currentColor" fill-rule="evenodd" d="M8 1a1 1 0 0 0-.716.302l-6 6.156A1 1 0 0 0 1 8.156V16a1 1 0 0 0 .293.707l6 6A1 1 0 0 0 8 23h8a1 1 0 0 0 .707-.293l6-6A1 1 0 0 0 23 16V8.156a1 1 0 0 0-.284-.698l-6-6.156A1 1 0 0 0 16 1H8Zm0 10a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2H8Z" clip-rule="evenodd"/>`
	sunPath                     = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="M12 3V2m0 20v-1m9-9h1M2 12h1m15.5-6.5L20 4M4 20l1.5-1.5M4 4l1.5 1.5m13 13L20 20"/><circle cx="12" cy="12" r="4"/></g>`
	sunFillPath                 = `<path fill="currentColor" d="M12 7a5 5 0 1 0 0 10a5 5 0 0 0 0-10Z"/><path fill="currentColor" fill-rule="evenodd" d="M12 1a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0V2a1 1 0 0 1 1-1ZM3.293 3.293a1 1 0 0 1 1.414 0l1.5 1.5a1 1 0 0 1-1.414 1.414l-1.5-1.5a1 1 0 0 1 0-1.414Zm17.414 0a1 1 0 0 1 0 1.414l-1.5 1.5a1 1 0 1 1-1.414-1.414l1.5-1.5a1 1 0 0 1 1.414 0ZM1 12a1 1 0 0 1 1-1h1a1 1 0 1 1 0 2H2a1 1 0 0 1-1-1Zm19 0a1 1 0 0 1 1-1h1a1 1 0 1 1 0 2h-1a1 1 0 0 1-1-1ZM6.207 17.793a1 1 0 0 1 0 1.414l-1.5 1.5a1 1 0 0 1-1.414-1.414l1.5-1.5a1 1 0 0 1 1.414 0Zm11.586 0a1 1 0 0 1 1.414 0l1.5 1.5a1 1 0 0 1-1.414 1.414l-1.5-1.5a1 1 0 0 1 0-1.414ZM12 20a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0v-1a1 1 0 0 1 1-1Z" clip-rule="evenodd"/>`
	swordPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m18 3l4-1l-1 4l-10 10l-2.5-.5L8 13L18 3ZM2 20l2 2m1-8l1 4l4 1m-4-1l-3 3"/>`
	tabletDevicePath            = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="16" height="20" x="4" y="2" rx="2"/><path d="M11 18h2"/></g>`
	...
	telegramFillPath            = `<g fill="none"><g clip-path="url(#akarIconsTelegramFill0)"><path fill="currentColor" fill-rule="evenodd" d="M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12S5.373 0 12 0s12 5.373 12 12ZM12.43 8.859c-1.167.485-3.5 1.49-6.998 3.014c-.568.226-.866.447-.893.663c-.046.366.412.51 1.034.705c.085.027.173.054.263.084c.613.199 1.437.432 1.865.441c.389.008.823-.152 1.302-.48c3.268-2.207 4.955-3.322 5.061-3.346c.075-.017.179-.039.249.024c.07.062.063.18.056.212c-.046.193-1.84 1.862-2.77 2.726c-.29.269-.495.46-.537.504c-.094.097-.19.19-.282.279c-.57.548-.996.96.024 1.632c.49.323.882.59 1.273.856c.427.291.853.581 1.405.943c.14.092.274.187.405.28c.497.355.944.673 1.496.623c.32-.03.652-.331.82-1.23c.397-2.126 1.179-6.73 1.36-8.628a2.111 2.111 0 0 0-.02-.472a.506.506 0 0 0-.172-.325c-.143-.117-.365-.142-.465-.14c-.451.008-1.143.249-4.476 1.635Z" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsTelegramFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	telescopePath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m7 21l6-8l8 8M5.228 7.303l13.532-5.06a1 1 0 0 1 1.108.285l.19.22A8 8 0 0 1 22 7.973v.616a1 1 0 0 1-.65.937l-13.536 5.06l-2.586-7.283Z"/><path d="M2.66 11.371a2 2 0 0 1 1.193-2.545l1.694-.624l1.944 5.473l-1.64.612a2 2 0 0 1-2.585-1.205l-.606-1.711ZM13 13v9"/></g>`
	tetragonPath                = `<path fill="none" stroke="currentColor" stroke-width="2" d="M3.575 13.388a1.962 1.962 0 0 1 0-2.776l7.037-7.037a1.962 1.962 0 0 1 2.776 0l7.037 7.037a1.963 1.963 0 0 1 0 2.776l-7.037 7.037a1.963 1.963 0 0 1-2.776 0l-7.037-7.037Z"/>`
	tetragonFillPath            = `<path fill="currentColor" d="M10.61 2.576a1.966 1.966 0 0 1 2.78 0l8.034 8.034a1.966 1.966 0 0 1 0 2.78l-8.034 8.034a1.966 1.966 0 0 1-2.78 0L2.576 13.39a1.966 1.966 0 0 1 0-2.78l8.034-8.034Z"/>`
	textAlignCenterPath         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M3 6h18M7 12h10M5 18h14"/>`
	textAlignJustifiedPath      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M3 6h18M3 12h18M3 18h18"/>`
	textAlignLeftPath           = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M3 6h18M3 12h10M3 18h15"/>`
	textAlignRightPath          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M3 6h18m-10 6h10M6 18h15"/>`
	threeLineHorizontalPath     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5 6h14M5 12h14M5 18h14"/>`
	threeLineVerticalPath       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 19V5m6 14V5M6 19V5"/>`
	...
	thunderPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.684 3.603c.521-.659.03-1.603-.836-1.603h-6.716a1.06 1.06 0 0 0-.909.502l-5.082 8.456c-.401.666.103 1.497.908 1.497h3.429l-3.23 8.065c-.467 1.02.795 1.953 1.643 1.215L20 9.331h-6.849l4.533-5.728Z"/>`
	ticketPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.707 3.293c-.39.39-.369 1.021-.138 1.523a2.83 2.83 0 0 1-3.753 3.753c-.502-.23-1.133-.252-1.523.138l-.586.586a1 1 0 0 0 0 1.414l10.586 10.586a1 1 0 0 0 1.414 0l.586-.586c.39-.39.369-1.021.138-1.523a2.83 2.83 0 0 1 3.753-3.753c.502.23 1.133.252 1.523-.138l.586-.586a1 1 0 0 0 0-1.414L10.707 2.707a1 1 0 0 0-1.414 0l-.586.586Z"/>`
	tiktokFillPath              = `<path fill="currentColor" d="M19.321 5.562a5.124 5.124 0 0 1-.443-.258a6.228 6.228 0 0 1-1.137-.966c-.849-.971-1.166-1.956-1.282-2.645h.004c-.097-.573-.057-.943-.05-.943h-3.865v14.943c0 .2 0 .399-.008.595c0 .024-.003.046-.004.073c0 .01 0 .022-.003.033v.009a3.28 3.28 0 0 1-1.65 2.604a3.226 3.226 0 0 1-1.6.422c-1.8 0-3.26-1.468-3.26-3.281c0-1.814 1.46-3.282 3.26-3.282c.341 0 .68.054 1.004.16l.005-3.936a7.178 7.178 0 0 0-5.532 1.62a7.583 7.583 0 0 0-1.655 2.04c-.163.281-.779 1.412-.853 3.246c-.047 1.04.266 2.12.415 2.565v.01c.093.262.457 1.158 1.049 1.913a7.856 7.856 0 0 0 1.674 1.58v-.01l.009.01c1.87 1.27 3.945 1.187 3.945 1.187c.359-.015 1.562 0 2.928-.647c1.515-.718 2.377-1.787 2.377-1.787a7.43 7.43 0 0 0 1.296-2.153c.35-.92.466-2.022.466-2.462V8.273c.047.028.672.441.672.441s.9.577 2.303.952c1.006.267 2.363.324 2.363.324V6.153c-.475.052-1.44-.098-2.429-.59Z"/>`
	toggleOffPath               = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="20" height="10" x="2" y="7" rx="5"/><circle cx="7" cy="12" r="5"/></g>`
	toggleOffFillPath           = `<path fill="currentColor" fill-rule="evenodd" d="M7 7a5 5 0 0 0 0 10h10a5 5 0 0 0 0-10H7Zm0 2.5a2.5 2.5 0 1 0 0 5a2.5 2.5 0 0 0 0-5Z" clip-rule="evenodd"/>`
	toggleOnPath                = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="20" height="10" x="2" y="7" rx="5"/><circle cx="17" cy="12" r="5"/></g>`
	toggleOnFillPath            = `<path fill="currentColor" fill-rule="evenodd" d="M7 7a5 5 0 0 0 0 10h10a5 5 0 0 0 0-10H7Zm10 2.5a2.5 2.5 0 1 0 0 5a2.5 2.5 0 0 0 0-5Z" clip-rule="evenodd"/>`
	togoCupPath                 = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 5.4A2.4 2.4 0 0 1 5.4 3h13.2A2.4 2.4 0 0 1 21 5.4v0a.6.6 0 0 1-.6.6H3.6a.6.6 0 0 1-.6-.6v0ZM5 6h14l-1.555 14.218A2 2 0 0 1 15.457 22H8.543a2 2 0 0 1-1.988-1.782L5 6Z"/><path d="m6.313 18l-.875-8h13.125l-.875 8H6.313Z"/></g>`
	trashPath                   = `<g fill="none"><path d="M3 4l.813 8.132c.125 1.243.346 2.475.662 3.684l.667 2.55a4 4 0 0 0 2.66 2.801l.567.18a12 12 0 0 0 7.262 0l.567-.18a4 4 0 0 0 2.66-2.8l.667-2.55c.316-1.21.538-2.442.662-3.685L21 4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><ellipse cx="12" cy="4" rx="9" ry="2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></g>`
	trashBinPath                = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m3 4l2.303 14.076a4 4 0 0 0 2.738 3.167l.328.104a12 12 0 0 0 7.262 0l.328-.104a4 4 0 0 0 2.738-3.166L21 4"/><ellipse cx="12" cy="4" rx="9" ry="2"/></g>`
	trashCanPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16l-1.58 14.22A2 2 0 0 1 16.432 22H7.568a2 2 0 0 1-1.988-1.78L4 6Zm3.345-2.853A2 2 0 0 1 9.154 2h5.692a2 2 0 0 1 1.81 1.147L18 6H6l1.345-2.853ZM2 6h20m-12 5v5m4-5v5"/>`
	trianglePath                = `<path fill="none" stroke="currentColor" stroke-width="2" d="M10.293 4.793c.78-1.277 2.634-1.277 3.414 0l7.433 12.164C21.955 18.29 20.996 20 19.434 20H4.566c-1.562 0-2.52-1.71-1.706-3.043l7.433-12.164Z"/>`
	triangleAlertPath           = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="M12 9v5m0 3.5v.5"/><path stroke-linejoin="round" d="M2.232 19.016L10.35 3.052c.713-1.403 2.59-1.403 3.302 0l8.117 15.964C22.45 20.36 21.544 22 20.116 22H3.883c-1.427 0-2.334-1.64-1.65-2.984Z"/></g>`
	triangleAlertFillPath       = `<path fill="currentColor" fill-rule="evenodd" d="M14.543 2.598a2.821 2.821 0 0 0-5.086 0L1.341 18.563C.37 20.469 1.597 23 3.883 23h16.233c2.287 0 3.512-2.53 2.543-4.437L14.543 2.598ZM12 8a1 1 0 0 1 1 1v5a1 1 0 1 1-2 0V9a1 1 0 0 1 1-1Zm0 8.5a1 1 0 0 1 1 1v.5a1 1 0 1 1-2 0v-.5a1 1 0 0 1 1-1Z" clip-rule="evenodd"/>`
	triangleDownPath            = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 17L6 9h12l-6 8Z"/>`
	triangleDownFillPath        = `<path fill="currentColor" d="M6 8a1 1 0 0 0-.8 1.6l6 8a1 1 0 0 0 1.6 0l6-8A1 1 0 0 0 18 8H6Z"/>`
	triangleFillPath            = `<path fill="currentColor" d="M10.285 3.858c.777-1.294 2.653-1.294 3.43 0l8.468 14.113c.8 1.333-.16 3.029-1.715 3.029H3.532c-1.554 0-2.514-1.696-1.715-3.029l8.468-14.113Z"/>`
	triangleLeftPath            = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m7 12l8-6v12l-8-6Z"/>`
	triangleLeftFillPath        = `<path fill="currentColor" d="M16 6a1 1 0 0 0-1.6-.8l-8 6a1 1 0 0 0 0 1.6l8 6A1 1 0 0 0 16 18V6Z"/>`
	triangleRightPath           = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 12L9 6v12l8-6Z"/>`
	triangleRightFillPath       = `<path fill="currentColor" d="M8 6a1 1 0 0 1 1.6-.8l8 6a1 1 0 0 1 0 1.6l-8 6A1 1 0 0 1 8 18V6Z"/>`
	triangleUpPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m12 7l-6 8h12l-6-8Z"/>`
	triangleUpFillPath          = `<path fill="currentColor" d="M6 16a1 1 0 0 1-.8-1.6l6-8a1 1 0 0 1 1.6 0l6 8A1 1 0 0 1 18 16H6Z"/>`
...
func IconFromName(name string) g.Node {
	...
	case "arrowBack":
		return ArrowBack()
	case "arrowBackThick":
		return ArrowBackThick()
	case "arrowBackThickFill":
		return ArrowBackThickFill()
	case "arrowClockwise":
	...
	case "arrowForward":
		return ArrowForward()
	case "arrowForwardThick":
		return ArrowForwardThick()
	case "arrowForwardThickFill":
		return ArrowForwardThickFill()
	case "arrowLeft":
		return ArrowLeft()
	case "arrowLeftThick":
	...
	case "chevronVertical":
		return ChevronVertical()
	case "circle":
		return Circle()
	case "circleAlert":
		return CircleAlert()
	case "circleAlertFill":
		return CircleAlertFill()
	case "circleCheck":
		return CircleCheck()
	...
	case "circleChevronDownFill":
		return CircleChevronDownFill()
	case "circleChevronLeft":
		return CircleChevronLeft()
	case "circleChevronLeftFill":
		return CircleChevronLeftFill()
	case "circleChevronRight":
		return CircleChevronRight()
	case "circleChevronRightFill":
		return CircleChevronRightFill()
	case "circleChevronUp":
		return CircleChevronUp()
	case "circleChevronUpFill":
		return CircleChevronUpFill()
	case "circleFill":
		return CircleFill()
	case "circleMinus":
		return CircleMinus()
	case "circleMinusFill":
		return CircleMinusFill()
	case "circlePlus":
		return CirclePlus()
	case "circlePlusFill":
		return CirclePlusFill()
	case "circleTriangleDown":
		return CircleTriangleDown()
	case "circleTriangleDownFill":
		return CircleTriangleDownFill()
	case "circleTriangleLeft":
		return CircleTriangleLeft()
	case "circleTriangleLeftFill":
		return CircleTriangleLeftFill()
	case "circleTriangleRight":
		return CircleTriangleRight()
	case "circleTriangleRightFill":
		return CircleTriangleRightFill()
	case "circleTriangleUp":
		return CircleTriangleUp()
	case "circleTriangleUpFill":
		return CircleTriangleUpFill()
	case "circleX":
		return CircleX()
	case "circleXFill":
		return CircleXFill()
	...
	case "creditCard":
		return CreditCard()
	case "creditCardAltOne":
		return CreditCardAltOne()
	case "cross":
		return Cross()
	case "crown":
		return Crown()
	...
	case "dragHorizontalFill":
		return DragHorizontalFill()
	case "dragVertical":
		return DragVertical()
	case "dragVerticalFill":
		return DragVerticalFill()
	case "dribbbleFill":
		return DribbbleFill()
	case "dropboxFill":
		return DropboxFill()
	...
	case "githubFill":
		return GithubFill()
	case "githubOutlineFill":
		return GithubOutlineFill()
	case "glasses":
		return Glasses()
	case "globe":
		return Globe()
	case "googleContainedFill":
		return GoogleContainedFill()
	case "googleFill":
		return GoogleFill()
	case "graphqlFill":
		return GraphqlFill()
	...
	case "linkedinFill":
		return LinkedinFill()
	case "linkedinVOneFill":
		return LinkedinVOneFill()
	case "linkedinVTwoFill":
		return LinkedinVTwoFill()
	case "linkedinvOneFill":
		return LinkedinvOneFill()
	case "linkedinvTwoFill":
		return LinkedinvTwoFill()
	...
	case "panelSplit":
		return PanelSplit()
	case "panelSplitColumn":
		return PanelSplitColumn()
	case "panelSplitRow":
		return PanelSplitRow()
	case "panelTop":
		return PanelTop()
	case "paper":
		return Paper()
	...
	case "plus":
		return Plus()
	case "pointerDownFill":
		return PointerDownFill()
	case "pointerHand":
		return PointerHand()
	case "pointerLeftFill":
		return PointerLeftFill()
	case "pointerRightFill":
		return PointerRightFill()
	case "pointerUpFill":
		return PointerUpFill()
	case "pointingUp":
		return PointingUp()
	case "postgresqlFill":
		return PostgresqlFill()
	case "priceCut":
		return PriceCut()
	...
	case "send":
		return Send()
	case "settingsHorizontal":
		return SettingsHorizontal()
	case "settingsVertical":
		return SettingsVertical()
	case "shareArrow":
		return ShareArrow()
	case "shareBox":
		return ShareBox()
	case "shield":
		return Shield()
	case "shippingBoxOne":
		return ShippingBoxOne()
	case "shippingBoxTwo":
		return ShippingBoxTwo()
	case "shippingBoxVOne":
		return ShippingBoxVOne()
	case "shippingBoxVTwo":
		return ShippingBoxVTwo()
	case "shoppingBag":
		return ShoppingBag()
	case "sidebarLeft":
		return SidebarLeft()
	...
	case "threeLineHorizontal":
		return ThreeLineHorizontal()
	case "threeLineVertical":
		return ThreeLineVertical()
	case "thumbsDown":
		return ThumbsDown()
	case "thumbsUp":
		return ThumbsUp()
	...
	case "triangleAlertFill":
		return TriangleAlertFill()
	case "triangleDown":
		return TriangleDown()
	case "triangleDownFill":
		return TriangleDownFill()
	case "triangleFill":
		return TriangleFill()
	case "triangleLeft":
		return TriangleLeft()
	case "triangleLeftFill":
		return TriangleLeftFill()
	case "triangleRight":
		return TriangleRight()
	case "triangleRightFill":
		return TriangleRightFill()
	case "triangleUp":
		return TriangleUp()
	case "triangleUpFill":
		return TriangleUpFill()
	case "trophy":
		return Trophy()
	case "truck":
		return Truck()
	...
	case "twitterFill":
		return TwitterFill()
	case "twoLineHorizontal":
		return TwoLineHorizontal()
	case "twoLineVertical":
		return TwoLineVertical()
	case "typescriptFill":
		return TypescriptFill()
	case "umbrella":
		return Umbrella()
	case "unsplashFill":
		return UnsplashFill()
...
func Air(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(airPath), g.Group(children))
}

func AirplayAudio(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(airplayAudioPath), g.Group(children))
}

func AirplayVideo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(airplayVideoPath), g.Group(children))
}

func Airpods(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(airpodsPath), g.Group(children))
}
...
func AlignToBottom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignToBottomPath), g.Group(children))
}

func AlignToMiddle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignToMiddlePath), g.Group(children))
}

func AlignToTop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignToTopPath), g.Group(children))
}
...
func AngularFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(angularFillPath), g.Group(children))
}

func ArrowBack(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowBackPath), g.Group(children))
}

func ArrowBackThick(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowBackThickPath), g.Group(children))
}

func ArrowBackThickFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowBackThickFillPath), g.Group(children))
}

func ArrowClockwise(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowClockwisePath), g.Group(children))
}

func ArrowCounterClockwise(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowCounterClockwisePath), g.Group(children))
}

func ArrowCycle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowCyclePath), g.Group(children))
}
...
func ArrowDownThick(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowDownThickPath), g.Group(children))
}
...
func ArrowForwardThick(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowForwardThickPath), g.Group(children))
}

func ArrowForwardThickFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowForwardThickFillPath), g.Group(children))
}
...
func ArrowLeftThick(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowLeftThickPath), g.Group(children))
}

func ArrowRepeat(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowRepeatPath), g.Group(children))
}
...
func ArrowRightThick(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowRightThickPath), g.Group(children))
}

func ArrowShuffle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowShufflePath), g.Group(children))
}
...
func ArrowUpThick(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUpThickPath), g.Group(children))
}

func Ascending(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(ascendingPath), g.Group(children))
}

func Attach(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(attachPath), g.Group(children))
}
...
func Basket(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(basketPath), g.Group(children))
}
...
func BookClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bookClosePath), g.Group(children))
}
...
func ChatApprove(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatApprovePath), g.Group(children))
}
...
func ChatEdit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatEditPath), g.Group(children))
}

func ChatError(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatErrorPath), g.Group(children))
}

func ChatQuestion(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatQuestionPath), g.Group(children))
}
...
func CheckIn(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkInPath), g.Group(children))
}
...
func ChevronHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronHorizontalPath), g.Group(children))
}
...
func ChevronVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronVerticalPath), g.Group(children))
}
...
func CircleAlert(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleAlertPath), g.Group(children))
}

func CircleAlertFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleAlertFillPath), g.Group(children))
}
...
func CircleCheckFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleCheckFillPath), g.Group(children))
}
...
func CircleChevronDownFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleChevronDownFillPath), g.Group(children))
}
...
func CircleChevronLeftFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleChevronLeftFillPath), g.Group(children))
}
...
func CircleChevronRightFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleChevronRightFillPath), g.Group(children))
}
...
func CircleChevronUpFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleChevronUpFillPath), g.Group(children))
}
...
func CircleMinusFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleMinusFillPath), g.Group(children))
}
...
func CirclePlusFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circlePlusFillPath), g.Group(children))
}

func CircleTriangleDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleTriangleDownPath), g.Group(children))
}

func CircleTriangleDownFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleTriangleDownFillPath), g.Group(children))
}

func CircleTriangleLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleTriangleLeftPath), g.Group(children))
}

func CircleTriangleLeftFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleTriangleLeftFillPath), g.Group(children))
}

func CircleTriangleRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleTriangleRightPath), g.Group(children))
}

func CircleTriangleRightFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleTriangleRightFillPath), g.Group(children))
}

func CircleTriangleUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleTriangleUpPath), g.Group(children))
}

func CircleTriangleUpFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleTriangleUpFillPath), g.Group(children))
}

func CircleX(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleXPath), g.Group(children))
}

func CircleXFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleXFillPath), g.Group(children))
}
...
func Computing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(computingPath), g.Group(children))
}
...
func CreditCardAltOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(creditCardAltOnePath), g.Group(children))
}
...
func CssFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cssFillPath), g.Group(children))
}
...
func Dental(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dentalPath), g.Group(children))
}

func Descending(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(descendingPath), g.Group(children))
}

func DesktopDevice(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(desktopDevicePath), g.Group(children))
}
...
func DjangoFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(djangoFillPath), g.Group(children))
}

func Door(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doorPath), g.Group(children))
}

func DotGrid(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dotGridPath), g.Group(children))
}

func DotGridFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dotGridFillPath), g.Group(children))
}
...
func DoubleSword(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doubleSwordPath), g.Group(children))
}
...
func DragHorizontalFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dragHorizontalFillPath), g.Group(children))
}
...
func DragVerticalFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dragVerticalFillPath), g.Group(children))
}
...
func EyeOpen(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(eyeOpenPath), g.Group(children))
}

func EyeSlashed(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(eyeSlashedPath), g.Group(children))
}

func FaceHappy(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(faceHappyPath), g.Group(children))
}
...
func FaceSad(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(faceSadPath), g.Group(children))
}

func FaceVeryHappy(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(faceVeryHappyPath), g.Group(children))
}

func FaceVerySad(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(faceVerySadPath), g.Group(children))
}

func FaceWink(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(faceWinkPath), g.Group(children))
}
...
func FigmaFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(figmaFillPath), g.Group(children))
}
...
func ForkLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(forkLeftPath), g.Group(children))
}

func ForkRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(forkRightPath), g.Group(children))
}
...
func FullScreen(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fullScreenPath), g.Group(children))
}

func GameController(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gameControllerPath), g.Group(children))
}
...
func GithubOutlineFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(githubOutlineFillPath), g.Group(children))
}
...
func GoogleContainedFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(googleContainedFillPath), g.Group(children))
}
...
func GraphqlFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphqlFillPath), g.Group(children))
}
...
func Health(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(healthPath), g.Group(children))
}
...
func Height(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heightPath), g.Group(children))
}
...
func HeptagonFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heptagonFillPath), g.Group(children))
}
...
func HomeAltOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeAltOnePath), g.Group(children))
}

func HtmlFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(htmlFillPath), g.Group(children))
}
...
func Jar(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(jarPath), g.Group(children))
}
...
func JqueryFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(jqueryFillPath), g.Group(children))
}
...
func KeyCap(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(keyCapPath), g.Group(children))
}
...
func LaptopDevice(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(laptopDevicePath), g.Group(children))
}
...
func Lifesaver(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lifesaverPath), g.Group(children))
}
...
func LinkChain(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkChainPath), g.Group(children))
}

func LinkOff(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkOffPath), g.Group(children))
}

func LinkOn(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkOnPath), g.Group(children))
}

func LinkOut(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkOutPath), g.Group(children))
}
...
func LinkedinVOneFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkedinVOneFillPath), g.Group(children))
}

func LinkedinVTwoFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkedinVTwoFillPath), g.Group(children))
}
...
func LockOn(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lockOnPath), g.Group(children))
}
...
func MobileDevice(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mobileDevicePath), g.Group(children))
}
...
func NextjsFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(nextjsFillPath), g.Group(children))
}

func NodeFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(nodeFillPath), g.Group(children))
}

func NormalScreen(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(normalScreenPath), g.Group(children))
}
...
func OctocatFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(octocatFillPath), g.Group(children))
}

func OpenEnvelope(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(openEnvelopePath), g.Group(children))
}

func Oval(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(ovalPath), g.Group(children))
}
...
func PanelSplit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(panelSplitPath), g.Group(children))
}

func PanelSplitColumn(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(panelSplitColumnPath), g.Group(children))
}

func PanelSplitRow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(panelSplitRowPath), g.Group(children))
}
...
func Paper(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(paperPath), g.Group(children))
}
...
func Parallelogram(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(parallelogramPath), g.Group(children))
}
...
func PeopleGroup(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(peopleGroupPath), g.Group(children))
}

func PeopleMultiple(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(peopleMultiplePath), g.Group(children))
}
...
func PersonAdd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personAddPath), g.Group(children))
}

func PersonCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personCheckPath), g.Group(children))
}

func PersonCross(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personCrossPath), g.Group(children))
}
...
func PhpFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(phpFillPath), g.Group(children))
}
...
func Plant(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(plantPath), g.Group(children))
}
...
func PointerDownFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pointerDownFillPath), g.Group(children))
}

func PointerHand(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pointerHandPath), g.Group(children))
}

func PointerLeftFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pointerLeftFillPath), g.Group(children))
}

func PointerRightFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pointerRightFillPath), g.Group(children))
}

func PointerUpFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pointerUpFillPath), g.Group(children))
}

func PointingUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pointingUpPath), g.Group(children))
}

func PostgresqlFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(postgresqlFillPath), g.Group(children))
}

func PriceCut(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(priceCutPath), g.Group(children))
}
...
func PythonFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pythonFillPath), g.Group(children))
}
...
func Radish(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(radishPath), g.Group(children))
}

func ReactFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(reactFillPath), g.Group(children))
}
...
func ReduxFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(reduxFillPath), g.Group(children))
}
...
func Ribbon(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(ribbonPath), g.Group(children))
}

func RockOn(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rockOnPath), g.Group(children))
}
...
func SassFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sassFillPath), g.Group(children))
}
...
func Schedule(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(schedulePath), g.Group(children))
}
...
func SettingsHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(settingsHorizontalPath), g.Group(children))
}

func SettingsVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(settingsVerticalPath), g.Group(children))
}

func ShareArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shareArrowPath), g.Group(children))
}

func ShareBox(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shareBoxPath), g.Group(children))
}
...
func ShippingBoxOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shippingBoxOnePath), g.Group(children))
}

func ShippingBoxTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shippingBoxTwoPath), g.Group(children))
}

func ShippingBoxVOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shippingBoxVOnePath), g.Group(children))
}

func ShippingBoxVTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shippingBoxVTwoPath), g.Group(children))
}
...
func SidebarLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sidebarLeftPath), g.Group(children))
}
...
func SoundOn(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(soundOnPath), g.Group(children))
}
...
func StatisticDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(statisticDownPath), g.Group(children))
}

func StatisticUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(statisticUpPath), g.Group(children))
}
...
func TabletDevice(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tabletDevicePath), g.Group(children))
}
...
func Tetragon(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tetragonPath), g.Group(children))
}

func TetragonFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tetragonFillPath), g.Group(children))
}
...
func TextAlignJustified(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textAlignJustifiedPath), g.Group(children))
}
...
func ThreeLineHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(threeLineHorizontalPath), g.Group(children))
}

func ThreeLineVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(threeLineVerticalPath), g.Group(children))
}
...
func Thunder(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thunderPath), g.Group(children))
}
...
func ToggleOffFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(toggleOffFillPath), g.Group(children))
}
...
func ToggleOnFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(toggleOnFillPath), g.Group(children))
}

func TogoCup(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(togoCupPath), g.Group(children))
}
...
func TrashBin(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(trashBinPath), g.Group(children))
}

func TrashCan(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(trashCanPath), g.Group(children))
}
...
func TriangleAlert(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleAlertPath), g.Group(children))
}

func TriangleAlertFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleAlertFillPath), g.Group(children))
}

func TriangleDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleDownPath), g.Group(children))
}

func TriangleDownFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleDownFillPath), g.Group(children))
}
...
func TriangleLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleLeftPath), g.Group(children))
}

func TriangleLeftFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleLeftFillPath), g.Group(children))
}
...
func TriangleRightFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleRightFillPath), g.Group(children))
}

func TriangleUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleUpPath), g.Group(children))
}

func TriangleUpFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleUpFillPath), g.Group(children))
}
...
func TwoLineHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(twoLineHorizontalPath), g.Group(children))
}

func TwoLineVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(twoLineVerticalPath), g.Group(children))
}

func TypescriptFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(typescriptFillPath), g.Group(children))
}
...
func VapeKit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vapeKitPath), g.Group(children))
}

func VercelFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vercelFillPath), g.Group(children))
}

func VictoryHand(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(victoryHandPath), g.Group(children))
}
...
func VkFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vkFillPath), g.Group(children))
}

func VrAr(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vrArPath), g.Group(children))
}

func VscodeFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vscodeFillPath), g.Group(children))
}

func VueFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vueFillPath), g.Group(children))
}
...
func WatchDevice(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(watchDevicePath), g.Group(children))
}
...
func Width(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(widthPath), g.Group(children))
}
...
func XSmall(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(xSmallPath), g.Group(children))
}

func YarnFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(yarnFillPath), g.Group(children))
}

func YelpFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(yelpFillPath), g.Group(children))
}
...
func ZoomFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(zoomFillPath), g.Group(children))
}
