...
func Archive(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 25 25"),
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M42 20h-2v-5c0-.6-.4-1-1-1H11c-.6 0-1 .4-1 1v5H8v-5c0-1.7 1.3-3 3-3h28c1.7 0 3 1.3 3 3v5zm-5 20H13c-1.7 0-3-1.3-3-3V20h2v17c0 .6.4 1 1 1h24c.6 0 1-.4 1-1V20h2v17c0 1.7-1.3 3-3 3z"/><path fill="currentColor" d="M29 26h-8c-.6 0-1-.4-1-1s.4-1 1-1h8c.6 0 1 .4 1 1s-.4 1-1 1zM8 18h34v2H8z"/>`),
		g.Group(children),
	)
}
...
func ArrowLeft(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M25.3 34.7L15.6 25l9.7-9.7l1.4 1.4l-8.3 8.3l8.3 8.3z"/><path fill="currentColor" d="M17 24h17v2H17z"/>`),
		g.Group(children),
	)
}
...
func ArrowRight(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="m24.7 34.7l-1.4-1.4l8.3-8.3l-8.3-8.3l1.4-1.4l9.7 9.7z"/><path fill="currentColor" d="M16 24h17v2H16z"/>`),
		g.Group(children),
	)
}
...
func Check(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="m23 32.4l-8.7-8.7l1.4-1.4l7.3 7.3l11.3-11.3l1.4 1.4z"/>`),
		g.Group(children),
	)
}
...
func Clock(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M30.3 33.7L24 27.4V16h2v10.6l5.7 5.7z"/>`),
		g.Group(children),
	)
}
...
func Exclamation(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M24 32h2v2h-2zm1.6-2h-1.2l-.4-8v-6h2v6z"/>`),
		g.Group(children),
	)
}
...
func ExternalLink(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="m38.288 10.297l1.414 1.415l-14.99 14.99l-1.414-1.414z"/><path fill="currentColor" d="M40 20h-2v-8h-8v-2h10zm-5 18H15c-1.7 0-3-1.3-3-3V15c0-1.7 1.3-3 3-3h11v2H15c-.6 0-1 .4-1 1v20c0 .6.4 1 1 1h20c.6 0 1-.4 1-1V24h2v11c0 1.7-1.3 3-3 3z"/>`),
		g.Group(children),
	)
}
...
func Link(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M24 30.2c0 .2.1.5.1.8c0 1.4-.5 2.6-1.5 3.6l-2 2c-1 1-2.2 1.5-3.6 1.5c-2.8 0-5.1-2.3-5.1-5.1c0-1.4.5-2.6 1.5-3.6l2-2c1-1 2.2-1.5 3.6-1.5c.3 0 .5 0 .8.1l1.5-1.5c-.7-.3-1.5-.4-2.3-.4c-1.9 0-3.6.7-4.9 2l-2 2c-1.3 1.3-2 3-2 4.9c0 3.8 3.1 6.9 6.9 6.9c1.9 0 3.6-.7 4.9-2l2-2c1.3-1.3 2-3 2-4.9c0-.8-.1-1.6-.4-2.3L24 30.2zm9-20.1c-1.9 0-3.6.7-4.9 2l-2 2c-1.3 1.3-2 3-2 4.9c0 .8.1 1.6.4 2.3l1.5-1.5c0-.2-.1-.5-.1-.8c0-1.4.5-2.6 1.5-3.6l2-2c1-1 2.2-1.5 3.6-1.5c2.8 0 5.1 2.3 5.1 5.1c0 1.4-.5 2.6-1.5 3.6l-2 2c-1 1-2.2 1.5-3.6 1.5c-.3 0-.5 0-.8-.1l-1.5 1.5c.7.3 1.5.4 2.3.4c1.9 0 3.6-.7 4.9-2l2-2c1.3-1.3 2-3 2-4.9c0-3.8-3.1-6.9-6.9-6.9z"/><path fill="currentColor" d="M20 31c-.3 0-.5-.1-.7-.3c-.4-.4-.4-1 0-1.4l10-10c.4-.4 1-.4 1.4 0s.4 1 0 1.4l-10 10c-.2.2-.4.3-.7.3z"/>`),
		g.Group(children),
	)
}
...
func Minus(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M16 24h18v2H16z"/>`),
		g.Group(children),
	)
}
...
func Play(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M20 33.7V16.3L35 25l-15 8.7zm2-14v10.5l9-5.3l-9-5.2z"/>`),
		g.Group(children),
	)
}
...
func Plus(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M16 24h18v2H16z"/><path fill="currentColor" d="M24 16h2v18h-2z"/>`),
		g.Group(children),
	)
}
...
func ScTumblr(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M30.9 32.4c-.5.2-1.5.5-2.3.5c-2.2.1-2.7-1.6-2.7-2.8v-8.7h5.6v-4.2H26V10h-4.1c-.1 0-.2.1-.2.2c-.2 2.2-1.3 6-5.5 7.5v3.6H19v9.1c0 3.1 2.3 7.6 8.4 7.5c2.1 0 4.3-.9 4.8-1.6l-1.3-3.9z"/>`),
		g.Group(children),
	)
}
...
func Search(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M23 36c-7.2 0-13-5.8-13-13s5.8-13 13-13s13 5.8 13 13s-5.8 13-13 13zm0-24c-6.1 0-11 4.9-11 11s4.9 11 11 11s11-4.9 11-11s-4.9-11-11-11z"/><path fill="currentColor" d="m32.682 31.267l8.98 8.98l-1.414 1.414l-8.98-8.98z"/>`),
		g.Group(children),
	)
}
...
func Undo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("25"),
		h.Height("25"),
		g.Raw(`<path fill="currentColor" d="M25 38c-5.1 0-9.7-3-11.8-7.6l1.8-.8c1.8 3.9 5.7 6.4 10 6.4c6.1 0 11-4.9 11-11s-4.9-11-11-11c-4.6 0-8.5 2.8-10.1 7.3l-1.9-.7c1.9-5.2 6.6-8.6 12-8.6c7.2 0 13 5.8 13 13s-5.8 13-13 13z"/><path fill="currentColor" d="M20 22h-8v-8h2v6h6z"/>`),
		g.Group(children),
	)
}
