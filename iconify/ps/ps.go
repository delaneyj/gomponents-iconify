...
func IconFromName(name string) g.Node {
	...
	case "anySolvent":
		return AnySolvent()
	case "anySolventWithoutTetrachlorethylene":
		return AnySolventWithoutTetrachlorethylene()
	case "appStore":
		return AppStore()
	case "apple":
		return Apple()
	...
	case "boiledEgg":
		return BoiledEgg()
	case "boiledEggFinger":
		return BoiledEggFinger()
	case "bonnet":
		return Bonnet()
	case "book":
		return Book()
	...
	case "cart":
		return Cart()
	case "cartSupermarket":
		return CartSupermarket()
	case "chat":
		return Chat()
	case "chatAlt":
		return ChatAlt()
	...
	case "dryFlat":
		return DryFlat()
	case "dryInTheShade":
		return DryInTheShade()
	case "dryNormalHightHeat":
		return DryNormalHightHeat()
	case "dryNormalLowHeat":
		return DryNormalLowHeat()
	case "dryNormalNoHeat":
		return DryNormalNoHeat()
	case "dzone":
		return Dzone()
	case "ebay":
		return Ebay()
	...
	case "feedburner":
		return Feedburner()
	case "fiftyOneHundredTwenty":
		return FiftyOneHundredTwenty()
	case "file":
		return File()
	case "film":
		return Film()
	...
	case "forrst":
		return Forrst()
	case "fortyOneHundredFive":
		return FortyOneHundredFive()
	case "forward":
		return Forward()
	case "foursquare":
		return Foursquare()
	...
	case "girlOMouth":
		return GirlOMouth()
	case "girlOpenMouth":
		return GirlOpenMouth()
	case "girlSad":
		return GirlSad()
	case "girlSadHunappy":
		return GirlSadHunappy()
	case "girlSleep":
		return GirlSleep()
	case "girlSmile":
		return GirlSmile()
	...
	case "hand":
		return Hand()
	case "handPointerLeft":
		return HandPointerLeft()
	case "handPointerRight":
		return HandPointerRight()
	case "handPointerTop":
		return HandPointerTop()
	case "handWash":
		return HandWash()
	case "hangToDry":
		return HangToDry()
	...
	case "machineWash":
		return MachineWash()
	case "machineWashGentleOrDelicate":
		return MachineWashGentleOrDelicate()
	case "machineWashPermanentPress":
		return MachineWashPermanentPress()
	...
	case "man":
		return Man()
	case "maximumTempOneHundredFiftyThreeHundred":
		return MaximumTempOneHundredFiftyThreeHundred()
	case "maximumTempOneHundredTenTwoHundredThirty":
		return MaximumTempOneHundredTenTwoHundredThirty()
	case "maximumTempTwoHundredThreeHundredNinety":
		return MaximumTempTwoHundredThreeHundredNinety()
	case "mayoHotdog":
		return MayoHotdog()
	case "meetup":
		return Meetup()
	...
	case "next":
		return Next()
	case "ninetyFiveTwoHundred":
		return NinetyFiveTwoHundred()
	case "noEye":
		return NoEye()
	case "nonChlorineBleachIfNeeded":
		return NonChlorineBleachIfNeeded()
	case "official":
		return Official()
	case "openPadlock":
		return OpenPadlock()
	...
	case "peopleTeam":
		return PeopleTeam()
	case "petroleumSolventSteam":
		return PetroleumSolventSteam()
	case "phone":
		return Phone()
	case "photobucket":
		return Photobucket()
	...
	case "printer":
		return Printer()
	case "prisonSchoolBus":
		return PrisonSchoolBus()
	case "promo":
		return Promo()
	case "pull":
		return Pull()
	...
	case "scribd":
		return Scribd()
	case "seventyOneHundredSixty":
		return SeventyOneHundredSixty()
	case "sharethis":
		return Sharethis()
	case "shield":
		return Shield()
	...
	case "simplenote":
		return Simplenote()
	case "sixtyOneHundredForty":
		return SixtyOneHundredForty()
	case "skype":
		return Skype()
	case "slashdot":
		return Slashdot()
	...
	case "soundDown":
		return SoundDown()
	case "soundLevelOne":
		return SoundLevelOne()
	case "soundLevelTwo":
		return SoundLevelTwo()
	case "soundPlus":
		return SoundPlus()
	case "soundcloud":
		return Soundcloud()
	...
	case "watch":
		return Watch()
	case "waterTemperatureFifty":
		return WaterTemperatureFifty()
	case "waterTemperatureForty":
		return WaterTemperatureForty()
	case "waterTemperatureNinetyFive":
		return WaterTemperatureNinetyFive()
	case "waterTemperatureSeventy":
		return WaterTemperatureSeventy()
	case "waterTemperatureSixty":
		return WaterTemperatureSixty()
	case "waterTemperatureThirty":
		return WaterTemperatureThirty()
	case "whatsapp":
		return Whatsapp()
	case "wikipedia":
		return Wikipedia()
