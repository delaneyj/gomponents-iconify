...
func Archive(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 24px; height: 24px; display: block;"),
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="20" height="5" x="2" y="3" rx="1"/><path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8m-10 4h4"/></g>`),
		g.Group(children),
	)
}
...
func ArchiveX(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 24px; height: 24px; display: block;"),
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="20" height="5" x="2" y="3" rx="1"/><path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8M9.5 17l5-5m-5 0l5 5"/></g>`),
		g.Group(children),
	)
}
