...
func Brochure(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(brochurePath), g.Group(children))
}
...
func Editor(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(editorPath), g.Group(children))
}
...
func FileCodeOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileCodeOnePath), g.Group(children))
}
...
func FileError(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileErrorPath), g.Group(children))
}

func FileScript(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileScriptPath), g.Group(children))
}
...
func Issue(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(issuePath), g.Group(children))
}
...
func Multi(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(multiPath), g.Group(children))
}
...
func PortraitOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(portraitOnePath), g.Group(children))
}

func PortraitTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(portraitTwoPath), g.Group(children))
}
...
func Secure(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(securePath), g.Group(children))
}
