...
func IconFromName(name string) g.Node {
	...
	case "abacus":
		return Abacus()
	case "accessibleIconAlt":
		return AccessibleIconAlt()
	case "adjust":
		return Adjust()
	case "adjustAlt":
		return AdjustAlt()
	...
	case "alignCenterH":
		return AlignCenterH()
	case "alignCenterJustify":
		return AlignCenterJustify()
	case "alignCenterV":
		return AlignCenterV()
	case "alignJustify":
		return AlignJustify()
	case "alignLeft":
		return AlignLeft()
	case "alignLeftJustify":
		return AlignLeftJustify()
	case "alignLetterRight":
		return AlignLetterRight()
	case "alignRight":
		return AlignRight()
	case "alignRightJustify":
		return AlignRightJustify()
	case "amazon":
		return Amazon()
	case "ambulance":
		return Ambulance()
	...
	case "androidAlt":
		return AndroidAlt()
	case "androidPhoneSlash":
		return AndroidPhoneSlash()
	...
	case "arrowRandom":
		return ArrowRandom()
	case "arrowResizeDiagonal":
		return ArrowResizeDiagonal()
	case "arrowRight":
		return ArrowRight()
	case "arrowToBottom":
	...
	case "arrowsResize":
		return ArrowsResize()
	case "arrowsResizeH":
		return ArrowsResizeH()
	case "arrowsResizeV":
		return ArrowsResizeV()
	case "arrowsRightDown":
		return ArrowsRightDown()
	case "arrowsShrinkH":
		return ArrowsShrinkH()
	case "arrowsShrinkV":
		return ArrowsShrinkV()
	case "arrowsUpRight":
		return ArrowsUpRight()
	case "arrowsV":
		return ArrowsV()
	case "arrowsVAlt":
		return ArrowsVAlt()
	...
	case "brightness":
		return Brightness()
	case "brightnessEmpty":
		return BrightnessEmpty()
	case "brightnessHalf":
		return BrightnessHalf()
	case "brightnessLow":
		return BrightnessLow()
	case "brightnessMinus":
		return BrightnessMinus()
	case "brightnessPlus":
		return BrightnessPlus()
	case "bringBottom":
		return BringBottom()
	case "bringFront":
		return BringFront()
	...
	case "cloudDataConnection":
		return CloudDataConnection()
	case "cloudDatabaseTree":
		return CloudDatabaseTree()
	case "cloudDownload":
		return CloudDownload()
	case "cloudDrizzle":
		return CloudDrizzle()
	case "cloudExclamation":
	...
	case "cloudMoon":
		return CloudMoon()
	case "cloudMoonHail":
		return CloudMoonHail()
	case "cloudMoonMeatball":
		return CloudMoonMeatball()
	case "cloudMoonRain":
		return CloudMoonRain()
	case "cloudMoonShowers":
		return CloudMoonShowers()
	case "cloudQuestion":
	...
	case "cloudShowers":
		return CloudShowers()
	case "cloudShowersAlt":
		return CloudShowersAlt()
	...
	case "cloudSunHail":
		return CloudSunHail()
	case "cloudSunMeatball":
		return CloudSunMeatball()
	case "cloudSunRain":
		return CloudSunRain()
	case "cloudSunRainAlt":
		return CloudSunRainAlt()
	case "cloudSunTear":
		return CloudSunTear()
	case "cloudTimes":
		return CloudTimes()
	...
	case "commentAlt":
		return CommentAlt()
	case "commentAltBlock":
		return CommentAltBlock()
	case "commentAltChartLines":
		return CommentAltChartLines()
	case "commentAltCheck":
		return CommentAltCheck()
	case "commentAltDots":
		return CommentAltDots()
	case "commentAltDownload":
		return CommentAltDownload()
	case "commentAltEdit":
		return CommentAltEdit()
	case "commentAltExclamation":
		return CommentAltExclamation()
	case "commentAltHeart":
		return CommentAltHeart()
	case "commentAltImage":
		return CommentAltImage()
	case "commentAltInfo":
		return CommentAltInfo()
	case "commentAltLines":
		return CommentAltLines()
	case "commentAltLock":
		return CommentAltLock()
	case "commentAltMedical":
		return CommentAltMedical()
	case "commentAltMessage":
		return CommentAltMessage()
	case "commentAltNotes":
		return CommentAltNotes()
	case "commentAltPlus":
		return CommentAltPlus()
	case "commentAltQuestion":
		return CommentAltQuestion()
	case "commentAltRedo":
		return CommentAltRedo()
	case "commentAltSearch":
		return CommentAltSearch()
	case "commentAltShare":
		return CommentAltShare()
	case "commentAltShield":
		return CommentAltShield()
	case "commentAltSlash":
		return CommentAltSlash()
	case "commentAltUpload":
		return CommentAltUpload()
	case "commentAltVerify":
		return CommentAltVerify()
	case "commentBlock":
		return CommentBlock()
	case "commentChartLine":
		return CommentChartLine()
	case "commentCheck":
		return CommentCheck()
	case "commentDots":
		return CommentDots()
	case "commentDownload":
		return CommentDownload()
	case "commentEdit":
		return CommentEdit()
	case "commentExclamation":
	...
	case "compressAlt":
		return CompressAlt()
	case "compressAltLeft":
		return CompressAltLeft()
	case "compressArrows":
		return CompressArrows()
	case "compressLines":
	...
	case "cornerDownRightAlt":
		return CornerDownRightAlt()
	case "cornerLeftDown":
	...
	case "cornerUpLeft":
		return CornerUpLeft()
	case "cornerUpLeftAlt":
		return CornerUpLeftAlt()
	case "cornerUpRight":
		return CornerUpRight()
	case "cornerUpRightAlt":
		return CornerUpRightAlt()
	case "coronavirus":
		return Coronavirus()
	...
	case "cropAlt":
		return CropAlt()
	case "cropAltRotateLeft":
		return CropAltRotateLeft()
	case "cropAltRotateRight":
		return CropAltRotateRight()
	case "crosshair":
		return Crosshair()
	case "crosshairAlt":
		return CrosshairAlt()
	...
	case "desktopAlt":
		return DesktopAlt()
	case "desktopAltSlash":
		return DesktopAltSlash()
	case "desktopCloudAlt":
		return DesktopCloudAlt()
	case "desktopSlash":
		return DesktopSlash()
	case "dialpad":
		return Dialpad()
	...
	case "documentInfo":
		return DocumentInfo()
	case "documentLayoutCenter":
		return DocumentLayoutCenter()
	case "documentLayoutLeft":
		return DocumentLayoutLeft()
	case "documentLayoutRight":
		return DocumentLayoutRight()
	case "dollarAlt":
		return DollarAlt()
	case "dollarSign":
		return DollarSign()
	case "dollarSignAlt":
		return DollarSignAlt()
	case "downloadAlt":
		return DownloadAlt()
	case "draggabledots":
		return Draggabledots()
	case "dribbble":
		return Dribbble()
	case "drill":
		return Drill()
	...
	case "eighteenPlus":
		return EighteenPlus()
	case "elipsisDoubleVAlt":
		return ElipsisDoubleVAlt()
	case "ellipsisH":
		return EllipsisH()
	case "ellipsisV":
		return EllipsisV()
	...
	case "envelopeBookmark":
		return EnvelopeBookmark()
	case "envelopeCheck":
		return EnvelopeCheck()
	case "envelopeDownload":
		return EnvelopeDownload()
	case "envelopeDownloadAlt":
		return EnvelopeDownloadAlt()
	case "envelopeEdit":
		return EnvelopeEdit()
	case "envelopeExclamation":
		return EnvelopeExclamation()
	case "envelopeHeart":
		return EnvelopeHeart()
	case "envelopeInfo":
		return EnvelopeInfo()
	case "envelopeLock":
		return EnvelopeLock()
	case "envelopeMinus":
		return EnvelopeMinus()
	case "envelopeOpen":
		return EnvelopeOpen()
	case "envelopeQuestion":
		return EnvelopeQuestion()
	case "envelopeReceive":
		return EnvelopeReceive()
	case "envelopeRedo":
		return EnvelopeRedo()
	case "envelopeSearch":
	...
	case "envelopeUploadAlt":
		return EnvelopeUploadAlt()
	case "envelopes":
		return Envelopes()
	case "equalCircle":
		return EqualCircle()
	...
	case "expandFromCorner":
		return ExpandFromCorner()
	case "expandLeft":
		return ExpandLeft()
	case "expandRight":
		return ExpandRight()
	...
	case "facebookMessengerAlt":
		return FacebookMessengerAlt()
	case "fahrenheit":
		return Fahrenheit()
	case "fastMail":
		return FastMail()
	...
	case "fileBlockAlt":
		return FileBlockAlt()
	case "fileBookmarkAlt":
		return FileBookmarkAlt()
	case "fileCheck":
		return FileCheck()
	case "fileCheckAlt":
		return FileCheckAlt()
	case "fileContract":
		return FileContract()
	case "fileContractDollar":
		return FileContractDollar()
	case "fileCopyAlt":
		return FileCopyAlt()
	case "fileDownload":
		return FileDownload()
	case "fileDownloadAlt":
		return FileDownloadAlt()
	case "fileEditAlt":
		return FileEditAlt()
	case "fileExclamation":
		return FileExclamation()
	case "fileExclamationAlt":
		return FileExclamationAlt()
	case "fileExport":
		return FileExport()
	case "fileGraph":
		return FileGraph()
	...
	case "fileInfoAlt":
		return FileInfoAlt()
	case "fileLandscape":
		return FileLandscape()
	case "fileLandscapeAlt":
		return FileLandscapeAlt()
	case "fileLanscapeSlash":
		return FileLanscapeSlash()
	case "fileLockAlt":
		return FileLockAlt()
	case "fileMedical":
		return FileMedical()
	...
	case "fileQuestion":
		return FileQuestion()
	case "fileQuestionAlt":
		return FileQuestionAlt()
	case "fileRedoAlt":
		return FileRedoAlt()
	case "fileSearchAlt":
		return FileSearchAlt()
	case "fileShareAlt":
		return FileShareAlt()
	case "fileShieldAlt":
		return FileShieldAlt()
	case "fileSlash":
		return FileSlash()
	case "fileTimes":
		return FileTimes()
	...
	case "fileUpload":
		return FileUpload()
	case "fileUploadAlt":
		return FileUploadAlt()
	case "filesLandscapes":
		return FilesLandscapes()
	case "filesLandscapesAlt":
		return FilesLandscapesAlt()
	case "film":
		return Film()
	case "filter":
		return Filter()
	...
	case "football":
		return Football()
	case "footballAmerican":
		return FootballAmerican()
	case "footballBall":
		return FootballBall()
	case "forecastcloudMoonTear":
		return ForecastcloudMoonTear()
	case "forwadedCall":
		return ForwadedCall()
	case "forward":
		return Forward()
	...
	case "glassMartiniAltSlash":
		return GlassMartiniAltSlash()
	case "glassTea":
		return GlassTea()
	case "globe":
		return Globe()
	...
	case "googleDrive":
		return GoogleDrive()
	case "googleDriveAlt":
		return GoogleDriveAlt()
	case "googleHangouts":
		return GoogleHangouts()
	case "googleHangoutsAlt":
		return GoogleHangoutsAlt()
	case "googlePlay":
		return GooglePlay()
	case "graduationCap":
	...
	case "grinTongueWinkAlt":
		return GrinTongueWinkAlt()
	case "gripHorizontalLine":
		return GripHorizontalLine()
	case "hardHat":
		return HardHat()
	case "hdd":
		return Hdd()
	...
	case "horizontalDistributionCenter":
		return HorizontalDistributionCenter()
	case "horizontalDistributionLeft":
		return HorizontalDistributionLeft()
	case "horizontalDistributionRight":
		return HorizontalDistributionRight()
	case "hospital":
		return Hospital()
	case "hospitalSquareSign":
		return HospitalSquareSign()
	case "hospitalSymbol":
	...
	case "imageRedo":
		return ImageRedo()
	case "imageResizeLandscape":
		return ImageResizeLandscape()
	case "imageResizeSquare":
		return ImageResizeSquare()
	case "imageSearch":
		return ImageSearch()
	case "imageShare":
		return ImageShare()
	...
	case "keyboardShow":
		return KeyboardShow()
	case "keyholeCircle":
		return KeyholeCircle()
	case "keyholeSquare":
		return KeyholeSquare()
	case "keyholeSquareFull":
		return KeyholeSquareFull()
	case "kid":
		return Kid()
	case "label":
		return Label()
	...
	case "laptopCloud":
		return LaptopCloud()
	case "laptopConnection":
		return LaptopConnection()
	case "laughing":
		return Laughing()
	case "layerGroup":
		return LayerGroup()
	case "layerGroupSlash":
		return LayerGroupSlash()
	case "layers":
		return Layers()
	case "layersAlt":
		return LayersAlt()
	case "layersSlash":
		return LayersSlash()
	case "leftArrowFromLeft":
		return LeftArrowFromLeft()
	case "leftArrowToLeft":
		return LeftArrowToLeft()
	case "leftIndent":
		return LeftIndent()
	case "leftIndentAlt":
		return LeftIndentAlt()
	case "leftToRightTextDirection":
		return LeftToRightTextDirection()
	case "letterChineseA":
		return LetterChineseA()
	case "letterEnglishA":
		return LetterEnglishA()
	case "letterHindiA":
		return LetterHindiA()
	case "letterJapaneseA":
		return LetterJapaneseA()
	case "lifeRing":
		return LifeRing()
	case "lightbulb":
		return Lightbulb()
	...
	case "locationArrowAlt":
		return LocationArrowAlt()
	case "locationPinAlt":
		return LocationPinAlt()
	case "locationPoint":
	...
	case "mapMarkerShield":
		return MapMarkerShield()
	case "mapMarkerSlash":
		return MapMarkerSlash()
	case "mapPin":
		return MapPin()
	case "mapPinAlt":
		return MapPinAlt()
	...
	case "medicalDrip":
		return MedicalDrip()
	case "medicalSquare":
		return MedicalSquare()
	case "medicalSquareFull":
		return MedicalSquareFull()
	case "mediumM":
		return MediumM()
	case "medkit":
		return Medkit()
	...
	case "minusSquare":
		return MinusSquare()
	case "minusSquareFull":
		return MinusSquareFull()
	case "missedCall":
		return MissedCall()
	case "mobileAndroid":
		return MobileAndroid()
	case "mobileAndroidAlt":
		return MobileAndroidAlt()
	case "mobileVibrate":
	...
	case "moneyBill":
		return MoneyBill()
	case "moneyBillSlash":
		return MoneyBillSlash()
	case "moneyBillStack":
		return MoneyBillStack()
	case "moneyInsert":
		return MoneyInsert()
	case "moneyStack":
		return MoneyStack()
	...
	case "monitor":
		return Monitor()
	case "monitorHeartRate":
		return MonitorHeartRate()
	case "moon":
		return Moon()
	case "moonEclipse":
		return MoonEclipse()
	...
	case "presentationLinesAlt":
		return PresentationLinesAlt()
	case "presentationMinus":
		return PresentationMinus()
	case "presentationPlay":
		return PresentationPlay()
	case "presentationPlus":
		return PresentationPlus()
	...
	case "restaurant":
		return Restaurant()
	case "rightIndentAlt":
		return RightIndentAlt()
	case "rightToLeftTextDirection":
		return RightToLeftTextDirection()
	case "robot":
		return Robot()
	case "rocket":
		return Rocket()
	case "ropeWay":
		return RopeWay()
	case "rotateThreeHundredSixty":
		return RotateThreeHundredSixty()
	case "rss":
		return Rss()
	case "rssAlt":
		return RssAlt()
	...
	case "serverNetworkAlt":
		return ServerNetworkAlt()
	case "servers":
		return Servers()
	case "servicemark":
		return Servicemark()
	...
	case "shoppingCart":
		return ShoppingCart()
	case "shoppingCartAlt":
		return ShoppingCartAlt()
	case "shovel":
		return Shovel()
	case "shrink":
		return Shrink()
	...
	case "skipForward":
		return SkipForward()
	case "skipForwardAlt":
		return SkipForwardAlt()
	case "skipForwardCircle":
		return SkipForwardCircle()
	case "skype":
		return Skype()
	case "skypeAlt":
		return SkypeAlt()
	...
	case "smileDizzy":
		return SmileDizzy()
	case "smileSquintWink":
		return SmileSquintWink()
	case "smileSquintWinkAlt":
		return SmileSquintWinkAlt()
	case "smileWink":
		return SmileWink()
	case "smileWinkAlt":
		return SmileWinkAlt()
	...
	case "stepBackward":
		return StepBackward()
	case "stepBackwardAlt":
		return StepBackwardAlt()
	case "stepBackwardCircle":
		return StepBackwardCircle()
	case "stepForward":
		return StepForward()
	case "stethoscope":
		return Stethoscope()
	case "stethoscopeAlt":
		return StethoscopeAlt()
	case "stopCircle":
		return StopCircle()
	case "stopwatch":
		return Stopwatch()
	case "stopwatchSlash":
		return StopwatchSlash()
	case "store":
		return Store()
	case "storeAlt":
		return StoreAlt()
	...
	case "sync":
		return Sync()
	case "syncExclamation":
		return SyncExclamation()
	case "syncSlash":
		return SyncSlash()
	case "syringe":
		return Syringe()
	...
	case "tablets":
		return Tablets()
	case "tachometerFast":
		return TachometerFast()
	case "tachometerFastAlt":
		return TachometerFastAlt()
	case "tag":
		return Tag()
	case "tagAlt":
		return TagAlt()
	...
	case "temperatureMinus":
		return TemperatureMinus()
	case "temperaturePlus":
		return TemperaturePlus()
	case "temperatureQuarter":
		return TemperatureQuarter()
	case "temperatureThreeQuarter":
		return TemperatureThreeQuarter()
	case "tenPlus":
		return TenPlus()
	case "tennisBall":
		return TennisBall()
	...
	case "thunderstorm":
		return Thunderstorm()
	case "thunderstormMoon":
		return ThunderstormMoon()
	case "thunderstormSun":
	...
	case "toiletPaper":
		return ToiletPaper()
	case "topArrowFromTop":
		return TopArrowFromTop()
	case "topArrowToTop":
		return TopArrowToTop()
	case "tornado":
		return Tornado()
	case "trademark":
		return Trademark()
	case "trademarkCircle":
		return TrademarkCircle()
	case "trafficBarrier":
	...
	case "vectorSquare":
		return VectorSquare()
	case "vectorSquareAlt":
		return VectorSquareAlt()
	case "venus":
		return Venus()
	...
	case "verticalDistributeBottom":
		return VerticalDistributeBottom()
	case "verticalDistributionCenter":
		return VerticalDistributionCenter()
	case "verticalDistributionTop":
		return VerticalDistributionTop()
	case "video":
		return Video()
	case "videoQuestion":
	...
	case "voicemail":
		return Voicemail()
	case "voicemailRectangle":
		return VoicemailRectangle()
	case "volleyball":
		return Volleyball()
	case "volume":
		return Volume()
