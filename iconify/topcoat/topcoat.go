...
func Listview(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 24px; height: 24px; display: block;"),
		g.Raw(`<path fill="currentColor" d="M39.5 10.5v-1c0-1.47-.48-2-2-2h-34c-1.53 0-2 .52-2 2v1c0 1.55.52 2 2 2h34c1.5 0 2-.48 2-2zm0 11v-1c0-1.47-.48-2-2-2h-34c-1.53 0-2 .52-2 2v1c0 1.55.52 2 2 2h34c1.5 0 2-.48 2-2zm0 11v-1c0-1.471-.48-2-2-2h-34c-1.53 0-2 .52-2 2v1c0 1.55.52 2 2 2h34c1.5 0 2-.48 2-2z"/>`),
		g.Group(children),
	)
}
