...
func CovidCarrierBloodOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidCarrierBloodOnePath), g.Group(children))
}

func CovidCarrierBloodTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidCarrierBloodTwoPath), g.Group(children))
}

func CovidCarrierHuman(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidCarrierHumanPath), g.Group(children))
}

func CovidCarrierPackages(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidCarrierPackagesPath), g.Group(children))
}

func CovidNineteenVirusBat(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusBatPath), g.Group(children))
}

func CovidNineteenVirusFour(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusFourPath), g.Group(children))
}

func CovidNineteenVirusHealOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusHealOnePath), g.Group(children))
}

func CovidNineteenVirusHealTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusHealTwoPath), g.Group(children))
}

func CovidNineteenVirusLifelongOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusLifelongOnePath), g.Group(children))
}

func CovidNineteenVirusLifelongTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusLifelongTwoPath), g.Group(children))
}

func CovidNineteenVirusOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusOnePath), g.Group(children))
}

func CovidNineteenVirusPandemicOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusPandemicOnePath), g.Group(children))
}

func CovidNineteenVirusPandemicThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusPandemicThreePath), g.Group(children))
}

func CovidNineteenVirusPandemicTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusPandemicTwoPath), g.Group(children))
}

func CovidNineteenVirusPatientOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusPatientOnePath), g.Group(children))
}

func CovidNineteenVirusPatientTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusPatientTwoPath), g.Group(children))
}

func CovidNineteenVirusReinfected(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusReinfectedPath), g.Group(children))
}

func CovidNineteenVirusThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusThreePath), g.Group(children))
}

func CovidNineteenVirusTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusTwoPath), g.Group(children))
}

func CovidNineteenVirusWarningOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusWarningOnePath), g.Group(children))
}

func CovidNineteenVirusWarningThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusWarningThreePath), g.Group(children))
}

func CovidNineteenVirusWarningTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(covidNineteenVirusWarningTwoPath), g.Group(children))
}

func GraphCuredDecreasing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphCuredDecreasingPath), g.Group(children))
}

func GraphCuredIncreasing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphCuredIncreasingPath), g.Group(children))
}

func GraphCuredStable(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphCuredStablePath), g.Group(children))
}

func GraphDeathRateDecreasing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphDeathRateDecreasingPath), g.Group(children))
}

func GraphDeathRateIncreasing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphDeathRateIncreasingPath), g.Group(children))
}

func GraphDeathRateStable(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphDeathRateStablePath), g.Group(children))
}

func GraphDocumentInfectedReport(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphDocumentInfectedReportPath), g.Group(children))
}

func GraphInfectedDecreasing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphInfectedDecreasingPath), g.Group(children))
}

func GraphInfectedIncreasing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphInfectedIncreasingPath), g.Group(children))
}

func GraphInfectedStable(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(graphInfectedStablePath), g.Group(children))
}

func MutationOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mutationOnePath), g.Group(children))
}

func MutationStronger(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mutationStrongerPath), g.Group(children))
}

func MutationTemperatureChange(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mutationTemperatureChangePath), g.Group(children))
}

func MutationTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mutationTwoPath), g.Group(children))
}

func PersonalHygieneCleanBottleShield(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneCleanBottleShieldPath), g.Group(children))
}

func PersonalHygieneCleanBottleVirus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneCleanBottleVirusPath), g.Group(children))
}

func PersonalHygieneCleanBottleVirusBlock(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneCleanBottleVirusBlockPath), g.Group(children))
}

func PersonalHygieneCleanGel(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneCleanGelPath), g.Group(children))
}

func PersonalHygieneCleanToothpaste(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneCleanToothpastePath), g.Group(children))
}

func PersonalHygieneHandLiquidSoap(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandLiquidSoapPath), g.Group(children))
}

func PersonalHygieneHandSanitizerLiquidDrop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSanitizerLiquidDropPath), g.Group(children))
}

func PersonalHygieneHandSanitizerLiquidOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSanitizerLiquidOnePath), g.Group(children))
}

func PersonalHygieneHandSanitizerLiquidThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSanitizerLiquidThreePath), g.Group(children))
}

func PersonalHygieneHandSanitizerLiquidTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSanitizerLiquidTwoPath), g.Group(children))
}

func PersonalHygieneHandSanitizerLiquidVirusBlock(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSanitizerLiquidVirusBlockPath), g.Group(children))
}

func PersonalHygieneHandSanitizerSpray(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSanitizerSprayPath), g.Group(children))
}

func PersonalHygieneHandSanitizerSprayVirusBlock(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSanitizerSprayVirusBlockPath), g.Group(children))
}

func PersonalHygieneHandSanitizerVirusBlock(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSanitizerVirusBlockPath), g.Group(children))
}

func PersonalHygieneHandSanitizerVirusShield(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSanitizerVirusShieldPath), g.Group(children))
}

func PersonalHygieneHandSoapOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSoapOnePath), g.Group(children))
}

func PersonalHygieneHandSoapTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandSoapTwoPath), g.Group(children))
}

func PersonalHygieneHandWash(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandWashPath), g.Group(children))
}

func PersonalHygieneHandWipePaperFour(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandWipePaperFourPath), g.Group(children))
}

func PersonalHygieneHandWipePaperOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandWipePaperOnePath), g.Group(children))
}

func PersonalHygieneHandWipePaperThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandWipePaperThreePath), g.Group(children))
}

func PersonalHygieneHandWipePaperTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalHygieneHandWipePaperTwoPath), g.Group(children))
}

func QuarantinePlaceBed(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceBedPath), g.Group(children))
}

func QuarantinePlaceHospital(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceHospitalPath), g.Group(children))
}

func QuarantinePlaceHouseOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceHouseOnePath), g.Group(children))
}

func QuarantinePlaceHouseShield(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceHouseShieldPath), g.Group(children))
}

func QuarantinePlaceHouseTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceHouseTwoPath), g.Group(children))
}

func QuarantinePlaceSelfLockdownOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceSelfLockdownOnePath), g.Group(children))
}

func QuarantinePlaceSelfLockdownTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceSelfLockdownTwoPath), g.Group(children))
}

func QuarantinePlaceTimeCalendarDay(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceTimeCalendarDayPath), g.Group(children))
}

func QuarantinePlaceTimeCalendarOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceTimeCalendarOnePath), g.Group(children))
}

func QuarantinePlaceTimeCalendarTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceTimeCalendarTwoPath), g.Group(children))
}

func QuarantinePlaceTimeDateDay(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quarantinePlaceTimeDateDayPath), g.Group(children))
}

func SocialDistancingAttention(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingAttentionPath), g.Group(children))
}

func SocialDistancingCorrectFive(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingCorrectFivePath), g.Group(children))
}

func SocialDistancingCorrectFour(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingCorrectFourPath), g.Group(children))
}

func SocialDistancingCorrectOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingCorrectOnePath), g.Group(children))
}

func SocialDistancingCorrectSix(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingCorrectSixPath), g.Group(children))
}

func SocialDistancingCorrectThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingCorrectThreePath), g.Group(children))
}

func SocialDistancingCorrectTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingCorrectTwoPath), g.Group(children))
}

func SocialDistancingDoNotCloseFour(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingDoNotCloseFourPath), g.Group(children))
}

func SocialDistancingDoNotCloseOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingDoNotCloseOnePath), g.Group(children))
}

func SocialDistancingDoNotCloseThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingDoNotCloseThreePath), g.Group(children))
}

func SocialDistancingDoNotCloseTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingDoNotCloseTwoPath), g.Group(children))
}

func SocialDistancingDoNotTouch(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingDoNotTouchPath), g.Group(children))
}

func SocialDistancingMan(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingManPath), g.Group(children))
}

func SocialDistancingNotAllowedSpaceMan(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingNotAllowedSpaceManPath), g.Group(children))
}

func SocialDistancingNotAllowedSpaceWoman(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingNotAllowedSpaceWomanPath), g.Group(children))
}

func SocialDistancingOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingOnePath), g.Group(children))
}

func SocialDistancingProtectShieldOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingProtectShieldOnePath), g.Group(children))
}

func SocialDistancingProtectShieldTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingProtectShieldTwoPath), g.Group(children))
}

func SocialDistancingTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingTwoPath), g.Group(children))
}

func SocialDistancingVirus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingVirusPath), g.Group(children))
}

func SocialDistancingWoman(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingWomanPath), g.Group(children))
}

func SymptomsColdFever(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsColdFeverPath), g.Group(children))
}

func SymptomsFever(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsFeverPath), g.Group(children))
}

func SymptomsNausea(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsNauseaPath), g.Group(children))
}

func SymptomsVirusDiarrheaOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsVirusDiarrheaOnePath), g.Group(children))
}

func SymptomsVirusDiarrheaTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsVirusDiarrheaTwoPath), g.Group(children))
}

func SymptomsVirusHeadacheOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsVirusHeadacheOnePath), g.Group(children))
}

func SymptomsVirusHeadacheTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsVirusHeadacheTwoPath), g.Group(children))
}

func SymptomsVirusLossSmellOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsVirusLossSmellOnePath), g.Group(children))
}

func SymptomsVirusLossSmellTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsVirusLossSmellTwoPath), g.Group(children))
}

func SymptomsVirusLungDamage(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsVirusLungDamagePath), g.Group(children))
}

func SymptomsVirusStomach(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symptomsVirusStomachPath), g.Group(children))
}

func TransmissionVirusAirplaneFlight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusAirplaneFlightPath), g.Group(children))
}

func TransmissionVirusBriefcase(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusBriefcasePath), g.Group(children))
}

func TransmissionVirusCough(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusCoughPath), g.Group(children))
}

func TransmissionVirusCrowd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusCrowdPath), g.Group(children))
}

func TransmissionVirusExpand(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusExpandPath), g.Group(children))
}

func TransmissionVirusFloatWind(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusFloatWindPath), g.Group(children))
}

func TransmissionVirusHandshake(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusHandshakePath), g.Group(children))
}

func TransmissionVirusHumanInfected(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusHumanInfectedPath), g.Group(children))
}

func TransmissionVirusHumanTransmitOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusHumanTransmitOnePath), g.Group(children))
}

func TransmissionVirusHumanTransmitTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusHumanTransmitTwoPath), g.Group(children))
}

func TransmissionVirusIncreaseRate(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusIncreaseRatePath), g.Group(children))
}

func TransmissionVirusInhale(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusInhalePath), g.Group(children))
}

func TransmissionVirusMobileApplication(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusMobileApplicationPath), g.Group(children))
}

func TransmissionVirusRatMouse(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusRatMousePath), g.Group(children))
}

func TransmissionVirusTouchFinger(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusTouchFingerPath), g.Group(children))
}

func TransmissionVirusTouchHandOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusTouchHandOnePath), g.Group(children))
}

func TransmissionVirusTouchHandTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusTouchHandTwoPath), g.Group(children))
}

func TransmissionVirusTransmit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusTransmitPath), g.Group(children))
}

func TransmissionVirusTransportation(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusTransportationPath), g.Group(children))
}

func TransmissionVirusTrashBin(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusTrashBinPath), g.Group(children))
}

func TransmissionVirusVisible(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusVisiblePath), g.Group(children))
}

func TransmissionVirusWindBreath(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transmissionVirusWindBreathPath), g.Group(children))
}

func VaccineProtectionFaceMaskOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionFaceMaskOnePath), g.Group(children))
}

func VaccineProtectionFaceMaskThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionFaceMaskThreePath), g.Group(children))
}

func VaccineProtectionFaceMaskTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionFaceMaskTwoPath), g.Group(children))
}

func VaccineProtectionFaceShieldOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionFaceShieldOnePath), g.Group(children))
}

func VaccineProtectionFaceShieldTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionFaceShieldTwoPath), g.Group(children))
}

func VaccineProtectionInfraredThermometerGun(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionInfraredThermometerGunPath), g.Group(children))
}

func VaccineProtectionMedicinePill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionMedicinePillPath), g.Group(children))
}

func VaccineProtectionPeopleShield(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionPeopleShieldPath), g.Group(children))
}

func VaccineProtectionSanitizerSpray(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionSanitizerSprayPath), g.Group(children))
}

func VaccineProtectionShield(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionShieldPath), g.Group(children))
}

func VaccineProtectionSyringe(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionSyringePath), g.Group(children))
}

func VaccineProtectionVirus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionVirusPath), g.Group(children))
}

func VaccineProtectionWashHands(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vaccineProtectionWashHandsPath), g.Group(children))
}

func VirusLabResearchMagnifierOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(virusLabResearchMagnifierOnePath), g.Group(children))
}

func VirusLabResearchMagnifierTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(virusLabResearchMagnifierTwoPath), g.Group(children))
}

func VirusLabResearchMedicinePill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(virusLabResearchMedicinePillPath), g.Group(children))
}

func VirusLabResearchMicroscope(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(virusLabResearchMicroscopePath), g.Group(children))
}

func VirusLabResearchSyringe(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(virusLabResearchSyringePath), g.Group(children))
}

func VirusLabResearchTestTube(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(virusLabResearchTestTubePath), g.Group(children))
}
