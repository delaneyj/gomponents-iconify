...
func CovidNineteenVirusPandemicThree(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M17.851 8.875a2.94 2.94 0 1 0 0-5.88a2.94 2.94 0 0 0 0 5.88M17.361.79h.98m-.49 0v2.205m3.292-1.045l.693.693m-.347-.346L19.93 3.856m3.066 1.589v.98m0-.49h-2.205m1.045 3.292l-.693.693m.346-.347L19.93 8.014m-1.589 3.066h-.98m.49 0V8.875M14.56 9.92l-.693-.693m.346.346l1.559-1.559m-3.066-1.589v-.98m0 .49h2.205m-1.044-3.292l.693-.693m-.347.347l1.559 1.559m4.515 9.806a9.6 9.6 0 0 1-.606 3.264m-1.809 3.024a9.6 9.6 0 0 1-2.588 2.083m-3.351 1.094c-1.106.143-2.227.1-3.319-.127m-3.253-1.358a9.8 9.8 0 0 1-2.418-2.274m-1.571-3.155a9.2 9.2 0 0 1-.341-3.3m.88-3.413a9.7 9.7 0 0 1 1.9-2.726m2.901-2.002a9.8 9.8 0 0 1 3.22-.808m6.499 9.814A5.789 5.789 0 1 1 10 7.822"/><path d="m8.772 8.1l.355 1.447A1.29 1.29 0 0 1 8.84 10.7l-.653.738a1.3 1.3 0 0 0-.307.65L7.671 13.4a1.285 1.285 0 0 1-1.094 1.071l-1.612.223m11.223.547l-2.073-.885a1.287 1.287 0 0 0-1.764.921l-.27 1.293c-.052.248-.029.507.066.742l.657 1.634"/></g>`), g.Group(children),
	)
}
...
func CovidNineteenVirusPandemicTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M13.885 6.648a5.352 5.352 0 0 1 0 10.7m-.892-14.713h1.784m-.892 0v4.013m5.991-1.901l1.262 1.261m-.631-.63l-2.838 2.838m5.581 2.892v1.784m0-.892h-4.014m1.902 5.992l-1.262 1.261m.631-.631l-2.838-2.838m-2.892 5.581h-1.784m.892 0v-4.013M10.25 21.5a9.5 9.5 0 0 1 0-19z"/><path d="M10.25 2.5A10.92 10.92 0 0 0 5.5 12a10.92 10.92 0 0 0 4.75 9.5m0-12.571H1.665M10 15.071H1.415"/></g>`), g.Group(children),
	)
}
...
func PersonalHygieneHandSanitizerLiquidThree(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M9.125 20.076a6.505 6.505 0 0 1-8-6.326c0-4.875 6.5-13 6.5-13a46.4 46.4 0 0 1 5.306 8.5"/><path d="M22.875 15.75a7.67 7.67 0 0 1-6 7.5a7.67 7.67 0 0 1-6-7.5V13.5a1.5 1.5 0 0 1 1.5-1.5h9a1.5 1.5 0 0 1 1.5 1.5zm-6-.75v4.5m-2.25-2.25h4.5m-11.5 0a3.5 3.5 0 0 1-3.5-3.5"/></g>`), g.Group(children),
	)
}
...
func PersonalHygieneHandWipePaperTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M23.083 7.916a3.583 3.583 0 0 1-7.166 0C15.917 5.229 19.5.75 19.5.75s3.583 4.479 3.583 7.166m-5.264 6.335c.859 2.035 2.006 3.466-.084 6h-4.818m-6-10.201c-3.314 0-6-1.074-6-2.4v13.2c0 1.326 2.686 2.4 6 2.4s6-1.074 6-2.4V7.65c0 1.326-2.687 2.4-6 2.4"/><path d="M6.917 10.05c3.314 0 6-1.075 6-2.4s-2.686-2.4-6-2.4s-6 1.075-6 2.4s2.686 2.4 6 2.4m-.6-2.4h1.2m-.6-2.4h6.47"/></g>`), g.Group(children),
	)
}
...
func QuarantinePlaceSelfLockdownTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M12 11.25a2.25 2.25 0 1 0 0-4.5a2.25 2.25 0 0 0 0 4.5m1.5 12l.75-4.5h1.5V16.5a3.75 3.75 0 0 0-7.5 0v2.25h1.5l.75 4.5z"/><path d="M22.873 8.949L20.5 7.161V1.25H16v2.518L12 .75L1.127 8.949c-.224.208-.36.495-.377.8v12.522a.98.98 0 0 0 .978.979h20.544a.98.98 0 0 0 .978-.979V9.75a1.2 1.2 0 0 0-.377-.801"/></g>`), g.Group(children),
	)
}
...
func QuarantinePlaceTimeCalendarDay(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5"><path stroke-linecap="round" d="M6.75 12.007h2v8m8.5-3h-5.5c0-3 4-5 4-5v8"/><path stroke-linecap="round" d="M21.75 3.007H2.25a1.5 1.5 0 0 0-1.5 1.5v17a1.5 1.5 0 0 0 1.5 1.5h19.5a1.5 1.5 0 0 0 1.5-1.5v-17a1.5 1.5 0 0 0-1.5-1.5"/><path d="M.75 8.507h22.5"/><path stroke-linecap="round" d="M7.25 4.993v-4m9 4v-4"/></g>`), g.Group(children),
	)
}
...
func SocialDistancingCorrectTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4.974 19.375a2.625 2.625 0 1 0 0-5.25a2.625 2.625 0 0 0 0 5.25m4.226 3.75a4.473 4.473 0 0 0-8.449 0m18.275-3.75a2.625 2.625 0 1 0 0-5.25a2.625 2.625 0 0 0 0 5.25m4.224 3.75a4.473 4.473 0 0 0-8.449 0M5 8.875v2m14-2v2m-14-1h14m-10-7l2 2l4-4"/>`), g.Group(children),
	)
}
...
func SocialDistancingNotAllowedSpaceMan(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.75a3 3 0 1 0 0-6a3 3 0 0 0 0 6m5.25 6.75a5.25 5.25 0 1 0-10.5 0v2.25H9l.75 7.5h4.5l.75-7.5h2.25zM1 18.991l4 4m0-4l-4 4m18-4l4 4m0-4l-4 4"/>`), g.Group(children),
	)
}
...
func SocialDistancingTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M4.974 17.375a2.625 2.625 0 1 0 0-5.25a2.625 2.625 0 0 0 0 5.25m4.226 3.75a4.473 4.473 0 0 0-8.449 0m18.275-3.75a2.625 2.625 0 1 0 0-5.25a2.625 2.625 0 0 0 0 5.25m4.224 3.75a4.473 4.473 0 0 0-8.449 0"/><path d="M6 3.75A.375.375 0 1 1 6 3m0 .75A.375.375 0 1 0 6 3m6 .75A.375.375 0 0 1 12 3m0 .75A.375.375 0 0 0 12 3m6 .75A.375.375 0 0 1 18 3m0 .75A.375.375 0 0 0 18 3"/></g>`), g.Group(children),
	)
}
...
func SymptomsFever(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M6.01 16.607a3.495 3.495 0 1 0 0-6.99a3.495 3.495 0 0 0 0 6.99m5.242 6.616a5.243 5.243 0 0 0-10.485 0m20.968-7.821V3.751a2.996 2.996 0 1 0-5.991 0v11.651a4.493 4.493 0 1 0 5.991 0M18.74 5.249v11.983"/><path d="M18.74 20.227a1.498 1.498 0 1 0 0-2.995a1.498 1.498 0 0 0 0 2.995M2.014 7.745a2.47 2.47 0 0 1 0-3.495a2.47 2.47 0 0 0 0-3.495m3.721 6.99a2.47 2.47 0 0 1 0-3.495a2.47 2.47 0 0 0 0-3.495m3.995 6.99a2.47 2.47 0 0 1 0-3.495a2.473 2.473 0 0 0 0-3.495"/></g>`), g.Group(children),
	)
}
...
func TransmissionVirusBriefcase(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M12.369 11.107a2.857 2.857 0 1 0 0-5.714a2.857 2.857 0 0 0 0 5.714m-.476-7.857h.952m-.476 0v2.143m3.199-1.015l.673.673m-.336-.337L14.389 6.23m2.98 1.544v.952m0-.476h-2.143m1.015 3.199l-.673.673m.337-.336l-1.516-1.516m-1.544 2.98h-.952m.476 0v-2.143M9.17 12.122l-.673-.673m.337.337l1.515-1.516m-2.98-1.544v-.952m0 .476h2.143M8.497 5.051l.673-.673m-.336.336l1.515 1.516M6.75 2.25V.75m10.5 1.5V.75m-9.75 18a1.5 1.5 0 0 0 1.5 1.5h6a1.5 1.5 0 0 0 1.5-1.5"/><path d="M22.25 15.75H1.75a1 1 0 0 0-1 1v5.5a1 1 0 0 0 1 1h20.5a1 1 0 0 0 1-1v-5.5a1 1 0 0 0-1-1m-6.5-13.5h3.75a1.5 1.5 0 0 1 1.5 1.5v12m-18 0v-12a1.5 1.5 0 0 1 1.5-1.5h3.94"/></g>`), g.Group(children),
	)
}
...
func TransmissionVirusFloatWind(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.926 19.117a4.857 4.857 0 1 0 0-9.714a4.857 4.857 0 0 0 0 9.714m-.81-13.357h1.619m-.809 0v3.642m7.126-8.162l1.374.857m-.687-.428L16.811 4.76m3.618 2.851l1.145 1.145m-.572-.572l-2.576 2.576m-.917 8.938l-1.145 1.144m.572-.572l-2.576-2.576m-2.625 5.066h-1.619m.81 0v-3.643m-5.438 1.725l-1.145-1.144m.572.572l2.576-2.576m-5.065-2.625V13.45m0 .81h3.643M4.343 8.822l1.145-1.145m-.573.572l2.576 2.576"/>`), g.Group(children),
	)
}
...
func TransmissionVirusHumanTransmitOne(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M17.25 20.55a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858m-.571-9.429h1.142m-.571 0v2.572m3.839-1.218l.808.808m-.404-.404l-1.819 1.818m3.576 1.853v1.143m0-.572h-2.571m1.218 3.839l-.808.808m.404-.404l-1.819-1.818m-1.853 3.575h-1.142m.571 0V20.55m-3.839 1.218l-.808-.808m.404.404l1.819-1.818m-3.576-1.853V16.55m0 .571h2.571m-1.218-3.838l.808-.808m-.404.404l1.819 1.818M6.167 10.5a3.311 3.311 0 1 0 0-6.622a3.311 3.311 0 0 0 0 6.622M.75 17.121a5.42 5.42 0 0 1 7.55-4.982m5.707-4.26l.243-.97a4 4 0 0 1 3.88-3.03h4.877"/><path d="m20.007 6.879l3-3l-3-3"/></g>`), g.Group(children),
	)
}
...
func TransmissionVirusTransportation(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M17.25 10.514a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858m-.571-9.429h1.142m-.571 0v2.572m3.839-1.218l.808.808m-.404-.404l-1.819 1.818m3.576 1.853v1.143m0-.572h-2.571m1.218 3.839l-.808.808m.404-.404L19.674 9.51m-1.853 3.575h-1.142m.571 0v-2.571m-3.839 1.218l-.808-.808m.404.404l1.819-1.818M11.25 7.657V6.514m0 .571h2.571m-1.218-3.838l.808-.808m-.404.404l1.819 1.818M9.75 10.915h-1.5a1.5 1.5 0 0 0-1.5 1.5V19.2m11.212 2.215h.788a1.5 1.5 0 0 0 1.5-1.5v-4.83m-13.5-2.67h-3a3 3 0 0 0-3 3v4.5a1.5 1.5 0 0 0 1.5 1.5h2.287"/><path d="M6.375 22.915a1.875 1.875 0 1 0 0-3.75a1.875 1.875 0 0 0 0 3.75m9.75 0a1.875 1.875 0 1 0 0-3.75a1.875 1.875 0 0 0 0 3.75m-7.913-1.5h6.076M.75 17.016h6"/></g>`), g.Group(children),
	)
}
...
func VaccineProtectionFaceShieldTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M18.167 17.107V15.06H19.7a1.02 1.02 0 0 0 .935-1.435c-1-2.239-2.476-4.994-2.476-4.994V6.45a2 2 0 0 0-.18-.847c-1.111-2.409-2.617-4.074-5.5-4.652C6.611-.224.807 3.887.763 9.871a9.2 9.2 0 0 0 3.071 6.937v6.442m10.238 0v-1.34M.777 9.433h10.418"/><path d="M11.2 4.628h8.042a4 4 0 0 1 4 4v11.577H18.2a7 7 0 0 1-7-7zm-.005 0H2.528"/></g>`), g.Group(children),
	)
}
...
func VaccineProtectionMedicinePill(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M8.6 16.4a4.6 4.6 0 0 1-6.5-6.5l7.8-7.8a4.6 4.6 0 0 1 6.5 6.5M5.999 5.999l4.25 4.25"/><path d="M23.25 15.75a7.67 7.67 0 0 1-6 7.5a7.67 7.67 0 0 1-6-7.5V13.5a1.5 1.5 0 0 1 1.5-1.5h9a1.5 1.5 0 0 1 1.5 1.5zm-6-.75v4.5M15 17.25h4.5"/></g>`), g.Group(children),
	)
}
...
func VaccineProtectionShield(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M12.125 14.339a3.714 3.714 0 1 0 0-7.428a3.714 3.714 0 0 0 0 7.428m-.619-10.214h1.238m-.619 0v2.786m4.158-1.321l.876.877m-.438-.438l-1.97 1.97m3.874 2.007v1.238m0-.619h-2.786m1.32 4.158l-.876.876m.438-.438l-1.97-1.97m-2.007 3.874h-1.238m.619 0v-2.786m-4.158 1.32l-.876-.876m.438.438l1.97-1.97m-3.874-2.007v-1.238m0 .619h2.786m-1.32-4.158l.876-.876m-.438.438l1.97 1.97"/><path d="M2.25 3.923v7.614c0 3.723 1.629 8.8 8.673 11.513a3 3 0 0 0 2.154 0c7.041-2.708 8.673-7.822 8.673-11.513V3.923a1.49 1.49 0 0 0-.868-1.362A21.7 21.7 0 0 0 12 .75a21.7 21.7 0 0 0-8.882 1.811a1.49 1.49 0 0 0-.868 1.362"/></g>`), g.Group(children),
	)
}
...
func VaccineProtectionWashHands(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 4.5h-3a1.5 1.5 0 0 0 0-3H8.158a4.5 4.5 0 0 0-3.744 2L3.2 5.332A1.5 1.5 0 0 1 1.947 6H.75m11-1.5H14M.75 21.75h1.9c.233 0 .463.054.671.158l1.733.867a4.5 4.5 0 0 0 2.012.475H18.75a1.5 1.5 0 1 0 0-3H21a1.5 1.5 0 1 0 0-3h.75a1.5 1.5 0 1 0 0-3h-1.5a1.5 1.5 0 1 0 0-3H15a1.5 1.5 0 1 0 0-3H9.158a4.5 4.5 0 0 0-3.744 2L4.2 12.082a1.5 1.5 0 0 1-1.248.668H.75m12-1.5H15m1.5 6H21m-4.5-3h3.75m-4.5 6h3M21.007.75a.455.455 0 0 1 .423.289c.414 1.063 1.82 4.749 1.82 5.789a2.21 2.21 0 1 1-4.421 0c0-1.062 1.465-4.878 1.845-5.851a.36.36 0 0 1 .333-.227"/>`), g.Group(children),
	)
}
