...
func CovidCarrierHuman(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M11.857 20.628a3.163 3.163 0 1 0 0-6.326a3.163 3.163 0 0 0 0 6.326Zm-.527-8.698h1.054m-.527 0v2.372m3.541-1.124l.746.746m-.373-.373l-1.677 1.677m3.298 1.71v1.054m0-.527H15.02m1.124 3.541l-.746.746m.373-.373l-1.677-1.678M12.384 23H11.33m.527 0v-2.372m-3.541 1.124l-.745-.746m.372.373l1.678-1.678m-3.299-1.709v-1.054m0 .527h2.372m-1.123-3.541l.745-.746m-.373.373l1.678 1.677"/><path d="M9.357 9.004a4.529 4.529 0 1 1 5.286 0a8.41 8.41 0 0 1 5.769 7.98v6.219"/><path d="M3.588 23.203v-6.218a8.41 8.41 0 0 1 5.769-7.981"/></g>`), g.Group(children),
	)
}
...
func CovidNineteenVirusPandemicTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M13.885 6.648a5.352 5.352 0 0 1 0 10.7m-.892-14.713h1.784m-.892 0v4.013m5.991-1.901l1.262 1.261m-.631-.63l-2.838 2.838m5.581 2.892v1.784m0-.892h-4.014m1.902 5.992l-1.262 1.261m.631-.631l-2.838-2.838m-2.892 5.581h-1.784m.892 0v-4.013M10.25 21.5a9.5 9.5 0 0 1 0-19v19Z"/><path d="M10.25 2.5A10.924 10.924 0 0 0 5.5 12a10.924 10.924 0 0 0 4.75 9.5m0-12.571H1.665M10 15.071H1.415"/></g>`), g.Group(children),
	)
}

func CovidNineteenVirusPatientOne(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.25 20.679a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858Zm-.571-9.429h1.142m-.571 0v2.571m3.839-1.218l.808.808m-.404-.404l-1.819 1.819m3.576 1.853v1.142m0-.571h-2.571m1.218 3.839l-.808.808m.404-.404l-1.819-1.819m-1.853 3.576h-1.142m.571 0v-2.571m-3.839 1.218l-.808-.808m.404.404l1.819-1.819m-3.576-1.853v-1.142m0 .571h2.571m-1.218-3.839l.808-.808m-.404.404l1.819 1.819M7.5 9a4.125 4.125 0 1 0 0-8.25A4.125 4.125 0 0 0 7.5 9ZM.75 17.25a6.753 6.753 0 0 1 9.4-6.208"/>`), g.Group(children),
	)
}
...
func PersonalHygieneHandSanitizerLiquidThree(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M9.125 20.076a6.505 6.505 0 0 1-8-6.326c0-4.875 6.5-13 6.5-13a46.389 46.389 0 0 1 5.306 8.5"/><path d="M22.875 15.75a7.669 7.669 0 0 1-6 7.5a7.669 7.669 0 0 1-6-7.5V13.5a1.5 1.5 0 0 1 1.5-1.5h9a1.5 1.5 0 0 1 1.5 1.5v2.25Zm-6-.75v4.5m-2.25-2.25h4.5m-11.5 0a3.5 3.5 0 0 1-3.5-3.5"/></g>`), g.Group(children),
	)
}
...
func PersonalHygieneHandWipePaperThree(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M1.5.75v5a2 2 0 0 0 2 2h1m18-7v5a2 2 0 0 1-2 2h-1M9.786 18.893l1.714.857l2-1l2 1l2-1l2 1V4.25h-15v10.5m-3 8.5v-6.824a5 5 0 0 1 2.226-4.16l.774-.516"/><path d="m7.5 21.75l2.714-3.393a1.887 1.887 0 0 0-.427-2.749v0a1.886 1.886 0 0 0-2.381.236L5.5 17.75"/></g>`), g.Group(children),
	)
}
...
func PersonalHygieneHandWipePaperTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M23.083 7.916a3.583 3.583 0 0 1-7.166 0C15.917 5.229 19.5.75 19.5.75s3.583 4.479 3.583 7.166Zm-5.264 6.335c.859 2.035 2.006 3.466-.084 6h-4.818m-6-10.201c-3.314 0-6-1.074-6-2.4v13.2c0 1.326 2.686 2.4 6 2.4s6-1.074 6-2.4V7.65c0 1.326-2.687 2.4-6 2.4Z"/><path d="M6.917 10.05c3.314 0 6-1.075 6-2.4s-2.686-2.4-6-2.4s-6 1.075-6 2.4s2.686 2.4 6 2.4Zm-.6-2.4h1.2m-.6-2.4h6.47"/></g>`), g.Group(children),
	)
}
...
func QuarantinePlaceHouseOne(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M12 17.239a2.857 2.857 0 1 0 0-5.714a2.857 2.857 0 0 0 0 5.714Zm-.476-7.857h.952m-.476 0v2.143m3.199-1.015l.673.673m-.336-.336l-1.516 1.515M17 13.906v.952m0-.476h-2.143m1.015 3.199l-.673.673m.337-.336l-1.516-1.516m-1.544 2.98h-.952m.476 0v-2.143m-3.199 1.015l-.673-.673m.336.337l1.516-1.516M7 14.858v-.952m0 .476h2.143m-1.015-3.199l.673-.673m-.337.337l1.516 1.515"/><path d="M3.75 12.382v9a1.5 1.5 0 0 0 1.5 1.5h13.5a1.5 1.5 0 0 0 1.5-1.5v-9m3-1.5l-9.885-9.226a2 2 0 0 0-2.73 0L.75 10.882"/></g>`), g.Group(children),
	)
}
...
func QuarantinePlaceSelfLockdownTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M12 11.25a2.25 2.25 0 1 0 0-4.5a2.25 2.25 0 0 0 0 4.5Zm1.5 12l.75-4.5h1.5V16.5a3.75 3.75 0 0 0-7.5 0v2.25h1.5l.75 4.5h3Z"/><path d="M22.873 8.949L20.5 7.161V1.25H16v2.518L12 .75L1.127 8.949c-.224.208-.36.495-.377.8v12.522a.98.98 0 0 0 .978.979h20.544a.98.98 0 0 0 .978-.979V9.75a1.186 1.186 0 0 0-.377-.801v0Z"/></g>`), g.Group(children),
	)
}
...
func QuarantinePlaceTimeCalendarDay(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5"><path stroke-linecap="round" d="M6.75 12.007h2v8m8.5-3h-5.5c0-3 4-5 4-5v8"/><path stroke-linecap="round" d="M21.75 3.007H2.25a1.5 1.5 0 0 0-1.5 1.5v17a1.5 1.5 0 0 0 1.5 1.5h19.5a1.5 1.5 0 0 0 1.5-1.5v-17a1.5 1.5 0 0 0-1.5-1.5Z"/><path d="M.75 8.507h22.5"/><path stroke-linecap="round" d="M7.25 4.993v-4m9 4v-4"/></g>`), g.Group(children),
	)
}
...
func SocialDistancingCorrectTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4.974 19.375a2.625 2.625 0 1 0 0-5.25a2.625 2.625 0 0 0 0 5.25Zm4.226 3.75a4.473 4.473 0 0 0-8.449 0m18.275-3.75a2.625 2.625 0 1 0 0-5.25a2.625 2.625 0 0 0 0 5.25Zm4.224 3.75a4.473 4.473 0 0 0-8.449 0M5 8.875v2m14-2v2m-14-1h14m-10-7l2 2l4-4"/>`), g.Group(children),
	)
}
...
func SocialDistancingDoNotCloseTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M13.083 7.936a5.007 5.007 0 0 1 3.551 2.439M6.225 6.525a2.825 2.825 0 1 0 0-5.65a2.825 2.825 0 0 0 0 5.65Zm4.828 8.1a1.5 1.5 0 1 1 0-3h2.5m-7.25 10.25v-5.194m2.997.436v4.508a1.5 1.5 0 0 1-3 0M10.809.996a2.825 2.825 0 1 1-.05 5.392"/><path d="M.8 12.875a5 5 0 0 1 5-5h1a5 5 0 0 1 4.843 3.75"/><path d="M6.3 21.625a1.5 1.5 0 0 1-3 0v-6.812h-1a1.5 1.5 0 0 1-1.5-1.5v-.438m17.396 10.107a5 5 0 1 0 0-10a5 5 0 0 0 0 10Zm3.535-8.534l-7.07 7.07"/></g>`), g.Group(children),
	)
}
...
func SocialDistancingNotAllowedSpaceMan(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.75a3 3 0 1 0 0-6a3 3 0 0 0 0 6Zm5.25 6.75a5.25 5.25 0 1 0-10.5 0v2.25H9l.75 7.5h4.5l.75-7.5h2.25V13.5ZM1 18.991l4 4m0-4l-4 4m18-4l4 4m0-4l-4 4"/>`), g.Group(children),
	)
}
...
func SocialDistancingTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M4.974 17.375a2.625 2.625 0 1 0 0-5.25a2.625 2.625 0 0 0 0 5.25Zm4.226 3.75a4.473 4.473 0 0 0-8.449 0m18.275-3.75a2.625 2.625 0 1 0 0-5.25a2.625 2.625 0 0 0 0 5.25Zm4.224 3.75a4.473 4.473 0 0 0-8.449 0"/><path d="M6 3.75A.375.375 0 1 1 6 3m0 .75A.375.375 0 1 0 6 3m6 .75A.375.375 0 0 1 12 3m0 .75A.375.375 0 0 0 12 3m6 .75A.375.375 0 0 1 18 3m0 .75A.375.375 0 0 0 18 3"/></g>`), g.Group(children),
	)
}
...
func SymptomsFever(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M6.01 16.607a3.495 3.495 0 1 0 0-6.99a3.495 3.495 0 0 0 0 6.99Zm5.242 6.616a5.243 5.243 0 0 0-10.485 0m20.968-7.821V3.751a2.996 2.996 0 1 0-5.991 0v11.651a4.493 4.493 0 1 0 5.991 0ZM18.74 5.249v11.983"/><path d="M18.74 20.227a1.498 1.498 0 1 0 0-2.995a1.498 1.498 0 0 0 0 2.995ZM2.014 7.745a2.47 2.47 0 0 1 0-3.495a2.472 2.472 0 0 0 0-3.495m3.721 6.99a2.47 2.47 0 0 1 0-3.495a2.472 2.472 0 0 0 0-3.495m3.995 6.99a2.47 2.47 0 0 1 0-3.495a2.473 2.473 0 0 0 0-3.495"/></g>`), g.Group(children),
	)
}
...
func TransmissionVirusBriefcase(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M12.369 11.107a2.857 2.857 0 1 0 0-5.714a2.857 2.857 0 0 0 0 5.714Zm-.476-7.857h.952m-.476 0v2.143m3.199-1.015l.673.673m-.336-.337L14.389 6.23m2.98 1.544v.952m0-.476h-2.143m1.015 3.199l-.673.673m.337-.336l-1.516-1.516m-1.544 2.98h-.952m.476 0v-2.143M9.17 12.122l-.673-.673m.337.337l1.515-1.516m-2.98-1.544v-.952m0 .476h2.143M8.497 5.051l.673-.673m-.336.336l1.515 1.516M6.75 2.25V.75m10.5 1.5V.75m-9.75 18a1.5 1.5 0 0 0 1.5 1.5h6a1.5 1.5 0 0 0 1.5-1.5"/><path d="M22.25 15.75H1.75a1 1 0 0 0-1 1v5.5a1 1 0 0 0 1 1h20.5a1 1 0 0 0 1-1v-5.5a1 1 0 0 0-1-1Zm-6.5-13.5h3.75a1.5 1.5 0 0 1 1.5 1.5v12m-18 0v-12a1.5 1.5 0 0 1 1.5-1.5h3.94"/></g>`), g.Group(children),
	)
}
...
func TransmissionVirusFloatWind(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.926 19.117a4.857 4.857 0 1 0 0-9.714a4.857 4.857 0 0 0 0 9.714Zm-.81-13.357h1.619m-.809 0v3.642m7.126-8.162l1.374.857m-.687-.428L16.811 4.76m3.618 2.851l1.145 1.145m-.572-.572l-2.576 2.576m-.917 8.938l-1.145 1.144m.572-.572l-2.576-2.576m-2.625 5.066h-1.619m.81 0v-3.643m-5.438 1.725l-1.145-1.144m.572.572l2.576-2.576m-5.065-2.625V13.45m0 .81h3.643M4.343 8.822l1.145-1.145m-.573.572l2.576 2.576"/>`), g.Group(children),
	)
}
...
func TransmissionVirusHumanTransmitOne(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M17.25 20.55a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858Zm-.571-9.429h1.142m-.571 0v2.572m3.839-1.218l.808.808m-.404-.404l-1.819 1.818m3.576 1.853v1.143m0-.572h-2.571m1.218 3.839l-.808.808m.404-.404l-1.819-1.818m-1.853 3.575h-1.142m.571 0V20.55m-3.839 1.218l-.808-.808m.404.404l1.819-1.818m-3.576-1.853V16.55m0 .571h2.571m-1.218-3.838l.808-.808m-.404.404l1.819 1.818M6.167 10.5a3.311 3.311 0 1 0 0-6.622a3.311 3.311 0 0 0 0 6.622ZM.75 17.121a5.42 5.42 0 0 1 7.55-4.982m5.707-4.26l.243-.97a4 4 0 0 1 3.88-3.03h4.877"/><path d="m20.007 6.879l3-3l-3-3"/></g>`), g.Group(children),
	)
}
...
func TransmissionVirusTransportation(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M17.25 10.514a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858Zm-.571-9.429h1.142m-.571 0v2.572m3.839-1.218l.808.808m-.404-.404l-1.819 1.818m3.576 1.853v1.143m0-.572h-2.571m1.218 3.839l-.808.808m.404-.404L19.674 9.51m-1.853 3.575h-1.142m.571 0v-2.571m-3.839 1.218l-.808-.808m.404.404l1.819-1.818M11.25 7.657V6.514m0 .571h2.571m-1.218-3.838l.808-.808m-.404.404l1.819 1.818M9.75 10.915h-1.5a1.5 1.5 0 0 0-1.5 1.5V19.2m11.212 2.215h.788a1.5 1.5 0 0 0 1.5-1.5v-4.83m-13.5-2.67h-3a3 3 0 0 0-3 3v4.5a1.5 1.5 0 0 0 1.5 1.5h2.287"/><path d="M6.375 22.915a1.875 1.875 0 1 0 0-3.75a1.875 1.875 0 0 0 0 3.75Zm9.75 0a1.875 1.875 0 1 0 0-3.75a1.875 1.875 0 0 0 0 3.75Zm-7.913-1.5h6.076M.75 17.016h6"/></g>`), g.Group(children),
	)
}
...
func VaccineProtectionFaceShieldOne(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M7 .81c-3.559.543-6 1.645-6 2.92c0 1.811 4.925 3.28 11 3.28s11-1.469 11-3.28c0-1.275-2.441-2.377-6-2.92"/><path d="M1 3.73v3.3c0 1.812 4.925 3.281 11 3.281s11-1.465 11-3.277V3.73"/><path d="m4 9.315l-.9 9.794a1.98 1.98 0 0 0 .848 1.823A14.277 14.277 0 0 0 12 23.19c2.85.068 5.655-.718 8.054-2.258a1.98 1.98 0 0 0 .848-1.823L20 9.315"/><path d="M13 20.19a7.638 7.638 0 0 0 5-2"/></g>`), g.Group(children),
	)
}
...
func VaccineProtectionFaceShieldTwo(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M18.167 17.107V15.06H19.7a1.02 1.02 0 0 0 .935-1.435c-1-2.239-2.476-4.994-2.476-4.994V6.45a2.024 2.024 0 0 0-.18-.847c-1.111-2.409-2.617-4.074-5.5-4.652C6.611-.224.807 3.887.763 9.871a9.19 9.19 0 0 0 3.071 6.937v6.442m10.238 0v-1.34M.777 9.433h10.418"/><path d="M11.2 4.628h8.042a4 4 0 0 1 4 4v11.577H18.2a7 7 0 0 1-7-7V4.628Zm-.005 0H2.528"/></g>`), g.Group(children),
	)
}
...
func VaccineProtectionMedicinePill(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M8.6 16.4a4.6 4.6 0 0 1-6.5-6.5l7.8-7.8a4.6 4.6 0 0 1 6.5 6.5M5.999 5.999l4.25 4.25"/><path d="M23.25 15.75a7.669 7.669 0 0 1-6 7.5a7.669 7.669 0 0 1-6-7.5V13.5a1.5 1.5 0 0 1 1.5-1.5h9a1.5 1.5 0 0 1 1.5 1.5v2.25Zm-6-.75v4.5M15 17.25h4.5"/></g>`), g.Group(children),
	)
}
...
func VaccineProtectionShield(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M12.125 14.339a3.714 3.714 0 1 0 0-7.428a3.714 3.714 0 0 0 0 7.428Zm-.619-10.214h1.238m-.619 0v2.786m4.158-1.321l.876.877m-.438-.438l-1.97 1.97m3.874 2.007v1.238m0-.619h-2.786m1.32 4.158l-.876.876m.438-.438l-1.97-1.97m-2.007 3.874h-1.238m.619 0v-2.786m-4.158 1.32l-.876-.876m.438.438l1.97-1.97m-3.874-2.007v-1.238m0 .619h2.786m-1.32-4.158l.876-.876m-.438.438l1.97 1.97"/><path d="M2.25 3.923v7.614c0 3.723 1.629 8.8 8.673 11.513a3 3 0 0 0 2.154 0c7.041-2.708 8.673-7.822 8.673-11.513V3.923a1.486 1.486 0 0 0-.868-1.362A21.7 21.7 0 0 0 12 .75a21.7 21.7 0 0 0-8.882 1.811a1.486 1.486 0 0 0-.868 1.362v0Z"/></g>`), g.Group(children),
	)
}
...
func VaccineProtectionWashHands(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 4.5h-3a1.5 1.5 0 0 0 0-3H8.158a4.5 4.5 0 0 0-3.744 2L3.2 5.332A1.5 1.5 0 0 1 1.947 6H.75m11-1.5H14M.75 21.75h1.9c.233 0 .463.054.671.158l1.733.867a4.507 4.507 0 0 0 2.012.475H18.75a1.5 1.5 0 1 0 0-3H21a1.5 1.5 0 1 0 0-3h.75a1.5 1.5 0 1 0 0-3h-1.5a1.5 1.5 0 1 0 0-3H15a1.5 1.5 0 1 0 0-3H9.158a4.5 4.5 0 0 0-3.744 2L4.2 12.082a1.5 1.5 0 0 1-1.248.668H.75m12-1.5H15m1.5 6H21m-4.5-3h3.75m-4.5 6h3M21.007.75a.455.455 0 0 1 .423.289c.414 1.063 1.82 4.749 1.82 5.789a2.21 2.21 0 1 1-4.421 0c0-1.062 1.465-4.878 1.845-5.851a.357.357 0 0 1 .333-.227v0Z"/>`), g.Group(children),
	)
}
...
func VirusLabResearchMedicinePill(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.25 20.679a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858Zm-.571-9.429h1.142m-.571 0v2.571m3.839-1.218l.808.808m-.404-.404l-1.819 1.819m3.576 1.853v1.142m0-.571h-2.571m1.218 3.839l-.808.808m.404-.404l-1.819-1.819m-1.853 3.576h-1.142m.571 0v-2.571m-3.839 1.218l-.808-.808m.404.404l1.819-1.819m-3.576-1.853v-1.142m0 .571h2.571m-1.218-3.839l.808-.808m-.404.404l1.819 1.819M8.6 16.4a4.6 4.6 0 0 1-6.5-6.5l7.8-7.8a4.6 4.6 0 0 1 6.5 6.5M5.999 5.999l5.138 5.138"/>`), g.Group(children),
	)
}
...
func VirusLabResearchTestTube(children ...g.Node) g.Node {
	return s.SVG(
		viewbox, hAttr,
		g.Raw(`<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M17 20.679a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858Zm-.571-9.429h1.142m-.571 0v2.571m3.839-1.218l.808.808m-.404-.404l-1.819 1.819M23 16.679v1.142m0-.571h-2.571m1.218 3.839l-.808.808m.404-.404l-1.819-1.819m-1.853 3.576h-1.142m.571 0v-2.571m-3.839 1.218l-.808-.808m.404.404l1.819-1.819M11 17.821v-1.142m0 .571h2.571m-1.218-3.839l.808-.808m-.404.404l1.819 1.819M9.549 22.25a3.75 3.75 0 0 1-6.3-2.75V.75h7.5v9.5M13 .75H1"/><path d="M8.125 8.25a.375.375 0 0 1 .375.375m-.75 0a.375.375 0 0 1 .375-.375m0 .75a.375.375 0 0 1-.375-.375m.75 0A.375.375 0 0 1 8.125 9m-2.25 3.75a.375.375 0 0 1 .375.375m-.75 0a.375.375 0 0 1 .375-.375m0 .75a.375.375 0 0 1-.375-.375m.75 0a.375.375 0 0 1-.375.375m1.5 3.75a.375.375 0 0 1 .375.375m-.75 0a.375.375 0 0 1 .375-.375m0 .75A.375.375 0 0 1 7 17.625m.75 0a.375.375 0 0 1-.375.375M10.75 5.25h-7.5"/></g>`), g.Group(children),
	)
}
