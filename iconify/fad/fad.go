...
func IconFromName(name string) g.Node {
	...
	case "arrowsVert":
		return ArrowsVert()
	case "automationFourP":
		return AutomationFourP()
	case "automationThreeP":
		return AutomationThreeP()
	case "automationTwoP":
		return AutomationTwoP()
	case "backward":
		return Backward()
	case "bluetooth":
		return Bluetooth()
	...
	case "filterNotch":
		return FilterNotch()
	case "filterRezHighpass":
		return FilterRezHighpass()
	case "filterRezLowpass":
		return FilterRezLowpass()
	case "filterShelvingHi":
		return FilterShelvingHi()
	case "filterShelvingLo":
		return FilterShelvingLo()
	case "foldback":
		return Foldback()
	case "forward":
		return Forward()
	...
	case "logoAax":
		return LogoAax()
	case "logoAbletonlink":
		return LogoAbletonlink()
	case "logoAu":
		return LogoAu()
	case "logoAudacity":
		return LogoAudacity()
	...
	case "logoRewire":
		return LogoRewire()
	case "logoStudioone":
		return LogoStudioone()
	case "logoTracktion":
		return LogoTracktion()
	case "logoVst":
		return LogoVst()
	case "logoWaveform":
		return LogoWaveform()
	...
	case "ram":
		return Ram()
	case "randomOneDice":
		return RandomOneDice()
	case "randomTwoDice":
		return RandomTwoDice()
	case "record":
		return Record()
	case "redo":
		return Redo()
	...
	case "rew":
		return Rew()
	case "roundswitchOff":
		return RoundswitchOff()
	case "roundswitchOn":
		return RoundswitchOn()
	case "save":
		return Save()
	case "saveas":
		return Saveas()
	...
	case "shuffle":
		return Shuffle()
	case "sliderRoundOne":
		return SliderRoundOne()
	case "sliderRoundThree":
		return SliderRoundThree()
	case "sliderRoundTwo":
		return SliderRoundTwo()
	case "sliderhandleOne":
		return SliderhandleOne()
	case "sliderhandleTwo":
		return SliderhandleTwo()
	case "softclip":
		return Softclip()
	case "softclipcurve":
	...
	case "speaker":
		return Speaker()
	case "squareswitchOff":
		return SquareswitchOff()
	case "squareswitchOn":
		return SquareswitchOn()
	case "stereo":
		return Stereo()
	case "stop":
		return Stop()
	...
	case "vExpand":
		return VExpand()
	case "vroundswitchOff":
		return VroundswitchOff()
	case "vroundswitchOn":
		return VroundswitchOn()
	case "vsquareswitchOff":
		return VsquareswitchOff()
	case "vsquareswitchOn":
		return VsquareswitchOn()
	case "waveform":
		return Waveform()
	case "xlrplug":
		return Xlrplug()
...
func Adr(children ...g.Node) g.Node {
	return s.SVG(
...
func Arpchord(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M96 203.996A4.002 4.002 0 0 1 91.996 208H68.004A4.002 4.002 0 0 1 64 203.996v-23.992A4.002 4.002 0 0 1 68.004 176h23.992A4.002 4.002 0 0 1 96 180.004v23.992zm0-64A4.002 4.002 0 0 1 91.996 144H68.004A4.002 4.002 0 0 1 64 139.996v-23.992A4.002 4.002 0 0 1 68.004 112h23.992A4.002 4.002 0 0 1 96 116.004v23.992zm0-64A4.002 4.002 0 0 1 91.996 80H68.004A4.002 4.002 0 0 1 64 75.996V52.004A4.002 4.002 0 0 1 68.004 48h23.992A4.002 4.002 0 0 1 96 52.004v23.992zm64 0A4.002 4.002 0 0 0 164.004 80h23.992A4.002 4.002 0 0 0 192 75.996V52.004A4.002 4.002 0 0 0 187.996 48h-23.992A4.002 4.002 0 0 0 160 52.004v23.992zm0 64a4.002 4.002 0 0 0 4.004 4.004h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992a4.002 4.002 0 0 0-4.004-4.004h-23.992a4.002 4.002 0 0 0-4.004 4.004v23.992zm0 64a4.002 4.002 0 0 0 4.004 4.004h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992a4.002 4.002 0 0 0-4.004-4.004h-23.992a4.002 4.002 0 0 0-4.004 4.004v23.992z"/>`),
		g.Group(children),
	)
}

func Arpdown(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M80 52.004A4.002 4.002 0 0 0 75.996 48H52.004A4.002 4.002 0 0 0 48 52.004v23.992A4.002 4.002 0 0 0 52.004 80h23.992A4.002 4.002 0 0 0 80 75.996V52.004zm32 32A4.002 4.002 0 0 0 107.996 80H84.004A4.002 4.002 0 0 0 80 84.004v23.992A4.002 4.002 0 0 0 84.004 112h23.992a4.002 4.002 0 0 0 4.004-4.004V84.004zm32 32a4.002 4.002 0 0 0-4.004-4.004h-23.992a4.002 4.002 0 0 0-4.004 4.004v23.992a4.002 4.002 0 0 0 4.004 4.004h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992zm32 32a4.002 4.002 0 0 0-4.004-4.004h-23.992a4.002 4.002 0 0 0-4.004 4.004v23.992a4.002 4.002 0 0 0 4.004 4.004h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992zm32 32a4.002 4.002 0 0 0-4.004-4.004h-23.992a4.002 4.002 0 0 0-4.004 4.004v23.992a4.002 4.002 0 0 0 4.004 4.004h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992z"/>`),
		g.Group(children),
	)
}

func Arpdownandup(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M80 75.996A4.002 4.002 0 0 1 75.996 80H52.004A4.002 4.002 0 0 1 48 75.996V52.004A4.002 4.002 0 0 1 52.004 48h23.992A4.002 4.002 0 0 1 80 52.004v23.992zm16 64A4.002 4.002 0 0 1 91.996 144H68.004A4.002 4.002 0 0 1 64 139.996v-23.992A4.002 4.002 0 0 1 68.004 112h23.992A4.002 4.002 0 0 1 96 116.004v23.992zm16 64a4.002 4.002 0 0 1-4.004 4.004H84.004A4.002 4.002 0 0 1 80 203.996v-23.992A4.002 4.002 0 0 1 84.004 176h23.992a4.002 4.002 0 0 1 4.004 4.004v23.992zm64 0a4.002 4.002 0 0 1-4.004 4.004h-23.992a4.002 4.002 0 0 1-4.004-4.004v-23.992a4.002 4.002 0 0 1 4.004-4.004h23.992a4.002 4.002 0 0 1 4.004 4.004v23.992zm16-64a4.002 4.002 0 0 1-4.004 4.004h-23.992a4.002 4.002 0 0 1-4.004-4.004v-23.992a4.002 4.002 0 0 1 4.004-4.004h23.992a4.002 4.002 0 0 1 4.004 4.004v23.992zm16-64A4.002 4.002 0 0 1 203.996 80h-23.992A4.002 4.002 0 0 1 176 75.996V52.004A4.002 4.002 0 0 1 180.004 48h23.992A4.002 4.002 0 0 1 208 52.004v23.992z"/>`),
		g.Group(children),
	)
}

func Arpdownup(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M80 52.004A4.002 4.002 0 0 0 75.996 48H52.004A4.002 4.002 0 0 0 48 52.004v23.992A4.002 4.002 0 0 0 52.004 80h23.992A4.002 4.002 0 0 0 80 75.996V52.004zm32 64a4.002 4.002 0 0 0-4.004-4.004H84.004A4.002 4.002 0 0 0 80 116.004v23.992A4.002 4.002 0 0 0 84.004 144h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992zm32 64a4.002 4.002 0 0 0-4.004-4.004h-23.992a4.002 4.002 0 0 0-4.004 4.004v23.992a4.002 4.002 0 0 0 4.004 4.004h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992zm32-64a4.002 4.002 0 0 0-4.004-4.004h-23.992a4.002 4.002 0 0 0-4.004 4.004v23.992a4.002 4.002 0 0 0 4.004 4.004h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992zm32-64A4.002 4.002 0 0 0 203.996 48h-23.992A4.002 4.002 0 0 0 176 52.004v23.992A4.002 4.002 0 0 0 180.004 80h23.992A4.002 4.002 0 0 0 208 75.996V52.004z"/>`),
		g.Group(children),
	)
}

func Arpplayorder(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M80 203.996A4.002 4.002 0 0 1 75.996 208H52.004A4.002 4.002 0 0 1 48 203.996v-23.992A4.002 4.002 0 0 1 52.004 176h23.992A4.002 4.002 0 0 1 80 180.004v23.992zm16-64A4.002 4.002 0 0 1 91.996 144H68.004A4.002 4.002 0 0 1 64 139.996v-23.992A4.002 4.002 0 0 1 68.004 112h23.992A4.002 4.002 0 0 1 96 116.004v23.992zm16-64A4.002 4.002 0 0 1 107.996 80H84.004A4.002 4.002 0 0 1 80 75.996V52.004A4.002 4.002 0 0 1 84.004 48h23.992A4.002 4.002 0 0 1 112 52.004v23.992zm64 0A4.002 4.002 0 0 0 180.004 80h23.992A4.002 4.002 0 0 0 208 75.996V52.004A4.002 4.002 0 0 0 203.996 48h-23.992A4.002 4.002 0 0 0 176 52.004v23.992zm-16 64a4.002 4.002 0 0 0 4.004 4.004h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992a4.002 4.002 0 0 0-4.004-4.004h-23.992a4.002 4.002 0 0 0-4.004 4.004v23.992zm-16 64a4.002 4.002 0 0 0 4.004 4.004h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992a4.002 4.002 0 0 0-4.004-4.004h-23.992a4.002 4.002 0 0 0-4.004 4.004v23.992z"/>`),
		g.Group(children),
	)
}

func Arprandom(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M80 123.996A4.002 4.002 0 0 1 75.996 128H52.004A4.002 4.002 0 0 1 48 123.996v-23.992A4.002 4.002 0 0 1 52.004 96h23.992A4.002 4.002 0 0 1 80 100.004v23.992zm32 80a4.002 4.002 0 0 1-4.004 4.004H84.004A4.002 4.002 0 0 1 80 203.996v-23.992A4.002 4.002 0 0 1 84.004 176h23.992a4.002 4.002 0 0 1 4.004 4.004v23.992zm96-64a4.002 4.002 0 0 1-4.004 4.004h-23.992a4.002 4.002 0 0 1-4.004-4.004v-23.992a4.002 4.002 0 0 1 4.004-4.004h23.992a4.002 4.002 0 0 1 4.004 4.004v23.992zm-96 16a4.002 4.002 0 0 0 4.004 4.004h23.992a4.002 4.002 0 0 0 4.004-4.004v-23.992a4.002 4.002 0 0 0-4.004-4.004h-23.992a4.002 4.002 0 0 0-4.004 4.004v23.992zm32-80A4.002 4.002 0 0 0 148.004 80h23.992A4.002 4.002 0 0 0 176 75.996V52.004A4.002 4.002 0 0 0 171.996 48h-23.992A4.002 4.002 0 0 0 144 52.004v23.992z"/>`),
		g.Group(children),
	)
}

func Arpup(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M48 203.996A4.002 4.002 0 0 0 52.004 208h25.994c1.106 0 2.002-.89 2.002-2.002v-27.996c0-1.106-.89-2.002-2.002-2.002H50.002c-1.106 0-2.002.89-2.002 2.002v25.994zm32-29.998c0 1.106.89 2.002 2.002 2.002h27.996c1.106 0 2.002-.89 2.002-2.002v-27.996c0-1.106-.89-2.002-2.002-2.002H82.002c-1.106 0-2.002.89-2.002 2.002v27.996zm32-32c0 1.106.89 2.002 2.002 2.002h27.996c1.106 0 2.002-.89 2.002-2.002v-27.996c0-1.106-.89-2.002-2.002-2.002h-27.996c-1.106 0-2.002.89-2.002 2.002v27.996zm32-32c0 1.106.89 2.002 2.002 2.002h27.996c1.106 0 2.002-.89 2.002-2.002V82.002c0-1.106-.89-2.002-2.002-2.002h-27.996c-1.106 0-2.002.89-2.002 2.002v27.996zm32-32c0 1.106.89 2.002 2.002 2.002h27.996c1.106 0 2.002-.89 2.002-2.002V50.002c0-1.106-.89-2.002-2.002-2.002h-27.996c-1.106 0-2.002.89-2.002 2.002v27.996z"/>`),
		g.Group(children),
	)
}

func Arpupandown(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M80 203.996A4.002 4.002 0 0 1 75.996 208H52.004A4.002 4.002 0 0 1 48 203.996v-23.992A4.002 4.002 0 0 1 52.004 176h23.992A4.002 4.002 0 0 1 80 180.004v23.992zm16-64A4.002 4.002 0 0 1 91.996 144H68.004A4.002 4.002 0 0 1 64 139.996v-23.992A4.002 4.002 0 0 1 68.004 112h23.992A4.002 4.002 0 0 1 96 116.004v23.992zm16-64A4.002 4.002 0 0 1 107.996 80H84.004A4.002 4.002 0 0 1 80 75.996V52.004A4.002 4.002 0 0 1 84.004 48h23.992A4.002 4.002 0 0 1 112 52.004v23.992zm64 0A4.002 4.002 0 0 1 171.996 80h-23.992A4.002 4.002 0 0 1 144 75.996V52.004A4.002 4.002 0 0 1 148.004 48h23.992A4.002 4.002 0 0 1 176 52.004v23.992zm16 64a4.002 4.002 0 0 1-4.004 4.004h-23.992a4.002 4.002 0 0 1-4.004-4.004v-23.992a4.002 4.002 0 0 1 4.004-4.004h23.992a4.002 4.002 0 0 1 4.004 4.004v23.992zm16 64a4.002 4.002 0 0 1-4.004 4.004h-23.992a4.002 4.002 0 0 1-4.004-4.004v-23.992a4.002 4.002 0 0 1 4.004-4.004h23.992a4.002 4.002 0 0 1 4.004 4.004v23.992z"/>`),
		g.Group(children),
	)
}

func Arpupdown(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M80 203.996A4.002 4.002 0 0 1 75.996 208H52.004A4.002 4.002 0 0 1 48 203.996v-23.992A4.002 4.002 0 0 1 52.004 176h23.992A4.002 4.002 0 0 1 80 180.004v23.992zm32-64a4.002 4.002 0 0 1-4.004 4.004H84.004A4.002 4.002 0 0 1 80 139.996v-23.992A4.002 4.002 0 0 1 84.004 112h23.992a4.002 4.002 0 0 1 4.004 4.004v23.992zm32-64A4.002 4.002 0 0 1 139.996 80h-23.992A4.002 4.002 0 0 1 112 75.996V52.004A4.002 4.002 0 0 1 116.004 48h23.992A4.002 4.002 0 0 1 144 52.004v23.992zm32 64a4.002 4.002 0 0 1-4.004 4.004h-23.992a4.002 4.002 0 0 1-4.004-4.004v-23.992a4.002 4.002 0 0 1 4.004-4.004h23.992a4.002 4.002 0 0 1 4.004 4.004v23.992zm32 64a4.002 4.002 0 0 1-4.004 4.004h-23.992a4.002 4.002 0 0 1-4.004-4.004v-23.992a4.002 4.002 0 0 1 4.004-4.004h23.992a4.002 4.002 0 0 1 4.004 4.004v23.992z"/>`),
		g.Group(children),
	)
}
...
func AutomationFourP(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M144.282 145.51A32.19 32.19 0 0 1 150 145c4.032 0 7.89.746 11.444 2.107L175.584 127l.54.306A31.88 31.88 0 0 1 168 106c0-17.673 14.327-32 32-32c17.673 0 32 14.327 32 32c0 17.673-14.327 32-32 32c-3.672 0-7.2-.619-10.485-1.757l-14.31 21.038A31.863 31.863 0 0 1 182 177c0 17.673-14.327 32-32 32c-17.673 0-32-14.327-32-32c0-9.767 4.376-18.512 11.274-24.382l-20.764-41.28A32.14 32.14 0 0 1 102 112a32.05 32.05 0 0 1-8.16-1.05l-14.716 25.93C85.21 142.705 89 150.91 89 160c0 17.673-14.327 32-32 32c-17.673 0-32-14.327-32-32c0-17.673 14.327-32 32-32c2.655 0 5.234.323 7.7.932l14.809-26.17C73.638 96.963 70 88.907 70 80c0-17.673 14.327-32 32-32c17.673 0 32 14.327 32 32c0 9.563-4.195 18.146-10.844 24.01l21.126 41.5zM200 122c8.837 0 16-7.163 16-16s-7.163-16-16-16s-16 7.163-16 16s7.163 16 16 16zM57 176c8.837 0 16-7.163 16-16s-7.163-16-16-16s-16 7.163-16 16s7.163 16 16 16zm45-80c8.837 0 16-7.163 16-16s-7.163-16-16-16s-16 7.163-16 16s7.163 16 16 16zm48 97c8.837 0 16-7.163 16-16s-7.163-16-16-16s-16 7.163-16 16s7.163 16 16 16z"/>`),
		g.Group(children),
	)
}

func AutomationThreeP(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M129.175 107.005A31.85 31.85 0 0 1 112 112a32.54 32.54 0 0 1-1.503-.035l.077.035l-12.804 37.383C106.35 155.123 112 164.902 112 176c0 17.673-14.327 32-32 32c-17.673 0-32-14.327-32-32c0-17.673 14.327-32 32-32c.87 0 1.731.035 2.583.103l12.14-37.163C85.867 101.248 80 91.31 80 80c0-17.673 14.327-32 32-32c17.673 0 32 14.327 32 32c0 5.51-1.393 10.696-3.846 15.224l19.42 21.308A31.851 31.851 0 0 1 176 112c17.673 0 32 14.327 32 32c0 17.673-14.327 32-32 32c-17.673 0-32-14.327-32-32a31.857 31.857 0 0 1 3.92-15.36l-18.745-21.635zM80 192c8.837 0 16-7.163 16-16s-7.163-16-16-16s-16 7.163-16 16s7.163 16 16 16zm32-96c8.837 0 16-7.163 16-16s-7.163-16-16-16s-16 7.163-16 16s7.163 16 16 16zm64 64c8.837 0 16-7.163 16-16s-7.163-16-16-16s-16 7.163-16 16s7.163 16 16 16z"/>`),
		g.Group(children),
	)
}
...
func Backward(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M117.027 60.858c0 14.184.118 120.734.118 134.66c0 13.925-7.798 16.307-14.543 10.568c-6.745-5.74-46.666-60.003-52.014-67.201c-5.349-7.198-4.45-12.951.086-20.28c4.535-7.328 47.284-62.224 52.46-68.2c5.175-5.977 13.893-3.73 13.893 10.453zM65.424 132.65l32.874 43.167c1.336 1.754 2.425 1.393 2.424-.814l-.005-92.006c0-2.197-1.072-2.562-2.395-.792l-32.927 44.057c-1.327 1.776-1.31 4.63.03 6.388zm142.603-71.792c0 14.184.118 120.734.118 134.66c0 13.925-7.798 16.307-14.543 10.568c-6.745-5.74-46.666-60.003-52.014-67.201c-5.349-7.198-4.45-12.951.086-20.28c4.535-7.328 47.284-62.224 52.46-68.2c5.175-5.977 13.893-3.73 13.893 10.453zm-51.603 71.792l32.874 43.167c1.336 1.754 2.425 1.393 2.424-.814l-.005-92.006c0-2.197-1.072-2.562-2.395-.792l-32.927 44.057c-1.327 1.776-1.31 4.63.03 6.388z"/>`),
		g.Group(children),
	)
}
...
func CaretLeft(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M136.916 184.407c11.363 11.578 31.242 2.954 31.005-12.728c-.237-15.682-.237-71.898-.237-87.355v-.003c0-15.453-17.987-23.243-29.502-11.835c-3.95 3.913-9.505 9.312-15.348 14.99c-11.192 10.879-23.441 22.784-27.494 27.242c-6.169 6.786-8.362 19.001-.898 26.332c4.938 4.85 16.962 17.194 27.823 28.345c5.555 5.703 10.806 11.094 14.651 15.012zm13.777-13.569c.011 2.214-1.465 1.562-3.02 0v-.001l-40.04-39.91c-1.548-1.554-1.561-4.107-.013-5.684l41.117-41.082c1.548-1.578 1.944-.605 1.956 1.605v85.072z" clip-rule="evenodd"/>`),
		g.Group(children),
	)
}
...
func DigitalNine(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
...
func DigitalOne(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
...
func DigitalSeven(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
...
func DigitalSix(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
...
func DigitalThree(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
...
func DigitalTwo(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
...
func DigitalZero(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
...
func Forward(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M138.033 60.858c0-14.183 8.718-16.43 13.894-10.454c5.176 5.977 47.925 60.873 52.46 68.201c4.535 7.329 5.434 13.082.086 20.28c-5.349 7.198-45.27 61.462-52.015 67.2c-6.745 5.74-14.543 3.358-14.543-10.567c0-13.926.118-120.476.118-134.66zm51.265 71.792c1.34-1.758 1.357-4.612.03-6.388L156.4 82.205c-1.323-1.77-2.396-1.405-2.396.792L154 175.003c0 2.207 1.088 2.568 2.424.814l32.874-43.167zM47.033 60.858c0-14.183 8.718-16.43 13.894-10.454c5.176 5.977 47.925 60.873 52.46 68.201c4.535 7.329 5.434 13.082.086 20.28c-5.349 7.198-45.27 61.462-52.015 67.2c-6.745 5.74-14.543 3.358-14.543-10.567c0-13.926.118-120.476.118-134.66zm51.265 71.792c1.34-1.758 1.357-4.612.03-6.388L65.4 82.205c-1.323-1.77-2.396-1.405-2.396.792L63 175.003c0 2.207 1.088 2.568 2.424.814l32.874-43.167z"/>`),
		g.Group(children),
	)
}
...
func Headphones(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<g fill="currentColor" fill-rule="evenodd"><path d="M46.735 116.622c0-47.684 41.426-69.596 81.994-69.696c40.567-.1 80.92 24.207 80.92 69.292c0 45.086.004 70.408.004 70.408l-4.204 3.418l-9.406.045l-2.946-3.716s-.485-33.33-.485-70.36c0-37.031-27.957-52.448-64.552-52.481c-36.595-.033-64.821 15.18-64.821 52.613v71.228l-3.966 3.393H51.49l-4.755-3.393v-70.75z"/><path d="M147.773 144.92c5.397 0 3.968-.253 15.42-.253c11.454 0 20.303 8.673 20.303 19.444v23.847c0 11.872-9.148 20.76-20.36 20.76c-11.214 0-9.847-.135-15.433-.068s-10.349-4.51-10.349-10.51s.176-37.786.176-43.587c0-5.8 4.845-9.632 10.243-9.632zm5.214 15.68l.107 32.639s7.836 0 10.124-.043c2.288-.042 5.123-2.588 5.123-5.242c0-2.655.532-18.77.532-21.468c0-2.698-2.388-5.886-5.484-5.992c-3.097-.107-10.402.106-10.402.106zm-59.403-15.732c11.228-.048 10.137 0 15.342 0s10.303 4.385 10.385 9.819c.082 5.433 0 38.77-.082 44.005c-.081 5.235-4.267 9.885-10.303 9.885c-6.035 0-4.906-.196-15.551-.098s-20.162-9.532-20.162-20.48s.661-13.256.33-23.772c-.33-10.516 8.813-19.311 20.041-19.36zm-5.253 21.12c0 2.807.093 19.047.093 22.116c0 3.068 2.26 4.918 5.38 4.918s10.077-.045 10.077-.045v-32.65s-7.217-.124-9.964-.124c-2.748 0-5.586 2.98-5.586 5.786z"/></g>`),
		g.Group(children),
	)
}
...
func Loop(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M24.849 72.002a8 8 0 0 1 8.027-7.983l189.787.462c4.42.01 8.004 3.61 8.004 8.026v111.986c0 4.422-3.587 8.04-8.008 8.08l-42.661.39A4.04 4.04 0 0 0 176 197v22.002c0 2.208-1.39 2.878-3.115 1.488l-35.31-28.463c-5.157-4.156-5.11-10.846.099-14.935l35.174-27.616c1.74-1.367 3.152-.685 3.152 1.534v21.482a4 4 0 0 0 3.992 4.009h30.683a4.02 4.02 0 0 0 4.013-3.991l.437-83.012a7.98 7.98 0 0 0-7.952-8.02l-158.807-.454c-4.415-.013-8.008 3.56-8.025 7.975l-.31 79.504a7.962 7.962 0 0 0 7.967 7.998H108a4.003 4.003 0 0 1 3.999 3.994v8.512a3.968 3.968 0 0 1-4.001 3.971l-75.502-.431c-4.417-.026-7.987-3.634-7.974-8.048l.326-112.496z"/>`),
		g.Group(children),
	)
}
...
func Modsquare(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M35.996 208A4 4 0 0 1 32 204.005V51.995A3.997 3.997 0 0 1 36.003 48h87.994a4.018 4.018 0 0 1 4.017 4.007l.472 135.486a4.05 4.05 0 0 0 4.01 4.032l71.507.45a3.971 3.971 0 0 0 3.997-3.977V52.002A3.999 3.999 0 0 1 211.996 48h8.008A4 4 0 0 1 224 51.995v152.01a3.992 3.992 0 0 1-4.003 3.995H116.003a4.004 4.004 0 0 1-4.003-4.002V68.002A4.004 4.004 0 0 0 107.997 64H52.003A4.005 4.005 0 0 0 48 68.002v135.996A3.999 3.999 0 0 1 44.004 208h-8.008z"/>`),
		g.Group(children),
	)
}

func Modtri(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M35.996 208c-2.207 0-3.077-1.532-1.935-3.434l91.878-153.132c1.138-1.896 2.98-1.902 4.122 0l91.878 153.132c1.138 1.896.272 3.434-1.935 3.434h-8.008c-2.207 0-4.922-1.54-6.054-3.421L130.058 78.42c-1.137-1.89-2.984-1.881-4.116 0L50.058 204.58c-1.138 1.889-3.848 3.42-6.054 3.42h-8.008z"/>`),
		g.Group(children),
	)
}
...
func Next(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M80.033 60.858c0-14.183 8.718-16.43 13.894-10.454c5.176 5.977 47.925 60.873 52.46 68.201c4.535 7.329 5.434 13.082.086 20.28c-5.349 7.198-45.27 61.462-52.015 67.2c-6.745 5.74-14.543 3.358-14.543-10.567c0-13.926.118-120.476.118-134.66zm51.265 71.792c1.34-1.758 1.357-4.612.03-6.388L98.4 82.205c-1.323-1.77-2.396-1.405-2.396.792L96 175.003c0 2.207 1.088 2.568 2.424.814l32.874-43.167zm44.866-78.858c.17-2.538-1.22-4.792-3.45-4.792h-8.193c-3.655 0-3.52.682-3.52 3.859c0 3.176.394 147.132.46 149.86c.064 2.729 1.06 4.454 3.219 4.454s6.252 0 8.33-.006c2.079-.007 3.088-1.897 3.088-4.033s-.104-146.803.066-149.342z"/>`),
		g.Group(children),
	)
}
...
func Pointer(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="m56.402 54l157.203 70l-37.957 37l29.604 29.188c1.58 1.558 1.649 4.135.165 5.767l-6.73 7.405a3.756 3.756 0 0 1-5.5.122L163 173.092l-39 39.812L56.402 54zm32.593 30.615c-2.503-1.157-3.628-.05-2.514 2.471l41.64 94.202c.893 2.021 2.859 2.38 4.397.793l48.982-50.53c1.535-1.584 1.15-3.62-.847-4.545l-91.658-42.39z"/>`),
		g.Group(children),
	)
}
...
func Prev(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M175.967 60.858c0 14.184.118 120.734.118 134.66c0 13.925-7.798 16.307-14.543 10.568c-6.745-5.74-46.666-60.003-52.015-67.201c-5.348-7.198-4.449-12.951.086-20.28c4.535-7.328 47.284-62.224 52.46-68.2c5.176-5.977 13.894-3.73 13.894 10.453zm-51.265 71.792l32.874 43.167c1.336 1.754 2.424 1.393 2.424-.814l-.005-92.006c0-2.197-1.073-2.562-2.396-.792l-32.926 44.057c-1.328 1.776-1.31 4.63.029 6.388zM79.836 53.792c-.17-2.538 1.22-4.792 3.45-4.792h8.193c3.655 0 3.52.682 3.52 3.859c0 3.176-.394 147.132-.46 149.86c-.064 2.729-1.06 4.454-3.219 4.454s-6.252 0-8.33-.006c-2.079-.007-3.088-1.897-3.088-4.033s.104-146.803-.066-149.342z"/>`),
		g.Group(children),
	)
}

func PunchIn(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M24.28 67.494a3.999 3.999 0 0 1 4.005-3.994H83.78c8.837 0 19.659 6.169 24.165 13.767l50.391 84.966c4.51 7.604 15.33 13.767 24.157 13.767H227.7a4.002 4.002 0 0 1 4.005 4.007v8.986a4.004 4.004 0 0 1-3.998 4.007h-58.708c-8.835 0-19.602-6.196-24.04-13.828L95.32 93.828C90.88 86.19 80.114 80 71.28 80h-43c-2.21 0-4-1.797-4-3.994v-8.512z"/>`),
		g.Group(children),
	)
}
...
func Scissors(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M109.56 157.868a33.419 33.419 0 0 1 5.59 18.557c0 18.543-15.032 33.575-33.575 33.575C63.032 210 48 194.968 48 176.425c0-18.543 15.032-33.575 33.575-33.575a33.42 33.42 0 0 1 16.753 4.472l19.743-19.843l-17.873-17.963a33.419 33.419 0 0 1-18.623 5.634C63.032 115.15 48 100.118 48 81.575C48 63.032 63.032 48 81.575 48c18.543 0 33.575 15.032 33.575 33.575a33.41 33.41 0 0 1-4.43 16.68l18.309 18.21L198.144 47h9.974l-33.82 61.459c-1.062 1.93-3.714 3.39-5.918 3.249l-6.667-.426c-2.753-.176-6.585 1.261-8.545 3.21l-13.06 12.992l14.06 13.986c1.96 1.95 5.792 3.387 8.545 3.21l6.667-.425c2.204-.14 4.856 1.319 5.918 3.25l33.82 61.458h-9.974l-70.11-70.465l-19.473 19.37zM81.602 195c9.72 0 17.601-7.89 17.601-17.623s-7.88-17.623-17.601-17.623c-9.72 0-17.601 7.89-17.601 17.623S71.88 195 81.601 195zm0-95c9.72 0 17.601-7.89 17.601-17.623s-7.88-17.623-17.601-17.623c-9.72 0-17.601 7.89-17.601 17.623S71.88 100 81.601 100z"/>`),
		g.Group(children),
	)
}
...
func Speaker(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<g fill="currentColor" fill-rule="evenodd"><path d="M192 41.993v174.014c0 8.827-7.164 15.993-16 15.993H80c-8.844 0-16-7.16-16-15.993V41.993C64 33.166 71.164 26 80 26h96c8.844 0 16 7.16 16 15.993zm-16 9.015c0-4.423-3.588-8.008-8-8.008H88c-4.419 0-8 3.573-8 8.008v155.984c0 4.423 3.588 8.008 8 8.008h80c4.419 0 8-3.573 8-8.008V51.008z"/><path d="M128 192c-17.673 0-32-14.327-32-32c0-17.673 14.327-32 32-32c17.673 0 32 14.327 32 32c0 17.673-14.327 32-32 32zm.5-16c8.56 0 15.5-7.163 15.5-16s-6.94-16-15.5-16c-8.56 0-15.5 7.163-15.5 16s6.94 16 15.5 16zm-.5-72c-12.703 0-23-10.521-23-23.5S115.297 57 128 57s23 10.521 23 23.5s-10.297 23.5-23 23.5zm0-14.769c4.694 0 8.953-.25 8.953-9.087s-4.225-9.48-8.92-9.48c-4.694 0-8.919.643-8.919 9.48s4.192 9.087 8.886 9.087z"/></g>`),
		g.Group(children),
	)
}

func SquareswitchOff(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<g fill="currentColor" fill-rule="evenodd"><path d="M25 185.377V70.39c0-3.527 2.878-6.39 6.428-6.39h192.95c3.547 0 6.427 2.861 6.427 6.39v114.987c0 3.527-2.878 6.39-6.428 6.39H31.427c-3.547 0-6.427-2.86-6.427-6.39zm14.667-15.382c0 3.316 2.84 6.005 6.354 6.005h163.625c3.51 0 6.354-2.693 6.354-6.005v-83.99c0-3.316-2.841-6.005-6.354-6.005H46.021c-3.51 0-6.354 2.693-6.354 6.005v83.99z"/><path d="M120.236 163.017c0 1.766 1.789 3.197 3.996 3.197h8.008c2.207 0 3.996-1.43 3.996-3.197V92.75c0-1.765-1.79-3.197-3.996-3.197h-8.008c-2.207 0-3.996 1.43-3.996 3.197v70.267zm-32.726 0c0 1.766 1.789 3.197 3.996 3.197h8.008c2.207 0 3.996-1.43 3.996-3.197V92.75c0-1.765-1.789-3.197-3.996-3.197h-8.008c-2.207 0-3.996 1.43-3.996 3.197v70.267zm-31.726 0c0 1.766 1.79 3.197 3.997 3.197h8.007c2.207 0 3.996-1.43 3.996-3.197V92.75c0-1.765-1.788-3.197-3.996-3.197h-8.007c-2.207 0-3.997 1.43-3.997 3.197v70.267z"/></g>`),
		g.Group(children),
	)
}

func SquareswitchOn(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<g fill="currentColor" fill-rule="evenodd"><path d="M231 70.623V185.61c0 3.528-2.878 6.391-6.428 6.391H31.622c-3.547 0-6.427-2.861-6.427-6.39V70.622c0-3.527 2.878-6.39 6.428-6.39h192.95c3.547 0 6.427 2.86 6.427 6.39zm-14.667 15.382c0-3.316-2.84-6.005-6.354-6.005H46.354C42.844 80 40 82.693 40 86.005v83.99c0 3.316 2.841 6.005 6.354 6.005h163.625c3.51 0 6.354-2.693 6.354-6.005v-83.99z"/><path d="M135.764 92.983c0-1.766-1.789-3.197-3.996-3.197h-8.008c-2.207 0-3.996 1.43-3.996 3.197v70.267c0 1.765 1.79 3.197 3.996 3.197h8.008c2.207 0 3.996-1.43 3.996-3.197V92.983zm32.726 0c0-1.766-1.789-3.197-3.996-3.197h-8.008c-2.207 0-3.996 1.43-3.996 3.197v70.267c0 1.765 1.789 3.197 3.996 3.197h8.008c2.207 0 3.996-1.43 3.996-3.197V92.983zm31.726 0c0-1.766-1.79-3.197-3.997-3.197h-8.007c-2.207 0-3.996 1.43-3.996 3.197v70.267c0 1.765 1.788 3.197 3.996 3.197h8.007c2.207 0 3.997-1.43 3.997-3.197V92.983z"/></g>`),
		g.Group(children),
	)
}

func Stereo(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M128.802 95.03c-9.229-9.369-22.39-15.228-37-15.228c-27.92 0-50.555 21.402-50.555 47.803c0 26.4 22.634 47.802 50.555 47.802c14.711 0 27.954-5.94 37.193-15.423c-12.232-16.88-14.177-19.888-14.177-32.38c0-12.016 5.924-18.458 14.19-31.142c6.753 13.293 13.629 19.445 13.629 31.538c0 12.802-6.03 20.525-13.402 32.614c9.206 9.115 22.185 14.793 36.567 14.793c27.922 0 50.556-21.401 50.556-47.802c0-26.4-22.634-47.803-50.556-47.803c-14.608 0-27.77 5.86-37 15.228zM128 75.374C138.501 68.202 151.252 64 165 64c35.899 0 65 28.654 65 64c0 35.346-29.101 64-65 64c-13.748 0-26.499-4.202-37-11.374C117.499 187.798 104.748 192 91 192c-35.899 0-65-28.654-65-64c0-35.346 29.101-64 65-64c13.748 0 26.499 4.202 37 11.374z"/>`),
		g.Group(children),
	)
}
...
func Thunderbolt(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M78.424 228.77c-.178 1.087.505 1.617 1.525 1.186l51.823-21.958c1.02-.433 1.149-1.346.29-2.039l-13.124-10.58l63.836-86.902c.654-.89.282-1.612-.808-1.612H128l53.414-79.142c.616-.912.21-1.65-.883-1.65h-34.145c-1.103 0-2.423.794-2.939 1.754L92.4 123.004c-.52.97-.044 1.755 1.053 1.755h48.942c1.102 0 1.477.73.834 1.638l-41.005 57.873l-13.127-9.535c-.895-.65-1.764-.301-1.943.792l-8.729 53.243z"/>`),
		g.Group(children),
	)
}
...
func Undo(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M55.265 167.072c-.975-1.973-3.388-2.796-5.372-1.847L42 169s22.5 53.5 85.5 56c60-1.5 96.627-48.626 97-96.5c.373-47.874-37-95.5-95.5-96c-57.5-1-79.556 45.004-79.556 45.004c-1.073 1.93-1.944 1.698-1.944-.501V51.997a4 4 0 0 0-4-3.997H37c-2.209 0-4 1.8-4 4.008v48.984A3.998 3.998 0 0 0 36.998 105h50.504a3.995 3.995 0 0 0 3.998-3.993v-6.014c0-2.205-1.79-4.02-4.008-4.053l-25.484-.38c-2.214-.033-3.223-1.679-2.182-3.628C59.826 86.932 78 45 128.5 45.5c49 .5 82.751 41.929 82.5 83.242C208 184 166 211 127.5 210c-54.5 0-72.235-42.928-72.235-42.928z"/>`),
		g.Group(children),
	)
}
...
func VroundswitchOff(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M128 25c8.667 0 16.95 1.71 24.85 5.13c7.9 3.42 14.7 7.996 20.4 13.73c5.7 5.733 10.25 12.573 13.65 20.52c3.4 7.946 5.1 16.278 5.1 24.995v77.25c0 8.717-1.7 17.05-5.1 24.996c-3.4 7.946-7.95 14.786-13.65 20.52c-5.7 5.733-12.5 10.31-20.4 13.73C144.95 229.29 136.667 231 128 231c-8.667 0-16.95-1.71-24.85-5.13c-7.9-3.42-14.7-7.996-20.4-13.73c-5.7-5.733-10.25-12.573-13.65-20.52c-3.4-7.946-5.1-16.278-5.1-24.995v-77.25c0-8.717 1.7-17.05 5.1-24.996c3.4-7.946 7.95-14.786 13.65-20.52c5.7-5.733 12.5-10.31 20.4-13.73C111.05 26.71 119.333 25 128 25zm.064 18c-6.508 0-12.72 1.36-18.634 4.08c-5.914 2.72-11.03 6.397-15.349 11.032c-4.318 4.634-7.744 10.125-10.279 16.472C81.267 80.93 80 87.596 80 94.58v31.47c3.802-5.44 16.147-16.472 23.281-19.947c7.135-3.476 17.96-5.642 24.468-5.642c.782 0 1.577-.022 2.397-.044h.001c5.999-.166 13.327-.367 26.831 7.701c9.439 5.639 16.357 13.944 19.15 17.909v.628c1.88 2.637 1.748 1.855 0-.628V94.58c0-6.985-1.267-13.65-3.801-19.997c-2.535-6.347-5.962-11.838-10.28-16.472c-4.318-4.635-9.434-8.312-15.348-11.032A44.086 44.086 0 0 0 128.064 43zm-18.674 78.797C115.297 119.266 121.5 118 128 118s12.703 1.266 18.609 3.797c5.907 2.531 11.016 5.953 15.328 10.266c4.313 4.312 7.735 9.421 10.266 15.327C174.734 153.297 176 159.5 176 166s-1.266 12.703-3.797 18.609c-2.531 5.907-5.953 11.016-10.266 15.328c-4.312 4.313-9.421 7.735-15.327 10.266C140.703 212.734 134.5 214 128 214s-12.703-1.266-18.609-3.797c-5.907-2.531-11.016-5.953-15.328-10.266c-4.313-4.312-7.735-9.421-10.266-15.327C81.266 178.703 80 172.5 80 166s1.266-12.703 3.797-18.609c2.531-5.907 5.953-11.016 10.265-15.328c4.313-4.313 9.422-7.735 15.328-10.266z" clip-rule="evenodd"/>`),
		g.Group(children),
	)
}

func VroundswitchOn(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M128 231c-8.667 0-16.95-1.71-24.85-5.13c-7.9-3.42-14.7-7.996-20.4-13.73c-5.7-5.733-10.25-12.573-13.65-20.52c-3.4-7.946-5.1-16.278-5.1-24.995v-77.25c0-8.717 1.7-17.05 5.1-24.996c3.4-7.946 7.95-14.786 13.65-20.52c5.7-5.733 12.5-10.31 20.4-13.73C111.05 26.71 119.333 25 128 25c8.667 0 16.95 1.71 24.85 5.13c7.9 3.42 14.7 7.996 20.4 13.73c5.7 5.733 10.25 12.573 13.65 20.52c3.4 7.946 5.1 16.278 5.1 24.995v77.25c0 8.717-1.7 17.05-5.1 24.996c-3.4 7.946-7.95 14.786-13.65 20.52c-5.7 5.733-12.5 10.31-20.4 13.73C144.95 229.29 136.667 231 128 231zm-.064-18c6.508 0 12.72-1.36 18.634-4.08c5.914-2.72 11.03-6.397 15.349-11.032c4.318-4.634 7.744-10.125 10.279-16.472c2.535-6.346 3.802-13.012 3.802-19.997v-31.47c-3.802 5.44-16.147 16.472-23.281 19.947c-7.135 3.476-17.96 5.642-24.468 5.642c-.783 0-1.578.022-2.398.044c-5.999.166-13.327.367-26.831-7.701c-9.44-5.639-16.357-13.944-19.15-17.909v-.628c-1.88-2.637-1.748-1.855 0 .628v31.447c0 6.985 1.267 13.65 3.801 19.997c2.535 6.347 5.962 11.838 10.28 16.472c4.318 4.635 9.434 8.312 15.348 11.032a44.085 44.085 0 0 0 18.635 4.08zm18.674-78.797C140.703 136.734 134.5 138 128 138s-12.703-1.266-18.609-3.797c-5.907-2.531-11.016-5.953-15.328-10.265c-4.313-4.313-7.735-9.422-10.266-15.328C81.266 102.703 80 96.5 80 90s1.266-12.703 3.797-18.609c2.531-5.907 5.953-11.016 10.265-15.328c4.313-4.313 9.422-7.735 15.328-10.266C115.297 43.266 121.5 42 128 42s12.703 1.266 18.609 3.797c5.907 2.531 11.016 5.953 15.328 10.265c4.313 4.313 7.735 9.422 10.266 15.328C174.734 77.297 176 83.5 176 90s-1.266 12.703-3.797 18.609c-2.531 5.907-5.953 11.016-10.266 15.328c-4.312 4.313-9.421 7.735-15.327 10.266z" clip-rule="evenodd"/>`),
		g.Group(children),
	)
}

func VsquareswitchOff(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<g fill="currentColor" fill-rule="evenodd"><path d="M185.377 231H70.39c-3.528 0-6.391-2.878-6.391-6.428V31.622c0-3.547 2.861-6.427 6.39-6.427h114.987c3.527 0 6.39 2.878 6.39 6.428v192.95c0 3.547-2.86 6.427-6.39 6.427zm-15.382-14.667c3.316 0 6.005-2.84 6.005-6.354V46.354c0-3.51-2.693-6.354-6.005-6.354h-83.99C82.69 40 80 42.841 80 46.354v163.625c0 3.51 2.693 6.354 6.005 6.354h83.99z"/><path d="M163.017 135.764c1.766 0 3.197-1.789 3.197-3.996v-8.008c0-2.207-1.43-3.996-3.197-3.996H92.75c-1.765 0-3.197 1.79-3.197 3.996v8.008c0 2.207 1.43 3.996 3.197 3.996h70.267zm0 32.726c1.766 0 3.197-1.789 3.197-3.996v-8.008c0-2.207-1.43-3.996-3.197-3.996H92.75c-1.765 0-3.197 1.789-3.197 3.996v8.008c0 2.207 1.43 3.996 3.197 3.996h70.267zm0 31.726c1.766 0 3.197-1.79 3.197-3.997v-8.007c0-2.207-1.43-3.996-3.197-3.996H92.75c-1.765 0-3.197 1.788-3.197 3.996v8.007c0 2.207 1.43 3.997 3.197 3.997h70.267z"/></g>`),
		g.Group(children),
	)
}

func VsquareswitchOn(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 256 256"),
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<g fill="currentColor" fill-rule="evenodd"><path d="M70.623 25H185.61c3.528 0 6.391 2.878 6.391 6.428v192.95c0 3.547-2.861 6.427-6.39 6.427H70.622c-3.527 0-6.39-2.878-6.39-6.428V31.427c0-3.547 2.86-6.427 6.39-6.427zm15.382 14.667c-3.316 0-6.005 2.84-6.005 6.354v163.625c0 3.51 2.693 6.354 6.005 6.354h83.99c3.316 0 6.005-2.841 6.005-6.354V46.021c0-3.51-2.693-6.354-6.005-6.354h-83.99z"/><path d="M92.983 120.236c-1.766 0-3.197 1.789-3.197 3.996v8.008c0 2.207 1.43 3.996 3.197 3.996h70.267c1.765 0 3.197-1.79 3.197-3.996v-8.008c0-2.207-1.43-3.996-3.197-3.996H92.983zm0-32.726c-1.766 0-3.197 1.789-3.197 3.996v8.008c0 2.207 1.43 3.996 3.197 3.996h70.267c1.765 0 3.197-1.789 3.197-3.996v-8.008c0-2.207-1.43-3.996-3.197-3.996H92.983zm0-31.726c-1.766 0-3.197 1.79-3.197 3.997v8.007c0 2.207 1.43 3.996 3.197 3.996h70.267c1.765 0 3.197-1.788 3.197-3.996v-8.007c0-2.207-1.43-3.997-3.197-3.997H92.983z"/></g>`),
		g.Group(children),
	)
}
...
func Zoomout(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 16px; height: 16px; display: block;"),
		g.Raw(`<g fill="currentColor" fill-rule="evenodd"><path d="M120.46 158.29c-30.166 8.65-61.631-8.792-70.281-38.957c-8.65-30.165 8.792-61.63 38.957-70.28c30.165-8.65 61.63 8.792 70.28 38.957c4.417 15.403-1.937 38.002-9.347 50.872c-.614 1.067 59.212 53.064 59.212 53.064l-17.427 17.63l-53.514-56.72s-10.233 3.241-17.88 5.434zM104 144c22.091 0 40-17.909 40-40s-17.909-40-40-40s-40 17.909-40 40s17.909 40 40 40z"/><path d="M80 96.084v15.992h48V96.084z"/></g>`),
		g.Group(children),
	)
}
