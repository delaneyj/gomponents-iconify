...
func IconFromName(name string) g.Node {
	...
	case "article":
		return Article()
	case "articleMultiple":
		return ArticleMultiple()
	case "aspectRatio":
		return AspectRatio()
	case "at":
		return At()
	...
	case "briefcaseDelete":
		return BriefcaseDelete()
	...
	case "briefcaseSearchOne":
		return BriefcaseSearchOne()
	...
	case "calendarSortAscending":
		return CalendarSortAscending()
	case "calendarSortDescending":
		return CalendarSortDescending()
	case "calendarText":
		return CalendarText()
	case "calendarToday":
	...
	case "cast":
		return Cast()
	case "cellularSignalOff":
		return CellularSignalOff()
	case "cellularSignalOne":
		return CellularSignalOne()
	case "cellularSignalThree":
		return CellularSignalThree()
	case "cellularSignalTwo":
		return CellularSignalTwo()
	case "cellularSignalZero":
		return CellularSignalZero()
	case "chart":
		return Chart()
	case "chartAdd":
		return ChartAdd()
	...
	case "chevronUp":
		return ChevronUp()
	case "chevronsHorizontal":
		return ChevronsHorizontal()
	case "chevronsVertical":
		return ChevronsVertical()
	case "circle":
		return Circle()
	case "clipboard":
		return Clipboard()
	...
	case "deviceTv":
		return DeviceTv()
	case "deviceTvSmart":
		return DeviceTvSmart()
	case "deviceVibrate":
		return DeviceVibrate()
	case "deviceWatch":
		return DeviceWatch()
	case "devices":
		return Devices()
	...
	case "labelAlt":
		return LabelAlt()
	case "labelAltMultiple":
		return LabelAltMultiple()
	case "labelSharp":
		return LabelSharp()
	case "layout":
		return Layout()
	...
	case "layoutDistributeHorizontal":
		return LayoutDistributeHorizontal()
	case "layoutDistributeVertical":
		return LayoutDistributeVertical()
	case "layoutFooter":
		return LayoutFooter()
	case "layoutHeader":
		return LayoutHeader()
	...
	case "removeBox":
		return RemoveBox()
	case "removeBoxMultiple":
		return RemoveBoxMultiple()
	case "repeat":
		return Repeat()
	case "reply":
		return Reply()
