...
func IconFromName(name string) g.Node {
	...
	case "sort":
		return Sort()
	case "sortAlphaAltDown":
		return SortAlphaAltDown()
	case "sortAlphaAltUp":
		return SortAlphaAltUp()
	case "sortAlphaDown":
	...
	case "sortDown":
		return SortDown()
	case "sortNumericAltDown":
		return SortNumericAltDown()
	case "sortNumericAltUp":
		return SortNumericAltUp()
