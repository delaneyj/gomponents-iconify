...
const (
	...
	accessibilityPath            = `<path fill="currentColor" fill-rule="evenodd" d="M.877 7.5a6.623 6.623 0 1 1 13.246 0a6.623 6.623 0 0 1-13.246 0ZM7.5 1.827a5.673 5.673 0 1 0 0 11.346a5.673 5.673 0 0 0 0-11.346ZM7.125 9c-.055.127-.793 2.96-.793 2.96a.5.5 0 1 1-.966-.26s.88-2.827.88-3.43V6.801l-1.958-.525a.5.5 0 1 1 .258-.966s1.654.563 2.3.563h1.309c.645 0 2.298-.563 2.298-.563a.5.5 0 1 1 .26.966l-1.966.527V8.27c0 .603.88 3.427.88 3.427a.5.5 0 0 1-.966.259S7.92 9.127 7.869 9c-.05-.127-.219-.127-.219-.127h-.307s-.173 0-.218.127ZM7.5 5.12a1.125 1.125 0 1 0 0-2.25a1.125 1.125 0 0 0 0 2.25Z" clip-rule="evenodd"/>`
	activityLogPath              = `<path fill="currentColor" fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm4 0a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1h-10a.5.5 0 0 1-.5-.5Zm0 3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm-4 3A.5.5 0 0 1 .5 7h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm4 0a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1h-10a.5.5 0 0 1-.5-.5Zm0 3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm-4 3a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm4 0a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1h-10a.5.5 0 0 1-.5-.5Z" clip-rule="evenodd"/>`
	alignBaselinePath            = `<path fill="currentColor" fill-rule="evenodd" d="M10.5 1.75a.5.5 0 0 1 .47.33l3 8.32a.5.5 0 1 1-.94.34l-.982-2.724H8.952L7.97 10.74a.5.5 0 0 1-.94-.339l3-8.32a.5.5 0 0 1 .47-.33Zm0 1.974l1.241 3.442H9.26l1.24-3.442ZM2.5 2.1c.22 0 .4.18.4.4v7.034l1.317-1.317a.4.4 0 0 1 .565.566l-2 2a.4.4 0 0 1-.565 0l-2-2a.4.4 0 1 1 .565-.566L2.1 9.534V2.5c0-.22.18-.4.4-.4ZM.1 13.5a.4.4 0 0 1 .4-.4h14a.4.4 0 1 1 0 .8H.5a.4.4 0 0 1-.4-.4Z" clip-rule="evenodd"/>`
	alignBottomPath              = `<path fill="currentColor" fill-rule="evenodd" d="M9 3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1v11H1.5a.5.5 0 0 0 0 1h12a.5.5 0 0 0 0-1H9V3Z" clip-rule="evenodd"/>`
	alignCenterPath              = `<g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M6 7.05V4h3v3.05H6zm-1 0H1.5a.45.45 0 0 0 0 .9H5v3.3c0 .414.336.75.75.75h3.5a.75.75 0 0 0 .75-.75v-3.3h3.5a.45.45 0 0 0 0-.9H10v-3.3A.75.75 0 0 0 9.25 3h-3.5a.75.75 0 0 0-.75.75v3.3zm4 .9V11H6V7.95h3z" fill="currentColor"/></g>`
	alignCenterHorizontallyPath  = `<path fill="currentColor" fill-rule="evenodd" d="M2 6a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h5v4.5a.5.5 0 0 0 1 0V9h5a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H8V1.5a.5.5 0 0 0-1 0V6H2Z" clip-rule="evenodd"/>`
	alignCenterVerticallyPath    = `<path fill="currentColor" fill-rule="evenodd" d="M7 1a1 1 0 0 0-1 1v5H1.5a.5.5 0 0 0 0 1H6v5a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V8h4.5a.5.5 0 0 0 0-1H9V2a1 1 0 0 0-1-1H7Z" clip-rule="evenodd"/>`
	alignEndPath                 = `<g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M6 11V4h3v7H6zM5 3.75A.75.75 0 0 1 5.75 3h3.5a.75.75 0 0 1 .75.75v7.5a.75.75 0 0 1-.75.75h-3.5a.75.75 0 0 1-.75-.75v-7.5zm-3.5 9.3a.45.45 0 0 0 0 .9h12a.45.45 0 1 0 0-.9h-12z" fill="currentColor"/></g>`
	alignHorizontalCentersPath   = `<g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.25 2C2.56 2 2 2.56 2 3.25v8.5c0 .69.56 1.25 1.25 1.25h2.5C6.44 13 7 12.44 7 11.75v-8.5C7 2.56 6.44 2 5.75 2h-2.5zM3 3.25A.25.25 0 0 1 3.25 3h2.5a.25.25 0 0 1 .25.25v8.5a.25.25 0 0 1-.25.25h-2.5a.25.25 0 0 1-.25-.25v-8.5zM9.25 4C8.56 4 8 4.56 8 5.25v4.5c0 .69.56 1.25 1.25 1.25h2.5c.69 0 1.25-.56 1.25-1.25v-4.5C13 4.56 12.44 4 11.75 4h-2.5z" fill="currentColor"/></g>`
	alignLeftPath                = `<path fill="currentColor" fill-rule="evenodd" d="M.5 1a.5.5 0 0 0-.5.5v12a.5.5 0 0 0 1 0V9h11a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H1V1.5A.5.5 0 0 0 .5 1Z" clip-rule="evenodd"/>`
	alignRightPath               = `<path fill="currentColor" fill-rule="evenodd" d="M14.5 1a.5.5 0 0 0-.5.5V6H3a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h11v4.5a.5.5 0 1 0 1 0v-12a.5.5 0 0 0-.5-.5Z" clip-rule="evenodd"/>`
	alignStartPath               = `<g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M1.5 1.05a.45.45 0 1 0 0 .9h12a.45.45 0 0 0 0-.9h-12zM6 11V4h3v7H6zM5 3.75A.75.75 0 0 1 5.75 3h3.5a.75.75 0 0 1 .75.75v7.5a.75.75 0 0 1-.75.75h-3.5a.75.75 0 0 1-.75-.75v-7.5z" fill="currentColor"/></g>`
	alignStretchPath             = `<g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M1.05 1.5a.45.45 0 0 1 .45-.45h12a.45.45 0 0 1 0 .9h-12a.45.45 0 0 1-.45-.45zm0 12a.45.45 0 0 1 .45-.45h12a.45.45 0 0 1 0 .9h-12a.45.45 0 0 1-.45-.45zM6 11V4h3v7H6zM5 3.75A.75.75 0 0 1 5.75 3h3.5a.75.75 0 0 1 .75.75v7.5a.75.75 0 0 1-.75.75h-3.5a.75.75 0 0 1-.75-.75v-7.5z" fill="currentColor"/></g>`
	alignTopPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M1.5 0a.5.5 0 0 0 0 1H6v11a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V1h4.5a.5.5 0 0 0 0-1h-12Z" clip-rule="evenodd"/>`
	alignVerticalCentersPath     = `<g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M2 3.25C2 2.56 2.56 2 3.25 2h8.5c.69 0 1.25.56 1.25 1.25v2.5C13 6.44 12.44 7 11.75 7h-8.5C2.56 7 2 6.44 2 5.75v-2.5zM3.25 3a.25.25 0 0 0-.25.25v2.5c0 .138.112.25.25.25h8.5a.25.25 0 0 0 .25-.25v-2.5a.25.25 0 0 0-.25-.25h-8.5zM4 9.25C4 8.56 4.56 8 5.25 8h4.5c.69 0 1.25.56 1.25 1.25v2.5c0 .69-.56 1.25-1.25 1.25h-4.5C4.56 13 4 12.44 4 11.75v-2.5z" fill="currentColor"/></g>`
	allSidesPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M7.5.75L9.75 3h-4.5L7.5.75Zm0 13.5L9.75 12h-4.5l2.25 2.25Zm-4.5-9L.75 7.5L3 9.75v-4.5ZM14.25 7.5L12 5.25v4.5l2.25-2.25Z" clip-rule="evenodd"/>`
	anglePath                    = `<path fill="currentColor" fill-rule="evenodd" d="M8.891 2.194a.5.5 0 0 1 .115.697L2.474 12H13.5a.5.5 0 0 1 0 1h-12a.5.5 0 0 1-.406-.791l7.1-9.9a.5.5 0 0 1 .697-.115ZM11.1 6.5a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0ZM10.4 4a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1Zm1.7 4.5a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0Zm1.3 1.5a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1Z" clip-rule="evenodd"/>`
	archivePath                  = `<path fill="currentColor" fill-rule="evenodd" d="M3.309 1a1 1 0 0 0-.894.553L1.053 4.276A.5.5 0 0 0 1 4.5V13a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1V4.5a.5.5 0 0 0-.053-.224l-1.362-2.723A1 1 0 0 0 11.691 1H3.309Zm0 1H7v2H2.309l1-2ZM8 4V2h3.691l1 2H8Zm-.5 1H13v8H2V5h5.5Zm-2 2a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4Z" clip-rule="evenodd"/>`
	arrowBottomLeftPath          = `<path fill="currentColor" fill-rule="evenodd" d="M11.354 3.646a.5.5 0 0 1 0 .708L4.707 11H9a.5.5 0 0 1 0 1H3.5a.5.5 0 0 1-.5-.5V6a.5.5 0 0 1 1 0v4.293l6.646-6.647a.5.5 0 0 1 .708 0Z" clip-rule="evenodd"/>`
	arrowBottomRightPath         = `<path fill="currentColor" fill-rule="evenodd" d="M3.646 3.646a.5.5 0 0 0 0 .708L10.293 11H6a.5.5 0 0 0 0 1h5.5a.5.5 0 0 0 .5-.5V6a.5.5 0 0 0-1 0v4.293L4.354 3.646a.5.5 0 0 0-.708 0Z" clip-rule="evenodd"/>`
	arrowDownPath                = `<path fill="currentColor" fill-rule="evenodd" d="M7.5 2a.5.5 0 0 1 .5.5v8.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 1 1 .708-.708L7 11.293V2.5a.5.5 0 0 1 .5-.5Z" clip-rule="evenodd"/>`
	arrowLeftPath                = `<path fill="currentColor" fill-rule="evenodd" d="M6.854 3.146a.5.5 0 0 1 0 .708L3.707 7H12.5a.5.5 0 0 1 0 1H3.707l3.147 3.146a.5.5 0 0 1-.708.708l-4-4a.5.5 0 0 1 0-.708l4-4a.5.5 0 0 1 .708 0Z" clip-rule="evenodd"/>`
	arrowRightPath               = `<path fill="currentColor" fill-rule="evenodd" d="M8.146 3.146a.5.5 0 0 1 .708 0l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L11.293 8H2.5a.5.5 0 0 1 0-1h8.793L8.146 3.854a.5.5 0 0 1 0-.708Z" clip-rule="evenodd"/>`
	arrowTopLeftPath             = `<path fill="currentColor" fill-rule="evenodd" d="M11.354 11.354a.5.5 0 0 0 0-.707L4.707 4H9a.5.5 0 0 0 0-1H3.5a.5.5 0 0 0-.5.5V9a.5.5 0 0 0 1 0V4.707l6.646 6.647a.5.5 0 0 0 .708 0Z" clip-rule="evenodd"/>`
	arrowTopRightPath            = `<path fill="currentColor" fill-rule="evenodd" d="M3.646 11.354a.5.5 0 0 1 0-.707L10.293 4H6a.5.5 0 0 1 0-1h5.5a.5.5 0 0 1 .5.5V9a.5.5 0 0 1-1 0V4.707l-6.646 6.647a.5.5 0 0 1-.708 0Z" clip-rule="evenodd"/>`
	arrowUpPath                  = `<path fill="currentColor" fill-rule="evenodd" d="M7.146 2.146a.5.5 0 0 1 .708 0l4 4a.5.5 0 0 1-.708.708L8 3.707V12.5a.5.5 0 0 1-1 0V3.707L3.854 6.854a.5.5 0 1 1-.708-.708l4-4Z" clip-rule="evenodd"/>`
	aspectRatioPath              = `<path fill="currentColor" fill-rule="evenodd" d="M2.5 2h10a.5.5 0 0 1 .5.5v10a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5ZM1 2.5A1.5 1.5 0 0 1 2.5 1h10A1.5 1.5 0 0 1 14 2.5v10a1.5 1.5 0 0 1-1.5 1.5h-10A1.5 1.5 0 0 1 1 12.5v-10ZM7.5 4a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1ZM8 5.5a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0ZM7.5 8a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Zm2.5-.5a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0Zm1.5.5a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Z" clip-rule="evenodd"/>`
	avatarPath                   = `<path fill="currentColor" fill-rule="evenodd" d="M.877 7.5a6.623 6.623 0 1 1 13.246 0a6.623 6.623 0 0 1-13.246 0ZM7.5 1.827a5.673 5.673 0 0 0-4.193 9.494A4.971 4.971 0 0 1 7.5 9.025a4.97 4.97 0 0 1 4.193 2.296A5.673 5.673 0 0 0 7.5 1.827Zm3.482 10.152A4.023 4.023 0 0 0 7.5 9.975a4.023 4.023 0 0 0-3.482 2.004A5.648 5.648 0 0 0 7.5 13.173c1.312 0 2.52-.446 3.482-1.194ZM5.15 6.505a2.35 2.35 0 1 1 4.7 0a2.35 2.35 0 0 1-4.7 0Zm2.35-1.4a1.4 1.4 0 1 0 0 2.8a1.4 1.4 0 0 0 0-2.8Z" clip-rule="evenodd"/>`
	backpackPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M5 1a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v1h4a1 1 0 0 1 1 1v3c0 .889-.387 1.687-1 2.236V11.5a1.5 1.5 0 0 1-1.5 1.5h-10A1.5 1.5 0 0 1 1 11.5V8.236A2.993 2.993 0 0 1 0 6V3a1 1 0 0 1 1-1h4V1Zm4 0v1H6V1h3ZM1 3h13v3a1.996 1.996 0 0 1-2 2H8v-.5a.5.5 0 0 0-1 0V8H3a1.996 1.996 0 0 1-2-2V3Zm6 6H3c-.35 0-.687-.06-1-.17v2.67a.5.5 0 0 0 .5.5h10a.5.5 0 0 0 .5-.5V8.83c-.313.11-.65.17-1 .17H8v.5a.5.5 0 0 1-1 0V9Z" clip-rule="evenodd"/>`
	badgePath                    = `<path fill="currentColor" fill-rule="evenodd" d="M3.5 6h8a1.5 1.5 0 0 1 0 3h-8a1.5 1.5 0 1 1 0-3ZM1 7.5A2.5 2.5 0 0 1 3.5 5h8a2.5 2.5 0 0 1 0 5h-8A2.5 2.5 0 0 1 1 7.5ZM4.5 7a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1h-6Z" clip-rule="evenodd"/>`
	barChartPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M11.5 1a.5.5 0 0 1 .5.5v12a.5.5 0 0 1-1 0v-12a.5.5 0 0 1 .5-.5Zm-2 2a.5.5 0 0 1 .5.5v10a.5.5 0 0 1-1 0v-10a.5.5 0 0 1 .5-.5Zm4 0a.5.5 0 0 1 .5.5v10a.5.5 0 0 1-1 0v-10a.5.5 0 0 1 .5-.5Zm-8 1a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-1 0v-9a.5.5 0 0 1 .5-.5Zm-4 1a.5.5 0 0 1 .5.5v8a.5.5 0 0 1-1 0v-8a.5.5 0 0 1 .5-.5Zm6 0a.5.5 0 0 1 .5.5v8a.5.5 0 0 1-1 0v-8a.5.5 0 0 1 .5-.5Zm-4 2a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0v-6a.5.5 0 0 1 .5-.5Z" clip-rule="evenodd"/>`
	bellPath                     = `<path fill="currentColor" fill-rule="evenodd" d="M8.601 1.25a1.1 1.1 0 0 1-.8 1.06A4.5 4.5 0 0 1 12 6.8v3.45c0 .806.033 1.457.724 1.803A.5.5 0 0 1 12.5 13H8.161a1 1 0 1 1-1.323 0H2.5a.5.5 0 0 1-.224-.947c.691-.346.724-.997.724-1.803V6.8a4.5 4.5 0 0 1 4.2-4.49a1.1 1.1 0 1 1 1.401-1.06ZM7.5 3.3A3.5 3.5 0 0 0 4 6.8v3.5c0 .446.001 1.108-.3 1.7h7.6c-.301-.592-.3-1.254-.3-1.7V6.8a3.5 3.5 0 0 0-3.5-3.5Z" clip-rule="evenodd"/>`
	blendingModePath             = `<path fill="currentColor" fill-rule="evenodd" d="M3 9c0-2.5 1.5-4.75 4.5-7.5c3 2.75 4.5 5 4.5 7.5a4.5 4.5 0 1 1-9 0Zm7.952-.697c-1.279-.482-2.664.16-3.962.76c-1.057.488-2.056.95-2.893.759A3.51 3.51 0 0 1 4 9c0-1.888 1.027-3.728 3.5-6.126c2.168 2.102 3.225 3.776 3.452 5.43Z" clip-rule="evenodd"/>`
	bookmarkPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M3 2.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v11a.5.5 0 0 1-.765.424L7.5 11.59l-3.735 2.334A.5.5 0 0 1 3 13.5v-11ZM4 3v9.598l2.97-1.856a1 1 0 0 1 1.06 0L11 12.598V3H4Z" clip-rule="evenodd"/>`
	bookmarkFilledPath           = `<path fill="currentColor" fill-rule="evenodd" d="M3.5 2a.5.5 0 0 0-.5.5v11a.5.5 0 0 0 .765.424L7.5 11.59l3.735 2.334A.5.5 0 0 0 12 13.5v-11a.5.5 0 0 0-.5-.5h-8Z" clip-rule="evenodd"/>`
	borderAllPath                = `<g fill="currentColor"><path fill-rule="evenodd" d="M.25 1A.75.75 0 0 1 1 .25h13a.75.75 0 0 1 .75.75v13a.75.75 0 0 1-.75.75H1A.75.75 0 0 1 .25 14V1Zm1.5.75v11.5h11.5V1.75H1.75Z" clip-rule="evenodd"/><rect width="1" height="1" x="7" y="5" rx=".5"/><rect width="1" height="1" x="7" y="3" rx=".5"/><rect width="1" height="1" x="7" y="7" rx=".5"/><rect width="1" height="1" x="5" y="7" rx=".5"/><rect width="1" height="1" x="3" y="7" rx=".5"/><rect width="1" height="1" x="9" y="7" rx=".5"/><rect width="1" height="1" x="11" y="7" rx=".5"/><rect width="1" height="1" x="7" y="9" rx=".5"/><rect width="1" height="1" x="7" y="11" rx=".5"/></g>`
	borderBottomPath             = `<g fill="currentColor"><path fill-rule="evenodd" d="M1 13.25h13v1.5H1v-1.5Z" clip-rule="evenodd"/><rect width="1" height="1" x="7" y="5" rx=".5"/><rect width="1" height="1" x="13" y="5" rx=".5"/><rect width="1" height="1" x="7" y="3" rx=".5"/><rect width="1" height="1" x="13" y="3" rx=".5"/><rect width="1" height="1" x="7" y="7" rx=".5"/><rect width="1" height="1" x="7" y="1" rx=".5"/><rect width="1" height="1" x="13" y="7" rx=".5"/><rect width="1" height="1" x="13" y="1" rx=".5"/><rect width="1" height="1" x="5" y="7" rx=".5"/><rect width="1" height="1" x="5" y="1" rx=".5"/><rect width="1" height="1" x="3" y="7" rx=".5"/><rect width="1" height="1" x="3" y="1" rx=".5"/><rect width="1" height="1" x="9" y="7" rx=".5"/><rect width="1" height="1" x="9" y="1" rx=".5"/><rect width="1" height="1" x="11" y="7" rx=".5"/><rect width="1" height="1" x="11" y="1" rx=".5"/><rect width="1" height="1" x="7" y="9" rx=".5"/><rect width="1" height="1" x="13" y="9" rx=".5"/><rect width="1" height="1" x="7" y="11" rx=".5"/><rect width="1" height="1" x="13" y="11" rx=".5"/><rect width="1" height="1" x="1" y="5" rx=".5"/><rect width="1" height="1" x="1" y="3" rx=".5"/><rect width="1" height="1" x="1" y="7" rx=".5"/><rect width="1" height="1" x="1" y="1" rx=".5"/><rect width="1" height="1" x="1" y="9" rx=".5"/><rect width="1" height="1" x="1" y="11" rx=".5"/></g>`
	borderDashedPath             = `<path fill="currentColor" fill-rule="evenodd" d="M0 7.5A.5.5 0 0 1 .5 7H3a.5.5 0 0 1 0 1H.5a.5.5 0 0 1-.5-.5Zm5.75 0a.5.5 0 0 1 .5-.5h2.5a.5.5 0 0 1 0 1h-2.5a.5.5 0 0 1-.5-.5ZM12 7a.5.5 0 0 0 0 1h2.5a.5.5 0 0 0 0-1H12Z" clip-rule="evenodd"/>`
	borderDottedPath             = `<path fill="currentColor" fill-rule="evenodd" d="M1.5 6.625a.875.875 0 1 0 0 1.75a.875.875 0 0 0 0-1.75Zm4 0a.875.875 0 1 0 0 1.75a.875.875 0 0 0 0-1.75Zm4 0a.875.875 0 1 0 0 1.75a.875.875 0 0 0 0-1.75Zm3.125.875a.875.875 0 1 1 1.75 0a.875.875 0 0 1-1.75 0Z" clip-rule="evenodd"/>`
	borderLeftPath               = `<g fill="currentColor"><path fill-rule="evenodd" d="M1.75 1v13H.25V1h1.5Z" clip-rule="evenodd"/><rect width="1" height="1" x="10" y="7" rx=".5" transform="rotate(90 10 7)"/><rect width="1" height="1" x="10" y="13" rx=".5" transform="rotate(90 10 13)"/><rect width="1" height="1" x="12" y="7" rx=".5" transform="rotate(90 12 7)"/><rect width="1" height="1" x="12" y="13" rx=".5" transform="rotate(90 12 13)"/><rect width="1" height="1" x="8" y="7" rx=".5" transform="rotate(90 8 7)"/><rect width="1" height="1" x="14" y="7" rx=".5" transform="rotate(90 14 7)"/><rect width="1" height="1" x="8" y="13" rx=".5" transform="rotate(90 8 13)"/><rect width="1" height="1" x="14" y="13" rx=".5" transform="rotate(90 14 13)"/><rect width="1" height="1" x="8" y="5" rx=".5" transform="rotate(90 8 5)"/><rect width="1" height="1" x="14" y="5" rx=".5" transform="rotate(90 14 5)"/><rect width="1" height="1" x="8" y="3" rx=".5" transform="rotate(90 8 3)"/><rect width="1" height="1" x="14" y="3" rx=".5" transform="rotate(90 14 3)"/><rect width="1" height="1" x="8" y="9" rx=".5" transform="rotate(90 8 9)"/><rect width="1" height="1" x="14" y="9" rx=".5" transform="rotate(90 14 9)"/><rect width="1" height="1" x="8" y="11" rx=".5" transform="rotate(90 8 11)"/><rect width="1" height="1" x="14" y="11" rx=".5" transform="rotate(90 14 11)"/><rect width="1" height="1" x="6" y="7" rx=".5" transform="rotate(90 6 7)"/><rect width="1" height="1" x="6" y="13" rx=".5" transform="rotate(90 6 13)"/><rect width="1" height="1" x="4" y="7" rx=".5" transform="rotate(90 4 7)"/><rect width="1" height="1" x="4" y="13" rx=".5" transform="rotate(90 4 13)"/><rect width="1" height="1" x="10" y="1" rx=".5" transform="rotate(90 10 1)"/><rect width="1" height="1" x="12" y="1" rx=".5" transform="rotate(90 12 1)"/><rect width="1" height="1" x="8" y="1" rx=".5" transform="rotate(90 8 1)"/><rect width="1" height="1" x="14" y="1" rx=".5" transform="rotate(90 14 1)"/><rect width="1" height="1" x="6" y="1" rx=".5" transform="rotate(90 6 1)"/><rect width="1" height="1" x="4" y="1" rx=".5" transform="rotate(90 4 1)"/></g>`
	...
	borderRightPath              = `<g fill="currentColor"><path fill-rule="evenodd" d="M13.25 1v13h1.5V1h-1.5Z" clip-rule="evenodd"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 5 7)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 5 13)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 3 7)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 3 13)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 7 7)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 1 7)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 7 13)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 1 13)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 7 5)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 1 5)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 7 3)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 1 3)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 7 9)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 1 9)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 7 11)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 1 11)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 9 7)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 9 13)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 11 7)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 11 13)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 5 1)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 3 1)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 7 1)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 1 1)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 9 1)"/><rect width="1" height="1" rx=".5" transform="matrix(0 1 1 0 11 1)"/></g>`
	borderSolidPath              = `<path fill="currentColor" fill-rule="evenodd" d="M1.25 7.5a.5.5 0 0 1 .5-.5h11.5a.5.5 0 0 1 0 1H1.75a.5.5 0 0 1-.5-.5Z" clip-rule="evenodd"/>`
	borderSplitPath              = `<g fill="currentColor"><rect width="1" height="1" x="7" y="5.025" rx=".5"/><rect width="1" height="1" x="7" y="3.025" rx=".5"/><rect width="1" height="1" x="7" y="7.025" rx=".5"/><rect width="1" height="1" x="7" y="13.025" rx=".5"/><rect width="1" height="1" x="7" y="1.025" rx=".5"/><rect width="1" height="1" x="13" y="7.025" rx=".5"/><rect width="1" height="1" x="5" y="7.025" rx=".5"/><rect width="1" height="1" x="3" y="7.025" rx=".5"/><rect width="1" height="1" x="9" y="7.025" rx=".5"/><rect width="1" height="1" x="11" y="7.025" rx=".5"/><rect width="1" height="1" x="7" y="9.025" rx=".5"/><rect width="1" height="1" x="7" y="11.025" rx=".5"/><rect width="1" height="1" x="1" y="7.025" rx=".5"/><path fill-rule="evenodd" d="M1 1.5a.5.5 0 0 1 .5-.5H6v1H2v4H1V1.5ZM13 2H9V1h4.5a.5.5 0 0 1 .5.5V6h-1V2ZM1 13.5V9h1v4h4v1H1.5a.5.5 0 0 1-.5-.5Zm12-.5V9h1v4.5a.5.5 0 0 1-.5.5h-4v-1H13Z" clip-rule="evenodd"/></g>`
	borderStylePath              = `<path fill="currentColor" fill-rule="evenodd" d="M1.5 3a.5.5 0 0 0 0 1h12a.5.5 0 0 0 0-1h-12ZM1 7.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm0 4a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0Zm2 0a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0Zm2.5-.5a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1Zm1.5.5a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0Zm2.5-.5a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1Zm1.5.5a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0Zm2.5-.5a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1Zm-7-4a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2Zm4.5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Z" clip-rule="evenodd"/>`
	borderTopPath                = `<g fill="currentColor"><path fill-rule="evenodd" d="M14 1.75H1V.25h13v1.5Z" clip-rule="evenodd"/><rect width="1" height="1" x="8" y="10" rx=".5" transform="rotate(-180 8 10)"/><rect width="1" height="1" x="2" y="10" rx=".5" transform="rotate(-180 2 10)"/><rect width="1" height="1" x="8" y="12" rx=".5" transform="rotate(-180 8 12)"/><rect width="1" height="1" x="2" y="12" rx=".5" transform="rotate(-180 2 12)"/><rect width="1" height="1" x="8" y="8" rx=".5" transform="rotate(-180 8 8)"/><rect width="1" height="1" x="8" y="14" rx=".5" transform="rotate(-180 8 14)"/><rect width="1" height="1" x="2" y="8" rx=".5" transform="rotate(-180 2 8)"/><rect width="1" height="1" x="2" y="14" rx=".5" transform="rotate(-180 2 14)"/><rect width="1" height="1" x="10" y="8" rx=".5" transform="rotate(-180 10 8)"/><rect width="1" height="1" x="10" y="14" rx=".5" transform="rotate(-180 10 14)"/><rect width="1" height="1" x="12" y="8" rx=".5" transform="rotate(-180 12 8)"/><rect width="1" height="1" x="12" y="14" rx=".5" transform="rotate(-180 12 14)"/><rect width="1" height="1" x="6" y="8" rx=".5" transform="rotate(-180 6 8)"/><rect width="1" height="1" x="6" y="14" rx=".5" transform="rotate(-180 6 14)"/><rect width="1" height="1" x="4" y="8" rx=".5" transform="rotate(-180 4 8)"/><rect width="1" height="1" x="4" y="14" rx=".5" transform="rotate(-180 4 14)"/><rect width="1" height="1" x="8" y="6" rx=".5" transform="rotate(-180 8 6)"/><rect width="1" height="1" x="2" y="6" rx=".5" transform="rotate(-180 2 6)"/><rect width="1" height="1" x="8" y="4" rx=".5" transform="rotate(-180 8 4)"/><rect width="1" height="1" x="2" y="4" rx=".5" transform="rotate(-180 2 4)"/><rect width="1" height="1" x="14" y="10" rx=".5" transform="rotate(-180 14 10)"/><rect width="1" height="1" x="14" y="12" rx=".5" transform="rotate(-180 14 12)"/><rect width="1" height="1" x="14" y="8" rx=".5" transform="rotate(-180 14 8)"/><rect width="1" height="1" x="14" y="14" rx=".5" transform="rotate(-180 14 14)"/><rect width="1" height="1" x="14" y="6" rx=".5" transform="rotate(-180 14 6)"/><rect width="1" height="1" x="14" y="4" rx=".5" transform="rotate(-180 14 4)"/></g>`
	borderWidthPath              = `<path fill="currentColor" fill-rule="evenodd" d="M1 3h13v1H1V3Zm0 3h13v2H1V6Zm13 4.25H1v2.5h13v-2.5Z" clip-rule="evenodd"/>`
	boxPath                      = `<path fill="currentColor" fill-rule="evenodd" d="M12.5 2h-10a.5.5 0 0 0-.5.5v10a.5.5 0 0 0 .5.5h10a.5.5 0 0 0 .5-.5v-10a.5.5 0 0 0-.5-.5Zm-10-1A1.5 1.5 0 0 0 1 2.5v10A1.5 1.5 0 0 0 2.5 14h10a1.5 1.5 0 0 0 1.5-1.5v-10A1.5 1.5 0 0 0 12.5 1h-10Z" clip-rule="evenodd"/>`
	boxModelPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M2 1a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H2Zm0 1h11v11H2V2Zm2.5 2a.5.5 0 0 0-.5.5v6a.5.5 0 0 0 .5.5h6a.5.5 0 0 0 .5-.5v-6a.5.5 0 0 0-.5-.5h-6Zm.5 6V5h5v5H5Z" clip-rule="evenodd"/>`
	buttonPath                   = `<path fill="currentColor" fill-rule="evenodd" d="M2 5h11a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1ZM0 6a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6Zm4.5.75a.75.75 0 1 0 0 1.5a.75.75 0 0 0 0-1.5Zm2.25.75a.75.75 0 1 1 1.5 0a.75.75 0 0 1-1.5 0Zm3.75-.75a.75.75 0 1 0 0 1.5a.75.75 0 0 0 0-1.5Z" clip-rule="evenodd"/>`
	calendarPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M4.5 1a.5.5 0 0 1 .5.5V2h5v-.5a.5.5 0 0 1 1 0V2h1.5A1.5 1.5 0 0 1 14 3.5v9a1.5 1.5 0 0 1-1.5 1.5h-10A1.5 1.5 0 0 1 1 12.5v-9A1.5 1.5 0 0 1 2.5 2H4v-.5a.5.5 0 0 1 .5-.5ZM10 3v.5a.5.5 0 0 0 1 0V3h1.5a.5.5 0 0 1 .5.5V5H2V3.5a.5.5 0 0 1 .5-.5H4v.5a.5.5 0 0 0 1 0V3h5ZM2 6v6.5a.5.5 0 0 0 .5.5h10a.5.5 0 0 0 .5-.5V6H2Zm5 1.5a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0ZM9.5 7a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1Zm1.5.5a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0Zm.5 1.5a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1ZM9 9.5a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0ZM7.5 9a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1ZM5 9.5a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0ZM3.5 9a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1ZM3 11.5a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0Zm2.5-.5a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1Zm1.5.5a.5.5 0 1 1 1 0a.5.5 0 0 1-1 0Zm2.5-.5a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1Z" clip-rule="evenodd"/>`
	cameraPath                   = `<path fill="currentColor" fill-rule="evenodd" d="M2 3a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H2ZM0 4a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2 .25A.25.25 0 0 1 2.25 4h2.5a.25.25 0 0 1 .25.25v1.505a.25.25 0 0 1-.25.25h-2.5a.25.25 0 0 1-.25-.25V4.25Zm10.101 3.334a2.601 2.601 0 1 1-5.202 0a2.601 2.601 0 0 1 5.202 0Zm1 0a3.601 3.601 0 1 1-7.202 0a3.601 3.601 0 0 1 7.202 0Z" clip-rule="evenodd"/>`
	cardStackPath                = `<path fill="currentColor" fill-rule="evenodd" d="M2 3.5a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-6Zm0 7.415A1.5 1.5 0 0 1 1 9.5v-6A1.5 1.5 0 0 1 2.5 2h10A1.5 1.5 0 0 1 14 3.5v6a1.5 1.5 0 0 1-1 1.415v.585a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 2 11.5v-.585ZM12 11v.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5V11h9Z" clip-rule="evenodd"/>`
	cardStackMinusPath           = `<path fill="currentColor" fill-rule="evenodd" d="M2.5 3a.5.5 0 0 0-.5.5v6a.5.5 0 0 0 .5.5h10a.5.5 0 0 0 .5-.5v-6a.5.5 0 0 0-.5-.5h-10ZM1 9.5a1.5 1.5 0 0 0 1 1.415v.585A1.5 1.5 0 0 0 3.5 13h8a1.5 1.5 0 0 0 1.5-1.5v-.585A1.5 1.5 0 0 0 14 9.5v-6A1.5 1.5 0 0 0 12.5 2h-10A1.5 1.5 0 0 0 1 3.5v6Zm11 2V11H3v.5a.5.5 0 0 0 .5.5h8a.5.5 0 0 0 .5-.5ZM5.5 6a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4Z" clip-rule="evenodd"/>`
	cardStackPlusPath            = `<path fill="currentColor" fill-rule="evenodd" d="M2 3.5a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-6Zm0 7.415A1.5 1.5 0 0 1 1 9.5v-6A1.5 1.5 0 0 1 2.5 2h10A1.5 1.5 0 0 1 14 3.5v6a1.5 1.5 0 0 1-1 1.415v.585a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 2 11.5v-.585ZM12 11v.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5V11h9ZM5 6.5a.5.5 0 0 1 .5-.5H7V4.5a.5.5 0 0 1 1 0V6h1.5a.5.5 0 0 1 0 1H8v1.5a.5.5 0 0 1-1 0V7H5.5a.5.5 0 0 1-.5-.5Z" clip-rule="evenodd"/>`
	caretDownPath                = `<path fill="currentColor" fill-rule="evenodd" d="M4.182 6.182a.45.45 0 0 1 .636 0L7.5 8.864l2.682-2.682a.45.45 0 0 1 .636.636l-3 3a.45.45 0 0 1-.636 0l-3-3a.45.45 0 0 1 0-.636Z" clip-rule="evenodd"/>`
	caretLeftPath                = `<path fill="currentColor" fill-rule="evenodd" d="M8.818 4.182a.45.45 0 0 1 0 .636L6.136 7.5l2.682 2.682a.45.45 0 1 1-.636.636l-3-3a.45.45 0 0 1 0-.636l3-3a.45.45 0 0 1 .636 0Z" clip-rule="evenodd"/>`
	caretRightPath               = `<path fill="currentColor" fill-rule="evenodd" d="M6.182 4.182a.45.45 0 0 1 .636 0l3 3a.45.45 0 0 1 0 .636l-3 3a.45.45 0 1 1-.636-.636L8.864 7.5L6.182 4.818a.45.45 0 0 1 0-.636Z" clip-rule="evenodd"/>`
	caretSortPath                = `<path fill="currentColor" fill-rule="evenodd" d="M4.932 5.432a.45.45 0 1 0 .636.636L7.5 4.136l1.932 1.932a.45.45 0 0 0 .636-.636l-2.25-2.25a.45.45 0 0 0-.636 0l-2.25 2.25Zm5.136 4.136a.45.45 0 0 0-.636-.636L7.5 10.864L5.568 8.932a.45.45 0 0 0-.636.636l2.25 2.25a.45.45 0 0 0 .636 0l2.25-2.25Z" clip-rule="evenodd"/>`
	caretUpPath                  = `<path fill="currentColor" fill-rule="evenodd" d="M4.182 8.818a.45.45 0 0 1 0-.636l3-3a.45.45 0 0 1 .636 0l3 3a.45.45 0 0 1-.636.636L7.5 6.136L4.818 8.818a.45.45 0 0 1-.636 0Z" clip-rule="evenodd"/>`
	chatBubblePath               = `<path fill="currentColor" fill-rule="evenodd" d="M12.5 3h-10A1.5 1.5 0 0 0 1 4.5v5A1.5 1.5 0 0 0 2.5 11h5a.5.5 0 0 1 .354.146L10 13.293V11.5a.5.5 0 0 1 .5-.5h2A1.5 1.5 0 0 0 14 9.5v-5A1.5 1.5 0 0 0 12.5 3Zm-10-1h10A2.5 2.5 0 0 1 15 4.5v5a2.5 2.5 0 0 1-2.5 2.5H11v2.5a.5.5 0 0 1-.854.354L7.293 12H2.5A2.5 2.5 0 0 1 0 9.5v-5A2.5 2.5 0 0 1 2.5 2Z" clip-rule="evenodd"/>`
	checkPath                    = `<path fill="currentColor" fill-rule="evenodd" d="M11.467 3.727c.289.189.37.576.181.865l-4.25 6.5a.625.625 0 0 1-.944.12l-2.75-2.5a.625.625 0 0 1 .841-.925l2.208 2.007l3.849-5.886a.625.625 0 0 1 .865-.181Z" clip-rule="evenodd"/>`
	checkCircledPath             = `<path fill="currentColor" fill-rule="evenodd" d="M7.5.877a6.623 6.623 0 1 0 0 13.246A6.623 6.623 0 0 0 7.5.877ZM1.827 7.5a5.673 5.673 0 1 1 11.346 0a5.673 5.673 0 0 1-11.346 0Zm8.332-1.962a.5.5 0 0 0-.818-.576L6.52 8.972L5.357 7.787a.5.5 0 0 0-.714.7L6.227 10.1a.5.5 0 0 0 .765-.062l3.167-4.5Z" clip-rule="evenodd"/>`
	checkboxPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M3 3h9v9H3V3ZM2 3a1 1 0 0 1 1-1h9a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3Zm8.35 2.511a.5.5 0 0 0-.825-.566L6.64 9.15L5.197 7.41a.5.5 0 0 0-.77.638l1.866 2.25a.5.5 0 0 0 .797-.037l3.26-4.749Z" clip-rule="evenodd"/>`
	chevronDownPath              = `<path fill="currentColor" fill-rule="evenodd" d="M3.135 6.158a.5.5 0 0 1 .707-.023L7.5 9.565l3.658-3.43a.5.5 0 0 1 .684.73l-4 3.75a.5.5 0 0 1-.684 0l-4-3.75a.5.5 0 0 1-.023-.707Z" clip-rule="evenodd"/>`
	chevronLeftPath              = `<path fill="currentColor" fill-rule="evenodd" d="M8.842 3.135a.5.5 0 0 1 .023.707L5.435 7.5l3.43 3.658a.5.5 0 0 1-.73.684l-3.75-4a.5.5 0 0 1 0-.684l3.75-4a.5.5 0 0 1 .707-.023Z" clip-rule="evenodd"/>`
	chevronRightPath             = `<path fill="currentColor" fill-rule="evenodd" d="M6.158 3.135a.5.5 0 0 1 .707.023l3.75 4a.5.5 0 0 1 0 .684l-3.75 4a.5.5 0 1 1-.73-.684L9.566 7.5l-3.43-3.658a.5.5 0 0 1 .023-.707Z" clip-rule="evenodd"/>`
	chevronUpPath                = `<path fill="currentColor" fill-rule="evenodd" d="M3.135 8.842a.5.5 0 0 0 .707.023L7.5 5.435l3.658 3.43a.5.5 0 0 0 .684-.73l-4-3.75a.5.5 0 0 0-.684 0l-4 3.75a.5.5 0 0 0-.023.707Z" clip-rule="evenodd"/>`
	circlePath                   = `<path fill="currentColor" fill-rule="evenodd" d="M.877 7.5a6.623 6.623 0 1 1 13.246 0a6.623 6.623 0 0 1-13.246 0ZM7.5 1.827a5.673 5.673 0 1 0 0 11.346a5.673 5.673 0 0 0 0-11.346Z" clip-rule="evenodd"/>`
	circleBackslashPath          = `<path fill="currentColor" fill-rule="evenodd" d="M7.5.877a6.623 6.623 0 1 0 0 13.246A6.623 6.623 0 0 0 7.5.877ZM3.858 3.151a5.673 5.673 0 0 1 7.992 7.992L3.857 3.15Zm-.707.707a5.673 5.673 0 0 0 7.992 7.992L3.15 3.857Z" clip-rule="evenodd"/>`
	clipboardPath                = `<path fill="currentColor" fill-rule="evenodd" d="M5 2V1h5v1H5Zm-.25-2A.75.75 0 0 0 4 .75V1h-.5A1.5 1.5 0 0 0 2 2.5v10A1.5 1.5 0 0 0 3.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-10A1.5 1.5 0 0 0 11.5 1H11V.75a.75.75 0 0 0-.75-.75h-5.5ZM11 2v.25a.75.75 0 0 1-.75.75h-5.5A.75.75 0 0 1 4 2.25V2h-.5a.5.5 0 0 0-.5.5v10a.5.5 0 0 0 .5.5h8a.5.5 0 0 0 .5-.5v-10a.5.5 0 0 0-.5-.5H11Z" clip-rule="evenodd"/>`
	clipboardCopyPath            = `<path fill="currentColor" fill-rule="evenodd" d="M5 2V1h5v1H5Zm-.25-2A.75.75 0 0 0 4 .75V1h-.5A1.5 1.5 0 0 0 2 2.5v10A1.5 1.5 0 0 0 3.5 14H7v-1H3.5a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5H4v.25c0 .414.336.75.75.75h5.5a.75.75 0 0 0 .75-.75V2h.5a.5.5 0 0 1 .5.5V7h1V2.5A1.5 1.5 0 0 0 11.5 1H11V.75a.75.75 0 0 0-.75-.75h-5.5ZM9 8.5a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0Zm1.5.5a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Zm2.5-.5a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0Zm1.5.5a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Zm.5 1.5a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0Zm-.5 2.5a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Zm0 2a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Zm-6-4a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Zm.5 1.5a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0ZM8.5 15a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Zm2.5-.5a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0Zm1.5.5a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Z" clip-rule="evenodd"/>`
	clockPath                    = `<path fill="currentColor" fill-rule="evenodd" d="M7.5.877a6.623 6.623 0 1 0 0 13.246A6.623 6.623 0 0 0 7.5.877ZM1.827 7.5a5.673 5.673 0 1 1 11.346 0a5.673 5.673 0 0 1-11.346 0ZM8 4.5a.5.5 0 0 0-1 0v3a.5.5 0 0 0 .146.354l2 2a.5.5 0 0 0 .708-.708L8 7.293V4.5Z" clip-rule="evenodd"/>`
	...
	heartFilledPath              = `<path fill="currentColor" fill-rule="evenodd" d="M1.352 4.905a3.547 3.547 0 0 1 3.541-3.553c1.365 0 1.968.571 2.607 1.583c.64-1.012 1.242-1.583 2.607-1.583a3.547 3.547 0 0 1 3.54 3.553c0 1.835-1.046 3.6-2.246 5.064c-1.137 1.387-2.48 2.582-3.395 3.397l-.173.155a.5.5 0 0 1-.666 0l-.173-.155c-.916-.815-2.258-2.01-3.395-3.397C2.4 8.505 1.352 6.74 1.352 4.905Z" clip-rule="evenodd"/>`
	heightPath                   = `<path fill="currentColor" fill-rule="evenodd" d="M7.181 1.682a.45.45 0 0 1 .637 0l2.5 2.5a.45.45 0 0 1-.637.636L7.95 3.086v8.828l1.731-1.732a.45.45 0 0 1 .637.636l-2.5 2.5a.45.45 0 0 1-.637 0l-2.5-2.5a.45.45 0 0 1 .637-.636l1.732 1.732V3.086L5.317 4.818a.45.45 0 0 1-.637-.636l2.5-2.5Z" clip-rule="evenodd"/>`
	hobbyKnifePath               = `<path fill="currentColor" fill-rule="evenodd" d="M12.354 13.354a.5.5 0 0 1-.707 0l-5.25-5.25A.5.5 0 0 1 6.316 8H5a.5.5 0 0 1-.472-.336l-2.4-6.9A.5.5 0 0 1 2.936.23l5.4 4.9a.5.5 0 0 1 .164.37v.317a.501.501 0 0 1 .104.08l5.25 5.25a.5.5 0 0 1 0 .707l-1.5 1.5ZM8.25 6.957l-.793.793L12 12.293l.793-.793L8.25 6.957ZM3.717 2.288L5.355 7h.938L7.5 5.793V5.72L3.717 2.288Z" clip-rule="evenodd"/>`
	homePath                     = `<path fill="currentColor" fill-rule="evenodd" d="M7.08.222a.6.6 0 0 1 .84 0l6.75 6.64a.6.6 0 0 1-.84.856L13 6.902V12.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5V6.902l-.83.816a.6.6 0 1 1-.84-.856L7.08.222Zm.42 1.27L12 5.918V12h-2V8.5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5V12H3V5.918l4.5-4.426ZM7 12h2V9H7v3Z" clip-rule="evenodd"/>`
	iconjarLogoPath              = `<path fill="currentColor" fill-rule="evenodd" d="M7.5.003c-.695 0-1.25.278-1.25.747c0 .247.174.37.327.477c.118.084.223.158.223.273c0 .207-.738.243-1.602.284c-1.222.06-2.698.13-2.698.716A.5.5 0 0 0 3 3h9a.5.5 0 0 0 .5-.5c0-.586-1.476-.657-2.698-.716C8.938 1.743 8.2 1.707 8.2 1.5c0-.115.105-.19.223-.273c.153-.107.327-.23.327-.477c0-.469-.555-.747-1.25-.747Zm-4.605 6.12a1.958 1.958 0 0 0-.87 1.933l.81 4.421A1.867 1.867 0 0 0 4.662 14h5.676c.898 0 1.651-.644 1.825-1.523l.812-4.42c.115-.733-.146-1.524-.84-1.963c-.406-.264-.493-.762 0-.966C12.827 4.864 12.693 4 12 4H3c-.695 0-.801.893-.105 1.157c.491.175.404.673 0 .966ZM8.2 6.25c0-.432-.114-.874-.294-1.25H4.111a1.4 1.4 0 0 1 .118.655c-.034.57-.383 1.014-.749 1.278l-.025.018l-.026.017a.96.96 0 0 0-.418.92l.807 4.4a.867.867 0 0 0 .843.712h5.676c.4 0 .756-.285.843-.711l.807-4.4c.061-.407-.092-.763-.388-.95l-.011-.007c-.393-.256-.755-.704-.79-1.284A1.398 1.398 0 0 1 10.912 5H9.055A2.127 2.127 0 0 0 9 5.5c0 .474.217.871.444 1.287c.249.456.51.934.51 1.563c0 .92-.455 1.492-1.332 1.492c-.49 0-1.044-.381-1.044-1.084c0-.405.138-.742.283-1.098c.164-.402.34-.83.34-1.41Z" clip-rule="evenodd"/>`
	idCardPath                   = `<path fill="currentColor" fill-rule="evenodd" d="M14 11V4H1v7h13Zm1-7v7a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h13a1 1 0 0 1 1 1ZM2 5.25A.25.25 0 0 1 2.25 5h3.5a.25.25 0 0 1 .25.25v4.5a.25.25 0 0 1-.25.25h-3.5A.25.25 0 0 1 2 9.75v-4.5ZM7.5 7a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3ZM7 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5ZM7.5 5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4Z" clip-rule="evenodd"/>`
	imagePath                    = `<path fill="currentColor" fill-rule="evenodd" d="M2.5 1h10A1.5 1.5 0 0 1 14 2.5v10a1.5 1.5 0 0 1-1.5 1.5h-10A1.5 1.5 0 0 1 1 12.5v-10A1.5 1.5 0 0 1 2.5 1Zm0 1a.5.5 0 0 0-.5.5v5.864l1.682-1.682a.45.45 0 0 1 .647.01l3.545 3.798l2.808-2.808a.45.45 0 0 1 .636 0L13 9.364V2.5a.5.5 0 0 0-.5-.5h-10ZM2 12.5V9.636l1.989-1.988l3.542 3.794L8.941 13H2.5a.5.5 0 0 1-.5-.5Zm10.5.5h-2.345l-1.672-1.847L11 8.636l2 2V12.5a.5.5 0 0 1-.5.5ZM6.65 5.5a.85.85 0 1 1 1.7 0a.85.85 0 0 1-1.7 0Zm.85-1.75a1.75 1.75 0 1 0 0 3.5a1.75 1.75 0 0 0 0-3.5Z" clip-rule="evenodd"/>`
	infoCircledPath              = `<path fill="currentColor" fill-rule="evenodd" d="M7.5.877a6.623 6.623 0 1 0 0 13.246A6.623 6.623 0 0 0 7.5.877ZM1.827 7.5a5.673 5.673 0 1 1 11.346 0a5.673 5.673 0 0 1-11.346 0Zm6.423-3a.75.75 0 1 1-1.5 0a.75.75 0 0 1 1.5 0ZM6 6h1.5a.5.5 0 0 1 .5.5V10h1v1H6v-1h1V7H6V6Z" clip-rule="evenodd"/>`
	inputPath                    = `<path fill="currentColor" fill-rule="evenodd" d="M6.5 1a.5.5 0 0 0 0 1c.627 0 .957.2 1.156.478C7.878 2.79 8 3.288 8 4v7c0 .712-.122 1.21-.344 1.522c-.199.278-.53.478-1.156.478a.5.5 0 0 0 0 1c.873 0 1.543-.3 1.97-.897l.03-.044l.03.044c.427.597 1.097.897 1.97.897a.5.5 0 0 0 0-1c-.627 0-.957-.2-1.156-.478C9.122 12.21 9 11.712 9 11V4c0-.712.122-1.21.344-1.522C9.543 2.2 9.874 2 10.5 2a.5.5 0 0 0 0-1c-.873 0-1.543.3-1.97.897l-.03.044l-.03-.044C8.042 1.3 7.372 1 6.5 1ZM14 5h-3V4h3a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1h-3v-1h3V5ZM6 4v1H1v5h5v1H1a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h5Z" clip-rule="evenodd"/>`
	instagramLogoPath            = `<path fill="currentColor" fill-rule="evenodd" d="M12.91 12.909c.326-.327.582-.72.749-1.151c.16-.414.27-.886.302-1.578c.032-.693.04-.915.04-2.68c0-1.765-.008-1.987-.04-2.68c-.032-.692-.142-1.164-.302-1.578a3.185 3.185 0 0 0-.75-1.151a3.187 3.187 0 0 0-1.151-.75c-.414-.16-.886-.27-1.578-.302C9.487 1.007 9.265 1 7.5 1c-1.765 0-1.987.007-2.68.04c-.692.03-1.164.14-1.578.301a3.2 3.2 0 0 0-1.151.75a3.2 3.2 0 0 0-.75 1.151c-.16.414-.27.886-.302 1.578C1.007 5.513 1 5.735 1 7.5c0 1.765.007 1.987.04 2.68c.03.692.14 1.164.301 1.578c.164.434.42.826.75 1.151c.325.33.718.586 1.151.75c.414.16.886.27 1.578.302c.693.031.915.039 2.68.039c1.765 0 1.987-.008 2.68-.04c.692-.03 1.164-.14 1.578-.301a3.323 3.323 0 0 0 1.151-.75ZM2 6.735v1.53c-.002.821-.002 1.034.02 1.5c.026.586.058 1.016.156 1.34c.094.312.199.63.543 1.012c.344.383.675.556 1.097.684c.423.127.954.154 1.415.175c.522.024.73.024 1.826.024H8.24c.842.001 1.054.002 1.526-.02c.585-.027 1.015-.059 1.34-.156c.311-.094.629-.2 1.011-.543c.383-.344.556-.676.684-1.098c.127-.422.155-.953.176-1.414C13 9.247 13 9.04 13 7.947v-.89c0-1.096 0-1.303-.023-1.826c-.021-.461-.049-.992-.176-1.414c-.127-.423-.3-.754-.684-1.098c-.383-.344-.7-.449-1.011-.543c-.325-.097-.755-.13-1.34-.156A27.29 27.29 0 0 0 8.24 2H7.057c-1.096 0-1.304 0-1.826.023c-.461.021-.992.049-1.415.176c-.422.128-.753.301-1.097.684c-.344.383-.45.7-.543 1.012c-.098.324-.13.754-.156 1.34c-.022.466-.022.679-.02 1.5ZM7.5 5.25a2.25 2.25 0 1 0 0 4.5a2.25 2.25 0 0 0 0-4.5ZM4.25 7.5a3.25 3.25 0 1 1 6.5 0a3.25 3.25 0 0 1-6.5 0Zm6.72-2.72a.75.75 0 1 0 0-1.5a.75.75 0 0 0 0 1.5Z" clip-rule="evenodd"/>`
	justifyCenterPath            = `<g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.95 6H11v3H7.95V6zm0-1V1.5a.45.45 0 0 0-.9 0V5h-3.3a.75.75 0 0 0-.75.75v3.5c0 .414.336.75.75.75h3.3v3.5a.45.45 0 1 0 .9 0V10h3.3a.75.75 0 0 0 .75-.75v-3.5a.75.75 0 0 0-.75-.75h-3.3zm-.9 4H4V6h3.05v3z" fill="currentColor"/></g>`
	justifyEndPath               = `<g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.95 1.5a.45.45 0 0 0-.9 0v12a.45.45 0 1 0 .9 0v-12zM4 6h7v3H4V6zm7.25-1a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-.75.75h-7.5A.75.75 0 0 1 3 9.25v-3.5A.75.75 0 0 1 3.75 5h7.5z" fill="currentColor"/></g>`
	justifyStartPath             = `<g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M1.05 13.5a.45.45 0 0 0 .9 0v-12a.45.45 0 1 0-.9 0v12zM11 9H4V6h7v3zm-7.25 1A.75.75 0 0 1 3 9.25v-3.5A.75.75 0 0 1 3.75 5h7.5a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-.75.75h-7.5z" fill="currentColor"/></g>`
	justifyStretchPath           = `<g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.5 1.05a.45.45 0 0 1 .45.45v12a.45.45 0 0 1-.9 0v-12a.45.45 0 0 1 .45-.45zm-12 0a.45.45 0 0 1 .45.45v12a.45.45 0 0 1-.9 0v-12a.45.45 0 0 1 .45-.45zM4 6h7v3H4V6zm7.25-1a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-.75.75h-7.5A.75.75 0 0 1 3 9.25v-3.5A.75.75 0 0 1 3.75 5h7.5z" fill="currentColor"/></g>`
	keyboardPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M13.5 4h-12a.5.5 0 0 0-.5.5v6a.5.5 0 0 0 .5.5h12a.5.5 0 0 0 .5-.5v-6a.5.5 0 0 0-.5-.5Zm-12-1A1.5 1.5 0 0 0 0 4.5v6A1.5 1.5 0 0 0 1.5 12h12a1.5 1.5 0 0 0 1.5-1.5v-6A1.5 1.5 0 0 0 13.5 3h-12ZM2 5h1v1H2V5Zm3 0H4v1h1V5Zm1 0h1v1H6V5Zm3 0H8v1h1V5Zm1 0h1v1h-1V5Zm3 0h-1v1h1V5Zm-2 2h1v1h-1V7Zm2 2h-1v1h1V9ZM9 7h1v1H9V7ZM8 7H7v1h1V7ZM5 7h1v1H5V7ZM4 7H3v1h1V7ZM2 9h1v1H2V9Zm9 0H4v1h7V9Z" clip-rule="evenodd"/>`
	lapTimerPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M5.5.5A.5.5 0 0 1 6 0h3a.5.5 0 0 1 0 1H8v1.12a6.363 6.363 0 0 1 2.992 1.016a.638.638 0 0 1 .066-.078l1-1a.625.625 0 0 1 .884.884l-.975.975A6.4 6.4 0 1 1 7 2.119V1H6a.5.5 0 0 1-.5-.5Zm-3.4 8a5.4 5.4 0 1 1 10.8 0a5.4 5.4 0 0 1-10.8 0Zm5.4 0V4.1a4.4 4.4 0 1 0 3.111 7.511L7.5 8.5Z" clip-rule="evenodd"/>`
	laptopPath                   = `<path fill="currentColor" fill-rule="evenodd" d="M2 4.25A.25.25 0 0 1 2.25 4h10.5a.25.25 0 0 1 .25.25v7.25H2V4.25ZM2.25 3C1.56 3 1 3.56 1 4.25V12H0v.5a.5.5 0 0 0 .5.5h14a.5.5 0 0 0 .5-.5V12h-1V4.25C14 3.56 13.44 3 12.75 3H2.25Z" clip-rule="evenodd"/>`
	layersPath                   = `<path fill="currentColor" fill-rule="evenodd" d="M7.754.82a.5.5 0 0 0-.508 0l-5.5 3.25a.5.5 0 0 0 0 .86l5.5 3.25a.5.5 0 0 0 .508 0l5.5-3.25a.5.5 0 0 0 0-.86L7.754.82ZM7.5 7.17L2.983 4.5L7.5 1.83l4.517 2.67L7.5 7.17Zm-5.93.326a.5.5 0 0 1 .684-.176l5.246 3.1l5.246-3.1a.5.5 0 1 1 .508.86l-5.5 3.25a.5.5 0 0 1-.508 0l-5.5-3.25a.5.5 0 0 1-.177-.684Zm0 3a.5.5 0 0 1 .684-.177l5.246 3.1l5.246-3.1a.5.5 0 0 1 .508.861l-5.5 3.25a.5.5 0 0 1-.508 0l-5.5-3.25a.5.5 0 0 1-.177-.684Z" clip-rule="evenodd"/>`
	layoutPath                   = `<path fill="currentColor" fill-rule="evenodd" d="M9 2H6v11h3V2Zm1 0v11h2.5a.5.5 0 0 0 .5-.5v-10a.5.5 0 0 0-.5-.5H10ZM2.5 2H5v11H2.5a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5Zm0-1A1.5 1.5 0 0 0 1 2.5v10A1.5 1.5 0 0 0 2.5 14h10a1.5 1.5 0 0 0 1.5-1.5v-10A1.5 1.5 0 0 0 12.5 1h-10Z" clip-rule="evenodd"/>`
	letterCaseCapitalizePath     = `<path fill="currentColor" fill-rule="evenodd" d="M3.69 2.75a.5.5 0 0 1 .467.32l3.21 8.32a.5.5 0 0 1-.933.36L5.383 9.025H2.01L.967 11.75a.5.5 0 0 1-.934-.358l3.19-8.32a.5.5 0 0 1 .467-.321Zm.002 1.893l1.363 3.532H2.337l1.355-3.532Zm7.207.564c-1.64 0-2.89 1.479-2.89 3.403c0 2.024 1.35 3.402 2.89 3.402a3.06 3.06 0 0 0 2.255-.99v.508a.45.45 0 1 0 .9 0V5.72a.45.45 0 0 0-.9 0v.503A3.01 3.01 0 0 0 10.9 5.207Zm2.255 4.591V7.302c-.39-.721-1.213-1.244-2.067-1.244c-.978 0-2.052.908-2.052 2.552c0 1.543.974 2.552 2.052 2.552c.883 0 1.685-.667 2.067-1.364Z" clip-rule="evenodd"/>`
	letterCaseLowercasePath      = `<path fill="currentColor" fill-rule="evenodd" d="M3.699 5.207c-1.64 0-2.89 1.479-2.89 3.403c0 2.024 1.35 3.402 2.89 3.402a3.06 3.06 0 0 0 2.255-.99v.508a.45.45 0 0 0 .9 0V5.72a.45.45 0 0 0-.9 0v.503a3.01 3.01 0 0 0-2.255-1.016Zm2.255 4.592V7.301c-.39-.72-1.213-1.243-2.067-1.243c-.978 0-2.052.908-2.052 2.552c0 1.543.974 2.552 2.052 2.552c.883 0 1.684-.666 2.067-1.363Zm4.845-4.592c-1.64 0-2.89 1.479-2.89 3.403c0 2.024 1.35 3.402 2.89 3.402a3.06 3.06 0 0 0 2.255-.99v.508a.45.45 0 0 0 .9 0V5.72a.45.45 0 1 0-.9 0v.503A3.01 3.01 0 0 0 10.8 5.207Zm2.255 4.591V7.302c-.39-.721-1.213-1.244-2.067-1.244c-.978 0-2.052.908-2.052 2.552c0 1.543.974 2.552 2.052 2.552c.883 0 1.685-.667 2.067-1.364Z" clip-rule="evenodd"/>`
	letterCaseTogglePath         = `<path fill="currentColor" fill-rule="evenodd" d="M11.29 2.75a.5.5 0 0 1 .467.32l3.21 8.32a.5.5 0 0 1-.934.36l-1.05-2.725H9.61L8.567 11.75a.5.5 0 0 1-.934-.358l3.19-8.32a.5.5 0 0 1 .466-.321Zm.002 1.893l1.362 3.532H9.937l1.354-3.532Zm-8.393.564c-1.64 0-2.89 1.479-2.89 3.403c0 2.024 1.35 3.402 2.89 3.402a3.06 3.06 0 0 0 2.255-.99v.508a.45.45 0 0 0 .9 0V5.72a.45.45 0 1 0-.9 0v.503A3.01 3.01 0 0 0 2.9 5.207Zm2.255 4.591V7.302c-.39-.721-1.213-1.244-2.067-1.244c-.978 0-2.052.908-2.052 2.552c0 1.543.974 2.552 2.052 2.552c.883 0 1.685-.667 2.067-1.364Z" clip-rule="evenodd"/>`
	letterCaseUppercasePath      = `<path fill="currentColor" fill-rule="evenodd" d="M3.626 2.75a.5.5 0 0 1 .468.327l3.076 8.32a.5.5 0 0 1-.938.346L5.224 9.016H2.027L1.02 11.743a.5.5 0 1 1-.938-.347l3.076-8.32a.5.5 0 0 1 .469-.326Zm0 1.942L4.91 8.166H2.34l1.284-3.474Zm7.746-1.942a.5.5 0 0 1 .469.327l3.075 8.32a.5.5 0 1 1-.938.346L12.97 9.016H9.773l-1.008 2.727a.5.5 0 1 1-.938-.347l3.076-8.32a.5.5 0 0 1 .469-.326Zm0 1.942l1.284 3.474h-2.568l1.284-3.474Z" clip-rule="evenodd"/>`
	letterSpacingPath            = `<path fill="currentColor" fill-rule="evenodd" d="M4.553 1c.2 0 .38.12.46.303L8.01 8.3a.5.5 0 1 1-.92.394l-.975-2.277H2.99l-.976 2.277a.5.5 0 0 1-.92-.394l3-6.997A.5.5 0 0 1 4.552 1Zm0 1.77l1.199 2.797H3.354l1.199-2.798Zm6.503 6.232a.5.5 0 0 0 .466-.317l2.751-7.002a.5.5 0 0 0-.93-.366l-2.287 5.818L8.77 1.317a.5.5 0 1 0-.931.366l2.752 7.002a.5.5 0 0 0 .465.317Zm3.898 3.498a.4.4 0 0 1-.118.283l-2 2a.4.4 0 0 1-.565-.566l1.317-1.317H1.519l1.318 1.317a.4.4 0 0 1-.566.566l-2-2a.4.4 0 0 1 0-.566l2-2a.4.4 0 0 1 .566.566L1.519 12.1h12.069l-1.317-1.317a.4.4 0 0 1 .565-.566l2 2a.4.4 0 0 1 .118.283Z" clip-rule="evenodd"/>`
	lightningBoltPath            = `<path fill="currentColor" fill-rule="evenodd" d="M8.697.04a.5.5 0 0 1 .296.542L8.09 6h4.41a.5.5 0 0 1 .4.8l-6 8a.5.5 0 0 1-.893-.382L6.91 9H2.5a.5.5 0 0 1-.4-.8l6-8a.5.5 0 0 1 .597-.16ZM3.5 8h4a.5.5 0 0 1 .493.582L7.33 12.56L11.5 7h-4a.5.5 0 0 1-.493-.582L7.67 2.44L3.5 8Z" clip-rule="evenodd"/>`
	lineHeightPath               = `<path fill="currentColor" fill-rule="evenodd" d="M3.782 2.217a.4.4 0 0 0-.565 0l-2 2a.4.4 0 0 0 .565.566L3.1 3.466v8.068l-1.317-1.317a.4.4 0 0 0-.565.566l2 2a.4.4 0 0 0 .565 0l2-2a.4.4 0 0 0-.565-.566L3.9 11.534V3.466l1.318 1.317a.4.4 0 0 0 .565-.566l-2-2ZM8.5 4a.5.5 0 1 0 0 1h6a.5.5 0 0 0 0-1h-6ZM8 7.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5Zm.5 2.5a.5.5 0 1 0 0 1h6a.5.5 0 0 0 0-1h-6Z" clip-rule="evenodd"/>`
	linkBreakOnePath             = `<path fill="currentColor" fill-rule="evenodd" d="M13.354 2.354a.5.5 0 0 0-.708-.708l-11 11a.5.5 0 0 0 .708.708l11-11ZM2.037 8.467c.137.66.632 1.204 1.302 1.426l-.76.76a2.91 2.91 0 0 1-1.52-1.983c-.06-.283-.06-.61-.06-1.107v-.126c0-.497 0-.824.06-1.107c.24-1.16 1.179-2.05 2.36-2.275C3.706 4 4.04 4 4.563 4H5.5a.5.5 0 0 1 0 1h-.875c-.604 0-.836.002-1.02.037c-.802.154-1.413.752-1.568 1.496c-.035.17-.037.385-.037.967c0 .583.002.798.037.967Zm10.925-1.934a1.935 1.935 0 0 0-1.301-1.426l.76-.76a2.91 2.91 0 0 1 1.52 1.983c.059.283.059.61.059 1.107v.126c0 .497 0 .824-.059 1.107c-.24 1.16-1.18 2.05-2.36 2.275c-.288.055-.623.055-1.146.055H9.5a.5.5 0 1 1 0-1h.875c.604 0 .835-.002 1.019-.037c.803-.154 1.414-.752 1.568-1.496c.035-.17.038-.384.038-.967c0-.582-.003-.798-.038-.967Z" clip-rule="evenodd"/>`
	linkBreakTwoPath             = `<path fill="currentColor" fill-rule="evenodd" d="M4.5 0a.5.5 0 0 1 .5.5v2a.5.5 0 1 1-1 0v-2a.5.5 0 0 1 .5-.5ZM.646.646a.5.5 0 0 1 .708 0l1.5 1.5a.5.5 0 1 1-.708.708l-1.5-1.5a.5.5 0 0 1 0-.708ZM0 4.5A.5.5 0 0 1 .5 4h2a.5.5 0 1 1 0 1h-2a.5.5 0 0 1-.5-.5Zm12 6a.5.5 0 0 1 .5-.5h2a.5.5 0 1 1 0 1h-2a.5.5 0 0 1-.5-.5ZM10.5 12a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2a.5.5 0 0 1 .5-.5Zm1.646.146a.5.5 0 0 1 .707 0l1.5 1.5a.5.5 0 0 1-.707.707l-1.5-1.5a.5.5 0 0 1 0-.707ZM7.765 3.7c.427-.427.592-.589.747-.694c.676-.46 1.531-.468 2.166-.051c.145.095.299.245.71.657c.412.412.563.566.658.71c.417.636.408 1.49-.052 2.167c-.104.154-.267.32-.694.747l-.619.619a.5.5 0 0 0 .708.707l.618-.62l.043-.042c.37-.37.606-.606.772-.85c.675-.993.71-2.287.06-3.277c-.16-.241-.39-.472-.742-.823l-.044-.045l-.045-.045c-.351-.351-.582-.582-.824-.74c-.99-.651-2.283-.616-3.277.059c-.243.165-.48.402-.85.771l-.042.043l-.619.619a.5.5 0 1 0 .707.707l.619-.619ZM2.992 7.06l-.043.042c-.37.37-.606.606-.771.85c-.676.993-.71 2.287-.06 3.277c.158.241.39.472.74.824l.046.044l.044.045c.351.351.582.582.824.74c.99.651 2.284.616 3.278-.06c.243-.164.48-.4.849-.77l.043-.043l.618-.619a.5.5 0 0 0-.707-.707l-.619.619c-.427.427-.592.589-.746.694c-.677.46-1.532.468-2.167.051c-.144-.095-.299-.245-.71-.657c-.412-.412-.563-.566-.657-.71c-.418-.636-.409-1.49.05-2.167c.106-.154.268-.32.695-.747l.619-.619a.5.5 0 1 0-.707-.707l-.62.62Z" clip-rule="evenodd"/>`
	...
	listBulletPath               = `<path fill="currentColor" fill-rule="evenodd" d="M1.5 5.25a.75.75 0 1 0 0-1.5a.75.75 0 0 0 0 1.5ZM4 4.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5ZM4.5 7a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9Zm0 3a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9ZM2.25 7.5a.75.75 0 1 1-1.5 0a.75.75 0 0 1 1.5 0Zm-.75 3.75a.75.75 0 1 0 0-1.5a.75.75 0 0 0 0 1.5Z" clip-rule="evenodd"/>`
	lockClosedPath               = `<path fill="currentColor" fill-rule="evenodd" d="M5 4.636c0-.876.242-1.53.643-1.962c.396-.427 1.003-.696 1.858-.696c.856 0 1.462.269 1.857.694c.4.431.642 1.085.642 1.961V6H5V4.636ZM4 6V4.636c0-1.055.293-1.978.91-2.643c.623-.67 1.517-1.015 2.591-1.015c1.075 0 1.969.344 2.59 1.014c.617.664.909 1.587.909 2.641V6h1a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h1ZM3 7h9v6H3V7Z" clip-rule="evenodd"/>`
	lockOpenOnePath              = `<path fill="currentColor" fill-rule="evenodd" d="M7.499 0C6.326 0 5.36.39 4.738 1.194C4.238 1.839 4 2.682 4 3.634h1c0-.79.197-1.4.528-1.828c.388-.5 1.024-.806 1.97-.806c.859 0 1.465.265 1.86.686c.4.426.642 1.074.642 1.95V6H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h9a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-1V3.636c0-1.055-.293-1.974-.912-2.634C9.465.338 8.57 0 7.498 0ZM3 7h9v6H3V7Z" clip-rule="evenodd"/>`
	...
	textAlignRightPath           = `<path fill="currentColor" fill-rule="evenodd" d="M2 4.5a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1h-10a.5.5 0 0 1-.5-.5Zm5 3a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm-3 3a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 0 1h-8a.5.5 0 0 1-.5-.5Z" clip-rule="evenodd"/>`
	textAlignTopPath             = `<path fill="currentColor" fill-rule="evenodd" d="M3.9 9.5a.4.4 0 0 1-.8 0V2.466L1.781 3.783a.4.4 0 0 1-.565-.566l2-2a.4.4 0 0 1 .565 0l2 2a.4.4 0 0 1-.565.566L3.899 2.466V9.5ZM8.5 2a.5.5 0 1 0 0 1h6a.5.5 0 0 0 0-1h-6Zm0 3a.5.5 0 1 0 0 1h6a.5.5 0 0 0 0-1h-6ZM8 8.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5Z" clip-rule="evenodd"/>`
	textNonePath                 = `<path fill="currentColor" fill-rule="evenodd" d="M13.354 2.354a.5.5 0 0 0-.708-.708l-.717.718a.45.45 0 0 0-.429-.314h-8a.45.45 0 0 0-.45.45v2a.45.45 0 1 0 .9 0V2.95h3v4.393l-5.304 5.303a.5.5 0 0 0 .708.708L6.95 8.757v3.293H5.754a.45.45 0 1 0 0 .9h3.5a.45.45 0 0 0 0-.9H8.05V7.657l5.304-5.303ZM8.05 6.243l3-3V2.95h-3v3.293Z" clip-rule="evenodd"/>`
	thickArrowDownPath           = `<path fill="currentColor" fill-rule="evenodd" d="M5 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 .5.5V6h2.5a.5.5 0 0 1 .407.79l-5 7a.5.5 0 0 1-.814 0l-5-7A.5.5 0 0 1 2.5 6H5V3.5ZM6 4v2.5a.5.5 0 0 1-.5.5H3.472L7.5 12.64L11.528 7H9.5a.5.5 0 0 1-.5-.5V4H6Z" clip-rule="evenodd"/>`
	thickArrowLeftPath           = `<path fill="currentColor" fill-rule="evenodd" d="M1 7.5a.5.5 0 0 0 .21.407l7 5A.5.5 0 0 0 9 12.5V10h2.5a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5H9V2.5a.5.5 0 0 0-.79-.407l-7 5A.5.5 0 0 0 1 7.5Zm7-4.028V5.5a.5.5 0 0 0 .5.5H11v3H8.5a.5.5 0 0 0-.5.5v2.028L2.36 7.5L8 3.472Z" clip-rule="evenodd"/>`
	thickArrowRightPath          = `<path fill="currentColor" fill-rule="evenodd" d="M14 7.5a.5.5 0 0 1-.21.407l-7 5A.5.5 0 0 1 6 12.5V10H3.5a.5.5 0 0 1-.5-.5v-4a.5.5 0 0 1 .5-.5H6V2.5a.5.5 0 0 1 .79-.407l7 5A.5.5 0 0 1 14 7.5ZM7 3.472V5.5a.5.5 0 0 1-.5.5H4v3h2.5a.5.5 0 0 1 .5.5v2.028L12.64 7.5L7 3.472Z" clip-rule="evenodd"/>`
	thickArrowUpPath             = `<path fill="currentColor" fill-rule="evenodd" d="M7.5 1a.5.5 0 0 1 .407.21l5 7A.5.5 0 0 1 12.5 9H10v2.5a.5.5 0 0 1-.5.5h-4a.5.5 0 0 1-.5-.5V9H2.5a.5.5 0 0 1-.407-.79l5-7A.5.5 0 0 1 7.5 1ZM3.472 8H5.5a.5.5 0 0 1 .5.5V11h3V8.5a.5.5 0 0 1 .5-.5h2.028L7.5 2.36L3.472 8Z" clip-rule="evenodd"/>`
	timerPath                    = `<path fill="currentColor" fill-rule="evenodd" d="M7.5.85a.5.5 0 0 0-.5.5v2.172a.5.5 0 1 0 1 0v-1.65a5.65 5.65 0 1 1-4.81 1.974a.5.5 0 1 0-.762-.647A6.65 6.65 0 1 0 7.5.85Zm-.76 7.23L4.224 4.573a.25.25 0 0 1 .348-.348L8.081 6.74a.96.96 0 1 1-1.34 1.34Z" clip-rule="evenodd"/>`
	tokensPath                   = `<path fill="currentColor" fill-rule="evenodd" d="M4.5 2a2.5 2.5 0 1 0 0 5a2.5 2.5 0 0 0 0-5ZM3 4.5a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0ZM10.5 2a2.5 2.5 0 1 0 0 5a2.5 2.5 0 0 0 0-5ZM9 4.5a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0Zm-7 6a2.5 2.5 0 1 1 5 0a2.5 2.5 0 0 1-5 0ZM4.5 9a1.5 1.5 0 1 0 0 3a1.5 1.5 0 0 0 0-3Zm6-1a2.5 2.5 0 1 0 0 5a2.5 2.5 0 0 0 0-5ZM9 10.5a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0Z" clip-rule="evenodd"/>`
	trackNextPath                = `<path fill="currentColor" fill-rule="evenodd" d="M13.05 2.75a.55.55 0 1 0-1.1 0v4.533a.5.5 0 0 0-.217-.225l-9-4.75A.5.5 0 0 0 2 2.75v9.5a.5.5 0 0 0 .733.442l9-4.75a.5.5 0 0 0 .217-.225v4.533a.55.55 0 0 0 1.1 0v-9.5ZM3 11.42V3.58l7.429 3.92L3 11.42Z" clip-rule="evenodd"/>`
	trackPreviousPath            = `<path fill="currentColor" fill-rule="evenodd" d="M1.95 2.75a.55.55 0 1 1 1.1 0v4.533a.5.5 0 0 1 .217-.225l9-4.75A.5.5 0 0 1 13 2.75v9.5a.5.5 0 0 1-.733.442l-9-4.75a.5.5 0 0 1-.217-.225v4.533a.55.55 0 0 1-1.1 0v-9.5ZM4.57 7.5L12 11.42V3.58L4.571 7.5Z" clip-rule="evenodd"/>`
	transformPath                = `<path fill="currentColor" fill-rule="evenodd" d="M.85 1.75a.9.9 0 0 1 .9-.9h1.5a.9.9 0 0 1 .9.9v.3h6.7v-.3a.9.9 0 0 1 .9-.9h1.5a.9.9 0 0 1 .9.9v1.5a.9.9 0 0 1-.9.9h-.3v6.7h.3a.9.9 0 0 1 .9.9v1.5a.9.9 0 0 1-.9.9h-1.5a.9.9 0 0 1-.9-.9v-.3h-6.7v.3a.9.9 0 0 1-.9.9h-1.5a.9.9 0 0 1-.9-.9v-1.5a.9.9 0 0 1 .9-.9h.3v-6.7h-.3a.9.9 0 0 1-.9-.9v-1.5Zm2.1 2.4v6.7h.3a.9.9 0 0 1 .9.9v.3h6.7v-.3a.9.9 0 0 1 .9-.9h.3v-6.7h-.3a.9.9 0 0 1-.9-.9v-.3h-6.7v.3a.9.9 0 0 1-.9.9h-.3Zm-.6-2.4h-.6v1.5h1.5v-1.5h-.9ZM5.1 6a.9.9 0 0 1 .9-.9h1a.9.9 0 0 1 .9.9v1a.91.91 0 0 1-.006.106A.908.908 0 0 1 8 7.1h1a.9.9 0 0 1 .9.9v1a.9.9 0 0 1-.9.9H8a.9.9 0 0 1-.9-.9V8c0-.036.002-.071.006-.106A.91.91 0 0 1 7 7.9H6a.9.9 0 0 1-.9-.9V6Zm1 0H6v1h1V6h-.9ZM8 8h1v1H8V8Zm-5.35 3.75h-.9v1.5h1.5v-1.5h-.6Zm9.1-10h1.5v1.5h-1.5v-1.5Zm.9 10h-.9v1.5h1.5v-1.5h-.6Z" clip-rule="evenodd"/>`
	transparencyGridPath         = `<path fill="currentColor" fill-rule="evenodd" d="M0 0h3v3H0V0Zm6 3H3v3H0v3h3v3H0v3h3v-3h3v3h3v-3h3v3h3v-3h-3V9h3V6h-3V3h3V0h-3v3H9V0H6v3Zm0 3V3h3v3H6Zm0 3H3V6h3v3Zm3 0V6h3v3H9Zm0 0H6v3h3V9Z" clip-rule="evenodd" opacity=".25"/>`
	trashPath                    = `<path fill="currentColor" fill-rule="evenodd" d="M5.5 1a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4ZM3 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 0 1H11v8a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V4h-.5a.5.5 0 0 1-.5-.5ZM5 4h5v8H5V4Z" clip-rule="evenodd"/>`
	triangleDownPath             = `<path fill="currentColor" d="M4 6h7l-3.5 4.5L4 6Z"/>`
	triangleLeftPath             = `<path fill="currentColor" d="M9 4v7L4.5 7.5L9 4Z"/>`
	triangleRightPath            = `<path fill="currentColor" d="M6 11V4l4.5 3.5L6 11Z"/>`
	triangleUpPath               = `<path fill="currentColor" d="M4 9h7L7.5 4.5L4 9Z"/>`
	twitterLogoPath              = `<path fill="currentColor" fill-rule="evenodd" d="M7.233 4.696c0-1.727 1.4-3.127 3.127-3.127c1.014 0 1.823.479 2.365 1.175a5.246 5.246 0 0 0 1.626-.629a2.634 2.634 0 0 1-1.148 1.45l.002.003a5.26 5.26 0 0 0 1.5-.413l-.001.002c-.337.505-.76.95-1.248 1.313c.026.177.04.354.04.53c0 3.687-2.809 7.975-7.975 7.975a7.93 7.93 0 0 1-4.296-1.26a.5.5 0 0 1-.108-.748a.45.45 0 0 1 .438-.215c.916.108 1.83-.004 2.637-.356a3.086 3.086 0 0 1-1.69-1.876a.45.45 0 0 1 .103-.448a3.07 3.07 0 0 1-1.045-2.31v-.034a.45.45 0 0 1 .365-.442a3.068 3.068 0 0 1-.344-1.416c0-.468.003-1.058.332-1.59a.45.45 0 0 1 .323-.208a.5.5 0 0 1 .538.161a6.964 6.964 0 0 0 4.46 2.507v-.044Zm-1.712 7.279a6.936 6.936 0 0 1-2.249-.373a5.318 5.318 0 0 0 2.39-1.042a.45.45 0 0 0-.27-.804a2.174 2.174 0 0 1-1.714-.888c.19-.015.376-.048.556-.096a.45.45 0 0 0-.028-.876a2.18 2.18 0 0 1-1.644-1.474c.2.048.409.077.623.084a.45.45 0 0 0 .265-.824a2.177 2.177 0 0 1-.97-1.812c0-.168.003-.317.013-.453a7.95 7.95 0 0 0 5.282 2.376a.5.5 0 0 0 .513-.61a2.127 2.127 0 0 1 2.071-2.614c1.234 0 2.136 1.143 2.136 2.432c0 3.256-2.476 6.974-6.975 6.974Z" clip-rule="evenodd"/>`
	underlinePath                = `<path fill="currentColor" fill-rule="evenodd" d="M5 2.75a.5.5 0 0 0-1 0v5.3a3.5 3.5 0 0 0 7 0v-5.3a.5.5 0 1 0-1 0v5.3a2.5 2.5 0 1 1-5 0v-5.3ZM3.5 13.1a.4.4 0 1 0 0 .8h8a.4.4 0 0 0 0-.8h-8Z" clip-rule="evenodd"/>`
	...
	valuePath                    = `<path fill="currentColor" fill-rule="evenodd" d="M.877 7.5a6.623 6.623 0 1 1 13.246 0a6.623 6.623 0 0 1-13.246 0ZM7.5 1.827a5.673 5.673 0 1 0 0 11.346a5.673 5.673 0 0 0 0-11.346Z" clip-rule="evenodd"/>`
	valueNonePath                = `<path fill="currentColor" fill-rule="evenodd" d="M7.5.877a6.623 6.623 0 0 0-5.023 10.94l-.83.83a.5.5 0 1 0 .707.707l.83-.83a6.623 6.623 0 0 0 9.34-9.34l.83-.83a.5.5 0 1 0-.708-.708l-.83.83A6.597 6.597 0 0 0 7.5.878Zm3.642 2.274a5.673 5.673 0 0 0-7.992 7.992l7.992-7.992Zm-7.284 8.698a5.673 5.673 0 0 0 7.992-7.992L3.857 11.85Z" clip-rule="evenodd"/>`
	vercelLogoPath               = `<path fill="currentColor" fill-rule="evenodd" d="m7.5 1l-.577 1.003L1.175 12L.6 13h13.8l-.575-1l-5.748-9.997L7.5 1Zm0 2.006L2.329 12H12.67L7.5 3.006Z" clip-rule="evenodd"/>`
	videoPath                    = `<path fill="currentColor" fill-rule="evenodd" d="M4.764 3.122A32.656 32.656 0 0 1 7.5 3c.94 0 1.868.049 2.736.122c1.044.088 1.72.148 2.236.27c.47.111.733.258.959.489c.024.025.06.063.082.09c.2.23.33.518.405 1.062c.08.583.082 1.343.082 2.492c0 1.135-.002 1.885-.082 2.46c-.074.536-.204.821-.405 1.054a2.276 2.276 0 0 1-.083.09c-.23.234-.49.379-.948.487c-.507.12-1.168.178-2.194.264c-.869.072-1.812.12-2.788.12c-.976 0-1.92-.048-2.788-.12c-1.026-.086-1.687-.144-2.194-.264c-.459-.108-.719-.253-.948-.487a2.299 2.299 0 0 1-.083-.09c-.2-.233-.33-.518-.405-1.054C1.002 9.41 1 8.66 1 7.525c0-1.149.002-1.91.082-2.492c.075-.544.205-.832.405-1.062c.023-.027.058-.065.082-.09c.226-.231.489-.378.959-.489c.517-.122 1.192-.182 2.236-.27ZM0 7.525c0-2.242 0-3.363.73-4.208c.036-.042.085-.095.124-.135c.78-.799 1.796-.885 3.826-1.056C5.57 2.05 6.527 2 7.5 2c.973 0 1.93.05 2.82.126c2.03.171 3.046.257 3.826 1.056c.039.04.087.093.124.135c.73.845.73 1.966.73 4.208c0 2.215 0 3.323-.731 4.168a3.243 3.243 0 0 1-.125.135c-.781.799-1.778.882-3.773 1.048C9.48 12.951 8.508 13 7.5 13s-1.98-.05-2.87-.124c-1.996-.166-2.993-.25-3.774-1.048a3.316 3.316 0 0 1-.125-.135C0 10.848 0 9.74 0 7.525Zm5.25-2.142a.25.25 0 0 1 .35-.23l4.828 2.118c.2.088.2.37 0 .458L5.6 9.846a.25.25 0 0 1-.35-.229V5.383Z" clip-rule="evenodd"/>`
	viewGridPath                 = `<path fill="currentColor" fill-rule="evenodd" d="M7 2H1.5a.5.5 0 0 0-.5.5V7h6V2Zm1 0v5h6V2.5a.5.5 0 0 0-.5-.5H8ZM7 8H1v4.5a.5.5 0 0 0 .5.5H7V8Zm1 5V8h6v4.5a.5.5 0 0 1-.5.5H8ZM1.5 1A1.5 1.5 0 0 0 0 2.5v10A1.5 1.5 0 0 0 1.5 14h12a1.5 1.5 0 0 0 1.5-1.5v-10A1.5 1.5 0 0 0 13.5 1h-12Z" clip-rule="evenodd"/>`
	viewHorizontalPath           = `<path fill="currentColor" fill-rule="evenodd" d="M1.5 2h12a.5.5 0 0 1 .5.5V7H1V2.5a.5.5 0 0 1 .5-.5ZM1 8v4.5a.5.5 0 0 0 .5.5h12a.5.5 0 0 0 .5-.5V8H1ZM0 2.5A1.5 1.5 0 0 1 1.5 1h12A1.5 1.5 0 0 1 15 2.5v10a1.5 1.5 0 0 1-1.5 1.5h-12A1.5 1.5 0 0 1 0 12.5v-10Z" clip-rule="evenodd"/>`
	viewNonePath                 = `<path fill="currentColor" fill-rule="evenodd" d="M14 2.587L1.852 13H13.5a.5.5 0 0 0 .5-.5V2.587ZM.763 13.807l.062.073l.03-.026c.195.094.414.146.645.146h12a1.5 1.5 0 0 0 1.5-1.5v-10a1.5 1.5 0 0 0-.763-1.307l-.062-.073l-.03.025A1.494 1.494 0 0 0 13.5 1h-12A1.5 1.5 0 0 0 0 2.5v10c0 .56.307 1.05.763 1.307ZM1 12.413L13.148 2H1.5a.5.5 0 0 0-.5.5v9.913Z" clip-rule="evenodd"/>`
	viewVerticalPath             = `<path fill="currentColor" fill-rule="evenodd" d="M8 2h5.5a.5.5 0 0 1 .5.5v10a.5.5 0 0 1-.5.5H8V2ZM7 2H1.5a.5.5 0 0 0-.5.5v10a.5.5 0 0 0 .5.5H7V2Zm-7 .5A1.5 1.5 0 0 1 1.5 1h12A1.5 1.5 0 0 1 15 2.5v10a1.5 1.5 0 0 1-1.5 1.5h-12A1.5 1.5 0 0 1 0 12.5v-10Z" clip-rule="evenodd"/>`
	widthPath                    = `<path fill="currentColor" fill-rule="evenodd" d="M4.818 4.682a.45.45 0 0 1 0 .636L3.086 7.05h8.828l-1.732-1.732a.45.45 0 0 1 .636-.636l2.5 2.5a.45.45 0 0 1 0 .636l-2.5 2.5a.45.45 0 0 1-.636-.636l1.732-1.732H3.086l1.732 1.732a.45.45 0 1 1-.636.636l-2.5-2.5a.45.45 0 0 1 0-.636l2.5-2.5a.45.45 0 0 1 .636 0Z" clip-rule="evenodd"/>`
	zoomInPath                   = `<path fill="currentColor" fill-rule="evenodd" d="M10 6.5a3.5 3.5 0 1 1-7 0a3.5 3.5 0 0 1 7 0Zm-.691 3.516a4.5 4.5 0 1 1 .707-.707l2.838 2.837a.5.5 0 0 1-.708.708L9.31 10.016ZM4.25 6.5a.5.5 0 0 1 .5-.5H6V4.75a.5.5 0 0 1 1 0V6h1.25a.5.5 0 0 1 0 1H7v1.25a.5.5 0 0 1-1 0V7H4.75a.5.5 0 0 1-.5-.5Z" clip-rule="evenodd"/>`
	zoomOutPath                  = `<path fill="currentColor" fill-rule="evenodd" d="M6.5 10a3.5 3.5 0 1 0 0-7a3.5 3.5 0 0 0 0 7Zm0 1a4.48 4.48 0 0 0 2.809-.984l2.837 2.838a.5.5 0 0 0 .708-.708L10.016 9.31A4.5 4.5 0 1 0 6.5 11ZM4.75 6a.5.5 0 0 0 0 1h3.5a.5.5 0 0 0 0-1h-3.5Z" clip-rule="evenodd"/>`
)
...
func IconFromName(name string) g.Node {
	...
	case "alignCenterHorizontally":
		return AlignCenterHorizontally()
	case "alignCenterVertically":
		return AlignCenterVertically()
	case "alignEnd":
		return AlignEnd()
	...
	case "cardStack":
		return CardStack()
	case "cardStackMinus":
		return CardStackMinus()
	case "cardStackPlus":
		return CardStackPlus()
	case "caretDown":
		return CaretDown()
	case "caretLeft":
		return CaretLeft()
	...
	case "counterClockwiseClock":
		return CounterClockwiseClock()
	case "crop":
		return Crop()
	case "crossCircled":
		return CrossCircled()
	...
	case "download":
		return Download()
	case "dragHandleDotsOne":
		return DragHandleDotsOne()
	case "dragHandleDotsTwo":
		return DragHandleDotsTwo()
	case "dragHandleHorizontal":
		return DragHandleHorizontal()
	case "dragHandleVertical":
		return DragHandleVertical()
	case "drawingPin":
		return DrawingPin()
	case "drawingPinFilled":
		return DrawingPinFilled()
	case "dropdownMenu":
		return DropdownMenu()
	case "enter":
		return Enter()
	...
	case "layout":
		return Layout()
	case "letterCaseCapitalize":
		return LetterCaseCapitalize()
	case "letterCaseLowercase":
		return LetterCaseLowercase()
	case "letterCaseToggle":
		return LetterCaseToggle()
	case "letterCaseUppercase":
		return LetterCaseUppercase()
	case "letterSpacing":
	...
	case "mix":
		return Mix()
	case "mixerHorizontal":
		return MixerHorizontal()
	case "mixerVertical":
		return MixerVertical()
	case "mobile":
		return Mobile()
	case "modulzLogo":
		return ModulzLogo()
	...
	case "questionMark":
		return QuestionMark()
	case "questionMarkCircled":
		return QuestionMarkCircled()
	case "quote":
		return Quote()
	case "radiobutton":
		return Radiobutton()
	...
	case "sewingPin":
		return SewingPin()
	case "sewingPinFilled":
		return SewingPinFilled()
	case "shadow":
		return Shadow()
	case "shadowInner":
		return ShadowInner()
	...
	case "slider":
		return Slider()
	case "spaceBetweenHorizontally":
		return SpaceBetweenHorizontally()
	case "spaceBetweenVertically":
		return SpaceBetweenVertically()
	case "spaceEvenlyHorizontally":
		return SpaceEvenlyHorizontally()
	case "spaceEvenlyVertically":
		return SpaceEvenlyVertically()
	case "speakerLoud":
		return SpeakerLoud()
	case "speakerModerate":
	...
	case "thickArrowLeft":
		return ThickArrowLeft()
	case "thickArrowRight":
		return ThickArrowRight()
	case "thickArrowUp":
		return ThickArrowUp()
	case "timer":
		return Timer()
...
func ActivityLog(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(activityLogPath), g.Group(children))
}

func AlignBaseline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignBaselinePath), g.Group(children))
}
...
func AlignCenterHorizontally(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignCenterHorizontallyPath), g.Group(children))
}

func AlignCenterVertically(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignCenterVerticallyPath), g.Group(children))
}

func AlignEnd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignEndPath), g.Group(children))
}
...
func AlignStart(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignStartPath), g.Group(children))
}

func AlignStretch(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignStretchPath), g.Group(children))
}
...
func AllSides(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(allSidesPath), g.Group(children))
}
...
func BlendingMode(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(blendingModePath), g.Group(children))
}
...
func BookmarkFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bookmarkFilledPath), g.Group(children))
}
...
func BorderDashed(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderDashedPath), g.Group(children))
}

func BorderDotted(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderDottedPath), g.Group(children))
}
...
func BorderNone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderNonePath), g.Group(children))
}
...
func BorderSolid(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderSolidPath), g.Group(children))
}

func BorderSplit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderSplitPath), g.Group(children))
}

func BorderStyle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderStylePath), g.Group(children))
}
...
func BorderWidth(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderWidthPath), g.Group(children))
}
...
func BoxModel(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(boxModelPath), g.Group(children))
}
...
func CardStackMinus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cardStackMinusPath), g.Group(children))
}

func CardStackPlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cardStackPlusPath), g.Group(children))
}
...
func CaretSort(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretSortPath), g.Group(children))
}
...
func CheckCircled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkCircledPath), g.Group(children))
}
...
func CircleBackslash(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleBackslashPath), g.Group(children))
}
...
func CodesandboxLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(codesandboxLogoPath), g.Group(children))
}
...
func ColumnSpacing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(columnSpacingPath), g.Group(children))
}
...
func Commit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(commitPath), g.Group(children))
}

func ComponentBoolean(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(componentBooleanPath), g.Group(children))
}

func ComponentInstance(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(componentInstancePath), g.Group(children))
}

func ComponentNone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(componentNonePath), g.Group(children))
}

func ComponentOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(componentOnePath), g.Group(children))
}

func ComponentPlaceholder(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(componentPlaceholderPath), g.Group(children))
}

func ComponentTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(componentTwoPath), g.Group(children))
}
...
func Corners(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cornersPath), g.Group(children))
}

func CountdownTimer(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(countdownTimerPath), g.Group(children))
}

func CounterClockwiseClock(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(counterClockwiseClockPath), g.Group(children))
}
...
func CrossCircled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(crossCircledPath), g.Group(children))
}

func CrossOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(crossOnePath), g.Group(children))
}

func CrossTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(crossTwoPath), g.Group(children))
}

func CrosshairOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(crosshairOnePath), g.Group(children))
}

func CrosshairTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(crosshairTwoPath), g.Group(children))
}

func CrumpledPaper(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(crumpledPaperPath), g.Group(children))
}
...
func CursorArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cursorArrowPath), g.Group(children))
}

func CursorText(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cursorTextPath), g.Group(children))
}

func Dash(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dashPath), g.Group(children))
}
...
func Dimensions(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dimensionsPath), g.Group(children))
}
...
func DiscordLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(discordLogoPath), g.Group(children))
}

func DividerHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dividerHorizontalPath), g.Group(children))
}

func DividerVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dividerVerticalPath), g.Group(children))
}
...
func DotFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dotFilledPath), g.Group(children))
}
...
func DoubleArrowDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doubleArrowDownPath), g.Group(children))
}

func DoubleArrowLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doubleArrowLeftPath), g.Group(children))
}

func DoubleArrowRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doubleArrowRightPath), g.Group(children))
}

func DoubleArrowUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doubleArrowUpPath), g.Group(children))
}
...
func DragHandleDotsOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dragHandleDotsOnePath), g.Group(children))
}

func DragHandleDotsTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dragHandleDotsTwoPath), g.Group(children))
}

func DragHandleHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dragHandleHorizontalPath), g.Group(children))
}

func DragHandleVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dragHandleVerticalPath), g.Group(children))
}

func DrawingPin(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(drawingPinPath), g.Group(children))
}

func DrawingPinFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(drawingPinFilledPath), g.Group(children))
}

func DropdownMenu(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dropdownMenuPath), g.Group(children))
}
...
func EnterFullScreen(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(enterFullScreenPath), g.Group(children))
}

func EnvelopeClosed(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(envelopeClosedPath), g.Group(children))
}
...
func ExclamationTriangle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(exclamationTrianglePath), g.Group(children))
}
...
func ExitFullScreen(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(exitFullScreenPath), g.Group(children))
}
...
func EyeNone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(eyeNonePath), g.Group(children))
}
...
func Face(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(facePath), g.Group(children))
}

func FigmaLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(figmaLogoPath), g.Group(children))
}
...
func FontBold(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fontBoldPath), g.Group(children))
}
...
func FontItalic(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fontItalicPath), g.Group(children))
}

func FontRoman(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fontRomanPath), g.Group(children))
}
...
func FontStyle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fontStylePath), g.Group(children))
}
...
func FramerLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(framerLogoPath), g.Group(children))
}
...
func GithubLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(githubLogoPath), g.Group(children))
}
...
func HalfOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(halfOnePath), g.Group(children))
}

func HalfTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(halfTwoPath), g.Group(children))
}

func HamburgerMenu(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hamburgerMenuPath), g.Group(children))
}
...
func HeartFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heartFilledPath), g.Group(children))
}
...
func HobbyKnife(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hobbyKnifePath), g.Group(children))
}
...
func IconjarLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(iconjarLogoPath), g.Group(children))
}
...
func InfoCircled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(infoCircledPath), g.Group(children))
}
...
func InstagramLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(instagramLogoPath), g.Group(children))
}

func JustifyCenter(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(justifyCenterPath), g.Group(children))
}

func JustifyEnd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(justifyEndPath), g.Group(children))
}

func JustifyStart(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(justifyStartPath), g.Group(children))
}

func JustifyStretch(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(justifyStretchPath), g.Group(children))
}
...
func LapTimer(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lapTimerPath), g.Group(children))
}
...
func LetterCaseCapitalize(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(letterCaseCapitalizePath), g.Group(children))
}

func LetterCaseLowercase(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(letterCaseLowercasePath), g.Group(children))
}

func LetterCaseToggle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(letterCaseTogglePath), g.Group(children))
}

func LetterCaseUppercase(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(letterCaseUppercasePath), g.Group(children))
}

func LetterSpacing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(letterSpacingPath), g.Group(children))
}
...
func LinkBreakOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkBreakOnePath), g.Group(children))
}

func LinkBreakTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkBreakTwoPath), g.Group(children))
}

func LinkNoneOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkNoneOnePath), g.Group(children))
}

func LinkNoneTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkNoneTwoPath), g.Group(children))
}

func LinkOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkOnePath), g.Group(children))
}
...
func LinkedinLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkedinLogoPath), g.Group(children))
}
...
func LockOpenOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lockOpenOnePath), g.Group(children))
}

func LockOpenTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lockOpenTwoPath), g.Group(children))
}
...
func MagnifyingGlass(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(magnifyingGlassPath), g.Group(children))
}
...
func MaskOff(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(maskOffPath), g.Group(children))
}

func MaskOn(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(maskOnPath), g.Group(children))
}
...
func MinusCircled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(minusCircledPath), g.Group(children))
}

func Mix(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mixPath), g.Group(children))
}

func MixerHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mixerHorizontalPath), g.Group(children))
}

func MixerVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mixerVerticalPath), g.Group(children))
}
...
func ModulzLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(modulzLogoPath), g.Group(children))
}
...
func NotionLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notionLogoPath), g.Group(children))
}

func Opacity(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(opacityPath), g.Group(children))
}

func OpenInNewWindow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(openInNewWindowPath), g.Group(children))
}
...
func PencilOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pencilOnePath), g.Group(children))
}

func PencilTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pencilTwoPath), g.Group(children))
}
...
func PinLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pinLeftPath), g.Group(children))
}

func PinRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pinRightPath), g.Group(children))
}
...
func PlusCircled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(plusCircledPath), g.Group(children))
}
...
func QuestionMarkCircled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(questionMarkCircledPath), g.Group(children))
}
...
func Radiobutton(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(radiobuttonPath), g.Group(children))
}

func Reader(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(readerPath), g.Group(children))
}
...
func Resume(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(resumePath), g.Group(children))
}
...
func RotateCounterClockwise(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rotateCounterClockwisePath), g.Group(children))
}

func RowSpacing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rowSpacingPath), g.Group(children))
}
...
func RulerHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rulerHorizontalPath), g.Group(children))
}

func RulerSquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rulerSquarePath), g.Group(children))
}
...
func SewingPin(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sewingPinPath), g.Group(children))
}

func SewingPinFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sewingPinFilledPath), g.Group(children))
}

func Shadow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shadowPath), g.Group(children))
}

func ShadowInner(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shadowInnerPath), g.Group(children))
}

func ShadowNone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shadowNonePath), g.Group(children))
}

func ShadowOuter(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shadowOuterPath), g.Group(children))
}
...
func SketchLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sketchLogoPath), g.Group(children))
}
...
func SpaceBetweenHorizontally(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(spaceBetweenHorizontallyPath), g.Group(children))
}

func SpaceBetweenVertically(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(spaceBetweenVerticallyPath), g.Group(children))
}

func SpaceEvenlyHorizontally(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(spaceEvenlyHorizontallyPath), g.Group(children))
}

func SpaceEvenlyVertically(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(spaceEvenlyVerticallyPath), g.Group(children))
}

func SpeakerLoud(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(speakerLoudPath), g.Group(children))
}

func SpeakerModerate(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(speakerModeratePath), g.Group(children))
}

func SpeakerOff(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(speakerOffPath), g.Group(children))
}

func SpeakerQuiet(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(speakerQuietPath), g.Group(children))
}
...
func StarFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starFilledPath), g.Group(children))
}

func StitchesLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(stitchesLogoPath), g.Group(children))
}
...
func StretchHorizontally(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(stretchHorizontallyPath), g.Group(children))
}

func StretchVertically(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(stretchVerticallyPath), g.Group(children))
}
...
func Symbol(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(symbolPath), g.Group(children))
}
...
func TextAlignBottom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textAlignBottomPath), g.Group(children))
}
...
func TextAlignMiddle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textAlignMiddlePath), g.Group(children))
}
...
func TextAlignTop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textAlignTopPath), g.Group(children))
}

func TextNone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textNonePath), g.Group(children))
}

func ThickArrowDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thickArrowDownPath), g.Group(children))
}

func ThickArrowLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thickArrowLeftPath), g.Group(children))
}

func ThickArrowRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thickArrowRightPath), g.Group(children))
}

func ThickArrowUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thickArrowUpPath), g.Group(children))
}
...
func Tokens(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tokensPath), g.Group(children))
}

func TrackNext(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(trackNextPath), g.Group(children))
}

func TrackPrevious(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(trackPreviousPath), g.Group(children))
}

func Transform(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transformPath), g.Group(children))
}

func TransparencyGrid(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transparencyGridPath), g.Group(children))
}
...
func TwitterLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(twitterLogoPath), g.Group(children))
}
...
func Update(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(updatePath), g.Group(children))
}
...
func Value(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(valuePath), g.Group(children))
}

func ValueNone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(valueNonePath), g.Group(children))
}

func VercelLogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vercelLogoPath), g.Group(children))
}
...
func ViewHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(viewHorizontalPath), g.Group(children))
}

func ViewNone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(viewNonePath), g.Group(children))
}

func ViewVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(viewVerticalPath), g.Group(children))
}
