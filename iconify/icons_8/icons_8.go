...
func IconFromName(name string) g.Node {
	...
	case "areaChart":
		return AreaChart()
	case "arrowsLongDown":
		return ArrowsLongDown()
	case "arrowsLongLeft":
		return ArrowsLongLeft()
	...
	case "chevronDown":
		return ChevronDown()
	case "chevronDownRound":
		return ChevronDownRound()
	case "chevronLeft":
		return ChevronLeft()
	case "chevronLeftRound":
		return ChevronLeftRound()
	case "chevronRight":
		return ChevronRight()
	case "chevronRightRound":
		return ChevronRightRound()
	case "chevronUp":
		return ChevronUp()
	case "chevronUpRound":
		return ChevronUpRound()
	case "circle":
		return Circle()
	case "circleNotch":
		return CircleNotch()
	...
	case "gender":
		return Gender()
	case "genderNeutralUser":
		return GenderNeutralUser()
	case "genderqueer":
		return Genderqueer()
	case "genericSorting":
		return GenericSorting()
	case "genericSortingTwo":
		return GenericSortingTwo()
	case "genericText":
		return GenericText()
	case "gift":
		return Gift()
	...
	case "resizeFourDirections":
		return ResizeFourDirections()
	...
	case "roundedRectangleFilled":
		return RoundedRectangleFilled()
	case "rupee":
		return Rupee()
	case "search":
		return Search()
