...
func AnimalShelter(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M7.528.895L9 2h1L11.473.896a.33.33 0 0 1 .527.263V4.5c0 .722-.522 1.184-1 1.573V10l.8 2.4l.706.353a.894.894 0 0 1 .494.8c0 .247-.2.447-.447.447H4.25C3.017 14 2 13 2 11.713c0-2.17.453-3.783.745-4.868c.146-.543.29-.95.393-1.231c.058-.157.115-.303.192-.449c.449-.855 1.744-.21 1.342.668a6.311 6.311 0 0 0-.133.317c-.091.232-.214.593-.346 1.084c-.246.915-.519 2.287-.635 4.133c.368-2.06 2.422-4.128 4.077-5.609c-.345-.326-.634-.72-.634-1.258V1.158c0-.27.31-.425.527-.263z"/>`),
		g.Group(children),
	)
}
...
func Arrow(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M8.293 2.293a1 1 0 0 1 1.414 0l4.5 4.5a1 1 0 0 1 0 1.414l-4.5 4.5a1 1 0 0 1-1.414-1.414L11 8.5H1.5a1 1 0 0 1 0-2H11L8.293 3.707a1 1 0 0 1 0-1.414Z"/>`),
		g.Group(children),
	)
}
...
func College(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M7.5 1L0 4.5l2 .9v1.7c-.6.2-1 .8-1 1.4s.4 1.2 1 1.4v.1l-.9 2.1C.8 13 1 14 2.5 14s1.7-1 1.4-1.9L3 10c.6-.3 1-.8 1-1.5s-.4-1.2-1-1.4V5.9L7.5 8L15 4.5L7.5 1zm4.4 6.5l-4.5 2L5 8.4v.1c0 .7-.3 1.3-.8 1.8l.6 1.4v.1c.1.4.2.8.1 1.2c.7.3 1.5.5 2.5.5c3.3 0 4.5-2 4.5-3v-3z"/>`),
		g.Group(children),
	)
}
...
func Construction(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M13.5 11h-1.8L8.2.5C8-.2 7-.2 6.8.5L3.3 11H1.5c-.3 0-.5.2-.5.5v1c0 .3.2.5.5.5h12c.3 0 .5-.2.5-.5v-1c0-.3-.2-.5-.5-.5ZM7 3h1l.7 2H6.4L7 3ZM5.7 7h3.6l.7 2H5l.7-2Z"/>`),
		g.Group(children),
	)
}
...
func Dentist(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M4.36 14c-1 0-.56-2.67-.86-5c-.1-.76-1-1.49-1.12-2.06C2 5 1.39 1.44 3.66 1S6 3 7.54 3S9.11.64 11.39 1s1.59 3.9 1.29 5.9c-.1.45-1.1 1.48-1.18 2.06c-.33 2.4.32 5-.8 5c-.93 0-1.32-2.72-2-4.5C8.43 8.63 8.06 8 7.54 8C6 8 5.75 14 4.36 14z"/>`),
		g.Group(children),
	)
}
...
func Diamond(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M7.037 1.201L2.125 6.7a.482.482 0 0 0-.124.3c-.006.11.028.21.096.3l4.91 6.46c.055.074.13.135.215.177a.637.637 0 0 0 .556 0a.595.595 0 0 0 .216-.177l4.91-6.46a.453.453 0 0 0 .095-.3a.482.482 0 0 0-.124-.3L7.963 1.201a.604.604 0 0 0-.208-.148a.64.64 0 0 0-.718.148Z"/>`),
		g.Group(children),
	)
}
...
func EntranceAltOne(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M6.554 9.639a.5.5 0 0 0 .707.707l2.667-2.677a.25.25 0 0 0 0-.354L7.261 4.639a.5.5 0 0 0-.707.707L8.2 7H1.5a.5.5 0 0 0 0 1h6.7ZM12 1H5.5a.5.5 0 0 0 0 1h6a.5.5 0 0 1 .5.5v10a.5.5 0 0 1-.5.5H5.25a.5.5 0 0 0 0 1H12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1Z"/>`),
		g.Group(children),
	)
}
...
func HospitalJp(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M12.504 3H2.496A1.005 1.005 0 0 0 1.5 4.013v5.58a1.015 1.015 0 0 0 .55.907l4.78 2.84a1.474 1.474 0 0 0 1.339 0l4.78-2.84a1.015 1.015 0 0 0 .551-.906v-5.58A1.002 1.002 0 0 0 12.504 3zM10.5 8.5h-2v2h-2v-2h-2v-2h2v-2h2v2h2z"/>`),
		g.Group(children),
	)
}
...
func Karaoke(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M12.1 2.952a2.988 2.988 0 0 0-5.11 1.965l3.142 3.142A2.988 2.988 0 0 0 12.1 2.952Zm-7.428 5.3L2.55 10.377a1 1 0 0 0 0 1.414l.707.707a1 1 0 0 0 1.414 0l2.121-2.121l2.122-2.122l-2.121-2.121Zm.741 2.087l-.707-.707l2.087-2.084l.707.707Z"/>`),
		g.Group(children),
	)
}
...
func Lighthouse(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M4.5 6L0 7v-.5l4.5-1V6zm0-2.5L0 2.5V3l4.5 1v-.5zm6 0V4L15 3v-.5l-4.5 1zm0 2.5L15 7v-.5l-4.5-1V6zM8 7V2h2.5a.51.51 0 0 0 .2-1l-3-1a.5.5 0 0 0-.41 0l-3 1a.51.51 0 0 0 .2 1H7v5H5l-2 7h9l-2-7H8z"/>`),
		g.Group(children),
	)
}
...
func Lodging(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M.5 2.5c-.3 0-.5.2-.5.5v9.5c0 .3.2.5.5.5s.5-.2.5-.5V11h13v1.5c0 .3.2.5.5.5s.5-.2.5-.5v-2c0-.3-.2-.5-.5-.5H1V3c0-.3-.2-.5-.5-.5zm3 .5C2.7 3 2 3.7 2 4.5S2.7 6 3.5 6S5 5.3 5 4.5S4.3 3 3.5 3zM7 4C5.5 4 5.5 5.5 5.5 5.5V7h-3c-.3 0-.5.2-.5.5v1c0 .3.2.5.5.5H15V6.5C15 4 12.5 4 12.5 4H7z"/>`),
		g.Group(children),
	)
}
...
func PicnicSiteEleven(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path d="M2.75 2c-.416 0-.75.334-.75.75s.334.75.75.75H4L3.54 5H1.75c-.415 0-.75.335-.75.75s.335.75.75.75h1.326L2 10h1l1.076-3.5h2.848L8 10h1L7.924 6.5H9.25c.415 0 .75-.335.75-.75S9.665 5 9.25 5H7.46L7 3.5h1.25c.415 0 .75-.334.75-.75S8.665 2 8.25 2h-5.5zM5 3.5h1L6.46 5H4.54L5 3.5z" fill="currentColor"/>`),
		g.Group(children),
	)
}
...
func Police(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M5.5 1L6 2h5l.5-1h-6zM6 2.5v1.25S6 6.5 8.5 6.5S11 3.75 11 3.75V2.5H6zM1.984 3.986A1 1 0 0 0 1 5v4a1 1 0 0 0 1.217.977L5 9.357V14l5.879-6.93a1.58 1.58 0 0 0-.438-.07H6.5L3 7.754V5a1 1 0 0 0-1.016-1.014zm9.764 3.725L6.412 14H12V8.559c0-.314-.094-.604-.252-.848z"/>`),
		g.Group(children),
	)
}
...
func PoliceEleven(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path d="M4.5.5l.5 1h3l.5-1h-4zM5 2v1a1.5 1.5 0 0 0 3 0V2H5zM1.75 3C1 3 1 3.75 1 3.75v3a.75.75 0 0 0 .975.715L4 6.826V10l4-5H5s-.195 0-.424.072L2.5 5.727V3.75S2.5 3 1.75 3zm7.021 2.389L5 10h4V6a.98.98 0 0 0-.229-.611z" fill="currentColor"/>`),
		g.Group(children),
	)
}
...
func ReligiousMuslimEleven(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path d="M4.9 0C2.2 0 0 2.2 0 4.9s2.2 4.9 4.9 4.9c.9 0 1.7-.2 2.4-.6h-.6c-2.4 0-4.3-1.9-4.3-4.3S4.3.6 6.7.6h.6C6.5.2 5.8 0 4.9 0zm3.6 2l-.816 1.7L6 4l1 1.5L6.5 7l2-1l2 1l-.5-1.5L11 4l-1.5-.3l-1-1.7z" fill="currentColor"/>`),
		g.Group(children),
	)
}
...
func Rocket(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M11.555 2C9.41 2 6.534 3.471 4.602 6H3C1.843 6 1.18 6.864.723 7.777L.11 9H3l1.5 1.5L6 12v2.889l1.223-.612C8.136 13.821 9 13.157 9 12v-1.602c2.529-1.932 4-4.809 4-6.953V2zM9 5a1 1 0 1 1 0 2a1 1 0 0 1 0-2zm-6.5 6l-.5.5c-.722.722-1 2.5-1 2.5s1.698-.198 2.5-1l.5-.5z"/>`),
		g.Group(children),
	)
}
...
func Shoe(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M9.5 7a9.97 9.97 0 0 1-1.315-.948L6.01 3.221a.558.558 0 0 0-1 .279H5V5H3.209a.5.5 0 0 1-.357-.148S2.5 4 2 4h-.5a.5.5 0 0 0-.5.5V9h5.5c1.5 0 2 1 3.5 1h4v-.5C14 8 10.547 7.594 9.5 7Zm0 4a3.131 3.131 0 0 1-1.526-.447A4.1 4.1 0 0 0 6 10H1v1.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5V11a3.134 3.134 0 0 1 1.526.447A4.1 4.1 0 0 0 9.5 12h4a.5.5 0 0 0 .5-.5V11Z"/>`),
		g.Group(children),
	)
}
...
func Slipway(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="m2 10l12 1.495V12H2v-2Zm12-4l-1 1v.583L5.196 4.332l.063-.125L6.61 2.845h.831a.35.35 0 0 0 0-.7h-.976a.352.352 0 0 0-.248.103L4.723 3.753a.371.371 0 0 0-.066.09l-.109.219L2 3c0 2-.03 3.958 2.86 4.5C6.28 7.765 13 9 13 9l2-2l-1-1Z"/>`),
		g.Group(children),
	)
}
...
func TriangleStrokedEleven(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path d="M5.517 1.232a.556.556 0 0 0-.493.268l-4 6.66c-.223.37.044.84.476.84h8c.432 0 .699-.47.476-.84l-4-6.66a.556.556 0 0 0-.459-.268zM5.5 2.861l3.02 5.03H2.48l3.02-5.03z" fill="currentColor"/>`),
		g.Group(children),
	)
}
...
func Zoo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("15"),
		h.Height("15"),
		g.Raw(`<path fill="currentColor" d="M8.388 3.893S7.682 5 7 5H4.5c-.682 0-1.298.409-1.773.864L.5 8c-.269.258-.493.768-.5 1c-.016.5 0 1 0 1s1 0 1-1v-.5l1-1h.5l.158.29s-.954 1.824-.954 3.528c0 .682.682.682.682.682h.682s.341 0 0-.34l-.34-.342C2.727 10.636 3.5 9.667 4 9c0 0 .017 1.158 0 2c-.008.41.272 1 .682 1h.682s.34 0 0-.34l-.341-.342C4.71 10.75 5.5 8.5 5.5 8.5c1.272 0 1.5.5 3 .5l.364 2.318c.111.71.636.682.636.682H11c.34 0 .961-.311.34-.774L11 11V9c1.214-.172 2-1 2-2h1c.321 0 1 0 1-.5v-1l-1.704-1.682C12.543 3.078 12 2.5 11 2.5c-1.453 0-2.136.569-2.612 1.393z"/>`),
		g.Group(children),
	)
}
