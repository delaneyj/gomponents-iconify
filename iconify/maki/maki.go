...
func IconFromName(name string) g.Node {
	...
	case "aerialway":
		return Aerialway()
	case "aerialwayEleven":
		return AerialwayEleven()
	case "airfield":
		return Airfield()
	case "airfieldEleven":
		return AirfieldEleven()
	case "airport":
		return Airport()
	case "airportEleven":
		return AirportEleven()
	case "alcoholShop":
		return AlcoholShop()
	case "alcoholShopEleven":
		return AlcoholShopEleven()
	case "americanFootball":
		return AmericanFootball()
	case "americanFootballEleven":
		return AmericanFootballEleven()
	case "amusementPark":
		return AmusementPark()
	case "amusementParkEleven":
		return AmusementParkEleven()
	case "animalShelter":
		return AnimalShelter()
	case "aquarium":
		return Aquarium()
	case "aquariumEleven":
		return AquariumEleven()
	case "arrow":
		return Arrow()
	case "artGallery":
		return ArtGallery()
	case "artGalleryEleven":
		return ArtGalleryEleven()
	case "attraction":
		return Attraction()
	case "attractionEleven":
		return AttractionEleven()
	case "bakery":
		return Bakery()
	case "bakeryEleven":
		return BakeryEleven()
	case "bakeryFifteen":
		return BakeryFifteen()
	case "bank":
		return Bank()
	case "bankEleven":
		return BankEleven()
	...
	case "barrier":
		return Barrier()
	case "barrierEleven":
		return BarrierEleven()
	case "baseball":
		return Baseball()
	case "baseballEleven":
		return BaseballEleven()
	case "basketball":
		return Basketball()
	case "basketballEleven":
		return BasketballEleven()
	case "bbq":
		return Bbq()
	case "bbqEleven":
		return BbqEleven()
	...
	case "bicycle":
		return Bicycle()
	case "bicycleEleven":
		return BicycleEleven()
	case "bicycleShare":
		return BicycleShare()
	case "bicycleShareEleven":
		return BicycleShareEleven()
	case "bloodBank":
		return BloodBank()
	case "bloodBankEleven":
		return BloodBankEleven()
	case "bowlingAlley":
		return BowlingAlley()
	case "bowlingAlleyEleven":
		return BowlingAlleyEleven()
	case "bridge":
		return Bridge()
	case "bridgeEleven":
		return BridgeEleven()
	case "building":
		return Building()
	case "buildingAltOne":
		return BuildingAltOne()
	case "buildingAltOneEleven":
		return BuildingAltOneEleven()
	case "buildingEleven":
		return BuildingEleven()
	case "bus":
		return Bus()
	case "busEleven":
		return BusEleven()
	...
	case "carRental":
		return CarRental()
	case "carRentalEleven":
		return CarRentalEleven()
	case "carRentalFifteen":
		return CarRentalFifteen()
	case "carRepair":
		return CarRepair()
	case "carRepairEleven":
		return CarRepairEleven()
	case "carRepairFifteen":
		return CarRepairFifteen()
	case "casino":
		return Casino()
	case "casinoEleven":
		return CasinoEleven()
	...
	case "castleJp":
		return CastleJp()
	case "castleJpEleven":
		return CastleJpEleven()
	case "caution":
		return Caution()
	case "cemetery":
		return Cemetery()
	case "cemeteryEleven":
		return CemeteryEleven()
	case "cemeteryJp":
		return CemeteryJp()
	case "cemeteryJpEleven":
		return CemeteryJpEleven()
	case "chargingStation":
		return ChargingStation()
	case "chargingStationEleven":
		return ChargingStationEleven()
	case "cinema":
		return Cinema()
	case "cinemaEleven":
		return CinemaEleven()
	...
	case "circleEleven":
		return CircleEleven()
	case "circleStroked":
		return CircleStroked()
	case "circleStrokedEleven":
		return CircleStrokedEleven()
	case "city":
		return City()
	case "cityEleven":
		return CityEleven()
	...
	case "clothingStoreEleven":
		return ClothingStoreEleven()
	case "college":
		return College()
	case "collegeEleven":
		return CollegeEleven()
	case "collegeJp":
		return CollegeJp()
	case "collegeJpEleven":
		return CollegeJpEleven()
	case "commercial":
		return Commercial()
	case "commercialEleven":
		return CommercialEleven()
	case "communicationsTower":
		return CommunicationsTower()
	case "communicationsTowerEleven":
		return CommunicationsTowerEleven()
	case "confectionery":
		return Confectionery()
	case "confectioneryEleven":
		return ConfectioneryEleven()
	case "construction":
		return Construction()
	case "convenience":
		return Convenience()
	case "convenienceEleven":
		return ConvenienceEleven()
	case "cricket":
		return Cricket()
	case "cricketEleven":
		return CricketEleven()
	case "cross":
		return Cross()
	case "crossEleven":
		return CrossEleven()
	...
	case "defibrillatorEleven":
		return DefibrillatorEleven()
	case "dentist":
		return Dentist()
	case "dentistEleven":
		return DentistEleven()
	case "diamond":
		return Diamond()
	case "doctor":
		return Doctor()
	...
	case "dogPark":
		return DogPark()
	case "dogParkEleven":
		return DogParkEleven()
	case "drinkingWater":
		return DrinkingWater()
	case "drinkingWaterEleven":
		return DrinkingWaterEleven()
	case "drinkingWaterFifteen":
		return DrinkingWaterFifteen()
	case "elevator":
		return Elevator()
	case "embassy":
		return Embassy()
	case "embassyEleven":
		return EmbassyEleven()
	case "emergencyPhone":
		return EmergencyPhone()
	case "emergencyPhoneEleven":
		return EmergencyPhoneEleven()
	case "entrance":
		return Entrance()
	case "entranceAltOne":
		return EntranceAltOne()
	case "entranceAltOneEleven":
		return EntranceAltOneEleven()
	case "entranceEleven":
		return EntranceEleven()
	case "entranceFifteen":
		return EntranceFifteen()
	case "farm":
		return Farm()
	case "farmEleven":
		return FarmEleven()
	...
	case "fireStation":
		return FireStation()
	case "fireStationEleven":
		return FireStationEleven()
	case "fireStationJp":
		return FireStationJp()
	case "fireStationJpEleven":
		return FireStationJpEleven()
	case "fitnessCentre":
		return FitnessCentre()
	case "fitnessCentreEleven":
		return FitnessCentreEleven()
	case "florist":
		return Florist()
	case "floristEleven":
		return FloristEleven()
	case "fuel":
		return Fuel()
	case "fuelEleven":
		return FuelEleven()
	case "furniture":
		return Furniture()
	case "furnitureEleven":
		return FurnitureEleven()
	case "furnitureFifteen":
		return FurnitureFifteen()
	case "gaming":
		return Gaming()
	case "gamingEleven":
		return GamingEleven()
	...
	case "gardenCentre":
		return GardenCentre()
	case "gardenCentreEleven":
		return GardenCentreEleven()
	case "gardenEleven":
		return GardenEleven()
	case "gate":
		return Gate()
	...
	case "grocery":
		return Grocery()
	case "groceryEleven":
		return GroceryEleven()
	case "hairdresser":
		return Hairdresser()
	case "hairdresserEleven":
		return HairdresserEleven()
	case "harbor":
		return Harbor()
	case "harborEleven":
		return HarborEleven()
	...
	case "heliport":
		return Heliport()
	case "heliportEleven":
		return HeliportEleven()
	case "highwayRestArea":
		return HighwayRestArea()
	case "historic":
		return Historic()
	case "home":
		return Home()
	...
	case "horseRiding":
		return HorseRiding()
	case "horseRidingEleven":
		return HorseRidingEleven()
	case "hospital":
		return Hospital()
	case "hospitalEleven":
		return HospitalEleven()
	case "hospitalJp":
		return HospitalJp()
	case "hospitalJpEleven":
		return HospitalJpEleven()
	case "hotSpring":
		return HotSpring()
	case "iceCream":
		return IceCream()
	case "iceCreamEleven":
		return IceCreamEleven()
	case "iceCreamFifteen":
		return IceCreamFifteen()
	case "industry":
		return Industry()
	case "industryEleven":
		return IndustryEleven()
	case "information":
		return Information()
	case "informationEleven":
		return InformationEleven()
	case "jewelryStore":
		return JewelryStore()
	case "jewelryStoreEleven":
		return JewelryStoreEleven()
	case "karaoke":
		return Karaoke()
	case "karaokeEleven":
		return KaraokeEleven()
	case "karaokeFifteen":
		return KaraokeFifteen()
	case "landmark":
		return Landmark()
	case "landmarkEleven":
		return LandmarkEleven()
	case "landmarkJp":
		return LandmarkJp()
	case "landmarkJpEleven":
		return LandmarkJpEleven()
	case "landuse":
		return Landuse()
	case "landuseEleven":
		return LanduseEleven()
	case "laundry":
		return Laundry()
	case "laundryEleven":
		return LaundryEleven()
	case "library":
		return Library()
	case "libraryEleven":
		return LibraryEleven()
	case "libraryFifteen":
		return LibraryFifteen()
	case "liftGate":
		return LiftGate()
	case "lighthouse":
		return Lighthouse()
	case "lighthouseEleven":
		return LighthouseEleven()
	case "lighthouseJp":
		return LighthouseJp()
	case "lodging":
		return Lodging()
	case "lodgingEleven":
		return LodgingEleven()
	case "logging":
		return Logging()
	case "loggingEleven":
		return LoggingEleven()
	case "marker":
		return Marker()
	case "markerEleven":
		return MarkerEleven()
	case "markerStroked":
		return MarkerStroked()
	case "markerStrokedEleven":
		return MarkerStrokedEleven()
	case "mobilePhone":
		return MobilePhone()
	case "mobilePhoneEleven":
		return MobilePhoneEleven()
	case "monument":
		return Monument()
	case "monumentEleven":
		return MonumentEleven()
	case "monumentJp":
		return MonumentJp()
	case "mountain":
		return Mountain()
	case "mountainEleven":
		return MountainEleven()
	case "museum":
		return Museum()
	case "museumEleven":
		return MuseumEleven()
	case "museumFifteen":
		return MuseumFifteen()
	case "music":
		return Music()
	case "musicEleven":
		return MusicEleven()
	...
	case "parkAltOne":
		return ParkAltOne()
	case "parkAltOneEleven":
		return ParkAltOneEleven()
	case "parkEleven":
		return ParkEleven()
	case "parking":
		return Parking()
	case "parkingEleven":
		return ParkingEleven()
	case "parkingGarage":
		return ParkingGarage()
	case "parkingGarageEleven":
		return ParkingGarageEleven()
	case "parkingPaid":
		return ParkingPaid()
	case "pharmacy":
		return Pharmacy()
	case "pharmacyEleven":
		return PharmacyEleven()
	case "picnicSite":
		return PicnicSite()
	case "picnicSiteEleven":
		return PicnicSiteEleven()
	case "pitch":
		return Pitch()
	case "pitchEleven":
		return PitchEleven()
	...
	case "placeOfWorshipEleven":
		return PlaceOfWorshipEleven()
	case "playground":
		return Playground()
	case "playgroundEleven":
		return PlaygroundEleven()
	case "police":
		return Police()
	case "policeEleven":
		return PoliceEleven()
	...
	case "racetrack":
		return Racetrack()
	case "racetrackBoat":
		return RacetrackBoat()
	case "racetrackCycling":
		return RacetrackCycling()
	case "racetrackHorse":
		return RacetrackHorse()
	case "rail":
		return Rail()
	case "railEleven":
		return RailEleven()
	case "railLight":
		return RailLight()
	case "railLightEleven":
		return RailLightEleven()
	case "railMetro":
		return RailMetro()
	case "railMetroEleven":
		return RailMetroEleven()
	case "rangerStation":
		return RangerStation()
	case "rangerStationEleven":
		return RangerStationEleven()
	case "recycling":
		return Recycling()
	case "recyclingEleven":
		return RecyclingEleven()
	case "religiousBuddhist":
		return ReligiousBuddhist()
	case "religiousBuddhistEleven":
		return ReligiousBuddhistEleven()
	case "religiousChristian":
		return ReligiousChristian()
	case "religiousChristianEleven":
		return ReligiousChristianEleven()
	case "religiousJewish":
		return ReligiousJewish()
	case "religiousJewishEleven":
		return ReligiousJewishEleven()
	case "religiousMuslim":
		return ReligiousMuslim()
	case "religiousMuslimEleven":
		return ReligiousMuslimEleven()
	case "religiousShinto":
		return ReligiousShinto()
	case "religiousShintoEleven":
		return ReligiousShintoEleven()
	case "residentialCommunity":
		return ResidentialCommunity()
	case "residentialCommunityEleven":
		return ResidentialCommunityEleven()
	case "restaurant":
		return Restaurant()
	case "restaurantBbq":
		return RestaurantBbq()
	case "restaurantEleven":
		return RestaurantEleven()
	case "restaurantNoodle":
		return RestaurantNoodle()
	case "restaurantNoodleEleven":
		return RestaurantNoodleEleven()
	case "restaurantPizza":
		return RestaurantPizza()
	case "restaurantPizzaEleven":
		return RestaurantPizzaEleven()
	case "restaurantSeafood":
		return RestaurantSeafood()
	case "restaurantSeafoodEleven":
		return RestaurantSeafoodEleven()
	...
	case "roadblock":
		return Roadblock()
	case "roadblockEleven":
		return RoadblockEleven()
	case "rocket":
		return Rocket()
	case "rocketEleven":
		return RocketEleven()
	...
	case "schoolJp":
		return SchoolJp()
	case "schoolJpEleven":
		return SchoolJpEleven()
	case "scooter":
		return Scooter()
	case "scooterEleven":
		return ScooterEleven()
	case "shelter":
		return Shelter()
	case "shelterEleven":
		return ShelterEleven()
	case "shoe":
		return Shoe()
	case "shoeEleven":
		return ShoeEleven()
	...
	case "skateboard":
		return Skateboard()
	case "skateboardEleven":
		return SkateboardEleven()
	case "skiing":
		return Skiing()
	case "skiingEleven":
		return SkiingEleven()
	...
	case "slaughterhouseEleven":
		return SlaughterhouseEleven()
	case "slipway":
		return Slipway()
	case "slipwayEleven":
		return SlipwayEleven()
	case "snowmobile":
		return Snowmobile()
	case "snowmobileEleven":
		return SnowmobileEleven()
	case "soccer":
		return Soccer()
	case "soccerEleven":
		return SoccerEleven()
	...
	case "squareEleven":
		return SquareEleven()
	case "squareStroked":
		return SquareStroked()
	case "squareStrokedEleven":
		return SquareStrokedEleven()
	case "stadium":
		return Stadium()
	case "stadiumEleven":
		return StadiumEleven()
	case "star":
		return Star()
	case "starEleven":
		return StarEleven()
	case "starStroked":
		return StarStroked()
	case "starStrokedEleven":
		return StarStrokedEleven()
	case "suitcase":
		return Suitcase()
	case "suitcaseEleven":
		return SuitcaseEleven()
	case "sushiEleven":
		return SushiEleven()
	case "swimming":
		return Swimming()
	case "swimmingEleven":
		return SwimmingEleven()
	case "tableTennis":
		return TableTennis()
	case "tableTennisEleven":
		return TableTennisEleven()
	case "teahouse":
		return Teahouse()
	case "teahouseEleven":
		return TeahouseEleven()
	case "telephone":
		return Telephone()
	case "telephoneEleven":
		return TelephoneEleven()
	case "tennis":
		return Tennis()
	case "tennisEleven":
		return TennisEleven()
	...
	case "townHall":
		return TownHall()
	case "townHallEleven":
		return TownHallEleven()
	case "townHallFifteen":
		return TownHallFifteen()
	case "triangle":
		return Triangle()
	case "triangleEleven":
		return TriangleEleven()
	case "triangleStroked":
		return TriangleStroked()
	case "triangleStrokedEleven":
		return TriangleStrokedEleven()
	case "tunnel":
		return Tunnel()
	case "veterinary":
		return Veterinary()
	case "veterinaryEleven":
		return VeterinaryEleven()
	case "veterinaryFifteen":
		return VeterinaryFifteen()
	case "viewpoint":
		return Viewpoint()
	case "viewpointEleven":
		return ViewpointEleven()
	case "village":
		return Village()
	case "villageEleven":
		return VillageEleven()
	case "volcano":
		return Volcano()
	case "volcanoEleven":
		return VolcanoEleven()
	case "volleyball":
		return Volleyball()
	case "volleyballEleven":
		return VolleyballEleven()
	case "warehouse":
		return Warehouse()
	case "warehouseEleven":
		return WarehouseEleven()
	case "wasteBasket":
		return WasteBasket()
	case "wasteBasketEleven":
		return WasteBasketEleven()
	case "watch":
		return Watch()
	case "watchEleven":
		return WatchEleven()
	...
	case "waterfall":
		return Waterfall()
	case "waterfallEleven":
		return WaterfallEleven()
	case "watermill":
		return Watermill()
	case "watermillEleven":
		return WatermillEleven()
	case "wetland":
		return Wetland()
	case "wetlandEleven":
		return WetlandEleven()
	case "wheelchair":
		return Wheelchair()
	case "wheelchairEleven":
		return WheelchairEleven()
	case "windmill":
		return Windmill()
	case "windmillEleven":
		return WindmillEleven()
	case "zoo":
		return Zoo()
	case "zooEleven":
		return ZooEleven()
