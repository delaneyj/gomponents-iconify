...
func IconFromName(name string) g.Node {
	...
	case "arrowBack":
		return ArrowBack()
	case "arrowFromBottom":
		return ArrowFromBottom()
	case "arrowFromLeft":
		return ArrowFromLeft()
	case "arrowFromRight":
		return ArrowFromRight()
	case "arrowFromTop":
		return ArrowFromTop()
	case "arrowToBottom":
	...
	case "bookmarkAlt":
		return BookmarkAlt()
	case "bookmarkAltMinus":
		return BookmarkAltMinus()
	case "bookmarkAltPlus":
		return BookmarkAltPlus()
	case "bookmarkHeart":
		return BookmarkHeart()
	case "bookmarkMinus":
	...
	case "briefcaseAlt":
		return BriefcaseAlt()
	case "briefcaseAltTwo":
		return BriefcaseAltTwo()
	case "brightness":
		return Brightness()
	case "brightnessHalf":
		return BrightnessHalf()
	case "broadcast":
		return Broadcast()
	case "brush":
		return Brush()
	...
	case "bxlCodepen":
		return BxlCodepen()
	case "bxlCreativeCommons":
		return BxlCreativeCommons()
	case "bxlCssThree":
		return BxlCssThree()
	case "bxlDailymotion":
		return BxlDailymotion()
	case "bxlDevTo":
		return BxlDevTo()
	case "bxlDeviantart":
		return BxlDeviantart()
	case "bxlDigg":
		return BxlDigg()
	case "bxlDigitalocean":
		return BxlDigitalocean()
	case "bxlDiscord":
		return BxlDiscord()
	case "bxlDiscordAlt":
		return BxlDiscordAlt()
	case "bxlDiscourse":
		return BxlDiscourse()
	case "bxlDjango":
		return BxlDjango()
	...
	case "bxlFacebook":
		return BxlFacebook()
	case "bxlFacebookCircle":
		return BxlFacebookCircle()
	case "bxlFacebookSquare":
		return BxlFacebookSquare()
	case "bxlFigma":
		return BxlFigma()
	case "bxlFirebase":
		return BxlFirebase()
	case "bxlFirefox":
		return BxlFirefox()
	case "bxlFiveHundredPx":
		return BxlFiveHundredPx()
	case "bxlFlask":
		return BxlFlask()
	case "bxlFlickr":
		return BxlFlickr()
	case "bxlFlickrSquare":
		return BxlFlickrSquare()
	case "bxlFlutter":
		return BxlFlutter()
	case "bxlFoursquare":
		return BxlFoursquare()
	case "bxlGit":
		return BxlGit()
	case "bxlGithub":
		return BxlGithub()
	...
	case "bxlGoogle":
		return BxlGoogle()
	case "bxlGoogleCloud":
		return BxlGoogleCloud()
	case "bxlGooglePlus":
		return BxlGooglePlus()
	case "bxlGooglePlusCircle":
		return BxlGooglePlusCircle()
	case "bxlHeroku":
		return BxlHeroku()
	case "bxlHtmlFive":
		return BxlHtmlFive()
	...
	case "bxlInstagram":
		return BxlInstagram()
	case "bxlInstagramAlt":
		return BxlInstagramAlt()
	case "bxlInternetExplorer":
		return BxlInternetExplorer()
	case "bxlInvision":
		return BxlInvision()
	case "bxlJava":
		return BxlJava()
	case "bxlJavascript":
		return BxlJavascript()
	case "bxlJoomla":
		return BxlJoomla()
	case "bxlJquery":
		return BxlJquery()
	case "bxlJsfiddle":
		return BxlJsfiddle()
	case "bxlKickstarter":
		return BxlKickstarter()
	case "bxlKubernetes":
		return BxlKubernetes()
	case "bxlLess":
		return BxlLess()
	case "bxlLinkedin":
		return BxlLinkedin()
	case "bxlLinkedinSquare":
		return BxlLinkedinSquare()
	case "bxlMagento":
		return BxlMagento()
	case "bxlMailchimp":
		return BxlMailchimp()
	...
	case "bxlMediumOld":
		return BxlMediumOld()
	case "bxlMediumSquare":
		return BxlMediumSquare()
	case "bxlMessenger":
		return BxlMessenger()
	case "bxlMeta":
		return BxlMeta()
	case "bxlMicrosoft":
		return BxlMicrosoft()
	case "bxlMicrosoftTeams":
		return BxlMicrosoftTeams()
	case "bxlNetlify":
		return BxlNetlify()
	case "bxlNinetyNineDesigns":
		return BxlNinetyNineDesigns()
	case "bxlNodejs":
		return BxlNodejs()
	case "bxlOkRu":
		return BxlOkRu()
	...
	case "bxlPinterest":
		return BxlPinterest()
	case "bxlPinterestAlt":
		return BxlPinterestAlt()
	case "bxlPlayStore":
		return BxlPlayStore()
	case "bxlPocket":
		return BxlPocket()
	case "bxlProductHunt":
		return BxlProductHunt()
	case "bxlPython":
		return BxlPython()
	case "bxlQuora":
		return BxlQuora()
	...
	case "bxlSnapchat":
		return BxlSnapchat()
	case "bxlSoundcloud":
		return BxlSoundcloud()
	case "bxlSpotify":
		return BxlSpotify()
	case "bxlSpringBoot":
		return BxlSpringBoot()
	case "bxlSquarespace":
		return BxlSquarespace()
	case "bxlStackOverflow":
		return BxlStackOverflow()
	case "bxlSteam":
		return BxlSteam()
	case "bxlStripe":
		return BxlStripe()
	case "bxlTailwindCss":
		return BxlTailwindCss()
	case "bxlTelegram":
		return BxlTelegram()
	case "bxlTiktok":
		return BxlTiktok()
	...
	case "bxlVisa":
		return BxlVisa()
	case "bxlVisualStudio":
		return BxlVisualStudio()
	case "bxlVk":
		return BxlVk()
	case "bxlVuejs":
		return BxlVuejs()
	case "bxlWhatsapp":
		return BxlWhatsapp()
	case "bxlWhatsappSquare":
		return BxlWhatsappSquare()
	case "bxlWikipedia":
		return BxlWikipedia()
	case "bxlWindows":
		return BxlWindows()
	...
	case "bxsAlarmAdd":
		return BxsAlarmAdd()
	case "bxsAlarmExclamation":
		return BxsAlarmExclamation()
	case "bxsAlarmOff":
		return BxsAlarmOff()
	case "bxsAlarmSnooze":
		return BxsAlarmSnooze()
	case "bxsAlbum":
		return BxsAlbum()
	case "bxsAmbulance":
		return BxsAmbulance()
	...
	case "bxsArchiveIn":
		return BxsArchiveIn()
	case "bxsArchiveOut":
		return BxsArchiveOut()
	case "bxsArea":
		return BxsArea()
	case "bxsArrowFromBottom":
		return BxsArrowFromBottom()
	case "bxsArrowFromLeft":
		return BxsArrowFromLeft()
	case "bxsArrowFromRight":
		return BxsArrowFromRight()
	case "bxsArrowFromTop":
		return BxsArrowFromTop()
	case "bxsArrowToBottom":
		return BxsArrowToBottom()
	case "bxsArrowToLeft":
		return BxsArrowToLeft()
	case "bxsArrowToRight":
		return BxsArrowToRight()
	case "bxsArrowToTop":
		return BxsArrowToTop()
	case "bxsAward":
		return BxsAward()
	case "bxsBabyCarriage":
		return BxsBabyCarriage()
	case "bxsBackpack":
		return BxsBackpack()
	case "bxsBadge":
		return BxsBadge()
	case "bxsBadgeCheck":
		return BxsBadgeCheck()
	case "bxsBadgeDollar":
		return BxsBadgeDollar()
	case "bxsBaguette":
		return BxsBaguette()
	case "bxsBall":
		return BxsBall()
	...
	case "bxsBank":
		return BxsBank()
	case "bxsBarChartAltTwo":
		return BxsBarChartAltTwo()
	case "bxsBarChartSquare":
		return BxsBarChartSquare()
	case "bxsBarcode":
		return BxsBarcode()
	case "bxsBaseball":
		return BxsBaseball()
	case "bxsBasket":
		return BxsBasket()
	case "bxsBasketball":
		return BxsBasketball()
	case "bxsBath":
		return BxsBath()
	case "bxsBattery":
		return BxsBattery()
	case "bxsBatteryCharging":
		return BxsBatteryCharging()
	case "bxsBatteryFull":
		return BxsBatteryFull()
	case "bxsBatteryLow":
		return BxsBatteryLow()
	case "bxsBed":
		return BxsBed()
	case "bxsBeenHere":
		return BxsBeenHere()
	...
	case "bxsBible":
		return BxsBible()
	case "bxsBinoculars":
		return BxsBinoculars()
	case "bxsBlanket":
		return BxsBlanket()
	case "bxsBolt":
		return BxsBolt()
	case "bxsBoltCircle":
		return BxsBoltCircle()
	case "bxsBomb":
		return BxsBomb()
	case "bxsBone":
		return BxsBone()
	...
	case "bxsBookAlt":
		return BxsBookAlt()
	case "bxsBookBookmark":
		return BxsBookBookmark()
	case "bxsBookContent":
		return BxsBookContent()
	case "bxsBookHeart":
		return BxsBookHeart()
	case "bxsBookOpen":
		return BxsBookOpen()
	case "bxsBookReader":
		return BxsBookReader()
	case "bxsBookmark":
		return BxsBookmark()
	case "bxsBookmarkAlt":
		return BxsBookmarkAlt()
	case "bxsBookmarkAltMinus":
		return BxsBookmarkAltMinus()
	case "bxsBookmarkAltPlus":
		return BxsBookmarkAltPlus()
	case "bxsBookmarkHeart":
		return BxsBookmarkHeart()
	case "bxsBookmarkMinus":
		return BxsBookmarkMinus()
	case "bxsBookmarkPlus":
		return BxsBookmarkPlus()
	case "bxsBookmarkStar":
		return BxsBookmarkStar()
	case "bxsBookmarks":
		return BxsBookmarks()
	case "bxsBot":
		return BxsBot()
	...
	case "bxsBriefcase":
		return BxsBriefcase()
	case "bxsBriefcaseAlt":
		return BxsBriefcaseAlt()
	case "bxsBriefcaseAltTwo":
		return BxsBriefcaseAltTwo()
	case "bxsBrightness":
		return BxsBrightness()
	case "bxsBrightnessHalf":
		return BxsBrightnessHalf()
	case "bxsBrush":
		return BxsBrush()
	case "bxsBrushAlt":
		return BxsBrushAlt()
	...
	case "bxsBuilding":
		return BxsBuilding()
	case "bxsBuildingHouse":
		return BxsBuildingHouse()
	case "bxsBuildings":
		return BxsBuildings()
	case "bxsBulb":
		return BxsBulb()
	...
	case "bxsCake":
		return BxsCake()
	case "bxsCalculator":
		return BxsCalculator()
	case "bxsCalendar":
		return BxsCalendar()
	case "bxsCalendarAlt":
		return BxsCalendarAlt()
	case "bxsCalendarCheck":
		return BxsCalendarCheck()
	case "bxsCalendarEdit":
		return BxsCalendarEdit()
	case "bxsCalendarEvent":
		return BxsCalendarEvent()
	case "bxsCalendarExclamation":
		return BxsCalendarExclamation()
	case "bxsCalendarHeart":
		return BxsCalendarHeart()
	case "bxsCalendarMinus":
		return BxsCalendarMinus()
	case "bxsCalendarPlus":
		return BxsCalendarPlus()
	case "bxsCalendarStar":
		return BxsCalendarStar()
	case "bxsCalendarWeek":
		return BxsCalendarWeek()
	case "bxsCalendarX":
		return BxsCalendarX()
	case "bxsCamera":
		return BxsCamera()
	case "bxsCameraHome":
		return BxsCameraHome()
	case "bxsCameraMovie":
		return BxsCameraMovie()
	case "bxsCameraOff":
		return BxsCameraOff()
	case "bxsCameraPlus":
		return BxsCameraPlus()
	case "bxsCapsule":
		return BxsCapsule()
	case "bxsCaptions":
		return BxsCaptions()
	case "bxsCar":
		return BxsCar()
	case "bxsCarBattery":
		return BxsCarBattery()
	case "bxsCarCrash":
		return BxsCarCrash()
	case "bxsCarGarage":
		return BxsCarGarage()
	case "bxsCarMechanic":
		return BxsCarMechanic()
	case "bxsCarWash":
		return BxsCarWash()
	case "bxsCard":
		return BxsCard()
	case "bxsCaretDownCircle":
		return BxsCaretDownCircle()
	case "bxsCaretDownSquare":
		return BxsCaretDownSquare()
	case "bxsCaretLeftCircle":
		return BxsCaretLeftCircle()
	case "bxsCaretLeftSquare":
		return BxsCaretLeftSquare()
	case "bxsCaretRightCircle":
		return BxsCaretRightCircle()
	case "bxsCaretRightSquare":
		return BxsCaretRightSquare()
	case "bxsCaretUpCircle":
		return BxsCaretUpCircle()
	case "bxsCaretUpSquare":
		return BxsCaretUpSquare()
	case "bxsCarousel":
		return BxsCarousel()
	case "bxsCart":
		return BxsCart()
	...
	case "bxsCartAlt":
		return BxsCartAlt()
	case "bxsCartDownload":
		return BxsCartDownload()
	case "bxsCat":
		return BxsCat()
	case "bxsCategory":
		return BxsCategory()
	case "bxsCategoryAlt":
		return BxsCategoryAlt()
	case "bxsCctv":
		return BxsCctv()
	case "bxsCertification":
		return BxsCertification()
	case "bxsChalkboard":
		return BxsChalkboard()
	case "bxsChart":
		return BxsChart()
	case "bxsChat":
		return BxsChat()
	case "bxsCheckCircle":
		return BxsCheckCircle()
	case "bxsCheckShield":
		return BxsCheckShield()
	case "bxsCheckSquare":
		return BxsCheckSquare()
	case "bxsCheckbox":
		return BxsCheckbox()
	case "bxsCheckboxChecked":
		return BxsCheckboxChecked()
	case "bxsCheckboxMinus":
		return BxsCheckboxMinus()
	case "bxsChess":
		return BxsChess()
	case "bxsChevronDown":
		return BxsChevronDown()
	case "bxsChevronDownCircle":
		return BxsChevronDownCircle()
	case "bxsChevronDownSquare":
		return BxsChevronDownSquare()
	case "bxsChevronLeft":
		return BxsChevronLeft()
	case "bxsChevronLeftCircle":
		return BxsChevronLeftCircle()
	case "bxsChevronLeftSquare":
		return BxsChevronLeftSquare()
	case "bxsChevronRight":
		return BxsChevronRight()
	case "bxsChevronRightCircle":
		return BxsChevronRightCircle()
	case "bxsChevronRightSquare":
		return BxsChevronRightSquare()
	case "bxsChevronUp":
		return BxsChevronUp()
	case "bxsChevronUpCircle":
		return BxsChevronUpCircle()
	case "bxsChevronUpSquare":
		return BxsChevronUpSquare()
	case "bxsChevronsDown":
		return BxsChevronsDown()
	case "bxsChevronsLeft":
		return BxsChevronsLeft()
	case "bxsChevronsRight":
		return BxsChevronsRight()
	case "bxsChevronsUp":
		return BxsChevronsUp()
	case "bxsChip":
		return BxsChip()
	case "bxsChurch":
		return BxsChurch()
	case "bxsCircle":
		return BxsCircle()
	case "bxsCircleHalf":
		return BxsCircleHalf()
	case "bxsCircleQuarter":
		return BxsCircleQuarter()
	case "bxsCircleThreeQuarter":
		return BxsCircleThreeQuarter()
	case "bxsCity":
		return BxsCity()
	case "bxsClinic":
		return BxsClinic()
	case "bxsCloud":
		return BxsCloud()
	case "bxsCloudDownload":
		return BxsCloudDownload()
	case "bxsCloudLightning":
		return BxsCloudLightning()
	case "bxsCloudRain":
		return BxsCloudRain()
	case "bxsCloudUpload":
		return BxsCloudUpload()
	case "bxsCoffee":
		return BxsCoffee()
	case "bxsCoffeeAlt":
		return BxsCoffeeAlt()
	case "bxsCoffeeTogo":
		return BxsCoffeeTogo()
	case "bxsCog":
		return BxsCog()
	case "bxsCoin":
		return BxsCoin()
	case "bxsCoinStack":
		return BxsCoinStack()
	case "bxsCollection":
		return BxsCollection()
	case "bxsColorFill":
		return BxsColorFill()
	case "bxsComment":
		return BxsComment()
	case "bxsCommentAdd":
		return BxsCommentAdd()
	case "bxsCommentCheck":
		return BxsCommentCheck()
	case "bxsCommentDetail":
		return BxsCommentDetail()
	case "bxsCommentDots":
		return BxsCommentDots()
	case "bxsCommentEdit":
		return BxsCommentEdit()
	case "bxsCommentError":
		return BxsCommentError()
	case "bxsCommentMinus":
		return BxsCommentMinus()
	case "bxsCommentX":
		return BxsCommentX()
	case "bxsCompass":
		return BxsCompass()
	...
	case "bxsContact":
		return BxsContact()
	case "bxsConversation":
		return BxsConversation()
	case "bxsCookie":
		return BxsCookie()
	case "bxsCool":
		return BxsCool()
	...
	case "bxsCoupon":
		return BxsCoupon()
	case "bxsCreditCard":
		return BxsCreditCard()
	case "bxsCreditCardAlt":
		return BxsCreditCardAlt()
	case "bxsCreditCardFront":
		return BxsCreditCardFront()
	case "bxsCricketBall":
		return BxsCricketBall()
	case "bxsCrop":
		return BxsCrop()
	case "bxsCrown":
		return BxsCrown()
	...
	case "bxsDiceTwo":
		return BxsDiceTwo()
	case "bxsDirectionLeft":
		return BxsDirectionLeft()
	case "bxsDirectionRight":
		return BxsDirectionRight()
	case "bxsDirections":
		return BxsDirections()
	case "bxsDisc":
		return BxsDisc()
	case "bxsDiscount":
		return BxsDiscount()
	...
	case "bxsDog":
		return BxsDog()
	case "bxsDollarCircle":
		return BxsDollarCircle()
	case "bxsDonateBlood":
		return BxsDonateBlood()
	case "bxsDonateHeart":
		return BxsDonateHeart()
	case "bxsDoorOpen":
		return BxsDoorOpen()
	case "bxsDoughnutChart":
		return BxsDoughnutChart()
	case "bxsDownArrow":
		return BxsDownArrow()
	case "bxsDownArrowAlt":
		return BxsDownArrowAlt()
	case "bxsDownArrowCircle":
		return BxsDownArrowCircle()
	case "bxsDownArrowSquare":
		return BxsDownArrowSquare()
	case "bxsDownload":
		return BxsDownload()
	case "bxsDownvote":
		return BxsDownvote()
	...
	case "bxsEditAlt":
		return BxsEditAlt()
	case "bxsEditLocation":
		return BxsEditLocation()
	case "bxsEject":
		return BxsEject()
	case "bxsEnvelope":
		return BxsEnvelope()
	case "bxsEnvelopeOpen":
		return BxsEnvelopeOpen()
	case "bxsEraser":
		return BxsEraser()
	case "bxsError":
		return BxsError()
	...
	case "bxsFactory":
		return BxsFactory()
	case "bxsFastForwardCircle":
		return BxsFastForwardCircle()
	case "bxsFile":
		return BxsFile()
	case "bxsFileArchive":
		return BxsFileArchive()
	case "bxsFileBlank":
		return BxsFileBlank()
	case "bxsFileCss":
		return BxsFileCss()
	...
	case "bxsFlagAlt":
		return BxsFlagAlt()
	case "bxsFlagCheckered":
		return BxsFlagCheckered()
	case "bxsFlame":
		return BxsFlame()
	case "bxsFlask":
		return BxsFlask()
	...
	case "bxsFolder":
		return BxsFolder()
	case "bxsFolderMinus":
		return BxsFolderMinus()
	case "bxsFolderOpen":
		return BxsFolderOpen()
	case "bxsFolderPlus":
		return BxsFolderPlus()
	case "bxsFoodMenu":
		return BxsFoodMenu()
	case "bxsFridge":
		return BxsFridge()
	...
	case "bxsHappyAlt":
		return BxsHappyAlt()
	case "bxsHappyBeaming":
		return BxsHappyBeaming()
	case "bxsHappyHeartEyes":
		return BxsHappyHeartEyes()
	case "bxsHdd":
		return BxsHdd()
	case "bxsHeart":
		return BxsHeart()
	case "bxsHeartCircle":
		return BxsHeartCircle()
	case "bxsHeartSquare":
		return BxsHeartSquare()
	case "bxsHelpCircle":
		return BxsHelpCircle()
	case "bxsHide":
		return BxsHide()
	case "bxsHome":
		return BxsHome()
	case "bxsHomeCircle":
		return BxsHomeCircle()
	case "bxsHomeHeart":
		return BxsHomeHeart()
	case "bxsHomeSmile":
		return BxsHomeSmile()
	...
	case "bxsHourglass":
		return BxsHourglass()
	case "bxsHourglassBottom":
		return BxsHourglassBottom()
	case "bxsHourglassTop":
		return BxsHourglassTop()
	case "bxsIdCard":
		return BxsIdCard()
	case "bxsImage":
		return BxsImage()
	...
	case "bxsInfoSquare":
		return BxsInfoSquare()
	case "bxsInjection":
		return BxsInjection()
	case "bxsInstitution":
		return BxsInstitution()
	case "bxsInvader":
		return BxsInvader()
	case "bxsJoystick":
		return BxsJoystick()
	case "bxsJoystickAlt":
		return BxsJoystickAlt()
	case "bxsJoystickButton":
		return BxsJoystickButton()
	case "bxsKey":
		return BxsKey()
	case "bxsKeyboard":
		return BxsKeyboard()
	...
	case "bxsLeftArrow":
		return BxsLeftArrow()
	case "bxsLeftArrowAlt":
		return BxsLeftArrowAlt()
	case "bxsLeftArrowCircle":
		return BxsLeftArrowCircle()
	case "bxsLeftArrowSquare":
		return BxsLeftArrowSquare()
	case "bxsLeftDownArrowCircle":
		return BxsLeftDownArrowCircle()
	case "bxsLeftTopArrowCircle":
		return BxsLeftTopArrowCircle()
	case "bxsLemon":
		return BxsLemon()
	case "bxsLike":
		return BxsLike()
	case "bxsLocationPlus":
		return BxsLocationPlus()
	case "bxsLock":
		return BxsLock()
	case "bxsLockAlt":
		return BxsLockAlt()
	case "bxsLockOpen":
		return BxsLockOpen()
	case "bxsLockOpenAlt":
		return BxsLockOpenAlt()
	case "bxsLogIn":
		return BxsLogIn()
	case "bxsLogInCircle":
		return BxsLogInCircle()
	case "bxsLogOut":
		return BxsLogOut()
	case "bxsLogOutCircle":
		return BxsLogOutCircle()
	case "bxsLowVision":
		return BxsLowVision()
	case "bxsMagicWand":
		return BxsMagicWand()
	...
	case "bxsMehBlank":
		return BxsMehBlank()
	case "bxsMemoryCard":
		return BxsMemoryCard()
	case "bxsMessage":
		return BxsMessage()
	case "bxsMessageAdd":
		return BxsMessageAdd()
	case "bxsMessageAlt":
		return BxsMessageAlt()
	case "bxsMessageAltAdd":
		return BxsMessageAltAdd()
	case "bxsMessageAltCheck":
		return BxsMessageAltCheck()
	case "bxsMessageAltDetail":
		return BxsMessageAltDetail()
	case "bxsMessageAltDots":
		return BxsMessageAltDots()
	case "bxsMessageAltEdit":
		return BxsMessageAltEdit()
	case "bxsMessageAltError":
		return BxsMessageAltError()
	case "bxsMessageAltMinus":
		return BxsMessageAltMinus()
	case "bxsMessageAltX":
		return BxsMessageAltX()
	case "bxsMessageCheck":
		return BxsMessageCheck()
	case "bxsMessageDetail":
		return BxsMessageDetail()
	case "bxsMessageDots":
		return BxsMessageDots()
	case "bxsMessageEdit":
		return BxsMessageEdit()
	case "bxsMessageError":
		return BxsMessageError()
	case "bxsMessageMinus":
		return BxsMessageMinus()
	case "bxsMessageRounded":
		return BxsMessageRounded()
	case "bxsMessageRoundedAdd":
		return BxsMessageRoundedAdd()
	case "bxsMessageRoundedCheck":
		return BxsMessageRoundedCheck()
	case "bxsMessageRoundedDetail":
		return BxsMessageRoundedDetail()
	case "bxsMessageRoundedDots":
		return BxsMessageRoundedDots()
	case "bxsMessageRoundedEdit":
		return BxsMessageRoundedEdit()
	case "bxsMessageRoundedError":
		return BxsMessageRoundedError()
	case "bxsMessageRoundedMinus":
		return BxsMessageRoundedMinus()
	case "bxsMessageRoundedX":
		return BxsMessageRoundedX()
	case "bxsMessageSquare":
		return BxsMessageSquare()
	case "bxsMessageSquareAdd":
		return BxsMessageSquareAdd()
	case "bxsMessageSquareCheck":
		return BxsMessageSquareCheck()
	case "bxsMessageSquareDetail":
		return BxsMessageSquareDetail()
	case "bxsMessageSquareDots":
		return BxsMessageSquareDots()
	case "bxsMessageSquareEdit":
		return BxsMessageSquareEdit()
	case "bxsMessageSquareError":
		return BxsMessageSquareError()
	case "bxsMessageSquareMinus":
		return BxsMessageSquareMinus()
	case "bxsMessageSquareX":
		return BxsMessageSquareX()
	case "bxsMessageX":
		return BxsMessageX()
	case "bxsMeteor":
		return BxsMeteor()
	case "bxsMicrochip":
		return BxsMicrochip()
	case "bxsMicrophone":
		return BxsMicrophone()
	case "bxsMicrophoneAlt":
		return BxsMicrophoneAlt()
	case "bxsMicrophoneOff":
		return BxsMicrophoneOff()
	case "bxsMinusCircle":
		return BxsMinusCircle()
	case "bxsMinusSquare":
		return BxsMinusSquare()
	case "bxsMobile":
		return BxsMobile()
	case "bxsMobileVibration":
		return BxsMobileVibration()
	case "bxsMoon":
		return BxsMoon()
	case "bxsMouse":
		return BxsMouse()
	...
	case "bxsMusic":
		return BxsMusic()
	case "bxsNavigation":
		return BxsNavigation()
	case "bxsNetworkChart":
		return BxsNetworkChart()
	case "bxsNews":
		return BxsNews()
	case "bxsNoEntry":
		return BxsNoEntry()
	...
	case "bxsNotepad":
		return BxsNotepad()
	case "bxsNotification":
		return BxsNotification()
	case "bxsNotificationOff":
		return BxsNotificationOff()
	case "bxsOffer":
		return BxsOffer()
	case "bxsPackage":
		return BxsPackage()
	...
	case "bxsPhoneCall":
		return BxsPhoneCall()
	case "bxsPhoneIncoming":
		return BxsPhoneIncoming()
	case "bxsPhoneOff":
		return BxsPhoneOff()
	case "bxsPhoneOutgoing":
		return BxsPhoneOutgoing()
	case "bxsPhotoAlbum":
		return BxsPhotoAlbum()
	case "bxsPiano":
		return BxsPiano()
	case "bxsPieChart":
		return BxsPieChart()
	case "bxsPieChartAlt":
		return BxsPieChartAlt()
	case "bxsPieChartAltTwo":
		return BxsPieChartAltTwo()
	case "bxsPin":
		return BxsPin()
	case "bxsPizza":
		return BxsPizza()
	...
	case "bxsPlaneLand":
		return BxsPlaneLand()
	case "bxsPlaneTakeOff":
		return BxsPlaneTakeOff()
	case "bxsPlanet":
		return BxsPlanet()
	case "bxsPlaylist":
		return BxsPlaylist()
	case "bxsPlug":
		return BxsPlug()
	case "bxsPlusCircle":
		return BxsPlusCircle()
	case "bxsPlusSquare":
		return BxsPlusSquare()
	case "bxsPointer":
		return BxsPointer()
	case "bxsPolygon":
		return BxsPolygon()
	...
	case "bxsPrinter":
		return BxsPrinter()
	case "bxsPurchaseTag":
		return BxsPurchaseTag()
	case "bxsPurchaseTagAlt":
		return BxsPurchaseTagAlt()
	case "bxsPyramid":
		return BxsPyramid()
	case "bxsQuoteAltLeft":
		return BxsQuoteAltLeft()
	case "bxsQuoteAltRight":
		return BxsQuoteAltRight()
	case "bxsQuoteLeft":
		return BxsQuoteLeft()
	case "bxsQuoteRight":
		return BxsQuoteRight()
	case "bxsQuoteSingleLeft":
		return BxsQuoteSingleLeft()
	case "bxsQuoteSingleRight":
		return BxsQuoteSingleRight()
	case "bxsRadiation":
		return BxsRadiation()
	case "bxsRadio":
		return BxsRadio()
	...
	case "bxsRectangle":
		return BxsRectangle()
	case "bxsRegistered":
		return BxsRegistered()
	case "bxsRename":
		return BxsRename()
	case "bxsReport":
		return BxsReport()
	case "bxsRewindCircle":
		return BxsRewindCircle()
	case "bxsRightArrow":
		return BxsRightArrow()
	case "bxsRightArrowAlt":
		return BxsRightArrowAlt()
	case "bxsRightArrowCircle":
		return BxsRightArrowCircle()
	case "bxsRightArrowSquare":
		return BxsRightArrowSquare()
	case "bxsRightDownArrowCircle":
		return BxsRightDownArrowCircle()
	case "bxsRightTopArrowCircle":
		return BxsRightTopArrowCircle()
	case "bxsRocket":
		return BxsRocket()
	case "bxsRuler":
		return BxsRuler()
	...
	case "bxsSearch":
		return BxsSearch()
	case "bxsSearchAltTwo":
		return BxsSearchAltTwo()
	case "bxsSelectMultiple":
		return BxsSelectMultiple()
	case "bxsSend":
		return BxsSend()
	case "bxsServer":
		return BxsServer()
	...
	case "bxsShield":
		return BxsShield()
	case "bxsShieldAltTwo":
		return BxsShieldAltTwo()
	case "bxsShieldX":
		return BxsShieldX()
	case "bxsShip":
		return BxsShip()
	case "bxsShocked":
		return BxsShocked()
	case "bxsShoppingBag":
		return BxsShoppingBag()
	case "bxsShoppingBagAlt":
		return BxsShoppingBagAlt()
	case "bxsShoppingBags":
		return BxsShoppingBags()
	case "bxsShow":
		return BxsShow()
	case "bxsSkipNextCircle":
		return BxsSkipNextCircle()
	case "bxsSkipPreviousCircle":
		return BxsSkipPreviousCircle()
	case "bxsSkull":
		return BxsSkull()
	case "bxsSleepy":
		return BxsSleepy()
	...
	case "bxsSprayCan":
		return BxsSprayCan()
	case "bxsSpreadsheet":
		return BxsSpreadsheet()
	case "bxsSquare":
		return BxsSquare()
	case "bxsSquareRounded":
		return BxsSquareRounded()
	case "bxsStar":
		return BxsStar()
	case "bxsStarHalf":
		return BxsStarHalf()
	...
	case "bxsTaxi":
		return BxsTaxi()
	case "bxsTennisBall":
		return BxsTennisBall()
	case "bxsTerminal":
		return BxsTerminal()
	case "bxsThermometer":
		return BxsThermometer()
	case "bxsTime":
		return BxsTime()
	case "bxsTimeFive":
		return BxsTimeFive()
	...
	case "bxsToTop":
		return BxsToTop()
	case "bxsToggleLeft":
		return BxsToggleLeft()
	case "bxsToggleRight":
		return BxsToggleRight()
	case "bxsTone":
		return BxsTone()
	case "bxsTorch":
		return BxsTorch()
	case "bxsTraffic":
		return BxsTraffic()
	case "bxsTrafficBarrier":
		return BxsTrafficBarrier()
	case "bxsTrafficCone":
		return BxsTrafficCone()
	case "bxsTrain":
		return BxsTrain()
	case "bxsTrash":
		return BxsTrash()
	...
	case "bxsUpArrow":
		return BxsUpArrow()
	case "bxsUpArrowAlt":
		return BxsUpArrowAlt()
	case "bxsUpArrowCircle":
		return BxsUpArrowCircle()
	case "bxsUpArrowSquare":
		return BxsUpArrowSquare()
	case "bxsUpsideDown":
		return BxsUpsideDown()
	case "bxsUpvote":
		return BxsUpvote()
	case "bxsUser":
		return BxsUser()
	case "bxsUserAccount":
		return BxsUserAccount()
	case "bxsUserBadge":
		return BxsUserBadge()
	case "bxsUserCheck":
		return BxsUserCheck()
	case "bxsUserCircle":
		return BxsUserCircle()
	case "bxsUserDetail":
		return BxsUserDetail()
	case "bxsUserMinus":
		return BxsUserMinus()
	case "bxsUserPin":
		return BxsUserPin()
	case "bxsUserPlus":
		return BxsUserPlus()
	case "bxsUserRectangle":
		return BxsUserRectangle()
	case "bxsUserVoice":
		return BxsUserVoice()
	case "bxsUserX":
		return BxsUserX()
	...
	case "bxsVideoPlus":
		return BxsVideoPlus()
	case "bxsVideoRecording":
		return BxsVideoRecording()
	case "bxsVideos":
		return BxsVideos()
	case "bxsVirus":
		return BxsVirus()
	case "bxsVirusBlock":
		return BxsVirusBlock()
	case "bxsVolume":
		return BxsVolume()
	case "bxsVolumeFull":
		return BxsVolumeFull()
	case "bxsVolumeLow":
		return BxsVolumeLow()
	case "bxsVolumeMute":
		return BxsVolumeMute()
	case "bxsWallet":
		return BxsWallet()
	case "bxsWalletAlt":
		return BxsWalletAlt()
	...
	case "caretLeftCircle":
		return CaretLeftCircle()
	case "caretLeftSquare":
		return CaretLeftSquare()
	case "caretRight":
		return CaretRight()
	case "caretRightCircle":
		return CaretRightCircle()
	case "caretRightSquare":
		return CaretRightSquare()
	case "caretUp":
		return CaretUp()
	case "caretUpCircle":
	...
	case "circleThreeQuarter":
		return CircleThreeQuarter()
	case "clinic":
		return Clinic()
	case "clipboard":
		return Clipboard()
	...
	case "collapseHorizontal":
		return CollapseHorizontal()
	case "collapseVertical":
		return CollapseVertical()
	case "collection":
		return Collection()
	case "color":
		return Color()
	...
	case "dotsHorizontalRounded":
		return DotsHorizontalRounded()
	case "dotsVertical":
		return DotsVertical()
	case "dotsVerticalRounded":
		return DotsVerticalRounded()
	case "doughnutChart":
	...
	case "leftDownArrowCircle":
		return LeftDownArrowCircle()
	case "leftIndent":
		return LeftIndent()
	case "leftTopArrowCircle":
		return LeftTopArrowCircle()
	case "lemon":
		return Lemon()
	case "library":
		return Library()
	...
	case "messageAlt":
		return MessageAlt()
	case "messageAltAdd":
		return MessageAltAdd()
	case "messageAltCheck":
		return MessageAltCheck()
	case "messageAltDetail":
		return MessageAltDetail()
	case "messageAltDots":
		return MessageAltDots()
	case "messageAltEdit":
		return MessageAltEdit()
	case "messageAltError":
		return MessageAltError()
	case "messageAltMinus":
		return MessageAltMinus()
	case "messageAltX":
		return MessageAltX()
	case "messageCheck":
		return MessageCheck()
	...
	case "messageRoundedAdd":
		return MessageRoundedAdd()
	case "messageRoundedCheck":
		return MessageRoundedCheck()
	case "messageRoundedDetail":
		return MessageRoundedDetail()
	case "messageRoundedDots":
		return MessageRoundedDots()
	case "messageRoundedEdit":
		return MessageRoundedEdit()
	case "messageRoundedError":
		return MessageRoundedError()
	case "messageRoundedMinus":
		return MessageRoundedMinus()
	case "messageRoundedX":
		return MessageRoundedX()
	case "messageSquare":
		return MessageSquare()
	case "messageSquareAdd":
		return MessageSquareAdd()
	case "messageSquareCheck":
		return MessageSquareCheck()
	case "messageSquareDetail":
		return MessageSquareDetail()
	case "messageSquareDots":
		return MessageSquareDots()
	case "messageSquareEdit":
		return MessageSquareEdit()
	case "messageSquareError":
		return MessageSquareError()
	case "messageSquareMinus":
		return MessageSquareMinus()
	case "messageSquareX":
	...
	case "objectsHorizontalCenter":
		return ObjectsHorizontalCenter()
	case "objectsHorizontalLeft":
		return ObjectsHorizontalLeft()
	case "objectsHorizontalRight":
		return ObjectsHorizontalRight()
	case "objectsVerticalBottom":
		return ObjectsVerticalBottom()
	case "objectsVerticalCenter":
		return ObjectsVerticalCenter()
	case "objectsVerticalTop":
		return ObjectsVerticalTop()
	case "outline":
		return Outline()
	case "package":
		return Package()
	...
	case "radioCircle":
		return RadioCircle()
	case "radioCircleMarked":
		return RadioCircleMarked()
	case "receipt":
		return Receipt()
	case "rectangle":
		return Rectangle()
	...
	case "rightDownArrowCircle":
		return RightDownArrowCircle()
	case "rightIndent":
		return RightIndent()
	case "rightTopArrowCircle":
		return RightTopArrowCircle()
	case "rocket":
		return Rocket()
	case "rotateLeft":
		return RotateLeft()
	...
	case "subdirectoryLeft":
		return SubdirectoryLeft()
	case "subdirectoryRight":
		return SubdirectoryRight()
	case "sun":
		return Sun()
	case "support":
		return Support()
