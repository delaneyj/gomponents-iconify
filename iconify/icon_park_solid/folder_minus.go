...
func FolderMinus(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Raw(`<mask id="ipSFolderMinus0"><g fill="none" stroke-linejoin="round" stroke-width="4"><path fill="#fff" stroke="#fff" d="M5 9a2 2 0 0 1 2-2h12l5 6h17a2 2 0 0 1 2 2v26a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V9Z"/><path stroke="#000" stroke-linecap="round" d="M17.95 28h12"/></g></mask><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipSFolderMinus0)"/>`),
		g.Group(children),
	)
}