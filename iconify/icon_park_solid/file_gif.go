...
func FileGif(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Raw(`<mask id="ipSFileGif0"><g fill="none" stroke-linejoin="round" stroke-width="4"><path fill="#fff" stroke="#fff" d="M10 4h20l10 10v28a2 2 0 0 1-2 2H10a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z"/><path stroke="#000" stroke-linecap="round" d="M31.008 18H17v16h14.008v-6.992H26"/></g></mask><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipSFileGif0)"/>`),
		g.Group(children),
	)
}