...
func Gps(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Raw(`<mask id="ipSGps0"><g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="4"><path fill="#fff" fill-rule="evenodd" stroke="#fff" d="M24 44c11.046 0 20-8.954 20-20S35.046 4 24 4S4 12.954 4 24s8.954 20 20 20Z" clip-rule="evenodd"/><path fill="#000" stroke="#000" d="m24 13l-7 21l7-5l7 5l-7-21Z"/></g></mask><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipSGps0)"/>`),
		g.Group(children),
	)
}