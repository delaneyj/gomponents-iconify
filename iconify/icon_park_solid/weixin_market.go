...
func WeixinMarket(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Raw(`<mask id="ipSWeixinMarket0"><g fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="4"><path fill="#fff" d="M38 14H10a2 2 0 0 0-2 2v26a2 2 0 0 0 2 2h28a2 2 0 0 0 2-2V16a2 2 0 0 0-2-2Z"/><path d="M17 18v-7a7 7 0 1 1 14 0v7"/></g></mask><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipSWeixinMarket0)"/>`),
		g.Group(children),
	)
}