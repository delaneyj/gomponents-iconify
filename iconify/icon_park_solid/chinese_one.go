...
func ChineseOne(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Raw(`<mask id="ipSChineseOne0"><g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="4"><rect width="36" height="36" x="6" y="6" fill="#fff" stroke="#fff" rx="3"/><path stroke="#000" d="M21 19.939c-.4-1.164-1.597-3.202-3.992-2.91c-2.396.29-4.193 3.492-3.993 7.567c.2 4.075 2.396 6.404 4.392 6.404C19.802 31 21 28.206 21 28.206M26 31V19m0 12v-6.5a4.5 4.5 0 0 1 4.5-4.5v0a4.5 4.5 0 0 1 4.5 4.5V31"/></g></mask><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipSChineseOne0)"/>`),
		g.Group(children),
	)
}