...
func ClothesBriefs(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Raw(`<mask id="ipSClothesBriefs0"><path fill="#fff" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M22.158 37s-.9-8.075-4.158-12c-3.044-3.669-12-6-12-6v-5h36v5s-8.956 2.331-12 6c-3.257 3.925-4.158 12-4.158 12h-3.684Z"/></mask><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipSClothesBriefs0)"/>`),
		g.Group(children),
	)
}