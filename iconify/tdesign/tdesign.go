...
func IconFromName(name string) g.Node {
	...
	case "application":
		return Application()
	case "architectureHuiStyle":
		return ArchitectureHuiStyle()
	case "archway":
		return Archway()
	case "archwayOne":
		return ArchwayOne()
	...
	case "arrowDownRectangle":
		return ArrowDownRectangle()
	case "arrowLeft":
		return ArrowLeft()
	...
	case "arrowLeftDownCircle":
		return ArrowLeftDownCircle()
	case "arrowLeftRightCircle":
		return ArrowLeftRightCircle()
	case "arrowLeftRightOne":
		return ArrowLeftRightOne()
	case "arrowLeftRightThree":
		return ArrowLeftRightThree()
	case "arrowLeftRightTwo":
		return ArrowLeftRightTwo()
	case "arrowLeftUp":
		return ArrowLeftUp()
	case "arrowLeftUpCircle":
		return ArrowLeftUpCircle()
	case "arrowRight":
		return ArrowRight()
	...
	case "arrowRightDownCircle":
		return ArrowRightDownCircle()
	case "arrowRightUp":
		return ArrowRightUp()
	case "arrowRightUpCircle":
		return ArrowRightUpCircle()
	case "arrowTriangleDown":
		return ArrowTriangleDown()
	case "arrowTriangleDownFilled":
		return ArrowTriangleDownFilled()
	case "arrowTriangleUp":
		return ArrowTriangleUp()
	case "arrowTriangleUpFilled":
		return ArrowTriangleUpFilled()
	case "arrowUp":
		return ArrowUp()
	case "arrowUpCircle":
		return ArrowUpCircle()
	case "arrowUpDownCircle":
		return ArrowUpDownCircle()
	case "arrowUpDownOne":
		return ArrowUpDownOne()
	case "arrowUpDownThree":
		return ArrowUpDownThree()
	case "arrowUpDownTwo":
		return ArrowUpDownTwo()
	case "artboard":
		return Artboard()
	case "article":
		return Article()
	...
	case "backtop":
		return Backtop()
	case "backtopRectangle":
		return BacktopRectangle()
	case "backup":
		return Backup()
	case "backward":
		return Backward()
	...
	case "bookmarkChecked":
		return BookmarkChecked()
	case "bookmarkDouble":
		return BookmarkDouble()
	case "bookmarkMinus":
	...
	case "caretDown":
		return CaretDown()
	case "caretDownSmall":
		return CaretDownSmall()
	case "caretLeft":
		return CaretLeft()
	case "caretLeftSmall":
		return CaretLeftSmall()
	case "caretRight":
		return CaretRight()
	case "caretRightSmall":
		return CaretRightSmall()
	case "caretUp":
		return CaretUp()
	case "caretUpSmall":
		return CaretUpSmall()
	...
	case "chartLineDataOne":
		return ChartLineDataOne()
	case "chartLineMulti":
		return ChartLineMulti()
	case "chartMaximum":
		return ChartMaximum()
	case "chartMedian":
		return ChartMedian()
	...
	case "chatBubble":
		return ChatBubble()
	case "chatBubbleAdd":
		return ChatBubbleAdd()
	case "chatBubbleError":
		return ChatBubbleError()
	case "chatBubbleHelp":
		return ChatBubbleHelp()
	case "chatBubbleHistory":
		return ChatBubbleHistory()
	case "chatBubbleLocked":
		return ChatBubbleLocked()
	case "chatBubbleOne":
		return ChatBubbleOne()
	case "chatBubbleSmile":
		return ChatBubbleSmile()
	case "chatChecked":
		return ChatChecked()
	case "chatClear":
		return ChatClear()
	...
	case "checkRectangleFilled":
		return CheckRectangleFilled()
	case "cheese":
		return Cheese()
	case "cherry":
		return Cherry()
	...
	case "chevronDownDoubleS":
		return ChevronDownDoubleS()
	case "chevronDownRectangle":
		return ChevronDownRectangle()
	case "chevronDownS":
		return ChevronDownS()
	case "chevronLeft":
		return ChevronLeft()
	...
	case "chevronLeftDoubleS":
		return ChevronLeftDoubleS()
	case "chevronLeftRectangle":
		return ChevronLeftRectangle()
	case "chevronLeftS":
		return ChevronLeftS()
	case "chevronRight":
		return ChevronRight()
	...
	case "chevronRightDoubleS":
		return ChevronRightDoubleS()
	case "chevronRightRectangle":
		return ChevronRightRectangle()
	case "chevronRightS":
		return ChevronRightS()
	case "chevronUp":
		return ChevronUp()
	...
	case "chevronUpDoubleS":
		return ChevronUpDoubleS()
	case "chevronUpRectangle":
		return ChevronUpRectangle()
	case "chevronUpS":
		return ChevronUpS()
	case "chicken":
		return Chicken()
	...
	case "cityAncient":
		return CityAncient()
	case "cityAncientOne":
		return CityAncientOne()
	case "cityAncientTwo":
		return CityAncientTwo()
	case "cityEight":
		return CityEight()
	case "cityEleven":
		return CityEleven()
	...
	case "clearFormattingOne":
		return ClearFormattingOne()
	case "close":
		return Close()
	case "closeCircle":
		return CloseCircle()
	...
	case "compassOne":
		return CompassOne()
	case "componentBreadcrumb":
		return ComponentBreadcrumb()
	case "componentCheckbox":
		return ComponentCheckbox()
	case "componentDividerHorizontal":
		return ComponentDividerHorizontal()
	case "componentDividerVertical":
		return ComponentDividerVertical()
	case "componentDropdown":
	...
	case "fingerprintThree":
		return FingerprintThree()
	case "fingerprintTwo":
	...
	case "flipSmilingFace":
		return FlipSmilingFace()
	case "flipToBack":
		return FlipToBack()
	case "flipToFront":
		return FlipToFront()
	...
	case "form":
		return Form()
	case "formatHorizontalAlignBottom":
		return FormatHorizontalAlignBottom()
	case "formatHorizontalAlignCenter":
		return FormatHorizontalAlignCenter()
	case "formatHorizontalAlignTop":
		return FormatHorizontalAlignTop()
	case "formatVerticalAlignCenter":
		return FormatVerticalAlignCenter()
	case "formatVerticalAlignLeft":
		return FormatVerticalAlignLeft()
	case "formatVerticalAlignRight":
		return FormatVerticalAlignRight()
	case "forward":
		return Forward()
	case "frame":
		return Frame()
	...
	case "fullscreenExitOne":
		return FullscreenExitOne()
	case "fullscreenOne":
		return FullscreenOne()
	case "fullscreenTwo":
		return FullscreenTwo()
	case "functionCurve":
	...
	case "genderMale":
		return GenderMale()
	case "gestureApplause":
		return GestureApplause()
	case "gestureClick":
		return GestureClick()
	case "gestureDown":
		return GestureDown()
	case "gestureExpansion":
		return GestureExpansion()
	case "gestureLeft":
		return GestureLeft()
	case "gestureLeftSlip":
		return GestureLeftSlip()
	case "gesturePray":
		return GesturePray()
	case "gesturePrayOne":
		return GesturePrayOne()
	case "gesturePress":
		return GesturePress()
	case "gestureRanslation":
		return GestureRanslation()
	case "gestureRanslationOne":
		return GestureRanslationOne()
	case "gestureRight":
		return GestureRight()
	case "gestureRightSlip":
		return GestureRightSlip()
	case "gestureSlideUp":
		return GestureSlideUp()
	case "gestureUp":
		return GestureUp()
	case "gestureUpAndDown":
		return GestureUpAndDown()
	case "gestureUpOne":
		return GestureUpOne()
	case "gestureUpTwo":
		return GestureUpTwo()
	case "gestureWipeDown":
		return GestureWipeDown()
	case "gift":
		return Gift()
	case "giggle":
		return Giggle()
	...
	case "gitRepositoryCommits":
		return GitRepositoryCommits()
	case "gitRepositoryPrivate":
		return GitRepositoryPrivate()
	case "gps":
		return Gps()
	case "grape":
		return Grape()
	...
	case "institution":
		return Institution()
	case "institutionChecked":
		return InstitutionChecked()
	case "internet":
		return Internet()
	case "ipod":
		return Ipod()
	...
	case "lightbulbCircle":
		return LightbulbCircle()
	case "lighthouse":
		return Lighthouse()
	case "lighthouseOne":
		return LighthouseOne()
	case "lighthouseTwo":
		return LighthouseTwo()
	case "lightingCircle":
		return LightingCircle()
	case "lineHeight":
		return LineHeight()
	case "link":
		return Link()
	...
	case "location":
		return Location()
	case "locationEnlargement":
		return LocationEnlargement()
	case "locationError":
		return LocationError()
	case "locationOne":
		return LocationOne()
	case "locationParkingPlace":
		return LocationParkingPlace()
	case "locationReduction":
		return LocationReduction()
	...
	case "login":
		return Login()
	case "logoAdobeIllustrate":
		return LogoAdobeIllustrate()
	case "logoAdobePhotoshop":
		return LogoAdobePhotoshop()
	case "logoAdobePhotoshopOne":
		return LogoAdobePhotoshopOne()
	case "logoAndroid":
		return LogoAndroid()
	case "logoApple":
		return LogoApple()
	case "logoAppleFilled":
		return LogoAppleFilled()
	case "logoBehance":
		return LogoBehance()
	case "logoChrome":
		return LogoChrome()
	case "logoChromeFilled":
		return LogoChromeFilled()
	case "logoCinemaFourD":
		return LogoCinemaFourD()
	case "logoCodepen":
		return LogoCodepen()
	case "logoCodesandbox":
		return LogoCodesandbox()
	case "logoDribbble":
		return LogoDribbble()
	case "logoFacebook":
		return LogoFacebook()
	...
	case "logoGithub":
		return LogoGithub()
	case "logoGithubFilled":
		return LogoGithubFilled()
	case "logoGitlab":
		return LogoGitlab()
	case "logoIe":
		return LogoIe()
	...
	case "logoWechat":
		return LogoWechat()
	case "logoWechatStroke":
		return LogoWechatStroke()
	case "logoWecom":
		return LogoWecom()
	case "logoWindows":
		return LogoWindows()
	case "logoWindowsFilled":
		return LogoWindowsFilled()
	case "logoYoutube":
		return LogoYoutube()
	case "logout":
		return Logout()
	...
	case "mapInformationOne":
		return MapInformationOne()
	case "mapInformationTwo":
		return MapInformationTwo()
	case "mapLocation":
		return MapLocation()
	case "mapLocked":
		return MapLocked()
	...
	case "mapOutline":
		return MapOutline()
	case "mapRoutePlanning":
		return MapRoutePlanning()
	case "mapRuler":
		return MapRuler()
	case "mapSafety":
		return MapSafety()
	...
	case "minusRectangleFilled":
		return MinusRectangleFilled()
	case "mirror":
		return Mirror()
	case "mobile":
		return Mobile()
	...
	case "musicOne":
		return MusicOne()
	case "musicRectangleAdd":
		return MusicRectangleAdd()
	case "musicTwo":
		return MusicTwo()
	...
	case "numbersEight":
		return NumbersEight()
	case "numbersEightOne":
		return NumbersEightOne()
	case "numbersFive":
		return NumbersFive()
	case "numbersFiveOne":
		return NumbersFiveOne()
	case "numbersFour":
		return NumbersFour()
	case "numbersFourOne":
		return NumbersFourOne()
	case "numbersNine":
		return NumbersNine()
	case "numbersNineOne":
		return NumbersNineOne()
	case "numbersOne":
		return NumbersOne()
	case "numbersOneOne":
		return NumbersOneOne()
	case "numbersSeven":
		return NumbersSeven()
	case "numbersSevenOne":
		return NumbersSevenOne()
	case "numbersSix":
		return NumbersSix()
	case "numbersSixOne":
		return NumbersSixOne()
	case "numbersThree":
		return NumbersThree()
	case "numbersThreeOne":
		return NumbersThreeOne()
	case "numbersTwo":
		return NumbersTwo()
	case "numbersTwoOne":
		return NumbersTwoOne()
	case "numbersZero":
		return NumbersZero()
	case "numbersZeroOne":
		return NumbersZeroOne()
	case "nut":
		return Nut()
	case "objectStorage":
	...
	case "opera":
		return Opera()
	case "orderAdjustmentColumn":
		return OrderAdjustmentColumn()
	case "orderAscending":
	...
	case "pauseCircleStroke":
		return PauseCircleStroke()
	case "pea":
		return Pea()
	case "peach":
		return Peach()
	case "pear":
		return Pear()
	case "pearlOfTheOrient":
		return PearlOfTheOrient()
	case "pen":
		return Pen()
	case "penBall":
		return PenBall()
	...
	case "playCircleStroke":
		return PlayCircleStroke()
	case "playCircleStrokeAdd":
		return PlayCircleStrokeAdd()
	case "playDemo":
		return PlayDemo()
	case "playRectangle":
		return PlayRectangle()
	case "plus":
		return Plus()
	case "popsicle":
		return Popsicle()
	...
	case "space":
		return Space()
	case "speechlessOne":
		return SpeechlessOne()
	case "star":
		return Star()
	case "starFilled":
		return StarFilled()
	case "statueOfJesus":
		return StatueOfJesus()
	case "stickyNote":
		return StickyNote()
	case "stop":
		return Stop()
	...
	case "stopCircleFilled":
		return StopCircleFilled()
	case "stopCircleStroke":
		return StopCircleStroke()
	case "store":
		return Store()
	case "streetRoad":
		return StreetRoad()
	case "streetRoadOne":
		return StreetRoadOne()
	case "subtitle":
		return Subtitle()
	case "subwayLine":
		return SubwayLine()
	...
	case "terminal":
		return Terminal()
	case "terminalRectangle":
		return TerminalRectangle()
	case "terminalRectangleOne":
		return TerminalRectangleOne()
	case "terminalWindow":
	...
	case "thunderstormSunny":
		return ThunderstormSunny()
	case "ticket":
		return Ticket()
	case "time":
		return Time()
	...
	case "treeRoundDot":
		return TreeRoundDot()
	case "treeRoundDotVertical":
		return TreeRoundDotVertical()
	case "treeSquareDot":
		return TreeSquareDot()
	case "treeSquareDotVertical":
		return TreeSquareDotVertical()
	case "trendingDown":
		return TrendingDown()
	case "trendingUp":
		return TrendingUp()
	...
	case "uncomfortableOne":
		return UncomfortableOne()
	case "uncomfortableTwo":
		return UncomfortableTwo()
	case "undertake":
		return Undertake()
	case "undertakeDelivery":
		return UndertakeDelivery()
	case "undertakeEnvironmentProtection":
		return UndertakeEnvironmentProtection()
	case "undertakeHoldUp":
		return UndertakeHoldUp()
	case "undertakeTransaction":
		return UndertakeTransaction()
	case "unfoldLess":
		return UnfoldLess()
	case "unfoldMore":
		return UnfoldMore()
	...
	case "userAdd":
		return UserAdd()
	case "userArrowDown":
		return UserArrowDown()
	case "userArrowLeft":
		return UserArrowLeft()
	case "userArrowRight":
	...
	case "videoCamera":
		return VideoCamera()
	case "videoCameraDollar":
		return VideoCameraDollar()
	case "videoCameraMinus":
		return VideoCameraMinus()
	case "videoCameraMusic":
		return VideoCameraMusic()
	case "videoCameraOff":
		return VideoCameraOff()
	case "videoCameraOne":
		return VideoCameraOne()
	case "videoCameraTwo":
		return VideoCameraTwo()
	case "videoLibrary":
		return VideoLibrary()
	case "viewAgenda":
		return ViewAgenda()
