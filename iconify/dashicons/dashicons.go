...
func IconFromName(name string) g.Node {
	...
	case "adminSiteAlt":
		return AdminSiteAlt()
	case "adminSiteAltThree":
		return AdminSiteAltThree()
	case "adminSiteAltTwo":
		return AdminSiteAltTwo()
	case "adminTools":
		return AdminTools()
	case "adminUsers":
		return AdminUsers()
	...
	case "alignCenter":
		return AlignCenter()
	case "alignFullWidth":
		return AlignFullWidth()
	case "alignLeft":
		return AlignLeft()
	case "alignNone":
		return AlignNone()
	case "alignPullLeft":
		return AlignPullLeft()
	case "alignPullRight":
		return AlignPullRight()
	case "alignRight":
		return AlignRight()
	case "alignWide":
		return AlignWide()
	...
	case "arrowDownAlt":
		return ArrowDownAlt()
	case "arrowDownAltTwo":
		return ArrowDownAltTwo()
	case "arrowLeft":
		return ArrowLeft()
	case "arrowLeftAlt":
		return ArrowLeftAlt()
	case "arrowLeftAltTwo":
		return ArrowLeftAltTwo()
	case "arrowRight":
		return ArrowRight()
	case "arrowRightAlt":
		return ArrowRightAlt()
	case "arrowRightAltTwo":
		return ArrowRightAltTwo()
	case "arrowUp":
		return ArrowUp()
	case "arrowUpAlt":
		return ArrowUpAlt()
	case "arrowUpAltTwo":
		return ArrowUpAltTwo()
	case "arrowUpDuplicate":
		return ArrowUpDuplicate()
	case "art":
		return Art()
	case "awards":
		return Awards()
	...
	case "bookAlt":
		return BookAlt()
	case "buddiconsActivity":
		return BuddiconsActivity()
	case "buddiconsBbpressLogo":
		return BuddiconsBbpressLogo()
	case "buddiconsBuddypressLogo":
		return BuddiconsBuddypressLogo()
	case "buddiconsCommunity":
		return BuddiconsCommunity()
	case "buddiconsForums":
		return BuddiconsForums()
	case "buddiconsFriends":
		return BuddiconsFriends()
	case "buddiconsGroups":
		return BuddiconsGroups()
	case "buddiconsPm":
		return BuddiconsPm()
	case "buddiconsReplies":
		return BuddiconsReplies()
	case "buddiconsTopics":
		return BuddiconsTopics()
	case "buddiconsTracking":
		return BuddiconsTracking()
	case "building":
		return Building()
	case "businessman":
		return Businessman()
	...
	case "controlsBack":
		return ControlsBack()
	case "controlsForward":
		return ControlsForward()
	case "controlsPause":
		return ControlsPause()
	case "controlsPlay":
		return ControlsPlay()
	case "controlsRepeat":
		return ControlsRepeat()
	case "controlsSkipback":
		return ControlsSkipback()
	case "controlsSkipforward":
		return ControlsSkipforward()
	case "controlsVolumeoff":
		return ControlsVolumeoff()
	case "controlsVolumeon":
		return ControlsVolumeon()
	case "coverImage":
		return CoverImage()
	case "dashboard":
		return Dashboard()
	...
	case "editPage":
		return EditPage()
	case "editorAligncenter":
		return EditorAligncenter()
	case "editorAlignleft":
		return EditorAlignleft()
	case "editorAlignright":
		return EditorAlignright()
	case "editorBold":
		return EditorBold()
	case "editorBreak":
		return EditorBreak()
	case "editorCode":
		return EditorCode()
	case "editorCodeDuplicate":
		return EditorCodeDuplicate()
	case "editorContract":
		return EditorContract()
	case "editorCustomchar":
		return EditorCustomchar()
	case "editorExpand":
		return EditorExpand()
	case "editorHelp":
		return EditorHelp()
	case "editorIndent":
		return EditorIndent()
	case "editorInsertmore":
		return EditorInsertmore()
	case "editorItalic":
		return EditorItalic()
	case "editorJustify":
		return EditorJustify()
	case "editorKitchensink":
		return EditorKitchensink()
	case "editorLtr":
		return EditorLtr()
	case "editorOl":
		return EditorOl()
	case "editorOlRtl":
		return EditorOlRtl()
	case "editorOutdent":
		return EditorOutdent()
	case "editorParagraph":
		return EditorParagraph()
	case "editorPasteText":
		return EditorPasteText()
	case "editorPasteWord":
		return EditorPasteWord()
	case "editorQuote":
		return EditorQuote()
	case "editorRemoveformatting":
		return EditorRemoveformatting()
	case "editorRtl":
		return EditorRtl()
	case "editorSpellcheck":
		return EditorSpellcheck()
	case "editorStrikethrough":
		return EditorStrikethrough()
	case "editorTable":
		return EditorTable()
	...
	case "forms":
		return Forms()
	case "fullscreenAlt":
		return FullscreenAlt()
	case "fullscreenExitAlt":
		return FullscreenExitAlt()
	case "games":
		return Games()
	case "google":
		return Google()
	...
	case "mediaInteractive":
		return MediaInteractive()
	case "mediaSpreadsheet":
		return MediaSpreadsheet()
	case "mediaText":
		return MediaText()
	case "mediaVideo":
		return MediaVideo()
	...
	case "tableColDelete":
		return TableColDelete()
	case "tableRowAfter":
		return TableRowAfter()
	case "tableRowBefore":
		return TableRowBefore()
	case "tableRowDelete":
	...
	case "universalAccessAlt":
		return UniversalAccessAlt()
	case "unlock":
		return Unlock()
	case "update":
		return Update()
	...
	case "warning":
		return Warning()
	case "welcomeAddPage":
		return WelcomeAddPage()
	case "welcomeComments":
		return WelcomeComments()
	case "welcomeLearnMore":
		return WelcomeLearnMore()
	case "welcomeViewSite":
		return WelcomeViewSite()
	case "welcomeWidgetsMenus":
		return WelcomeWidgetsMenus()
	case "welcomeWriteBlog":
		return WelcomeWriteBlog()
	case "whatsapp":
		return Whatsapp()
	case "wordpress":
		return Wordpress()
