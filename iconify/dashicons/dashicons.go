...
func AdminCustomizer(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M18.33 3.57s.27-.8-.31-1.36c-.53-.52-1.22-.24-1.22-.24c-.61.3-5.76 3.47-7.67 5.57c-.86.96-2.06 3.79-1.09 4.82c.92.98 3.96-.17 4.79-1c2.06-2.06 5.21-7.17 5.5-7.79zM1.4 17.65c2.37-1.56 1.46-3.41 3.23-4.64c.93-.65 2.22-.62 3.08.29c.63.67.8 2.57-.16 3.46c-1.57 1.45-4 1.55-6.15.89z"/>`),
		g.Group(children),
	)
}
...
func AlignCenter(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M3 5h14V3H3v2zm12 8V7H5v6h10zM3 17h14v-2H3v2z"/>`),
		g.Group(children),
	)
}
...
func AlignLeft(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M3 5h14V3H3v2zm9 8V7H3v6h9zm2-4h3V7h-3v2zm0 4h3v-2h-3v2zM3 17h14v-2H3v2z"/>`),
		g.Group(children),
	)
}
...
func AlignRight(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M3 5h14V3H3v2zm0 4h3V7H3v2zm14 4V7H8v6h9zM3 13h3v-2H3v2zm0 4h14v-2H3v2z"/>`),
		g.Group(children),
	)
}
...
func ArrowDown(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="m15 8l-4.03 6L7 8h8z"/>`),
		g.Group(children),
	)
}
...
func ArrowDownAltTwo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="m5 6l5 5l5-5l2 1l-7 7l-7-7z"/>`),
		g.Group(children),
	)
}
...
func ArrowLeft(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M13 14L7 9.97L13 6v8z"/>`),
		g.Group(children),
	)
}
...
func ArrowRight(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="m8 6l6 4.03L8 14V6z"/>`),
		g.Group(children),
	)
}
...
func ArrowUp(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="m11 7l-4 6h8z"/>`),
		g.Group(children),
	)
}
...
func Button(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M17 5H3c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm1 7c0 .6-.4 1-1 1H3c-.6 0-1-.4-1-1V7c0-.6.4-1 1-1h14c.6 0 1 .4 1 1v5z"/>`),
		g.Group(children),
	)
}
...
func Calendar(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M15 4h3v14H2V4h3V3c0-.83.67-1.5 1.5-1.5S8 2.17 8 3v1h4V3c0-.83.67-1.5 1.5-1.5S15 2.17 15 3v1zM6 3v2.5c0 .28.22.5.5.5s.5-.22.5-.5V3c0-.28-.22-.5-.5-.5S6 2.72 6 3zm7 0v2.5c0 .28.22.5.5.5s.5-.22.5-.5V3c0-.28-.22-.5-.5-.5s-.5.22-.5.5zm4 14V8H3v9h14zM7 16V9H5v7h2zm4 0V9H9v7h2zm4 0V9h-2v7h2z"/>`),
		g.Group(children),
	)
}
...
func Cart(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M6 13h9c.55 0 1 .45 1 1s-.45 1-1 1H5c-.55 0-1-.45-1-1V4H2c-.55 0-1-.45-1-1s.45-1 1-1h3c.55 0 1 .45 1 1v2h13l-4 7H6v1zm-.5 3c.83 0 1.5.67 1.5 1.5S6.33 19 5.5 19S4 18.33 4 17.5S4.67 16 5.5 16zm9 0c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5s-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5z"/>`),
		g.Group(children),
	)
}
...
func Desktop(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M3 2h14c.55 0 1 .45 1 1v10c0 .55-.45 1-1 1h-5v2h2c.55 0 1 .45 1 1v1H5v-1c0-.55.45-1 1-1h2v-2H3c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1zm13 9V4H4v7h12zM5 5h9L5 9V5z"/>`),
		g.Group(children),
	)
}
...
func EditorExpand(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M7 8h6v4H7zm-5 5v4h4l-1.2-1.2L7 12l-3.8 2.2M14 17h4v-4l-1.2 1.2L13 12l2.2 3.8M14 3l1.3 1.3L13 8l3.8-2.2L18 7V3M6 3H2v4l1.2-1.2L7 8L4.7 4.3"/>`),
		g.Group(children),
	)
}
...
func EditorKitchensink(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M19 2v6H1V2h18zm-1 5V3H2v4h16zM5 4v2H3V4h2zm3 0v2H6V4h2zm3 0v2H9V4h2zm3 0v2h-2V4h2zm3 0v2h-2V4h2zm2 5v9H1V9h18zm-1 8v-7H2v7h16zM5 11v2H3v-2h2zm3 0v2H6v-2h2zm3 0v2H9v-2h2zm6 0v2h-5v-2h5zm-6 3v2H3v-2h8zm3 0v2h-2v-2h2zm3 0v2h-2v-2h2z"/>`),
		g.Group(children),
	)
}
...
func EditorRtl(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M13 2H5.5C3 2 1 4 1 6.5S3 11 5.5 11H6v6c0 .5.5 1 1 1s1-.5 1-1V5c0-.5.5-1 1-1s1 .5 1 1v12c0 .5.5 1 1 1s1-.5 1-1V4h1c.5 0 1-.5 1-1s-.5-1-1-1zm1 8l5 4V6l-5 4z"/>`),
		g.Group(children),
	)
}
...
func Email(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M3.87 4h13.25C18.37 4 19 4.59 19 5.79v8.42c0 1.19-.63 1.79-1.88 1.79H3.87c-1.25 0-1.88-.6-1.88-1.79V5.79c0-1.2.63-1.79 1.88-1.79zm6.62 8.6l6.74-5.53c.24-.2.43-.66.13-1.07c-.29-.41-.82-.42-1.17-.17l-5.7 3.86L4.8 5.83c-.35-.25-.88-.24-1.17.17c-.3.41-.11.87.13 1.07z"/>`),
		g.Group(children),
	)
}
...
func EmbedAudio(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M17 4H3c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-7 3H7v4c0 1.1-.9 2-2 2s-2-.9-2-2s.9-2 2-2c.4 0 .7.1 1 .3V5h4v2zm4 3.5L12.5 12l1.5 1.5V15l-3-3l3-3v1.5zm1 4.5v-1.5l1.5-1.5l-1.5-1.5V9l3 3l-3 3z"/>`),
		g.Group(children),
	)
}
...
func FormatImage(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M2.25 1h15.5c.69 0 1.25.56 1.25 1.25v15.5c0 .69-.56 1.25-1.25 1.25H2.25C1.56 19 1 18.44 1 17.75V2.25C1 1.56 1.56 1 2.25 1zM17 17V3H3v14h14zM10 6c0-1.1-.9-2-2-2s-2 .9-2 2s.9 2 2 2s2-.9 2-2zm3 5s0-6 3-6v10c0 .55-.45 1-1 1H5c-.55 0-1-.45-1-1V8c2 0 3 4 3 4s1-3 3-3s3 2 3 2z"/>`),
		g.Group(children),
	)
}
...
func Google(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" fill-rule="evenodd" d="M17.6 8.5h-7.5v3h4.4c-.4 2.1-2.3 3.5-4.4 3.4c-2.6-.1-4.6-2.1-4.7-4.7c-.1-2.7 2-5 4.7-5.1c1.1 0 2.2.4 3.1 1.2l2.3-2.2C14.1 2.7 12.1 2 10.2 2c-4.4 0-8 3.6-8 8s3.6 8 8 8c4.6 0 7.7-3.2 7.7-7.8c-.1-.6-.1-1.1-.3-1.7z" clip-rule="evenodd"/>`),
		g.Group(children),
	)
}
...
func GridView(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M2 1h16c.55 0 1 .45 1 1v16c0 .55-.45 1-1 1H2c-.55 0-1-.45-1-1V2c0-.55.45-1 1-1zm7.01 7.99v-6H3v6h6.01zm8 0v-6h-6v6h6zm-8 8.01v-6H3v6h6.01zm8 0v-6h-6v6h6z"/>`),
		g.Group(children),
	)
}
...
func IndexCard(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M1 3.17V18h18V4H8v-.83c0-.32-.12-.6-.35-.83S7.14 2 6.82 2H2.18c-.33 0-.6.11-.83.34c-.24.23-.35.51-.35.83zM10 6v2H3V6h7zm7 0v10h-5V6h5zm-7 4v2H3v-2h7zm0 4v2H3v-2h7z"/>`),
		g.Group(children),
	)
}
...
func InsertBefore(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M11 8H9v2H7v2h2v2h2v-2h2v-2h-2V8zm-1-4c-3.9 0-7 3.1-7 7s3.1 7 7 7s7-3.1 7-7s-3.1-7-7-7zm0 12c-2.8 0-5-2.2-5-5s2.2-5 5-5s5 2.2 5 5s-2.2 5-5 5zM3 1v2h14V1H3z"/>`),
		g.Group(children),
	)
}
...
func Laptop(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M3 3h14c.6 0 1 .4 1 1v10c0 .6-.4 1-1 1H3c-.6 0-1-.4-1-1V4c0-.6.4-1 1-1zm13 2H4v8h12V5zm-3 1H5v4zm6 11v-1H1v1c0 .6.5 1 1.1 1h15.8c.6 0 1.1-.4 1.1-1z"/>`),
		g.Group(children),
	)
}
...
func Linkedin(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M2.5 18h3V6.9h-3V18zM4 2c-1 0-1.8.8-1.8 1.8S3 5.6 4 5.6s1.8-.8 1.8-1.8S5 2 4 2zm6.6 6.6V6.9h-3V18h3v-5.7c0-3.2 4.1-3.4 4.1 0V18h3v-6.8c0-5.4-5.7-5.2-7.1-2.6z"/>`),
		g.Group(children),
	)
}
...
func MediaDefault(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="m12 2l4 4v12H4V2h8zm0 4h3l-3-3v3z"/>`),
		g.Group(children),
	)
}
...
func No(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="m12.12 10l3.53 3.53l-2.12 2.12L10 12.12l-3.54 3.54l-2.12-2.12L7.88 10L4.34 6.46l2.12-2.12L10 7.88l3.54-3.53l2.12 2.12z"/>`),
		g.Group(children),
	)
}
...
func NoAlt(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M14.95 6.46L11.41 10l3.54 3.54l-1.41 1.41L10 11.42l-3.53 3.53l-1.42-1.42L8.58 10L5.05 6.47l1.42-1.42L10 8.58l3.54-3.53z"/>`),
		g.Group(children),
	)
}
...
func Palmtree(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M8.58 2.39c.32 0 .59.05.81.14c1.25.55 1.69 2.24 1.7 3.97c.59-.82 2.15-2.29 3.41-2.29s2.94.73 3.53 3.55c-1.13-.65-2.42-.94-3.65-.94c-1.26 0-2.45.32-3.29.89c.4-.11.86-.16 1.33-.16c1.39 0 2.9.45 3.4 1.31c.68 1.16.47 3.38-.76 4.14c-.14-2.1-1.69-4.12-3.47-4.12c-.44 0-.88.12-1.33.38C8 10.62 7 14.56 7 19H2c0-5.53 4.21-9.65 7.68-10.79c-.56-.09-1.17-.15-1.82-.15C6.1 8.06 4.05 8.5 2 10c.76-2.96 2.78-4.1 4.69-4.1c1.25 0 2.45.5 3.2 1.29c-.66-2.24-2.49-2.86-4.08-2.86c-.8 0-1.55.16-2.05.35c.91-1.29 3.31-2.29 4.82-2.29zM13 11.5c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5s.67 1.5 1.5 1.5s1.5-.67 1.5-1.5z"/>`),
		g.Group(children),
	)
}
...
func Privacy(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M10 9.6c-.6 0-1 .4-1 1c0 .4.3.7.6.8l-.3 1.4h1.3l-.3-1.4c.4-.1.6-.4.6-.8c.1-.6-.3-1-.9-1zm.1-4.3c-.7 0-1.4.5-1.4 1.2V8h2.7V6.5c-.1-.7-.6-1.2-1.3-1.2zM10 2L3 5v3c.1 4.4 2.9 8.3 7 9.9c4.1-1.6 6.9-5.5 7-9.9V5l-7-3zm4 11c0 .6-.4 1-1 1H7c-.6 0-1-.4-1-1V9c0-.6.4-1 1-1h.3V6.5C7.4 5.1 8.6 4 10 4c1.4 0 2.6 1.1 2.7 2.5V8h.3c.6 0 1 .4 1 1v4z"/>`),
		g.Group(children),
	)
}
...
func Smartphone(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M6 2h8c.55 0 1 .45 1 1v14c0 .55-.45 1-1 1H6c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1zm7 12V4H7v10h6zM8 5h4l-4 5V5z"/>`),
		g.Group(children),
	)
}
...
func Sort(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M11 7H1l5 7zm-2 7h10l-5-7z"/>`),
		g.Group(children),
	)
}
...
func TableColAfter(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M14.08 12.864V9.216h3.648V7.424H14.08V3.776h-1.728v3.648H8.64v1.792h3.712v3.648zM0 17.92V0h20.48v17.92H0zM6.4 1.28H1.28v3.84H6.4V1.28zm0 5.12H1.28v3.84H6.4V6.4zm0 5.12H1.28v3.84H6.4v-3.84zM19.2 1.28H7.68v14.08H19.2V1.28z"/>`),
		g.Group(children),
	)
}
...
func TableColBefore(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M6.4 3.776v3.648H2.752v1.792H6.4v3.648h1.728V9.216h3.712V7.424H8.128V3.776zM0 17.92V0h20.48v17.92H0zM12.8 1.28H1.28v14.08H12.8V1.28zm6.4 0h-5.12v3.84h5.12V1.28zm0 5.12h-5.12v3.84h5.12V6.4zm0 5.12h-5.12v3.84h5.12v-3.84z"/>`),
		g.Group(children),
	)
}
...
func TableRowAfter(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M13.824 10.176h-2.88v-2.88H9.536v2.88h-2.88v1.344h2.88v2.88h1.408v-2.88h2.88zM0 17.92V0h20.48v17.92H0zM6.4 1.28H1.28v3.84H6.4V1.28zm6.4 0H7.68v3.84h5.12V1.28zm6.4 0h-5.12v3.84h5.12V1.28zm0 5.056H1.28v9.024H19.2V6.336z"/>`),
		g.Group(children),
	)
}
...
func TableRowBefore(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M6.656 6.464h2.88v2.88h1.408v-2.88h2.88V5.12h-2.88V2.24H9.536v2.88h-2.88zM0 17.92V0h20.48v17.92H0zm7.68-2.56h5.12v-3.84H7.68v3.84zm-6.4 0H6.4v-3.84H1.28v3.84zM19.2 1.28H1.28v9.024H19.2V1.28zm0 10.24h-5.12v3.84h5.12v-3.84z"/>`),
		g.Group(children),
	)
}
...
func Tagcloud(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M11 3v4H1V3h10zm8 0v4h-7V3h7zM7 8v3H1V8h6zm12 0v3H8V8h11zM9 12v2H1v-2h8zm10 0v2h-9v-2h9zM6 15v1H1v-1h5zm5 0v1H7v-1h4zm3 0v1h-2v-1h2zm5 0v1h-4v-1h4z"/>`),
		g.Group(children),
	)
}
...
func Text(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M18 3v2H2V3h16zm-6 4v2H2V7h10zm6 0v2h-4V7h4zM8 11v2H2v-2h6zm10 0v2h-8v-2h8zm-4 4v2H2v-2h12z"/>`),
		g.Group(children),
	)
}
...
func ThumbsDown(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M7.28 18c-.15.02-.26-.02-.41-.07c-.56-.19-.83-.79-.66-1.35c.17-.55 1-3.04 1-3.58c0-.53-.75-1-1.35-1h-3c-.6 0-1-.4-1-1s2-7 2-7c.17-.39.55-1 1-1H14v9h-2.14c-.41.41-3.3 4.71-3.58 5.27c-.21.41-.6.68-1 .73zM18 12h-2V3h2v9z"/>`),
		g.Group(children),
	)
}
...
func Trash(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M12 4h3c.6 0 1 .4 1 1v1H3V5c0-.6.5-1 1-1h3c.2-1.1 1.3-2 2.5-2s2.3.9 2.5 2zM8 4h3c-.2-.6-.9-1-1.5-1S8.2 3.4 8 4zM4 7h11l-.9 10.1c0 .5-.5.9-1 .9H5.9c-.5 0-.9-.4-1-.9L4 7z"/>`),
		g.Group(children),
	)
}
...
func Undo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M12 5H7V2L1 6l6 4V7h5c2.2 0 4 1.8 4 4s-1.8 4-4 4H7v2h5c3.3 0 6-2.7 6-6s-2.7-6-6-6z" class="st0"/>`),
		g.Group(children),
	)
}
...
func UniversalAccess(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M10 2.6c.83 0 1.5.67 1.5 1.5s-.67 1.51-1.5 1.51c-.82 0-1.5-.68-1.5-1.51s.68-1.5 1.5-1.5zM3.4 7.36c0-.65 6.6-.76 6.6-.76s6.6.11 6.6.76s-4.47 1.4-4.47 1.4s1.69 8.14 1.06 8.38c-.62.24-3.19-5.19-3.19-5.19s-2.56 5.43-3.18 5.19c-.63-.24 1.06-8.38 1.06-8.38S3.4 8.01 3.4 7.36z"/>`),
		g.Group(children),
	)
}
...
func UpdateAlt(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M5.7 9c.4-2 2.2-3.5 4.3-3.5c1.5 0 2.7.7 3.5 1.8l1.7-2C14 3.9 12.1 3 10 3C6.5 3 3.6 5.6 3.1 9H1l3.5 4L8 9H5.7zm9.8-2L12 11h2.3c-.5 2-2.2 3.5-4.3 3.5c-1.5 0-2.7-.7-3.5-1.8l-1.7 1.9C6 16.1 7.9 17 10 17c3.5 0 6.4-2.6 6.9-6H19l-3.5-4z"/>`),
		g.Group(children),
	)
}
...
func Warning(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M10 2c4.42 0 8 3.58 8 8s-3.58 8-8 8s-8-3.58-8-8s3.58-8 8-8zm1.13 9.38l.35-6.46H8.52l.35 6.46h2.26zm-.09 3.36c.24-.23.37-.55.37-.96c0-.42-.12-.74-.36-.97s-.59-.35-1.06-.35s-.82.12-1.07.35s-.37.55-.37.97c0 .41.13.73.38.96c.26.23.61.34 1.06.34s.8-.11 1.05-.34z"/>`),
		g.Group(children),
	)
}
...
func Whatsapp(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("20"),
		h.Height("20"),
		g.Raw(`<path fill="currentColor" d="M16.8 5.7C14.4 2 9.5.9 5.7 3.2C2 5.5.8 10.5 3.2 14.2l.2.3l-.8 3l3-.8l.3.2c1.3.7 2.7 1.1 4.1 1.1c1.5 0 3-.4 4.3-1.2c3.7-2.4 4.8-7.3 2.5-11.1zm-2.1 7.7c-.4.6-.9 1-1.6 1.1c-.4 0-.9.2-2.9-.6c-1.7-.8-3.1-2.1-4.1-3.6c-.6-.7-.9-1.6-1-2.5c0-.8.3-1.5.8-2c.2-.2.4-.3.6-.3H7c.2 0 .4 0 .5.4c.2.5.7 1.7.7 1.8c.1.1.1.3 0 .4c.1.2 0 .4-.1.5c-.1.1-.2.3-.3.4c-.2.1-.3.3-.2.5c.4.6.9 1.2 1.4 1.7c.6.5 1.2.9 1.9 1.2c.2.1.4.1.5-.1s.6-.7.8-.9c.2-.2.3-.2.5-.1l1.6.8c.2.1.4.2.5.3c.1.3.1.7-.1 1z"/>`),
		g.Group(children),
	)
}
