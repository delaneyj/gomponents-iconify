...
func IconFromName(name string) g.Node {
	...
	case "arrowNextRtl":
		return ArrowNextRtl()
	case "arrowPreviousLtr":
		return ArrowPreviousLtr()
	case "arrowPreviousRtl":
		return ArrowPreviousRtl()
	case "articleAdd":
		return ArticleAdd()
	case "articleCheck":
		return ArticleCheck()
	case "articleDisambiguationLtr":
		return ArticleDisambiguationLtr()
	case "articleDisambiguationRtl":
		return ArticleDisambiguationRtl()
	case "articleLtr":
		return ArticleLtr()
	case "articleNotFoundLtr":
		return ArticleNotFoundLtr()
	case "articleNotFoundRtl":
		return ArticleNotFoundRtl()
	case "articleRedirectLtr":
		return ArticleRedirectLtr()
	case "articleRedirectRtl":
		return ArticleRedirectRtl()
	case "articleRtl":
		return ArticleRtl()
	case "articleSearch":
	...
	case "articlesRtl":
		return ArticlesRtl()
	case "articlesSearchLtr":
		return ArticlesSearchLtr()
	case "articlesSearchRtl":
		return ArticlesSearchRtl()
	case "attachment":
		return Attachment()
	case "bell":
		return Bell()
	...
	case "boldCyrlBe":
		return BoldCyrlBe()
	case "boldCyrlPalochka":
		return BoldCyrlPalochka()
	case "boldCyrlTe":
		return BoldCyrlTe()
	case "boldCyrlZhe":
		return BoldCyrlZhe()
	...
	case "die":
		return Die()
	case "doubleChevronEndLtr":
		return DoubleChevronEndLtr()
	case "doubleChevronEndRtl":
		return DoubleChevronEndRtl()
	case "doubleChevronStartLtr":
		return DoubleChevronStartLtr()
	case "doubleChevronStartRtl":
		return DoubleChevronStartRtl()
	case "downTriangle":
		return DownTriangle()
	case "download":
		return Download()
	...
	case "flagRtl":
		return FlagRtl()
	case "folderPlaceholderLtr":
		return FolderPlaceholderLtr()
	case "folderPlaceholderRtl":
		return FolderPlaceholderRtl()
	case "fullScreen":
		return FullScreen()
	case "function":
		return Function()
	case "functionArgumentLtr":
		return FunctionArgumentLtr()
	case "functionArgumentRtl":
		return FunctionArgumentRtl()
	case "funnelLtr":
		return FunnelLtr()
	case "funnelRtl":
		return FunnelRtl()
	case "globe":
		return Globe()
	case "halfBrightLtr":
		return HalfBrightLtr()
	case "halfBrightRtl":
		return HalfBrightRtl()
	case "halfStarLtr":
		return HalfStarLtr()
	case "halfStarRtl":
		return HalfStarRtl()
	...
	case "helpLtr":
		return HelpLtr()
	case "helpNoticeLtr":
		return HelpNoticeLtr()
	case "helpNoticeRtl":
		return HelpNoticeRtl()
	case "helpRtl":
		return HelpRtl()
	case "hieroglyph":
		return Hieroglyph()
	...
	case "imageGallery":
		return ImageGallery()
	case "imageLayoutBasic":
		return ImageLayoutBasic()
	case "imageLayoutFrame":
		return ImageLayoutFrame()
	case "imageLayoutFrameless":
		return ImageLayoutFrameless()
	case "imageLayoutThumbnail":
		return ImageLayoutThumbnail()
	case "imageLockLtr":
		return ImageLockLtr()
	case "imageLockRtl":
		return ImageLockRtl()
	...
	case "italicA":
		return ItalicA()
	case "italicArabKehehJeem":
		return ItalicArabKehehJeem()
	case "italicArabMeem":
		return ItalicArabMeem()
	case "italicArabTeh":
		return ItalicArabTeh()
	case "italicArmnSha":
		return ItalicArmnSha()
	case "italicC":
		return ItalicC()
	case "italicD":
		return ItalicD()
	...
	case "link":
		return Link()
	case "linkExternalLtr":
		return LinkExternalLtr()
	case "linkExternalRtl":
		return LinkExternalRtl()
	case "linkSecure":
		return LinkSecure()
	case "listBulletLtr":
		return ListBulletLtr()
	case "listBulletRtl":
		return ListBulletRtl()
	case "listNumberedLtr":
		return ListNumberedLtr()
	...
	case "logoCc":
		return LogoCc()
	case "logoMediaWiki":
		return LogoMediaWiki()
	case "logoMetaWiki":
		return LogoMetaWiki()
	case "logoWikibooks":
		return LogoWikibooks()
	case "logoWikidata":
		return LogoWikidata()
	case "logoWikifunctions":
		return LogoWikifunctions()
	case "logoWikimedia":
		return LogoWikimedia()
	case "logoWikimediaCommons":
		return LogoWikimediaCommons()
	case "logoWikimediaDiscovery":
		return LogoWikimediaDiscovery()
	case "logoWikinews":
		return LogoWikinews()
	case "logoWikipedia":
		return LogoWikipedia()
	case "logoWikiquote":
		return LogoWikiquote()
	case "logoWikisource":
		return LogoWikisource()
	case "logoWikispecies":
		return LogoWikispecies()
	case "logoWikiversity":
		return LogoWikiversity()
	case "logoWikivoyage":
		return LogoWikivoyage()
	case "logoWiktionary":
	...
	case "mathematics":
		return Mathematics()
	case "mathematicsDisplayBlock":
		return MathematicsDisplayBlock()
	case "mathematicsDisplayDefault":
		return MathematicsDisplayDefault()
	case "mathematicsDisplayInline":
		return MathematicsDisplayInline()
	case "menu":
		return Menu()
	case "message":
		return Message()
	...
	case "ocr":
		return Ocr()
	case "ongoingConversationLtr":
		return OngoingConversationLtr()
	case "ongoingConversationRtl":
		return OngoingConversationRtl()
	case "outdentLtr":
		return OutdentLtr()
	case "outdentRtl":
		return OutdentRtl()
	...
	case "quotesRtl":
		return QuotesRtl()
	case "recentChangesLtr":
		return RecentChangesLtr()
	case "recentChangesRtl":
		return RecentChangesRtl()
	case "redoLtr":
		return RedoLtr()
	case "redoRtl":
		return RedoRtl()
	case "reference":
		return Reference()
	case "referenceExistingLtr":
		return ReferenceExistingLtr()
	case "referenceExistingRtl":
		return ReferenceExistingRtl()
	case "referencesLtr":
		return ReferencesLtr()
	case "referencesRtl":
		return ReferencesRtl()
	case "reload":
		return Reload()
	case "restore":
		return Restore()
	...
	case "searchDiacritics":
		return SearchDiacritics()
	case "searchRegularExpression":
	...
	case "specialPagesLtr":
		return SpecialPagesLtr()
	case "specialPagesRtl":
		return SpecialPagesRtl()
	case "speechBubbleAddLtr":
		return SpeechBubbleAddLtr()
	case "speechBubbleAddRtl":
		return SpeechBubbleAddRtl()
	case "speechBubbleLtr":
		return SpeechBubbleLtr()
	case "speechBubbleRtl":
		return SpeechBubbleRtl()
	case "speechBubblesLtr":
		return SpeechBubblesLtr()
	case "speechBubblesRtl":
		return SpeechBubblesRtl()
	case "star":
		return Star()
	case "stop":
		return Stop()
	case "strikethroughA":
		return StrikethroughA()
	case "strikethroughS":
		return StrikethroughS()
	case "strikethroughY":
		return StrikethroughY()
	case "subscriptLtr":
		return SubscriptLtr()
	case "subscriptRtl":
		return SubscriptRtl()
	...
	case "success":
		return Success()
	case "superscriptLtr":
		return SuperscriptLtr()
	case "superscriptRtl":
		return SuperscriptRtl()
	case "table":
		return Table()
	case "tableAddColumnAfterLtr":
		return TableAddColumnAfterLtr()
	case "tableAddColumnAfterRtl":
		return TableAddColumnAfterRtl()
	case "tableAddColumnBeforeLtr":
		return TableAddColumnBeforeLtr()
	case "tableAddColumnBeforeRtl":
		return TableAddColumnBeforeRtl()
	case "tableAddRowAfter":
		return TableAddRowAfter()
	case "tableAddRowBefore":
		return TableAddRowBefore()
	case "tableCaption":
		return TableCaption()
	case "tableMergeCells":
		return TableMergeCells()
	case "tableMoveColumnAfterLtr":
		return TableMoveColumnAfterLtr()
	case "tableMoveColumnAfterRtl":
		return TableMoveColumnAfterRtl()
	case "tableMoveColumnBeforeLtr":
		return TableMoveColumnBeforeLtr()
	case "tableMoveColumnBeforeRtl":
		return TableMoveColumnBeforeRtl()
	case "tableMoveRowAfter":
		return TableMoveRowAfter()
	case "tableMoveRowBefore":
		return TableMoveRowBefore()
	case "tagLtr":
		return TagLtr()
	case "tagRtl":
		return TagRtl()
	case "templateAddLtr":
		return TemplateAddLtr()
	case "templateAddRtl":
		return TemplateAddRtl()
	case "textDirLtr":
		return TextDirLtr()
	case "textDirRtl":
		return TextDirRtl()
	...
	case "textStyle":
		return TextStyle()
	case "textSummaryLtr":
		return TextSummaryLtr()
	case "textSummaryRtl":
		return TextSummaryRtl()
	case "trash":
		return Trash()
	case "tray":
		return Tray()
	...
	case "userAvatar":
		return UserAvatar()
	case "userAvatarOutline":
		return UserAvatarOutline()
	case "userContributionsLtr":
		return UserContributionsLtr()
	case "userContributionsRtl":
		return UserContributionsRtl()
	case "userGroupLtr":
		return UserGroupLtr()
	case "userGroupRtl":
		return UserGroupRtl()
	case "userRightsLtr":
		return UserRightsLtr()
	case "userRightsRtl":
		return UserRightsRtl()
	case "userTalkLtr":
		return UserTalkLtr()
	case "userTalkRtl":
		return UserTalkRtl()
	case "userTemporaryLtr":
		return UserTemporaryLtr()
	case "userTemporaryRtl":
		return UserTemporaryRtl()
	case "viewCompact":
		return ViewCompact()
	case "viewDetailsLtr":
		return ViewDetailsLtr()
	case "viewDetailsRtl":
		return ViewDetailsRtl()
	case "visionSimulator":
		return VisionSimulator()
	case "volumeDownLtr":
		return VolumeDownLtr()
	case "volumeDownRtl":
		return VolumeDownRtl()
	case "volumeOffLtr":
		return VolumeOffLtr()
	case "volumeOffRtl":
		return VolumeOffRtl()
