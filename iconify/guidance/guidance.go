...
func IconFromName(name string) g.Node {
	switch name {
	case "accesibleRestroom":
		return AccesibleRestroom()
	case "accessForHearingLoss":
		return AccessForHearingLoss()
	case "accessToLowVision":
		return AccessToLowVision()
	case "accessibleExit":
		return AccessibleExit()
	case "accessibleExitTwo":
		return AccessibleExitTwo()
	case "accessibleMenRestroom":
		return AccessibleMenRestroom()
	case "accessibleWomenRestroom":
		return AccessibleWomenRestroom()
	case "airplaneMode":
		return AirplaneMode()
	...
	case "ambulanceEntrance":
		return AmbulanceEntrance()
	case "amusementPark":
	...
	case "arrival":
		return Arrival()
	case "assistiveListeningDevice":
		return AssistiveListeningDevice()
	case "atm":
		return Atm()
	...
	case "card":
		return Card()
	case "careStaffArea":
		return CareStaffArea()
	case "casino":
		return Casino()
	case "changinRoomDisabled":
		return ChanginRoomDisabled()
	case "changinRoomFamily":
		return ChanginRoomFamily()
	case "changinRoomMan":
		return ChanginRoomMan()
	case "changinRoomWoman":
		return ChanginRoomWoman()
	case "changingRoomHanger":
		return ChangingRoomHanger()
	case "chapel":
		return Chapel()
	...
	case "chat":
		return Chat()
	case "childrenMustBeSupervised":
		return ChildrenMustBeSupervised()
	case "cleaningRoom":
		return CleaningRoom()
	case "cleaningRoomTwo":
		return CleaningRoomTwo()
	case "climbingWall":
		return ClimbingWall()
	case "clock":
		return Clock()
	...
	case "doNotSit":
		return DoNotSit()
	case "doNotSkateboardRollerboard":
		return DoNotSkateboardRollerboard()
	case "doNotStandHere":
		return DoNotStandHere()
	case "downAngleArrow":
		return DownAngleArrow()
	case "downArrow":
		return DownArrow()
	case "downLeftArrow":
		return DownLeftArrow()
	case "downLeftTwoShortArrow":
		return DownLeftTwoShortArrow()
	case "downRightArrow":
		return DownRightArrow()
	case "downRightTwoShortArrow":
		return DownRightTwoShortArrow()
	case "downTwoShortArrow":
		return DownTwoShortArrow()
	...
	case "eBikeTwo":
		return EBikeTwo()
	case "elderlyPeoplePrioritySeating":
		return ElderlyPeoplePrioritySeating()
	...
	case "elevator":
		return Elevator()
	case "elevatorAccesible":
		return ElevatorAccesible()
	case "elevatorPerson":
		return ElevatorPerson()
	case "emergencyExit":
	...
	case "escalator":
		return Escalator()
	case "escalatorDownArrow":
		return EscalatorDownArrow()
	case "escalatorDownPerson":
		return EscalatorDownPerson()
	case "escalatorUpArrow":
		return EscalatorUpArrow()
	case "escalatorUpPerson":
		return EscalatorUpPerson()
	...
	case "fishingArea":
		return FishingArea()
	case "fishingAreaOne":
		return FishingAreaOne()
	case "fishingAreaTwo":
		return FishingAreaTwo()
	case "flashAllowed":
		return FlashAllowed()
	case "flashNotAllowed":
		return FlashNotAllowed()
	case "folder":
		return Folder()
	case "forbidden":
		return Forbidden()
	...
	case "guestHeightLimit":
		return GuestHeightLimit()
	case "guestWithinHeightLimitMustBeSupervised":
		return GuestWithinHeightLimitMustBeSupervised()
	case "gym":
		return Gym()
	case "hairdresser":
		return Hairdresser()
	...
	case "helicopter":
		return Helicopter()
	case "hideEyeCrossbar":
		return HideEyeCrossbar()
	case "highVoltage":
		return HighVoltage()
	case "hiking":
		return Hiking()
	...
	case "inPatient":
		return InPatient()
	case "informationDeskPeople":
		return InformationDeskPeople()
	case "informationDeskSymbol":
		return InformationDeskSymbol()
	case "intensiveCare":
	...
	case "laundryTwo":
		return LaundryTwo()
	case "leftAngleArrow":
		return LeftAngleArrow()
	case "leftArrow":
		return LeftArrow()
	case "leftLuggage":
		return LeftLuggage()
	case "leftTwoShortArrow":
		return LeftTwoShortArrow()
	case "lessMinus":
		return LessMinus()
	case "lgbtFriendly":
		return LgbtFriendly()
	...
	case "luggage":
		return Luggage()
	case "luggageCheckIn":
		return LuggageCheckIn()
	case "luggageConveyorBelt":
		return LuggageConveyorBelt()
	case "luggageLockers":
	...
	case "meetingPoint":
		return MeetingPoint()
	case "meetingPointTwo":
		return MeetingPointTwo()
	case "meetingRoom":
		return MeetingRoom()
	case "menRestroom":
		return MenRestroom()
	...
	case "newspapers":
		return Newspapers()
	case "noAccessForServiceAnimalFour":
		return NoAccessForServiceAnimalFour()
	case "noAccessForServiceAnimalThree":
		return NoAccessForServiceAnimalThree()
	case "noAccessForServiceAnimalTwo":
		return NoAccessForServiceAnimalTwo()
	case "noAlcohol":
		return NoAlcohol()
	case "noDrinkingWater":
		return NoDrinkingWater()
	case "noDroneAllowed":
		return NoDroneAllowed()
	case "noDrugOrSubstance":
		return NoDrugOrSubstance()
	case "noElectricScooter":
		return NoElectricScooter()
	case "noEntryForPedestrians":
		return NoEntryForPedestrians()
	case "noFirearmWeapon":
		return NoFirearmWeapon()
	case "noFishingOne":
		return NoFishingOne()
	case "noFood":
		return NoFood()
	case "noLitterTwo":
		return NoLitterTwo()
	case "noLuggageTrolleysBeyondThisPoint":
		return NoLuggageTrolleysBeyondThisPoint()
	case "noNoise":
		return NoNoise()
	case "noParking":
		return NoParking()
	case "noPetsAllowed":
		return NoPetsAllowed()
	case "noPictures":
		return NoPictures()
	case "noRunning":
		return NoRunning()
	case "noSelfieStickAllowed":
		return NoSelfieStickAllowed()
	case "noSmoking":
		return NoSmoking()
	case "noTouch":
		return NoTouch()
	...
	case "paper":
		return Paper()
	case "parentAndInfantPrioritySeating":
		return ParentAndInfantPrioritySeating()
	case "park":
		return Park()
	case "parking":
		return Parking()
	...
	case "prayingRoom":
		return PrayingRoom()
	case "pregnantWomanPrioritySeating":
		return PregnantWomanPrioritySeating()
	case "printer":
		return Printer()
	case "projectionRoom":
	...
	case "rampDown":
		return RampDown()
	case "rampDownArrow":
		return RampDownArrow()
	case "rampUp":
		return RampUp()
	case "rampUpArrow":
		return RampUpArrow()
	case "receptionHotelBell":
		return ReceptionHotelBell()
	case "recordingStudio":
		return RecordingStudio()
	case "recycling":
		return Recycling()
	case "refillForWaterBottle":
		return RefillForWaterBottle()
	case "refrigeration":
	...
	case "rightAngleArrow":
		return RightAngleArrow()
	case "rightArrow":
		return RightArrow()
	case "rightTwoShortArrow":
		return RightTwoShortArrow()
	case "rvTrailer":
		return RvTrailer()
	case "safeSocialDistancing":
		return SafeSocialDistancing()
	case "sanitizeHands":
		return SanitizeHands()
	case "sauna":
		return Sauna()
	case "schoolZone":
		return SchoolZone()
	...
	case "send":
		return Send()
	case "serviceAnimalOne":
		return ServiceAnimalOne()
	case "serviceAnimalThree":
		return ServiceAnimalThree()
	case "serviceAnimalTwo":
		return ServiceAnimalTwo()
	case "settings":
		return Settings()
	case "share":
		return Share()
	...
	case "stairs":
		return Stairs()
	case "stairsDownArrow":
		return StairsDownArrow()
	case "stairsDownPerson":
		return StairsDownPerson()
	case "stairsUpArrow":
		return StairsUpArrow()
	case "stairsUpPerson":
		return StairsUpPerson()
	case "standHere":
		return StandHere()
	case "star":
		return Star()
	case "strollerParking":
		return StrollerParking()
	case "studyRoom":
		return StudyRoom()
	case "sun":
		return Sun()
	...
	case "train":
		return Train()
	case "transgenderSign":
		return TransgenderSign()
	case "tunnel":
		return Tunnel()
	...
	case "upLeftArrow":
		return UpLeftArrow()
	case "upLeftTwoShortArrow":
		return UpLeftTwoShortArrow()
	case "upRightArrow":
		return UpRightArrow()
	case "upRightTwoShortArrow":
		return UpRightTwoShortArrow()
	case "upTwoShortArrow":
		return UpTwoShortArrow()
	case "userOne":
		return UserOne()
	case "userTwo":
		return UserTwo()
	...
	case "volume":
		return Volume()
	case "volumeControlTelephone":
		return VolumeControlTelephone()
	case "waitingRoom":
		return WaitingRoom()
	case "walker":
		return Walker()
	...
	case "wheelchairBasketball":
		return WheelchairBasketball()
	case "wheelchairOne":
		return WheelchairOne()
	case "wheelchairTennis":
		return WheelchairTennis()
	case "wheelchairTwo":
		return WheelchairTwo()
	case "wiFi":
		return WiFi()
	case "wifiOff":
		return WifiOff()
