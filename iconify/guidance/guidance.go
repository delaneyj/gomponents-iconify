...
const (
	...
	deskForLaptopPath                          = `<path fill="none" stroke="currentColor" d="M18.5 10.5h-13m13 0v-8h-13v8m13 0l.674 6.5H19c-1.95-.217-4.405-.5-7-.5c-2.595 0-5.05.283-7 .5h-.174l.674-6.5m5.5 4h2M3.5 7.06c-.403 0-.968.072-1.5.157L.608 21.5H.75s5.25-1 11.25-1s11.25 1 11.25 1h.087L22 7.217c-.532-.085-1.097-.157-1.5-.157"/>`
	discothequePath                            = `<path fill="none" stroke="currentColor" d="M14 23.5c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-3.5-.75-5v-.5l-5-2.5V6.5h5V14m-3 3.5c-.21 0-.466.133-.737.344C5.958 19.24 5.5 21.718 5.5 24m-5-14l2.328-2.328A4 4 0 0 1 5.657 6.5h7.186a4 4 0 0 0 2.829-1.172L18 3m1.5 14.5a2 2 0 1 0-4 0a2 2 0 0 0 4 0Zm0 0v-8h.75s.75 4 3.75 4m-14.805-9s-1.81-.557-2.135-1.776A1.768 1.768 0 0 1 8.302.561a1.75 1.75 0 0 1 2.146 1.25c.324 1.219-.962 2.61-.962 2.61l-.291.079Z"/>`
	dislikePath                                = `<path fill="none" stroke="currentColor" d="M1.5 15V3m17 .5v.16a16 16 0 0 0 3.761 10.307l.239.283v.25h-9V18a3.5 3.5 0 0 1-3.5 3.5h-.5V19A4.5 4.5 0 0 0 5 14.5h-.5v-11h14Z"/>`
	doNotSitPath                               = `<path fill="none" stroke="currentColor" d="M6 19.5h7m-.5-7v-6h-1.172a3 3 0 0 0-2.829 2m5.501 8H6.5v-.25L8 10.4m10 13.1c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-2.5-.75-4M.5.5l23 23m-11.15-19s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25h-.3Z"/>`
	doNotSkateboardRollerboardPath             = `<path fill="none" stroke="currentColor" d="M13.5 13.5H7v-.25l1-2.7M13.5 20c0-1.851.538-3.464 1.54-4.96M14.5 6.5l-2.162 5.838M10.764 15.5C9.94 16.94 9.5 18.326 9.5 20m9.5 1.5l-1.09.272a24.371 24.371 0 0 1-11.82 0L5 21.5m2 .482V24m10-2.018V24M.5.5l11.838 11.838M23.5 23.5l-8.46-8.46M2.5 5.5s4 1 9.5 1s9.5-1 9.5-1m-9.162 6.838l2.701 2.701M11.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25h-.3Z"/>`
	doNotStandHerePath                         = `<path fill="none" stroke="currentColor" d="m.5.5l2.65 2.65M23.5 23.5l-8.707-8.707m4.07 6.213c-.374 1.3-1.582 2.232-2.911 1.944a11.457 11.457 0 0 1-.151-.033c-1.225-.283-1.906-1.473-1.802-2.718l.196-2.336L16 18.18M9.894 12.5l-.346 2.233l-5.916 1.037l-1.163-4.047A12.039 12.039 0 0 1 2.489 5m.66-1.85l.018-.04l.443-1.172S6.207 1 8.916 1l.956 2.85c.612 1.826.778 3.77.483 5.673l-.111.72M3.15 3.15l7.094 7.094M14.4 14.4l-.755-4.877a12.04 12.04 0 0 1 .483-5.672L15.084 1c2.71 0 5.306.938 5.306.938l.832 2.2a12.04 12.04 0 0 1 .31 7.585l-1.164 4.047l-5.575-.977M14.4 14.4l.393.393M14.4 14.4l-4.156-4.156M8.199 22.917l-.15.033c-1.33.288-2.538-.644-2.912-1.944l-.636-2.213l5.304-.93L10 20.2c.104 1.245-.577 2.435-1.802 2.718Z"/>`
	downAngleArrowPath                         = `<path fill="none" stroke="currentColor" d="M24 16c-.741 0-1.85.733-2.78 1.475c-1.2.954-2.247 2.094-3.046 3.401C17.575 21.856 17 23.044 17 24m0 0c0-.956-.575-2.145-1.174-3.124c-.8-1.307-1.847-2.447-3.045-3.401C11.85 16.733 10.74 16 10 16m7 8V12.5c0-6.627-5.373-12-12-12H0"/>`
	downArrowPath                              = `<path fill="none" stroke="currentColor" d="M5 16c.742 0 1.85.733 2.78 1.475c1.2.954 2.247 2.094 3.046 3.401C11.425 21.856 12 23.044 12 24m0 0c0-.956.575-2.145 1.174-3.124c.8-1.307 1.847-2.447 3.045-3.401C17.15 16.733 18.26 16 19 16m-7 8V0"/>`
	downLeftArrowPath                          = `<path fill="none" stroke="currentColor" d="M3 21L21 3M3 21c.676-.676 1.923-1.11 3.039-1.379c1.49-.359 3.036-.424 4.559-.252c1.182.134 2.484.4 3.009.924M3 21c.676-.676 1.11-1.923 1.379-3.039c.359-1.49.424-3.036.252-4.559c-.134-1.182-.4-2.484-.924-3.009"/>`
	downLeftTwoShortArrowPath                  = `<path fill="none" stroke="currentColor" d="M3.01 20.991L21 3.001M4.07 5.08c.785.786 1.182 2.737 1.381 4.51c.258 2.282.159 4.6-.381 6.834c-.404 1.673-1.056 3.543-2.07 4.557m15.92-1.051c-.785-.785-2.737-1.181-4.51-1.381c-2.282-.258-4.6-.159-6.834.381c-1.673.404-3.543 1.056-4.557 2.07"/>`
	downRightArrowPath                         = `<path fill="none" stroke="currentColor" d="M21 21L3 3m18 18c-.676-.676-1.923-1.11-3.039-1.379c-1.49-.359-3.036-.424-4.559-.252c-1.182.134-2.484.4-3.009.924M21 21c-.676-.676-1.11-1.923-1.379-3.039c-.359-1.49-.424-3.036-.252-4.559c.134-1.182.4-2.484.924-3.009"/>`
	downRightTwoShortArrowPath                 = `<path fill="none" stroke="currentColor" d="M20.991 20.991L3.001 3.001m16.93 2.08c-.786.786-1.183 2.737-1.382 4.51c-.258 2.282-.159 4.6.381 6.834c.404 1.673 1.056 3.543 2.07 4.557M5.081 19.93c.786-.785 2.737-1.181 4.51-1.381c2.282-.258 4.6-.159 6.834.381c1.673.404 3.543 1.056 4.557 2.07"/>`
	downTwoShortArrowPath                      = `<path fill="none" stroke="currentColor" d="M1.5 12c1.11 0 2.771 1.1 4.166 2.212c1.796 1.432 3.365 3.141 4.563 5.102c.897 1.469 1.758 3.253 1.758 4.686M22.5 12c-1.11 0-2.771 1.1-4.166 2.212c-1.796 1.432-3.365 3.141-4.563 5.102c-.897 1.469-1.758 3.253-1.758 4.686M12 24V0"/>`
	drinkingFountainPath                       = `<g fill="none"><path stroke="currentColor" d="M6.5 15v9m11 0v-.179c0-4.527-1.799-8.87-5-12.071v-.25H22M2.5 24v-9.5l2.22-5.182A3 3 0 0 1 7.479 7.5H8.5v3.757a3 3 0 0 0 .879 2.122L12 16M9.805 5.902s1.812.414 2.686-.46A1.726 1.726 0 0 0 12.498 3a1.722 1.722 0 0 0-2.438.01c-.874.873-.464 2.683-.464 2.683l.209.208Z"/><path fill="currentColor" d="m15.275 7.421l.137.481l-.137-.48Zm4.278 2.303l.223.447l.895-.447l-.224-.448l-.894.448Zm-4.376-1.755l.48-.137l-.274-.961l-.481.137l.275.961Zm-.079-1.017l-.48.137l.274.962l.481-.138l-.275-.961Zm.656.87l.492-.09l-.18-.983l-.491.09l.179.983Zm2.04-.832l-.475-.155l-.31.95l.475.156l.31-.951Zm.33 1.232l.436.246l.491-.871l-.435-.246l-.491.871Zm2.103.663l-.267-.423l-.846.533l.267.423l.846-.533Zm-5.09-.904l.04-.012l-.275-.961l-.04.011l.275.962Zm.236-.068l.04-.01l-.275-.962l-.04.01l.275.962Zm.04-.01a3.57 3.57 0 0 1 .34-.08l-.178-.984c-.146.026-.292.06-.437.102l.274.961Zm2.07.038c.223.072.438.167.642.281l.49-.87a4.555 4.555 0 0 0-.82-.362l-.311.95Zm1.898 1.477c.061.098.119.2.172.306l.894-.448a4.551 4.551 0 0 0-.22-.391l-.846.533Z"/></g>`
	...
	inPatientPath                              = `<path fill="none" stroke="currentColor" d="M1.5 20.5V6m0 14.5s0 3-1.5 3m1.5-3h21m0 0s0 3 1.5 3m-1.5-3V15a3.5 3.5 0 0 0-3.5-3.5h-8.5v4m-9 2h21m-6.5-8v-2s-1.5-1-4-1s-4 1-4 1v2m.5 3.9S7.5 15 6.25 15a1.75 1.75 0 0 1-1.75-1.75c0-.966.784-1.746 1.75-1.746c1.25 0 2.25 1.596 2.25 1.596v.3Zm3.352-8.9s-1.6-1-1.6-2.25c0-.966.784-1.75 1.75-1.75c.967 0 1.746.784 1.746 1.75c0 1.25-1.596 2.25-1.596 2.25h-.3Z"/>`
	informationDeskPeoplePath                  = `<path fill="none" stroke="currentColor" d="M0 12.5h14.464m7.072 0H24M10 10V7.5s-1.5-1-4-1s-4 1-4 1V10m14 14v-5.5h-3.5v-.25l.072-.15A24.999 24.999 0 0 0 15 7.35v-.328a8.58 8.58 0 0 1 3-.523c1.288 0 2.311.266 3 .523v.328c0 3.72.83 7.391 2.428 10.749l.072.15v.25H20V24M5.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0C7.746 3.5 6.15 4.5 6.15 4.5h-.3Zm12 0s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25h-.3Z"/>`
	informationDeskSymbolPath                  = `<path fill="none" stroke="currentColor" d="M12 7V5M9 9.5h3v8m0 0H8m4 0h4m-4 6C5.649 23.5.5 18.351.5 12S5.649.5 12 .5S23.5 5.649 23.5 12S18.351 23.5 12 23.5Z"/>`
	intensiveCarePath                          = `<path fill="none" stroke="currentColor" d="M1.5 20.5V6m0 14.5s0 3-1.5 3m1.5-3h21m0 0s0 3 1.5 3m-1.5-3V15a3.5 3.5 0 0 0-3.5-3.5h-8.5v4m-9 2h21M10.5 4h1.573a1.5 1.5 0 0 0 1.342-.83L14.75.5H15l3.5 7h.25l1.335-2.67A1.5 1.5 0 0 1 21.427 4H23M8.5 13.4S7.5 15 6.25 15a1.75 1.75 0 0 1-1.75-1.75c0-.966.784-1.746 1.75-1.746c1.25 0 2.25 1.596 2.25 1.596v.3Z"/>`
	irisScanPath                               = `<path fill="none" stroke="currentColor" d="m7 1l-5.7.3L1 7m16-6l5.7.3L23 7m-6 16l5.7-.3l.3-5.7M7 23l-5.7-.3L1 17m-1-5c1.276 0 2.5 1 3.5 2l2.606 2.947a8.079 8.079 0 0 0 11.788 0L20.5 14c1-1 2.224-2 3.5-2c-1.276 0-2.5-1-3.5-2l-2.606-2.947a8.079 8.079 0 0 0-11.788 0L3.5 10c-1 1-2.224 2-3.5 2Zm12 2.5a2.5 2.5 0 1 1 0-5a2.5 2.5 0 0 1 0 5Z"/>`
	kitchenPath                                = `<path fill="none" stroke="currentColor" d="M12 22.5H1.5v-20s2-1 5.25-1s5.25 1 5.25 1v20Zm0 0v-10h.25s1.75 1 5 1s5-1 5-1h.25v10H12ZM1.5 9.5s2-1 5.25-1s5.25 1 5.25 1m-8-5v2M4 11v2m14.5.449V9.75a1.25 1.25 0 1 0-2.5 0V10"/>`
	laboratoryPath                             = `<path fill="none" stroke="currentColor" d="M6.5 12.5h.146c2.206 0 4.381.514 6.354 1.5c1.973.986 4.148 1.5 6.354 1.5H20.5m-13-14h9v.25l-.707.972a6.762 6.762 0 0 0 .688 8.759L22.5 17.5c0 2-1 3.5-3 5h-15c-2-1.5-3-3-3-5l6.02-6.02a6.762 6.762 0 0 0 .687-8.758L7.5 1.75V1.5Z"/>`
	laundryPath                                = `<path fill="none" stroke="currentColor" d="M16.9 13H16a2 2 0 0 1-2-2a2 2 0 1 1-4 0a2 2 0 0 1-2 2h-.9M5.5 4h3m.217 17h6.566a4 4 0 0 1 3.392 1.88l.075.12H21V1H3v22h2.25l.075-.12A4 4 0 0 1 8.717 21ZM12 17a5 5 0 1 1 0-10a5 5 0 0 1 0 10Z"/>`
	laundryTwoPath                             = `<path fill="none" stroke="currentColor" d="M9 14.5h6M17 4H7m10 0a3 3 0 0 0 3-3V.5H7.5a3.5 3.5 0 1 0 0 7H20V7a3 3 0 0 0-3-3ZM3.5 23.5h17c0-4 .934-7.79 2.722-11.217l.278-.533v-.25H.5v.25l.278.533C2.566 15.71 3.5 19.5 3.5 23.5Z"/>`
	leftAngleArrowPath                         = `<path fill="none" stroke="currentColor" d="M16 0c0 .742.733 1.85 1.475 2.78c.954 1.2 2.094 2.247 3.401 3.046C21.856 6.425 23.044 7 24 7m0 0c-.956 0-2.145.575-3.124 1.174c-1.307.8-2.447 1.847-3.401 3.045C16.733 12.15 16 13.26 16 14m8-7H12.5C5.873 7 .5 12.373.5 19v5"/>`
	leftArrowPath                              = `<path fill="none" stroke="currentColor" d="M16 5c0 .742.733 1.85 1.475 2.78c.954 1.2 2.094 2.247 3.401 3.046C21.856 11.425 23.044 12 24 12m0 0c-.956 0-2.145.575-3.124 1.174c-1.307.8-2.447 1.847-3.401 3.045C16.733 17.15 16 18.26 16 19m8-7H0"/>`
	leftLuggagePath                            = `<path fill="none" stroke="currentColor" d="M7.5 7.5v11m8-11v11m-1-11a3 3 0 1 0-6 0M1 1.5h21.5v21H1m18.5-4h-16v-.177l.202-1.345a26.737 26.737 0 0 0 0-7.956L3.5 7.676V7.5h16v.176l-.203 1.346a26.748 26.748 0 0 0 0 7.956l.203 1.345v.177Z"/>`
	leftTwoShortArrowPath                      = `<path fill="none" stroke="currentColor" d="M12 1.5c0 1.11 1.1 2.771 2.212 4.166c1.432 1.796 3.141 3.365 5.102 4.563c1.469.897 3.253 1.758 4.686 1.758M12 22.5c0-1.11 1.1-2.771 2.212-4.166c1.432-1.796 3.141-3.365 5.102-4.563c1.469-.897 3.253-1.758 4.686-1.758M24 12H0"/>`
	lessMinusPath                              = `<path fill="none" stroke="currentColor" d="M.5 14.5h23v-.25l-.054-.27a10.101 10.101 0 0 1 0-3.96l.054-.27V9.5H.5v.25l.054.27a10.1 10.1 0 0 1 0 3.96l-.054.27v.25Z"/>`
	lgbtFriendlyPath                           = `<path fill="none" stroke="currentColor" d="M1.507 7.5h10.487m10.5 0H12.005m-8.996 4h17.98m-13.28 4h8.58m-4.296-8a5.25 5.25 0 0 0-5.244-5c-2.9 0-5.25 2.382-5.25 5.282c0 1.56.688 3.055 1.88 4.062l5.657 4.776A8.35 8.35 0 0 1 12 23a8.35 8.35 0 0 1 2.964-6.38l5.657-4.776a5.327 5.327 0 0 0 1.88-4.062c0-2.9-2.351-5.282-5.25-5.282a5.25 5.25 0 0 0-5.245 5m-.012 0h.012"/>`
	libraryPath                                = `<path fill="none" stroke="currentColor" d="M12 7.5V17m0-9.5a3 3 0 0 0-3-3H2v1.085A62.99 62.99 0 0 1 .5 19.25v.25H9a3 3 0 0 1 3 3m0-15a3 3 0 0 1 3-3h7v1.085c0 4.596.503 9.178 1.5 13.665v.25H15a3 3 0 0 0-3 3m0 0v.5"/>`
	likePath                                   = `<path fill="none" stroke="currentColor" d="M1.5 9v12m17-.5v-.16a16 16 0 0 1 3.761-10.307l.239-.283V9.5h-9V6A3.5 3.5 0 0 0 10 2.5h-.5V5A4.5 4.5 0 0 1 5 9.5h-.5v11h14Z"/>`
	locationOffPath                            = `<path fill="none" stroke="currentColor" d="m16.19 16.19l1.337-1.215A8.365 8.365 0 0 0 20.25 8.8c0-4.558-3.694-8.3-8.25-8.3c-3.104 0-5.807 1.737-7.216 4.284M12 23.92a9.041 9.041 0 0 1 2.383-6.037M12 23.92a9.04 9.04 0 0 0-2.96-6.61l-2.567-2.334a8.365 8.365 0 0 1-2.6-7.603M12 23.92V24v-.057M.5.5l23 23M9.564 9.564a2.5 2.5 0 1 1 1.872 1.872"/>`
	locationPinPath                            = `<path fill="none" stroke="currentColor" d="M12 23.92a9.04 9.04 0 0 0-2.96-6.61l-2.567-2.334A8.365 8.365 0 0 1 3.75 8.799C3.75 4.242 7.444.5 12 .5s8.25 3.741 8.25 8.298c0 2.343-.989 4.6-2.723 6.177l-2.568 2.334a9.041 9.041 0 0 0-2.96 6.61Zm0 0V24v-.057M12 11.5a2.5 2.5 0 1 1 0-5a2.5 2.5 0 0 1 0 5Z"/>`
	lockPath                                   = `<path fill="none" stroke="currentColor" d="M6.5 10.5V6a5.5 5.5 0 1 1 11 0v4.5M12 15v4m8.5 4.5h-17v-.25l.075-.327a26.342 26.342 0 0 0 0-11.846L3.5 10.75v-.25h17v.25l-.075.327a26.34 26.34 0 0 0 0 11.846l.075.327v.25Z"/>`
	lockersPath                                = `<g fill="none" stroke="currentColor"><path d="M.5 9.5v.25l4.75 4.75h.25a3.89 3.89 0 0 1 5.5 0l9 9h3.5V20l-1-1h-2v-2h-2v-2l-4-4a3.89 3.89 0 0 1 0-5.5v-.25L9.75.5H9.5a9 9 0 0 0-9 9Z"/><path d="M4.5 6a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0Z"/></g>`
	lostAndFoundPath                           = `<path fill="none" stroke="currentColor" d="M9.5 11v-1a2.5 2.5 0 0 1 5 0v.039a2 2 0 0 1-.75 1.562l-1 .798a2 2 0 0 0-.75 1.562V15.5m0 1.5v2M5.5 4.5v17m13 0v-17h-2.027m-8.946 0H.5v.25l.055.31a45.684 45.684 0 0 1 0 15.88l-.055.31v.25h23v-.25l-.055-.31a45.686 45.686 0 0 1 0-15.88l.055-.31V4.5h-7.027m-8.946 0a4.5 4.5 0 0 1 8.945 0m-8.945 0h8.945"/>`
	loungePath                                 = `<path fill="none" stroke="currentColor" d="M22 23.5c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-2.5-.75-4v-1.5h-9L8.621 8.985a2 2 0 0 1 1.94-2.485h.939l4 8m1 5.5h-5a4.643 4.643 0 0 1-4.504-3.517L3 .5m6.195 4s-1.81-.557-2.135-1.776A1.768 1.768 0 0 1 8.302.561a1.75 1.75 0 0 1 2.146 1.25c.324 1.219-.962 2.61-.962 2.61l-.291.079Z"/>`
	luggagePath                                = `<path fill="none" stroke="currentColor" d="M5.5 4.5v17m13-17v17m-2.027-17H23.5v.25l-.055.31a45.687 45.687 0 0 0 0 15.88l.055.31v.25H.5v-.25l.055-.31a45.682 45.682 0 0 0 0-15.88L.5 4.75V4.5h7.027m8.945 0a4.5 4.5 0 0 0-8.945 0m8.945 0H7.527"/>`
	luggageCheckInPath                         = `<path fill="none" stroke="currentColor" d="M1 23.5h20.5v-19m0 0a2 2 0 1 0 0-4a2 2 0 0 0 0 4Zm-16 4v11m8-11v11m-1-11a3 3 0 1 0-6 0m11 11h-16v-.177l.202-1.345a26.737 26.737 0 0 0 0-7.956L1.5 8.676V8.5h16v.176l-.203 1.346a26.747 26.747 0 0 0 0 7.956l.203 1.345v.177Z"/>`
	luggageConveyorBeltPath                    = `<path fill="none" stroke="currentColor" d="M8 3.5v11m8-11v11m-1-11a3 3 0 1 0-6 0M4 21h1m4 0h1m4 0h1m4 0h1m0-6.5H4v-.177l.202-1.345a26.737 26.737 0 0 0 0-7.956L4 3.676V3.5h16v.176l-.203 1.346a26.749 26.749 0 0 0 0 7.956L20 14.323v.177Zm1 4H3a2.5 2.5 0 0 0 0 5h18a2.5 2.5 0 0 0 0-5Z"/>`
	luggageLockersPath                         = `<path fill="none" stroke="currentColor" d="M8.5 3.5h1M15 5V3.5M13 5V3.5m-5 9v11m8-11v11m-1-11a3 3 0 1 0-6 0M11.599 5A2.999 2.999 0 0 1 6 3.5A3 3 0 0 1 11.599 2h4.813c.347.492.815.885 1.36 1.142L18 3.25v.5l-.229.108A3.486 3.486 0 0 0 16.411 5H11.6ZM20 23.5H4v-.177l.202-1.345a26.737 26.737 0 0 0 0-7.956L4 12.677V12.5h16v.177l-.203 1.345a26.747 26.747 0 0 0 0 7.956L20 23.323v.177Z"/>`
	luggageTrolleyPath                         = `<path fill="none" stroke="currentColor" d="M11.5 5v11m8-11v11m-1-11a3 3 0 1 0-6 0m-8 16.5a2 2 0 1 0 4 0m11 0a2 2 0 1 0 4 0M24 19H4.5v-3.249c0-3.165-.058-6.353-.795-9.432C3.035 3.52 1.877.5 0 .5M23.5 16h-16v-.177l.202-1.345a26.737 26.737 0 0 0 0-7.956L7.5 5.176V5h16v.176l-.203 1.346a26.749 26.749 0 0 0 0 7.956l.203 1.345V16Z"/>`
	mailPath                                   = `<path fill="none" stroke="currentColor" d="m.5 6.5l11.375 7h.25l11.375-7m0-2.5v16.5H23c-3-.5-8-.75-11-.75S4 20 1 20.5H.5V4c3-.5 8.5-.75 11.5-.75s8.5.25 11.5.75Z"/>`
	mailboxPath                                = `<path fill="none" stroke="currentColor" d="M11 21.5v-7.174C11 11.27 9.058 8.5 6 8.5s-5 2.769-5 5.826V21.5h10Zm0 0h.5l11.5-2v-7.541c0-2.845-2.35-4.816-5.163-4.934a3.554 3.554 0 0 0-.534.023L16 7.192m-2 .227c-2.382.275-6.484.8-8.6 1.118M14 16.5V4.75m0 0v-3L19 1s.5 1.5 0 3l-5 .75ZM3 14s1.5.5 3 .5s3-.5 3-.5"/>`
	maleSignPath                               = `<path fill="none" stroke="currentColor" d="M23.497.5L13.302 10.695M23.497.5c-.676.676-1.924 1.11-3.04 1.379c-1.489.359-3.035.424-4.558.252c-1.183-.134-2.485-.4-3.009-.924M23.497.5c-.676.676-1.11 1.923-1.38 3.039c-.358 1.49-.424 3.036-.251 4.559c.134 1.182.4 2.484.924 3.009M8 23.5a7.5 7.5 0 1 1 0-15a7.5 7.5 0 0 1 0 15Z"/>`
	...
	plasticPath                                = `<path fill="none" stroke="currentColor" d="M10 .5h4M6.5 10H7l1.027.171a24.168 24.168 0 0 0 7.946 0L17 10h.5m-11 7H7l1.027-.171a24.168 24.168 0 0 1 7.946 0L17 17h.5m-4-13.5h-3a7.236 7.236 0 0 0-4 6.472V21.5a2 2 0 0 0 2 2h7a2 2 0 0 0 2-2V9.972a7.236 7.236 0 0 0-4-6.472Z"/>`
	playPath                                   = `<path fill="none" stroke="currentColor" d="m2 22.5l1 .5c7.5-5 12.5-7.75 19-10.25v-1.5C15.5 8.75 10.5 6 3 1l-1 .5s.5 6.2.5 10.5S2 22.5 2 22.5Z"/>`
	playRoomPath                               = `<path fill="none" stroke="currentColor" d="M7.5 8v5m2.5-2.5H5m-.909 10H5.5s1.5-5 6.5-5s6.5 5 6.5 5h1.409a3.591 3.591 0 0 0 3.499-4.398L20.5 3.5h-.25S17 4.5 12 4.5s-8.25-1-8.25-1H3.5L.592 16.102A3.59 3.59 0 0 0 4.091 20.5ZM16.5 8.5a2 2 0 1 1 0 4a2 2 0 0 1 0-4Z"/>`
	playgroundPath                             = `<path fill="none" stroke="currentColor" d="M.5 23.5c3-5 3-14.5 3-20.578V.5h17v2.422c0 6.078 0 15.578 3 20.578M9.5.5v15m5-15v15m-8 0v3h11v-3h-11Z"/>`
	policePath                                 = `<g fill="none" stroke="currentColor"><path d="M11.75 23.5C4 19 2.5 16 2.5 5.5c3.15 0 6.356-1.238 8.276-3.357c.422-.465.687-1.044.874-1.643h.7c.187.599.452 1.178.874 1.643C15.144 4.262 18.35 5.5 21.5 5.5c0 10.5-1.5 13.5-9.25 18h-.5Z"/><path d="M11.898 7.5h.204l.15.542a4 4 0 0 0 3.856 2.935h.392v.166l-.365.252a4 4 0 0 0-1.55 4.473l.196.632h-.21a4.066 4.066 0 0 0-5.142 0h-.21l.195-.632a4 4 0 0 0-1.55-4.473l-.364-.252v-.166h.392a4 4 0 0 0 3.856-2.935l.15-.542Z"/></g>`
	portPath                                   = `<path fill="none" stroke="currentColor" d="M12 4.5a2 2 0 1 0 0-4a2 2 0 0 0 0 4Zm0 0v19M7 15c-2 0-3.5-1-5-3h-.5c0 4.68 3.06 8.643 7.29 10c1.21.4 2.21.5 3.085 1.5h.25C13 22.5 14 22.4 15.211 22c4.228-1.357 7.289-5.32 7.289-10H22c-1.5 2-3 3-5 3M7 7.5s2.5 1 5 1s5-1 5-1"/>`
	prayingRoomPath                            = `<path fill="none" stroke="currentColor" d="m17 9l-4.25 4.5h-.25l-1.5-6h-.5a3 3 0 0 0-3 3V17c5.5 0 9 2.5 9 3.5H7m6-10.882L15 7.5m-15 16h24m-12.445-18s1.81-.557 2.135-1.776a1.768 1.768 0 0 0-1.242-2.163a1.75 1.75 0 0 0-2.146 1.25c-.324 1.219.963 2.61.963 2.61l.29.079Z"/>`
	pregnantWomanPrioritySeatingPath           = `<path fill="none" stroke="currentColor" d="M15 23.5c-2.5-2-2-5.5-2-5.5l-6.5-1v-.25l1.343-2.552A10.053 10.053 0 0 0 9 9.516A3.016 3.016 0 0 1 12.016 6.5H13.5v3l.546.137a3.24 3.24 0 0 1 2.454 3.142c0 1.13.283 2.24.824 3.232L18 17.25v.25l-3 .5m-5 6c0-1.613.229-3.323 1-4.68m.85-14.82s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25h-.3Z"/>`
	printerPath                                = `<path fill="none" stroke="currentColor" d="M5.5 13.5c0 4.5-2 7.5-2 7.5v.5h17V21s-2-3-2-7.5m-13-6v-5h13v5M3 13.5h18m-18 4H.5v-10h23v10H21"/>`
	projectionRoomPath                         = `<path fill="none" stroke="currentColor" d="M0 20.5h5.5M5 15v-5h-.557a3 3 0 0 0-2.938 2.392L.5 17.25v.25h5m1.5 3h5.5M12 15v-5h-.557a3 3 0 0 0-2.938 2.392L7.5 17.25v.25H14v.5c0 1.5 0 2.5.75 4c0 0 .75 1.5 1.75 1.5m-2-9h9v-.25S23 12 23 7.5s.5-6.75.5-6.75V.5h-19V3m.382 5.249S3.623 7.436 3.623 6.42C3.623 5.636 4.239 5 5 5c.76 0 1.374.636 1.374 1.421c0 1.015-1.256 1.828-1.256 1.828h-.236Zm7 0s-1.26-.813-1.26-1.828C10.623 5.636 11.24 5 12 5c.76 0 1.373.636 1.373 1.421c0 1.015-1.255 1.828-1.255 1.828h-.236Z"/>`
	prostheticArmPath                          = `<path fill="none" stroke="currentColor" d="M10 18v6m4 0v-6.5a2 2 0 0 1 2-2v-8s-1.5-1-4-1s-4 1-4 1V11m1.5 4.5H8m0 0H6.5m1.5 0V12m3.85-7.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25h-.3Z"/>`
	prostheticLegPath                          = `<path fill="none" stroke="currentColor" d="M10 24v-6.5a2 2 0 0 0-2-2v-8s1.5-1 4-1s4 1 4 1v8a2 2 0 0 0-2 2V19m-1.5 4.5H14m0 0h1.5m-1.5 0V20M11.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25h-.3Z"/>`
	...
	pushPath                                   = `<path fill="none" stroke="currentColor" d="M24 12h-8m3.429-4c0 .423.419 1.056.842 1.587a7.506 7.506 0 0 0 1.944 1.738c.56.342 1.239.67 1.785.67M19.428 16c0-.423.42-1.056.843-1.587a7.509 7.509 0 0 1 1.944-1.738c.56-.342 1.239-.67 1.785-.67M0 22.5h6a6.5 6.5 0 0 0 6.5-6.5V9.5H12A2.5 2.5 0 0 0 9.5 12v4V6A2.5 2.5 0 0 0 7 3.5h-.59M.5 16V3.5H1A2.5 2.5 0 0 1 3.5 6v6V1.5h.46A2.5 2.5 0 0 1 6.46 4v8"/>`
	questionMarkPath                           = `<path fill="none" stroke="currentColor" d="M5 8.5v-1a7 7 0 0 1 14 0a4.83 4.83 0 0 1-1.414 3.414l-2.414 2.414A4 4 0 0 0 14 16.157v.343h-4v-1.172c0-1.81.72-3.547 2-4.828l1.293-1.293A2.414 2.414 0 0 0 14 7.5a2 2 0 1 0-4 0v1H5Zm7 11a2 2 0 1 1 0 4a2 2 0 0 1 0-4Z"/>`
	quietAreaPath                              = `<path fill="none" stroke="currentColor" d="M14.5 24v-4a2.5 2.5 0 0 0-2.5-2.5h-.5V24m9-4v-1.5A2.5 2.5 0 0 0 18 16h-.5v4v-9.5H17a2.5 2.5 0 0 0-2.5 2.5v8m9 3v-4a2.5 2.5 0 0 0-2.5-2.5h-.708M.5 24v-2.5a4 4 0 0 1 4-4h4v-7h3v-.25l-.063-.1A19.008 19.008 0 0 1 8.5 0"/>`
	...
	shopPath                                   = `<path fill="none" stroke="currentColor" d="M5.5 21a2 2 0 1 0 4 0m3 0a2 2 0 1 0 4 0M7 7.5h15.5v.25l-.239.283A16 16 0 0 0 18.5 18.34v.16h-13v-1.88c0-2.08-.066-4.158-.386-6.212C4.56 6.852 3.337 1.5 1 1.5"/>`
	...
	womenRestroomPath                          = `<path fill="none" stroke="currentColor" d="M10 24v-5.5H6.5v-.25l.072-.15A25 25 0 0 0 9 7.35v-.328a8.58 8.58 0 0 1 3-.523c1.288 0 2.311.266 3 .523v.328c0 3.72.83 7.391 2.428 10.749l.072.15v.25H14V24M11.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25h-.3Z"/>`
	yogaPath                                   = `<path fill="none" stroke="currentColor" d="m2 14.5l1.654-.551a6 6 0 0 0 3.795-3.795L8 8.5s1.5-1 4-1s4 1 4 1l.551 1.654a6 6 0 0 0 3.795 3.795L22 14.5m-12.5-4v5l-4.25.85a.937.937 0 0 0-.042 1.825c1.305.332 4.198 1.095 6.792 1.99c2.657.916 5 1.97 5 2.835m-2.5-12.5v5l4.25.85a.937.937 0 0 1 .042 1.825c-.974.248-2.833.736-4.792 1.34m-4 1.397c-1.73.712-3 1.45-3 2.088m4.85-17.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25h-.3Z"/>`
	zooPath                                    = `<path fill="none" stroke="currentColor" d="M6 3h-.5a5 5 0 0 0-5 5v13h3l1.072-2.679a3.693 3.693 0 0 1 6.856 0L12.5 21h3v-6.5a1.5 1.5 0 1 1 3 0v4A2.5 2.5 0 0 0 21 21h2.5v-3h-2V8a5 5 0 0 0-5-5h-8v6a2.5 2.5 0 0 0 2.5 2.5h.5l.867-2.603A2.775 2.775 0 0 1 15 7m3.5 2.5v-2"/>`
)
...
func AccesibleRestroom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accesibleRestroomPath), g.Group(children))
}

func AccessForHearingLoss(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accessForHearingLossPath), g.Group(children))
}

func AccessToLowVision(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accessToLowVisionPath), g.Group(children))
}

func AccessibleExit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accessibleExitPath), g.Group(children))
}

func AccessibleExitTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accessibleExitTwoPath), g.Group(children))
}

func AccessibleMenRestroom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accessibleMenRestroomPath), g.Group(children))
}

func AccessibleWomenRestroom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accessibleWomenRestroomPath), g.Group(children))
}

func AirplaneMode(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(airplaneModePath), g.Group(children))
}

func AirplaneModeOff(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(airplaneModeOffPath), g.Group(children))
}
...
func AlarmBell(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alarmBellPath), g.Group(children))
}
...
func AmbulanceEntrance(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(ambulanceEntrancePath), g.Group(children))
}
...
func Arrival(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrivalPath), g.Group(children))
}

func AssistiveListeningDevice(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(assistiveListeningDevicePath), g.Group(children))
}
...
func AudioDescription(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(audioDescriptionPath), g.Group(children))
}

func Auditorium(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(auditoriumPath), g.Group(children))
}
...
func BillingDepartment(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(billingDepartmentPath), g.Group(children))
}
...
func BinPerson(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(binPersonPath), g.Group(children))
}

func BinThrowPerson(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(binThrowPersonPath), g.Group(children))
}

func Bowling(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bowlingPath), g.Group(children))
}

func Boxing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(boxingPath), g.Group(children))
}
...
func Campfires(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(campfiresPath), g.Group(children))
}

func Campground(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(campgroundPath), g.Group(children))
}
...
func CareStaffArea(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(careStaffAreaPath), g.Group(children))
}
...
func ChanginRoomDisabled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(changinRoomDisabledPath), g.Group(children))
}

func ChanginRoomFamily(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(changinRoomFamilyPath), g.Group(children))
}

func ChanginRoomMan(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(changinRoomManPath), g.Group(children))
}

func ChanginRoomWoman(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(changinRoomWomanPath), g.Group(children))
}

func ChangingRoomHanger(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(changingRoomHangerPath), g.Group(children))
}

func Chapel(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chapelPath), g.Group(children))
}
...
func ChildrenMustBeSupervised(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(childrenMustBeSupervisedPath), g.Group(children))
}

func CleaningRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cleaningRoomPath), g.Group(children))
}

func CleaningRoomTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cleaningRoomTwoPath), g.Group(children))
}

func ClimbingWall(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(climbingWallPath), g.Group(children))
}
...
func CoffeeShop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeeShopPath), g.Group(children))
}

func ComputerRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(computerRoomPath), g.Group(children))
}

func ConferenceRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(conferenceRoomPath), g.Group(children))
}

func CoworkingSpace(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coworkingSpacePath), g.Group(children))
}

func Crutch(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(crutchPath), g.Group(children))
}

func CurrencyExchange(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(currencyExchangePath), g.Group(children))
}

func Customs(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(customsPath), g.Group(children))
}

func DangerPoison(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dangerPoisonPath), g.Group(children))
}

func Departure(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(departurePath), g.Group(children))
}

func DeskForLaptop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(deskForLaptopPath), g.Group(children))
}

func Discotheque(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(discothequePath), g.Group(children))
}
...
func DoNotSit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doNotSitPath), g.Group(children))
}

func DoNotSkateboardRollerboard(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doNotSkateboardRollerboardPath), g.Group(children))
}

func DoNotStandHere(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doNotStandHerePath), g.Group(children))
}

func DownAngleArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downAngleArrowPath), g.Group(children))
}

func DownArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downArrowPath), g.Group(children))
}

func DownLeftArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downLeftArrowPath), g.Group(children))
}

func DownLeftTwoShortArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downLeftTwoShortArrowPath), g.Group(children))
}

func DownRightArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downRightArrowPath), g.Group(children))
}

func DownRightTwoShortArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downRightTwoShortArrowPath), g.Group(children))
}

func DownTwoShortArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downTwoShortArrowPath), g.Group(children))
}

func DrinkingFountain(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(drinkingFountainPath), g.Group(children))
}
...
func DroneZone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(droneZonePath), g.Group(children))
}

func EBikeOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(eBikeOnePath), g.Group(children))
}

func EBikeTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(eBikeTwoPath), g.Group(children))
}

func ElderlyPeoplePrioritySeating(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(elderlyPeoplePrioritySeatingPath), g.Group(children))
}

func ElectricScooter(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(electricScooterPath), g.Group(children))
}

func ElectricWheelchair(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(electricWheelchairPath), g.Group(children))
}
...
func ElevatorAccesible(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(elevatorAccesiblePath), g.Group(children))
}

func ElevatorPerson(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(elevatorPersonPath), g.Group(children))
}

func EmergencyExit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emergencyExitPath), g.Group(children))
}
...
func EscalatorDownArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(escalatorDownArrowPath), g.Group(children))
}

func EscalatorDownPerson(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(escalatorDownPersonPath), g.Group(children))
}

func EscalatorUpArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(escalatorUpArrowPath), g.Group(children))
}

func EscalatorUpPerson(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(escalatorUpPersonPath), g.Group(children))
}

func ExclamationMark(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(exclamationMarkPath), g.Group(children))
}
...
func FaceScan(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(faceScanPath), g.Group(children))
}

func FallingRocks(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fallingRocksPath), g.Group(children))
}

func FemaleSign(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(femaleSignPath), g.Group(children))
}
...
func FireAlarm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fireAlarmPath), g.Group(children))
}
...
func FireHazard(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fireHazardPath), g.Group(children))
}

func FireHose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fireHosePath), g.Group(children))
}
...
func FishingArea(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fishingAreaPath), g.Group(children))
}

func FishingAreaOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fishingAreaOnePath), g.Group(children))
}

func FishingAreaTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fishingAreaTwoPath), g.Group(children))
}

func FlashAllowed(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(flashAllowedPath), g.Group(children))
}

func FlashNotAllowed(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(flashNotAllowedPath), g.Group(children))
}
...
func Forbidden(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(forbiddenPath), g.Group(children))
}

func ForbiddenTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(forbiddenTwoPath), g.Group(children))
}

func Fountain(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fountainPath), g.Group(children))
}

func Fragile(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fragilePath), g.Group(children))
}

func FunicularRailway(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(funicularRailwayPath), g.Group(children))
}
...
func GasStation(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gasStationPath), g.Group(children))
}

func GiftShop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(giftShopPath), g.Group(children))
}
...
func GolfCourse(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(golfCoursePath), g.Group(children))
}

func GroupTraining(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(groupTrainingPath), g.Group(children))
}

func GuestHeightLimit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(guestHeightLimitPath), g.Group(children))
}

func GuestWithinHeightLimitMustBeSupervised(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(guestWithinHeightLimitMustBeSupervisedPath), g.Group(children))
}
...
func HealthServices(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(healthServicesPath), g.Group(children))
}
...
func Helicopter(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(helicopterPath), g.Group(children))
}

func HideEyeCrossbar(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hideEyeCrossbarPath), g.Group(children))
}

func HighVoltage(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(highVoltagePath), g.Group(children))
}

func Hiking(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hikingPath), g.Group(children))
}

func HoldTight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(holdTightPath), g.Group(children))
}
...
func HomeTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeTwoPath), g.Group(children))
}
...
func HotelRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hotelRoomPath), g.Group(children))
}

func HotelRoomTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hotelRoomTwoPath), g.Group(children))
}

func Hydrant(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hydrantPath), g.Group(children))
}
...
func InPatient(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(inPatientPath), g.Group(children))
}

func InformationDeskPeople(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(informationDeskPeoplePath), g.Group(children))
}

func InformationDeskSymbol(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(informationDeskSymbolPath), g.Group(children))
}

func IntensiveCare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(intensiveCarePath), g.Group(children))
}
...
func Kitchen(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(kitchenPath), g.Group(children))
}

func Laboratory(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(laboratoryPath), g.Group(children))
}
...
func LaundryTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(laundryTwoPath), g.Group(children))
}

func LeftAngleArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(leftAngleArrowPath), g.Group(children))
}

func LeftArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(leftArrowPath), g.Group(children))
}

func LeftLuggage(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(leftLuggagePath), g.Group(children))
}

func LeftTwoShortArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(leftTwoShortArrowPath), g.Group(children))
}

func LessMinus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lessMinusPath), g.Group(children))
}

func LgbtFriendly(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lgbtFriendlyPath), g.Group(children))
}
...
func LocationOff(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(locationOffPath), g.Group(children))
}
...
func Lockers(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lockersPath), g.Group(children))
}

func LostAndFound(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lostAndFoundPath), g.Group(children))
}
...
func LuggageCheckIn(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(luggageCheckInPath), g.Group(children))
}

func LuggageConveyorBelt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(luggageConveyorBeltPath), g.Group(children))
}

func LuggageLockers(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(luggageLockersPath), g.Group(children))
}

func LuggageTrolley(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(luggageTrolleyPath), g.Group(children))
}
...
func MaleSign(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(maleSignPath), g.Group(children))
}
...
func Massage(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(massagePath), g.Group(children))
}

func MedicalLaboratory(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(medicalLaboratoryPath), g.Group(children))
}

func MeetingPoint(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(meetingPointPath), g.Group(children))
}

func MeetingPointTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(meetingPointTwoPath), g.Group(children))
}

func MeetingRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(meetingRoomPath), g.Group(children))
}

func MenRestroom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menRestroomPath), g.Group(children))
}
...
func MoreAddPlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moreAddPlusPath), g.Group(children))
}
...
func MriPet(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mriPetPath), g.Group(children))
}
...
func MusicRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(musicRoomPath), g.Group(children))
}

func MuteNotification(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(muteNotificationPath), g.Group(children))
}

func Newspapers(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(newspapersPath), g.Group(children))
}

func NoAccessForServiceAnimalFour(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noAccessForServiceAnimalFourPath), g.Group(children))
}

func NoAccessForServiceAnimalThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noAccessForServiceAnimalThreePath), g.Group(children))
}

func NoAccessForServiceAnimalTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noAccessForServiceAnimalTwoPath), g.Group(children))
}

func NoAlcohol(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noAlcoholPath), g.Group(children))
}

func NoDrinkingWater(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noDrinkingWaterPath), g.Group(children))
}

func NoDroneAllowed(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noDroneAllowedPath), g.Group(children))
}

func NoDrugOrSubstance(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noDrugOrSubstancePath), g.Group(children))
}

func NoElectricScooter(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noElectricScooterPath), g.Group(children))
}

func NoEntryForPedestrians(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noEntryForPedestriansPath), g.Group(children))
}

func NoFirearmWeapon(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noFirearmWeaponPath), g.Group(children))
}

func NoFishingOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noFishingOnePath), g.Group(children))
}

func NoFood(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noFoodPath), g.Group(children))
}

func NoLitterTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noLitterTwoPath), g.Group(children))
}

func NoLuggageTrolleysBeyondThisPoint(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noLuggageTrolleysBeyondThisPointPath), g.Group(children))
}

func NoNoise(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noNoisePath), g.Group(children))
}

func NoParking(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noParkingPath), g.Group(children))
}

func NoPetsAllowed(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noPetsAllowedPath), g.Group(children))
}

func NoPictures(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noPicturesPath), g.Group(children))
}

func NoRunning(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noRunningPath), g.Group(children))
}

func NoSelfieStickAllowed(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noSelfieStickAllowedPath), g.Group(children))
}
...
func NoTouch(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noTouchPath), g.Group(children))
}

func NoVideo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noVideoPath), g.Group(children))
}

func NoWheelchairAccess(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noWheelchairAccessPath), g.Group(children))
}

func Nursery(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(nurseryPath), g.Group(children))
}
...
func OfficePod(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(officePodPath), g.Group(children))
}
...
func ParentAndInfantPrioritySeating(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(parentAndInfantPrioritySeatingPath), g.Group(children))
}
...
func Passports(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(passportsPath), g.Group(children))
}

func Patio(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(patioPath), g.Group(children))
}

func Pedestrians(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pedestriansPath), g.Group(children))
}
...
func PersonalTraining(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(personalTrainingPath), g.Group(children))
}

func PetsAllowed(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(petsAllowedPath), g.Group(children))
}
...
func PhysicalTherapy(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(physicalTherapyPath), g.Group(children))
}

func Pilates(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pilatesPath), g.Group(children))
}
...
func Plastic(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(plasticPath), g.Group(children))
}
...
func PlayRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(playRoomPath), g.Group(children))
}
...
func Port(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(portPath), g.Group(children))
}

func PrayingRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(prayingRoomPath), g.Group(children))
}

func PregnantWomanPrioritySeating(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pregnantWomanPrioritySeatingPath), g.Group(children))
}
...
func ProjectionRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(projectionRoomPath), g.Group(children))
}

func ProstheticArm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(prostheticArmPath), g.Group(children))
}

func ProstheticLeg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(prostheticLegPath), g.Group(children))
}

func Pull(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pullPath), g.Group(children))
}

func Push(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pushPath), g.Group(children))
}
...
func QuietArea(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(quietAreaPath), g.Group(children))
}
...
func Radiology(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(radiologyPath), g.Group(children))
}

func RampDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rampDownPath), g.Group(children))
}

func RampDownArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rampDownArrowPath), g.Group(children))
}

func RampUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rampUpPath), g.Group(children))
}

func RampUpArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rampUpArrowPath), g.Group(children))
}

func ReceptionHotelBell(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(receptionHotelBellPath), g.Group(children))
}

func RecordingStudio(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(recordingStudioPath), g.Group(children))
}
...
func RefillForWaterBottle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(refillForWaterBottlePath), g.Group(children))
}

func Refrigeration(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(refrigerationPath), g.Group(children))
}

func RemoveXCross(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(removeXCrossPath), g.Group(children))
}
...
func RightAngleArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rightAngleArrowPath), g.Group(children))
}

func RightArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rightArrowPath), g.Group(children))
}

func RightTwoShortArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rightTwoShortArrowPath), g.Group(children))
}

func RvTrailer(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rvTrailerPath), g.Group(children))
}

func SafeSocialDistancing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(safeSocialDistancingPath), g.Group(children))
}

func SanitizeHands(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sanitizeHandsPath), g.Group(children))
}

func Sauna(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(saunaPath), g.Group(children))
}

func SchoolZone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(schoolZonePath), g.Group(children))
}
...
func ServiceAnimalOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(serviceAnimalOnePath), g.Group(children))
}

func ServiceAnimalThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(serviceAnimalThreePath), g.Group(children))
}

func ServiceAnimalTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(serviceAnimalTwoPath), g.Group(children))
}
...
func Showers(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(showersPath), g.Group(children))
}

func SignLanguage(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(signLanguagePath), g.Group(children))
}

func SkatePark(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(skateParkPath), g.Group(children))
}
...
func SmokingArea(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(smokingAreaPath), g.Group(children))
}

func Socket(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socketPath), g.Group(children))
}

func Spinning(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(spinningPath), g.Group(children))
}
...
func StaffOnly(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(staffOnlyPath), g.Group(children))
}

func Stairs(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(stairsPath), g.Group(children))
}

func StairsDownArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(stairsDownArrowPath), g.Group(children))
}

func StairsDownPerson(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(stairsDownPersonPath), g.Group(children))
}

func StairsUpArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(stairsUpArrowPath), g.Group(children))
}

func StairsUpPerson(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(stairsUpPersonPath), g.Group(children))
}

func StandHere(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(standHerePath), g.Group(children))
}
...
func StrollerParking(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(strollerParkingPath), g.Group(children))
}

func StudyRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(studyRoomPath), g.Group(children))
}
...
func Surgery(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(surgeryPath), g.Group(children))
}

func SurveillanceCamera(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(surveillanceCameraPath), g.Group(children))
}

func SwimmingPool(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(swimmingPoolPath), g.Group(children))
}
...
func Telecoil(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(telecoilPath), g.Group(children))
}

func Terrace(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(terracePath), g.Group(children))
}
...
func TrailerSites(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(trailerSitesPath), g.Group(children))
}
...
func TransgenderSign(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transgenderSignPath), g.Group(children))
}
...
func TwentyFourHours(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(twentyFourHoursPath), g.Group(children))
}

func UiPhone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(uiPhonePath), g.Group(children))
}

func UnisexRestroom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(unisexRestroomPath), g.Group(children))
}
...
func UpAngleArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(upAngleArrowPath), g.Group(children))
}

func UpArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(upArrowPath), g.Group(children))
}

func UpLeftArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(upLeftArrowPath), g.Group(children))
}

func UpLeftTwoShortArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(upLeftTwoShortArrowPath), g.Group(children))
}

func UpRightArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(upRightArrowPath), g.Group(children))
}

func UpRightTwoShortArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(upRightTwoShortArrowPath), g.Group(children))
}

func UpTwoShortArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(upTwoShortArrowPath), g.Group(children))
}
...
func VendingMachine(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vendingMachinePath), g.Group(children))
}
...
func VisualImpairment(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(visualImpairmentPath), g.Group(children))
}
...
func VolumeControlTelephone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(volumeControlTelephonePath), g.Group(children))
}

func WaitingRoom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(waitingRoomPath), g.Group(children))
}

func Walker(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(walkerPath), g.Group(children))
}

func WashHands(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(washHandsPath), g.Group(children))
}

func Waste(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wastePath), g.Group(children))
}

func Wc(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wcPath), g.Group(children))
}

func WearGasMask(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wearGasMaskPath), g.Group(children))
}

func WearGloves(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wearGlovesPath), g.Group(children))
}

func WearGoggles(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wearGogglesPath), g.Group(children))
}

func WearHardHat(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wearHardHatPath), g.Group(children))
}

func WearHeadset(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wearHeadsetPath), g.Group(children))
}

func WearMask(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wearMaskPath), g.Group(children))
}

func Weightlifting(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(weightliftingPath), g.Group(children))
}

func WetFloor(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wetFloorPath), g.Group(children))
}

func WheelchairBasketball(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wheelchairBasketballPath), g.Group(children))
}

func WheelchairOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wheelchairOnePath), g.Group(children))
}

func WheelchairTennis(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wheelchairTennisPath), g.Group(children))
}

func WheelchairTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wheelchairTwoPath), g.Group(children))
}
...
func WomenRestroom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(womenRestroomPath), g.Group(children))
}
