...
func AdminTwo(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M384 256c-70.7 0-128 57.3-128 128s57.3 128 128 128s128-57.3 128-128s-57.3-128-128-128zm85.3 149.3H298.7v-42.7h170.7v42.7zm-256-21.3c0-87 65.2-158.7 149.3-169.2v-1.5c5.5-8 21.3-21.3 21.3-42.7s-21.3-42.7-21.3-53.3C362.7 32 319.2 0 256 0c-60.5 0-106.7 32-106.7 117.3c0 10.7-21.3 32-21.3 53.3s15.2 35.4 21.3 42.7c0 0 0 21.3 10.7 53.3c0 10.7 21.3 21.3 32 32c0 10.7 0 21.3-10.7 42.7L64 362.7C21.3 373.3 0 448 0 512h271.4c-35.5-31.3-58.1-77-58.1-128z"/>`),
		g.Group(children),
	)
}
...
func Brightest(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
...
func CercleSix(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
...
func CercleThree(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
...
func Circle(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<circle cx="256" cy="256" r="256" fill="currentColor"/>`),
		g.Group(children),
	)
}
...
func FolderThree(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
...
func LeftUpCornerArrowOne(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M197.8 128L302.5 23.3L0 0l23.3 302.5L128 197.8L442.2 512l69.8-69.8z"/>`),
		g.Group(children),
	)
}
...
func Mic(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M155.7 320.3c2.8 23.3 24.9 42.4 49 42.4h87.8c24.1 0 46.2-19.1 49-42.4l11.7-96.6c2.8-23.3 2.8-61.4 0-84.8l-11.7-96.6C338.6 19 316.5 0 292.4 0h-87.8c-24.1 0-46.2 19.1-49 42.4L144 138.9c-2.8 23.3-2.8 61.5 0 84.8l11.7 96.6zm263.4-149.6h-42.6c.4 19.5-.3 40.2-2.2 55.6l-11.7 96.6c-4.1 34.3-34.9 61.1-70.2 61.1h-87.8c-35.2 0-66-26.9-70.2-61.1l-11.7-96.6c-1.9-15.4-2.6-36.1-2.2-55.6H77.9c-.4 21.3.4 43.6 2.5 60.7L92.1 328c6.7 55.3 56.1 98.6 112.5 98.6h22.6v42.7h-64V512h170.7v-42.7h-64v-42.7h22.6c56.5 0 105.9-43.4 112.5-98.7l11.7-96.7c2-17 2.8-39.3 2.4-60.5z"/>`),
		g.Group(children),
	)
}
...
func Musk(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
...
func Netwark(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
...
func ParagraphSeven(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M128 464h256v-64H128v64zM0 357.3h512v-64H0v64zm0-106.6h512v-64H0v64zM0 80v64h512V80H0z"/>`),
		g.Group(children),
	)
}
...
func ParagraphTwo(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M0 462h256v-64H0v64zm0-106.7h512v-64H0v64zm256-170.6H0v64h256v-64zM0 78v64h512V78H0z"/>`),
		g.Group(children),
	)
}
...
func PartOfCircleFive(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M256 0v256L75 75C28.6 121.3 0 185.3 0 256c0 141.4 114.6 256 256 256s256-114.6 256-256S397.4 0 256 0z"/>`),
		g.Group(children),
	)
}
...
func Play(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M0 0v512l512-256z"/>`),
		g.Group(children),
	)
}
...
func RoundArrowFive(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
...
func RoundArrowTwo(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
...
func SmsFive(children ...g.Node) g.Node {
	return s.SVG(
		g.Attr("viewbox", "0 0 512 512"),
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M256 0C114.6 0 0 85.9 0 192c0 75 57.5 139.8 141.1 171.4L85.3 512l160.5-128.4c3.4.1 6.7.4 10.2.4c141.4 0 256-85.9 256-192S397.4 0 256 0z"/>`),
		g.Group(children),
	)
}
...
func StopOne(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M465.5 0h-419C20.9 0 0 20.9 0 46.5v418.9C0 491.1 20.9 512 46.5 512h418.9c25.7 0 46.5-20.9 46.5-46.5v-419C512 20.9 491.1 0 465.5 0z"/>`),
		g.Group(children),
	)
}
...
func Subtraction(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zm149.3 277.3c0 11.8-9.5 21.3-21.3 21.3H128c-11.8 0-21.3-9.6-21.3-21.3v-42.7c0-11.8 9.5-21.3 21.3-21.3h256c11.8 0 21.3 9.6 21.3 21.3v42.7z"/>`),
		g.Group(children),
	)
}
...
func Switch(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M469.3 362.7H42.7C19.1 362.7 0 381.8 0 405.3V448c0 23.5 19.1 42.7 42.7 42.7h426.7c23.5 0 42.7-19.1 42.7-42.7v-42.7c-.1-23.5-19.2-42.6-42.8-42.6zM85.3 448H42.7v-42.7h42.7V448zm298.7 0h-21.3v-42.7H384V448zm42.7 0h-21.3v-42.7h21.3V448zm42.6 0H448v-42.7h21.3V448zm0-256H42.7C19.1 192 0 211.1 0 234.7v42.7C0 300.9 19.1 320 42.7 320h426.7c23.5 0 42.7-19.1 42.7-42.7v-42.7c-.1-23.5-19.2-42.6-42.8-42.6zm-384 85.3H42.7v-42.7h42.7v42.7zm298.7 0h-21.3v-42.7H384v42.7zm42.7 0h-21.3v-42.7h21.3v42.7zm42.6 0H448v-42.7h21.3v42.7zm0-256H42.7C19.1 21.3 0 40.5 0 64v42.7c0 23.5 19.1 42.7 42.7 42.7h426.7c23.5 0 42.7-19.1 42.7-42.7V64c-.1-23.5-19.2-42.7-42.8-42.7zm-384 85.4H42.7V64h42.7v42.7zm298.7 0h-21.3V64H384v42.7zm42.7 0h-21.3V64h21.3v42.7zm42.6 0H448V64h21.3v42.7z"/>`),
		g.Group(children),
	)
}
...
func Time(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zm0 469.3c-117.8 0-213.3-95.5-213.3-213.3c0-117.8 95.5-213.3 213.3-213.3c117.8 0 213.3 95.5 213.3 213.3c0 117.8-95.5 213.3-213.3 213.3zm21.3-256v-128h-42.7V320l128-128l-32-32l-53.3 53.3z"/>`),
		g.Group(children),
	)
}
...
func TimeFour(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zm0 469.3c-117.8 0-213.3-95.5-213.3-213.3c0-117.8 95.5-213.3 213.3-213.3c117.8 0 213.3 95.5 213.3 213.3c0 117.8-95.5 213.3-213.3 213.3zm-21.3-234.6H128v42.7h149.3v-192h-42.7v149.3z"/>`),
		g.Group(children),
	)
}
...
func TimeTwo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zm0 469.3c-117.8 0-213.3-95.5-213.3-213.3c0-117.8 95.5-213.3 213.3-213.3c117.8 0 213.3 95.5 213.3 213.3c0 117.8-95.5 213.3-213.3 213.3zm21.3-384h-42.7V256l96 96l32-32l-85.3-85.3V85.3z"/>`),
		g.Group(children),
	)
}
...
func ZoomMinus(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M325.8 0C223 0 139.6 83.4 139.6 186.2c0 33.5 9 64.8 24.4 92L0 442.2l23.3 46.5L69.8 512l164-164c27.1 15.5 58.5 24.4 92 24.4C428.6 372.4 512 289 512 186.2S428.6 0 325.8 0zm0 314.2c-70.7 0-128-57.3-128-128s57.3-128 128-128s128 57.3 128 128s-57.3 128-128 128zM256 209.5h139.6V163H256v46.5z"/>`),
		g.Group(children),
	)
}
...
func ZoomPlus(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M325.8 0C223 0 139.6 83.4 139.6 186.2c0 33.5 9 64.8 24.4 92L0 442.2l23.3 46.5L69.8 512l164-164c27.2 15.5 58.5 24.4 92 24.4C428.6 372.4 512 289 512 186.2S428.6 0 325.8 0zm0 314.2c-70.7 0-128-57.3-128-128s57.3-128 128-128s128 57.3 128 128s-57.3 128-128 128zm23.3-197.8h-46.5v46.5H256v46.5h46.5V256H349v-46.5h46.5V163H349v-46.6z"/>`),
		g.Group(children),
	)
}
