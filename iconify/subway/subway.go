...
func IconFromName(name string) g.Node {
	...
	case "circle":
		return Circle()
	case "closeCornerArrowOne":
		return CloseCornerArrowOne()
	case "closeCornerArrowTwo":
		return CloseCornerArrowTwo()
	case "closeTwo":
		return CloseTwo()
	case "cloth":
		return Cloth()
	...
	case "downloadTwo":
		return DownloadTwo()
	case "dubleCornerArrowBlodTwo":
		return DubleCornerArrowBlodTwo()
	case "dubleCornerArrowFive":
		return DubleCornerArrowFive()
	case "dubleCornerArrowFour":
		return DubleCornerArrowFour()
	case "dubleCornerArrowOne":
		return DubleCornerArrowOne()
	case "dubleCornerArrowSix":
		return DubleCornerArrowSix()
	case "dubleCornerArrowThree":
		return DubleCornerArrowThree()
	case "equal":
		return Equal()
	case "equalOne":
		return EqualOne()
	...
	case "homeTwo":
		return HomeTwo()
	case "hulfOfCircleTwo":
		return HulfOfCircleTwo()
	case "hurt":
		return Hurt()
	case "hurtOne":
		return HurtOne()
	...
	case "image":
		return Image()
	case "joinCornerArrowFive":
		return JoinCornerArrowFive()
	case "joinCornerArrowFour":
		return JoinCornerArrowFour()
	case "joinCornerArrowOne":
		return JoinCornerArrowOne()
	case "joinCornerArrowSix":
		return JoinCornerArrowSix()
	case "joinCornerArrowThree":
		return JoinCornerArrowThree()
	case "joinCornerArrowTwo":
		return JoinCornerArrowTwo()
	case "key":
		return Key()
	case "leftArrow":
		return LeftArrow()
	case "leftArrowOne":
		return LeftArrowOne()
	case "leftDownCornerArrow":
		return LeftDownCornerArrow()
	case "leftDownCornerArrowOne":
		return LeftDownCornerArrowOne()
	case "leftUpCornerArrow":
		return LeftUpCornerArrow()
	case "leftUpCornerArrowOne":
		return LeftUpCornerArrowOne()
	case "like":
		return Like()
	case "location":
		return Location()
	...
	case "partOfCircle":
		return PartOfCircle()
	case "partOfCircleFive":
		return PartOfCircleFive()
	case "partOfCircleFour":
		return PartOfCircleFour()
	case "partOfCircleOne":
		return PartOfCircleOne()
	case "partOfCircleThree":
		return PartOfCircleThree()
	case "partOfCircleTwo":
		return PartOfCircleTwo()
	case "passing":
		return Passing()
	case "pause":
		return Pause()
	...
	case "rectangle":
		return Rectangle()
	case "rectangleFour":
		return RectangleFour()
	case "rectangleOne":
		return RectangleOne()
	case "rectangleThree":
		return RectangleThree()
	case "rectangleTwo":
		return RectangleTwo()
	case "rectangular":
		return Rectangular()
	...
	case "rightArrow":
		return RightArrow()
	case "rightArrowOne":
		return RightArrowOne()
	case "rightDownCornerArrow":
		return RightDownCornerArrow()
	case "rightDownCornerArrowOne":
		return RightDownCornerArrowOne()
	case "rightUpCornerArrow":
		return RightUpCornerArrow()
	case "rightUpCornerArrowOne":
		return RightUpCornerArrowOne()
	case "roundArrowFive":
		return RoundArrowFive()
	case "roundArrowFour":
		return RoundArrowFour()
	case "roundArrowOne":
		return RoundArrowOne()
	case "roundArrowSix":
		return RoundArrowSix()
	case "roundArrowThree":
		return RoundArrowThree()
	case "roundArrowTwo":
		return RoundArrowTwo()
	case "save":
		return Save()
	case "search":
		return Search()
