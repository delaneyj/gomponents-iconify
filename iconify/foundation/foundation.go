...
func IconFromName(name string) g.Node {
	...
	case "pageExport":
		return PageExport()
	case "pageExportCsv":
		return PageExportCsv()
	case "pageExportDoc":
		return PageExportDoc()
	case "pageExportPdf":
		return PageExportPdf()
	case "pageFilled":
		return PageFilled()
	case "pageMultiple":
		return PageMultiple()
	...
	case "priceTag":
		return PriceTag()
	case "pricetagMultiple":
		return PricetagMultiple()
	case "print":
		return Print()
	case "prohibited":
		return Prohibited()
	...
	case "results":
		return Results()
	case "resultsDemographics":
		return ResultsDemographics()
	case "rewind":
		return Rewind()
	case "rewindTen":
		return RewindTen()
	...
	case "socialBing":
		return SocialBing()
	case "socialBlogger":
		return SocialBlogger()
	case "socialDelicious":
		return SocialDelicious()
	case "socialDesignerNews":
		return SocialDesignerNews()
	case "socialDeviantArt":
		return SocialDeviantArt()
	case "socialDigg":
		return SocialDigg()
	case "socialDribbble":
	...
	case "socialEvernote":
		return SocialEvernote()
	case "socialFacebook":
		return SocialFacebook()
	case "socialFiveHundredPx":
		return SocialFiveHundredPx()
	case "socialFlickr":
		return SocialFlickr()
	case "socialForrst":
		return SocialForrst()
	case "socialFoursquare":
		return SocialFoursquare()
	case "socialGameCenter":
		return SocialGameCenter()
	case "socialGithub":
		return SocialGithub()
	case "socialGooglePlus":
		return SocialGooglePlus()
	case "socialHackerNews":
		return SocialHackerNews()
	case "socialHiFive":
		return SocialHiFive()
	...
	case "socialReddit":
		return SocialReddit()
	case "socialSkillshare":
		return SocialSkillshare()
	case "socialSkype":
		return SocialSkype()
	case "socialSmashingMag":
		return SocialSmashingMag()
	case "socialSnapchat":
		return SocialSnapchat()
	case "socialSpotify":
		return SocialSpotify()
	case "socialSquidoo":
		return SocialSquidoo()
	case "socialStackOverflow":
		return SocialStackOverflow()
	case "socialSteam":
		return SocialSteam()
	case "socialStumbleupon":
		return SocialStumbleupon()
	case "socialTreehouse":
		return SocialTreehouse()
	case "socialTumblr":
		return SocialTumblr()
	case "socialTwitter":
	...
	case "telephone":
		return Telephone()
	case "telephoneAccessible":
		return TelephoneAccessible()
	case "textColor":
		return TextColor()
	case "thumbnails":
		return Thumbnails()
	...
	case "torsosAll":
		return TorsosAll()
	case "torsosAllFemale":
		return TorsosAllFemale()
	case "torsosFemaleMale":
		return TorsosFemaleMale()
	case "torsosMaleFemale":
		return TorsosMaleFemale()
	case "trash":
		return Trash()
	case "trees":
		return Trees()
...
func AddressBook(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Attr("height", "none"),
		g.Attr("style", "width: 20px; height: 20px; display: block;"),
