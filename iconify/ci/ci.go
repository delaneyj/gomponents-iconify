...
const (
	IconifyVersion                    = ""
	addColumnPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 17h3m0 0h3m-3 0v-3m0 3v3m6 1h1a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v6"/>`
	addMinusSquarePath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h8M4 16.8V7.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C5.52 4 6.08 4 7.2 4h9.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C20 5.52 20 6.08 20 7.2v9.6c0 1.12 0 1.68-.218 2.108a2.001 2.001 0 0 1-.874.874c-.428.218-.986.218-2.104.218H7.197c-1.118 0-1.678 0-2.105-.218a2 2 0 0 1-.874-.874C4 18.48 4 17.92 4 16.8Z"/>`
	addPlusPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 12h6m0 0h6m-6 0v6m0-6V6"/>`
	addPlusCirclePath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h4m0 0h4m-4 0v4m0-4V8m0 13a9 9 0 1 1 0-18a9 9 0 0 1 0 18Z"/>`
	addPlusSquarePath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h4m0 0h4m-4 0v4m0-4V8m-8 8.8V7.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C5.52 4 6.08 4 7.2 4h9.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C20 5.52 20 6.08 20 7.2v9.6c0 1.12 0 1.68-.218 2.108a2.001 2.001 0 0 1-.874.874c-.428.218-.986.218-2.104.218H7.197c-1.118 0-1.678 0-2.105-.218a2 2 0 0 1-.874-.874C4 18.48 4 17.92 4 16.8Z"/>`
	addRowPath                        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 14v1a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-6m-3-3H7m0 0H4m3 0V5m0 3v3"/>`
	addToQueuePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9v10.4c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437C3.76 21 4.04 21 4.598 21H15m-1-8v-3m0 0V7m0 3h-3m3 0h3M7 13.8V6.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C8.52 3 9.08 3 10.2 3h7.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C21 4.52 21 5.08 21 6.2v7.6c0 1.12 0 1.68-.218 2.108a2.001 2.001 0 0 1-.874.874c-.428.218-.986.218-2.104.218h-7.607c-1.118 0-1.678 0-2.105-.218a2 2 0 0 1-.874-.874C7 15.48 7 14.92 7 13.8Z"/>`
	adobeXdPath                       = `<path fill="currentColor" d="M18 22H6a4 4 0 0 1-4-4V6a4 4 0 0 1 4-4h12a4 4 0 0 1 4 4v12a4 4 0 0 1-4 4ZM6 4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H6Zm9.762 12.776a3.188 3.188 0 0 1-2.351-.9a3.762 3.762 0 0 1-.928-2.69a3.8 3.8 0 0 1 .955-2.6a3.422 3.422 0 0 1 2.587-1.069h.233v-2c0-.156.127-.283.283-.284h1.317a.29.29 0 0 1 .2.07a.263.263 0 0 1 .082.2v7.679c-.005.265.009.53.04.793V16a.286.286 0 0 1-.056.177a.34.34 0 0 1-.121.094a5.188 5.188 0 0 1-2.222.506l-.019-.001Zm-.916-5.116l-.005.006a2.222 2.222 0 0 0-.45 1.455a2.264 2.264 0 0 0 .443 1.524c.267.294.652.454 1.049.434a1.63 1.63 0 0 0 .375-.038v-3.849a1.31 1.31 0 0 0-.284-.029a1.436 1.436 0 0 0-1.128.5v-.003Zm-2.621 5h-1.451a.358.358 0 0 1-.354-.22l-.21-.44l-.005-.011L10 15.58l-.064-.133c-.319-.658-.648-1.336-.978-2.034a125.419 125.419 0 0 1-1.417 3.031v.01l-.005.009a.4.4 0 0 1-.136.137a.354.354 0 0 1-.188.05H5.841a.264.264 0 0 1-.263-.179a.282.282 0 0 1 .043-.245l2.229-4.261l-2.156-4.314a.27.27 0 0 1-.012-.288a.273.273 0 0 1 .234-.131H7.35a.372.372 0 0 1 .2.046a.33.33 0 0 1 .136.163c.536 1.125.988 2.1 1.383 2.965c.491-1.1 1.013-2.218 1.363-2.959l.005-.011l.006-.01v-.011a.495.495 0 0 1 .093-.115a.332.332 0 0 1 .221-.077H12.1a.266.266 0 0 1 .247.151a.285.285 0 0 1-.023.263l-2.157 4.187l2.282 4.4a.3.3 0 0 1 .029.259a.266.266 0 0 1-.253.175v.002Z"/>`
	airplayPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6.25 17h-.053c-1.118 0-1.678 0-2.105-.218a2.001 2.001 0 0 1-.874-.875C3 15.48 3 14.92 3 13.8V8.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C4.52 5 5.08 5 6.2 5h11.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v5.606c0 1.118 0 1.677-.218 2.104a2.002 2.002 0 0 1-.874.875C19.48 17 18.92 17 17.803 17h-.05M16 20H8l4-5l4 5Z"/>`
	alarmPath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 7v5h5m4.004-7.429L17.939 2M6.064 2L3 4.571M12 20a8 8 0 1 1 0-16a8 8 0 0 1 0 16Z"/>`
	alarmAddPath                      = `<path fill="currentColor" d="M12 22a9.121 9.121 0 0 1-9-9a9.121 9.121 0 0 1 9-9a9.121 9.121 0 0 1 9 9a9.121 9.121 0 0 1-9 9Zm0-16a7.094 7.094 0 0 0-7 7a7.094 7.094 0 0 0 7 7a7.094 7.094 0 0 0 7-7a7.094 7.094 0 0 0-7-7Zm1 12h-2v-4H7v-2h4V8h2v4h4v2h-4v4Zm7.292-11.292l-3.009-3l1.409-1.417l3.01 3l-1.41 1.416v.001Zm-16.583 0L2.292 5.291l2.991-3l1.415 1.416l-2.989 3v.001Z"/>`
	appStorePath                      = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm-4.273-7.213c-.129 0-.257.016-.383.046l-.15.041l-.594 1.017a.823.823 0 0 0 1.365.916l.062-.093l.79-1.371a1.386 1.386 0 0 0-1.1-.556h.01Zm5.484-6.127a1.944 1.944 0 0 0-.587 1.1a2.4 2.4 0 0 0 .3 1.689l3.04 5.266a.827.827 0 0 0 1.071.322a.823.823 0 0 0 .4-1.044l-.049-.1l-.8-1.391h1.19a.823.823 0 0 0 .1-1.639l-.1-.006h-2.14l-2.194-3.8l-.229-.4l-.002.003ZM6.26 12.85a.817.817 0 0 0-.815.821c0 .414.308.764.719.817l.1.005h7.48a1.16 1.16 0 0 0-.017-1.067a1.034 1.034 0 0 0-.793-.571l-.121-.006h-2.551L13.79 6.74a.828.828 0 0 0 .082-.625a.824.824 0 0 0-1.447-.29l-.062.092l-.363.634l-.359-.634a.827.827 0 0 0-1.072-.322a.825.825 0 0 0-.4 1.045l.049.1l.83 1.46l-2.685 4.65H6.26Z"/>`
	applePath                         = `<path fill="currentColor" d="M9.094 21.006a2.457 2.457 0 0 1-1.653-.766a9.899 9.899 0 0 1-1.377-1.648a11.406 11.406 0 0 1-1.459-2.893a10.653 10.653 0 0 1-.61-3.445a6.317 6.317 0 0 1 .825-3.292a4.88 4.88 0 0 1 1.73-1.751a4.663 4.663 0 0 1 2.344-.662a5.51 5.51 0 0 1 1.81.421c.459.202.941.344 1.436.422a8.564 8.564 0 0 0 1.593-.5a5.79 5.79 0 0 1 1.903-.393c.087 0 .173 0 .256.01c1.43.041 2.76.743 3.6 1.9a4.02 4.02 0 0 0-2.123 3.637a4.022 4.022 0 0 0 1.317 3.023a4.38 4.38 0 0 0 1.316.863c-.1.3-.215.59-.337.882a10.38 10.38 0 0 1-1.02 1.837a9.437 9.437 0 0 1-1.317 1.592a2.57 2.57 0 0 1-1.692.743a4.249 4.249 0 0 1-1.562-.373a4.501 4.501 0 0 0-1.68-.373a4.647 4.647 0 0 0-1.73.371a4.656 4.656 0 0 1-1.495.393l-.075.002Zm3.15-14.507c-.075 0-.15 0-.225-.009a2.893 2.893 0 0 1-.025-.359a4.17 4.17 0 0 1 1.1-2.688a4.277 4.277 0 0 1 1.35-1.009a4.03 4.03 0 0 1 1.535-.435c.015.131.015.259.015.381a4.071 4.071 0 0 1-1.04 2.66a3.643 3.643 0 0 1-2.71 1.459Z"/>`
	archivePath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6.6 9h10.8M6.6 9c-.56 0-.84 0-1.054.109a1 1 0 0 0-.437.437c-.11.214-.11.494-.11 1.054v5.2c0 1.12 0 1.68.219 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h7.606c1.117 0 1.676 0 2.104-.218c.376-.192.683-.498.875-.874c.218-.427.218-.986.218-2.104V10.59c0-.554 0-.832-.109-1.045a1.002 1.002 0 0 0-.437-.437C18.24 9 17.96 9 17.4 9M6.6 9H4.975c-.849 0-1.273 0-1.514-.148a1 1 0 0 1-.472-.938c.024-.282.277-.623.783-1.307c.147-.197.22-.296.31-.372c.119-.1.26-.172.413-.208C4.609 6 4.73 6 4.977 6h14.045c.246 0 .368 0 .482.027c.152.036.294.108.414.208c.09.076.163.174.31.372c.506.683.759 1.025.783 1.307a1 1 0 0 1-.472.938C20.298 9 19.872 9 19.023 9H17.4M10 14h4"/>`
	arrowCircleDownPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 13l3 3m0 0l3-3m-3 3V8m9 4a9 9 0 1 0-18 0a9 9 0 0 0 18 0Z"/>`
	arrowCircleDownLeftPath           = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 11v4m0 0h4m-4 0l6-6m6 3a9 9 0 1 0-18 0a9 9 0 0 0 18 0Z"/>`
	arrowCircleDownRightPath          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 15h4m0 0v-4m0 4L9 9m12 3a9 9 0 1 0-18 0a9 9 0 0 0 18 0Z"/>`
	arrowCircleLeftPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m11 9l-3 3m0 0l3 3m-3-3h8m5 0a9 9 0 1 0-18 0a9 9 0 0 0 18 0Z"/>`
	arrowCircleRightPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m13 15l3-3m0 0l-3-3m3 3H8m13 0a9 9 0 1 0-18 0a9 9 0 0 0 18 0Z"/>`
	arrowCircleUpPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 11l-3-3m0 0l-3 3m3-3v8m9-4a9 9 0 1 0-18 0a9 9 0 0 0 18 0Z"/>`
	arrowCircleUpLeftPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 9H9m0 0v4m0-4l6 6m6-3a9 9 0 1 0-18 0a9 9 0 0 0 18 0Z"/>`
	arrowCircleUpRightPath            = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13V9m0 0h-4m4 0l-6 6m12-3a9 9 0 1 0-18 0a9 9 0 0 0 18 0Z"/>`
	arrowDownLeftLgPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.636 18.364h7.07m-7.07 0v-7.072m0 7.072L18.364 5.636"/>`
	arrowDownLeftMdPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 7L7 17m0 0h8m-8 0V9"/>`
	arrowDownLeftSmPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m16 8l-8 8m0 0h6m-6 0v-6"/>`
	arrowDownLgPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m12 21l5-5m-5 5l-5-5m5 5V3"/>`
	arrowDownMdPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v14m0 0l6-6m-6 6l-6-6"/>`
	arrowDownRightLgPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364v-7.071m0 7.071h-7.071m7.07 0L5.637 5.636"/>`
	arrowDownRightMdPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m7 7l10 10m0 0V9m0 8H9"/>`
	arrowDownRightSmPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 8l8 8m0 0v-6m0 6h-6"/>`
	arrowDownSmPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 7v10m0 0l4-4m-4 4l-4-4"/>`
	arrowDownUpPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m11 16l-3 3m0 0l-3-3m3 3V5m5 3l3-3m0 0l3 3m-3-3v14"/>`
	arrowLeftLgPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m3 12l5 5m-5-5l5-5m-5 5h18"/>`
	arrowLeftMdPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m0 0l6 6m-6-6l6-6"/>`
	arrowLeftRightPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m16 13l3 3m0 0l-3 3m3-3H5m3-5L5 8m0 0l3-3M5 8h14"/>`
	arrowLeftSmPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 12H7m0 0l4 4m-4-4l4-4"/>`
	arrowReloadTwoPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 16h5v5M10 8H5V3m14.418 6.003A8 8 0 0 0 5.086 7.976m-.504 7.021a8 8 0 0 0 14.331 1.027"/>`
	arrowRightLgPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 12l-5-5m5 5l-5 5m5-5H3"/>`
	arrowRightMdPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m0 0l-6-6m6 6l-6 6"/>`
	arrowRightSmPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12h10m0 0l-4-4m4 4l-4 4"/>`
	arrowSubDownLeftPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m11 11l-5 5m0 0l5 5m-5-5h7.803c1.118 0 1.677 0 2.105-.218a2 2 0 0 0 .874-.874c.218-.428.218-.987.218-2.105V3"/>`
	arrowSubDownRightPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m13 11l5 5m0 0l-5 5m5-5h-7.803c-1.118 0-1.678 0-2.105-.218a2 2 0 0 1-.874-.874C7 14.48 7 13.92 7 12.8V3"/>`
	arrowSubLeftDownPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m13.5 12.5l-5 5m0 0l-5-5m5 5V9.7c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874c.428-.218.988-.218 2.108-.218h9.8"/>`
	arrowSubLeftUpPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m12.5 11.5l-5-5m0 0l-5 5m5-5v7.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218H20.5"/>`
	arrowSubRightDownPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m11 13l5 5m0 0l5-5m-5 5v-7.803c0-1.118 0-1.678-.218-2.105a2 2 0 0 0-.874-.874C14.48 7 13.92 7 12.8 7H3"/>`
	arrowSubRightUpPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m11 11l5-5m0 0l5 5m-5-5v7.803c0 1.118 0 1.677-.218 2.105a2.002 2.002 0 0 1-.874.874C14.48 17 13.92 17 12.803 17H3"/>`
	arrowSubUpLeftPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 13L6 8m0 0l5-5M6 8h7.8c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874c.218.427.218.987.218 2.105V21"/>`
	arrowSubUpRightPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m13 13l5-5m0 0l-5-5m5 5h-7.8c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C7 9.52 7 10.08 7 11.2V21"/>`
	arrowUndoDownLeftPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m7 11l-4 4m0 0l4 4m-4-4h13a5 5 0 0 0 0-10h-5"/>`
	arrowUndoDownRightPath            = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m17 11l4 4m0 0l-4 4m4-4H8A5 5 0 0 1 8 5h5"/>`
	arrowUndoUpLeftPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 13L3 9m0 0l4-4M3 9h13a5 5 0 0 1 0 10h-5"/>`
	arrowUndoUpRightPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m17 13l4-4m0 0l-4-4m4 4H8a5 5 0 0 0 0 10h5"/>`
	arrowUpLeftLgPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.636 5.636v7.07m0-7.07h7.07m-7.07 0l12.728 12.728"/>`
	arrowUpLeftMdPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17L7 7m0 0v8m0-8h8"/>`
	arrowUpLeftSmPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 16L8 8m0 0v6m0-6h6"/>`
	arrowUpLgPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3L7 8m5-5l5 5m-5-5v18"/>`
	arrowUpMdPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19V5m0 0l-6 6m6-6l6 6"/>`
	arrowUpRightLgPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.365 5.636h-7.071m7.07 0v7.071m0-7.07L5.638 18.363"/>`
	arrowUpRightMdPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 17L17 7m0 0H9m8 0v8"/>`
	arrowUpRightSmPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 16l8-8m0 0h-6m6 0v6"/>`
	arrowUpSmPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 17V7m0 0l-4 4m4-4l4 4"/>`
	arrowsReloadOnePath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 16H5v5m9-13h5V3M4.583 9.003a8 8 0 0 1 14.331-1.027m.504 7.021a8 8 0 0 1-14.332 1.027"/>`
	barBottomPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 15H4m16 0V7.197c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C18.48 4 17.92 4 16.8 4H7.2c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C4 5.52 4 6.08 4 7.2V15m16 0v1.803c0 1.118 0 1.677-.218 2.104a2.003 2.003 0 0 1-.875.875c-.427.218-.986.218-2.104.218H7.197c-1.118 0-1.678 0-2.105-.218a2.001 2.001 0 0 1-.874-.875C4 18.48 4 17.92 4 16.8V15"/>`
	barChartPath                      = `<path fill="currentColor" d="M21 21h-3V11h3v10Zm-5 0h-3V8h3v13Zm-5 0H8V5h3v16Zm-5 0H3v-8h3v8Z"/>`
	barChartAltPath                   = `<path fill="currentColor" d="M22 21H2V11a2 2 0 0 1 2-2h4V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v3h4a2 2 0 0 1 2 2v12ZM16 9v10h4V9h-4Zm-6-5v15h4V4h-4Zm-6 7v8h4v-8H4Z"/>`
	barChartCirclePath                = `<path fill="currentColor" fill-rule="evenodd" d="M12 20a8 8 0 1 1 0-16a8 8 0 0 1 0 16ZM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12Zm13 4h2V9h-2v7Zm-8 0h2v-5H7v5Zm4 0h2V6h-2v10Z" clip-rule="evenodd"/>`
	barChartHorizontalPath            = `<path fill="currentColor" d="M4 22H2V2h2v20Zm11-1H5v-3h10v3Zm3-5H5v-3h13v3Zm3-5H5V8h16v3Zm-8-5H5V3h8v3Z"/>`
	barChartSquarePath                = `<path fill="currentColor" d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2ZM5 5v14h14V5H5Zm12 12h-2v-7h2v7Zm-4 0h-2V7h2v10Zm-4 0H7v-5h2v5Z"/>`
	...
	chatAddPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14v-3m0 0V8m0 3H9m3 0h3m-7.876 7.701L5.6 19.921c-.833.665-1.249.998-1.599.998a1 1 0 0 1-.783-.376C3 20.27 3 19.737 3 18.671V7.201c0-1.12 0-1.681.218-2.11c.192-.376.497-.681.874-.873C4.52 4 5.08 4 6.2 4h11.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874c.218.427.218.987.218 2.105v7.607c0 1.117 0 1.676-.218 2.104a2 2 0 0 1-.874.874c-.427.218-.986.218-2.104.218H9.123c-.416 0-.625 0-.824.04a2 2 0 0 0-.507.179c-.18.092-.342.221-.665.48l-.003.002Z"/>`
	chatAltPath                       = `<path fill="currentColor" d="M16 2a2 2 0 0 1 2 2H4v11.177a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h12Z"/><path fill="currentColor" d="m14 22l-2.667-2.823H8a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v9.177a2 2 0 0 1-2 2h-3.333L14 22Zm1.805-4.823H20V8H8v9.177h4.195L14 19.087l1.805-1.91Z"/>`
	chatCheckPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 9l-4 4l-2-2m-1.876 7.701L5.6 19.921c-.833.665-1.249.998-1.599.998a1 1 0 0 1-.783-.376C3 20.27 3 19.737 3 18.671V7.201c0-1.12 0-1.681.218-2.11c.192-.376.497-.681.874-.873C4.52 4 5.08 4 6.2 4h11.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874c.218.427.218.987.218 2.105v7.607c0 1.117 0 1.676-.218 2.104a2 2 0 0 1-.874.874c-.427.218-.986.218-2.104.218H9.123c-.416 0-.625 0-.824.04a2 2 0 0 0-.507.179c-.18.092-.342.221-.665.48l-.003.002Z"/>`
	chatCirclePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.51 19.802a9 9 0 1 0-3.312-3.312l.003.005c.073.127.11.191.127.252c.016.057.02.108.016.168a1.058 1.058 0 0 1-.07.26l-.768 2.307l-.001.003c-.162.487-.243.73-.186.892c.05.142.163.253.304.304c.162.057.404-.023.889-.185l.006-.002l2.306-.769c.131-.044.198-.066.262-.07a.471.471 0 0 1 .167.017a1.3 1.3 0 0 1 .253.127l.004.003Z"/>`
	chatCircleAddPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v-3m0 0V9m0 3H9m3 0h3m-3 9a8.96 8.96 0 0 1-4.49-1.198a1.276 1.276 0 0 0-.257-.13a.475.475 0 0 0-.167-.017a1.12 1.12 0 0 0-.258.07l-2.31.769h-.002c-.487.163-.731.245-.893.187a.5.5 0 0 1-.304-.304c-.057-.162.024-.405.186-.892v-.003l.77-2.306l.002-.005c.042-.129.064-.194.068-.256a.478.478 0 0 0-.017-.168a1.228 1.228 0 0 0-.127-.252l-.003-.005A9 9 0 1 1 12 21Z"/>`
	chatCircleCheckPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 10l-4 4l-2-2m3 9a8.96 8.96 0 0 1-4.49-1.198a1.276 1.276 0 0 0-.257-.13a.475.475 0 0 0-.167-.017a1.12 1.12 0 0 0-.258.07l-2.31.769h-.002c-.487.163-.731.245-.893.187a.5.5 0 0 1-.304-.304c-.057-.162.024-.405.186-.892v-.003l.77-2.306l.002-.005c.042-.129.064-.194.068-.256a.478.478 0 0 0-.017-.168a1.228 1.228 0 0 0-.127-.252l-.003-.005A9 9 0 1 1 12 21Z"/>`
	chatCircleClosePath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m-2 7a8.959 8.959 0 0 1-4.49-1.198l-.004-.003c-.128-.073-.192-.11-.253-.127a.475.475 0 0 0-.167-.017c-.064.004-.13.026-.262.07l-2.306.769l-.006.002c-.485.162-.727.242-.889.185a.502.502 0 0 1-.304-.304c-.057-.162.024-.405.186-.892v-.003l.77-2.306c.044-.132.065-.198.07-.261a.498.498 0 0 0-.017-.168a1.228 1.228 0 0 0-.127-.252l-.003-.005A9 9 0 1 1 12 21Z"/>`
	chatCircleDotsPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.51 19.802a9 9 0 1 0-3.312-3.312l.003.005c.073.127.11.191.127.252c.016.057.02.108.016.168a1.058 1.058 0 0 1-.07.26l-.768 2.307l-.001.003c-.162.487-.243.73-.186.892c.05.142.163.253.304.304c.162.057.404-.023.889-.185l.006-.002l2.306-.769c.131-.044.198-.066.262-.07a.471.471 0 0 1 .167.017a1.3 1.3 0 0 1 .253.127l.004.003Z"/>`
	chatCircleRemovePath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-3 9a8.959 8.959 0 0 1-4.49-1.198l-.004-.003c-.128-.073-.192-.11-.253-.127a.475.475 0 0 0-.167-.017c-.064.004-.13.026-.262.07l-2.306.769l-.006.002c-.485.162-.727.242-.889.185a.502.502 0 0 1-.304-.304c-.057-.162.024-.405.186-.892v-.003l.77-2.306c.044-.132.065-.198.07-.261a.498.498 0 0 0-.017-.168a1.228 1.228 0 0 0-.127-.252l-.003-.005A9 9 0 1 1 12 21Z"/>`
	chatClosePath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m10 13l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m-6.876 5.701L5.6 19.921c-.833.665-1.249.998-1.599.998a1 1 0 0 1-.783-.376C3 20.27 3 19.737 3 18.671V7.201c0-1.12 0-1.681.218-2.11c.192-.376.497-.681.874-.873C4.52 4 5.08 4 6.2 4h11.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v7.607c0 1.117 0 1.676-.218 2.104a2 2 0 0 1-.874.874c-.427.218-.987.218-2.105.218h-8.68c-.417 0-.624 0-.823.04a2.004 2.004 0 0 0-.508.179c-.18.091-.34.22-.657.474l-.011.008Z"/>`
	chatConversationPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8h4a1 1 0 0 1 1 1v11l-3.333-2.769a1.002 1.002 0 0 0-.64-.231H9a1 1 0 0 1-1-1v-3m8-5V5a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v11l3.333-2.77c.18-.148.406-.23.64-.23H8m8-5v4a1 1 0 0 1-1 1H8"/>`
	chatConversationCirclePath        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.338 15.99a6 6 0 1 0-5.408-2.78l-.424 1.272v.002c-.163.487-.244.73-.187.893c.05.141.163.253.304.303c.162.058.404-.023.888-.184l.007-.002l1.272-.424a5.971 5.971 0 0 0 3.548.92Zm0 0s0 0 0 0Zm0 0a6.003 6.003 0 0 0 8.872 3.08l1.272.424h.003c.487.163.73.244.893.186a.5.5 0 0 0 .302-.303c.058-.162-.023-.406-.186-.895l-.424-1.272l.142-.235A6 6 0 0 0 15 8l-.225.004l-.113.006"/>`
	chatDotsPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5.6 19.92l1.524-1.219l.01-.008c.318-.255.479-.383.658-.474c.16-.082.331-.142.508-.178c.199-.041.406-.041.822-.041h8.681c1.118 0 1.678 0 2.105-.218a2 2 0 0 0 .874-.874C21 16.48 21 15.92 21 14.804V7.197c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C19.48 4 18.92 4 17.8 4H6.2c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C3 5.52 3 6.08 3 7.2v11.471c0 1.066 0 1.599.218 1.872a1 1 0 0 0 .783.377c.35 0 .766-.334 1.599-1Z"/>`
	chatRemovePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 11h6m-7.876 7.701L5.6 19.921c-.833.665-1.249.998-1.599.998a1 1 0 0 1-.783-.376C3 20.27 3 19.737 3 18.671V7.201c0-1.12 0-1.681.218-2.11c.192-.376.497-.681.874-.873C4.52 4 5.08 4 6.2 4h11.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v7.607c0 1.117 0 1.676-.218 2.104a2 2 0 0 1-.874.874c-.427.218-.987.218-2.105.218h-8.68c-.417 0-.624 0-.823.04a2.004 2.004 0 0 0-.508.179c-.18.091-.34.22-.657.474l-.011.008Z"/>`
	checkPath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m6 12l4.243 4.243l8.484-8.486"/>`
	checkAllPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 12.485l4.243 4.243l8.484-8.485M3 12.485l4.243 4.243m8.485-8.485L12.5 11.5"/>`
	checkAllBigPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m7 12l4.95 4.95L22.557 6.343M2.05 12.05L7 17M17.606 6.394l-5.303 5.303"/>`
	checkBigPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 12l4.95 4.95L19.557 6.343"/>`
	checkBoldPath                     = `<path fill="currentColor" d="m8.818 19.779l-6.364-6.364l2.83-2.83l3.534 3.544l9.898-9.908l2.83 2.83L8.818 19.779Z"/>`
	checkboxPath                      = `<path fill="currentColor" d="M17 19H7a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2ZM7 7v10h10V7H7Z"/>`
	checkboxCheckPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 12l3 3l5-6M4 16.8V7.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C5.52 4 6.08 4 7.2 4h9.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v9.607c0 1.118 0 1.677-.218 2.104a2.002 2.002 0 0 1-.875.874c-.427.218-.986.218-2.104.218H7.197c-1.118 0-1.678 0-2.105-.218a2 2 0 0 1-.874-.874C4 18.48 4 17.92 4 16.8Z"/>`
	checkboxCheckedPath               = `<path fill="currentColor" d="M17 19H7a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2ZM7 7v10h10V7H7Zm4 8.362l-2.7-2.647l1.4-1.43l1.3 1.271l3.3-3.267l1.4 1.422l-4.7 4.65v.001Z"/>`
	checkboxFillPath                  = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M4 7.2v9.6c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h9.606c1.118 0 1.677 0 2.104-.218c.377-.192.683-.498.875-.874c.218-.428.218-.986.218-2.104V7.197c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C18.48 4 17.92 4 16.8 4H7.2c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C4 5.52 4 6.08 4 7.2Z"/><path d="M15 13.4v-2.8c0-.56 0-.84-.11-1.054a.998.998 0 0 0-.436-.437C14.24 9 13.96 9 13.4 9h-2.8c-.56 0-.84 0-1.054.109a1 1 0 0 0-.437.437C9 9.76 9 10.04 9 10.6v2.8c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437c.214.109.493.109 1.052.109h2.803c.559 0 .84 0 1.053-.109a1 1 0 0 0 .437-.437C15 14.24 15 13.96 15 13.4Z"/></g>`
	checkboxSquarePath                = `<path fill="currentColor" d="M17 19H7a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2ZM7 7v10h10V7H7Zm8 8H9V9h6v6Z"/>`
	checkboxUncheckedPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7.2v9.6c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h9.606c1.118 0 1.677 0 2.104-.218c.377-.192.683-.498.875-.874c.218-.428.218-.986.218-2.104V7.197c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C18.48 4 17.92 4 16.8 4H7.2c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C4 5.52 4 6.08 4 7.2Z"/>`
	chevronBigDownPath                = `<path fill="currentColor" d="M3.515 8.465L12 16.95l8.485-8.485L19.07 7.05L12 14.122L4.929 7.05L3.515 8.465Z"/>`
	chevronBigLeftPath                = `<path fill="currentColor" d="M15.535 3.515L7.05 12l8.485 8.485l1.415-1.414L9.878 12l7.072-7.071l-1.415-1.414Z"/>`
	chevronBigRightPath               = `<path fill="currentColor" d="M8.465 20.485L16.95 12L8.465 3.515L7.05 4.929L14.122 12L7.05 19.071l1.415 1.414Z"/>`
	chevronBigUpPath                  = `<path fill="currentColor" d="M20.485 15.535L12 7.05l-8.485 8.485L4.93 16.95L12 9.878l7.071 7.072l1.414-1.415Z"/>`
	chevronDownPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 9l-7 7l-7-7"/>`
	chevronDownDuoPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m16 13l-4 4l-4-4m8-6l-4 4l-4-4"/>`
	chevronDuoDownPath                = `<path fill="currentColor" d="m12 18.424l-6.01-6.01l1.414-1.415l4.6 4.6l4.6-4.6l1.406 1.415l-6.009 6.01H12ZM12 13L5.99 6.989l1.414-1.414l4.6 4.6l4.6-4.6l1.406 1.414l-6.009 6.01L12 13Z"/>`
	chevronDuoLeftPath                = `<path fill="currentColor" d="M11.585 18.01L5.575 12l6.01-6.01L13 7.404l-4.6 4.6l4.6 4.6l-1.414 1.406h-.001Zm5.425 0L10.999 12l6.011-6.01l1.414 1.414l-4.6 4.6l4.6 4.6l-1.413 1.406h-.001Z"/>`
	chevronDuoRightPath               = `<path fill="currentColor" d="m12.414 18.01l-1.415-1.413l4.6-4.6l-4.6-4.6l1.415-1.407l6.01 6.01l-6.009 6.01h-.001Zm-5.425 0l-1.414-1.413l4.6-4.6l-4.6-4.593L6.989 5.99L13 12l-6.01 6.01h-.001Z"/>`
	chevronDuoUpPath                  = `<path fill="currentColor" d="M7.403 18.425L5.99 17.01L12 10.999l6.01 6.011l-1.413 1.413l-4.6-4.6l-4.6 4.6l.006.002Zm0-5.424L5.99 11.585L12 5.575l6.01 6.01l-1.413 1.414l-4.6-4.6l-4.6 4.6l.006.002Z"/>`
	chevronLeftPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 19l-7-7l7-7"/>`
	chevronLeftDuoPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m17 16l-4-4l4-4m-6 8l-4-4l4-4"/>`
	chevronLeftMdPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m14 16l-4-4l4-4"/>`
	chevronRightPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5l7 7l-7 7"/>`
	chevronRightDuoPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m13 8l4 4l-4 4M7 8l4 4l-4 4"/>`
	chevronRightMdPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m10 8l4 4l-4 4"/>`
	chevronUpPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 16l7-7l7 7"/>`
	chevronUpDuoPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 17l4-4l4 4m-8-6l4-4l4 4"/>`
	...
	circlePath                        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0-18 0Z"/>`
	circleCheckPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 10l-4 4l-2-2m3 9a9 9 0 1 1 0-18a9 9 0 0 1 0 18Z"/>`
	circleCheckOutlinePath            = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm-.016-2H12a8 8 0 1 0-.016 0ZM10 17l-4-4l1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8Z"/>`
	circleChevronDownPath             = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm0-18a8 8 0 1 0 8 8a8.009 8.009 0 0 0-8-8Zm-.05 11.5L7 10.55l1.414-1.414l3.536 3.535l3.536-3.535L16.9 10.55l-4.95 4.95Z"/>`
	circleChevronLeftPath             = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm0-18a8 8 0 1 0 8 8.18v1.783V12a8.009 8.009 0 0 0-8-8Zm1.45 12.9L8.5 11.95L13.45 7l1.414 1.414l-3.536 3.536l3.535 3.536l-1.412 1.414h-.001Z"/>`
	circleChevronRightPath            = `<path fill="currentColor" d="M12 22c-5.52-.006-9.994-4.48-10-10v-.2C2.11 6.305 6.635 1.928 12.13 2c5.497.074 9.904 4.569 9.868 10.065C21.962 17.562 17.497 22 12 22Zm0-18a8 8 0 1 0 8 8a8.009 8.009 0 0 0-8-8Zm-1.45 13l-1.414-1.415l3.535-3.535l-3.535-3.535L10.55 7.1l4.95 4.95L10.551 17h-.001Z"/>`
	circleChevronUpPath               = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm-.016-2H12a8 8 0 1 0-.016 0Zm-3.47-5.136L7.1 13.45l4.95-4.95L17 13.45l-1.414 1.413l-3.536-3.535l-3.535 3.536h-.001Z"/>`
	circleDownPath                    = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm0-18a8 8 0 1 0 8 8a8.009 8.009 0 0 0-8-8Zm0 13l-5-5l1.41-1.41L11 13.17V7h2v6.17l2.59-2.58L17 12l-5 5Z"/>`
	circleHelpPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.146 9.074a2.998 2.998 0 0 1 5.28-.838A3 3 0 0 1 12 13v1m0 7a9 9 0 1 1 0-18a9 9 0 0 1 0 18Zm.05-4v.1h-.1V17h.1Z"/>`
	circleLeftPath                    = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm0-18a8 8 0 1 0 8 8.18v1.783V12a8.009 8.009 0 0 0-8-8Zm0 13l-5-5l5-5l1.41 1.41L10.83 11H17v2h-6.17l2.58 2.59L12 17Z"/>`
	circleRightPath                   = `<path fill="currentColor" d="M12 22c-5.52-.006-9.994-4.48-10-10v-.2C2.11 6.305 6.635 1.928 12.13 2c5.497.074 9.904 4.569 9.868 10.065C21.962 17.562 17.497 22 12 22Zm0-18a8 8 0 1 0 8 8a8.009 8.009 0 0 0-8-8Zm0 13l-1.41-1.41L13.17 13H7v-2h6.17l-2.58-2.59L12 7l5 5l-5 5Z"/>`
	circleUpPath                      = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm-.016-2H12a8 8 0 1 0-.016 0ZM13 17h-2v-6.17l-2.59 2.58L7 12l5-5l5 5l-1.41 1.41L13 10.83V17Z"/>`
	circleWarningPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8.45v4M12 21a9 9 0 1 1 0-18a9 9 0 0 1 0 18Zm.05-5.55v.1h-.1v-.1h.1Z"/>`
	clockPath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 7v5h5m-5 9a9 9 0 1 1 0-18a9 9 0 0 1 0 18Z"/>`
	closeBigPath                      = `<path fill="currentColor" d="M17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12L19 6.41L17.59 5Z"/>`
	closeCirclePath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 9l3 3m0 0l3 3m-3-3l-3 3m3-3l3-3m-3 12a9 9 0 1 1 0-18a9 9 0 0 1 0 18Z"/>`
	closeLgPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 21l-9-9m0 0L3 3m9 9l9-9m-9 9l-9 9"/>`
	closeMdPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m18 18l-6-6m0 0L6 6m6 6l6-6m-6 6l-6 6"/>`
	closeSmPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m16 16l-4-4m0 0L8 8m4 4l4-4m-4 4l-4 4"/>`
	closeSmallPath                    = `<path fill="currentColor" d="M15.59 7L12 10.59L8.41 7L7 8.41L10.59 12L7 15.59L8.41 17L12 13.41L15.59 17L17 15.59L13.41 12L17 8.41L15.59 7Z"/>`
	...
	cloudPath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11a4 4 0 0 1 0 8H6a5 5 0 0 1-.331-9.99A7.002 7.002 0 0 1 18.929 11H19Z"/>`
	cloudAddPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 16v-3m0 0v-3m0 3H9m3 0h3m8 2a4 4 0 0 0-4.07-4A7.002 7.002 0 0 0 5.669 9.01A5 5 0 0 0 6 19h13a4 4 0 0 0 4-4Z"/>`
	cloudCheckPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 11l-4 4l-2-2m14 2a4 4 0 0 0-4.07-4A7.002 7.002 0 0 0 5.669 9.01A5 5 0 0 0 6 19h13a4 4 0 0 0 4-4Z"/>`
	cloudClosePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m10 15l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m9 0a4 4 0 0 0-4.07-4A7.002 7.002 0 0 0 5.669 9.01A5 5 0 0 0 6 19h13a4 4 0 0 0 4-4Z"/>`
	...
	commandPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 15v3a3 3 0 1 1-3-3h3Zm0 0h6m-6 0V9m6 6v3a3 3 0 1 0 3-3h-3Zm0 0V9m0 0H9m6 0V6a3 3 0 1 1 3 3h-3ZM9 9V6a3 3 0 1 0-3 3h3Z"/>`
	compassPath                       = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0-18 0Z"/><path d="M10.5 10.5L16 8l-2.5 5.5L8 16l2.5-5.5Z"/></g>`
	confusedPath                      = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm0-18a8 8 0 1 0 8 8a8.009 8.009 0 0 0-8-8Zm4 13H8v-2h8v2Zm-7.5-5a1.5 1.5 0 1 1 0-3a1.5 1.5 0 0 1 0 3Zm6.993-.014a1.493 1.493 0 1 1 0-2.986a1.493 1.493 0 0 1 0 2.986Z"/>`
	...
	globePath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12h5m-5 0a9 9 0 0 0 9 9m-9-9a9 9 0 0 1 9-9m-4 9h8m-8 0c0 4.97 1.79 9 4 9m-4-9c0-4.97 1.79-9 4-9m4 9h5m-5 0c0-4.97-1.79-9-4-9m4 9c0 4.97-1.79 9-4 9m9-9a9 9 0 0 0-9-9m9 9a9 9 0 0 1-9 9"/>`
	googlePath                        = `<path fill="currentColor" d="M11.956 10.356v3.451h4.792c-.446 2.193-2.313 3.453-4.792 3.453a5.28 5.28 0 0 1 0-10.559a5.166 5.166 0 0 1 3.29 1.178l2.6-2.6a8.93 8.93 0 1 0-5.89 15.635c4.467 0 8.529-3.249 8.529-8.934a7.468 7.468 0 0 0-.2-1.625l-8.329.001Z"/>`
	gridPath                          = `<path fill="currentColor" d="M20 20h-4v-4h4v4Zm-6 0h-4v-4h4v4Zm-6 0H4v-4h4v4Zm12-6h-4v-4h4v4Zm-6 0h-4v-4h4v4Zm-6 0H4v-4h4v4Zm12-6h-4V4h4v4Zm-6 0h-4V4h4v4ZM8 8H4V4h4v4Z"/>`
	gridBigPath                       = `<path fill="currentColor" d="M19 19h-6v-6h6v6Zm-8 0H5v-6h6v6Zm8-8h-6V5h6v6Zm-8 0H5V5h6v6Z"/>`
	gridBigRoundPath                  = `<path fill="currentColor" d="M16 19a3 3 0 1 1 0-6a3 3 0 0 1 0 6Zm-8 0a3 3 0 1 1 0-6a3 3 0 0 1 0 6Zm8-8a3 3 0 1 1 0-6a3 3 0 0 1 0 6Zm-8 0a3 3 0 1 1 0-6a3 3 0 0 1 0 6Z"/>`
	gridHorizontalPath                = `<path fill="currentColor" d="M20 17h-4v-4h4v4Zm-6 0h-4v-4h4v4Zm-6 0H4v-4h4v4Zm12-6h-4V7h4v4Zm-6 0h-4V7h4v4Zm-6 0H4V7h4v4Z"/>`
	gridHorizontalRoundPath           = `<path fill="currentColor" d="M20 17h-4v-4h4v4Zm-6 0h-4v-4h4v4Zm-6 0H4v-4h4v4Zm12-6h-4V7h4v4Zm-8 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4Zm-4 0H4V7h4v4Z"/>`
	gridRoundPath                     = `<path fill="currentColor" d="M18 20a2 2 0 1 1 0-4a2 2 0 0 1 0 4Zm-6 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4Zm-6 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4Zm12-6a2 2 0 1 1 0-4a2 2 0 0 1 0 4Zm-6 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4Zm-6 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4Zm12-6a2 2 0 1 1 0-4a2 2 0 0 1 0 4Zm-6 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4ZM6 8a2 2 0 1 1 0-4a2 2 0 0 1 0 4Z"/>`
	gridSmallPath                     = `<path fill="currentColor" d="M17 17h-4v-4h4v4Zm-6 0H7v-4h4v4Zm6-6h-4V7h4v4Zm-6 0H7V7h4v4Z"/>`
	gridSmallRoundPath                = `<path fill="currentColor" d="M17 17h-4v-4h4v4Zm-6 0H7v-4h4v4Zm6-6h-4V7h4v4Zm-8 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4Z"/>`
	gridVerticalPath                  = `<path fill="currentColor" d="M17 20h-4v-4h4v4Zm-6 0H7v-4h4v4Zm6-6h-4v-4h4v4Zm-6 0H7v-4h4v4Zm6-6h-4V4h4v4Zm-6 0H7V4h4v4Z"/>`
	gridVerticalRoundPath             = `<path fill="currentColor" d="M17 20h-4v-4h4v4Zm-6 0H7v-4h4v4Zm6-6h-4v-4h4v4Zm-8 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4Zm8-6h-4V4h4v4Zm-6 0H7V4h4v4Z"/>`
	groupPath                         = `<path fill="currentColor" d="M9 3a5 5 0 1 0 0 10A5 5 0 0 0 9 3ZM6 8a3 3 0 1 1 6 0a3 3 0 0 1-6 0Zm10.908.218A2 2 0 0 0 16 8V6a4 4 0 1 1-2.357 7.232l1.178-1.616a2 2 0 1 0 2.087-3.398ZM19.998 21A3.999 3.999 0 0 0 16 17.002V15a6.001 6.001 0 0 1 6 6h-2.002ZM16 21h-2a5 5 0 0 0-10 0H2a7 7 0 1 1 14 0Z"/>`
	groupAltPath                      = `<path fill="currentColor" d="M11 7a4 4 0 1 1-8 0a4 4 0 0 1 8 0ZM9 7a2 2 0 1 0-4 0a2 2 0 0 0 4 0Zm12 4.5a3.5 3.5 0 1 1-7 0a3.5 3.5 0 0 1 7 0Zm-2 0a1.5 1.5 0 1 0-3 0a1.5 1.5 0 0 0 3 0ZM10 21v-4a3 3 0 1 0-6 0v4H2v-4a5 5 0 0 1 10 0v4h-2Zm10-.5v.5h2v-.5a4.5 4.5 0 1 0-9 0v.5h2v-.5a2.5 2.5 0 0 1 5 0Z"/>`
	hamburgerPath                     = `<path fill="currentColor" d="M21 18H3v-2h18v2Zm0-5H3v-2h18v2Zm0-5H3V6h18v2Z"/>`
	hamburgerLgPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 17h18M3 12h18M3 7h18"/>`
	hamburgerMdPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 17h14M5 12h14M5 7h14"/>`
	handbagPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 8h-.29c-.962 0-1.443 0-1.834.175a2 2 0 0 0-.847.718c-.237.356-.316.83-.475 1.78l-.933 5.6v.003c-.214 1.28-.32 1.921-.135 2.42c.163.439.475.806.88 1.039C4.828 20 5.478 20 6.777 20h10.445c1.3 0 1.95 0 2.413-.265a2 2 0 0 0 .88-1.038c.184-.5.078-1.14-.136-2.42v-.003l-.934-5.6c-.158-.95-.237-1.425-.474-1.781a2 2 0 0 0-.847-.718C17.734 8 17.252 8 16.289 8H16M8 8h8M8 8a4 4 0 1 1 8 0"/>`
	happyPath                         = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm0-18a8 8 0 1 0 8 8a8.009 8.009 0 0 0-8-8Zm0 14a4.837 4.837 0 0 1-4-2a6.3 6.3 0 0 1-1-2h10v.008A6.422 6.422 0 0 1 16 16a4.838 4.838 0 0 1-4 2Zm-3.5-6a1.5 1.5 0 1 1 0-3a1.5 1.5 0 0 1 0 3Zm6.993-.014a1.493 1.493 0 1 1 0-2.986a1.493 1.493 0 0 1 0 2.986Z"/>`
	headingPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 5v7m0 0v7m0-7h10m0-7v7m0 0v7"/>`
	headingHFivePath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 9h-4l-1.25 5.016a2.998 2.998 0 0 1 3.555-.717a3 3 0 1 1-3.555 4.685M3 5v7m0 0v7m0-7h8m0-7v7m0 0v7"/>`
	headingHFourPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m18 9l-2.5 8H20m0 0h1m-1 0v-3m0 3v2M3 5v7m0 0v7m0-7h8m0-7v7m0 0v7"/>`
	headingHOnePath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m16 10l3-1v10M3 5v7m0 0v7m0-7h8m0-7v7m0 0v7"/>`
	headingHSixPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.402 14.525A2.974 2.974 0 0 0 16.5 18.6a3.01 3.01 0 0 0 4.099-1.092a2.973 2.973 0 0 0-1.099-4.075a3.01 3.01 0 0 0-4.098 1.092Zm0 0L19 8M3 5v7m0 0v7m0-7h8m0-7v7m0 0v7"/>`
	headingHThreePath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 9h6l-4 4h1a3 3 0 1 1-2.83 3.998M3 5v7m0 0v7m0-7h8m0-7v7m0 0v7"/>`
	headingHTwoPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12.5V12a3 3 0 0 1 3-3h.172a2.828 2.828 0 0 1 2 4.829L15 19h6M3 5v7m0 0v7m0-7h8m0-7v7m0 0v7"/>`
	headphonesPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11a7 7 0 1 0-14 0m11 3.5v2c0 .465 0 .697.038.89a2 2 0 0 0 1.572 1.572c.193.038.425.038.89.038s.697 0 .89-.038a2 2 0 0 0 1.571-1.572c.039-.193.039-.425.039-.89v-2c0-.465 0-.697-.039-.89a2 2 0 0 0-1.57-1.572C19.196 12 18.964 12 18.5 12s-.697 0-.89.038a2 2 0 0 0-1.572 1.571c-.038.194-.038.426-.038.891Zm-8 0v2c0 .465 0 .697-.039.89a2 2 0 0 1-1.57 1.572C6.196 19 5.964 19 5.5 19s-.697 0-.89-.038a2 2 0 0 1-1.572-1.572C3 17.197 3 16.965 3 16.5v-2c0-.465 0-.697.038-.89a2 2 0 0 1 1.572-1.572C4.803 12 5.035 12 5.5 12s.697 0 .89.038a2 2 0 0 1 1.571 1.571c.039.194.039.426.039.891Z"/>`
	heartFillPath                     = `<path fill="currentColor" d="M2 8.4A5.4 5.4 0 0 1 7.5 3A5.991 5.991 0 0 1 12 5a5.991 5.991 0 0 1 4.5-2A5.4 5.4 0 0 1 22 8.4c0 5.356-6.379 9.4-10 12.6C8.387 17.773 2 13.76 2 8.4Z"/>`
	heartOnePath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 7.694C10 3 3 3.5 3 9.5s9 11 9 11s9-5 9-11s-7-6.5-9-1.806Z"/>`
	heartOutlinePath                  = `<path fill="currentColor" d="M12 21c-.645-.572-1.374-1.167-2.145-1.8h-.01c-2.715-2.22-5.792-4.732-7.151-7.742c-.446-.958-.683-2-.694-3.058A5.39 5.39 0 0 1 7.5 3a6.158 6.158 0 0 1 3.328.983A5.6 5.6 0 0 1 12 5c.344-.39.738-.732 1.173-1.017A6.152 6.152 0 0 1 16.5 3A5.39 5.39 0 0 1 22 8.4a7.422 7.422 0 0 1-.694 3.063c-1.359 3.01-4.435 5.521-7.15 7.737l-.01.008c-.772.629-1.5 1.224-2.145 1.8L12 21ZM7.5 5a3.535 3.535 0 0 0-2.5.992A3.342 3.342 0 0 0 4 8.4c.011.77.186 1.53.512 2.228A12.316 12.316 0 0 0 7.069 14.1c.991 1 2.131 1.968 3.117 2.782c.273.225.551.452.829.679l.175.143c.267.218.543.444.81.666l.013-.012l.006-.005h.006l.009-.007h.01l.018-.015l.041-.033l.007-.006l.011-.008h.006l.009-.008l.664-.545l.174-.143c.281-.229.559-.456.832-.681c.986-.814 2.127-1.781 3.118-2.786a12.298 12.298 0 0 0 2.557-3.471c.332-.704.51-1.472.52-2.25A3.343 3.343 0 0 0 19 6a3.535 3.535 0 0 0-2.5-1a3.988 3.988 0 0 0-2.99 1.311L12 8.051l-1.51-1.74A3.988 3.988 0 0 0 7.5 5Z"/>`
	heartTwoPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.237 6.237a4.098 4.098 0 0 1 .135 5.654l-7.373 8.11l-7.37-8.11a4.098 4.098 0 1 1 6.23-5.316L12 8l1.14-1.425a4.098 4.098 0 0 1 6.097-.338Z"/>`
	helpPath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.195 8.765A4 4 0 1 1 12 14v1m.05 4v.1h-.1V19h.1Z"/>`
	helpCirclePath                    = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm-1-5v2h2v-2h-2Zm1-10a2 2 0 0 1 2 2a1.95 1.95 0 0 1-.59 1.41l-1.24 1.26A4.015 4.015 0 0 0 11 14.5v.5h2a3.42 3.42 0 0 1 1.17-2.83l.9-.92A3.16 3.16 0 0 0 16 9a4 4 0 0 0-8 0h2a2 2 0 0 1 2-2Z"/>`
	helpCircleOutlinePath             = `<path fill="currentColor" d="M12 22c-5.52-.006-9.994-4.48-10-10v-.2C2.11 6.305 6.635 1.928 12.13 2c5.497.074 9.904 4.569 9.868 10.065C21.962 17.562 17.497 22 12 22Zm-.016-2H12a8 8 0 1 0-.016 0ZM13 18h-2v-2h2v2Zm0-3h-2a3.583 3.583 0 0 1 1.77-3.178C13.43 11.316 14 10.88 14 10a2 2 0 1 0-4 0H8v-.09a4 4 0 1 1 8 .09a3.413 3.413 0 0 1-1.56 2.645A3.1 3.1 0 0 0 13 15Z"/>`
	helpQuestionmarkPath              = `<path fill="currentColor" d="M13 22h-3v-3h3v3Zm0-5h-3v-.007c0-1.65 0-3.075.672-4.073a6.304 6.304 0 0 1 1.913-1.62c.334-.214.649-.417.914-.628a3.712 3.712 0 0 0 1.332-3.824A3.033 3.033 0 0 0 9 8H6a6 6 0 0 1 6-6a6.04 6.04 0 0 1 5.434 3.366a6.017 6.017 0 0 1-.934 6.3c-.453.502-.96.95-1.514 1.337a7.248 7.248 0 0 0-1.316 1.167A4.23 4.23 0 0 0 13 17Z"/>`
	hidePath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 4l16 16m-3.5-3.244C15.147 17.485 13.618 18 12 18c-3.53 0-6.634-2.452-8.413-4.221c-.47-.467-.705-.7-.854-1.159c-.107-.327-.107-.913 0-1.24c.15-.459.385-.693.855-1.16c.897-.892 2.13-1.956 3.584-2.793M19.5 14.634c.333-.293.638-.582.912-.854l.003-.003c.468-.466.703-.7.852-1.156c.107-.327.107-.914 0-1.241c-.15-.458-.384-.692-.854-1.159C18.633 8.452 15.53 6 12 6c-.338 0-.671.022-1 .064m2.323 7.436a2 2 0 0 1-2.762-2.889"/>`
	homeAltCheckPath                  = `<path fill="currentColor" d="M19 22H5a1 1 0 0 1-1-1v-9.643a1.01 1.01 0 0 1 .293-.65l7-7a1 1 0 0 1 1.415 0l7 7a.994.994 0 0 1 .292.707V21a1 1 0 0 1-1 1ZM12 5.828l-6 6V20h12v-8.172l-6-6Zm-1.5 12.731l-2.706-2.7L9.2 14.441l1.3 1.292l4.3-4.292l1.412 1.416l-5.712 5.701v.001Z"/>`
	homeAltFillPath                   = `<path fill="currentColor" d="m2 13l9.293-9.293a1 1 0 0 1 1.414 0L22 13h-2v8a1 1 0 0 1-1 1h-5v-7h-4v7H5a1 1 0 0 1-1-1v-8H2Z"/>`
	homeAltMinusPath                  = `<path fill="currentColor" d="M19 22H5a1 1 0 0 1-1-1v-9.643a1.01 1.01 0 0 1 .293-.65l7-7a1 1 0 0 1 1.415 0l7 7a.994.994 0 0 1 .292.707V21a1 1 0 0 1-1 1ZM12 5.828l-6 6V20h12v-8.172l-6-6ZM16 16H8v-2h8v2Z"/>`
	homeAltOutlinePath                = `<path fill="currentColor" d="M19 22H5a1 1 0 0 1-1-1v-8H2l9.292-9.293a1 1 0 0 1 1.415 0L22 13h-2v8a1 1 0 0 1-1 1Zm-9-7h4v5h4v-8.172l-6-6l-6 6V20h4v-5Z"/>`
	homeAltPlusPath                   = `<path fill="currentColor" d="M19 22H5a1 1 0 0 1-1-1v-9.643a1.01 1.01 0 0 1 .293-.65l7-7a1 1 0 0 1 1.415 0l7 7a.994.994 0 0 1 .292.707V21a1 1 0 0 1-1 1ZM12 5.828l-6 6V20h12v-8.172l-6-6Zm1 12.171h-2v-3H8v-2h3v-3h2v3h3v2h-3v3Z"/>`
	homeAltXPath                      = `<path fill="currentColor" d="M19 22H5a1 1 0 0 1-1-1v-9.643a1.01 1.01 0 0 1 .293-.65l7-7a1 1 0 0 1 1.415 0l7 7a.994.994 0 0 1 .292.707V21a1 1 0 0 1-1 1ZM12 5.828l-6 6V20h12v-8.172l-6-6ZM9.878 18.071l-1.413-1.414l2.121-2.121l-2.121-2.122L9.879 11L12 13.121L14.121 11l1.414 1.414l-2.121 2.121l2.121 2.121l-1.413 1.413L12 15.949l-2.121 2.122h-.001Z"/>`
	homeCheckPath                     = `<path fill="currentColor" d="M16 20H5a1 1 0 0 1-1-1v-7.86a1 1 0 0 1 .281-.695l5.5-5.7a1 1 0 0 1 1.439 0l2.8 2.9l-1.43 1.402L10.5 6.88L6 11.54v6.455h11v1A1 1 0 0 1 16 20Zm-1.712-4l-2.706-2.7L13 11.882l1.292 1.291l4.3-4.292L20 10.298l-5.712 5.7V16Z"/>`
	homeFillPath                      = `<path fill="currentColor" d="m4.293 10.707l7-7a1 1 0 0 1 1.414 0l7 7a1 1 0 0 1 .293.707V21a1 1 0 0 1-1 1h-5v-7h-4v7H5a1 1 0 0 1-1-1v-9.586a1 1 0 0 1 .293-.707Z"/>`
	...
	homeHeartOnePath                  = `<path fill="currentColor" d="M19 22H5a1 1 0 0 1-1-1v-9.643a1.01 1.01 0 0 1 .293-.65l7-7a1 1 0 0 1 1.415 0l7 7a.994.994 0 0 1 .292.707V21a1 1 0 0 1-1 1Zm-7.622-4.525c.22.18.433.356.622.525c.2-.177.424-.36.662-.554l.057-.047c1.166-.951 2.618-2.134 2.618-3.6A1.8 1.8 0 0 0 13.5 12a2.008 2.008 0 0 0-1.5.667A2.007 2.007 0 0 0 10.5 12a1.8 1.8 0 0 0-1.835 1.8c0 1.461 1.44 2.636 2.6 3.58h-.001h.005l.018.015h.005l.008.019l.052.043l.013.01h.006l.007.008Z"/>`
	homeMinusPath                     = `<path fill="currentColor" d="M16 20H5a1 1 0 0 1-1-1v-7.86a1 1 0 0 1 .281-.695l5.5-5.7a1 1 0 0 1 1.439 0l2.8 2.9l-1.43 1.402L10.5 6.88L6 11.54v6.455h11v1A1 1 0 0 1 16 20Zm4-6h-8v-2h8v2Z"/>`
	homeOutlinePath                   = `<path fill="currentColor" d="M19 22H5a1 1 0 0 1-1-1v-9.586a1 1 0 0 1 .293-.707l7-7a1 1 0 0 1 1.415 0l7 7a.994.994 0 0 1 .292.707V21a1 1 0 0 1-1 1Zm-9-7h4v5h4v-8.172l-6-6l-6 6V20h4v-5Z"/>`
	homePlusPath                      = `<path fill="currentColor" d="M16 20H5a1 1 0 0 1-1-1v-7.86a1 1 0 0 1 .281-.695l5.5-5.7a1 1 0 0 1 1.439 0l1.651 1.713l-1.433 1.394l-.938-.972L6 11.54v6.455h11v1A1 1 0 0 1 16 20Zm1-4h-2v-3h-3v-2h3V8h2v3h3v2h-3v3Z"/>`
	homeXPath                         = `<path fill="currentColor" d="M16 20H5a1 1 0 0 1-1-1v-7.86a1 1 0 0 1 .281-.695l5.5-5.7a1 1 0 0 1 1.439 0l2.136 2.215l-1.434 1.394L10.5 6.88L6 11.54v6.455h11v1A1 1 0 0 1 16 20Zm-1.658-4l-1.413-1.414l2.121-2.122l-2.121-2.124l1.414-1.414l2.121 2.121l2.121-2.121L20 10.34l-2.121 2.124L20 14.586l-1.414 1.413l-2.122-2.121L14.343 16h-.001Z"/>`
	houseAddPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 16v-3m0 0v-3m0 3H9m3 0h3M4 16.8v-5.348c0-.534 0-.801.065-1.05c.058-.22.152-.429.28-.617c.145-.213.346-.39.748-.741l4.801-4.202c.746-.652 1.119-.978 1.538-1.102c.37-.11.765-.11 1.135 0c.42.124.794.45 1.54 1.104l4.8 4.2c.403.352.603.528.748.74a2 2 0 0 1 .28.618c.065.248.065.516.065 1.05v5.352c0 1.118 0 1.677-.218 2.105a2 2 0 0 1-.874.873c-.428.218-.986.218-2.104.218H7.197c-1.118 0-1.678 0-2.105-.218a1.999 1.999 0 0 1-.874-.873C4 18.48 4 17.92 4 16.8Z"/>`
	houseCheckPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 11l-4 4l-2-2m-5 3.8v-5.348c0-.534 0-.801.065-1.05a2 2 0 0 1 .28-.617c.145-.213.346-.39.748-.741l4.801-4.202c.746-.652 1.119-.978 1.538-1.102c.37-.11.765-.11 1.135 0c.42.124.794.45 1.54 1.104l4.8 4.2c.403.352.603.528.748.74c.127.19.222.398.28.618c.065.249.065.516.065 1.05v5.352c0 1.118 0 1.677-.218 2.105a2 2 0 0 1-.875.873c-.427.218-.986.218-2.104.218H7.197c-1.118 0-1.678 0-2.105-.218a1.999 1.999 0 0 1-.874-.873C4 18.48 4 17.92 4 16.8Z"/>`
	...
	lastPagePath                      = `<path fill="currentColor" d="m7.558 18.01l-1.414-1.413l4.6-4.6l-4.6-4.593L7.558 5.99L13.569 12l-6.01 6.01h-.001Zm10.3-.01h-2V6h2v12Z"/>`
	layerPath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 14l-9 6l-9-6m18-4l-9 6l-9-6l9-6l9 6Z"/>`
	layersPath                        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 12l-9 6l-9-6m18 4l-9 6l-9-6m18-8l-9 6l-9-6l9-6l9 6Z"/>`
	layersAltPath                     = `<path fill="currentColor" d="m12 23.27l-9-7l1.62-1.26l7.37 5.73l7.38-5.739L21 16.27l-9 7ZM12 19l-9-7l1.62-1.26l7.37 5.73l7.38-5.74L21 12l-9 7Zm0-4.27L4.63 9L3 7.73l9-7l9 7L19.36 9L12 14.73Z"/>`
	leafPath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6.83 17.08c7.07 4.243 12.727-1.414 12.02-12.02C8.244 4.353 2.587 10.01 6.83 17.08Zm0 0c-.001 0 0 0 0 0Zm0 0L5 18.91m1.83-1.828l3.827-3.829"/>`
	lineBreakPath                     = `<path fill="currentColor" d="M18 6v6H7.83l2.58-2.59L9 8l-5 5l5 5l1.41-1.41L7.83 14H20V6h-2Z"/>`
	lineChartDownPath                 = `<path fill="currentColor" d="M21 21H4a1 1 0 0 1-1-1V3h2v16h16v2Zm-1.373-5l-4.17-4.082l-2.228 2.182a.985.985 0 0 1-1.373 0L7 9.344L8.373 8l4.17 4.082L14.77 9.9a.985.985 0 0 1 1.373 0L21 14.656L19.627 16Z"/>`
	lineChartUpPath                   = `<path fill="currentColor" d="M21 21H4a1 1 0 0 1-1-1V3h2v16h16v2ZM8.373 16L7 14.656L11.856 9.9a.985.985 0 0 1 1.373 0l2.227 2.181L19.627 8L21 9.344L16.144 14.1a.985.985 0 0 1-1.373 0l-2.228-2.182L8.374 16h-.001Z"/>`
	lineLPath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19V5"/>`
	lineMPath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 17V7"/>`
	lineSPath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15V9"/>`
	lineSxPath                        = `<path fill="currentColor" d="M13 10h-2v4h2v-4Z"/>`
	lineXlPath                        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21V3"/>`
	linkPath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9.172 14.829l5.657-5.657M7.05 11.293l-1.414 1.414a4 4 0 1 0 5.657 5.657l1.412-1.414m-1.413-9.9l1.414-1.414a4 4 0 1 1 5.657 5.657l-1.414 1.414"/>`
	linkBreakPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 20v-2m2-2h2M7.05 11.293l-1.414 1.414a4 4 0 0 0 5.657 5.657l1.415-1.414M6 8H4m4-4v2m3.293 1.05l1.414-1.414a4 4 0 1 1 5.656 5.657l-1.414 1.414"/>`
	linkHorizontalPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h8m-1-4h2a4 4 0 0 1 0 8h-2M9 8H7a4 4 0 1 0 0 8h2"/>`
	linkHorizontalOffPath             = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h4m0 0L8 8m4 4l8 8M15 8h2a4 4 0 0 1 2.645 7M9 16H7a4 4 0 0 1 0-8h1m0 0L4 4"/>`
	linkTwoPath                       = `<path fill="currentColor" d="M8.465 20.535A5 5 0 0 1 4.929 12L7.05 9.878l1.414 1.414l-2.121 2.121a3 3 0 1 0 4.243 4.243l2.12-2.121l1.415 1.415L12 19.071a4.969 4.969 0 0 1-3.536 1.464Zm.707-4.293l-1.414-1.414l7.07-7.071l1.415 1.414l-7.07 7.07l-.001.001Zm7.779-2.121l-1.415-1.414l2.12-2.121a3 3 0 1 0-4.241-4.243l-2.122 2.121L9.879 7.05L12 4.928a5 5 0 0 1 7.07 7.071l-2.12 2.121v.001Z"/>`
	linkVerticalPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v8m4-1v2a4 4 0 0 1-8 0v-2m8-6V7a4 4 0 0 0-8 0v2"/>`
	linkedinPath                      = `<path fill="currentColor" d="M13 21H9V9h4v2a4.618 4.618 0 0 1 3.525-1.763A4.5 4.5 0 0 1 21 13.75V21h-4v-6.75a2.265 2.265 0 0 0-2.247-1.944A1.815 1.815 0 0 0 13 14.25V21Zm-6 0H3V9h4v12ZM5 7a2 2 0 1 1 0-4a2 2 0 0 1 0 4Z"/>`
	linkpathPath                      = `<path fill="currentColor" d="M10.396 22a1.84 1.84 0 0 1-.918-.246l-4.52-2.61a1.84 1.84 0 0 1-.917-1.588v-5.22a1.84 1.84 0 0 1 .917-1.589l1.373-.793v1.71a2.76 2.76 0 0 0 1.376 2.383l4.521 2.61a2.75 2.75 0 0 0 2.752 0l1.772-1.022v1.921a1.84 1.84 0 0 1-.917 1.589l-4.521 2.61a1.84 1.84 0 0 1-.918.245Zm3.207-5.891c-.322 0-.638-.085-.917-.246l-4.521-2.61a1.84 1.84 0 0 1-.918-1.589v-5.22c.001-.655.35-1.26.918-1.59l4.521-2.608a1.834 1.834 0 0 1 1.834 0l4.521 2.61c.567.328.916.934.917 1.589v5.22c0 .655-.35 1.26-.917 1.589l-4.521 2.61c-.279.16-.595.245-.917.245Z"/>`
	listAddPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 17h7m5-1h3m0 0h3m-3 0v3m0-3v-3M3 12h11M3 7h11"/>`
	listCheckPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 17h7m9-3l-4 4l-2-2M4 12h11M4 7h11"/>`
	listChecklistPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 17h9M8 15l-2.5 3L4 17m7-5h9M8 10l-2.5 3L4 12m7-5h9M8 5L5.5 8L4 7"/>`
	listChecklistAltPath              = `<path fill="currentColor" d="M11 4h10v2H11V4Zm0 4h6v2h-6V8Zm0 6h10v2H11v-2Zm0 4h6v2h-6v-2ZM3 4h6v6H3V4Zm2 2v2h2V6H5Zm-2 8h6v6H3v-6Zm2 2v2h2v-2H5Z"/>`
	listMinusPath                     = `<path fill="currentColor" d="M22 17h-9v-2h9v2Zm-11 0H2v-2h9v2Zm4-4H2v-2h13v2Zm0-4H2V7h13v2Z"/>`
	listOlPath                        = `<path fill="currentColor" d="M6.983 19H4v-1h1.989v-.5h-.994v-1h.995V16H4v-1h2.983v4ZM21 18H9.069v-2H21v2ZM6.983 14H4v-.9L5.79 11H4v-1h2.983v.9L5.193 13h1.79v1ZM21 13H9.069v-2H21v2ZM6.486 9h-.995V6H4.5V5h1.986v4ZM21 8H9.069V6H21v2Z"/>`
	listOrderedPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 17h10M4 15.685V15.5A1.5 1.5 0 0 1 5.5 14h.04c.807 0 1.46.653 1.46 1.46c0 .35-.114.692-.324.973L4 20h3m3-8h10M10 7h10M4 5l2-1v6"/>`
	listPlusPath                      = `<path fill="currentColor" d="M19 20h-2v-3h-3v-2h3v-3h2v3h3v2h-3v3Zm-7-3H2v-2h10v2Zm3-4H2v-2h13v2Zm0-4H2V7h13v2Z"/>`
	listRemovePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 17h7m5-1h6M3 12h11M3 7h11"/>`
	listUlPath                        = `<path fill="currentColor" d="M20 18H8v-2h12v2ZM6 18H4v-2h2v2Zm14-5H8v-2h12v2ZM6 13H4v-2h2v2Zm14-5H8.023V6H20v2ZM6 8H4V6h2v2Z"/>`
	listUnorderedPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17h10M9 12h10M9 7h10M5.002 17v.002H5V17h.002Zm0-5v.002H5V12h.002Zm0-5v.002H5V7h.002Z"/>`
	loadingPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 14a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm6-2a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm6-2a1 1 0 1 0 2 0a1 1 0 0 0-2 0Z"/>`
	locationPath                      = `<path fill="currentColor" d="M12 21a29.776 29.776 0 0 1-3.5-3.531C6.9 15.558 5 12.712 5 10a7 7 0 0 1 11.952-4.951A6.955 6.955 0 0 1 19 10c0 2.712-1.9 5.558-3.5 7.469A29.777 29.777 0 0 1 12 21Zm0-14a3 3 0 1 0 0 6a3 3 0 0 0 0-6Z"/>`
	locationOutlinePath               = `<path fill="currentColor" d="M12 21a29.776 29.776 0 0 1-3.5-3.531C6.9 15.558 5 12.712 5 10a7 7 0 0 1 11.952-4.951A6.955 6.955 0 0 1 19 10c0 2.712-1.9 5.558-3.5 7.469A29.777 29.777 0 0 1 12 21Zm0-16a5.006 5.006 0 0 0-5 5c0 1.166.527 3.185 3.035 6.186A27.93 27.93 0 0 0 12 18.3a28.121 28.121 0 0 0 1.966-2.111C16.473 13.184 17 11.165 17 10a5.006 5.006 0 0 0-5-5Zm0 8a3 3 0 1 1 0-6a3 3 0 0 1 0 6Z"/>`
	lockPath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.23 9H7.2c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C4 10.52 4 11.08 4 12.2v5.6c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h9.606c1.118 0 1.677 0 2.104-.218c.377-.192.683-.498.875-.874c.218-.428.218-.986.218-2.104v-5.607c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C18.48 9 17.92 9 16.8 9h-2.03M9.23 9h5.539M9.23 9A.23.23 0 0 1 9 8.77V6a3 3 0 1 1 6 0v2.77a.23.23 0 0 1-.231.23"/>`
	lockOpenPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 9H7.2c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C4 10.52 4 11.08 4 12.2v5.6c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h9.606c1.118 0 1.677 0 2.104-.218c.377-.192.683-.498.875-.874c.218-.428.218-.986.218-2.104v-5.607c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C18.48 9 17.92 9 16.8 9H9Zm0 0V6.12C9 4.397 10.3 3 11.904 3c.824 0 1.567.369 2.095.961"/>`
	logOutPath                        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m12 15l3-3m0 0l-3-3m3 3H4m5-4.751V7.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C10.52 4 11.08 4 12.2 4h4.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v9.607c0 1.118 0 1.677-.218 2.104a2.002 2.002 0 0 1-.875.874c-.427.218-.986.218-2.104.218h-4.606c-1.118 0-1.678 0-2.105-.218a2 2 0 0 1-.874-.874C9 18.48 9 17.92 9 16.8v-.05"/>`
	longBottomDownPath                = `<path fill="currentColor" d="M7.021 15.55L7.014 12H5v7h7v-2.014l-3.55-.007L19 6.429L17.571 5L7.021 15.55Z"/>`
	longBottomUpPath                  = `<path fill="currentColor" d="m16.979 8.45l.007 3.55H19V5h-7v2.014l3.55.007L5 17.571L6.429 19l10.55-10.55Z"/>`
	longDownPath                      = `<path fill="currentColor" d="m11 18.17l-2.59-2.58L7 17l5 5l5-5l-1.41-1.41L13 18.17V2h-2v16.17Z"/>`
	longLeftPath                      = `<path fill="currentColor" d="m5.83 11l2.58-2.59L7 7l-5 5l5 5l1.41-1.41L5.83 13H22v-2H5.83Z"/>`
	longRightPath                     = `<path fill="currentColor" d="m18.17 13l-2.58 2.59L17 17l5-5l-5-5l-1.41 1.41L18.17 11H2v2h16.17Z"/>`
	longUpPath                        = `<path fill="currentColor" d="m13 5.83l2.59 2.58L17 7l-5-5l-5 5l1.41 1.41L11 5.83V22h2V5.83Z"/>`
	longUpLeftPath                    = `<path fill="currentColor" d="M8.45 7.021L12 7.014V5H5v7h2.014l.007-3.55L17.571 19L19 17.571L8.45 7.021Z"/>`
	magnifyingGlassMinusPath          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 10h6m2 5l6 6m-11-4a7 7 0 1 1 0-14a7 7 0 0 1 0 14Z"/>`
	magnifyingGlassPlusPath           = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 10h3m0 0h3m-3 0V7m0 3v3m5 2l6 6m-11-4a7 7 0 1 1 0-14a7 7 0 0 1 0 14Z"/>`
	mailPath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 6l6.108 4.612l.002.002c.678.497 1.017.746 1.389.842a2 2 0 0 0 1.002 0c.372-.096.712-.345 1.392-.844c0 0 3.917-3.006 6.107-4.612M3 15.8V8.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C4.52 5 5.08 5 6.2 5h11.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v7.607c0 1.118 0 1.676-.218 2.104a2.002 2.002 0 0 1-.875.874c-.427.218-.986.218-2.104.218H6.197c-1.118 0-1.678 0-2.105-.218a2 2 0 0 1-.874-.874C3 17.48 3 16.92 3 15.8Z"/>`
	...
	mainComponentPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.235 2.374c-.368.152-.697.482-1.356 1.14c-.659.66-.989.989-1.14 1.356a2 2 0 0 0 0 1.531c.151.368.48.697 1.14 1.356c.658.659.988.989 1.356 1.14a2 2 0 0 0 1.53 0c.368-.151.697-.48 1.356-1.14c.66-.659.988-.988 1.14-1.356a2 2 0 0 0 0-1.53c-.152-.368-.48-.697-1.14-1.356c-.659-.66-.988-.989-1.356-1.141a2 2 0 0 0-1.53 0ZM4.87 8.738c-.367.152-.697.481-1.355 1.14c-.66.66-.989.989-1.141 1.356a2 2 0 0 0 0 1.531c.152.368.482.697 1.14 1.356c.66.659.989.988 1.356 1.14a2 2 0 0 0 1.531 0c.368-.152.697-.481 1.356-1.14c.66-.659.988-.988 1.14-1.356a2 2 0 0 0 0-1.53c-.152-.368-.48-.698-1.14-1.357c-.659-.659-.988-.988-1.356-1.14a2 2 0 0 0-1.53 0Zm11.373 1.14c-.659.66-.988.989-1.14 1.356a2 2 0 0 0 0 1.531c.152.368.481.697 1.14 1.356c.659.659.989.988 1.356 1.14a2 2 0 0 0 1.53 0c.368-.152.698-.481 1.357-1.14c.659-.659.987-.988 1.14-1.356a2 2 0 0 0 0-1.53c-.153-.368-.481-.698-1.14-1.357c-.66-.659-.989-.988-1.356-1.14a2 2 0 0 0-1.531 0c-.367.152-.697.481-1.356 1.14Zm-5.008 5.224c-.368.152-.697.482-1.356 1.14c-.659.66-.989.989-1.14 1.357a2 2 0 0 0 0 1.53c.151.368.48.697 1.14 1.356c.658.659.988.989 1.356 1.14a2 2 0 0 0 1.53 0c.368-.151.697-.48 1.356-1.14c.66-.659.988-.988 1.14-1.356c.203-.49.203-1.04 0-1.53c-.152-.368-.48-.698-1.14-1.356c-.659-.66-.988-.989-1.356-1.141a2 2 0 0 0-1.53 0Z"/>`
	mapPath                           = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 6v15m0-15l6-3v15l-6 3m0-15L9 3m6 18l-6-3m0 0l-6 3V6l6-3m0 15V3"/>`
	mapPinPath                        = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M5 9.923c0 4.852 4.244 8.864 6.123 10.402c.27.22.405.332.606.388c.156.044.386.044.542 0c.201-.056.336-.167.606-.388C14.756 18.787 19 14.775 19 9.923a6.885 6.885 0 0 0-2.05-4.895A7.04 7.04 0 0 0 12 3a7.04 7.04 0 0 0-4.95 2.028A6.884 6.884 0 0 0 5 9.923Z"/><path d="M10 9a2 2 0 1 0 4 0a2 2 0 0 0-4 0Z"/></g>`
	mentionPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12.002V13a2 2 0 1 0 4 0v-1a7 7 0 1 0-4.406 6.502m.406-6.5a3 3 0 1 1 0-.004m0 .004v-.004m0 0V9"/>`
	menuAltFivePath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 17h8m-8-5h14m-8-5h8"/>`
	menuAltFourPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 17h14M5 12h14M5 7h8"/>`
	menuAltOnePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 17h7M5 12h14M5 7h14"/>`
	menuAltThreePath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 17h8m-8-5h14M5 7h8"/>`
	menuAltTwoPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 17h8M5 12h14m-8-5h8"/>`
	menuDuoPath                       = `<path fill="currentColor" d="M21 16H3v-2h18v2Zm0-6H3V8h18v2Z"/>`
	menuDuoLgPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15h18M3 9h18"/>`
	menuDuoMdPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15h14M5 9h14"/>`
	messagePath                       = `<path fill="currentColor" d="M3 21V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H9c-.433 0-.854.14-1.2.4L3 21ZM5 5v12l2.134-1.6a1.99 1.99 0 0 1 1.2-.4H19V5H5Z"/>`
	messageCheckPath                  = `<path fill="currentColor" d="M3 21V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H9c-.433 0-.854.14-1.2.4L3 21ZM5 5v12l2.134-1.6a1.99 1.99 0 0 1 1.2-.4H19V5H5Zm6 8.561L7.293 9.853L8.707 8.44L11 10.733l4.293-4.293l1.414 1.414L11 13.56v.001Z"/>`
	messageCirclePath                 = `<path fill="currentColor" d="m8.051 17.828l.654.35a6.96 6.96 0 0 0 3.292.822H12a7 7 0 1 0-7-7v.003a6.96 6.96 0 0 0 .822 3.292l.35.654l-.538 2.417l2.417-.538ZM3 21l1.058-4.762A9 9 0 0 1 12 3a9 9 0 0 1 9 9a9 9 0 0 1-13.238 7.942L3 21Z"/>`
	messageClosePath                  = `<path fill="currentColor" d="M9.879 13.536L8.464 12.12L10.586 10L8.464 7.879L9.88 6.464L12 8.586l2.121-2.122l1.415 1.415L13.414 10l2.122 2.121l-1.415 1.415L12 11.414l-2.121 2.122Z"/><path fill="currentColor" d="M3 5v16l4.8-3.6c.346-.26.767-.4 1.2-.4h10a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2Zm2 12V5h14v10H8.334a1.984 1.984 0 0 0-1.2.4L5 17Z"/>`
	messageMinusPath                  = `<path fill="currentColor" d="M3 21V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H9c-.433 0-.854.14-1.2.4L3 21ZM5 5v12l2.134-1.6a1.99 1.99 0 0 1 1.2-.4H19V5H5Zm11 6H8V9h8v2Z"/>`
	messagePlusPath                   = `<path fill="currentColor" d="M3 21V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H9c-.433 0-.854.14-1.2.4L3 21ZM5 5v12l2.134-1.6a1.99 1.99 0 0 1 1.2-.4H19V5H5Zm8 9h-2v-3H8V9h3V6h2v3h3v2h-3v3Z"/>`
	messagePlusAltPath                = `<path fill="currentColor" d="M19 10h-2V7h-3V5h3V2h2v3h3v2h-3v3Z"/><path fill="currentColor" d="M21 12h-2v3H8.334a1.984 1.984 0 0 0-1.2.4L5 17V5h7V3H5a2 2 0 0 0-2 2v16l4.8-3.6c.346-.26.767-.4 1.2-.4h10a2 2 0 0 0 2-2v-3Z"/>`
	messageRoundPath                  = `<path fill="currentColor" d="m5.124 12.114l.003.012a5.909 5.909 0 0 0 3.336 4.16L12 17.894V16h2a5 5 0 0 0 5-5v-1a5 5 0 0 0-5-5h-4a5 5 0 0 0-5 5v1c0 .38.042.748.121 1.1l.003.014ZM14 21l-6.364-2.893A7.909 7.909 0 0 1 3.17 12.54A7.024 7.024 0 0 1 3 11v-1a7 7 0 0 1 7-7h4a7 7 0 0 1 7 7v1a7 7 0 0 1-7 7v3Z"/>`
	messageWritingPath                = `<path fill="currentColor" d="M9 9H7v2h2V9Zm2 0h2v2h-2V9Zm6 0h-2v2h2V9Z"/><path fill="currentColor" d="M3 5v16l4.8-3.6c.346-.26.767-.4 1.2-.4h10a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2Zm2 12V5h14v10H8.334a1.984 1.984 0 0 0-1.2.4L5 17Z"/>`
	messengerPath                     = `<path fill="currentColor" d="M6.401 21v-3.189a8.1 8.1 0 0 1-3.31-6.479C3.09 6.738 7.09 3 12 3s8.91 3.738 8.91 8.332c.001 4.594-4 8.33-8.91 8.33a9.463 9.463 0 0 1-2.559-.349L6.403 21h-.002Zm4.66-11.931l-4.866 5.163l4.438-2.454l2.3 2.394L17.8 9.01l-4.434 2.454l-2.305-2.395Z"/>`
	minusPath                         = `<path fill="currentColor" d="M5 13v-2h14v2H5Z"/>`
	minusCirclePath                   = `<path fill="currentColor" d="M12 22c-5.52-.006-9.994-4.48-10-10v-.2C2.11 6.305 6.635 1.928 12.13 2c5.497.074 9.904 4.569 9.868 10.065C21.962 17.562 17.497 22 12 22ZM7 11v2h10v-2H7Z"/>`
	minusCircleOutlinePath            = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm-8-9.828A8 8 0 1 0 4 12v.172ZM17 13H7v-2h10v2Z"/>`
	minusSquarePath                   = `<path fill="currentColor" d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2ZM5 5v14h14V5H5Zm12 8H7v-2h10v2Z"/>`
	mobilePath                        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 6.2v11.6c0 1.12 0 1.68.218 2.107c.192.377.497.683.874.875c.427.218.987.218 2.105.218h3.606c1.118 0 1.677 0 2.104-.218a2 2 0 0 0 .875-.875c.218-.427.218-.986.218-2.104V6.197c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C15.48 3 14.92 3 13.8 3h-3.6c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C7 4.52 7 5.08 7 6.2Z"/>`
	mobileAltPath                     = `<path fill="currentColor" d="M16.75 23h-10a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v18a2 2 0 0 1-2 2Zm-10-20v18h10V3h-10Zm5 17a1 1 0 1 1 0-2a1 1 0 0 1 0 2Z"/>`
	mobileButtonPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 6.2v11.6c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h3.606c1.118 0 1.677 0 2.104-.218c.377-.192.683-.498.875-.874c.218-.428.218-.986.218-2.104V6.197c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C15.48 3 14.92 3 13.8 3h-3.6c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C7 4.52 7 5.08 7 6.2Z"/>`
	...
	monitorPlayPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 20H9m-5-6.2V8.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C5.52 5 6.08 5 7.2 5h9.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v5.606c0 1.118 0 1.677-.218 2.104a2.003 2.003 0 0 1-.875.875c-.427.218-.986.218-2.104.218H7.197c-1.118 0-1.678 0-2.105-.218a2.001 2.001 0 0 1-.874-.875C4 15.48 4 14.92 4 13.8ZM14.5 11L10 8v6l4.5-3Z"/>`
	moonPath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 6a9 9 0 0 0 9 9c.91 0 1.787-.134 2.614-.385A9.004 9.004 0 0 1 12 21A9 9 0 0 1 9.386 3.386A8.999 8.999 0 0 0 9 6Z"/>`
	moreGridBigPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 18a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm-6 0a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm-6 0a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm12-6a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm-6 0a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm-6 0a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm12-6a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm-6 0a1 1 0 1 0 2 0a1 1 0 0 0-2 0ZM5 6a1 1 0 1 0 2 0a1 1 0 0 0-2 0Z"/>`
	moreGridSmallPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 15a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm-6 0a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm6-6a1 1 0 1 0 2 0a1 1 0 0 0-2 0ZM8 9a1 1 0 1 0 2 0a1 1 0 0 0-2 0Z"/>`
	moreHorizontalPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 12a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm-6 0a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm-6 0a1 1 0 1 0 2 0a1 1 0 0 0-2 0Z"/>`
	moreVerticalPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 18a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm0-6a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm0-6a1 1 0 1 0 2 0a1 1 0 0 0-2 0Z"/>`
	mousePath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10V7m6 2v6a6 6 0 0 1-12 0V9a6 6 0 1 1 12 0Z"/>`
	movePath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21v-9m0 9l3-3m-3 3l-3-3m3-6V3m0 9H3m9 0h9m-9-9L9 6m3-3l3 3M3 12l3 3m-3-3l3-3m15 3l-3-3m3 3l-3 3"/>`
	moveHorizontalPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12h18M3 12l3 3m-3-3l3-3m15 3l-3-3m3 3l-3 3"/>`
	moveVerticalPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21V3m0 18l3-3m-3 3l-3-3m3-15L9 6m3-3l3 3"/>`
	movingDeskPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12v3m0-3h1.803c1.118 0 1.677 0 2.104-.218c.377-.191.683-.498.875-.875C21 10.48 21 9.921 21 8.803v-.606c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C19.48 5 18.92 5 17.8 5h-3.6c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C11 6.52 11 7.08 11 8.2v.6c0 1.12 0 1.68.218 2.107c.192.377.498.684.874.875c.427.218.987.218 2.105.218H16Zm-9-2l-2 2l-2-2m0-3l2-2l2 2M3 21v-1.8c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C4.52 16 5.08 16 6.2 16h11.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105V21"/>`
	navigationPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4.805 3.555l15.81 4.865c.862.265.96 1.446.153 1.85l-6.7 3.35a1 1 0 0 0-.448.447l-3.35 6.7c-.403.807-1.584.71-1.85-.153L3.555 4.804a1 1 0 0 1 1.25-1.249Z"/>`
	notePath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 20H7.197c-1.118 0-1.678 0-2.105-.218a2 2 0 0 1-.874-.874C4 18.48 4 17.92 4 16.8V7.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C5.52 4 6.08 4 7.2 4h9.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105V13m-7 7c.286-.003.466-.014.639-.055c.204-.05.399-.13.578-.24c.202-.124.375-.296.72-.642l4.126-4.125c.346-.346.518-.52.642-.721c.11-.18.19-.375.24-.579c.04-.172.051-.352.054-.638M13 20v-5.4c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C13.76 13 14.04 13 14.6 13H20"/>`
	noteEditPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 4H7.2c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C4 5.52 4 6.08 4 7.2v9.6c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h9.606c1.118 0 1.677 0 2.104-.218c.377-.192.683-.498.875-.874c.218-.428.218-.987.218-2.105V14m-4-9l-6 6v3h3l6-6m-3-3l3-3l3 3l-3 3m-3-3l3 3"/>`
	noteSearchPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19l-3-3m-6 4H7.197c-1.118 0-1.678 0-2.105-.218a2 2 0 0 1-.874-.874C4 18.48 4 17.92 4 16.8V7.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C5.52 4 6.08 4 7.2 4h9.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105V10m-6.5 7a3.5 3.5 0 1 1 0-7a3.5 3.5 0 0 1 0 7Z"/>`
	notebookPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 4h-.8c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C4 5.52 4 6.08 4 7.2v9.6c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218H8M8 4h8.8c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v9.607c0 1.118 0 1.677-.218 2.104a2.002 2.002 0 0 1-.875.874c-.427.218-.986.218-2.104.218H8M8 4v16m4-9h4m-4-3h4"/>`
	notificationPath                  = `<path fill="currentColor" d="M12 22a2.02 2.02 0 0 1-2.01-2h4a2.02 2.02 0 0 1-.15.78a2.042 2.042 0 0 1-1.44 1.18h-.047A1.922 1.922 0 0 1 12 22Zm8-3H4v-2l2-1v-5.5a8.065 8.065 0 0 1 .924-4.06A4.654 4.654 0 0 1 10 4.18V2h4v2.18c2.579.614 4 2.858 4 6.32V16l2 1v2Z"/>`
	notificationActivePath            = `<path fill="currentColor" d="M12 22a2.02 2.02 0 0 1-2.01-2h4a2.02 2.02 0 0 1-.149.78a2.043 2.043 0 0 1-1.44 1.18h-.046A1.944 1.944 0 0 1 12 22Zm8-3H4v-2l2-1v-5.5a8.065 8.065 0 0 1 .924-4.06A4.654 4.654 0 0 1 10 4.18V2h4v2.18c2.579.614 4 2.858 4 6.32V16l2 1v2Zm1.97-9h-2a8.672 8.672 0 0 0-3.39-6.57L18 2a9.9 9.9 0 0 1 2.825 3.486A11.52 11.52 0 0 1 21.97 10ZM4 10H2c.07-1.567.46-3.103 1.145-4.514A9.9 9.9 0 0 1 5.97 2l1.42 1.43A8.67 8.67 0 0 0 4 10Z"/>`
	notificationDeactivatedPath       = `<path fill="currentColor" d="M12 22a2 2 0 0 1-2-2h4a2 2 0 0 1-2 2Zm7.585-.1l-2.9-2.9H4v-2l2-1v-5.5a10.57 10.57 0 0 1 .182-2L2.615 4.929L4.03 3.515L21 20.487L19.585 21.9ZM18 14.659L8.28 4.938A4.946 4.946 0 0 1 10 4.18V2h4v2.18c2.58.613 4 2.858 4 6.32v4.16v-.001Z"/>`
	notificationDotPath               = `<path fill="currentColor" d="M12 22a2 2 0 0 1-2-2h4a2 2 0 0 1-2 2Zm8-3H4v-2l2-1v-5.5a8.065 8.065 0 0 1 .924-4.06A4.654 4.654 0 0 1 10 4.18V2h3.646a4.5 4.5 0 0 0 4.3 7.4c.035.357.052.727.052 1.1V16l2 1v2H20ZM17 8a3 3 0 1 1 .01-6A3 3 0 0 1 17 8Z"/>`
	notificationMinusPath             = `<path fill="currentColor" d="M12 22a2.02 2.02 0 0 1-2.01-2h4a2.02 2.02 0 0 1-.15.78a2.042 2.042 0 0 1-1.44 1.18a1.758 1.758 0 0 1-.4.04Zm8-3H4v-2l2-1v-5.5a8.065 8.065 0 0 1 .924-4.06A4.654 4.654 0 0 1 10 4.18V2h4v2.18h.011c.025 0 .049.01.073.016C16.611 4.845 18 7.082 18 10.5V16l2 1v2ZM9 11v2h6v-2H9Z"/>`
	notificationOutlinePath           = `<path fill="currentColor" d="M12 22a2 2 0 0 1-2-2h4a2 2 0 0 1-2 2Zm8-3H4v-2l2-1v-5.5c0-3.462 1.421-5.707 4-6.32V2h4v2.18c2.579.612 4 2.856 4 6.32V16l2 1v2ZM12 5.75A3.6 3.6 0 0 0 8.875 7.2A5.692 5.692 0 0 0 8 10.5V17h8v-6.5a5.693 5.693 0 0 0-.875-3.3A3.6 3.6 0 0 0 12 5.75Z"/>`
	notificationOutlineDotPath        = `<path fill="currentColor" d="M12 22a2 2 0 0 1-2-2h4a2 2 0 0 1-2 2Zm8-3H4v-2l2-1v-5.5c0-3.462 1.421-5.707 4-6.32V2h3a4.955 4.955 0 0 0-1 3c0 .251.019.502.056.751H12A3.6 3.6 0 0 0 8.875 7.2A5.692 5.692 0 0 0 8 10.5V17h8v-6.5c0-.211-.007-.414-.021-.6a5.044 5.044 0 0 0 2.006.007c.011.211.015.412.015.6V16l2 1v2ZM17 8a3 3 0 1 1 0-6a3 3 0 0 1 0 6Z"/>`
	notificationOutlineMinusPath      = `<path fill="currentColor" d="M12 22a2 2 0 0 1-2-2h4a2 2 0 0 1-2 2Zm8-3H4v-2l2-1v-5.5c0-3.462 1.421-5.707 4-6.32V2h4v2.18h.041l.042.01C16.611 4.843 18 7.08 18 10.5V16l2 1v2ZM12 5.75A3.6 3.6 0 0 0 8.875 7.2A5.692 5.692 0 0 0 8 10.5V17h8v-6.5a5.693 5.693 0 0 0-.875-3.3A3.6 3.6 0 0 0 12 5.75ZM15 13H9v-2h6v2Z"/>`
	notificationOutlinePlusPath       = `<path fill="currentColor" d="M12 22a2 2 0 0 1-2-2h4a2 2 0 0 1-2 2Zm8-3H4v-2l2-1v-5.5c0-3.462 1.421-5.707 4-6.32V2h4v2.18c2.579.612 4 2.856 4 6.32V16l2 1v2ZM12 5.75A3.6 3.6 0 0 0 8.875 7.2A5.692 5.692 0 0 0 8 10.5V17h8v-6.5a5.693 5.693 0 0 0-.875-3.3A3.6 3.6 0 0 0 12 5.75ZM13 15h-2v-2H9v-2h2V9h2v2h2v2h-2v2Z"/>`
	notificationPlusPath              = `<path fill="currentColor" d="M12 22a2.02 2.02 0 0 1-2.01-2h4a2.02 2.02 0 0 1-.15.78a2.042 2.042 0 0 1-1.44 1.18a1.758 1.758 0 0 1-.4.04Zm8-3H4v-2l2-1v-5.5a8.065 8.065 0 0 1 .924-4.06A4.654 4.654 0 0 1 10 4.18V2h4v2.18h.011c.025 0 .049.01.073.016C16.611 4.845 18 7.082 18 10.5V16l2 1v2ZM9 11v2h2v2h2v-2h2v-2h-2V9h-2v2H9Z"/>`
	...
	octagonCheckPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 10l-4 4l-2-2M7.332 3.937L3.938 7.332l-.004.003c-.343.343-.516.516-.64.717c-.109.179-.19.374-.239.578C3 8.86 3 9.105 3 9.594v4.812c0 .489 0 .733.055.964a2 2 0 0 0 .24.578c.124.201.297.375.643.72l3.394 3.395c.346.346.518.518.72.642c.179.11.374.19.578.24c.23.055.474.055.962.055h4.816c.487 0 .732 0 .962-.055c.204-.05.4-.13.578-.24c.202-.124.375-.296.72-.642l3.395-3.394c.346-.346.519-.52.642-.721c.11-.18.19-.374.24-.578c.055-.23.055-.475.055-.964V9.594c0-.489 0-.733-.056-.964a2 2 0 0 0-.239-.578c-.123-.202-.296-.374-.642-.72L16.67 3.938c-.346-.346-.519-.52-.72-.643a1.999 1.999 0 0 0-.579-.24C15.14 3 14.895 3 14.405 3H9.594c-.49 0-.734 0-.964.055a2.02 2.02 0 0 0-.578.24c-.2.122-.37.293-.71.633l-.01.01Z"/>`
	octagonHelpPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.146 9.074a2.998 2.998 0 0 1 5.28-.838A3 3 0 0 1 12 13v1m.05 3v.1h-.1V17h.1ZM7.332 3.937L3.938 7.332l-.004.003c-.343.343-.516.516-.64.717c-.109.179-.19.374-.239.578C3 8.86 3 9.105 3 9.594v4.812c0 .489 0 .733.055.964a2 2 0 0 0 .24.578c.124.201.297.375.643.72l3.394 3.395c.346.346.518.518.72.642c.179.11.374.19.578.24c.23.055.474.055.962.055h4.816c.487 0 .732 0 .962-.055c.204-.05.4-.13.578-.24c.202-.124.375-.296.72-.642l3.395-3.394c.346-.346.519-.52.642-.721c.11-.18.19-.374.24-.578c.055-.23.055-.475.055-.964V9.594c0-.489 0-.733-.056-.964a2 2 0 0 0-.239-.578c-.123-.202-.296-.374-.642-.72L16.67 3.938c-.346-.346-.519-.52-.72-.643a1.999 1.999 0 0 0-.579-.24C15.14 3 14.895 3 14.405 3H9.594c-.49 0-.734 0-.964.055a2.02 2.02 0 0 0-.578.24c-.2.122-.37.293-.71.633l-.01.01Z"/>`
	octagonWarningPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8.45v4M7.332 3.938L3.938 7.332l-.004.003c-.343.343-.516.516-.64.717c-.109.179-.19.374-.239.578C3 8.86 3 9.105 3 9.594v4.812c0 .489 0 .733.055.964a2 2 0 0 0 .24.578c.124.201.297.375.643.72l3.394 3.395c.346.346.518.518.72.642c.179.11.374.19.578.24c.23.055.474.055.962.055h4.816c.487 0 .732 0 .962-.055c.204-.05.4-.13.578-.24c.202-.124.375-.296.72-.642l3.395-3.394c.346-.346.519-.52.642-.721c.11-.18.19-.374.24-.578c.055-.23.055-.475.055-.964V9.594c0-.489 0-.733-.056-.964a2 2 0 0 0-.239-.578c-.123-.202-.296-.374-.642-.72L16.67 3.938c-.346-.346-.519-.52-.72-.643a1.999 1.999 0 0 0-.579-.24C15.14 3 14.895 3 14.405 3H9.594c-.49 0-.734 0-.964.055a2.02 2.02 0 0 0-.578.24c-.2.122-.37.293-.71.633l-.01.01ZM12.05 15.45v.1h-.1v-.1h.1Z"/>`
	offClosePath                      = `<path fill="currentColor" d="M12 22A9.99 9.99 0 0 1 2 12v-.2a10.005 10.005 0 0 1 17.074-6.874A10 10 0 0 1 12 22Zm0-8.59L14.59 16L16 14.59L13.41 12L16 9.41L14.59 8L12 10.59L9.41 8L8 9.41L10.59 12L8 14.59L9.41 16L12 13.411v-.001Z"/>`
	offOutlineClosePath               = `<path fill="currentColor" d="M12 22A10 10 0 0 1 4.926 4.926a10.004 10.004 0 1 1 14.148 14.148A9.936 9.936 0 0 1 12 22Zm-8-9.828A8 8 0 1 0 4 12v.172ZM9.409 16l-1.41-1.41L10.59 12L8 9.41L9.41 8L12 10.59L14.59 8L16 9.41L13.41 12L16 14.59L14.592 16L12 13.41L9.41 16h-.001Z"/>`
	optionPath                        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7h5.094c.33 0 .495 0 .643.047c.132.042.253.111.357.202c.117.103.202.245.372.528l5.068 8.446c.17.284.255.425.372.528c.103.09.224.16.356.202c.148.047.314.047.644.047H21M15 7h6"/>`
	paperPlanePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m10.308 13.692l4.846-4.846M20.11 5.89l-4.09 13.294c-.367 1.192-.55 1.788-.867 1.985a.999.999 0 0 1-.912.076c-.345-.143-.624-.7-1.182-1.816l-2.59-5.182a2.104 2.104 0 0 0-.193-.342a1.002 1.002 0 0 0-.18-.181a2.036 2.036 0 0 0-.331-.186L4.572 10.94c-1.115-.558-1.673-.837-1.816-1.181a1 1 0 0 1 .076-.913c.197-.316.793-.5 1.985-.867l13.295-4.09c.937-.289 1.405-.433 1.722-.316a1 1 0 0 1 .594.594c.116.316-.028.784-.316 1.72v.002Z"/>`
	paperclipAttechmentHorizontalPath = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 6h9.75a5.25 5.25 0 1 1 0 10.5H5.5a3.5 3.5 0 1 1 0-7h11.25a1.75 1.75 0 1 1 0 3.5H7"/>`
	paperclipAttechmentTiltPath       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.536 11.465L11.43 4.57a5.25 5.25 0 1 1 7.424 7.425L10.9 19.95A3.5 3.5 0 0 1 5.95 15l7.956-7.955A1.75 1.75 0 0 1 16.38 9.52l-6.895 6.894"/>`
	paragraphPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v8m0-8h4m-4 0h-1a4 4 0 1 0 0 8h1m0 0v6m4-14v14m0-14h1"/>`
	pathPath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.121 15.879a3 3 0 1 0-4.243 4.243a3 3 0 0 0 4.243-4.243Zm0 0L15.88 8.12m0 0a3 3 0 1 0 4.243-4.243A3 3 0 0 0 15.88 8.12Zm0 0l.004-.004"/>`
	pausePath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5.5v13c0 .465 0 .697.038.89a2 2 0 0 0 1.571 1.572c.194.038.426.038.89.038c.465 0 .698 0 .892-.038a2 2 0 0 0 1.57-1.572c.039-.19.039-.42.039-.878V5.488c0-.457 0-.687-.038-.879a2 2 0 0 0-1.572-1.57C18.197 3 17.965 3 17.5 3s-.697 0-.89.038a1.999 1.999 0 0 0-1.572 1.571C15 4.803 15 5.035 15 5.5Zm-11 0v13c0 .465 0 .697.038.89a2 2 0 0 0 1.571 1.572c.194.038.426.038.89.038c.465 0 .698 0 .892-.038a2 2 0 0 0 1.57-1.572C9 19.2 9 18.97 9 18.512V5.488c0-.457 0-.687-.038-.879A2 2 0 0 0 7.39 3.04C7.197 3 6.965 3 6.5 3s-.697 0-.89.038A1.999 1.999 0 0 0 4.037 4.61C4 4.803 4 5.035 4 5.5Z"/>`
	pauseCirclePath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 9v6m-4-6v6m2 6a9 9 0 1 1 0-18a9 9 0 0 1 0 18Z"/>`
	pauseCircleFilledPath             = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm1-14v8h2V8h-2ZM9 8v8h2V8H9Z"/>`
	pauseCircleOutlinePath            = `<path fill="currentColor" d="M12 22c-5.52-.006-9.994-4.48-10-10v-.2C2.11 6.305 6.635 1.928 12.13 2c5.497.074 9.904 4.569 9.868 10.065C21.962 17.562 17.497 22 12 22Zm-.016-2H12a8 8 0 1 0-.016 0ZM15 16h-2V8h2v8Zm-4 0H9V8h2v8Z"/>`
	paypalPath                        = `<path fill="currentColor" d="M11.398 21.009H8.874a.392.392 0 0 1-.33-.15a.459.459 0 0 1-.09-.363c.04-.241.09-.559.152-.963l.114-.727a313.336 313.336 0 0 1 .348-2.188v-.02l.188-1.164l.1-.619v-.005c.072-.445.129-.798.17-1.061a.39.39 0 0 1 .433-.371h1.52a10.08 10.08 0 0 0 2.171-.212a6.09 6.09 0 0 0 2.886-1.449a6.084 6.084 0 0 0 1.56-2.473c.152-.436.27-.884.352-1.338c.007-.042.015-.066.025-.074a.03.03 0 0 1 .025-.012h.01a.31.31 0 0 1 .062.035c.525.397.876.982.98 1.632c.118.68.105 1.376-.04 2.051a5.406 5.406 0 0 1-1.857 3.35a6.053 6.053 0 0 1-3.825 1.116h-.439a.662.662 0 0 0-.444.166a.722.722 0 0 0-.239.427l-.04.194l-.554 3.478l-.02.151a.706.706 0 0 1-.249.427a.67.67 0 0 1-.445.162Zm-3.578-2H4.855a.473.473 0 0 1-.369-.165a.466.466 0 0 1-.115-.39l2.331-14.79a.775.775 0 0 1 .277-.483a.783.783 0 0 1 .518-.19h6.014c.33.013.658.057.98.131c.382.073.758.18 1.122.32a3.425 3.425 0 0 1 1.645 1.238a3.41 3.41 0 0 1 .568 1.972a7.11 7.11 0 0 1-.46 2.374a4.909 4.909 0 0 1-3.042 3.165a8.046 8.046 0 0 1-2.535.425c-.01.006-.44.007-.9.007l-.9-.007a1.083 1.083 0 0 0-1.187.964c-.013.054-.317 1.947-.855 5.329a.107.107 0 0 1-.128.105l.001-.005Z"/>`
	...
	phoneOutlinePath                  = `<path fill="currentColor" d="M8.742 8.682c-1.073.912-1.466 2.575-.54 3.909a12.818 12.818 0 0 0 3.208 3.207c1.334.926 2.997.533 3.909-.54l.01.005A13.38 13.38 0 0 0 19 16.36V19h-.004C11.022 19.011 4.991 12.911 5 5.004V5h2.64v.001c.188 1.27.558 2.506 1.097 3.67l.005.01ZM19 21h1a1 1 0 0 0 1-1v-4.502a1 1 0 0 0-.853-.99l-.854-.126a11.416 11.416 0 0 1-3.123-.934l-.753-.349a1 1 0 0 0-1.234.326l-.341.477c-.299.419-.87.546-1.291.253a10.819 10.819 0 0 1-2.706-2.705c-.293-.422-.165-.993.253-1.291l.477-.34a1 1 0 0 0 .326-1.235l-.35-.754a11.424 11.424 0 0 1-.933-3.123l-.127-.854A1 1 0 0 0 8.501 3H4a1 1 0 0 0-1 1v1.001C2.99 14.008 9.91 21.013 18.999 21Z"/>`
	pieChartFiftyPath                 = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm-.016-2H12V4a8 8 0 1 0-.016 16Z"/>`
	pieChartOutlinePath               = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10ZM11 4.062a8 8 0 1 0 5.419 14.608l-.1.071l.094-.065l.059-.041l.064-.045l.016-.011l.009-.007l-5.128-5.13A1.51 1.51 0 0 1 11 12.379V4.062ZM13.829 13l4.227 4.227l.007-.008l.005-.006l-.01.011A7.944 7.944 0 0 0 19.938 13h-6.109ZM13 4.062V11h6.938A8 8 0 0 0 13 4.062Z"/>`
	pieChartOutlineTwentyFivePath     = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10ZM11 4.062a8 8 0 1 0 8.915 9.1V13H11V4.062Zm2 0V11h6.938A8 8 0 0 0 13 4.062Z"/>`
	pieChartSeventyFivePath           = `<path fill="currentColor" d="M12 22c-5.52-.006-9.994-4.48-10-10v-.2C2.11 6.305 6.635 1.928 12.13 2c5.497.074 9.904 4.569 9.868 10.065C21.962 17.562 17.497 22 12 22Zm0-18a8.008 8.008 0 0 0-8 8h8V4Z"/>`
	pieChartTwentyFivePath            = `<path fill="currentColor" d="M12 22c-5.52-.006-9.994-4.48-10-10v-.2C2.11 6.305 6.635 1.928 12.13 2c5.497.074 9.904 4.569 9.868 10.065C21.962 17.562 17.497 22 12 22Zm-8-9.828A8 8 0 1 0 20 12h-8V4a8.01 8.01 0 0 0-8 8v.172Z"/>`
	planetPath                        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6.898 18.162a8 8 0 0 0 12.93-7.821m-12.93 7.82a8 8 0 1 1 12.93-7.821m-12.93 7.822c1.955-.447 4.282-1.38 6.628-2.734c2.73-1.576 4.951-3.416 6.302-5.088m-12.93 7.822c-2.43.555-4.286.362-4.898-.698c-.63-1.091.196-2.867 2-4.755m15.828-2.369c1.252-1.55 1.756-2.956 1.224-3.876c-.539-.933-2.043-1.195-4.052-.865"/>`
	playPath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 17.334V6.667c0-.88 0-1.32.185-1.58a1 1 0 0 1 .687-.412c.317-.04.705.166 1.48.58l10 5.333l.004.002c.857.457 1.286.686 1.427.99c.122.266.122.573 0 .839c-.141.305-.571.535-1.43.993l-10 5.333c-.777.414-1.164.62-1.48.58a1 1 0 0 1-.688-.412C5 18.653 5 18.213 5 17.333Z"/>`
	playArrowPath                     = `<path fill="currentColor" d="m8 19l11-7L8 5v14Z"/>`
	playCirclePath                    = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0-18 0Z"/><path d="M10 15V9l5 3l-5 3Z"/></g>`
	playCircleFilledPath              = `<path fill="currentColor" d="M12 22c-5.52-.006-9.994-4.48-10-10v-.2C2.11 6.305 6.635 1.928 12.13 2c5.497.074 9.904 4.569 9.868 10.065C21.962 17.562 17.497 22 12 22ZM10 7.5v9l6-4.5l-6-4.5Z"/>`
	playCircleOutlinePath             = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm-8-9.828A8 8 0 1 0 4 12v.172Zm6 4.328v-9l6 4.5l-6 4.5Z"/>`
	playStorePath                     = `<path fill="currentColor" d="M5.4 21c-.17.003-.34-.026-.5-.086l8.054-8.057l2.666 2.669l-9.255 5.2A1.998 1.998 0 0 1 5.4 21Zm-1.164-.665a1.9 1.9 0 0 1-.236-.97V4.66a2.13 2.13 0 0 1 .1-.658l8.233 8.235l-8.1 8.1l.003-.002Zm12.179-5.258l-2.841-2.839l3.133-3.132l2.783 1.563c.534.24.892.755.928 1.339a1.574 1.574 0 0 1-.929 1.34l-3.074 1.729Zm-3.461-3.463l-8.34-8.339c.229-.17.506-.26.791-.261c.336.012.664.107.955.277l9.551 5.368l-2.956 2.955h-.001Z"/>`
	plusPath                          = `<path fill="currentColor" d="M13 13v6h-2v-6H5v-2h6V5h2v6h6v2h-6Z"/>`
	plusCirclePath                    = `<path fill="currentColor" d="M12 22c-5.52-.006-9.994-4.48-10-10v-.2C2.11 6.305 6.635 1.928 12.13 2c5.497.074 9.904 4.569 9.868 10.065C21.962 17.562 17.497 22 12 22ZM7 11v2h4v4h2v-4h4v-2h-4V7h-2v4H7Z"/>`
	plusCircleOutlinePath             = `<path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10c-.006 5.52-4.48 9.994-10 10Zm-8-9.828A8 8 0 1 0 4 12v.172ZM13 17h-2v-4H7v-2h4V7h2v4h4v2h-4v4Z"/>`
	plusSquarePath                    = `<path fill="currentColor" d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2ZM5 5v14h14V5H5Zm8 12h-2v-4H7v-2h4V7h2v4h4v2h-4v4Z"/>`
	printerPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 17c.932 0 1.398 0 1.765-.152a2 2 0 0 0 1.083-1.083C21 15.398 21 14.932 21 14v-3.803c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C19.506 7.013 18.988 7.001 18 7m0 0H6m12 0H6m12 0v-.803c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C16.48 3 15.92 3 14.8 3H9.2c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C6 4.52 6 5.08 6 6.2V7m0 0c-.988 0-1.507.013-1.908.218a1.999 1.999 0 0 0-.874.874C3 8.52 3 9.08 3 10.2V14c0 .932 0 1.398.152 1.765a2 2 0 0 0 1.082 1.083C4.602 17 5.068 17 6 17m4-6h4m-5 4h6c.932 0 1.398 0 1.765.152a2 2 0 0 1 1.083 1.082C18 16.602 18 17.068 18 18s0 1.398-.152 1.765a2 2 0 0 1-1.083 1.083C16.398 21 15.932 21 15 21H9c-.932 0-1.398 0-1.766-.152a1.999 1.999 0 0 1-1.082-1.082C6 19.398 6 18.932 6 18s0-1.398.152-1.766a2 2 0 0 1 1.082-1.082C7.602 15 8.068 15 9 15Z"/>`
	...
	qrCodePath                        = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20h1m-4 0h-2v-3m3 0h3v-3h-1m-5 0h2M4 17c0-.932 0-1.398.152-1.766a2 2 0 0 1 1.082-1.082C5.602 14 6.068 14 7 14s1.398 0 1.766.152c.49.203.879.592 1.082 1.082c.152.368.152.834.152 1.766s0 1.398-.152 1.765a2 2 0 0 1-1.082 1.083C8.398 20 7.932 20 7 20s-1.398 0-1.766-.152a1.999 1.999 0 0 1-1.082-1.082C4 18.398 4 17.932 4 17ZM14 7c0-.932 0-1.398.152-1.766a2 2 0 0 1 1.082-1.082C15.602 4 16.068 4 17 4s1.398 0 1.766.152c.49.203.879.592 1.082 1.082C20 5.602 20 6.068 20 7s0 1.398-.152 1.765a2 2 0 0 1-1.082 1.083C18.398 10 17.932 10 17 10s-1.398 0-1.766-.152a1.999 1.999 0 0 1-1.082-1.082C14 8.398 14 7.932 14 7ZM4 7c0-.932 0-1.398.152-1.766a2 2 0 0 1 1.082-1.082C5.602 4 6.068 4 7 4s1.398 0 1.766.152c.49.203.879.592 1.082 1.082C10 5.602 10 6.068 10 7s0 1.398-.152 1.765a2 2 0 0 1-1.082 1.083C8.398 10 7.932 10 7 10s-1.398 0-1.766-.152a1.999 1.999 0 0 1-1.082-1.082C4 8.398 4 7.932 4 7Z"/>`
	qrCodeOnePath                     = `<path fill="currentColor" d="M3 11V3h8v8H3Zm3-5v2h2V6H6Zm7 5V3h8v8h-8Zm3-5v2h2V6h-2ZM3 13v8h8v-8H3Zm5 3v2H6v-2h2Zm8-3h-3v2h3v4h-1v-2h-2v4h4v-2h2v2h2v-3h-2v-1h-1v-1h3v-3h-3v2h-2v-2Z"/>`
	radioPath                         = `<path fill="currentColor" d="M12 19a7 7 0 1 1 7-7a7.008 7.008 0 0 1-7 7Zm0-12a5 5 0 1 0 0 10a5 5 0 0 0 0-10Z"/>`
	radioFillPath                     = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 4a8 8 0 1 0 0 16a8 8 0 0 0 0-16Z"/><path d="M12 9a3 3 0 1 0 0 6a3 3 0 0 0 0-6Z"/></g>`
	radioFilledPath                   = `<path fill="currentColor" d="M12 19a7 7 0 1 1 7-7a7.008 7.008 0 0 1-7 7Zm0-12a5 5 0 1 0 0 10a5 5 0 0 0 0-10Zm0 8a3 3 0 1 1 0-6a3 3 0 0 1 0 6Z"/>`
	radioUncheckedPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4a8 8 0 1 0 0 16a8 8 0 0 0 0-16Z"/>`
	rainbowPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 17v-2a9 9 0 1 1 18 0v2M6 17v-2a6 6 0 0 1 12 0v2m-9 0v-2a3 3 0 1 1 6 0v2"/>`
	...
	shoppingCartTwoPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h.268c.474 0 .711 0 .905.085c.17.076.316.197.42.351c.12.174.163.407.248.871L7 16h10.422c.453 0 .68 0 .868-.08a.998.998 0 0 0 .415-.331c.12-.165.171-.385.273-.826v-.003l1.57-6.8v-.001c.154-.669.232-1.004.147-1.267a1.001 1.001 0 0 0-.44-.55C20.019 6 19.676 6 18.99 6H5.5M18 21a1 1 0 1 1 0-2a1 1 0 0 1 0 2ZM8 21a1 1 0 1 1 0-2a1 1 0 0 1 0 2Z"/>`
	shortDownPath                     = `<path fill="currentColor" d="m11 16.17l-3.59-3.58L6 14l6 6l6-6l-1.41-1.41L13 16.17V4h-2v12.17Z"/>`
	shortLeftPath                     = `<path fill="currentColor" d="m7.83 11l3.58-3.59L10 6l-6 6l6 6l1.41-1.41L7.83 13H20v-2H7.83Z"/>`
	shortRightPath                    = `<path fill="currentColor" d="m16.17 13l-3.58 3.59L14 18l6-6l-6-6l-1.41 1.41L16.17 11H4v2h12.17Z"/>`
	shortUpPath                       = `<path fill="currentColor" d="m13 7.83l3.59 3.58L18 10l-6-6l-6 6l1.41 1.41L11 7.83V20h2V7.83Z"/>`
	...
	squareWarningPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8.45v4m.05 3v.1h-.1v-.1h.1ZM3 17.8V6.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C4.52 3 5.08 3 6.2 3h11.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v11.607c0 1.118 0 1.677-.218 2.104a2.002 2.002 0 0 1-.875.874c-.427.218-.986.218-2.104.218H6.197c-1.118 0-1.678 0-2.105-.218a2 2 0 0 1-.874-.874C3 19.48 3 18.92 3 17.8Z"/>`
	stackOverflowPath                 = `<path fill="currentColor" d="M18.84 20.999H4.381v-6.4h1.6v4.8h11.26v-4.8h1.6v6.4Zm-3.2-3.2H7.581v-1.6h8.055v1.6h.004Zm0-2L7.781 14.16l.338-1.552l7.861 1.642l-.343 1.549h.003Zm.44-2.037l-7.28-3.4v-.006l.673-1.457l7.281 3.4l-.673 1.464l-.002-.001Zm.922-1.845l-6.17-5.14h.01l1.012-1.214l6.162 5.136L17 11.918l.003-.001Zm1.308-1.5l-4.807-6.449l1.31-.969L19.62 9.45l-1.312.971l.003-.004Z"/>`
	...
	tagOutlinePath                    = `<path fill="currentColor" d="M12.897 21.968a1.987 1.987 0 0 1-1.415-.586l-7.834-7.835a1.994 1.994 0 0 1-.58-1.567l.5-6.566a1.989 1.989 0 0 1 1.846-1.841l6.566-.5c.051-.011.103-.011.154-.011a2.01 2.01 0 0 1 1.413.586l7.835 7.834a2 2 0 0 1 0 2.829l-7.07 7.071a1.987 1.987 0 0 1-1.415.586Zm-.764-16.906l-6.57.5l-.5 6.571l7.834 7.835l7.07-7.07l-7.834-7.836Zm-3.479 5.592a2 2 0 1 1 0-4a2 2 0 0 1 0 4Z"/>`
	...
	terminalPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 15h-5m-5-5l3 2.5L7 15m-4 .8V8.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C4.52 5 5.08 5 6.2 5h11.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v7.606c0 1.118 0 1.677-.218 2.104a2.003 2.003 0 0 1-.875.875c-.427.218-.986.218-2.104.218H6.197c-1.118 0-1.678 0-2.105-.218a2.001 2.001 0 0 1-.874-.875C3 17.48 3 16.92 3 15.8Z"/>`
	textPath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19h2m0 0h2m-2 0V5m0 0H6v1m6-1h6v1"/>`
	textAlignCenterPath               = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 18H7m13-4H4m13-4H7m13-4H4"/>`
	textAlignJustifyPath              = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 18H4m16-4H4m16-4H4m16-4H4"/>`
	textAlignLeftPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 18h10M4 14h16M4 10h10M4 6h16"/>`
	textAlignRightPath                = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 18H10m10-4H4m16-4H10m10-4H4"/>`
	thinBigDownPath                   = `<path fill="currentColor" d="M6.5 17.5L13 24l6.5-6.5l-.707-.707l-5.293 5.293V0h-1v22.086l-5.293-5.293l-.707.707Z"/>`
	thinBigLeftPath                   = `<path fill="currentColor" d="M6.5 5.5L0 12l6.5 6.5l.707-.707L1.914 12.5H24v-1H1.914l5.293-5.293L6.5 5.5Z"/>`
	thinBigRightPath                  = `<path fill="currentColor" d="M17.5 18.5L24 12l-6.5-6.5l-.707.707l5.293 5.293H0v1h22.086l-5.293 5.293l.707.707Z"/>`
	thinBigUpPath                     = `<g fill="none"><g clip-path="url(#ciThinBigUp0)"><path fill="currentColor" d="M19.5 6.5L13 0L6.5 6.5l.707.707L12.5 1.914V24h1V1.914l5.293 5.293l.707-.707Z"/></g><defs><clipPath id="ciThinBigUp0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g>`
	thinLongDownPath                  = `<path fill="currentColor" d="M8.5 18.5L12 22l3.5-3.5l-.707-.707l-2.293 2.293V2h-1v18.086l-2.293-2.293l-.707.707Z"/>`
	thinLongLeftPath                  = `<path fill="currentColor" d="M5.5 8.5L2 12l3.5 3.5l.707-.707L3.914 12.5H22v-1H3.914l2.293-2.293L5.5 8.5Z"/>`
	thinLongRightPath                 = `<path fill="currentColor" d="M18.5 15.5L22 12l-3.5-3.5l-.707.707l2.293 2.293H2v1h18.086l-2.293 2.293l.707.707Z"/>`
	thinLongTwoDownPath               = `<path fill="currentColor" d="m9 16l3 3l3-3l-.707-.707l-1.793 1.793V5h-1v12.086l-1.793-1.793L9 16Z"/>`
	thinLongTwoLeftPath               = `<path fill="currentColor" d="m8 9l-3 3l3 3l.707-.707L6.914 12.5H19v-1H6.914l1.793-1.793L8 9Z"/>`
	thinLongTwoRightPath              = `<path fill="currentColor" d="m16 15l3-3l-3-3l-.707.707l1.793 1.793H5v1h12.086l-1.793 1.793L16 15Z"/>`
	thinLongTwoUpPath                 = `<path fill="currentColor" d="m15 8l-3-3l-3 3l.707.707L11.5 6.914V19h1V6.914l1.793 1.793L15 8Z"/>`
	thinLongUpPath                    = `<path fill="currentColor" d="M15.5 5.5L12 2L8.5 5.5l.707.707L11.5 3.914V22h1V3.914l2.293 2.293l.707-.707Z"/>`
	ticketVoucherPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 6H6c-.932 0-1.398 0-1.766.152a2 2 0 0 0-1.082 1.083C3 7.602 3 8.068 3 9a3 3 0 1 1 0 6c0 .932 0 1.398.152 1.765a2 2 0 0 0 1.082 1.083C4.602 18 5.068 18 6 18h8m0-12h4c.932 0 1.398 0 1.765.152a2 2 0 0 1 1.083 1.083C21 7.602 21 8.068 21 9a3 3 0 1 0 0 6c0 .932 0 1.398-.152 1.765a2 2 0 0 1-1.083 1.083C19.398 18 18.932 18 18 18h-4m0-12v12"/>`
	timerPath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 13V9m9-3l-2-2m-9-2h4m-2 19a8 8 0 1 1 0-16a8 8 0 0 1 0 16Z"/>`
	timerAddPath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 16v-3m0 0v-3m0 3H9m3 0h3m6-7l-2-2m-9-2h4m-2 19a8 8 0 1 1 0-16a8 8 0 0 1 0 16Z"/>`
	timerClosePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m10 15l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-9l-2-2m-9-2h4m-2 19a8 8 0 1 1 0-16a8 8 0 0 1 0 16Z"/>`
	timerRemovePath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m6-7l-2-2m-9-2h4m-2 19a8 8 0 1 1 0-16a8 8 0 0 1 0 16Z"/>`
	transferPath                      = `<path fill="currentColor" d="m9 20l-5-4l5-4v3h13v2H9v3Zm6-8V9H2V7h13V4l5 4l-5 4Z"/>`
	...
	trashFullPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 10v7m-4-7v7M6 6v11.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h5.606c1.118 0 1.677 0 2.104-.218c.377-.192.683-.498.875-.874c.218-.428.218-.987.218-2.105V6M6 6h2M6 6H4m4 0h8M8 6c0-.932 0-1.398.152-1.765a2 2 0 0 1 1.082-1.083C9.602 3 10.068 3 11 3h2c.932 0 1.398 0 1.765.152a2 2 0 0 1 1.083 1.083C16 4.602 16 5.068 16 6m0 0h2m0 0h2"/>`
	trelloPath                        = `<path fill="currentColor" d="M18.75 21H5.25A2.253 2.253 0 0 1 3 18.75V5.25A2.253 2.253 0 0 1 5.25 3h13.5A2.253 2.253 0 0 1 21 5.25v13.5A2.253 2.253 0 0 1 18.75 21ZM6.42 5.34a1.08 1.08 0 0 0-1.08 1.08v10.215c0 .596.484 1.08 1.08 1.08h3.33a1.08 1.08 0 0 0 1.08-1.08V6.42a1.08 1.08 0 0 0-1.08-1.08H6.42Zm7.83 0a1.08 1.08 0 0 0-1.08 1.08v5.715c0 .596.484 1.08 1.08 1.08h3.33a1.08 1.08 0 0 0 1.08-1.08V6.42a1.08 1.08 0 0 0-1.08-1.08h-3.33Z"/>`
	trendingDownPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m20 17l-5.846-5.938a4.945 4.945 0 0 0-.205-.202a1.999 1.999 0 0 0-2.667 0c-.047.042-.1.096-.205.203c-.105.106-.158.16-.205.202a2 2 0 0 1-2.667 0A4.898 4.898 0 0 1 8 11.062L4 7m16 10v-6m0 6h-6"/>`
	trendingUpPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m20 7l-5.846 5.938c-.105.106-.158.16-.205.202c-.76.68-1.907.68-2.667 0a4.814 4.814 0 0 1-.205-.203c-.105-.106-.158-.16-.205-.202a2 2 0 0 0-2.667 0a4.86 4.86 0 0 0-.204.202L4 17M20 7v6m0-6h-6"/>`
	trianglePath                      = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.379 15.2c-.91 1.575-1.364 2.363-1.296 3.01a2 2 0 0 0 .813 1.408C4.422 20 5.331 20 7.15 20h9.703c1.817 0 2.726 0 3.251-.382a2 2 0 0 0 .814-1.408c.068-.647-.386-1.435-1.296-3.01l-4.85-8.4c-.909-1.575-1.364-2.363-1.958-2.627a2 2 0 0 0-1.627 0c-.593.264-1.048 1.052-1.957 2.625L4.38 15.2Z"/>`
	triangleCheckPath                 = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 13l-4 4l-2-2m-4.621.2c-.91 1.575-1.364 2.363-1.296 3.01a2 2 0 0 0 .813 1.408C4.422 20 5.331 20 7.15 20h9.703c1.817 0 2.726 0 3.251-.382a2 2 0 0 0 .814-1.409c.068-.646-.386-1.434-1.296-3.01l-4.85-8.4c-.909-1.574-1.364-2.362-1.958-2.626a2 2 0 0 0-1.627 0c-.593.264-1.048 1.052-1.957 2.625L4.38 15.2Z"/>`
	...
	underlinePath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 19h12M8 5v6a4 4 0 0 0 8 0V5"/>`
	undoPath                          = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 8H5V3m.291 13.357a8 8 0 1 0 .188-8.991"/>`
	unfoldLessPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 19l4-4l4 4m0-14l-4 4l-4-4"/>`
	unfoldMorePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m16 15l-4 4l-4-4m0-6l4-4l4 4"/>`
	unlinkPath                        = `<path fill="currentColor" d="M20.292 21.707L11.586 13H7v-2h2.586l-2-2H7a3 3 0 1 0 0 6h3v2H7a5 5 0 0 1-1.255-9.841L2.292 3.707l1.415-1.414l18 18l-1.414 1.413v.001Zm-.156-5.814l-1.428-1.427A3 3 0 0 0 17 9h-3V7h3a5 5 0 0 1 3.137 8.893Z"/>`
	unsplashPath                      = `<path fill="currentColor" d="M21 21H3V10.875h5.625v5.063h6.75v-5.063H21V21ZM15.375 8.063h-6.75V3h6.75v5.063Z"/>`
	userPath                          = `<path fill="currentColor" d="M7 8a5 5 0 1 1 10 0A5 5 0 0 1 7 8Zm5 3a3 3 0 1 0 0-6a3 3 0 0 0 0 6Zm-5.657 5.343A8 8 0 0 0 4 22h2a6 6 0 1 1 12 0h2a8 8 0 0 0-13.657-5.657Z"/>`
	userAddPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19c0-2.21-2.686-4-6-4s-6 1.79-6 4m16-3v-3m0 0v-3m0 3h-3m3 0h3M9 12a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"/>`
	userCardIdPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18h6m-6 0c-.988 0-1.507-.013-1.908-.218a2.001 2.001 0 0 1-.874-.875C3 16.48 3 15.92 3 14.8V9.2c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C4.52 6 5.08 6 6.2 6h11.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105v5.606c0 1.118 0 1.677-.218 2.104a2.003 2.003 0 0 1-.875.875c-.427.218-.986.218-2.104.218H12m-6 0c0-1.105 1.343-2 3-2s3 .895 3 2m-6 0s0 0 0 0Zm12-4h-4m4-3h-3m-6 2a2 2 0 1 1 0-4a2 2 0 0 1 0 4Z"/>`
	userCheckPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19c0-2.21-2.686-4-6-4s-6 1.79-6 4m18-9l-4 4l-2-2m-6 0a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"/>`
	userCirclePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.217 19.332A6.982 6.982 0 0 0 12 17c-2.073 0-3.935.9-5.217 2.332M12 21a9 9 0 1 1 0-18a9 9 0 0 1 0 18Zm0-7a3 3 0 1 1 0-6a3 3 0 0 1 0 6Z"/>`
	userClosePath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19c0-2.21-2.686-4-6-4s-6 1.79-6 4m14-5l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2M9 12a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"/>`
	userHeartPath                     = `<path fill="currentColor" d="M2 19h2a4 4 0 0 1 8 0h2a6 6 0 0 0-12 0ZM4 8a4 4 0 1 1 8 0a4 4 0 0 1-8 0Zm2.002-.029A2 2 0 0 0 10 8.09V8a2 2 0 0 0-3.998-.029ZM18.339 15a22.972 22.972 0 0 0-.692-.583l-.047-.038l-.006-.004C16.438 13.432 15 12.258 15 10.799A1.8 1.8 0 0 1 16.839 9a2.008 2.008 0 0 1 1.5.667a2.009 2.009 0 0 1 1.5-.667a1.8 1.8 0 0 1 1.835 1.8c0 1.465-1.45 2.647-2.615 3.598l-.003.002l-.057.047l-.018.015c-.23.189-.448.367-.643.54l.001-.003Z"/>`
	userMinusPath                     = `<path fill="currentColor" d="M4 19H2a6 6 0 0 1 12 0h-2a4 4 0 0 0-8 0Zm18-6h-8v-2h8v2ZM8 12a4 4 0 1 1 0-8a4 4 0 0 1 0 8Zm0-6a2 2 0 1 0 2 2.09v.4V8a2 2 0 0 0-2-2Z"/>`
	userOnePath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21a7 7 0 1 0-14 0m7-10a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"/>`
	userPinPath                       = `<path fill="currentColor" d="m12 22l-3-3H5a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2h-4l-3 3ZM5 4v13h5l2 2l2-2h5V4H5Zm11 10.986H8V14.6a3.82 3.82 0 0 1 4-3.6a3.82 3.82 0 0 1 4 3.6v.386ZM12 10a1.934 1.934 0 0 1-2-2a1.935 1.935 0 0 1 2-2a1.935 1.935 0 0 1 2 2a1.934 1.934 0 0 1-2 2Z"/>`
	userPlusPath                      = `<path fill="currentColor" d="M4 19H2a6 6 0 0 1 12 0h-2a4 4 0 0 0-8 0Zm15-3h-2v-3h-3v-2h3V8h2v3h3v2h-3v3ZM8 12a4 4 0 1 1 0-8a4 4 0 0 1 0 8Zm0-6a2 2 0 1 0 2 2.09v.4V8a2 2 0 0 0-2-2Z"/>`
	userRemovePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19c0-2.21-2.686-4-6-4s-6 1.79-6 4m12-6h6M9 12a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"/>`
	userSquarePath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 21a5 5 0 0 0-10 0m10 0h.803c1.118 0 1.677 0 2.104-.218a2 2 0 0 0 .875-.875c.218-.427.218-.986.218-2.104V6.197c0-1.118 0-1.678-.218-2.105a2.001 2.001 0 0 0-.875-.874C19.48 3 18.92 3 17.8 3H6.2c-1.12 0-1.68 0-2.108.218a1.999 1.999 0 0 0-.874.874C3 4.52 3 5.08 3 6.2v11.6c0 1.12 0 1.68.218 2.107c.192.377.497.683.874.875c.427.218.987.218 2.105.218H7m10 0H7m5-8a3 3 0 1 1 0-6a3 3 0 0 1 0 6Z"/>`
	userThreePath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 19c0-2.21-2.686-4-6-4s-6 1.79-6 4m6-7a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"/>`
	userTwoPath                       = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 21c0-2.761-3.582-5-8-5s-8 2.239-8 5m8-8a5 5 0 1 1 0-10a5 5 0 0 1 0 10Z"/>`
	userVoicePath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19c0-2.21-2.686-4-6-4s-6 1.79-6 4M16.828 5.172a3.999 3.999 0 0 1 0 5.657M19 3a7.07 7.07 0 0 1 0 10M9 12a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"/>`
	usersPath                         = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 20c0-1.742-1.67-3.223-4-3.773M15 20c0-2.21-2.686-4-6-4s-6 1.79-6 4m12-7a4 4 0 0 0 0-8m-6 8a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"/>`
	usersGroupPath                    = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20c0-1.657-2.239-3-5-3s-5 1.343-5 3m14-3c0-1.23-1.234-2.287-3-2.75M3 17c0-1.23 1.234-2.287 3-2.75m12-4.014a3 3 0 1 0-4-4.472m-8 4.472a3 3 0 0 1 4-4.472M12 14a3 3 0 1 1 0-6a3 3 0 0 1 0 6Z"/>`
	volumeMaxPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.82 4.687a10 10 0 0 1 .05 14.579M16.093 7.612a6 6 0 0 1 .03 8.748m-8.642-.953l1.676 2.073c.873 1.08 1.31 1.621 1.692 1.68a1 1 0 0 0 .891-.315c.261-.286.261-.981.261-2.37v-8.95c0-1.389 0-2.083-.26-2.37a1 1 0 0 0-.892-.315c-.383.059-.82.6-1.692 1.68L7.48 8.593c-.176.219-.264.328-.373.406a1 1 0 0 1-.32.153c-.13.036-.27.036-.551.036H4.813c-.757 0-1.135 0-1.44.1A2 2 0 0 0 2.1 10.56c-.1.306-.1.684-.1 1.44c0 .756 0 1.134.1 1.44a2 2 0 0 0 1.273 1.272c.305.1.683.1 1.44.1h1.423c.28 0 .42 0 .55.036a1 1 0 0 1 .32.153c.11.078.198.188.374.406Z"/>`
	volumeMinPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16.41 8.343a5 5 0 0 1 .025 7.29m-8.955-.226l1.676 2.073c.873 1.08 1.31 1.62 1.692 1.68a1 1 0 0 0 .891-.316c.261-.286.261-.98.261-2.37V7.525c0-1.39 0-2.084-.26-2.37a1 1 0 0 0-.892-.315c-.383.059-.82.599-1.692 1.68L7.48 8.593c-.176.218-.264.327-.373.406a1 1 0 0 1-.32.153c-.13.035-.27.035-.551.035H4.813c-.757 0-1.135 0-1.44.101A2 2 0 0 0 2.1 10.56c-.1.305-.1.683-.1 1.44c0 .756 0 1.134.1 1.44a2 2 0 0 0 1.273 1.271c.305.101.683.101 1.44.101h1.423c.28 0 .42 0 .55.036a1 1 0 0 1 .32.152c.11.079.198.188.374.406Z"/>`
	volumeMinusPath                   = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12h6M7.48 15.406l1.676 2.074c.873 1.08 1.31 1.62 1.692 1.68a1 1 0 0 0 .891-.316c.261-.286.261-.98.261-2.37V7.525c0-1.39 0-2.084-.26-2.37a1 1 0 0 0-.892-.315c-.383.059-.82.599-1.692 1.68L7.48 8.593c-.176.218-.264.327-.373.406a1 1 0 0 1-.32.153c-.13.035-.27.035-.551.035H4.813c-.757 0-1.135 0-1.44.101A2 2 0 0 0 2.1 10.56c-.1.305-.1.683-.1 1.44c0 .756 0 1.134.1 1.44a2 2 0 0 0 1.273 1.271c.305.101.683.101 1.44.101h1.423c.28 0 .42 0 .55.036a1 1 0 0 1 .32.152c.11.079.198.188.374.406Z"/>`
	volumeOffPath                     = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m16.172 9.171l5.656 5.657m-5.656 0l5.656-5.657M7.48 15.407l1.676 2.073c.873 1.08 1.31 1.62 1.692 1.68a1 1 0 0 0 .891-.316c.261-.286.261-.98.261-2.37V7.525c0-1.39 0-2.084-.26-2.37a1 1 0 0 0-.892-.315c-.383.059-.82.599-1.692 1.68L7.48 8.593c-.176.218-.264.327-.373.406a1 1 0 0 1-.32.153c-.13.035-.27.035-.551.035H4.813c-.757 0-1.135 0-1.44.101A2 2 0 0 0 2.1 10.56c-.1.305-.1.683-.1 1.44c0 .756 0 1.134.1 1.44a2 2 0 0 0 1.273 1.271c.305.101.683.101 1.44.101h1.423c.28 0 .42 0 .55.036a1 1 0 0 1 .32.152c.11.079.198.188.374.406Z"/>`
	volumeOffTwoPath                  = `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9.187H8.812c-.756 0-1.134 0-1.44.101a2 2 0 0 0-1.271 1.272C6 10.865 6 11.243 6 12c0 .756 0 1.134.1 1.44a2 2 0 0 0 1.273 1.271c.305.101.683.101 1.44.101h1.423c.28 0 .42 0 .55.036a.998.998 0 0 1 .32.153c.11.078.198.187.374.406l1.675 2.073c.874 1.08 1.31 1.62 1.693 1.68a1 1 0 0 0 .891-.316c.261-.286.261-.98.261-2.37V15m0-4.5V6.977c0-.936 0-1.404-.122-1.628a1 1 0 0 0-1.26-.445c-.235.097-.53.461-1.118 1.19l-.625.773M6 5l14 14"/>`
...
func IconFromName(name string) g.Node {
	...
	case "addColumn":
		return AddColumn()
	case "addMinusSquare":
		return AddMinusSquare()
	case "addPlus":
		return AddPlus()
	case "addPlusCircle":
		return AddPlusCircle()
	case "addPlusSquare":
		return AddPlusSquare()
	case "addRow":
		return AddRow()
	case "addToQueue":
		return AddToQueue()
	...
	case "arrowCircleDownLeft":
		return ArrowCircleDownLeft()
	case "arrowCircleDownRight":
		return ArrowCircleDownRight()
	...
	case "arrowCircleUpLeft":
		return ArrowCircleUpLeft()
	case "arrowCircleUpRight":
		return ArrowCircleUpRight()
	case "arrowDownLeftLg":
		return ArrowDownLeftLg()
	case "arrowDownLeftMd":
		return ArrowDownLeftMd()
	case "arrowDownLeftSm":
		return ArrowDownLeftSm()
	case "arrowDownLg":
		return ArrowDownLg()
	case "arrowDownMd":
		return ArrowDownMd()
	case "arrowDownRightLg":
		return ArrowDownRightLg()
	case "arrowDownRightMd":
		return ArrowDownRightMd()
	case "arrowDownRightSm":
		return ArrowDownRightSm()
	case "arrowDownSm":
		return ArrowDownSm()
	case "arrowDownUp":
		return ArrowDownUp()
	...
	case "arrowRightSm":
		return ArrowRightSm()
	case "arrowSubDownLeft":
		return ArrowSubDownLeft()
	case "arrowSubDownRight":
		return ArrowSubDownRight()
	case "arrowSubLeftDown":
		return ArrowSubLeftDown()
	case "arrowSubLeftUp":
		return ArrowSubLeftUp()
	case "arrowSubRightDown":
		return ArrowSubRightDown()
	case "arrowSubRightUp":
		return ArrowSubRightUp()
	case "arrowSubUpLeft":
		return ArrowSubUpLeft()
	case "arrowSubUpRight":
		return ArrowSubUpRight()
	case "arrowUndoDownLeft":
		return ArrowUndoDownLeft()
	case "arrowUndoDownRight":
		return ArrowUndoDownRight()
	case "arrowUndoUpLeft":
		return ArrowUndoUpLeft()
	case "arrowUndoUpRight":
		return ArrowUndoUpRight()
	case "arrowUpLeftLg":
		return ArrowUpLeftLg()
	case "arrowUpLeftMd":
		return ArrowUpLeftMd()
	case "arrowUpLeftSm":
		return ArrowUpLeftSm()
	case "arrowUpLg":
		return ArrowUpLg()
	case "arrowUpMd":
		return ArrowUpMd()
	case "arrowUpRightLg":
		return ArrowUpRightLg()
	case "arrowUpRightMd":
		return ArrowUpRightMd()
	case "arrowUpRightSm":
		return ArrowUpRightSm()
	case "arrowUpSm":
		return ArrowUpSm()
	case "arrowsReloadOne":
		return ArrowsReloadOne()
	case "barBottom":
		return BarBottom()
	case "barChart":
		return BarChart()
	...
	case "cast":
		return Cast()
	case "chartBarHorizontalOne":
		return ChartBarHorizontalOne()
	case "chartBarVerticalOne":
		return ChartBarVerticalOne()
	case "chartLine":
		return ChartLine()
	case "chartPie":
		return ChartPie()
	...
	case "chatCircleCheck":
		return ChatCircleCheck()
	case "chatCircleClose":
		return ChatCircleClose()
	case "chatCircleDots":
		return ChatCircleDots()
	case "chatCircleRemove":
		return ChatCircleRemove()
	case "chatClose":
		return ChatClose()
	case "chatConversation":
		return ChatConversation()
	case "chatConversationCircle":
		return ChatConversationCircle()
	case "chatDots":
		return ChatDots()
	case "chatRemove":
		return ChatRemove()
	...
	case "chevronBigDown":
		return ChevronBigDown()
	case "chevronBigLeft":
		return ChevronBigLeft()
	case "chevronBigRight":
		return ChevronBigRight()
	case "chevronBigUp":
		return ChevronBigUp()
	case "chevronDown":
		return ChevronDown()
	case "chevronDownDuo":
		return ChevronDownDuo()
	case "chevronDuoDown":
		return ChevronDuoDown()
	case "chevronDuoLeft":
		return ChevronDuoLeft()
	case "chevronDuoRight":
		return ChevronDuoRight()
	case "chevronDuoUp":
		return ChevronDuoUp()
	case "chevronLeft":
		return ChevronLeft()
	case "chevronLeftDuo":
		return ChevronLeftDuo()
	case "chevronLeftMd":
		return ChevronLeftMd()
	case "chevronRight":
		return ChevronRight()
	case "chevronRightDuo":
		return ChevronRightDuo()
	case "chevronRightMd":
		return ChevronRightMd()
	case "chevronUp":
		return ChevronUp()
	case "chevronUpDuo":
		return ChevronUpDuo()
	...
	case "dummyCircle":
		return DummyCircle()
	case "dummyCircleSmall":
		return DummyCircleSmall()
	case "dummySquare":
		return DummySquare()
	case "dummySquareSmall":
		return DummySquareSmall()
	case "edit":
		return Edit()
	case "editPencilLineOne":
		return EditPencilLineOne()
	case "editPencilLineTwo":
		return EditPencilLineTwo()
	case "editPencilOne":
		return EditPencilOne()
	case "editPencilTwo":
		return EditPencilTwo()
	case "error":
		return Error()
	case "errorOutline":
		return ErrorOutline()
	...
	case "fileBlank":
		return FileBlank()
	case "fileBlankFill":
		return FileBlankFill()
	case "fileBlankOutline":
		return FileBlankOutline()
	case "fileCheck":
		return FileCheck()
	case "fileClose":
		return FileClose()
	...
	case "gridHorizontalRound":
		return GridHorizontalRound()
	case "gridRound":
		return GridRound()
	case "gridSmall":
		return GridSmall()
	case "gridSmallRound":
		return GridSmallRound()
	case "gridVertical":
		return GridVertical()
	case "gridVerticalRound":
		return GridVerticalRound()
	case "group":
		return Group()
	case "groupAlt":
		return GroupAlt()
	...
	case "infoSquare":
		return InfoSquare()
	case "infoSquareOutline":
		return InfoSquareOutline()
	case "instagram":
		return Instagram()
	case "instance":
		return Instance()
	...
	case "linkHorizontalOff":
		return LinkHorizontalOff()
	case "linkTwo":
		return LinkTwo()
	case "linkVertical":
		return LinkVertical()
	...
	case "listChecklistAlt":
		return ListChecklistAlt()
	case "listMinus":
		return ListMinus()
	case "listOl":
		return ListOl()
	...
	case "notificationDeactivated":
		return NotificationDeactivated()
	case "notificationDot":
		return NotificationDot()
	case "notificationMinus":
		return NotificationMinus()
	case "notificationOutline":
		return NotificationOutline()
	case "notificationOutlineDot":
		return NotificationOutlineDot()
	case "notificationOutlineMinus":
		return NotificationOutlineMinus()
	case "notificationOutlinePlus":
		return NotificationOutlinePlus()
	...
	case "offClose":
		return OffClose()
	case "offOutlineClose":
		return OffOutlineClose()
	case "option":
		return Option()
	case "paperPlane":
		return PaperPlane()
	case "paperclipAttechmentHorizontal":
		return PaperclipAttechmentHorizontal()
	case "paperclipAttechmentTilt":
		return PaperclipAttechmentTilt()
	case "paragraph":
		return Paragraph()
	case "path":
		return Path()
	...
	case "phoneOutline":
		return PhoneOutline()
	case "pieChartFifty":
		return PieChartFifty()
	case "pieChartOutline":
		return PieChartOutline()
	case "pieChartOutlineTwentyFive":
		return PieChartOutlineTwentyFive()
	case "pieChartSeventyFive":
		return PieChartSeventyFive()
	case "pieChartTwentyFive":
		return PieChartTwentyFive()
	case "planet":
		return Planet()
	case "play":
		return Play()
	...
	case "removeMinus":
		return RemoveMinus()
	case "removeMinusCircle":
		return RemoveMinusCircle()
	case "repeat":
		return Repeat()
	case "rewind":
		return Rewind()
	...
	case "searchMagnifyingGlass":
		return SearchMagnifyingGlass()
	case "searchSmall":
		return SearchSmall()
	case "searchSmallMinus":
		return SearchSmallMinus()
	case "searchSmallPlus":
		return SearchSmallPlus()
	case "selectMultiple":
	...
	case "sliderTwo":
		return SliderTwo()
	case "smallLongDown":
		return SmallLongDown()
	case "smallLongLeft":
		return SmallLongLeft()
	case "smallLongRight":
		return SmallLongRight()
	case "smallLongUp":
		return SmallLongUp()
	case "snapchat":
		return Snapchat()
	...
	case "sun":
		return Sun()
	case "swatchesPalette":
		return SwatchesPalette()
	case "swichtLeft":
		return SwichtLeft()
	case "swichtRight":
		return SwichtRight()
	...
	case "thinLongLeft":
		return ThinLongLeft()
	case "thinLongRight":
		return ThinLongRight()
	case "thinLongTwoDown":
		return ThinLongTwoDown()
	case "thinLongTwoLeft":
		return ThinLongTwoLeft()
	case "thinLongTwoRight":
		return ThinLongTwoRight()
	case "thinLongTwoUp":
		return ThinLongTwoUp()
	case "thinLongUp":
		return ThinLongUp()
	case "ticketVoucher":
	...
	case "windowClose":
		return WindowClose()
	case "windowCodeBlock":
		return WindowCodeBlock()
	case "windowSidebar":
		return WindowSidebar()
	case "windowTerminal":
		return WindowTerminal()
	case "youtube":
		return Youtube()
	default:
...
func AddMinusSquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(addMinusSquarePath), g.Group(children))
}

func AddPlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(addPlusPath), g.Group(children))
}

func AddPlusCircle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(addPlusCirclePath), g.Group(children))
}

func AddPlusSquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(addPlusSquarePath), g.Group(children))
}
...
func AddToQueue(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(addToQueuePath), g.Group(children))
}
...
func AlarmAdd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alarmAddPath), g.Group(children))
}
...
func ArrowCircleDownLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowCircleDownLeftPath), g.Group(children))
}

func ArrowCircleDownRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowCircleDownRightPath), g.Group(children))
}
...
func ArrowCircleUpLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowCircleUpLeftPath), g.Group(children))
}

func ArrowCircleUpRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowCircleUpRightPath), g.Group(children))
}

func ArrowDownLeftLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowDownLeftLgPath), g.Group(children))
}

func ArrowDownLeftMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowDownLeftMdPath), g.Group(children))
}

func ArrowDownLeftSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowDownLeftSmPath), g.Group(children))
}

func ArrowDownLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowDownLgPath), g.Group(children))
}

func ArrowDownMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowDownMdPath), g.Group(children))
}

func ArrowDownRightLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowDownRightLgPath), g.Group(children))
}

func ArrowDownRightMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowDownRightMdPath), g.Group(children))
}

func ArrowDownRightSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowDownRightSmPath), g.Group(children))
}

func ArrowDownSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowDownSmPath), g.Group(children))
}
...
func ArrowLeftLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowLeftLgPath), g.Group(children))
}

func ArrowLeftMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowLeftMdPath), g.Group(children))
}
...
func ArrowLeftSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowLeftSmPath), g.Group(children))
}

func ArrowReloadTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowReloadTwoPath), g.Group(children))
}

func ArrowRightLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowRightLgPath), g.Group(children))
}

func ArrowRightMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowRightMdPath), g.Group(children))
}

func ArrowRightSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowRightSmPath), g.Group(children))
}

func ArrowSubDownLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowSubDownLeftPath), g.Group(children))
}

func ArrowSubDownRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowSubDownRightPath), g.Group(children))
}

func ArrowSubLeftDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowSubLeftDownPath), g.Group(children))
}

func ArrowSubLeftUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowSubLeftUpPath), g.Group(children))
}

func ArrowSubRightDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowSubRightDownPath), g.Group(children))
}

func ArrowSubRightUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowSubRightUpPath), g.Group(children))
}

func ArrowSubUpLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowSubUpLeftPath), g.Group(children))
}

func ArrowSubUpRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowSubUpRightPath), g.Group(children))
}

func ArrowUndoDownLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUndoDownLeftPath), g.Group(children))
}

func ArrowUndoDownRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUndoDownRightPath), g.Group(children))
}

func ArrowUndoUpLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUndoUpLeftPath), g.Group(children))
}

func ArrowUndoUpRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUndoUpRightPath), g.Group(children))
}

func ArrowUpLeftLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUpLeftLgPath), g.Group(children))
}

func ArrowUpLeftMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUpLeftMdPath), g.Group(children))
}

func ArrowUpLeftSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUpLeftSmPath), g.Group(children))
}

func ArrowUpLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUpLgPath), g.Group(children))
}

func ArrowUpMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUpMdPath), g.Group(children))
}

func ArrowUpRightLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUpRightLgPath), g.Group(children))
}

func ArrowUpRightMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUpRightMdPath), g.Group(children))
}

func ArrowUpRightSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUpRightSmPath), g.Group(children))
}

func ArrowUpSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowUpSmPath), g.Group(children))
}

func ArrowsReloadOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowsReloadOnePath), g.Group(children))
}

func BarBottom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(barBottomPath), g.Group(children))
}
...
func BarChartAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(barChartAltPath), g.Group(children))
}

func BarChartCircle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(barChartCirclePath), g.Group(children))
}
...
func BarChartSquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(barChartSquarePath), g.Group(children))
}

func BarLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(barLeftPath), g.Group(children))
}

func BarRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(barRightPath), g.Group(children))
}

func BarTop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(barTopPath), g.Group(children))
}
...
func BellAdd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bellAddPath), g.Group(children))
}

func BellClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bellClosePath), g.Group(children))
}
...
func BellRemove(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bellRemovePath), g.Group(children))
}
...
func BlackLivesMatter(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(blackLivesMatterPath), g.Group(children))
}
...
func BuildingFour(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(buildingFourPath), g.Group(children))
}

func BuildingOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(buildingOnePath), g.Group(children))
}

func BuildingThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(buildingThreePath), g.Group(children))
}
...
func CalendarCalendar(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(calendarCalendarPath), g.Group(children))
}
...
func CalendarClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(calendarClosePath), g.Group(children))
}
...
func CalendarEdit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(calendarEditPath), g.Group(children))
}

func CalendarEvent(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(calendarEventPath), g.Group(children))
}
...
func CarAuto(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(carAutoPath), g.Group(children))
}

func CaretCircleDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretCircleDownPath), g.Group(children))
}

func CaretCircleLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretCircleLeftPath), g.Group(children))
}

func CaretCircleRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretCircleRightPath), g.Group(children))
}

func CaretCircleUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretCircleUpPath), g.Group(children))
}

func CaretDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretDownPath), g.Group(children))
}

func CaretDownMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretDownMdPath), g.Group(children))
}

func CaretDownSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretDownSmPath), g.Group(children))
}

func CaretLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretLeftPath), g.Group(children))
}

func CaretLeftSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretLeftSmPath), g.Group(children))
}

func CaretRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretRightPath), g.Group(children))
}

func CaretRightSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretRightSmPath), g.Group(children))
}

func CaretUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretUpPath), g.Group(children))
}

func CaretUpMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretUpMdPath), g.Group(children))
}

func CaretUpSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(caretUpSmPath), g.Group(children))
}
...
func ChartBarHorizontalOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chartBarHorizontalOnePath), g.Group(children))
}

func ChartBarVerticalOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chartBarVerticalOnePath), g.Group(children))
}
...
func ChatAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatAltPath), g.Group(children))
}

func ChatCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatCheckPath), g.Group(children))
}

func ChatCircle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatCirclePath), g.Group(children))
}

func ChatCircleAdd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatCircleAddPath), g.Group(children))
}

func ChatCircleCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatCircleCheckPath), g.Group(children))
}

func ChatCircleClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatCircleClosePath), g.Group(children))
}

func ChatCircleDots(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatCircleDotsPath), g.Group(children))
}

func ChatCircleRemove(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatCircleRemovePath), g.Group(children))
}

func ChatClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatClosePath), g.Group(children))
}

func ChatConversation(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatConversationPath), g.Group(children))
}

func ChatConversationCircle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatConversationCirclePath), g.Group(children))
}

func ChatDots(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chatDotsPath), g.Group(children))
}
...
func CheckAll(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkAllPath), g.Group(children))
}

func CheckAllBig(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkAllBigPath), g.Group(children))
}

func CheckBig(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkBigPath), g.Group(children))
}
...
func CheckboxCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkboxCheckPath), g.Group(children))
}

func CheckboxChecked(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkboxCheckedPath), g.Group(children))
}
...
func CheckboxSquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkboxSquarePath), g.Group(children))
}

func CheckboxUnchecked(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkboxUncheckedPath), g.Group(children))
}

func ChevronBigDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronBigDownPath), g.Group(children))
}

func ChevronBigLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronBigLeftPath), g.Group(children))
}

func ChevronBigRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronBigRightPath), g.Group(children))
}

func ChevronBigUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronBigUpPath), g.Group(children))
}
...
func ChevronDownDuo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronDownDuoPath), g.Group(children))
}

func ChevronDuoDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronDuoDownPath), g.Group(children))
}

func ChevronDuoLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronDuoLeftPath), g.Group(children))
}

func ChevronDuoRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronDuoRightPath), g.Group(children))
}

func ChevronDuoUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronDuoUpPath), g.Group(children))
}
...
func ChevronLeftDuo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronLeftDuoPath), g.Group(children))
}

func ChevronLeftMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronLeftMdPath), g.Group(children))
}
...
func ChevronRightDuo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronRightDuoPath), g.Group(children))
}

func ChevronRightMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronRightMdPath), g.Group(children))
}
...
func ChevronUpDuo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronUpDuoPath), g.Group(children))
}
...
func CircleCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleCheckPath), g.Group(children))
}

func CircleCheckOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleCheckOutlinePath), g.Group(children))
}

func CircleChevronDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleChevronDownPath), g.Group(children))
}

func CircleChevronLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleChevronLeftPath), g.Group(children))
}

func CircleChevronRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleChevronRightPath), g.Group(children))
}

func CircleChevronUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleChevronUpPath), g.Group(children))
}

func CircleDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleDownPath), g.Group(children))
}

func CircleHelp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleHelpPath), g.Group(children))
}

func CircleLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleLeftPath), g.Group(children))
}

func CircleRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleRightPath), g.Group(children))
}

func CircleUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleUpPath), g.Group(children))
}
...
func CloseBig(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(closeBigPath), g.Group(children))
}
...
func CloseLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(closeLgPath), g.Group(children))
}

func CloseMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(closeMdPath), g.Group(children))
}

func CloseSm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(closeSmPath), g.Group(children))
}

func CloseSmall(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(closeSmallPath), g.Group(children))
}
...
func CloudClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudClosePath), g.Group(children))
}

func CloudDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudDownPath), g.Group(children))
}
...
func CloudOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudOutlinePath), g.Group(children))
}
...
func CloudUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudUpPath), g.Group(children))
}
...
func CoffeToGo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeToGoPath), g.Group(children))
}
...
func CoffeeTogo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeeTogoPath), g.Group(children))
}

func Color(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(colorPath), g.Group(children))
}
...
func CombineCells(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(combineCellsPath), g.Group(children))
}
...
func Confused(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(confusedPath), g.Group(children))
}
...
func Coolicons(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cooliconsPath), g.Group(children))
}
...
func CreditCardAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(creditCardAltPath), g.Group(children))
}

func CreditCardOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(creditCardOnePath), g.Group(children))
}
...
func Cupcake(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cupcakePath), g.Group(children))
}
...
func DashboardTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dashboardTwoPath), g.Group(children))
}
...
func DesktopTower(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(desktopTowerPath), g.Group(children))
}
...
func DotFiveXl(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dotFiveXlPath), g.Group(children))
}

func DotFourL(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dotFourLPath), g.Group(children))
}

func DotOneXs(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dotOneXsPath), g.Group(children))
}

func DotThreeM(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dotThreeMPath), g.Group(children))
}

func DotTwoS(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dotTwoSPath), g.Group(children))
}
...
func DoughnutChart(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doughnutChartPath), g.Group(children))
}
...
func DownloadDone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downloadDonePath), g.Group(children))
}

func DownloadPackage(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downloadPackagePath), g.Group(children))
}

func DragHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dragHorizontalPath), g.Group(children))
}

func DragVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dragVerticalPath), g.Group(children))
}
...
func Dropbox(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dropboxPath), g.Group(children))
}

func DummyCircle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dummyCirclePath), g.Group(children))
}

func DummyCircleSmall(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dummyCircleSmallPath), g.Group(children))
}

func DummySquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dummySquarePath), g.Group(children))
}

func DummySquareSmall(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dummySquareSmallPath), g.Group(children))
}
...
func EditPencilLineOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(editPencilLineOnePath), g.Group(children))
}

func EditPencilLineTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(editPencilLineTwoPath), g.Group(children))
}

func EditPencilOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(editPencilOnePath), g.Group(children))
}

func EditPencilTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(editPencilTwoPath), g.Group(children))
}

func Error(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(errorPath), g.Group(children))
}

func ErrorOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(errorOutlinePath), g.Group(children))
}
...
func FastRewind(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fastRewindPath), g.Group(children))
}
...
func FileBlank(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileBlankPath), g.Group(children))
}

func FileBlankFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileBlankFillPath), g.Group(children))
}

func FileBlankOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileBlankOutlinePath), g.Group(children))
}
...
func FileCss(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileCssPath), g.Group(children))
}
...
func FileFind(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileFindPath), g.Group(children))
}

func FileHtml(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileHtmlPath), g.Group(children))
}
...
func FileJpg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileJpgPath), g.Group(children))
}

func FileJs(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileJsPath), g.Group(children))
}
...
func FileNew(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileNewPath), g.Group(children))
}

func FilePdf(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(filePdfPath), g.Group(children))
}

func FilePng(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(filePngPath), g.Group(children))
}
...
func FileSvg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileSvgPath), g.Group(children))
}

func FileUpload(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fileUploadPath), g.Group(children))
}
...
func FilterOff(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(filterOffPath), g.Group(children))
}

func FilterOffOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(filterOffOutlinePath), g.Group(children))
}
...
func FirstAid(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(firstAidPath), g.Group(children))
}

func FirstPage(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(firstPagePath), g.Group(children))
}
...
func FolderCode(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(folderCodePath), g.Group(children))
}
...
func FolderUpload(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(folderUploadPath), g.Group(children))
}
...
func Font(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fontPath), g.Group(children))
}
...
func GridBig(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridBigPath), g.Group(children))
}

func GridBigRound(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridBigRoundPath), g.Group(children))
}

func GridHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridHorizontalPath), g.Group(children))
}

func GridHorizontalRound(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridHorizontalRoundPath), g.Group(children))
}

func GridRound(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridRoundPath), g.Group(children))
}

func GridSmall(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridSmallPath), g.Group(children))
}

func GridSmallRound(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridSmallRoundPath), g.Group(children))
}

func GridVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridVerticalPath), g.Group(children))
}

func GridVerticalRound(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridVerticalRoundPath), g.Group(children))
}
...
func GroupAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(groupAltPath), g.Group(children))
}

func Hamburger(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hamburgerPath), g.Group(children))
}

func HamburgerLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hamburgerLgPath), g.Group(children))
}

func HamburgerMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hamburgerMdPath), g.Group(children))
}
...
func Happy(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(happyPath), g.Group(children))
}
...
func HeadingHFive(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(headingHFivePath), g.Group(children))
}

func HeadingHFour(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(headingHFourPath), g.Group(children))
}

func HeadingHOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(headingHOnePath), g.Group(children))
}

func HeadingHSix(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(headingHSixPath), g.Group(children))
}

func HeadingHThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(headingHThreePath), g.Group(children))
}

func HeadingHTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(headingHTwoPath), g.Group(children))
}
...
func HeartOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heartOnePath), g.Group(children))
}
...
func HeartTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heartTwoPath), g.Group(children))
}
...
func HelpCircleOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(helpCircleOutlinePath), g.Group(children))
}

func HelpQuestionmark(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(helpQuestionmarkPath), g.Group(children))
}

func Hide(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hidePath), g.Group(children))
}

func HomeAltCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeAltCheckPath), g.Group(children))
}

func HomeAltFill(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeAltFillPath), g.Group(children))
}

func HomeAltMinus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeAltMinusPath), g.Group(children))
}
...
func HomeAltPlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeAltPlusPath), g.Group(children))
}

func HomeAltX(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeAltXPath), g.Group(children))
}

func HomeCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeCheckPath), g.Group(children))
}
...
func HomeHeart(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeHeartPath), g.Group(children))
}

func HomeHeartOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeHeartOnePath), g.Group(children))
}

func HomeMinus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeMinusPath), g.Group(children))
}
...
func HomePlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homePlusPath), g.Group(children))
}

func HomeX(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeXPath), g.Group(children))
}

func HouseAdd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(houseAddPath), g.Group(children))
}

func HouseCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(houseCheckPath), g.Group(children))
}

func HouseClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(houseClosePath), g.Group(children))
}

func HouseOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(houseOnePath), g.Group(children))
}

func HouseRemove(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(houseRemovePath), g.Group(children))
}

func HouseThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(houseThreePath), g.Group(children))
}

func HouseTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(houseTwoPath), g.Group(children))
}
...
func IdCard(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(idCardPath), g.Group(children))
}
...
func ImageAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(imageAltPath), g.Group(children))
}

func ImageOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(imageOnePath), g.Group(children))
}

func ImageTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(imageTwoPath), g.Group(children))
}
...
func InfoSquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(infoSquarePath), g.Group(children))
}

func InfoSquareOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(infoSquareOutlinePath), g.Group(children))
}
...
func Instance(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(instancePath), g.Group(children))
}

func Invision(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(invisionPath), g.Group(children))
}
...
func Javascript(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(javascriptPath), g.Group(children))
}
...
func LastPage(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lastPagePath), g.Group(children))
}
...
func LayersAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(layersAltPath), g.Group(children))
}
...
func LineBreak(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lineBreakPath), g.Group(children))
}

func LineChartDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lineChartDownPath), g.Group(children))
}

func LineChartUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lineChartUpPath), g.Group(children))
}

func LineL(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lineLPath), g.Group(children))
}

func LineM(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lineMPath), g.Group(children))
}

func LineS(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lineSPath), g.Group(children))
}

func LineSx(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lineSxPath), g.Group(children))
}

func LineXl(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lineXlPath), g.Group(children))
}
...
func LinkBreak(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkBreakPath), g.Group(children))
}

func LinkHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkHorizontalPath), g.Group(children))
}

func LinkHorizontalOff(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkHorizontalOffPath), g.Group(children))
}
...
func LinkVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkVerticalPath), g.Group(children))
}
...
func Linkpath(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkpathPath), g.Group(children))
}

func ListAdd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listAddPath), g.Group(children))
}
...
func ListChecklist(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listChecklistPath), g.Group(children))
}

func ListChecklistAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listChecklistAltPath), g.Group(children))
}
...
func ListOl(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listOlPath), g.Group(children))
}
...
func ListRemove(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listRemovePath), g.Group(children))
}

func ListUl(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listUlPath), g.Group(children))
}
...
func Loading(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(loadingPath), g.Group(children))
}
...
func LongBottomDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(longBottomDownPath), g.Group(children))
}

func LongBottomUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(longBottomUpPath), g.Group(children))
}

func LongDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(longDownPath), g.Group(children))
}

func LongLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(longLeftPath), g.Group(children))
}

func LongRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(longRightPath), g.Group(children))
}

func LongUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(longUpPath), g.Group(children))
}

func LongUpLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(longUpLeftPath), g.Group(children))
}

func MagnifyingGlassMinus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(magnifyingGlassMinusPath), g.Group(children))
}

func MagnifyingGlassPlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(magnifyingGlassPlusPath), g.Group(children))
}
...
func MainComponent(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mainComponentPath), g.Group(children))
}
...
func MenuAltFive(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuAltFivePath), g.Group(children))
}

func MenuAltFour(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuAltFourPath), g.Group(children))
}

func MenuAltOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuAltOnePath), g.Group(children))
}

func MenuAltThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuAltThreePath), g.Group(children))
}

func MenuAltTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuAltTwoPath), g.Group(children))
}

func MenuDuo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuDuoPath), g.Group(children))
}

func MenuDuoLg(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuDuoLgPath), g.Group(children))
}

func MenuDuoMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuDuoMdPath), g.Group(children))
}
...
func MessageCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(messageCheckPath), g.Group(children))
}
...
func MessageClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(messageClosePath), g.Group(children))
}
...
func MessagePlusAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(messagePlusAltPath), g.Group(children))
}

func MessageRound(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(messageRoundPath), g.Group(children))
}

func MessageWriting(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(messageWritingPath), g.Group(children))
}

func Messenger(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(messengerPath), g.Group(children))
}
...
func MobileAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mobileAltPath), g.Group(children))
}

func MobileButton(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mobileButtonPath), g.Group(children))
}
...
func MoreGridBig(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moreGridBigPath), g.Group(children))
}

func MoreGridSmall(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moreGridSmallPath), g.Group(children))
}
...
func MovingDesk(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(movingDeskPath), g.Group(children))
}
...
func NoteEdit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noteEditPath), g.Group(children))
}

func NoteSearch(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(noteSearchPath), g.Group(children))
}

func Notebook(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notebookPath), g.Group(children))
}
...
func NotificationActive(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notificationActivePath), g.Group(children))
}

func NotificationDeactivated(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notificationDeactivatedPath), g.Group(children))
}

func NotificationDot(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notificationDotPath), g.Group(children))
}

func NotificationMinus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notificationMinusPath), g.Group(children))
}

func NotificationOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notificationOutlinePath), g.Group(children))
}

func NotificationOutlineDot(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notificationOutlineDotPath), g.Group(children))
}

func NotificationOutlineMinus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notificationOutlineMinusPath), g.Group(children))
}

func NotificationOutlinePlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notificationOutlinePlusPath), g.Group(children))
}

func NotificationPlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(notificationPlusPath), g.Group(children))
}
...
func OctagonCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(octagonCheckPath), g.Group(children))
}

func OctagonHelp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(octagonHelpPath), g.Group(children))
}
...
func OffClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(offClosePath), g.Group(children))
}

func OffOutlineClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(offOutlineClosePath), g.Group(children))
}
...
func PaperclipAttechmentHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(paperclipAttechmentHorizontalPath), g.Group(children))
}

func PaperclipAttechmentTilt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(paperclipAttechmentTiltPath), g.Group(children))
}
...
func Path(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pathPath), g.Group(children))
}
...
func PauseCircleFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pauseCircleFilledPath), g.Group(children))
}
...
func PieChartFifty(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pieChartFiftyPath), g.Group(children))
}
...
func PieChartOutlineTwentyFive(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pieChartOutlineTwentyFivePath), g.Group(children))
}

func PieChartSeventyFive(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pieChartSeventyFivePath), g.Group(children))
}

func PieChartTwentyFive(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pieChartTwentyFivePath), g.Group(children))
}
...
func PlayArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(playArrowPath), g.Group(children))
}
...
func PlayCircleFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(playCircleFilledPath), g.Group(children))
}
...
func PlayStore(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(playStorePath), g.Group(children))
}
...
func QrCodeOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(qrCodeOnePath), g.Group(children))
}
...
func RadioFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(radioFilledPath), g.Group(children))
}

func RadioUnchecked(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(radioUncheckedPath), g.Group(children))
}
...
func Reddit(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(redditPath), g.Group(children))
}
...
func RefreshTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(refreshTwoPath), g.Group(children))
}

func RemoveMinus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(removeMinusPath), g.Group(children))
}

func RemoveMinusCircle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(removeMinusCirclePath), g.Group(children))
}
...
func Sad(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sadPath), g.Group(children))
}
...
func SearchMagnifyingGlass(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(searchMagnifyingGlassPath), g.Group(children))
}

func SearchSmall(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(searchSmallPath), g.Group(children))
}

func SearchSmallMinus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(searchSmallMinusPath), g.Group(children))
}

func SearchSmallPlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(searchSmallPlusPath), g.Group(children))
}

func SelectMultiple(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(selectMultiplePath), g.Group(children))
}
...
func SettingsFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(settingsFilledPath), g.Group(children))
}

func SettingsFuture(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(settingsFuturePath), g.Group(children))
}
...
func ShareIosExport(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shareIosExportPath), g.Group(children))
}
...
func ShoppingBagOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shoppingBagOnePath), g.Group(children))
}

func ShoppingBagTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shoppingBagTwoPath), g.Group(children))
}

func ShoppingCartOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shoppingCartOnePath), g.Group(children))
}

func ShoppingCartTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shoppingCartTwoPath), g.Group(children))
}

func ShortDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shortDownPath), g.Group(children))
}

func ShortLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shortLeftPath), g.Group(children))
}

func ShortRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shortRightPath), g.Group(children))
}

func ShortUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(shortUpPath), g.Group(children))
}

func Show(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(showPath), g.Group(children))
}
...
func SkipPrevious(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(skipPreviousPath), g.Group(children))
}
...
func SliderOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sliderOnePath), g.Group(children))
}

func SliderThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sliderThreePath), g.Group(children))
}

func SliderTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sliderTwoPath), g.Group(children))
}

func SmallLongDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(smallLongDownPath), g.Group(children))
}

func SmallLongLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(smallLongLeftPath), g.Group(children))
}

func SmallLongRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(smallLongRightPath), g.Group(children))
}

func SmallLongUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(smallLongUpPath), g.Group(children))
}
...
func SortAscending(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sortAscendingPath), g.Group(children))
}

func SortDescending(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sortDescendingPath), g.Group(children))
}
...
func SquareCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(squareCheckPath), g.Group(children))
}

func SquareHelp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(squareHelpPath), g.Group(children))
}

func SquareWarning(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(squareWarningPath), g.Group(children))
}
...
func StopSign(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(stopSignPath), g.Group(children))
}
...
func SubLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(subLeftPath), g.Group(children))
}

func SubRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(subRightPath), g.Group(children))
}
...
func SwatchesPalette(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(swatchesPalettePath), g.Group(children))
}

func SwichtLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(swichtLeftPath), g.Group(children))
}

func SwichtRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(swichtRightPath), g.Group(children))
}
...
func TableAdd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tableAddPath), g.Group(children))
}

func TableDelete(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tableDeletePath), g.Group(children))
}

func TableRemove(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tableRemovePath), g.Group(children))
}
...
func TabletButton(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tabletButtonPath), g.Group(children))
}
...
func TennisMatch(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tennisMatchPath), g.Group(children))
}

func TennisMatchAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tennisMatchAltPath), g.Group(children))
}
...
func ThinBigDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinBigDownPath), g.Group(children))
}

func ThinBigLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinBigLeftPath), g.Group(children))
}

func ThinBigRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinBigRightPath), g.Group(children))
}

func ThinBigUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinBigUpPath), g.Group(children))
}

func ThinLongDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinLongDownPath), g.Group(children))
}

func ThinLongLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinLongLeftPath), g.Group(children))
}

func ThinLongRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinLongRightPath), g.Group(children))
}

func ThinLongTwoDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinLongTwoDownPath), g.Group(children))
}

func ThinLongTwoLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinLongTwoLeftPath), g.Group(children))
}

func ThinLongTwoRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinLongTwoRightPath), g.Group(children))
}

func ThinLongTwoUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinLongTwoUpPath), g.Group(children))
}

func ThinLongUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thinLongUpPath), g.Group(children))
}

func TicketVoucher(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(ticketVoucherPath), g.Group(children))
}
...
func TimerAdd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(timerAddPath), g.Group(children))
}

func TimerClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(timerClosePath), g.Group(children))
}

func TimerRemove(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(timerRemovePath), g.Group(children))
}

func Transfer(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(transferPath), g.Group(children))
}
...
func TrashFull(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(trashFullPath), g.Group(children))
}
...
func TriangleCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleCheckPath), g.Group(children))
}

func TriangleWarning(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(triangleWarningPath), g.Group(children))
}
...
func UnfoldLess(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(unfoldLessPath), g.Group(children))
}

func UnfoldMore(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(unfoldMorePath), g.Group(children))
}
...
func UserCardId(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(userCardIdPath), g.Group(children))
}
...
func UserClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(userClosePath), g.Group(children))
}

func UserHeart(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(userHeartPath), g.Group(children))
}
...
func UserOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(userOnePath), g.Group(children))
}

func UserPin(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(userPinPath), g.Group(children))
}
...
func UserThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(userThreePath), g.Group(children))
}
...
func UserVoice(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(userVoicePath), g.Group(children))
}
...
func UsersGroup(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(usersGroupPath), g.Group(children))
}

func VolumeMax(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(volumeMaxPath), g.Group(children))
}

func VolumeMin(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(volumeMinPath), g.Group(children))
}
...
func VolumeOffTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(volumeOffTwoPath), g.Group(children))
}
...
func WarningOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(warningOutlinePath), g.Group(children))
}

func WaterDrop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(waterDropPath), g.Group(children))
}

func Wavy(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wavyPath), g.Group(children))
}

func WavyCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wavyCheckPath), g.Group(children))
}

func WavyHelp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wavyHelpPath), g.Group(children))
}

func WavyWarning(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wavyWarningPath), g.Group(children))
}

func WifiHigh(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wifiHighPath), g.Group(children))
}

func WifiLow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wifiLowPath), g.Group(children))
}

func WifiMedium(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wifiMediumPath), g.Group(children))
}

func WifiNone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wifiNonePath), g.Group(children))
}
...
func WifiProblem(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wifiProblemPath), g.Group(children))
}

func Window(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(windowPath), g.Group(children))
}

func WindowCheck(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(windowCheckPath), g.Group(children))
}

func WindowClose(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(windowClosePath), g.Group(children))
}

func WindowCodeBlock(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(windowCodeBlockPath), g.Group(children))
}

func WindowSidebar(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(windowSidebarPath), g.Group(children))
}

func WindowTerminal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(windowTerminalPath), g.Group(children))
}
