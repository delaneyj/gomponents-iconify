...
func IconFromName(name string) g.Node {
	...
	case "alignImageCenter":
		return AlignImageCenter()
	case "alignImageLeft":
		return AlignImageLeft()
	case "alignImageNone":
		return AlignImageNone()
	...
	case "linkBreak":
		return LinkBreak()
	case "listCheckmark":
		return ListCheckmark()
	case "listOrdered":
		return ListOrdered()
	case "listOrderedRtl":
		return ListOrderedRtl()
	case "listUnordered":
	...
	case "readerExternal":
		return ReaderExternal()
	case "readerFollow":
		return ReaderFollow()
	case "readerFollowConversation":
		return ReaderFollowConversation()
	case "readerFollowing":
		return ReaderFollowing()
	case "readerFollowingConversation":
		return ReaderFollowingConversation()
	case "readerShare":
		return ReaderShare()
	case "readerStar":
		return ReaderStar()
