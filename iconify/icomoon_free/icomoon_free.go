...
func IconFromName(name string) g.Node {
	...
	case "arrowDownLeftTwo":
		return ArrowDownLeftTwo()
	case "arrowDownRight":
		return ArrowDownRight()
	case "arrowDownRightTwo":
		return ArrowDownRightTwo()
	case "arrowDownTwo":
		return ArrowDownTwo()
	case "arrowLeft":
		return ArrowLeft()
	...
	case "arrowUpLeft":
		return ArrowUpLeft()
	case "arrowUpLeftTwo":
		return ArrowUpLeftTwo()
	case "arrowUpRight":
		return ArrowUpRight()
	case "arrowUpRightTwo":
		return ArrowUpRightTwo()
	case "arrowUpTwo":
		return ArrowUpTwo()
	case "attachment":
		return Attachment()
	...
	case "googlePlus":
		return GooglePlus()
	case "googlePlusThree":
		return GooglePlusThree()
	case "googlePlusTwo":
		return GooglePlusTwo()
	case "googleThree":
		return GoogleThree()
	case "googleTwo":
		return GoogleTwo()
	...
	case "radioChecked":
		return RadioChecked()
	case "radioCheckedTwo":
		return RadioCheckedTwo()
	case "radioUnchecked":
	...
	case "sortNumbericDesc":
		return SortNumbericDesc()
	case "sortNumericAsc":
		return SortNumericAsc()
	case "soundcloud":
		return Soundcloud()
	case "soundcloudTwo":
		return SoundcloudTwo()
	case "spades":
		return Spades()
	case "spellCheck":
		return SpellCheck()
