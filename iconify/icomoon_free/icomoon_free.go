...
func ArrowUp(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 .5L.5 8H5v8h6V8h4.5z"/>`),
		g.Group(children),
	)
}
...
func Bookmark(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M3 0v16l5-5l5 5V0z"/>`),
		g.Group(children),
	)
}
...
func Bug(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M16 9V8h-3.02a5.785 5.785 0 0 0-1.12-3.004h2.53L15.485.617l-.97-.243l-.905 3.621h-2.729l-.042-.032A2.996 2.996 0 0 0 8.001-.001a2.996 2.996 0 0 0-2.838 3.964l-.042.032H2.392L1.487.374l-.97.243l1.095 4.379h2.53A5.785 5.785 0 0 0 3.022 8H.002v1h3.021c.059.713.242 1.388.526 1.996H1.612L.517 15.375l.97.243l.905-3.621h1.756c.917 1.219 2.303 1.996 3.854 1.996s2.937-.777 3.854-1.996h1.756l.905 3.621l.97-.243l-1.095-4.379h-1.937A5.903 5.903 0 0 0 12.981 9h3.021z"/>`),
		g.Group(children),
	)
}
...
func DrawerTwo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="m15.89 10.188l-4-5A.5.5 0 0 0 11.5 5h-7a.497.497 0 0 0-.39.188l-4 5A.5.5 0 0 0 0 10.5V15a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-4.5a.497.497 0 0 0-.11-.312zM15 11h-3.5l-2 2h-3l-2-2H1v-.325L4.74 6h6.519l3.74 4.675V11z"/>`),
		g.Group(children),
	)
}
...
func Enlarge(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M16 0H9.5L12 2.5l-3 3L10.5 7l3-3L16 6.5zm0 16V9.5L13.5 12l-3-3L9 10.5l3 3L9.5 16zM0 16h6.5L4 13.5l3-3L5.5 9l-3 3L0 9.5zM0 0v6.5L2.5 4l3 3L7 5.5l-3-3L6.5 0z"/>`),
		g.Group(children),
	)
}
...
func Envelop(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M14.5 2h-13C.675 2 0 2.675 0 3.5v10c0 .825.675 1.5 1.5 1.5h13c.825 0 1.5-.675 1.5-1.5v-10c0-.825-.675-1.5-1.5-1.5zM6.23 8.6L2 11.895V4.057L6.23 8.6zM2.756 4h10.488L8 7.938L2.756 4zm3.639 4.777L8 10.5l1.605-1.723L12.895 13h-9.79l3.29-4.223zM9.77 8.6L14 4.057v7.838L9.77 8.6z"/>`),
		g.Group(children),
	)
}
...
func Facebook(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M9.5 3H12V0H9.5C7.57 0 6 1.57 6 3.5V5H4v3h2v8h3V8h2.5l.5-3H9V3.5c0-.271.229-.5.5-.5z"/>`),
		g.Group(children),
	)
}
...
func FacebookTwo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M14.5 0h-13C.675 0 0 .675 0 1.5v13c0 .825.675 1.5 1.5 1.5H8V9H6V7h2V6c0-1.653 1.347-3 3-3h2v2h-2c-.55 0-1 .45-1 1v1h3l-.5 2H10v7h4.5c.825 0 1.5-.675 1.5-1.5v-13c0-.825-.675-1.5-1.5-1.5z"/>`),
		g.Group(children),
	)
}
...
func FileText(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M13.5 0h-12C.675 0 0 .675 0 1.5v13c0 .825.675 1.5 1.5 1.5h12c.825 0 1.5-.675 1.5-1.5v-13c0-.825-.675-1.5-1.5-1.5zM13 14H2V2h11v12zM4 7h7v1H4zm0 2h7v1H4zm0 2h7v1H4zm0-6h7v1H4z"/>`),
		g.Group(children),
	)
}
...
func Film(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M0 2v12h16V2H0zm3 11H1v-2h2v2zm0-4H1V7h2v2zm0-4H1V3h2v2zm9 8H4V3h8v10zm3 0h-2v-2h2v2zm0-4h-2V7h2v2zm0-4h-2V3h2v2zM6 5v6l4-3z"/>`),
		g.Group(children),
	)
}
...
func Filter(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 0C3.582 0 0 1.119 0 2.5V4l6 6v5c0 .552.895 1 2 1s2-.448 2-1v-5l6-6V2.5C16 1.119 12.418 0 8 0zM1.475 2.169c.374-.213.9-.416 1.52-.586C4.369 1.207 6.147 1 8 1s3.631.207 5.005.583c.62.17 1.146.372 1.52.586c.247.141.38.26.442.331c-.062.071-.195.19-.442.331c-.374.213-.9.416-1.52.586C11.631 3.793 9.853 4 8 4s-3.631-.207-5.005-.583c-.62-.17-1.146-.372-1.52-.586a1.741 1.741 0 0 1-.442-.331c.062-.071.195-.19.442-.331z"/>`),
		g.Group(children),
	)
}
...
func Folder(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="m7 2l2 2h7v11H0V2z"/>`),
		g.Group(children),
	)
}
...
func Instagram(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M14.5 0h-13C.675 0 0 .675 0 1.5v13c0 .825.675 1.5 1.5 1.5h13c.825 0 1.5-.675 1.5-1.5v-13c0-.825-.675-1.5-1.5-1.5zM11 2.5c0-.275.225-.5.5-.5h2c.275 0 .5.225.5.5v2c0 .275-.225.5-.5.5h-2a.501.501 0 0 1-.5-.5v-2zM8 5a3.001 3.001 0 0 1 0 6a3.001 3.001 0 0 1 0-6zm6 8.5c0 .275-.225.5-.5.5h-11a.501.501 0 0 1-.5-.5V7h1.1A4.999 4.999 0 0 0 8 13a4.999 4.999 0 0 0 4.9-6H14v6.5z"/>`),
		g.Group(children),
	)
}
...
func Keyboard(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M17 2H1c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h16c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1zm-7 2h2v2h-2V4zm3 3v2h-2V7h2zM7 4h2v2H7V4zm3 3v2H8V7h2zM4 4h2v2H4V4zm3 3v2H5V7h2zM2 4h1v2H2V4zm0 3h2v2H2V7zm1 5H2v-2h1v2zm9 0H4v-2h8v2zm4 0h-3v-2h3v2zm0-3h-2V7h2v2zm0-3h-3V4h3v2z"/>`),
		g.Group(children),
	)
}
...
func Location(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 0a5 5 0 0 0-5 5c0 5 5 11 5 11s5-6 5-11a5 5 0 0 0-5-5zm0 8a3 3 0 1 1 0-6a3 3 0 0 1 0 6z"/>`),
		g.Group(children),
	)
}
...
func MenuFour(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M0 3h14v3H0V3zm0 4h14v3H0V7zm0 4h14v3H0v-3zm15.5-1l3-3l3 3z"/>`),
		g.Group(children),
	)
}
...
func MoveDown(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M12 11V5h-1v6H8.5l3 3l3-3zM5 4v3H2V4h3zm1-1H1v5h5V3zm-5 7h1.5v1H1v-1zm2 0h1.5v1H3v-1zm2 0h1v1.5H5V10zm-4 3.5h1V15H1v-1.5zm1.5.5H4v1H2.5v-1zm2 0H6v1H4.5v-1zM1 11.5h1V13H1v-1.5zm4 .5h1v1.5H5V12z"/>`),
		g.Group(children),
	)
}
...
func NeutralTwo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm2 12H6v-1h4v1zm1-8a1 1 0 1 1 0 2a1 1 0 0 1 0-2zM5 4a1 1 0 1 1 0 2a1 1 0 0 1 0-2z"/>`),
		g.Group(children),
	)
}
...
func Newspaper(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M14 4V2H0v11a1 1 0 0 0 1 1h13.5a1.5 1.5 0 0 0 1.5-1.5V4h-2zm-1 9H1V3h12v10zM2 5h10v1H2zm6 2h4v1H8zm0 2h4v1H8zm0 2h3v1H8zM2 7h5v5H2z"/>`),
		g.Group(children),
	)
}
...
func NextTwo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M12 2v12h-2V8.5l-5 5v-11l5 5V2z"/>`),
		g.Group(children),
	)
}
...
func Notification(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 1.5c-1.736 0-3.369.676-4.596 1.904S1.5 6.264 1.5 8c0 1.736.676 3.369 1.904 4.596S6.264 14.5 8 14.5c1.736 0 3.369-.676 4.596-1.904S14.5 9.736 14.5 8c0-1.736-.676-3.369-1.904-4.596S9.736 1.5 8 1.5zM8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0zM7 11h2v2H7zm0-8h2v6H7z"/>`),
		g.Group(children),
	)
}
...
func Omega(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M11 14h4l1-2v4h-6v-3.347c2.049-.883 3.5-3.081 3.5-5.653c0-3.35-2.462-5.973-5.5-5.973S2.5 3.649 2.5 7c0 2.572 1.451 4.77 3.5 5.653V16H0v-4l1 2h4v-.509C2.068 12.453 0 9.938 0 7c0-3.866 3.582-7 8-7s8 3.134 8 7c0 2.938-2.068 5.452-5 6.491V14z"/>`),
		g.Group(children),
	)
}
...
func ParagraphJustify(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M0 1h16v2H0zm0 3h16v2H0zm0 3h16v2H0zm0 3h16v2H0zm0 3h16v2H0z"/>`),
		g.Group(children),
	)
}
...
func ParagraphLeft(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M0 1h16v2H0zm0 3h10v2H0zm0 6h10v2H0zm0-3h16v2H0zm0 6h16v2H0z"/>`),
		g.Group(children),
	)
}
...
func Paste(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M11 2H9V1c0-.55-.45-1-1-1H6c-.55 0-1 .45-1 1v1H3v2h8V2zM8 2H6v-.998L6.002 1h1.996L8 1.002V2zm5 3V2.5c0-.275-.225-.5-.5-.5h-1v1h.5v2H9L6 8v4H2V3h.5V2h-1c-.275 0-.5.225-.5.5v10c0 .275.225.5.5.5H6v3h10V5h-3zM9 6.414V8H7.414L9 6.414zM15 15H7V9h3V6h5v9z"/>`),
		g.Group(children),
	)
}
...
func Pause(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm0 14.5a6.5 6.5 0 1 1 0-13a6.5 6.5 0 0 1 0 13zM5 5h2v6H5zm4 0h2v6H9z"/>`),
		g.Group(children),
	)
}
...
func PauseTwo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M2 2h5v12H2zm7 0h5v12H9z"/>`),
		g.Group(children),
	)
}
...
func PhoneHangUp(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M15.897 9c.125.867.207 2.053-.182 2.507c-.643.751-4.714.751-4.714-.751c0-.756.67-1.252.027-2.003c-.632-.738-1.766-.75-3.027-.751s-2.394.012-3.027.751c-.643.751.027 1.247.027 2.003c0 1.501-4.071 1.501-4.714.751C-.102 11.053-.02 9.867.105 9c.096-.579.339-1.203 1.118-2c1.168-1.09 2.935-1.98 6.716-2h.126c3.781.019 5.548.91 6.716 2c.778.797 1.022 1.421 1.118 2z"/>`),
		g.Group(children),
	)
}
...
func Question(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M7 11h2v2H7zm4-7a1 1 0 0 1 1 1v3l-3 2H7V9l3-2V6H5V4h6zM8 1.5c-1.736 0-3.369.676-4.596 1.904S1.5 6.264 1.5 8c0 1.736.676 3.369 1.904 4.596S6.264 14.5 8 14.5c1.736 0 3.369-.676 4.596-1.904S14.5 9.736 14.5 8c0-1.736-.676-3.369-1.904-4.596S9.736 1.5 8 1.5zM8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0z"/>`),
		g.Group(children),
	)
}
...
func RadioUnchecked(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm0 14A6 6 0 1 1 8 2a6 6 0 0 1 0 12z"/>`),
		g.Group(children),
	)
}
...
func Search(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="m15.504 13.616l-3.79-3.223c-.392-.353-.811-.514-1.149-.499a6 6 0 1 0-.672.672c-.016.338.146.757.499 1.149l3.223 3.79c.552.613 1.453.665 2.003.115s.498-1.452-.115-2.003zM6 10a4 4 0 1 1 0-8a4 4 0 0 1 0 8z"/>`),
		g.Group(children),
	)
}
...
func ShockedTwo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zM5 7c-.552 0-1-.672-1-1.5S4.448 4 5 4s1 .672 1 1.5S5.552 7 5 7zm3 6a2 2 0 1 1-.001-3.999A2 2 0 0 1 8 13zm3-6c-.552 0-1-.672-1-1.5S10.448 4 11 4s1 .672 1 1.5S11.552 7 11 7z"/>`),
		g.Group(children),
	)
}
...
func SortNumericAsc(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M5 12V0H3v12H.5L4 15.5L7.5 12H5zm8.5-5a.5.5 0 0 1-.5-.5V1h-.5a.5.5 0 0 1 0-1h1a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-.5.5zm1 2h-3a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5H14v2h-2.5a.5.5 0 0 0 0 1h3a.5.5 0 0 0 .5-.5v-6a.5.5 0 0 0-.5-.5zM12 10h2v2h-2v-2z"/>`),
		g.Group(children),
	)
}
...
func Stop(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm0 14.5a6.5 6.5 0 1 1 0-13a6.5 6.5 0 0 1 0 13zM5 5h6v6H5z"/>`),
		g.Group(children),
	)
}
...
func Subscript(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M12 14.219V15h2v1h-3v-2.281l2-.938V12h-2v-1h3v2.281zM10.563 4H8.438L5.5 6.938L2.562 4H.437l4 4l-4 4h2.125L5.5 9.062L8.438 12h2.125l-4-4z"/>`),
		g.Group(children),
	)
}
...
func SubscriptTwo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="m3.032 13l.9-3h4.137l.9 3h1.775l-3-10H4.256l-3 10h1.776zm2.4-8h1.137l.9 3H4.532l.9-3zM16 3l-2.5 4L11 3h5zm-2.5 10h-1a.5.5 0 0 1 0-1h2a.5.5 0 0 0 0-1h-2a1.502 1.502 0 0 0-1.117 2.5c.275.307.674.5 1.117.5h1a.5.5 0 0 1 0 1h-2a.5.5 0 0 0 0 1h2a1.502 1.502 0 0 0 1.117-2.5A1.496 1.496 0 0 0 13.5 13z"/>`),
		g.Group(children),
	)
}
...
func Switch(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M10 2.29v2.124c.566.247 1.086.6 1.536 1.05C12.48 6.408 13 7.664 13 9s-.52 2.591-1.464 3.536C10.592 13.48 9.336 14 8 14s-2.591-.52-3.536-1.464C3.52 11.592 3 10.336 3 9s.52-2.591 1.464-3.536c.45-.45.97-.803 1.536-1.05V2.29a7 7 0 1 0 4 0zM7 0h2v8H7z"/>`),
		g.Group(children),
	)
}
...
func Terminal(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M0 1v14h16V1H0zm15 13H1V2h14v12zM14 3H2v10h12V3zM7 8H6v1H5v1H4V9h1V8h1V7H5V6H4V5h1v1h1v1h1v1zm4 2H8V9h3v1z"/>`),
		g.Group(children),
	)
}
...
func Tumblr(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M9.001 7v3.659c0 .928-.012 1.463.086 1.727c.098.262.342.534.609.691c.354.212.758.318 1.214.318c.81 0 1.289-.107 2.09-.633v2.405a9.089 9.089 0 0 1-1.833.639A7.93 7.93 0 0 1 9.369 16a4.9 4.9 0 0 1-1.725-.276a4.195 4.195 0 0 1-1.438-.79c-.398-.343-.672-.706-.826-1.091s-.23-.944-.23-1.676V6.556H3.003V4.29c.628-.204 1.331-.497 1.778-.877a4.386 4.386 0 0 0 1.08-1.374C6.133 1.505 6.32.825 6.422 0h2.579v4H13v3H9.001z"/>`),
		g.Group(children),
	)
}
...
func Underline(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M11 1h2v6.5c0 2.485-2.239 4.5-5 4.5S3 9.985 3 7.5V1h2v6.5c0 .628.285 1.23.802 1.695C6.379 9.714 7.159 10 8 10s1.621-.286 2.198-.805C10.715 8.729 11 8.127 11 7.5V1zM3 13h10v2H3z"/>`),
		g.Group(children),
	)
}
...
func Undo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 1a7.979 7.979 0 0 0-5.657 2.343L0 1v6h6L3.757 4.757a6 6 0 1 1 8.211 8.743l1.323 1.5A8 8 0 0 0 8 1z"/>`),
		g.Group(children),
	)
}
...
func UserMinus(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M6 11.5a5.508 5.508 0 0 1 3.594-5.159A4.574 4.574 0 0 0 10 4.5C10 2.015 10 0 7 0S4 2.015 4 4.5c0 1.548.898 3.095 2 3.716v.825C2.608 9.318 0 10.985 0 13h6.208A5.5 5.5 0 0 1 6 11.5z"/><path fill="currentColor" d="M11.5 7a4.5 4.5 0 1 0 0 9a4.5 4.5 0 0 0 0-9zm2.5 5H9v-1h5v1z"/>`),
		g.Group(children),
	)
}
...
func Users(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M12 12.041v-.825c1.102-.621 2-2.168 2-3.716C14 5.015 14 3 11 3S8 5.015 8 7.5c0 1.548.898 3.095 2 3.716v.825c-3.392.277-6 1.944-6 3.959h14c0-2.015-2.608-3.682-6-3.959z"/><path fill="currentColor" d="M5.112 12.427c.864-.565 1.939-.994 3.122-1.256a5.667 5.667 0 0 1-.633-.922a5.726 5.726 0 0 1-.726-2.748c0-1.344 0-2.614.478-3.653c.464-1.008 1.299-1.633 2.488-1.867C9.577.786 8.873.001 7 .001c-3 0-3 2.015-3 4.5c0 1.548.898 3.095 2 3.716v.825c-3.392.277-6 1.944-6 3.959h4.359c.227-.202.478-.393.753-.573z"/>`),
		g.Group(children),
	)
}
...
func VolumeDecrease(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M8 7h8v2H8V7zm-1.5 8a.504.504 0 0 1-.354-.146L2.292 11H.499a.5.5 0 0 1-.5-.5v-5a.5.5 0 0 1 .5-.5h1.793l3.854-3.854A.499.499 0 0 1 7 1.5v13a.5.5 0 0 1-.5.5z"/>`),
		g.Group(children),
	)
}
...
func VolumeMute(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="M6.5 15a.504.504 0 0 1-.354-.146L2.292 11H.499a.5.5 0 0 1-.5-.5v-5a.5.5 0 0 1 .5-.5h1.793l3.854-3.854A.499.499 0 0 1 7 1.5v13a.5.5 0 0 1-.5.5z"/>`),
		g.Group(children),
	)
}
...
func Warning(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="m8 1.45l6.705 13.363H1.296L8.001 1.45zM8 0c-.345 0-.69.233-.951.698L.22 14.309C-.303 15.239.142 16 1.209 16h13.583c1.067 0 1.512-.761.989-1.691L8.952.698C8.69.233 8.346 0 8.001 0z"/><path fill="currentColor" d="M9 13a1 1 0 1 1-2 0a1 1 0 0 1 2 0zm-1-2a1 1 0 0 1-1-1V7a1 1 0 0 1 2 0v3a1 1 0 0 1-1 1z"/>`),
		g.Group(children),
	)
}
...
func ZoomIn(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="m15.504 13.616l-3.79-3.223c-.392-.353-.811-.514-1.149-.499a6 6 0 1 0-.672.672c-.016.338.146.757.499 1.149l3.223 3.79c.552.613 1.453.665 2.003.115s.498-1.452-.115-2.003zM6 10a4 4 0 1 1 0-8a4 4 0 0 1 0 8zm1-7H5v2H3v2h2v2h2V7h2V5H7z"/>`),
		g.Group(children),
	)
}
...
func ZoomOut(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("16"),
		h.Height("16"),
		g.Raw(`<path fill="currentColor" d="m15.504 13.616l-3.79-3.223c-.392-.353-.811-.514-1.149-.499a6 6 0 1 0-.672.672c-.016.338.146.757.499 1.149l3.223 3.79c.552.613 1.453.665 2.003.115s.498-1.452-.115-2.003zM6 10a4 4 0 1 1 0-8a4 4 0 0 1 0 8zM3 5h6v2H3z"/>`),
		g.Group(children),
	)
}
