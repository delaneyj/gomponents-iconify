...
func IconFromName(name string) g.Node {
	...
	case "kakaotalk":
		return Kakaotalk()
	case "kakaotalkSquare":
		return KakaotalkSquare()
	case "kanjiChu":
		return KanjiChu()
	case "kanjiUtage":
		return KanjiUtage()
	...
	case "ninja":
		return Ninja()
	case "noCommentBubble":
		return NoCommentBubble()
	case "noSmokingAlt":
		return NoSmokingAlt()
	case "oSquare":
		return OSquare()
	...
	case "timeslot":
		return Timeslot()
	case "timeslotQuestion":
		return TimeslotQuestion()
	case "timeslots":
		return Timeslots()
	case "twoSquare":
		return TwoSquare()
	...
	case "userSuit":
		return UserSuit()
	case "userSuitFemale":
		return UserSuitFemale()
	case "userWaiter":
		return UserWaiter()
	case "userWaiterFemale":
		return UserWaiterFemale()
	case "vSquare":
		return VSquare()
	case "volumeOn":
		return VolumeOn()
