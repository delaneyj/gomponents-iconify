...
func IconFromName(name string) g.Node {
	...
	case "accountBox":
		return AccountBox()
	case "accountBoxMail":
		return AccountBoxMail()
	case "accountBoxO":
		return AccountBoxO()
	case "accountBoxPhone":
		return AccountBoxPhone()
	case "accountCalendar":
	...
	case "accountsList":
		return AccountsList()
	case "accountsListAlt":
		return AccountsListAlt()
	case "accountsOutline":
		return AccountsOutline()
	...
	case "airlineSeatIndividualSuite":
		return AirlineSeatIndividualSuite()
	case "airlineSeatLegroomExtra":
		return AirlineSeatLegroomExtra()
	case "airlineSeatLegroomNormal":
		return AirlineSeatLegroomNormal()
	case "airlineSeatLegroomReduced":
		return AirlineSeatLegroomReduced()
	...
	case "aspectRatio":
		return AspectRatio()
	case "aspectRatioAlt":
		return AspectRatioAlt()
	case "assignment":
		return Assignment()
	case "assignmentAccount":
		return AssignmentAccount()
	case "assignmentAlert":
		return AssignmentAlert()
	...
	case "brightnessSeven":
		return BrightnessSeven()
	case "brightnessSix":
		return BrightnessSix()
	case "brightnessThree":
	...
	case "cloudOutline":
		return CloudOutline()
	case "cloudOutlineAlt":
		return CloudOutlineAlt()
	case "cloudUpload":
		return CloudUpload()
	case "cocktail":
		return Cocktail()
	...
	case "collectionCasePlay":
		return CollectionCasePlay()
	case "collectionFolderImage":
		return CollectionFolderImage()
	case "collectionImage":
		return CollectionImage()
	case "collectionImageO":
		return CollectionImageO()
	case "collectionItem":
		return CollectionItem()
	case "collectionItemEight":
		return CollectionItemEight()
	case "collectionItemFive":
		return CollectionItemFive()
	case "collectionItemFour":
		return CollectionItemFour()
	case "collectionItemNine":
		return CollectionItemNine()
	case "collectionItemNinePlus":
		return CollectionItemNinePlus()
	case "collectionItemOne":
		return CollectionItemOne()
	case "collectionItemSeven":
		return CollectionItemSeven()
	case "collectionItemSix":
		return CollectionItemSix()
	case "collectionItemThree":
		return CollectionItemThree()
	case "collectionItemTwo":
		return CollectionItemTwo()
	case "collectionMusic":
		return CollectionMusic()
	case "collectionPdf":
		return CollectionPdf()
	case "collectionPlus":
		return CollectionPlus()
	case "collectionSpeaker":
	...
	case "cropPortrait":
		return CropPortrait()
	case "cropSevenFive":
		return CropSevenFive()
	case "cropSixteenNine":
		return CropSixteenNine()
	case "cropSquare":
		return CropSquare()
	case "cropThreeTwo":
		return CropThreeTwo()
	...
	case "formatStrikethroughS":
		return FormatStrikethroughS()
	case "formatSubject":
		return FormatSubject()
	case "formatUnderlined":
		return FormatUnderlined()
	case "formatValignBottom":
		return FormatValignBottom()
	case "formatValignCenter":
		return FormatValignCenter()
	case "formatValignTop":
		return FormatValignTop()
	case "forward":
		return Forward()
	case "forwardFive":
		return ForwardFive()
	...
	case "labelAlt":
		return LabelAlt()
	case "labelAltOutline":
		return LabelAltOutline()
	case "labelHeart":
		return LabelHeart()
	case "labels":
		return Labels()
	...
	case "landscape":
		return Landscape()
	case "languageCssThree":
		return LanguageCssThree()
	case "languageHtmlFive":
		return LanguageHtmlFive()
	case "languageJavascript":
		return LanguageJavascript()
	case "languagePython":
		return LanguagePython()
	case "languagePythonAlt":
		return LanguagePythonAlt()
	case "laptop":
		return Laptop()
	...
	case "longArrowReturn":
		return LongArrowReturn()
	case "longArrowRight":
	...
	case "plusCircleO":
		return PlusCircleO()
	case "plusCircleODuplicate":
		return PlusCircleODuplicate()
	case "plusOne":
		return PlusOne()
	case "plusSquare":
		return PlusSquare()
	...
	case "portableWifi":
		return PortableWifi()
	case "portableWifiChanges":
		return PortableWifiChanges()
	case "portableWifiOff":
		return PortableWifiOff()
	case "power":
		return Power()
	case "powerInput":
		return PowerInput()
	...
	case "refreshSync":
		return RefreshSync()
	case "refreshSyncAlert":
		return RefreshSyncAlert()
	case "refreshSyncOff":
		return RefreshSyncOff()
	case "remoteControl":
		return RemoteControl()
	case "remoteControlAlt":
		return RemoteControlAlt()
	case "repeat":
		return Repeat()
	case "repeatOne":
		return RepeatOne()
	...
	case "smartphoneAndroid":
		return SmartphoneAndroid()
	case "smartphoneDownload":
		return SmartphoneDownload()
	case "smartphoneErase":
		return SmartphoneErase()
	case "smartphoneInfo":
		return SmartphoneInfo()
	case "smartphoneIphone":
		return SmartphoneIphone()
	case "smartphoneLandscape":
		return SmartphoneLandscape()
	case "smartphoneLandscapeLock":
		return SmartphoneLandscapeLock()
	case "smartphoneLock":
		return SmartphoneLock()
	case "smartphonePortraitLock":
		return SmartphonePortraitLock()
	case "smartphoneRing":
		return SmartphoneRing()
	case "smartphoneSetting":
		return SmartphoneSetting()
	case "smartphoneSetup":
	...
	case "store":
		return Store()
	case "storeTwentyFour":
		return StoreTwentyFour()
	case "subway":
		return Subway()
	case "sun":
		return Sun()
	...
	case "timeRestore":
		return TimeRestore()
	case "timeRestoreSetting":
		return TimeRestoreSetting()
	case "timer":
		return Timer()
	case "timerOff":
		return TimerOff()
