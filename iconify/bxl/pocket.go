...
func Pocket(children ...g.Node) g.Node {
	return s.SVG(
		...
		g.Raw(`<path fill="currentColor" d="M19.327 3.983H4.746c-.947 0-1.736.726-1.736 1.673v5.396c0 4.892 4.04 8.964 9.026 8.964c4.955 0 8.964-4.072 8.964-8.964V5.656c0-.947-.758-1.673-1.673-1.673zm-2.178 6.691l-4.293 4.04c-.221.253-.567.348-.82.348c-.315 0-.631-.095-.884-.348l-4.229-4.04c-.441-.473-.504-1.262 0-1.768c.475-.441 1.263-.504 1.736 0l3.377 3.251l3.44-3.251c.441-.504 1.23-.441 1.673 0c.442.506.442 1.295 0 1.768z"/>`),
		g.Group(children),
	)
}