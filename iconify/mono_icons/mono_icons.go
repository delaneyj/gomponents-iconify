...
func Add(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M12 4a1 1 0 0 1 1 1v6h6a1 1 0 1 1 0 2h-6v6a1 1 0 1 1-2 0v-6H5a1 1 0 1 1 0-2h6V5a1 1 0 0 1 1-1z"/>`),
		g.Group(children),
	)
}
...
func ArrowRight(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M12.293 5.293a1 1 0 0 1 1.414 0l6 6a1 1 0 0 1 0 1.414l-6 6a1 1 0 0 1-1.414-1.414L16.586 13H5a1 1 0 1 1 0-2h11.586l-4.293-4.293a1 1 0 0 1 0-1.414z"/>`),
		g.Group(children),
	)
}
...
func ArrowUp(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M12 4a1 1 0 0 1 .707.293l6 6a1 1 0 0 1-1.414 1.414L13 7.414V19a1 1 0 1 1-2 0V7.414l-4.293 4.293a1 1 0 0 1-1.414-1.414l6-6A1 1 0 0 1 12 4z"/>`),
		g.Group(children),
	)
}
...
func CaretRight(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="m10 7l6 5l-6 5V7z"/>`),
		g.Group(children),
	)
}
...
func Check(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M20.664 5.253a1 1 0 0 1 .083 1.411l-10.666 12a1 1 0 0 1-1.495 0l-5.333-6a1 1 0 0 1 1.494-1.328l4.586 5.159l9.92-11.16a1 1 0 0 1 1.411-.082z"/>`),
		g.Group(children),
	)
}
...
func ChevronDoubleDown(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M5.293 6.293a1 1 0 0 1 1.414 0L12 11.586l5.293-5.293a1 1 0 1 1 1.414 1.414l-6 6a1 1 0 0 1-1.414 0l-6-6a1 1 0 0 1 0-1.414zm0 6a1 1 0 0 1 1.414 0L12 17.586l5.293-5.293a1 1 0 0 1 1.414 1.414l-6 6a1 1 0 0 1-1.414 0l-6-6a1 1 0 0 1 0-1.414z"/>`),
		g.Group(children),
	)
}
...
func ChevronDown(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M5.293 9.293a1 1 0 0 1 1.414 0L12 14.586l5.293-5.293a1 1 0 1 1 1.414 1.414l-6 6a1 1 0 0 1-1.414 0l-6-6a1 1 0 0 1 0-1.414z"/>`),
		g.Group(children),
	)
}
...
func ChevronLeft(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M14.707 5.293a1 1 0 0 1 0 1.414L9.414 12l5.293 5.293a1 1 0 0 1-1.414 1.414l-6-6a1 1 0 0 1 0-1.414l6-6a1 1 0 0 1 1.414 0z"/>`),
		g.Group(children),
	)
}
...
func ChevronRight(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M9.293 18.707a1 1 0 0 1 0-1.414L14.586 12L9.293 6.707a1 1 0 0 1 1.414-1.414l6 6a1 1 0 0 1 0 1.414l-6 6a1 1 0 0 1-1.414 0z"/>`),
		g.Group(children),
	)
}
...
func ChevronUp(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M11.293 7.293a1 1 0 0 1 1.414 0l6 6a1 1 0 0 1-1.414 1.414L12 9.414l-5.293 5.293a1 1 0 0 1-1.414-1.414l6-6z"/>`),
		g.Group(children),
	)
}
...
func Circle(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M12 4a8 8 0 1 0 0 16a8 8 0 0 0 0-16zM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12z"/>`),
		g.Group(children),
	)
}
...
func CircleAdd(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M12 4a8 8 0 1 0 0 16a8 8 0 0 0 0-16zM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12zm10-5a1 1 0 0 1 1 1v3h3a1 1 0 1 1 0 2h-3v3a1 1 0 1 1-2 0v-3H8a1 1 0 1 1 0-2h3V8a1 1 0 0 1 1-1z"/>`),
		g.Group(children),
	)
}
...
func CircleArrowDown(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M12 4a8 8 0 1 0 0 16a8 8 0 0 0 0-16zM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12zm10-6a1 1 0 0 1 1 1v7.586l2.293-2.293a1 1 0 0 1 1.414 1.414l-4 4a1 1 0 0 1-1.414 0l-4-4a1 1 0 1 1 1.414-1.414L11 14.586V7a1 1 0 0 1 1-1z"/>`),
		g.Group(children),
	)
}
...
func CircleInformation(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<g fill="currentColor"><path d="M12 4a8 8 0 1 0 0 16a8 8 0 0 0 0-16zM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12z"/><path d="M12 10a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0v-6a1 1 0 0 1 1-1zm1.5-2.5a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0z"/></g>`),
		g.Group(children),
	)
}
...
func ClipboardList(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<g fill="currentColor"><path d="M9 11.5a1 1 0 1 0 0-2a1 1 0 0 0 0 2zm2-1a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1zm1 2a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2h-3zm0 3a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2h-3zm-2-2a1 1 0 1 1-2 0a1 1 0 0 1 2 0zm-1 4a1 1 0 1 0 0-2a1 1 0 0 0 0 2z"/><path d="M9 2a1 1 0 0 0-1 1H6a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-2a1 1 0 0 0-1-1H9zm7 3h2v15H6V5h2v1a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V5zm-6 0V4h4v1h-4z"/></g>`),
		g.Group(children),
	)
}
...
func Clock(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M12 4a8 8 0 1 0 0 16a8 8 0 0 0 0-16zM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12zm10-6a1 1 0 0 1 1 1v4.586l2.707 2.707a1 1 0 0 1-1.414 1.414l-3-3A1 1 0 0 1 11 12V7a1 1 0 0 1 1-1z"/>`),
		g.Group(children),
	)
}
...
func Close(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M5.293 5.293a1 1 0 0 1 1.414 0L12 10.586l5.293-5.293a1 1 0 1 1 1.414 1.414L13.414 12l5.293 5.293a1 1 0 0 1-1.414 1.414L12 13.414l-5.293 5.293a1 1 0 0 1-1.414-1.414L10.586 12L5.293 6.707a1 1 0 0 1 0-1.414z"/>`),
		g.Group(children),
	)
}
...
func Comment(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M5 3a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5zm14 8.586L11.586 19H5V5h14v6.586zM14.414 19L19 14.414V19h-4.586z"/>`),
		g.Group(children),
	)
}
...
func Compass(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M4 12a8 8 0 1 1 16 0a8 8 0 0 1-16 0zm8-10C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2zm1.414 11.414l2.122-4.95l-4.95 2.122l-2.122 4.95l4.95-2.122z"/>`),
		g.Group(children),
	)
}
...
func CreditCard(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M22 6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6zm-2 2H4V6h16v2zM4 11h16v7H4v-7z"/>`),
		g.Group(children),
	)
}
...
func DeleteAlt(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M7 4a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2h4a1 1 0 1 1 0 2h-1.069l-.867 12.142A2 2 0 0 1 17.069 22H6.93a2 2 0 0 1-1.995-1.858L4.07 8H3a1 1 0 0 1 0-2h4V4zm2 2h6V4H9v2zM6.074 8l.857 12H17.07l.857-12H6.074z"/>`),
		g.Group(children),
	)
}
...
func Document(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M4 4a2 2 0 0 1 2-2h8a1 1 0 0 1 .707.293l5 5A1 1 0 0 1 20 8v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4zm13.586 4L14 4.414V8h3.586zM12 4H6v16h12V10h-5a1 1 0 0 1-1-1V4zm-4 9a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1zm0 4a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1z"/>`),
		g.Group(children),
	)
}
...
func DocumentEmpty(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M4 4a2 2 0 0 1 2-2h8a1 1 0 0 1 .707.293l5 5A1 1 0 0 1 20 8v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4zm13.586 4L14 4.414V8h3.586zM12 4H6v16h12V10h-5a1 1 0 0 1-1-1V4z"/>`),
		g.Group(children),
	)
}
...
func Download(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M12 2a1 1 0 0 1 1 1v10.586l2.293-2.293a1 1 0 0 1 1.414 1.414l-4 4a1 1 0 0 1-1.414 0l-4-4a1 1 0 1 1 1.414-1.414L11 13.586V3a1 1 0 0 1 1-1zM5 17a1 1 0 0 1 1 1v2h12v-2a1 1 0 1 1 2 0v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2a1 1 0 0 1 1-1z"/>`),
		g.Group(children),
	)
}
...
func Drag(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M4 6a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1zm0 4a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1zm0 4a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1zm0 4a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1z"/>`),
		g.Group(children),
	)
}
...
func Expand(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M17 2a1 1 0 1 0 0 2h1.586l-4.293 4.293a1 1 0 0 0 1.414 1.414L20 5.414V7a1 1 0 1 0 2 0V3a1 1 0 0 0-1-1h-4zM4 18.586V17a1 1 0 1 0-2 0v4a1 1 0 0 0 1 1h4a1 1 0 1 0 0-2H5.414l4.293-4.293a1 1 0 0 0-1.414-1.414L4 18.586z"/>`),
		g.Group(children),
	)
}
...
func ExternalLink(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M14 5a1 1 0 1 1 0-2h6a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0V6.414l-9.293 9.293a1 1 0 0 1-1.414-1.414L17.586 5H14zM3 7a2 2 0 0 1 2-2h5a1 1 0 1 1 0 2H5v12h12v-5a1 1 0 1 1 2 0v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z"/>`),
		g.Group(children),
	)
}
...
func Folder(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M2 6a2 2 0 0 1 2-2h5a1 1 0 0 1 .707.293L11.414 6H20a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6zm6.586 0H4v12h16V8h-9a1 1 0 0 1-.707-.293L8.586 6z"/>`),
		g.Group(children),
	)
}
...
func List(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M4 7a1 1 0 0 1 1-1h1a1 1 0 0 1 0 2H5a1 1 0 0 1-1-1zm5 0a1 1 0 0 1 1-1h9a1 1 0 1 1 0 2h-9a1 1 0 0 1-1-1zm-5 5a1 1 0 0 1 1-1h1a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1zm5 0a1 1 0 0 1 1-1h9a1 1 0 1 1 0 2h-9a1 1 0 0 1-1-1zm-5 5a1 1 0 0 1 1-1h1a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1zm5 0a1 1 0 0 1 1-1h9a1 1 0 1 1 0 2h-9a1 1 0 0 1-1-1z"/>`),
		g.Group(children),
	)
}
...
func Lock(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M12 4c1.648 0 3 1.352 3 3v3H9V7c0-1.648 1.352-3 3-3zm5 6V7c0-2.752-2.248-5-5-5S7 4.248 7 7v3H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-1zM6 12h12v8H6v-8z"/>`),
		g.Group(children),
	)
}
...
func Menu(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M4 7a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1zm0 5a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1zm0 5a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1z"/>`),
		g.Group(children),
	)
}
...
func Next(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M5 7.766c0-1.554 1.696-2.515 3.029-1.715l7.056 4.234c1.295.777 1.295 2.653 0 3.43L8.03 17.949c-1.333.8-3.029-.16-3.029-1.715V7.766zM14.056 12L7 7.766v8.468L14.056 12zM18 6a1 1 0 0 1 1 1v10a1 1 0 1 1-2 0V7a1 1 0 0 1 1-1z"/>`),
		g.Group(children),
	)
}
...
func Play(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M6 6.741c0-1.544 1.674-2.505 3.008-1.728l9.015 5.26c1.323.771 1.323 2.683 0 3.455l-9.015 5.258C7.674 19.764 6 18.803 6 17.26V6.741zM17.015 12L8 6.741V17.26L17.015 12z"/>`),
		g.Group(children),
	)
}
...
func Previous(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M19 7.766c0-1.554-1.696-2.515-3.029-1.715l-7.056 4.234c-1.295.777-1.295 2.653 0 3.43l7.056 4.234c1.333.8 3.029-.16 3.029-1.715V7.766zM9.944 12L17 7.766v8.468L9.944 12zM6 6a1 1 0 0 1 1 1v10a1 1 0 1 1-2 0V7a1 1 0 0 1 1-1z"/>`),
		g.Group(children),
	)
}
...
func Print(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M7 2a1 1 0 0 0-1 1v4H4a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2v2a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-2h2a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2V3a1 1 0 0 0-1-1H7zm10 12H7a1 1 0 0 0-1 1v2H4V9h16v8h-2v-2a1 1 0 0 0-1-1zm-1-7H8V4h8v3zM5 10v2h3v-2H5zm11 6v4H8v-4h8z"/>`),
		g.Group(children),
	)
}
...
func Share(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M11.293 2.293a1 1 0 0 1 1.414 0l3 3a1 1 0 0 1-1.414 1.414L13 5.414V15a1 1 0 1 1-2 0V5.414L9.707 6.707a1 1 0 0 1-1.414-1.414l3-3zM4 11a2 2 0 0 1 2-2h2a1 1 0 0 1 0 2H6v9h12v-9h-2a1 1 0 1 1 0-2h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-9z"/>`),
		g.Group(children),
	)
}
...
func Stop(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M5 7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V7zm12 0H7v10h10V7z"/>`),
		g.Group(children),
	)
}
...
func ThreeRows(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M19 2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h14zm0 4V4H5v2h14zm0 10a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-2a2 2 0 0 1 2-2h14zm0 4v-2H5v2h14zm0-11a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-2a2 2 0 0 1 2-2h14zm0 4v-2H5v2h14z"/>`),
		g.Group(children),
	)
}
...
func Undo(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M12.207 2.293a1 1 0 0 1 0 1.414L10.914 5H12.5c4.652 0 8.5 3.848 8.5 8.5S17.152 22 12.5 22S4 18.152 4 13.5a1 1 0 1 1 2 0c0 3.548 2.952 6.5 6.5 6.5s6.5-2.952 6.5-6.5S16.048 7 12.5 7h-1.586l1.293 1.293a1 1 0 0 1-1.414 1.414l-3-3a1 1 0 0 1 0-1.414l3-3a1 1 0 0 1 1.414 0z"/>`),
		g.Group(children),
	)
}
...
func Webcam(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M21.5 6.1c-.3-.2-.7-.2-1 0l-4.4 3V7c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2v-2.1l4.4 3c.2.1.4.2.6.2c.2 0 .3 0 .5-.1c.3-.2.5-.5.5-.9V7c0-.4-.2-.7-.5-.9zM14 17H4V7h10v10zm6-1.9l-4-2.7v-.9l4-2.7v6.3z"/>`),
		g.Group(children),
	)
}
...
func ZoomIn(children ...g.Node) g.Node {
	return s.SVG(
		...
		h.Width("24"),
		h.Height("24"),
		g.Raw(`<path fill="currentColor" d="M10 4a6 6 0 1 0 0 12a6 6 0 0 0 0-12zm-8 6a8 8 0 1 1 14.32 4.906l5.387 5.387a1 1 0 0 1-1.414 1.414l-5.387-5.387A8 8 0 0 1 2 10zm8-3a1 1 0 0 1 1 1v1h1a1 1 0 1 1 0 2h-1v1a1 1 0 1 1-2 0v-1H8a1 1 0 1 1 0-2h1V8a1 1 0 0 1 1-1z"/>`),
		g.Group(children),
	)
}
