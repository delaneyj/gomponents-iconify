...
func IconFromName(name string) g.Node {
	...
	case "abacus":
		return Abacus()
	case "adjustmentHorizon":
		return AdjustmentHorizon()
	case "adjustmentVertical":
		return AdjustmentVertical()
	case "airBalloon":
		return AirBalloon()
	case "airplane":
		return Airplane()
	...
	case "arrowChange":
		return ArrowChange()
	case "arrowCircleRycycle":
		return ArrowCircleRycycle()
	case "arrowDown":
		return ArrowDown()
	case "arrowForward":
		return ArrowForward()
	case "arrowFourWay":
		return ArrowFourWay()
	case "arrowFullscreen":
		return ArrowFullscreen()
	case "arrowFullscreenTwo":
		return ArrowFullscreenTwo()
	case "arrowLeft":
		return ArrowLeft()
	case "arrowLeftRight":
	...
	case "arrowReload":
		return ArrowReload()
	case "arrowResizeFive":
		return ArrowResizeFive()
	case "arrowResizeFour":
		return ArrowResizeFour()
	case "arrowResizeOne":
		return ArrowResizeOne()
	case "arrowResizeSix":
		return ArrowResizeSix()
	case "arrowResizeThree":
		return ArrowResizeThree()
	case "arrowResizeTwo":
		return ArrowResizeTwo()
	case "arrowRight":
		return ArrowRight()
	case "arrowShuffle":
		return ArrowShuffle()
	case "arrowThickDown":
		return ArrowThickDown()
	case "arrowThickLeft":
		return ArrowThickLeft()
	case "arrowThickRight":
		return ArrowThickRight()
	case "arrowThickThinDown":
		return ArrowThickThinDown()
	case "arrowThickThinUp":
		return ArrowThickThinUp()
	case "arrowThickUp":
		return ArrowThickUp()
	case "arrowThinDown":
		return ArrowThinDown()
	case "arrowThinLeft":
		return ArrowThinLeft()
	case "arrowThinLeftBottom":
		return ArrowThinLeftBottom()
	case "arrowThinLeftTop":
		return ArrowThinLeftTop()
	case "arrowThinRight":
		return ArrowThinRight()
	case "arrowThinRightBottom":
		return ArrowThinRightBottom()
	case "arrowThinRightTop":
		return ArrowThinRightTop()
	case "arrowThinUp":
		return ArrowThinUp()
	case "arrowThreeWayOne":
		return ArrowThreeWayOne()
	case "arrowThreeWayTwo":
		return ArrowThreeWayTwo()
	case "arrowTriangleRecycle":
		return ArrowTriangleRecycle()
	case "arrowTwoLeftRight":
		return ArrowTwoLeftRight()
	case "arrowTwoUp":
		return ArrowTwoUp()
	case "arrowTwoWay":
		return ArrowTwoWay()
	case "arrowTwoWayLeftRight":
		return ArrowTwoWayLeftRight()
	case "arrowTwoWayRight":
		return ArrowTwoWayRight()
	case "arrowTwoWayRightBottom":
		return ArrowTwoWayRightBottom()
	case "arrowUp":
		return ArrowUp()
	case "arrowUpDown":
		return ArrowUpDown()
	...
	case "baseball":
		return Baseball()
	case "baseballStick":
		return BaseballStick()
	case "basket":
		return Basket()
	case "basketArrowDown":
		return BasketArrowDown()
	case "basketArrowLeft":
		return BasketArrowLeft()
	case "basketArrowRight":
		return BasketArrowRight()
	case "basketArrowUp":
		return BasketArrowUp()
	case "basketChecked":
	...
	case "briefcase":
		return Briefcase()
	case "briefcasePerson":
		return BriefcasePerson()
	case "brightness":
		return Brightness()
	case "brushAndPencil":
		return BrushAndPencil()
	case "brushOne":
		return BrushOne()
	case "brushTwo":
		return BrushTwo()
	...
	case "bubbleMessageDot":
		return BubbleMessageDot()
	case "bubbleMessageDotTwo":
		return BubbleMessageDotTwo()
	case "bubbleMessageHi":
		return BubbleMessageHi()
	case "bubbleMessageQuote":
		return BubbleMessageQuote()
	case "bubbleMessageTalk":
		return BubbleMessageTalk()
	case "bubbleMessageText":
		return BubbleMessageText()
	case "bucket":
		return Bucket()
	case "bug":
		return Bug()
	case "building":
		return Building()
	case "bulletCheckedList":
		return BulletCheckedList()
	case "bulletList":
		return BulletList()
	case "bulletListTwo":
		return BulletListTwo()
	case "bus":
		return Bus()
	...
	case "buttonSell":
		return ButtonSell()
	case "buttonStarburst":
		return ButtonStarburst()
	case "buttonTriangleUp":
		return ButtonTriangleUp()
	case "buttonTv":
		return ButtonTv()
	case "cabinCable":
		return CabinCable()
	...
	case "castle":
		return Castle()
	case "caterpillarMachine":
		return CaterpillarMachine()
	case "centeJustify":
		return CenteJustify()
	case "chairOne":
		return ChairOne()
	...
	case "chartColumn":
		return ChartColumn()
	case "chartColumnDecrease":
		return ChartColumnDecrease()
	case "chartColumnIncrease":
		return ChartColumnIncrease()
	case "chartDecrease":
		return ChartDecrease()
	case "chartPiece":
		return ChartPiece()
	case "checked":
		return Checked()
	...
	case "cherry":
		return Cherry()
	case "christmasMistletoe":
		return ChristmasMistletoe()
	case "christmassBall":
		return ChristmassBall()
	case "christmassEgg":
		return ChristmassEgg()
	case "christmassHat":
		return ChristmassHat()
	case "christmassTree":
		return ChristmassTree()
	case "circle":
		return Circle()
	case "circleBackward":
		return CircleBackward()
	case "circleControlPad":
		return CircleControlPad()
	case "circleDrashed":
		return CircleDrashed()
	case "circleError":
		return CircleError()
	case "circleForward":
	...
	case "circleInfo":
		return CircleInfo()
	case "circleLoadLeft":
		return CircleLoadLeft()
	case "circleLoadRight":
		return CircleLoadRight()
	case "circlePlus":
		return CirclePlus()
	case "circleRemove":
		return CircleRemove()
	...
	case "cloudPlus":
		return CloudPlus()
	case "cloudRainHeavyRain":
		return CloudRainHeavyRain()
	case "cloudRemove":
		return CloudRemove()
	case "cloudSnow":
		return CloudSnow()
	...
	case "cone":
		return Cone()
	case "congratulationHat":
		return CongratulationHat()
	case "connectOne":
		return ConnectOne()
	case "connectTwo":
		return ConnectTwo()
	...
	case "delete":
		return Delete()
	case "deliciousCircle":
		return DeliciousCircle()
	case "deny":
		return Deny()
	case "desktop":
		return Desktop()
	...
	case "documentArrowDown":
		return DocumentArrowDown()
	case "documentArrowLeft":
		return DocumentArrowLeft()
	case "documentArrowRight":
		return DocumentArrowRight()
	case "documentArrowUp":
		return DocumentArrowUp()
	case "documentBackward":
		return DocumentBackward()
	case "documentBulletList":
		return DocumentBulletList()
	...
	case "film":
		return Film()
	case "filmThirtyFiveMm":
		return FilmThirtyFiveMm()
	case "finder":
		return Finder()
	case "fingerUp":
		return FingerUp()
	...
	case "fireWood":
		return FireWood()
	case "firstAidBriefcase":
		return FirstAidBriefcase()
	case "fish":
		return Fish()
	case "flag":
		return Flag()
	...
	case "jumpBackward":
		return JumpBackward()
	case "jumpDoublePageLeftRight":
		return JumpDoublePageLeftRight()
	case "jumpForward":
		return JumpForward()
	case "jumpPageLeftRight":
		return JumpPageLeftRight()
	case "jumpPageUpDown":
		return JumpPageUpDown()
	case "kette":
		return Kette()
	case "key":
		return Key()
	...
	case "leftJustify":
		return LeftJustify()
	case "leftwardsArrowToBar":
		return LeftwardsArrowToBar()
	case "lightAlarm":
		return LightAlarm()
	case "lightBulb":
		return LightBulb()
	...
	case "likeUnlike":
		return LikeUnlike()
	case "lineTwoAnglePoint":
		return LineTwoAnglePoint()
	case "linkOne":
		return LinkOne()
	case "linkThree":
		return LinkThree()
	...
	case "pinLocation":
		return PinLocation()
	case "pinLocationAdd":
		return PinLocationAdd()
	case "pinLocationDelete":
		return PinLocationDelete()
	case "pinLocationLove":
		return PinLocationLove()
	case "pinLocationMap":
		return PinLocationMap()
	case "pinLocationOne":
		return PinLocationOne()
	case "pinLocationRemove":
		return PinLocationRemove()
	case "pinLocationTwo":
		return PinLocationTwo()
	case "pinMap":
		return PinMap()
	case "pingPongRacket":
		return PingPongRacket()
	case "pipe":
		return Pipe()
	case "pizza":
		return Pizza()
	...
	case "repeat":
		return Repeat()
	case "resizeInFrame":
		return ResizeInFrame()
	case "resizeOutFrame":
		return ResizeOutFrame()
	case "retroeexcavadora":
		return Retroeexcavadora()
	case "ribbon":
		return Ribbon()
	case "rightJustify":
		return RightJustify()
	case "rightwardsArrowToBar":
		return RightwardsArrowToBar()
	case "ring":
		return Ring()
	case "road":
		return Road()
	...
	case "squareDashedOne":
		return SquareDashedOne()
	case "squareDashedTwo":
		return SquareDashedTwo()
	case "squareDelicious":
		return SquareDelicious()
	case "squareEightAnglePoint":
		return SquareEightAnglePoint()
	case "squareFour":
		return SquareFour()
	case "squareFourAnglePoint":
		return SquareFourAnglePoint()
	case "squarePlus":
		return SquarePlus()
	case "squareStar":
		return SquareStar()
	...
	case "strolley":
		return Strolley()
	case "strolleyArrowDown":
		return StrolleyArrowDown()
	case "strolleyArrowUp":
		return StrolleyArrowUp()
	case "strolleyPlus":
		return StrolleyPlus()
	case "strolleyRemove":
		return StrolleyRemove()
	case "subway":
		return Subway()
	case "suitcase":
		return Suitcase()
	case "suitcasePerson":
		return SuitcasePerson()
	case "syringe":
		return Syringe()
	case "tShirt":
		return TShirt()
	...
	case "television":
		return Television()
	case "tennisRacketBall":
		return TennisRacketBall()
	case "tentCamp":
		return TentCamp()
	case "tentOne":
		return TentOne()
	...
	case "trees":
		return Trees()
	case "triangleDoubleArrowDown":
		return TriangleDoubleArrowDown()
	case "triangleDoubleArrowLeft":
		return TriangleDoubleArrowLeft()
	case "triangleDoubleArrowRight":
		return TriangleDoubleArrowRight()
	case "triangleDoubleArrowUp":
		return TriangleDoubleArrowUp()
	case "triangleDown":
		return TriangleDown()
	case "triangleLeft":
		return TriangleLeft()
	...
	case "triangleUp":
		return TriangleUp()
	case "trolleyArrowDown":
		return TrolleyArrowDown()
	case "trolleyArrowUp":
		return TrolleyArrowUp()
	case "trolleyBriefcase":
		return TrolleyBriefcase()
	case "trolleyError":
		return TrolleyError()
	case "trolleyFull":
		return TrolleyFull()
	...
	case "twoArrowDown":
		return TwoArrowDown()
	case "twoArrowInDownUp":
		return TwoArrowInDownUp()
	case "twoArrowInLeftRight":
		return TwoArrowInLeftRight()
	case "twoArrowLeft":
		return TwoArrowLeft()
	case "twoArrowRight":
		return TwoArrowRight()
	case "typewriter":
		return Typewriter()
	case "umberllaChair":
		return UmberllaChair()
	case "umbrellaClose":
		return UmbrellaClose()
	case "umbrellaOpen":
		return UmbrellaOpen()
	case "umbrellaSea":
		return UmbrellaSea()
	...
	case "upwardsArrowToBar":
		return UpwardsArrowToBar()
	case "upwardsArrowWithLoop":
		return UpwardsArrowWithLoop()
	case "usb":
		return Usb()
	case "view":
		return View()
