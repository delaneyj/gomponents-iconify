...
const (
	...
	confirmPath                                           = `<path fill="none" stroke="currentColor" stroke-dasharray="24" stroke-dashoffset="24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 11L11 17L21 7"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.4s" values="24;0"/></path>`
	confirmCirclePath                                     = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path stroke-dasharray="60" stroke-dashoffset="60" d="M3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12Z"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.5s" values="60;0"/></path><path stroke-dasharray="14" stroke-dashoffset="14" d="M8 12L11 15L16 10"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.6s" dur="0.2s" values="14;0"/></path></g>`
	confirmCircleToCircleTransitionPath                   = `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="9"/><path stroke-dasharray="14" d="M8 12L11 15L16 10"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.2s" values="28;14"/></path></g>`
	...
	documentListTwotonePath                               = `<path fill="currentColor" fill-opacity="0" d="M5 3H12.5V8.5H19V21H5V3Z"><animate fill="freeze" attributeName="fill-opacity" begin="1.4s" dur="0.15s" values="0;0.3"/></path><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><g stroke-width="2"><path stroke-dasharray="64" stroke-dashoffset="64" d="M13 3L19 9V21H5V3H13"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.6s" values="64;0"/></path><path stroke-dasharray="6" stroke-dashoffset="6" d="M9 13H13"><animate fill="freeze" attributeName="stroke-dashoffset" begin="1s" dur="0.2s" values="6;0"/></path><path stroke-dasharray="8" stroke-dashoffset="8" d="M9 16H15"><animate fill="freeze" attributeName="stroke-dashoffset" begin="1.2s" dur="0.2s" values="8;0"/></path></g><path stroke-dasharray="14" stroke-dashoffset="14" d="M12.5 3V8.5H19"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.7s" dur="0.2s" values="14;0"/></path></g>`
...
func IconFromName(name string) g.Node {
	...
	case "alignLeft":
		return AlignLeft()
	case "arrowAlignCenter":
		return ArrowAlignCenter()
	case "arrowAlignLeft":
		return ArrowAlignLeft()
	case "arrowCloseLeft":
		return ArrowCloseLeft()
	case "arrowLeft":
		return ArrowLeft()
	...
	case "arrowsDiagonal":
		return ArrowsDiagonal()
	case "arrowsHorizontal":
		return ArrowsHorizontal()
	case "arrowsHorizontalAlt":
		return ArrowsHorizontalAlt()
	case "beer":
		return Beer()
	case "beerAltFilled":
		return BeerAltFilled()
	case "beerAltFilledLoop":
		return BeerAltFilledLoop()
	case "beerAltTwotone":
		return BeerAltTwotone()
	case "beerAltTwotoneLoop":
		return BeerAltTwotoneLoop()
	case "beerFilled":
		return BeerFilled()
	case "beerLoop":
		return BeerLoop()
	case "beerTwotone":
		return BeerTwotone()
	case "beerTwotoneLoop":
		return BeerTwotoneLoop()
	case "bell":
		return Bell()
	case "bellTwotone":
		return BellTwotone()
	case "buyMeACoffee":
		return BuyMeACoffee()
	case "buyMeACoffeeFilled":
		return BuyMeACoffeeFilled()
	case "buyMeACoffeeTwotone":
		return BuyMeACoffeeTwotone()
	case "calendar":
		return Calendar()
	case "calendarOut":
		return CalendarOut()
	...
	case "checkListThree":
		return CheckListThree()
	case "checkListThreeFilled":
		return CheckListThreeFilled()
	case "checkListThreeTwotone":
		return CheckListThreeTwotone()
	...
	case "chevronSmallLeft":
		return ChevronSmallLeft()
	case "chevronSmallTripleLeft":
		return ChevronSmallTripleLeft()
	case "chevronTripleLeft":
		return ChevronTripleLeft()
	case "circle":
		return Circle()
	case "circleToConfirmCircleTransition":
		return CircleToConfirmCircleTransition()
	case "circleToConfirmCircleTwotoneTransition":
		return CircleToConfirmCircleTwotoneTransition()
	case "circleTwotone":
		return CircleTwotone()
	case "circleTwotoneToConfirmCircleTwotoneTransition":
		return CircleTwotoneToConfirmCircleTwotoneTransition()
	case "clipboard":
		return Clipboard()
	case "clipboardArrow":
		return ClipboardArrow()
	case "clipboardArrowTwotone":
		return ClipboardArrowTwotone()
	case "clipboardCheck":
		return ClipboardCheck()
	case "clipboardCheckToClipboardTransition":
		return ClipboardCheckToClipboardTransition()
	case "clipboardCheckTwotone":
		return ClipboardCheckTwotone()
	case "clipboardCheckTwotoneToClipboardTwotoneTransition":
		return ClipboardCheckTwotoneToClipboardTwotoneTransition()
	case "clipboardList":
		return ClipboardList()
	case "clipboardListTwotone":
		return ClipboardListTwotone()
	case "clipboardMinus":
		return ClipboardMinus()
	case "clipboardMinusTwotone":
		return ClipboardMinusTwotone()
	case "clipboardPlus":
		return ClipboardPlus()
	case "clipboardPlusTwotone":
		return ClipboardPlusTwotone()
	case "clipboardToClipboardCheckTransition":
		return ClipboardToClipboardCheckTransition()
	case "clipboardTwotone":
		return ClipboardTwotone()
	case "clipboardTwotoneToClipboardTwotoneCheckTransition":
		return ClipboardTwotoneToClipboardTwotoneCheckTransition()
	case "close":
		return Close()
	case "closeCircle":
		return CloseCircle()
	...
	case "closeSmall":
		return CloseSmall()
	case "closeToMenuAltTransition":
		return CloseToMenuAltTransition()
	case "closeToMenuTransition":
		return CloseToMenuTransition()
	case "cloud":
		return Cloud()
	case "cloudBracesLoop":
		return CloudBracesLoop()
	case "cloudDown":
		return CloudDown()
	case "cloudDownTwotone":
		return CloudDownTwotone()
	case "cloudDownloadLoop":
		return CloudDownloadLoop()
	case "cloudDownloadOutlineLoop":
		return CloudDownloadOutlineLoop()
	case "cloudFilled":
		return CloudFilled()
	case "cloudLoop":
		return CloudLoop()
	case "cloudOffOutlineLoop":
		return CloudOffOutlineLoop()
	case "cloudOutlineLoop":
		return CloudOutlineLoop()
	case "cloudPrintLoop":
		return CloudPrintLoop()
	case "cloudPrintOutlineLoop":
		return CloudPrintOutlineLoop()
	case "cloudTagsLoop":
		return CloudTagsLoop()
	case "cloudTwotone":
		return CloudTwotone()
	case "cloudUp":
		return CloudUp()
	case "cloudUpTwotone":
		return CloudUpTwotone()
	case "cloudUploadLoop":
		return CloudUploadLoop()
	case "cloudUploadOutlineLoop":
		return CloudUploadOutlineLoop()
	case "coffee":
		return Coffee()
	case "coffeeArrow":
		return CoffeeArrow()
	case "coffeeArrowFilled":
		return CoffeeArrowFilled()
	case "coffeeArrowTwotone":
		return CoffeeArrowTwotone()
	case "coffeeFilled":
		return CoffeeFilled()
	case "coffeeHalfEmptyTwotoneLoop":
		return CoffeeHalfEmptyTwotoneLoop()
	case "coffeeLoop":
		return CoffeeLoop()
	case "coffeeTwotone":
		return CoffeeTwotone()
	case "coffeeTwotoneLoop":
		return CoffeeTwotoneLoop()
	case "computer":
		return Computer()
	case "computerTwotone":
		return ComputerTwotone()
	case "confirm":
		return Confirm()
	case "confirmCircle":
		return ConfirmCircle()
	case "confirmCircleToCircleTransition":
		return ConfirmCircleToCircleTransition()
	case "confirmCircleTwotone":
		return ConfirmCircleTwotone()
	case "confirmCircleTwotoneToCircleTransition":
	...
	case "constructionTwotone":
		return ConstructionTwotone()
	case "discord":
		return Discord()
	case "discordTwotone":
		return DiscordTwotone()
	case "document":
		return Document()
	case "documentAdd":
		return DocumentAdd()
	case "documentAddTwotone":
		return DocumentAddTwotone()
	case "documentCode":
		return DocumentCode()
	case "documentCodeTwotone":
		return DocumentCodeTwotone()
	case "documentList":
		return DocumentList()
	case "documentListTwotone":
		return DocumentListTwotone()
	case "documentRemove":
		return DocumentRemove()
	case "documentRemoveTwotone":
		return DocumentRemoveTwotone()
	case "documentReport":
		return DocumentReport()
	case "documentReportTwotone":
		return DocumentReportTwotone()
	case "documentTwotone":
		return DocumentTwotone()
	case "doubleArrowHorizontal":
		return DoubleArrowHorizontal()
	case "downloadLoop":
		return DownloadLoop()
	case "downloadOffLoop":
		return DownloadOffLoop()
	case "downloadOffOutline":
		return DownloadOffOutline()
	case "downloadOffOutlineLoop":
		return DownloadOffOutlineLoop()
	case "downloadOutline":
		return DownloadOutline()
	case "downloadOutlineLoop":
		return DownloadOutlineLoop()
	case "downloadingLoop":
		return DownloadingLoop()
	case "edit":
		return Edit()
	case "editTwotone":
		return EditTwotone()
	case "editTwotoneFull":
		return EditTwotoneFull()
	case "email":
		return Email()
	case "emailOpened":
		return EmailOpened()
	case "emailOpenedTwotone":
		return EmailOpenedTwotone()
	case "emailOpenedTwotoneAlt":
		return EmailOpenedTwotoneAlt()
	case "emailTwotone":
		return EmailTwotone()
	case "emailTwotoneAlt":
		return EmailTwotoneAlt()
	case "emojiAngry":
		return EmojiAngry()
	case "emojiAngryTwotone":
		return EmojiAngryTwotone()
	case "emojiFrown":
		return EmojiFrown()
	case "emojiFrownOpen":
		return EmojiFrownOpen()
	case "emojiFrownOpenTwotone":
		return EmojiFrownOpenTwotone()
	case "emojiFrownTwotone":
		return EmojiFrownTwotone()
	case "emojiGrin":
		return EmojiGrin()
	case "emojiGrinTwotone":
		return EmojiGrinTwotone()
	case "emojiNeutral":
		return EmojiNeutral()
	case "emojiNeutralTwotone":
		return EmojiNeutralTwotone()
	case "emojiSmile":
		return EmojiSmile()
	case "emojiSmileTwotone":
		return EmojiSmileTwotone()
	case "emojiSmileWink":
		return EmojiSmileWink()
	case "emojiSmileWinkTwotone":
		return EmojiSmileWinkTwotone()
	case "externalLink":
		return ExternalLink()
	case "externalLinkRounded":
		return ExternalLinkRounded()
	case "facebook":
		return Facebook()
	case "github":
		return Github()
	case "githubLoop":
		return GithubLoop()
	case "githubTwotone":
		return GithubTwotone()
	case "gridThree":
		return GridThree()
	case "gridThreeFilled":
		return GridThreeFilled()
	case "gridThreeTwotone":
		return GridThreeTwotone()
	case "hash":
		return Hash()
	case "hashSmall":
		return HashSmall()
	...
	case "heartFilled":
		return HeartFilled()
	case "heartFilledHalf":
		return HeartFilledHalf()
	case "heartHalf":
		return HeartHalf()
	case "heartHalfFilled":
		return HeartHalfFilled()
	case "heartHalfTwotone":
		return HeartHalfTwotone()
	case "heartTwotone":
		return HeartTwotone()
	case "heartTwotoneHalf":
		return HeartTwotoneHalf()
	case "heartTwotoneHalfFilled":
		return HeartTwotoneHalfFilled()
	case "home":
		return Home()
	case "homeMd":
		return HomeMd()
	case "homeMdTwotone":
		return HomeMdTwotone()
	case "homeMdTwotoneAlt":
		return HomeMdTwotoneAlt()
	case "homeSimple":
		return HomeSimple()
	case "homeSimpleFilled":
		return HomeSimpleFilled()
	case "homeSimpleTwotone":
		return HomeSimpleTwotone()
	case "homeTwotone":
		return HomeTwotone()
	case "homeTwotoneAlt":
		return HomeTwotoneAlt()
	case "iconifyOne":
		return IconifyOne()
	case "iconifyTwo":
		return IconifyTwo()
	...
	case "laptop":
		return Laptop()
	case "laptopTwotone":
		return LaptopTwotone()
	case "lightDark":
		return LightDark()
	case "lightDarkLoop":
		return LightDarkLoop()
	case "lightbulb":
		return Lightbulb()
	...
	case "lightbulbOff":
		return LightbulbOff()
	case "lightbulbOffFilled":
		return LightbulbOffFilled()
	case "lightbulbOffFilledLoop":
		return LightbulbOffFilledLoop()
	case "lightbulbOffLoop":
		return LightbulbOffLoop()
	case "lightbulbOffTwotone":
		return LightbulbOffTwotone()
	case "lightbulbOffTwotoneLoop":
		return LightbulbOffTwotoneLoop()
	case "lightbulbTwotone":
		return LightbulbTwotone()
	case "linkedin":
		return Linkedin()
	case "list":
		return List()
	...
	case "listThree":
		return ListThree()
	case "listThreeFilled":
		return ListThreeFilled()
	case "listThreeTwotone":
		return ListThreeTwotone()
	case "loadingAltLoop":
		return LoadingAltLoop()
	case "loadingLoop":
		return LoadingLoop()
	case "loadingTwotoneLoop":
		return LoadingTwotoneLoop()
	case "marker":
		return Marker()
	case "markerFilled":
		return MarkerFilled()
	case "markerTwotone":
		return MarkerTwotone()
	case "mastodon":
		return Mastodon()
	case "mastodonFilled":
		return MastodonFilled()
	case "mastodonTwotone":
		return MastodonTwotone()
	case "menu":
		return Menu()
	case "menuFoldLeft":
		return MenuFoldLeft()
	case "menuFoldRight":
		return MenuFoldRight()
	case "menuToCloseAltTransition":
		return MenuToCloseAltTransition()
	case "menuToCloseTransition":
		return MenuToCloseTransition()
	case "menuUnfoldLeft":
		return MenuUnfoldLeft()
	case "menuUnfoldRight":
		return MenuUnfoldRight()
	case "minus":
		return Minus()
	case "minusCircle":
		return MinusCircle()
	...
	case "moonAltLoop":
		return MoonAltLoop()
	case "moonAltToSunnyOutlineLoopTransition":
		return MoonAltToSunnyOutlineLoopTransition()
	case "moonFilled":
		return MoonFilled()
	case "moonFilledAltLoop":
		return MoonFilledAltLoop()
	case "moonFilledAltToSunnyFilledLoopTransition":
		return MoonFilledAltToSunnyFilledLoopTransition()
	case "moonFilledLoop":
		return MoonFilledLoop()
	case "moonFilledToSunnyFilledLoopTransition":
		return MoonFilledToSunnyFilledLoopTransition()
	case "moonFilledToSunnyFilledTransition":
		return MoonFilledToSunnyFilledTransition()
	case "moonLoop":
		return MoonLoop()
	case "moonRisingAltLoop":
		return MoonRisingAltLoop()
	case "moonRisingFilledAltLoop":
		return MoonRisingFilledAltLoop()
	case "moonRisingFilledLoop":
		return MoonRisingFilledLoop()
	case "moonRisingLoop":
		return MoonRisingLoop()
	case "moonRisingTwotoneAltLoop":
		return MoonRisingTwotoneAltLoop()
	case "moonRisingTwotoneLoop":
		return MoonRisingTwotoneLoop()
	case "moonToSunnyOutlineLoopTransition":
		return MoonToSunnyOutlineLoopTransition()
	case "moonToSunnyOutlineTransition":
		return MoonToSunnyOutlineTransition()
	case "moonTwotone":
		return MoonTwotone()
	case "moonTwotoneAltLoop":
		return MoonTwotoneAltLoop()
	case "moonTwotoneLoop":
		return MoonTwotoneLoop()
	case "navigationLeftDown":
		return NavigationLeftDown()
	case "navigationLeftUp":
		return NavigationLeftUp()
	case "navigationRightDown":
		return NavigationRightDown()
	case "navigationRightUp":
		return NavigationRightUp()
	case "paintDrop":
		return PaintDrop()
	case "paintDropFilled":
		return PaintDropFilled()
	case "paintDropHalfFilled":
		return PaintDropHalfFilled()
	case "paintDropHalfFilledTwotone":
		return PaintDropHalfFilledTwotone()
	case "paintDropHalfTwotone":
		return PaintDropHalfTwotone()
	case "paintDropTwotone":
		return PaintDropTwotone()
	case "pause":
		return Pause()
	case "pauseToPlayFilledTransition":
		return PauseToPlayFilledTransition()
	case "pauseToPlayTransition":
		return PauseToPlayTransition()
	case "pencil":
		return Pencil()
	case "pencilTwotone":
		return PencilTwotone()
	case "pencilTwotoneAlt":
		return PencilTwotoneAlt()
	case "play":
		return Play()
	case "playFilled":
		return PlayFilled()
	case "playFilledToPauseTransition":
		return PlayFilledToPauseTransition()
	case "playToPauseTransition":
		return PlayToPauseTransition()
	case "playTwotone":
		return PlayTwotone()
	case "plus":
		return Plus()
	...
	case "redditCircle":
		return RedditCircle()
	case "redditCircleLoop":
		return RedditCircleLoop()
	case "redditLoop":
		return RedditLoop()
	case "remove":
		return Remove()
	case "rotateNinety":
		return RotateNinety()
	case "rotateOneHundredEighty":
		return RotateOneHundredEighty()
	case "rotateTwoHundredSeventy":
		return RotateTwoHundredSeventy()
	case "search":
		return Search()
	case "searchFilled":
		return SearchFilled()
	...
	case "starAlt":
		return StarAlt()
	case "starAltFilled":
		return StarAltFilled()
	case "starAltTwotone":
		return StarAltTwotone()
	case "starFilled":
		return StarFilled()
	case "starFilledHalf":
		return StarFilledHalf()
	case "starHalf":
		return StarHalf()
	case "starHalfFilled":
		return StarHalfFilled()
	case "starHalfTwotone":
		return StarHalfTwotone()
	case "starPulsatingFilledLoop":
		return StarPulsatingFilledLoop()
	case "starPulsatingLoop":
		return StarPulsatingLoop()
	case "starPulsatingTwotoneLoop":
		return StarPulsatingTwotoneLoop()
	case "starTwotone":
		return StarTwotone()
	case "starTwotoneHalf":
		return StarTwotoneHalf()
	case "sunRisingFilledLoop":
		return SunRisingFilledLoop()
	case "sunRisingLoop":
		return SunRisingLoop()
	case "sunRisingTwotoneLoop":
		return SunRisingTwotoneLoop()
	case "sunnyFilled":
		return SunnyFilled()
	case "sunnyFilledLoop":
		return SunnyFilledLoop()
	case "sunnyFilledLoopToMoonAltFilledLoopTransition":
		return SunnyFilledLoopToMoonAltFilledLoopTransition()
	case "sunnyFilledLoopToMoonFilledLoopTransition":
		return SunnyFilledLoopToMoonFilledLoopTransition()
	case "sunnyFilledLoopToMoonFilledTransition":
		return SunnyFilledLoopToMoonFilledTransition()
	case "sunnyOutline":
		return SunnyOutline()
	case "sunnyOutlineLoop":
		return SunnyOutlineLoop()
	case "sunnyOutlineToMoonAltLoopTransition":
		return SunnyOutlineToMoonAltLoopTransition()
	case "sunnyOutlineToMoonLoopTransition":
		return SunnyOutlineToMoonLoopTransition()
	case "sunnyOutlineToMoonTransition":
		return SunnyOutlineToMoonTransition()
	case "sunnyOutlineTwotone":
		return SunnyOutlineTwotone()
	case "sunnyOutlineTwotoneLoop":
		return SunnyOutlineTwotoneLoop()
	case "switch":
		return Switch()
	case "switchFilled":
		return SwitchFilled()
	case "switchFilledToSwitchOffFilledTransition":
		return SwitchFilledToSwitchOffFilledTransition()
	case "switchOff":
		return SwitchOff()
	case "switchOffFilled":
		return SwitchOffFilled()
	case "switchOffFilledToSwitchFilledTransition":
		return SwitchOffFilledToSwitchFilledTransition()
	case "switchOffToSwitchTransition":
		return SwitchOffToSwitchTransition()
	case "switchToSwitchOffTransition":
		return SwitchToSwitchOffTransition()
	case "telegram":
		return Telegram()
	case "textBox":
		return TextBox()
	...
	case "textBoxMultipleToTextBoxTransition":
		return TextBoxMultipleToTextBoxTransition()
	case "textBoxMultipleTwotone":
		return TextBoxMultipleTwotone()
	case "textBoxMultipleTwotoneToTextBoxTwotoneTransition":
		return TextBoxMultipleTwotoneToTextBoxTwotoneTransition()
	case "textBoxToTextBoxMultipleTransition":
		return TextBoxToTextBoxMultipleTransition()
	case "textBoxTwotone":
		return TextBoxTwotone()
	case "textBoxTwotoneToTextBoxMultipleTwotoneTransition":
		return TextBoxTwotoneToTextBoxMultipleTwotoneTransition()
	case "thumbsDown":
		return ThumbsDown()
	case "thumbsDownTwotone":
		return ThumbsDownTwotone()
	case "thumbsUp":
		return ThumbsUp()
	case "thumbsUpTwotone":
		return ThumbsUpTwotone()
	case "twitter":
		return Twitter()
	case "twitterTwotone":
		return TwitterTwotone()
	case "twitterX":
		return TwitterX()
	case "twitterXAlt":
		return TwitterXAlt()
	case "uploadLoop":
		return UploadLoop()
	case "uploadOffLoop":
		return UploadOffLoop()
	case "uploadOffOutline":
		return UploadOffOutline()
	case "uploadOffOutlineLoop":
		return UploadOffOutlineLoop()
	case "uploadOutline":
		return UploadOutline()
	case "uploadOutlineLoop":
		return UploadOutlineLoop()
	case "uploadingLoop":
		return UploadingLoop()
	case "valignBaseline":
		return ValignBaseline()
	case "valignBaselineTwotone":
		return ValignBaselineTwotone()
	case "valignBottom":
		return ValignBottom()
	case "valignBottomTwotone":
		return ValignBottomTwotone()
	case "valignMiddle":
		return ValignMiddle()
	case "valignMiddleTwotone":
		return ValignMiddleTwotone()
	case "valignTop":
		return ValignTop()
...
func AccountAdd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accountAddPath), g.Group(children))
}
...
func AccountDelete(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accountDeletePath), g.Group(children))
}

func AccountRemove(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accountRemovePath), g.Group(children))
}

func AccountSmall(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(accountSmallPath), g.Group(children))
}
...
func ArrowAlignCenter(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowAlignCenterPath), g.Group(children))
}

func ArrowAlignLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowAlignLeftPath), g.Group(children))
}

func ArrowCloseLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowCloseLeftPath), g.Group(children))
}
...
func ArrowLongDiagonal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowLongDiagonalPath), g.Group(children))
}

func ArrowOpenLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowOpenLeftPath), g.Group(children))
}

func ArrowSmallLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowSmallLeftPath), g.Group(children))
}

func ArrowsDiagonal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowsDiagonalPath), g.Group(children))
}
...
func ArrowsHorizontalAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(arrowsHorizontalAltPath), g.Group(children))
}
...
func BeerAltFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(beerAltFilledPath), g.Group(children))
}

func BeerAltFilledLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(beerAltFilledLoopPath), g.Group(children))
}

func BeerAltTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(beerAltTwotonePath), g.Group(children))
}

func BeerAltTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(beerAltTwotoneLoopPath), g.Group(children))
}

func BeerFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(beerFilledPath), g.Group(children))
}

func BeerLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(beerLoopPath), g.Group(children))
}

func BeerTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(beerTwotonePath), g.Group(children))
}

func BeerTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(beerTwotoneLoopPath), g.Group(children))
}
...
func BellTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bellTwotonePath), g.Group(children))
}

func BuyMeACoffee(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(buyMeACoffeePath), g.Group(children))
}

func BuyMeACoffeeFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(buyMeACoffeeFilledPath), g.Group(children))
}

func BuyMeACoffeeTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(buyMeACoffeeTwotonePath), g.Group(children))
}
...
func CalendarOut(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(calendarOutPath), g.Group(children))
}
...
func CancelTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cancelTwotonePath), g.Group(children))
}

func CheckListThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkListThreePath), g.Group(children))
}

func CheckListThreeFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkListThreeFilledPath), g.Group(children))
}

func CheckListThreeTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(checkListThreeTwotonePath), g.Group(children))
}
...
func ChevronSmallDoubleLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronSmallDoubleLeftPath), g.Group(children))
}

func ChevronSmallLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronSmallLeftPath), g.Group(children))
}

func ChevronSmallTripleLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronSmallTripleLeftPath), g.Group(children))
}

func ChevronTripleLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(chevronTripleLeftPath), g.Group(children))
}
...
func CircleToConfirmCircleTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleToConfirmCircleTransitionPath), g.Group(children))
}

func CircleToConfirmCircleTwotoneTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleToConfirmCircleTwotoneTransitionPath), g.Group(children))
}

func CircleTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleTwotonePath), g.Group(children))
}

func CircleTwotoneToConfirmCircleTwotoneTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleTwotoneToConfirmCircleTwotoneTransitionPath), g.Group(children))
}
...
func ClipboardArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardArrowPath), g.Group(children))
}

func ClipboardArrowTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardArrowTwotonePath), g.Group(children))
}
...
func ClipboardCheckToClipboardTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardCheckToClipboardTransitionPath), g.Group(children))
}

func ClipboardCheckTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardCheckTwotonePath), g.Group(children))
}

func ClipboardCheckTwotoneToClipboardTwotoneTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardCheckTwotoneToClipboardTwotoneTransitionPath), g.Group(children))
}
...
func ClipboardListTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardListTwotonePath), g.Group(children))
}
...
func ClipboardMinusTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardMinusTwotonePath), g.Group(children))
}
...
func ClipboardPlusTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardPlusTwotonePath), g.Group(children))
}

func ClipboardToClipboardCheckTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardToClipboardCheckTransitionPath), g.Group(children))
}

func ClipboardTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardTwotonePath), g.Group(children))
}

func ClipboardTwotoneToClipboardTwotoneCheckTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clipboardTwotoneToClipboardTwotoneCheckTransitionPath), g.Group(children))
}
...
func CloseCircleTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(closeCircleTwotonePath), g.Group(children))
}
...
func CloseToMenuAltTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(closeToMenuAltTransitionPath), g.Group(children))
}

func CloseToMenuTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(closeToMenuTransitionPath), g.Group(children))
}
...
func CloudBracesLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudBracesLoopPath), g.Group(children))
}
...
func CloudDownTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudDownTwotonePath), g.Group(children))
}

func CloudDownloadLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudDownloadLoopPath), g.Group(children))
}

func CloudDownloadOutlineLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudDownloadOutlineLoopPath), g.Group(children))
}

func CloudFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudFilledPath), g.Group(children))
}

func CloudLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudLoopPath), g.Group(children))
}

func CloudOffOutlineLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudOffOutlineLoopPath), g.Group(children))
}

func CloudOutlineLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudOutlineLoopPath), g.Group(children))
}

func CloudPrintLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudPrintLoopPath), g.Group(children))
}

func CloudPrintOutlineLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudPrintOutlineLoopPath), g.Group(children))
}

func CloudTagsLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudTagsLoopPath), g.Group(children))
}

func CloudTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudTwotonePath), g.Group(children))
}
...
func CloudUpTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudUpTwotonePath), g.Group(children))
}

func CloudUploadLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudUploadLoopPath), g.Group(children))
}

func CloudUploadOutlineLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cloudUploadOutlineLoopPath), g.Group(children))
}
...
func CoffeeArrow(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeeArrowPath), g.Group(children))
}

func CoffeeArrowFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeeArrowFilledPath), g.Group(children))
}

func CoffeeArrowTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeeArrowTwotonePath), g.Group(children))
}

func CoffeeFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeeFilledPath), g.Group(children))
}

func CoffeeHalfEmptyTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeeHalfEmptyTwotoneLoopPath), g.Group(children))
}

func CoffeeLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeeLoopPath), g.Group(children))
}

func CoffeeTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeeTwotonePath), g.Group(children))
}

func CoffeeTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coffeeTwotoneLoopPath), g.Group(children))
}
...
func ComputerTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(computerTwotonePath), g.Group(children))
}

func Confirm(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(confirmPath), g.Group(children))
}

func ConfirmCircle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(confirmCirclePath), g.Group(children))
}

func ConfirmCircleToCircleTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(confirmCircleToCircleTransitionPath), g.Group(children))
}

func ConfirmCircleTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(confirmCircleTwotonePath), g.Group(children))
}

func ConfirmCircleTwotoneToCircleTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(confirmCircleTwotoneToCircleTransitionPath), g.Group(children))
}
...
func ConstructionTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(constructionTwotonePath), g.Group(children))
}
...
func DiscordTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(discordTwotonePath), g.Group(children))
}
...
func DocumentAddTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(documentAddTwotonePath), g.Group(children))
}

func DocumentCode(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(documentCodePath), g.Group(children))
}

func DocumentCodeTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(documentCodeTwotonePath), g.Group(children))
}
...
func DocumentListTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(documentListTwotonePath), g.Group(children))
}
...
func DocumentRemoveTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(documentRemoveTwotonePath), g.Group(children))
}
...
func DocumentReportTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(documentReportTwotonePath), g.Group(children))
}

func DocumentTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(documentTwotonePath), g.Group(children))
}

func DoubleArrowHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(doubleArrowHorizontalPath), g.Group(children))
}

func DownloadLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downloadLoopPath), g.Group(children))
}

func DownloadOffLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downloadOffLoopPath), g.Group(children))
}

func DownloadOffOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downloadOffOutlinePath), g.Group(children))
}

func DownloadOffOutlineLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downloadOffOutlineLoopPath), g.Group(children))
}
...
func DownloadOutlineLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downloadOutlineLoopPath), g.Group(children))
}

func DownloadingLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(downloadingLoopPath), g.Group(children))
}
...
func EditTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(editTwotonePath), g.Group(children))
}

func EditTwotoneFull(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(editTwotoneFullPath), g.Group(children))
}
...
func EmailOpened(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emailOpenedPath), g.Group(children))
}

func EmailOpenedTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emailOpenedTwotonePath), g.Group(children))
}

func EmailOpenedTwotoneAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emailOpenedTwotoneAltPath), g.Group(children))
}

func EmailTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emailTwotonePath), g.Group(children))
}

func EmailTwotoneAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emailTwotoneAltPath), g.Group(children))
}

func EmojiAngry(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiAngryPath), g.Group(children))
}

func EmojiAngryTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiAngryTwotonePath), g.Group(children))
}

func EmojiFrown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiFrownPath), g.Group(children))
}

func EmojiFrownOpen(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiFrownOpenPath), g.Group(children))
}

func EmojiFrownOpenTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiFrownOpenTwotonePath), g.Group(children))
}

func EmojiFrownTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiFrownTwotonePath), g.Group(children))
}

func EmojiGrin(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiGrinPath), g.Group(children))
}

func EmojiGrinTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiGrinTwotonePath), g.Group(children))
}

func EmojiNeutral(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiNeutralPath), g.Group(children))
}

func EmojiNeutralTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiNeutralTwotonePath), g.Group(children))
}

func EmojiSmile(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiSmilePath), g.Group(children))
}

func EmojiSmileTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiSmileTwotonePath), g.Group(children))
}

func EmojiSmileWink(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiSmileWinkPath), g.Group(children))
}

func EmojiSmileWinkTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(emojiSmileWinkTwotonePath), g.Group(children))
}
...
func ExternalLinkRounded(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(externalLinkRoundedPath), g.Group(children))
}
...
func GithubLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(githubLoopPath), g.Group(children))
}

func GithubTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(githubTwotonePath), g.Group(children))
}

func GridThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridThreePath), g.Group(children))
}

func GridThreeFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridThreeFilledPath), g.Group(children))
}

func GridThreeTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridThreeTwotonePath), g.Group(children))
}
...
func HashSmall(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hashSmallPath), g.Group(children))
}
...
func HeartFilledHalf(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heartFilledHalfPath), g.Group(children))
}
...
func HeartHalfFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heartHalfFilledPath), g.Group(children))
}

func HeartHalfTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heartHalfTwotonePath), g.Group(children))
}

func HeartTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heartTwotonePath), g.Group(children))
}

func HeartTwotoneHalf(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heartTwotoneHalfPath), g.Group(children))
}

func HeartTwotoneHalfFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(heartTwotoneHalfFilledPath), g.Group(children))
}
...
func HomeMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeMdPath), g.Group(children))
}

func HomeMdTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeMdTwotonePath), g.Group(children))
}

func HomeMdTwotoneAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeMdTwotoneAltPath), g.Group(children))
}
...
func HomeSimpleFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeSimpleFilledPath), g.Group(children))
}

func HomeSimpleTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeSimpleTwotonePath), g.Group(children))
}

func HomeTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeTwotonePath), g.Group(children))
}

func HomeTwotoneAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(homeTwotoneAltPath), g.Group(children))
}

func IconifyOne(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(iconifyOnePath), g.Group(children))
}

func IconifyTwo(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(iconifyTwoPath), g.Group(children))
}
...
func ImageTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(imageTwotonePath), g.Group(children))
}
...
func LaptopTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(laptopTwotonePath), g.Group(children))
}

func LightDark(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lightDarkPath), g.Group(children))
}

func LightDarkLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lightDarkLoopPath), g.Group(children))
}
...
func LightbulbFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lightbulbFilledPath), g.Group(children))
}
...
func LightbulbOffFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lightbulbOffFilledPath), g.Group(children))
}

func LightbulbOffFilledLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lightbulbOffFilledLoopPath), g.Group(children))
}

func LightbulbOffLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lightbulbOffLoopPath), g.Group(children))
}

func LightbulbOffTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lightbulbOffTwotonePath), g.Group(children))
}

func LightbulbOffTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lightbulbOffTwotoneLoopPath), g.Group(children))
}

func LightbulbTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lightbulbTwotonePath), g.Group(children))
}
...
func ListIndented(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listIndentedPath), g.Group(children))
}

func ListThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listThreePath), g.Group(children))
}

func ListThreeFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listThreeFilledPath), g.Group(children))
}

func ListThreeTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listThreeTwotonePath), g.Group(children))
}

func LoadingAltLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(loadingAltLoopPath), g.Group(children))
}

func LoadingLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(loadingLoopPath), g.Group(children))
}

func LoadingTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(loadingTwotoneLoopPath), g.Group(children))
}

func Marker(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(markerPath), g.Group(children))
}

func MarkerFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(markerFilledPath), g.Group(children))
}

func MarkerTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(markerTwotonePath), g.Group(children))
}

func Mastodon(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mastodonPath), g.Group(children))
}

func MastodonFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mastodonFilledPath), g.Group(children))
}

func MastodonTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mastodonTwotonePath), g.Group(children))
}
...
func MenuFoldLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuFoldLeftPath), g.Group(children))
}

func MenuFoldRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuFoldRightPath), g.Group(children))
}

func MenuToCloseAltTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuToCloseAltTransitionPath), g.Group(children))
}

func MenuToCloseTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuToCloseTransitionPath), g.Group(children))
}

func MenuUnfoldLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuUnfoldLeftPath), g.Group(children))
}

func MenuUnfoldRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(menuUnfoldRightPath), g.Group(children))
}
...
func MoonAltLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonAltLoopPath), g.Group(children))
}

func MoonAltToSunnyOutlineLoopTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonAltToSunnyOutlineLoopTransitionPath), g.Group(children))
}

func MoonFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonFilledPath), g.Group(children))
}

func MoonFilledAltLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonFilledAltLoopPath), g.Group(children))
}

func MoonFilledAltToSunnyFilledLoopTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonFilledAltToSunnyFilledLoopTransitionPath), g.Group(children))
}

func MoonFilledLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonFilledLoopPath), g.Group(children))
}

func MoonFilledToSunnyFilledLoopTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonFilledToSunnyFilledLoopTransitionPath), g.Group(children))
}

func MoonFilledToSunnyFilledTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonFilledToSunnyFilledTransitionPath), g.Group(children))
}

func MoonLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonLoopPath), g.Group(children))
}

func MoonRisingAltLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonRisingAltLoopPath), g.Group(children))
}

func MoonRisingFilledAltLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonRisingFilledAltLoopPath), g.Group(children))
}

func MoonRisingFilledLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonRisingFilledLoopPath), g.Group(children))
}

func MoonRisingLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonRisingLoopPath), g.Group(children))
}

func MoonRisingTwotoneAltLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonRisingTwotoneAltLoopPath), g.Group(children))
}

func MoonRisingTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonRisingTwotoneLoopPath), g.Group(children))
}

func MoonToSunnyOutlineLoopTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonToSunnyOutlineLoopTransitionPath), g.Group(children))
}

func MoonToSunnyOutlineTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonToSunnyOutlineTransitionPath), g.Group(children))
}

func MoonTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonTwotonePath), g.Group(children))
}

func MoonTwotoneAltLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonTwotoneAltLoopPath), g.Group(children))
}

func MoonTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(moonTwotoneLoopPath), g.Group(children))
}

func NavigationLeftDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(navigationLeftDownPath), g.Group(children))
}

func NavigationLeftUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(navigationLeftUpPath), g.Group(children))
}

func NavigationRightDown(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(navigationRightDownPath), g.Group(children))
}

func NavigationRightUp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(navigationRightUpPath), g.Group(children))
}

func PaintDrop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(paintDropPath), g.Group(children))
}

func PaintDropFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(paintDropFilledPath), g.Group(children))
}

func PaintDropHalfFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(paintDropHalfFilledPath), g.Group(children))
}

func PaintDropHalfFilledTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(paintDropHalfFilledTwotonePath), g.Group(children))
}

func PaintDropHalfTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(paintDropHalfTwotonePath), g.Group(children))
}

func PaintDropTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(paintDropTwotonePath), g.Group(children))
}
...
func PauseToPlayFilledTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pauseToPlayFilledTransitionPath), g.Group(children))
}

func PauseToPlayTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pauseToPlayTransitionPath), g.Group(children))
}
...
func PencilTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pencilTwotonePath), g.Group(children))
}

func PencilTwotoneAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pencilTwotoneAltPath), g.Group(children))
}
...
func PlayFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(playFilledPath), g.Group(children))
}

func PlayFilledToPauseTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(playFilledToPauseTransitionPath), g.Group(children))
}

func PlayToPauseTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(playToPauseTransitionPath), g.Group(children))
}

func PlayTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(playTwotonePath), g.Group(children))
}
...
func RedditCircle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(redditCirclePath), g.Group(children))
}

func RedditCircleLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(redditCircleLoopPath), g.Group(children))
}

func RedditLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(redditLoopPath), g.Group(children))
}
...
func RotateNinety(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rotateNinetyPath), g.Group(children))
}

func RotateOneHundredEighty(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rotateOneHundredEightyPath), g.Group(children))
}

func RotateTwoHundredSeventy(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rotateTwoHundredSeventyPath), g.Group(children))
}
...
func SearchFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(searchFilledPath), g.Group(children))
}
...
func StarAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starAltPath), g.Group(children))
}

func StarAltFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starAltFilledPath), g.Group(children))
}

func StarAltTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starAltTwotonePath), g.Group(children))
}
...
func StarFilledHalf(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starFilledHalfPath), g.Group(children))
}
...
func StarHalfFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starHalfFilledPath), g.Group(children))
}

func StarHalfTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starHalfTwotonePath), g.Group(children))
}

func StarPulsatingFilledLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starPulsatingFilledLoopPath), g.Group(children))
}

func StarPulsatingLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starPulsatingLoopPath), g.Group(children))
}

func StarPulsatingTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starPulsatingTwotoneLoopPath), g.Group(children))
}

func StarTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starTwotonePath), g.Group(children))
}

func StarTwotoneHalf(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starTwotoneHalfPath), g.Group(children))
}

func SunRisingFilledLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunRisingFilledLoopPath), g.Group(children))
}

func SunRisingLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunRisingLoopPath), g.Group(children))
}

func SunRisingTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunRisingTwotoneLoopPath), g.Group(children))
}

func SunnyFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyFilledPath), g.Group(children))
}

func SunnyFilledLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyFilledLoopPath), g.Group(children))
}

func SunnyFilledLoopToMoonAltFilledLoopTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyFilledLoopToMoonAltFilledLoopTransitionPath), g.Group(children))
}

func SunnyFilledLoopToMoonFilledLoopTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyFilledLoopToMoonFilledLoopTransitionPath), g.Group(children))
}

func SunnyFilledLoopToMoonFilledTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyFilledLoopToMoonFilledTransitionPath), g.Group(children))
}

func SunnyOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyOutlinePath), g.Group(children))
}

func SunnyOutlineLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyOutlineLoopPath), g.Group(children))
}

func SunnyOutlineToMoonAltLoopTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyOutlineToMoonAltLoopTransitionPath), g.Group(children))
}

func SunnyOutlineToMoonLoopTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyOutlineToMoonLoopTransitionPath), g.Group(children))
}

func SunnyOutlineToMoonTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyOutlineToMoonTransitionPath), g.Group(children))
}

func SunnyOutlineTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyOutlineTwotonePath), g.Group(children))
}

func SunnyOutlineTwotoneLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sunnyOutlineTwotoneLoopPath), g.Group(children))
}
...
func SwitchFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(switchFilledPath), g.Group(children))
}

func SwitchFilledToSwitchOffFilledTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(switchFilledToSwitchOffFilledTransitionPath), g.Group(children))
}
...
func SwitchOffFilled(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(switchOffFilledPath), g.Group(children))
}

func SwitchOffFilledToSwitchFilledTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(switchOffFilledToSwitchFilledTransitionPath), g.Group(children))
}

func SwitchOffToSwitchTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(switchOffToSwitchTransitionPath), g.Group(children))
}

func SwitchToSwitchOffTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(switchToSwitchOffTransitionPath), g.Group(children))
}
...
func TextBoxMultiple(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textBoxMultiplePath), g.Group(children))
}

func TextBoxMultipleToTextBoxTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textBoxMultipleToTextBoxTransitionPath), g.Group(children))
}

func TextBoxMultipleTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textBoxMultipleTwotonePath), g.Group(children))
}

func TextBoxMultipleTwotoneToTextBoxTwotoneTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textBoxMultipleTwotoneToTextBoxTwotoneTransitionPath), g.Group(children))
}

func TextBoxToTextBoxMultipleTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textBoxToTextBoxMultipleTransitionPath), g.Group(children))
}

func TextBoxTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textBoxTwotonePath), g.Group(children))
}

func TextBoxTwotoneToTextBoxMultipleTwotoneTransition(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(textBoxTwotoneToTextBoxMultipleTwotoneTransitionPath), g.Group(children))
}
...
func ThumbsDownTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thumbsDownTwotonePath), g.Group(children))
}
...
func ThumbsUpTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thumbsUpTwotonePath), g.Group(children))
}
...
func TwitterTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(twitterTwotonePath), g.Group(children))
}

func TwitterX(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(twitterXPath), g.Group(children))
}

func TwitterXAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(twitterXAltPath), g.Group(children))
}

func UploadLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(uploadLoopPath), g.Group(children))
}

func UploadOffLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(uploadOffLoopPath), g.Group(children))
}

func UploadOffOutline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(uploadOffOutlinePath), g.Group(children))
}

func UploadOffOutlineLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(uploadOffOutlineLoopPath), g.Group(children))
}
...
func UploadOutlineLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(uploadOutlineLoopPath), g.Group(children))
}

func UploadingLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(uploadingLoopPath), g.Group(children))
}

func ValignBaseline(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(valignBaselinePath), g.Group(children))
}

func ValignBaselineTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(valignBaselineTwotonePath), g.Group(children))
}

func ValignBottom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(valignBottomPath), g.Group(children))
}

func ValignBottomTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(valignBottomTwotonePath), g.Group(children))
}

func ValignMiddle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(valignMiddlePath), g.Group(children))
}

func ValignMiddleTwotone(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(valignMiddleTwotonePath), g.Group(children))
}

func ValignTop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(valignTopPath), g.Group(children))
}
...
func WeatherCloudyLoop(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(weatherCloudyLoopPath), g.Group(children))
}
