...
func IconFromName(name string) g.Node {
	...
	case "angelist":
		return Angelist()
	case "angleDobuleDown":
		return AngleDobuleDown()
	case "angleDobuleLeft":
		return AngleDobuleLeft()
	case "angleDobuleRight":
		return AngleDobuleRight()
	case "angleDobuleUp":
		return AngleDobuleUp()
	case "angleDown":
		return AngleDown()
	case "angleLeft":
		return AngleLeft()
	...
	case "checkboxPassive":
		return CheckboxPassive()
	case "chrome":
		return Chrome()
	case "circleONotch":
		return CircleONotch()
	...
	case "helicopter":
		return Helicopter()
	case "helicopterAmbulance":
		return HelicopterAmbulance()
	case "hexo":
		return Hexo()
	case "hipchat":
		return Hipchat()
	...
	case "icq":
		return Icq()
	case "ifQuestionCircle":
		return IfQuestionCircle()
	case "ils":
		return Ils()
	case "imdb":
		return Imdb()
	...
	case "info":
		return Info()
	case "injectionSyringe":
		return InjectionSyringe()
	case "inr":
		return Inr()
	case "instagram":
		return Instagram()
	...
	case "paragraph":
		return Paragraph()
	case "paralysisDisability":
		return ParalysisDisability()
	case "parasol":
		return Parasol()
	case "passport":
		return Passport()
	...
	case "productHunt":
		return ProductHunt()
	case "propellerFour":
		return PropellerFour()
	case "propellerOne":
		return PropellerOne()
	case "propellerThree":
		return PropellerThree()
	case "propellerTwo":
		return PropellerTwo()
	case "pulse":
		return Pulse()
	...
	case "radioBtnPassive":
		return RadioBtnPassive()
	case "rage":
		return Rage()
	case "rails":
		return Rails()
	...
	case "shoppingBarcode":
		return ShoppingBarcode()
	case "shoppingBasket":
		return ShoppingBasket()
	case "shoppingBasketAdd":
		return ShoppingBasketAdd()
	case "shoppingBasketRemove":
		return ShoppingBasketRemove()
	case "shoppingPackage":
		return ShoppingPackage()
	case "shoppingPosMachine":
		return ShoppingPosMachine()
	case "shoppingSale":
		return ShoppingSale()
	case "shoppingStore":
	...
	case "snowflake":
		return Snowflake()
	case "snowflakeEight":
		return SnowflakeEight()
	case "snowflakeFive":
		return SnowflakeFive()
	case "snowflakeFour":
		return SnowflakeFour()
	case "snowflakeOne":
		return SnowflakeOne()
	case "snowflakeSeven":
		return SnowflakeSeven()
	case "snowflakeSix":
		return SnowflakeSix()
	case "snowflakeThree":
		return SnowflakeThree()
	case "snowflakeTwo":
		return SnowflakeTwo()
	case "snows":
		return Snows()
	...
	case "spinnerRotateForward":
		return SpinnerRotateForward()
	case "spotify":
		return Spotify()
	case "stackOverflow":
	...
	case "sunglasses":
		return Sunglasses()
	case "sunglassesAlt":
		return SunglassesAlt()
	case "superscript":
		return Superscript()
	case "surgicalKnife":
		return SurgicalKnife()
	case "surprised":
		return Surprised()
	case "svn":
		return Svn()
