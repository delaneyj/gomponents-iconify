...
func IconFromName(name string) g.Node {
	...
	case "arrowLoop":
		return ArrowLoop()
	case "arrowLoopOutline":
		return ArrowLoopOutline()
	case "arrowMaximise":
		return ArrowMaximise()
	case "arrowMaximiseOutline":
		return ArrowMaximiseOutline()
	case "arrowMinimise":
		return ArrowMinimise()
	case "arrowMinimiseOutline":
		return ArrowMinimiseOutline()
	case "arrowMove":
		return ArrowMove()
	case "arrowMoveOutline":
		return ArrowMoveOutline()
	case "arrowRepeat":
		return ArrowRepeat()
	case "arrowRepeatOutline":
		return ArrowRepeatOutline()
	case "arrowRight":
		return ArrowRight()
	...
	case "arrowShuffle":
		return ArrowShuffle()
	case "arrowSortedDown":
		return ArrowSortedDown()
	case "arrowSortedUp":
		return ArrowSortedUp()
	case "arrowSync":
		return ArrowSync()
	case "arrowSyncOutline":
		return ArrowSyncOutline()
	case "arrowUnsorted":
		return ArrowUnsorted()
	case "arrowUp":
		return ArrowUp()
	case "arrowUpOutline":
	...
	case "chartArea":
		return ChartArea()
	case "chartAreaOutline":
		return ChartAreaOutline()
	case "chartBar":
		return ChartBar()
	case "chartBarOutline":
		return ChartBarOutline()
	case "chartLine":
		return ChartLine()
	case "chartLineOutline":
		return ChartLineOutline()
	case "chartPie":
		return ChartPie()
	...
	case "cloudStorage":
		return CloudStorage()
	case "cloudStorageOutline":
		return CloudStorageOutline()
	case "code":
		return Code()
	case "codeOutline":
		return CodeOutline()
	...
	case "heart":
		return Heart()
	case "heartFullOutline":
		return HeartFullOutline()
	...
	case "infinityOutline":
		return InfinityOutline()
	case "info":
		return Info()
	case "infoLarge":
		return InfoLarge()
	case "infoLargeOutline":
		return InfoLargeOutline()
	case "infoOutline":
		return InfoOutline()
	case "inputChecked":
		return InputChecked()
	case "inputCheckedOutline":
		return InputCheckedOutline()
	case "key":
		return Key()
	case "keyOutline":
		return KeyOutline()
	...
	case "mediaEject":
		return MediaEject()
	case "mediaEjectOutline":
		return MediaEjectOutline()
	case "mediaFastForward":
		return MediaFastForward()
	case "mediaFastForwardOutline":
		return MediaFastForwardOutline()
	case "mediaPause":
		return MediaPause()
	case "mediaPauseOutline":
		return MediaPauseOutline()
	case "mediaPlay":
		return MediaPlay()
	case "mediaPlayOutline":
		return MediaPlayOutline()
	case "mediaPlayReverse":
		return MediaPlayReverse()
	case "mediaPlayReverseOutline":
		return MediaPlayReverseOutline()
	case "mediaRecord":
		return MediaRecord()
	case "mediaRecordOutline":
		return MediaRecordOutline()
	case "mediaRewind":
		return MediaRewind()
	case "mediaRewindOutline":
		return MediaRewindOutline()
	case "mediaStop":
		return MediaStop()
	case "mediaStopOutline":
		return MediaStopOutline()
	case "message":
		return Message()
	case "messageTyping":
	...
	case "pointOfInterestOutline":
		return PointOfInterestOutline()
	case "power":
		return Power()
	case "powerOutline":
		return PowerOutline()
	...
	case "shoppingCart":
		return ShoppingCart()
	case "socialAtCircular":
		return SocialAtCircular()
	case "socialDribbble":
		return SocialDribbble()
	case "socialDribbbleCircular":
		return SocialDribbbleCircular()
	case "socialFacebook":
		return SocialFacebook()
	case "socialFacebookCircular":
		return SocialFacebookCircular()
	case "socialFlickr":
		return SocialFlickr()
	case "socialFlickrCircular":
		return SocialFlickrCircular()
	case "socialGithub":
		return SocialGithub()
	case "socialGithubCircular":
		return SocialGithubCircular()
	case "socialGooglePlus":
		return SocialGooglePlus()
	case "socialGooglePlusCircular":
		return SocialGooglePlusCircular()
	case "socialInstagram":
		return SocialInstagram()
	case "socialInstagramCircular":
		return SocialInstagramCircular()
	case "socialLastFm":
		return SocialLastFm()
	case "socialLastFmCircular":
		return SocialLastFmCircular()
	case "socialLinkedin":
		return SocialLinkedin()
	case "socialLinkedinCircular":
		return SocialLinkedinCircular()
	case "socialPinterest":
		return SocialPinterest()
	case "socialPinterestCircular":
		return SocialPinterestCircular()
	case "socialSkype":
		return SocialSkype()
	case "socialSkypeOutline":
		return SocialSkypeOutline()
	case "socialTumbler":
		return SocialTumbler()
	case "socialTumblerCircular":
		return SocialTumblerCircular()
	case "socialTwitter":
		return SocialTwitter()
	case "socialTwitterCircular":
		return SocialTwitterCircular()
	case "socialVimeo":
		return SocialVimeo()
	case "socialVimeoCircular":
		return SocialVimeoCircular()
	case "socialYoutube":
		return SocialYoutube()
	case "socialYoutubeCircular":
		return SocialYoutubeCircular()
	case "sortAlphabetically":
		return SortAlphabetically()
	case "sortAlphabeticallyOutline":
		return SortAlphabeticallyOutline()
	case "sortNumerically":
		return SortNumerically()
	case "sortNumericallyOutline":
		return SortNumericallyOutline()
	case "spanner":
		return Spanner()
	case "spannerOutline":
		return SpannerOutline()
	case "spiral":
		return Spiral()
	case "star":
		return Star()
	case "starFullOutline":
		return StarFullOutline()
	case "starHalf":
		return StarHalf()
	...
	case "starburst":
		return Starburst()
	case "starburstOutline":
		return StarburstOutline()
	case "stopwatch":
		return Stopwatch()
	case "support":
		return Support()
	...
	case "thLarge":
		return ThLarge()
	case "thLargeOutline":
		return ThLargeOutline()
	case "thList":
		return ThList()
	case "thListOutline":
		return ThListOutline()
	case "thMenu":
		return ThMenu()
	case "thMenuOutline":
		return ThMenuOutline()
	case "thSmall":
		return ThSmall()
	case "thSmallOutline":
		return ThSmallOutline()
	case "thermometer":
		return Thermometer()
	case "thumbsDown":
		return ThumbsDown()
	...
	case "userAdd":
		return UserAdd()
	case "userAddOutline":
		return UserAddOutline()
	case "userDelete":
		return UserDelete()
	case "userDeleteOutline":
		return UserDeleteOutline()
	case "userOutline":
		return UserOutline()
	case "vendorAndroid":
	...
	case "weatherDownpour":
		return WeatherDownpour()
	case "weatherNight":
		return WeatherNight()
	...
	case "weatherWindy":
		return WeatherWindy()
	case "weatherWindyCloudy":
		return WeatherWindyCloudy()
	case "wiFi":
		return WiFi()
	case "wiFiOutline":
		return WiFiOutline()
