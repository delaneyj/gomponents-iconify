...
func IconFromName(name string) g.Node {
	...
	case "angleDown":
		return AngleDown()
	case "angleDownPrint":
		return AngleDownPrint()
	case "angleLeft":
		return AngleLeft()
	case "angleLeftPrint":
		return AngleLeftPrint()
	case "angleRight":
		return AngleRight()
	case "angleRightPrint":
		return AngleRightPrint()
	case "angleUp":
		return AngleUp()
	case "angleUpPrint":
		return AngleUpPrint()
	...
	case "arrowDownLeftPrint":
		return ArrowDownLeftPrint()
	case "arrowDownPrint":
		return ArrowDownPrint()
	case "arrowDownRight":
		return ArrowDownRight()
	case "arrowDownRightPrint":
		return ArrowDownRightPrint()
	case "arrowLeft":
		return ArrowLeft()
	case "arrowLeftPrint":
		return ArrowLeftPrint()
	case "arrowRight":
		return ArrowRight()
	case "arrowRightPrint":
		return ArrowRightPrint()
	case "arrowUp":
		return ArrowUp()
	case "arrowUpLeft":
		return ArrowUpLeft()
	case "arrowUpLeftPrint":
		return ArrowUpLeftPrint()
	case "arrowUpPrint":
		return ArrowUpPrint()
	case "arrowUpRight":
		return ArrowUpRight()
	case "arrowUpRightPrint":
		return ArrowUpRightPrint()
	case "bank":
		return Bank()
	case "bankPrint":
		return BankPrint()
	...
	case "bookmarkPrint":
		return BookmarkPrint()
	case "briefcase":
		return Briefcase()
	case "briefcasePrint":
		return BriefcasePrint()
	case "building":
		return Building()
	case "buildingPrint":
	...
	case "calculator":
		return Calculator()
	case "calculatorPrint":
		return CalculatorPrint()
	case "calendar":
		return Calendar()
	case "calendarPrint":
	...
	case "cellphoneEye":
		return CellphoneEye()
	case "cellphoneEyePrint":
		return CellphoneEyePrint()
	case "cellphoneLoop":
		return CellphoneLoop()
	case "cellphoneLoopPrint":
		return CellphoneLoopPrint()
	case "chain":
		return Chain()
	case "chainPrint":
		return ChainPrint()
	...
	case "clapperboard":
		return Clapperboard()
	case "clapperboardPrint":
		return ClapperboardPrint()
	case "clipboard":
		return Clipboard()
	case "clipboardCheck":
		return ClipboardCheck()
	case "clipboardCheckCircle":
		return ClipboardCheckCircle()
	case "clipboardCheckCirclePrint":
		return ClipboardCheckCirclePrint()
	case "clipboardCheckPrint":
		return ClipboardCheckPrint()
	case "clipboardPrint":
		return ClipboardPrint()
	case "clock":
		return Clock()
	case "clockPrint":
		return ClockPrint()
	...
	case "cloudDown":
		return CloudDown()
	case "cloudDownFilled":
		return CloudDownFilled()
	case "cloudDownPrint":
		return CloudDownPrint()
	case "cloudFilled":
		return CloudFilled()
	case "cloudPrint":
		return CloudPrint()
	...
	case "colorPicker":
		return ColorPicker()
	case "colorPickerPrint":
		return ColorPickerPrint()
	case "contract":
		return Contract()
	case "contractPrint":
	...
	case "controller":
		return Controller()
	case "controllerPrint":
		return ControllerPrint()
	case "countdown":
		return Countdown()
	case "countdownPrint":
		return CountdownPrint()
	case "creditCard":
		return CreditCard()
	case "creditCardPrint":
		return CreditCardPrint()
	case "crown":
		return Crown()
	case "crownPrint":
		return CrownPrint()
	...
	case "electricity":
		return Electricity()
	case "electricityPrint":
		return ElectricityPrint()
	case "enter":
		return Enter()
	case "enterPrint":
		return EnterPrint()
	...
	case "exclamationCirclePrint":
		return ExclamationCirclePrint()
	case "exclamationFilled":
		return ExclamationFilled()
	case "exclamationPrint":
		return ExclamationPrint()
	case "expand":
		return Expand()
	case "expandPrint":
		return ExpandPrint()
	...
	case "eyeClosed":
		return EyeClosed()
	case "eyeClosedPrint":
		return EyeClosedPrint()
	case "eyeFrame":
		return EyeFrame()
	case "eyeFramePrint":
		return EyeFramePrint()
	case "eyeOff":
		return EyeOff()
	case "eyeOffPrint":
		return EyeOffPrint()
	...
	case "fastForward":
		return FastForward()
	case "fastForwardPrint":
		return FastForwardPrint()
	case "file":
		return File()
	case "fileLoop":
		return FileLoop()
	case "fileLoopPrint":
		return FileLoopPrint()
	case "filePrint":
		return FilePrint()
	case "filmFrame":
		return FilmFrame()
	case "filmFramePrint":
		return FilmFramePrint()
	case "fire":
		return Fire()
	case "firePrint":
		return FirePrint()
	...
	case "flagStraight":
		return FlagStraight()
	case "flagStraightPrint":
		return FlagStraightPrint()
	case "flower":
		return Flower()
	case "flowerBud":
		return FlowerBud()
	case "flowerBudPrint":
		return FlowerBudPrint()
	case "flowerPrint":
		return FlowerPrint()
	case "folder":
		return Folder()
	...
	case "foldingStool":
		return FoldingStool()
	case "foldingStoolPrint":
		return FoldingStoolPrint()
	case "gear":
		return Gear()
	case "gearFilled":
		return GearFilled()
	...
	case "hamburger":
		return Hamburger()
	case "hamburgerPrint":
		return HamburgerPrint()
	case "handGrab":
		return HandGrab()
	case "handGrabPrint":
		return HandGrabPrint()
	case "handOpen":
		return HandOpen()
	case "handOpenPrint":
		return HandOpenPrint()
	case "handPoint":
		return HandPoint()
	case "handPointOpen":
		return HandPointOpen()
	case "handPointOpenPrint":
		return HandPointOpenPrint()
	case "handPointPrint":
		return HandPointPrint()
	case "handshake":
		return Handshake()
	case "handshakePrint":
		return HandshakePrint()
	case "hash":
		return Hash()
	case "hashPrint":
		return HashPrint()
	...
	case "identificationPrint":
		return IdentificationPrint()
	case "info":
		return Info()
	case "infoCircle":
		return InfoCircle()
	case "infoCirclePrint":
		return InfoCirclePrint()
	case "infoFilled":
		return InfoFilled()
	case "infoPrint":
		return InfoPrint()
	...
	case "letterOpen":
		return LetterOpen()
	case "letterOpenPrint":
		return LetterOpenPrint()
	case "letterPrint":
		return LetterPrint()
	case "list":
		return List()
	...
	case "lockClosed":
		return LockClosed()
	case "lockClosedPrint":
		return LockClosedPrint()
	case "lockOpen":
		return LockOpen()
	case "lockOpenPrint":
		return LockOpenPrint()
	case "loop":
		return Loop()
	case "loopMinus":
		return LoopMinus()
	case "loopMinusPrint":
		return LoopMinusPrint()
	case "loopPlus":
		return LoopPlus()
	case "loopPlusPrint":
		return LoopPlusPrint()
	case "loopPrint":
		return LoopPrint()
	case "magnet":
		return Magnet()
	...
	case "microphone":
		return Microphone()
	case "microphonePrint":
		return MicrophonePrint()
	case "microphoneTwo":
		return MicrophoneTwo()
	case "microphoneTwoPrint":
		return MicrophoneTwoPrint()
	case "minus":
		return Minus()
	case "minusPrint":
		return MinusPrint()
	...
	case "monitorEye":
		return MonitorEye()
	case "monitorEyePrint":
		return MonitorEyePrint()
	case "monitorLoop":
		return MonitorLoop()
	case "monitorLoopPrint":
		return MonitorLoopPrint()
	case "monitorPrint":
		return MonitorPrint()
	case "monitorTwo":
		return MonitorTwo()
	case "monitorTwoPrint":
		return MonitorTwoPrint()
	case "moon":
		return Moon()
	case "moonFilled":
		return MoonFilled()
	...
	case "motorcycle":
		return Motorcycle()
	case "motorcyclePrint":
		return MotorcyclePrint()
	case "moveX":
		return MoveX()
	case "moveXPrint":
		return MoveXPrint()
	...
	case "moveYPrint":
		return MoveYPrint()
	case "musicNoteDouble":
		return MusicNoteDouble()
	case "musicNoteDoublePrint":
		return MusicNoteDoublePrint()
	case "musicNoteSingle":
		return MusicNoteSingle()
	case "musicNoteSinglePrint":
		return MusicNoteSinglePrint()
	case "nextTrack":
		return NextTrack()
	case "nextTrackPrint":
		return NextTrackPrint()
	case "noEntry":
		return NoEntry()
	case "noEntryPrint":
		return NoEntryPrint()
	...
	case "paintPallet":
		return PaintPallet()
	case "paintPalletPrint":
		return PaintPalletPrint()
	case "pause":
		return Pause()
	case "pausePrint":
		return PausePrint()
	...
	case "personCheckmark":
		return PersonCheckmark()
	case "personCheckmarkPrint":
		return PersonCheckmarkPrint()
	case "personFilled":
		return PersonFilled()
	case "personPlus":
		return PersonPlus()
	case "personPlusPrint":
		return PersonPlusPrint()
	case "personPrint":
		return PersonPrint()
	case "persons":
		return Persons()
	...
	case "photoCamera":
		return PhotoCamera()
	case "photoCameraPrint":
		return PhotoCameraPrint()
	case "photoPrint":
		return PhotoPrint()
	case "photoStudio":
		return PhotoStudio()
	case "photoStudioPrint":
		return PhotoStudioPrint()
	case "pill":
		return Pill()
	case "pillPrint":
		return PillPrint()
	...
	case "pinpoint":
		return Pinpoint()
	case "pinpointFilled":
		return PinpointFilled()
	case "pinpointOff":
		return PinpointOff()
	case "pinpointOffFilled":
		return PinpointOffFilled()
	case "pinpointOffPrint":
		return PinpointOffPrint()
	case "pinpointPrint":
		return PinpointPrint()
	case "play":
		return Play()
	case "playPrint":
		return PlayPrint()
	...
	case "previousTrackPrint":
		return PreviousTrackPrint()
	case "printer":
		return Printer()
	case "printerPrint":
		return PrinterPrint()
	...
	case "questionCirclePrint":
		return QuestionCirclePrint()
	case "questionFilled":
	...
	case "rewindTime":
		return RewindTime()
	case "rewindTimePrint":
		return RewindTimePrint()
	case "scissors":
		return Scissors()
	case "scissorsPrint":
	...
	case "shareAndroid":
		return ShareAndroid()
	case "shareAndroidPrint":
		return ShareAndroidPrint()
	case "shareIos":
		return ShareIos()
	case "shareIosPrint":
		return ShareIosPrint()
	case "shuffle":
		return Shuffle()
	case "shufflePrint":
		return ShufflePrint()
	...
	case "smartphone":
		return Smartphone()
	case "smartphoneCutout":
		return SmartphoneCutout()
	case "smartphoneCutoutPrint":
		return SmartphoneCutoutPrint()
	case "smartphoneNotch":
		return SmartphoneNotch()
	case "smartphoneNotchPrint":
		return SmartphoneNotchPrint()
	case "smartphonePrint":
		return SmartphonePrint()
	case "smartphoneTwo":
		return SmartphoneTwo()
	case "smartphoneTwoPrint":
		return SmartphoneTwoPrint()
	case "softDrink":
		return SoftDrink()
	case "softDrinkPrint":
		return SoftDrinkPrint()
	case "sort":
		return Sort()
	case "sortPrint":
		return SortPrint()
	case "speakerHigh":
		return SpeakerHigh()
	case "speakerHighPrint":
		return SpeakerHighPrint()
	case "speakerLow":
		return SpeakerLow()
	case "speakerLowPrint":
		return SpeakerLowPrint()
	case "speakerOff":
		return SpeakerOff()
	case "speakerOffPrint":
		return SpeakerOffPrint()
	case "square":
		return Square()
	case "squareFilled":
		return SquareFilled()
	...
	case "stopwatch":
		return Stopwatch()
	case "stopwatchPrint":
		return StopwatchPrint()
	case "studioBackdrop":
		return StudioBackdrop()
	case "studioBackdropPrint":
		return StudioBackdropPrint()
	case "studioLightFront":
		return StudioLightFront()
	case "studioLightFrontPrint":
		return StudioLightFrontPrint()
	case "studioLightSide":
		return StudioLightSide()
	case "studioLightSidePrint":
		return StudioLightSidePrint()
	case "sun":
		return Sun()
	case "sunFilled":
		return SunFilled()
	...
	case "television":
		return Television()
	case "televisionPrint":
		return TelevisionPrint()
	case "textBubble":
		return TextBubble()
	case "textBubblePrint":
		return TextBubblePrint()
	case "textBubbles":
		return TextBubbles()
	case "textBubblesPrint":
		return TextBubblesPrint()
	case "thumbsDown":
		return ThumbsDown()
	case "thumbsDownPrint":
		return ThumbsDownPrint()
	case "thumbsUp":
		return ThumbsUp()
	case "thumbsUpPrint":
		return ThumbsUpPrint()
	case "times":
		return Times()
	case "timesPrint":
		return TimesPrint()
	...
	case "triangleDownFilled":
		return TriangleDownFilled()
	case "triangleDownPrint":
		return TriangleDownPrint()
	case "triangleLeft":
		return TriangleLeft()
	case "triangleLeftFilled":
		return TriangleLeftFilled()
	case "triangleLeftPrint":
		return TriangleLeftPrint()
	case "triangleRight":
		return TriangleRight()
	case "triangleRightFilled":
		return TriangleRightFilled()
	case "triangleRightPrint":
		return TriangleRightPrint()
	case "triangleUp":
		return TriangleUp()
	case "triangleUpFilled":
		return TriangleUpFilled()
	case "triangleUpPrint":
		return TriangleUpPrint()
	case "trophy":
		return Trophy()
	case "trophyPrint":
		return TrophyPrint()
