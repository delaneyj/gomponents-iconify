...
const (
	...
	adobePath                = `<path fill="currentColor" d="M2 22.041a.998.998 0 0 1-1-1V2.959a1 1 0 0 1 1-1h7.425a1 1 0 0 1 .925 1.38L2.925 21.42a1 1 0 0 1-.925.62Zm14.244 0H13.63a1 1 0 0 1-.891-.546l-1.522-2.99H8.963a1 1 0 0 1-.928-1.372L11.094 9.5a1 1 0 0 1 .928-.628h.01a1 1 0 0 1 .926.646l4.221 11.168a1 1 0 0 1-.935 1.354ZM22 21.809a.999.999 0 0 1-.921-.613L13.56 3.346a1 1 0 0 1 .921-1.387H22a1 1 0 0 1 1 1v17.85a1 1 0 0 1-.802.98a1.049 1.049 0 0 1-.198.02Z"/>`
	adobeAltPath             = `<path fill="currentColor" d="M14.483 2.959L22 20.809V2.959ZM2 2.959V21.04L9.425 2.96Zm7.069 14.324h2.784l1.748 3.433h2.537l-4.1-10.843Z"/>`
	airplayPath              = `<rect width="20" height="15" x="2" y="3" fill="currentColor" opacity=".5" rx="3"/><path fill="currentColor" d="M16 21H8a1 1 0 0 1-.832-1.555l4-6a1.038 1.038 0 0 1 1.664 0l4 6A1 1 0 0 1 16 21Z"/>`
	alignPath                = `<path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-8 4H3a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2zm8 8H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-8-4H3a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2z" opacity=".5"/><path fill="currentColor" d="M19 14.666a1 1 0 0 1-1-1v-3.333a1 1 0 0 1 1.64-.768l2 1.667a1 1 0 0 1 0 1.536l-2 1.667a.999.999 0 0 1-.64.231Z"/>`
	alignAltPath             = `<path fill="currentColor" d="M10 5H7a1 1 0 0 1 0-2h3a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zM21 5h-7a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4h-7a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4h-7a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4h-7a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm-4 4h-3a1 1 0 0 1 0-2h3a1 1 0 0 1 0 2z"/>`
	alignCenterPath          = `<path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-4 4H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2zm4 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-4 4H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2z"/>`
	alignCenterJustifyPath   = `<path fill="currentColor" d="M21 5H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-4 4H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2z"/>`
	alignJustifyPath         = `<path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2z"/>`
	alignLeftPath            = `<path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-4 4H3a1 1 0 0 1 0-2h14a1 1 0 0 1 0 2zm4 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-4 4H3a1 1 0 0 1 0-2h14a1 1 0 0 1 0 2z"/>`
	alignLeftJustifyPath     = `<path fill="currentColor" d="M21 5H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-6 4H3a1 1 0 0 1 0-2h12a1 1 0 0 1 0 2z"/>`
	alignLetterRightPath     = `<path fill="currentColor" d="M21 4H10a1 1 0 0 1 0-2h11a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 6H11a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2z"/>`
	alignRightPath           = `<path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H7a1 1 0 0 1 0-2h14a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H7a1 1 0 0 1 0-2h14a1 1 0 0 1 0 2z"/>`
	alignRightJustifyPath    = `<path fill="currentColor" d="M21 5H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H11a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2z"/>`
	amazonPath               = `<path fill="currentColor" d="M1.04 17.52q.1-.16.32-.02a21.308 21.308 0 0 0 10.88 2.9a21.524 21.524 0 0 0 7.74-1.46q.1-.04.29-.12t.27-.12a.356.356 0 0 1 .47.12q.17.24-.11.44q-.36.26-.92.6a14.99 14.99 0 0 1-3.84 1.58A16.175 16.175 0 0 1 12 22a16.017 16.017 0 0 1-5.9-1.09a16.246 16.246 0 0 1-4.98-3.07a.273.273 0 0 1-.12-.2a.215.215 0 0 1 .04-.12Zm6.02-5.7a4.036 4.036 0 0 1 .68-2.36A4.197 4.197 0 0 1 9.6 7.98a10.063 10.063 0 0 1 2.66-.66q.54-.06 1.76-.16v-.34a3.562 3.562 0 0 0-.28-1.72a1.5 1.5 0 0 0-1.32-.6h-.16a2.189 2.189 0 0 0-1.14.42a1.64 1.64 0 0 0-.62 1a.508.508 0 0 1-.4.46L7.8 6.1q-.34-.08-.34-.36a.587.587 0 0 1 .02-.14a3.834 3.834 0 0 1 1.67-2.64A6.268 6.268 0 0 1 12.26 2h.5a5.054 5.054 0 0 1 3.56 1.18a3.81 3.81 0 0 1 .37.43a3.875 3.875 0 0 1 .27.41a2.098 2.098 0 0 1 .18.52q.08.34.12.47a2.856 2.856 0 0 1 .06.56q.02.43.02.51v4.84a2.868 2.868 0 0 0 .15.95a2.475 2.475 0 0 0 .29.62q.14.19.46.61a.599.599 0 0 1 .12.32a.346.346 0 0 1-.16.28q-1.66 1.44-1.8 1.56a.557.557 0 0 1-.58.04q-.28-.24-.49-.46t-.3-.32a4.466 4.466 0 0 1-.29-.39q-.2-.29-.28-.39a4.91 4.91 0 0 1-2.2 1.52a6.038 6.038 0 0 1-1.68.2a3.505 3.505 0 0 1-2.53-.95a3.553 3.553 0 0 1-.99-2.69Zm3.44-.4a1.895 1.895 0 0 0 .39 1.25a1.294 1.294 0 0 0 1.05.47a1.022 1.022 0 0 0 .17-.02a1.022 1.022 0 0 1 .15-.02a2.033 2.033 0 0 0 1.3-1.08a3.13 3.13 0 0 0 .33-.83a3.8 3.8 0 0 0 .12-.73q.01-.28.01-.92v-.5a7.287 7.287 0 0 0-1.76.16a2.144 2.144 0 0 0-1.76 2.22Zm8.4 6.44a.626.626 0 0 1 .12-.16a3.14 3.14 0 0 1 .96-.46a6.52 6.52 0 0 1 1.48-.22a1.195 1.195 0 0 1 .38.02q.9.08 1.08.3a.655.655 0 0 1 .08.36v.14a4.56 4.56 0 0 1-.38 1.65a3.84 3.84 0 0 1-1.06 1.53a.302.302 0 0 1-.18.08a.177.177 0 0 1-.08-.02q-.12-.06-.06-.22a7.632 7.632 0 0 0 .74-2.42a.513.513 0 0 0-.08-.32q-.2-.24-1.12-.24q-.34 0-.8.04q-.5.06-.92.12a.232.232 0 0 1-.16-.04a.065.065 0 0 1-.02-.08a.153.153 0 0 1 .02-.06Z"/>`
	analysisPath             = `<path fill="currentColor" d="M14 16a1 1 0 0 1-.707-1.707l7-7a1 1 0 0 1 1.414 1.414l-7 7A.997.997 0 0 1 14 16zM3 17a1 1 0 0 1-.707-1.707l6-6a1 1 0 0 1 1.414 1.414l-6 6A.997.997 0 0 1 3 17z"/><path fill="currentColor" d="M14 16a.997.997 0 0 1-.707-.293l-5-5a1 1 0 0 1 1.414-1.414l5 5A1 1 0 0 1 14 16Z"/>`
	analyticsPath            = `<path fill="currentColor" d="M5 22a1 1 0 0 1-1-1v-8a1 1 0 0 1 2 0v8a1 1 0 0 1-1 1zm5 0a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v18a1 1 0 0 1-1 1zm5 0a1 1 0 0 1-1-1V9a1 1 0 0 1 2 0v12a1 1 0 0 1-1 1zm5 0a1 1 0 0 1-1-1v-4a1 1 0 0 1 2 0v4a1 1 0 0 1-1 1z"/>`
	anchorPath               = `<path fill="currentColor" d="M12 22a8.01 8.01 0 0 1-8-8a1 1 0 0 1 2 0a6 6 0 0 0 12 0a1 1 0 0 1 2 0a8.01 8.01 0 0 1-8 8Z"/><path fill="currentColor" d="M12 22a1 1 0 0 1-1-1V7a1 1 0 0 1 2 0v14a1 1 0 0 1-1 1zm-5-7H5a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2zm12 0h-2a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2z"/><path fill="currentColor" d="M14 11h-4a1 1 0 0 1 0-2h4a1 1 0 0 1 0 2zm-2-3a3 3 0 1 1 3-3a3.003 3.003 0 0 1-3 3zm0-4a1 1 0 1 0 1 1a1.001 1.001 0 0 0-1-1z"/>`
	androidPath              = `<path fill="currentColor" d="m14.975 3.019l.96-1.732a.193.193 0 0 0-.338-.187l-.97 1.75a6.541 6.541 0 0 0-5.253 0l-.97-1.75a.193.193 0 0 0-.34.187l.96 1.732a5.546 5.546 0 0 0-3.092 4.876h12.137a5.546 5.546 0 0 0-3.094-4.876ZM5.931 17.17A1.467 1.467 0 0 0 7.4 18.64h.973v3a1.36 1.36 0 1 0 2.721 0v-3h1.814v3a1.36 1.36 0 1 0 2.72 0v-3h.974a1.467 1.467 0 0 0 1.468-1.468V8.375H5.93ZM4.064 8.14a1.362 1.362 0 0 0-1.36 1.361v5.669a1.36 1.36 0 1 0 2.72 0V9.502a1.362 1.362 0 0 0-1.36-1.36Zm15.872 0a1.362 1.362 0 0 0-1.36 1.361v5.669a1.36 1.36 0 1 0 2.72 0V9.502a1.362 1.362 0 0 0-1.36-1.36Z"/><circle cx="9.199" cy="5.168" r=".507" fill="currentColor" opacity=".5"/><circle cx="14.801" cy="5.168" r=".507" fill="currentColor" opacity=".5"/>`
	androidAltPath           = `<path fill="currentColor" d="m16.2 4.7l.7-1.2c.2-.5.1-1.1-.4-1.4c-.5-.2-1.1-.1-1.4.4l-.6 1.1c.6.2 1.2.6 1.7 1.1zm-8.4 0c.5-.5 1-.8 1.7-1.1l-.6-1.1c-.3-.5-.9-.6-1.4-.4s-.6.9-.4 1.4l.7 1.2zM6 9h12v2H6z"/><path fill="currentColor" d="M12 3C8.7 3 6 5.7 6 9h12c0-3.3-2.7-6-6-6zm9 6c-.6 0-1 .4-1 1v4c0 .6.4 1 1 1s1-.4 1-1v-4c0-.6-.4-1-1-1zM3 9c-.6 0-1 .4-1 1v4c0 .6.4 1 1 1s1-.4 1-1v-4c0-.6-.4-1-1-1zm3 8c0 .6.4 1 1 1h2v3c0 .6.4 1 1 1s1-.4 1-1v-3h2v3c0 .6.4 1 1 1s1-.4 1-1v-3h2c.6 0 1-.4 1-1v-6H6v6z" opacity=".5"/>`
	angleDoubleDownPath      = `<path fill="currentColor" d="M12 11.75a.997.997 0 0 1-.707-.293l-3-3a1 1 0 0 1 1.414-1.414L12 9.336l2.293-2.293a1 1 0 0 1 1.414 1.414l-3 3a.997.997 0 0 1-.707.293zm0 5.5a.997.997 0 0 1-.707-.293l-3-3a1 1 0 0 1 1.414-1.414L12 14.836l2.293-2.293a1 1 0 0 1 1.414 1.414l-3 3a.997.997 0 0 1-.707.293z"/>`
	angleDoubleLeftPath      = `<path fill="currentColor" d="M16.25 16a.997.997 0 0 1-.707-.293l-3-3a1 1 0 0 1 0-1.414l3-3a1 1 0 0 1 1.414 1.414L14.664 12l2.293 2.293A1 1 0 0 1 16.25 16zm-5.5 0a.997.997 0 0 1-.707-.293l-3-3a1 1 0 0 1 0-1.414l3-3a1 1 0 0 1 1.414 1.414L9.164 12l2.293 2.293A1 1 0 0 1 10.75 16z"/>`
	angleDoubleRightPath     = `<path fill="currentColor" d="M7.75 16a1 1 0 0 1-.707-1.707L9.336 12L7.043 9.707a1 1 0 0 1 1.414-1.414l3 3a1 1 0 0 1 0 1.414l-3 3A.997.997 0 0 1 7.75 16zm5.5 0a1 1 0 0 1-.707-1.707L14.836 12l-2.293-2.293a1 1 0 0 1 1.414-1.414l3 3a1 1 0 0 1 0 1.414l-3 3a.997.997 0 0 1-.707.293z"/>`
	angleDoubleUpPath        = `<path fill="currentColor" d="M15 17.25a.997.997 0 0 1-.707-.293L12 14.664l-2.293 2.293a1 1 0 0 1-1.414-1.414l3-3a1 1 0 0 1 1.414 0l3 3A1 1 0 0 1 15 17.25zm0-5.5a.997.997 0 0 1-.707-.293L12 9.164l-2.293 2.293a1 1 0 0 1-1.414-1.414l3-3a1 1 0 0 1 1.414 0l3 3A1 1 0 0 1 15 11.75z"/>`
	angleDownPath            = `<path fill="currentColor" d="M12 15.121a.997.997 0 0 1-.707-.293L7.05 10.586a1 1 0 0 1 1.414-1.414L12 12.707l3.536-3.535a1 1 0 0 1 1.414 1.414l-4.243 4.242a.997.997 0 0 1-.707.293Z"/>`
	angleLeftPath            = `<path fill="currentColor" d="M14.121 17.243a.997.997 0 0 1-.707-.293l-4.242-4.243a1 1 0 0 1 0-1.414l4.242-4.243a1 1 0 0 1 1.414 1.414L11.293 12l3.535 3.536a1 1 0 0 1-.707 1.707Z"/>`
	angleRightPath           = `<path fill="currentColor" d="M9.879 17.243a1 1 0 0 1-.707-1.707L12.707 12L9.172 8.464a1 1 0 0 1 1.414-1.414l4.242 4.243a1 1 0 0 1 0 1.414l-4.242 4.243a.997.997 0 0 1-.707.293Z"/>`
	angleRightBPath          = `<path fill="currentColor" d="M9.172 18.657a1 1 0 0 1-.707-1.707l4.95-4.95l-4.95-4.95a1 1 0 0 1 1.414-1.414l5.656 5.657a1 1 0 0 1 0 1.414L9.88 18.364a.997.997 0 0 1-.707.293Z"/>`
	angleUpPath              = `<path fill="currentColor" d="M16.243 15.121a.997.997 0 0 1-.707-.293L12 11.293l-3.536 3.535a1 1 0 0 1-1.414-1.414l4.243-4.242a1 1 0 0 1 1.414 0l4.243 4.242a1 1 0 0 1-.707 1.707Z"/>`
	applePath                = `<path fill="currentColor" d="M17.458 12.625A4.523 4.523 0 0 1 19.62 8.82a4.672 4.672 0 0 0-3.658-1.984c-1.558-.158-3.04.917-3.829.917c-.79 0-2.009-.894-3.3-.87a4.896 4.896 0 0 0-4.14 2.508c-1.762 3.06-.449 7.593 1.268 10.076c.84 1.214 1.843 2.581 3.158 2.532c1.268-.05 1.746-.82 3.277-.82c1.531 0 1.962.82 3.3.795c1.364-.025 2.229-1.239 3.062-2.457a10.946 10.946 0 0 0 1.385-2.845a4.42 4.42 0 0 1-2.685-4.047Zm-2.517-7.432A4.405 4.405 0 0 0 15.981 2a4.483 4.483 0 0 0-2.945 1.516a4.186 4.186 0 0 0-1.061 3.093a3.71 3.71 0 0 0 2.966-1.416Z"/>`
	appleAltPath             = `<path fill="currentColor" d="M17.594 12.625a4.523 4.523 0 0 1 2.162-3.805a4.672 4.672 0 0 0-3.658-1.984c-1.558-.158-3.04.917-3.83.917c-.789 0-2.008-.894-3.3-.87A4.896 4.896 0 0 0 4.83 9.392c-1.763 3.06-.45 7.593 1.267 10.076c.84 1.214 1.843 2.581 3.158 2.532c1.268-.05 1.746-.82 3.277-.82c1.53 0 1.961.82 3.3.795c1.364-.025 2.229-1.239 3.062-2.457a10.946 10.946 0 0 0 1.384-2.845a4.42 4.42 0 0 1-2.684-4.047Z"/><path fill="currentColor" d="M15.216 5.04A5.56 5.56 0 0 0 16.536 1a5.672 5.672 0 0 0-3.73 1.92l-.02.047a5.56 5.56 0 0 0-1.32 4.04a5.672 5.672 0 0 0 3.73-1.92Z"/>`
	appsPath                 = `<rect width="9" height="9" x="2" y="2" fill="currentColor" rx="1"/><rect width="9" height="9" x="2" y="13" fill="currentColor" opacity=".5" rx="1"/><rect width="9" height="9" x="13" y="2" fill="currentColor" opacity=".5" rx="1"/><rect width="9" height="9" x="13" y="13" fill="currentColor" opacity=".5" rx="1"/>`
	arrowCircleDownPath      = `<path fill="currentColor" d="m7.293 12.707l4 4a1.004 1.004 0 0 0 1.414 0l4-4a1 1 0 0 0-1.414-1.414L13 13.586V8a1 1 0 0 0-2 0v5.586l-2.293-2.293a1 1 0 0 0-1.414 1.414Z"/><path fill="currentColor" d="M12 22A10 10 0 1 0 2 12a10.011 10.011 0 0 0 10 10ZM7.293 11.293a1 1 0 0 1 1.414 0L11 13.586V8a1 1 0 0 1 2 0v5.586l2.293-2.293a1 1 0 0 1 1.414 1.414l-4 4a1.004 1.004 0 0 1-1.414 0l-4-4a1 1 0 0 1 0-1.414Z" opacity=".5"/>`
	arrowCircleLeftPath      = `<path fill="currentColor" d="m11.293 7.293l-4 4a1.004 1.004 0 0 0 0 1.414l4 4a1 1 0 0 0 1.414-1.414L10.414 13H16a1 1 0 0 0 0-2h-5.586l2.293-2.293a1 1 0 0 0-1.414-1.414Z"/><path fill="currentColor" d="M2 12A10 10 0 1 0 12 2A10.011 10.011 0 0 0 2 12Zm10.707-4.707a1 1 0 0 1 0 1.414L10.414 11H16a1 1 0 0 1 0 2h-5.586l2.293 2.293a1 1 0 0 1-1.414 1.414l-4-4a1.004 1.004 0 0 1 0-1.414l4-4a1 1 0 0 1 1.414 0Z" opacity=".5"/>`
	arrowCircleRightPath     = `<path fill="currentColor" d="m12.707 16.707l4-4a1.004 1.004 0 0 0 0-1.414l-4-4a1 1 0 0 0-1.414 1.414L13.586 11H8a1 1 0 0 0 0 2h5.586l-2.293 2.293a1 1 0 0 0 1.414 1.414Z"/><path fill="currentColor" d="M22 12a10 10 0 1 0-10 10a10.011 10.011 0 0 0 10-10Zm-10.707 4.707a1 1 0 0 1 0-1.414L13.586 13H8a1 1 0 0 1 0-2h5.586l-2.293-2.293a1 1 0 0 1 1.414-1.414l4 4a1.004 1.004 0 0 1 0 1.414l-4 4a1 1 0 0 1-1.414 0Z" opacity=".5"/>`
	arrowCircleUpPath        = `<path fill="currentColor" d="m16.707 11.293l-4-4a1.004 1.004 0 0 0-1.414 0l-4 4a1 1 0 0 0 1.414 1.414L11 10.414V16a1 1 0 0 0 2 0v-5.586l2.293 2.293a1 1 0 0 0 1.414-1.414Z"/><path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10.011 10.011 0 0 0 12 2Zm4.707 10.707a1 1 0 0 1-1.414 0L13 10.414V16a1 1 0 0 1-2 0v-5.586l-2.293 2.293a1 1 0 0 1-1.414-1.414l4-4a1.004 1.004 0 0 1 1.414 0l4 4a1 1 0 0 1 0 1.414Z" opacity=".5"/>`
	arrowDownLeftPath        = `<path fill="currentColor" d="M17 18H7a1 1 0 0 1-1-1V7a1 1 0 0 1 2 0v9h9a1 1 0 0 1 0 2Z"/><path fill="currentColor" d="M7 18a1 1 0 0 1-.707-1.707l10-10a1 1 0 0 1 1.414 1.414l-10 10A.997.997 0 0 1 7 18Z"/>`
	arrowDownRightPath       = `<path fill="currentColor" d="M17 18H7a1 1 0 0 1 0-2h9V7a1 1 0 0 1 2 0v10a1 1 0 0 1-1 1Z"/><path fill="currentColor" d="M17 18a.997.997 0 0 1-.707-.293l-10-10a1 1 0 0 1 1.414-1.414l10 10A1 1 0 0 1 17 18Z"/>`
	arrowUpLeftPath          = `<path fill="currentColor" d="M7 18a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h10a1 1 0 0 1 0 2H8v9a1 1 0 0 1-1 1Z"/><path fill="currentColor" d="M17 18a.997.997 0 0 1-.707-.293l-10-10a1 1 0 0 1 1.414-1.414l10 10A1 1 0 0 1 17 18Z"/>`
	arrowUpRightPath         = `<path fill="currentColor" d="M17 18a1 1 0 0 1-1-1V8H7a1 1 0 0 1 0-2h10a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1Z"/><path fill="currentColor" d="M7 18a1 1 0 0 1-.707-1.707l10-10a1 1 0 0 1 1.414 1.414l-10 10A.997.997 0 0 1 7 18Z"/>`
	atPath                   = `<path fill="currentColor" d="M12 16.5a4.5 4.5 0 1 1 4.5-4.5a4.505 4.505 0 0 1-4.5 4.5Zm0-7a2.5 2.5 0 1 0 2.5 2.5A2.503 2.503 0 0 0 12 9.5Z"/><path fill="currentColor" d="M12 22a10 10 0 1 1 10-10v.75a3.75 3.75 0 0 1-7.5 0V8.5a1 1 0 0 1 2 0v4.25a1.75 1.75 0 0 0 3.5 0V12a8 8 0 1 0-4 6.928a1 1 0 1 1 1 1.733A10.02 10.02 0 0 1 12 22Z"/>`
	bagPath                  = `<path fill="currentColor" d="M19 6H5a3 3 0 0 0-3 3v2.72L8.837 14h6.326L22 11.72V9a3 3 0 0 0-3-3z" opacity=".5"/><path fill="currentColor" d="M10 6V5h4v1h2V5a2.002 2.002 0 0 0-2-2h-4a2.002 2.002 0 0 0-2 2v1h2zm-1.163 8L2 11.72V18a3.003 3.003 0 0 0 3 3h14a3.003 3.003 0 0 0 3-3v-6.28L15.163 14H8.837z"/>`
	barsPath                 = `<path fill="currentColor" d="M21 13H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 5H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0-10H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2z"/>`
	batteryBoltPath          = `<path fill="currentColor" d="M13.988 12.059A1.023 1.023 0 0 0 13 11H9.732l1.444-2.5a1 1 0 1 0-1.733-1l-2.31 4A1.022 1.022 0 0 0 8 13h3.268l-1.444 2.5a1 1 0 0 0 1.733 1l2.31-4a1.267 1.267 0 0 0 .121-.441Z"/><path fill="currentColor" d="M17 7H4a2.002 2.002 0 0 0-2 2v6a2.002 2.002 0 0 0 2 2h6.69a1 1 0 0 1-.866-1.5l1.444-2.5H8a1.022 1.022 0 0 1-.866-1.5l2.31-4a1 1 0 1 1 1.732 1L9.732 11H13a1.023 1.023 0 0 1 .988 1.059a1.268 1.268 0 0 1-.122.441l-2.31 4a1 1 0 0 1-.867.5H17a2.002 2.002 0 0 0 2-2V9a2.002 2.002 0 0 0-2-2zm4 7a1 1 0 0 1-1-1v-2a1 1 0 0 1 2 0v2a1 1 0 0 1-1 1z" opacity=".5"/>`
	batteryEmptyPath         = `<path fill="currentColor" d="M21 14a1 1 0 0 1-1-1v-2a1 1 0 0 1 2 0v2a1 1 0 0 1-1 1zm-4 3H4a2.002 2.002 0 0 1-2-2V9a2.002 2.002 0 0 1 2-2h13a2.002 2.002 0 0 1 2 2v6a2.002 2.002 0 0 1-2 2z"/>`
	behancePath              = `<path fill="currentColor" d="M10.396 11.519h-.108l.24-.132a2.333 2.333 0 0 0 1.095-1.203a3.464 3.464 0 0 0 .145-1.697a2.815 2.815 0 0 0-1.732-2.297a4.728 4.728 0 0 0-1.925-.385H2v12.354h5.582a9.448 9.448 0 0 0 1.587-.132a3.465 3.465 0 0 0 2.659-1.973a3.741 3.741 0 0 0 .3-2.406a2.694 2.694 0 0 0-1.732-2.13ZM4.9 7.959h2.406a4.67 4.67 0 0 1 1.203.156a1.035 1.035 0 0 1 .794.926a1.9 1.9 0 0 1 0 .746a.999.999 0 0 1-.517.65a2.478 2.478 0 0 1-1.203.264H4.875Zm4.655 6.904a1.395 1.395 0 0 1-1.202 1.13a4.363 4.363 0 0 1-.794.085H4.875v-3.272h2.863a2.72 2.72 0 0 1 .902.156a1.311 1.311 0 0 1 .914 1.203a2.549 2.549 0 0 1 0 .698Zm12.439-.806c.012-.024.012-.048-.024-.024v-1.335a4.379 4.379 0 0 0-.41-1.769a3.729 3.729 0 0 0-1.924-1.852a5.137 5.137 0 0 0-2.947-.289a3.886 3.886 0 0 0-3.212 2.815a6.7 6.7 0 0 0-.144 3.465a3.5 3.5 0 0 0 .866 1.732a4.523 4.523 0 0 0 2.069 1.203a5.45 5.45 0 0 0 2.321.12a4.006 4.006 0 0 0 2.515-1.323a3.165 3.165 0 0 0 .71-1.203a.523.523 0 0 0 .084-.349H19.54a.12.12 0 0 0-.12.072a1.708 1.708 0 0 1-1.203.902a2.681 2.681 0 0 1-1.083 0a1.9 1.9 0 0 1-1.432-1.058a2.406 2.406 0 0 1-.204-.722v-.385Zm-6.352-1.732a4.515 4.515 0 0 1 .193-.566a1.732 1.732 0 0 1 1.576-1.082a2.287 2.287 0 0 1 1.046.144a1.78 1.78 0 0 1 1.13 1.444v.252l-3.945.036a2.099 2.099 0 0 1 0-.228Zm4.415-6.015h-5.004v1.444l5.004-.012Z"/>`
	behanceAltPath           = `<path fill="currentColor" d="M7.5 20H2a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1h5.5a4.5 4.5 0 0 1 0 9ZM3 18h4.5a2.5 2.5 0 0 0 0-5H3Z"/><path fill="currentColor" d="M7 13H2a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h5a4 4 0 0 1 0 8zm-4-2h4a2 2 0 0 0 0-4H3zm17-4h-4a1 1 0 0 1 0-2h4a1 1 0 0 1 0 2zm2 7h-8a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2z"/><path fill="currentColor" d="M18 20a5.006 5.006 0 0 1-5-5v-2a5 5 0 1 1 10 0a1 1 0 0 1-2 0a3 3 0 0 0-6 0v2a2.998 2.998 0 0 0 5.9.754a1 1 0 0 1 1.94.492A4.985 4.985 0 0 1 18 20Z"/>`
	bingPath                 = `<path fill="currentColor" d="m10.129 8.596l1.735 4.328l2.77 1.29L19 16.247V11.7l-8.871-3.104z" opacity=".7"/><path fill="currentColor" d="M14.634 14.214L9 17.457V3.4L5 2v17.76L9 22l10-5.753V11.7l-4.366 2.514z"/>`
	bitcoinPath              = `<path fill="currentColor" d="M16.358 10.575c.197-1.33-.805-2.046-2.175-2.523l.445-1.802l-1.085-.274l-.433 1.755c-.285-.072-.578-.14-.869-.207l.436-1.766l-1.085-.274l-.444 1.802a36.28 36.28 0 0 1-.693-.164l.001-.006l-1.496-.378l-.288 1.172s.804.187.788.198c.313.04.537.324.505.638l-1.217 4.938a.394.394 0 0 1-.498.26c.011.017-.788-.198-.788-.198l-.539 1.256l1.412.356c.263.066.52.136.773.201l-.449 1.824l1.084.273l.445-1.804c.296.082.583.157.864.227l-.443 1.795l1.085.274l.449-1.82c1.85.354 3.241.211 3.827-1.48a1.933 1.933 0 0 0-.997-2.662a1.743 1.743 0 0 0 1.385-1.61zm-2.479 3.516c-.335 1.362-2.603.626-3.339.44l.596-2.414c.735.185 3.094.553 2.743 1.974zm.336-3.535c-.306 1.239-2.194.61-2.806.455l.54-2.19c.612.154 2.584.442 2.266 1.735z" opacity=".5"/><path fill="currentColor" d="m11.949 8.82l-.54 2.191c.612.154 2.5.784 2.806-.455c.318-1.293-1.654-1.581-2.266-1.736zm-.813 3.297l-.596 2.415c.736.185 3.004.921 3.34-.441c.35-1.421-2.009-1.789-2.744-1.974z"/><path fill="currentColor" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2zm4.358 8.575a1.743 1.743 0 0 1-1.385 1.611a1.933 1.933 0 0 1 .997 2.66c-.586 1.693-1.977 1.836-3.827 1.482l-.449 1.82l-1.085-.274l.443-1.795a35.27 35.27 0 0 1-.864-.227l-.445 1.804l-1.084-.273l.45-1.824c-.254-.065-.511-.135-.774-.201l-1.412-.356l.539-1.256s.8.215.788.199l.005.001a.394.394 0 0 0 .493-.262l1.217-4.938a.583.583 0 0 0-.505-.638c.016-.011-.788-.198-.788-.198l.288-1.172l1.496.378l-.001.006c.225.056.457.11.693.164l.444-1.802l1.085.274l-.436 1.766c.291.068.584.135.87.207l.432-1.755l1.085.274l-.445 1.802c1.37.477 2.372 1.193 2.175 2.523z"/>`
	bitcoinAltPath           = `<path fill="currentColor" d="M16.313 11.24A3.998 3.998 0 0 0 13 5V4a1 1 0 0 0-2 0v1H9V4a1 1 0 0 0-2 0v1H6a1 1 0 0 0 0 2h1v10H6a1 1 0 0 0 0 2h1v1a1 1 0 0 0 2 0v-1h2v1a1 1 0 0 0 2 0v-1h2a3.99 3.99 0 0 0 1.313-7.76ZM15 9a2.002 2.002 0 0 1-2 2H9V7h4a2.002 2.002 0 0 1 2 2Zm0 8H9v-4h6a2 2 0 0 1 0 4Z"/>`
	blackberryPath           = `<path fill="currentColor" d="M7.188 13.352H5.27l.523-2.415h1.838c1.195 0 1.48.586 1.48 1.05c0 .657-.428 1.365-1.923 1.365zm.661-3.637H5.936l.52-2.416h1.84c1.194 0 1.479.587 1.479 1.051c0 .657-.428 1.365-1.926 1.365zm3.754 7.425H9.685l.522-2.418h1.84c1.193 0 1.476.589 1.476 1.054c0 .658-.425 1.364-1.92 1.364zm.708-3.788h-1.914l.521-2.415h1.84c1.193 0 1.476.586 1.476 1.05c0 .657-.425 1.365-1.923 1.365zm.664-3.637h-1.914l.523-2.416h1.836c1.196 0 1.48.587 1.48 1.051c0 .657-.427 1.365-1.925 1.365zm3.747 5.605h-1.915l.522-2.418h1.838c1.194 0 1.478.59 1.478 1.053c0 .657-.425 1.365-1.923 1.365zm.713-3.443H15.52l.522-2.416h1.84c1.194 0 1.476.587 1.476 1.052c0 .657-.425 1.364-1.923 1.364z" opacity=".5"/><path fill="currentColor" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2zM7.188 13.352H5.27l.523-2.415h1.838c1.195 0 1.48.586 1.48 1.05c0 .657-.428 1.365-1.923 1.365zm.661-3.637H5.936l.52-2.416h1.84c1.194 0 1.479.587 1.479 1.051c0 .657-.428 1.365-1.926 1.365zm3.754 7.425H9.685l.522-2.418h1.84c1.193 0 1.476.589 1.476 1.054c0 .658-.425 1.364-1.92 1.364zm.708-3.788h-1.914l.521-2.415h1.84c1.193 0 1.476.586 1.476 1.05c0 .657-.425 1.365-1.923 1.365zm.664-3.637h-1.914l.523-2.416h1.836c1.196 0 1.48.587 1.48 1.051c0 .657-.427 1.365-1.925 1.365zm3.747 5.605h-1.915l.522-2.418h1.838c1.194 0 1.478.59 1.478 1.053c0 .657-.425 1.365-1.923 1.365zm.713-3.443H15.52l.522-2.416h1.84c1.194 0 1.476.587 1.476 1.052c0 .657-.425 1.364-1.923 1.364z"/>`
	bloggerPath              = `<path fill="currentColor" fill-rule="evenodd" d="m18.333 10.922l-.11-.222l-.178-.14c-.235-.184-1.423.011-1.742-.278c-.228-.208-.263-.584-.33-1.09a3.154 3.154 0 0 0-.362-1.367a4.46 4.46 0 0 0-3.12-2.2H9.667a4.053 4.053 0 0 0-4.042 4.03v4.695a4.05 4.05 0 0 0 4.042 4.025h4.639a4.052 4.052 0 0 0 4.038-4.022l.02-2.675l.005-.579l-.036-.177zM9.718 8.917h2.24a.77.77 0 0 1 0 1.541h-2.24a.77.77 0 0 1 0-1.541zm4.55 6.125h-4.55a.75.75 0 1 1 0-1.5h4.55a.75.75 0 1 1 0 1.5z" clip-rule="evenodd" opacity=".5"/><path fill="currentColor" d="M14.267 13.542H9.673a.75.75 0 0 0 .045 1.5h4.587a.75.75 0 0 0-.038-1.5zm-4.549-3.084h2.24a.77.77 0 1 0 0-1.541h-2.24a.77.77 0 1 0 0 1.541z"/><path fill="currentColor" d="M19.5 2h-15A2.5 2.5 0 0 0 2 4.5v15A2.5 2.5 0 0 0 4.5 22h15a2.5 2.5 0 0 0 2.5-2.5v-15A2.5 2.5 0 0 0 19.5 2zm-1.136 9.678l-.02 2.675a4.051 4.051 0 0 1-4.038 4.022h-4.64a4.05 4.05 0 0 1-4.041-4.025V9.656a4.053 4.053 0 0 1 4.042-4.031h2.824a4.46 4.46 0 0 1 3.12 2.2c.222.422.346.89.362 1.367c.067.506.102.882.33 1.09c.32.29 1.507.094 1.742.278l.179.14l.109.222l.036.177l-.005.579z"/>`
	bloggerAltPath           = `<path fill="currentColor" d="M20 23H4a3.003 3.003 0 0 1-3-3V4a3.003 3.003 0 0 1 3-3h16a3.003 3.003 0 0 1 3 3v16a3.003 3.003 0 0 1-3 3z" opacity=".5"/><path fill="currentColor" d="M16.003 10.002H16V9a4.004 4.004 0 0 0-4-4h-2a5.006 5.006 0 0 0-5 5v4a5.006 5.006 0 0 0 5 5h4a5.006 5.006 0 0 0 5-5v-1a3 3 0 0 0-2.997-2.998zM10 9h1a1 1 0 1 1 0 2h-1a1 1 0 1 1 0-2zm4 6h-4a1 1 0 1 1 0-2h4a1 1 0 1 1 0 2z"/>`
	bookmarkPath             = `<path fill="currentColor" d="M18 22a1 1 0 0 1-.5-.134L12 18.694l-5.5 3.172A1 1 0 0 1 5 21V5a3.003 3.003 0 0 1 3-3h8a3.003 3.003 0 0 1 3 3v16a1 1 0 0 1-1 1Z"/>`
	borderAltPath            = `<path fill="currentColor" d="M3.5 20.5a1 1 0 0 1-1-1v-16a1 1 0 0 1 1-1h16a1 1 0 0 1 0 2h-15v15a1 1 0 0 1-1 1Z"/><circle cx="19.5" cy="11.5" r="1" fill="currentColor" opacity=".5"/><circle cx="19.5" cy="7.5" r="1" fill="currentColor" opacity=".5"/><circle cx="19.5" cy="15.5" r="1" fill="currentColor" opacity=".5"/><circle cx="7.5" cy="19.5" r="1" fill="currentColor" opacity=".5"/><circle cx="11.5" cy="19.5" r="1" fill="currentColor" opacity=".5"/><circle cx="15.5" cy="19.5" r="1" fill="currentColor" opacity=".5"/><circle cx="19.5" cy="19.5" r="1" fill="currentColor" opacity=".5"/>`
	borderBottomPath         = `<path fill="currentColor" d="M20 21.5H4a1 1 0 0 1 0-2h16a1 1 0 0 1 0 2Z"/><circle cx="12" cy="16.5" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="12.5" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="8.5" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="4.5" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="16.5" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="12.5" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="8.5" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="4.5" r="1" fill="currentColor" opacity=".5"/><circle cx="8" cy="4.5" r="1" fill="currentColor" opacity=".5"/><circle cx="16" cy="4.5" r="1" fill="currentColor" opacity=".5"/><circle cx="8" cy="12.5" r="1" fill="currentColor" opacity=".5"/><circle cx="16" cy="12.5" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="16.5" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="12.5" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="8.5" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="4.5" r="1" fill="currentColor" opacity=".5"/>`
	borderClearPath          = `<circle cx="12" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="8" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="16" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="8" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="16" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="8" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="16" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="4" r="1" fill="currentColor" opacity=".5"/>`
	borderHorizontalPath     = `<path fill="currentColor" d="M20 13H4a1 1 0 0 1 0-2h16a1 1 0 0 1 0 2Z"/><circle cx="12" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="8" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="16" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="8" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="16" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="4" r="1" fill="currentColor" opacity=".5"/>`
	borderInnerPath          = `<path fill="currentColor" d="M19.965 13h-16a1 1 0 0 1 0-2h16a1 1 0 0 1 0 2Z"/><path fill="currentColor" d="M11.965 21a1 1 0 0 1-1-1V4a1 1 0 0 1 2 0v16a1 1 0 0 1-1 1Z"/><circle cx="3.964" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="3.964" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="3.964" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="3.964" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="7.964" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="15.964" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="7.964" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="15.964" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="19.964" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="19.964" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="19.964" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="19.964" cy="4" r="1" fill="currentColor" opacity=".5"/>`
	borderLeftPath           = `<path fill="currentColor" d="M3.5 21a1 1 0 0 1-1-1V4a1 1 0 0 1 2 0v16a1 1 0 0 1-1 1Z"/><circle cx="7.5" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="11.5" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="15.5" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="19.5" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="7.5" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="11.5" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="15.5" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="19.5" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="19.5" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="19.5" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="11.5" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="11.5" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="7.5" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="11.5" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="15.5" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="19.5" cy="20" r="1" fill="currentColor" opacity=".5"/>`
	borderOutPath            = `<path fill="currentColor" d="M20 21H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1ZM5 19h14V5H5Z"/><circle cx="12" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="8" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="16" cy="12" r="1" fill="currentColor" opacity=".5"/>`
	borderRightPath          = `<path fill="currentColor" d="M20.5 21a1 1 0 0 1-1-1V4a1 1 0 0 1 2 0v16a1 1 0 0 1-1 1Z"/><circle cx="16.5" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="12.5" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="8.5" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="4.5" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="16.5" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="12.5" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="8.5" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="4.5" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="4.5" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="4.5" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="12.5" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="12.5" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="16.5" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="12.5" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="8.5" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="4.5" cy="4" r="1" fill="currentColor" opacity=".5"/>`
	borderTopPath            = `<path fill="currentColor" d="M20 4.5H4a1 1 0 0 1 0-2h16a1 1 0 0 1 0 2Z"/><circle cx="12" cy="7.5" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="11.5" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="15.5" r="1" fill="currentColor" opacity=".5"/><circle cx="12" cy="19.5" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="7.5" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="11.5" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="15.5" r="1" fill="currentColor" opacity=".5"/><circle cx="20" cy="19.5" r="1" fill="currentColor" opacity=".5"/><circle cx="16" cy="19.5" r="1" fill="currentColor" opacity=".5"/><circle cx="8" cy="19.5" r="1" fill="currentColor" opacity=".5"/><circle cx="16" cy="11.5" r="1" fill="currentColor" opacity=".5"/><circle cx="8" cy="11.5" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="7.5" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="11.5" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="15.5" r="1" fill="currentColor" opacity=".5"/><circle cx="4" cy="19.5" r="1" fill="currentColor" opacity=".5"/>`
	borderVerticalPath       = `<path fill="currentColor" d="M11 21a1 1 0 0 1-1-1V4a1 1 0 0 1 2 0v16a1 1 0 0 1-1 1Z"/><circle cx="7" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="3" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="15" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="19" cy="12" r="1" fill="currentColor" opacity=".5"/><circle cx="7" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="3" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="15" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="19" cy="4" r="1" fill="currentColor" opacity=".5"/><circle cx="19" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="19" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="3" cy="8" r="1" fill="currentColor" opacity=".5"/><circle cx="3" cy="16" r="1" fill="currentColor" opacity=".5"/><circle cx="7" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="3" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="15" cy="20" r="1" fill="currentColor" opacity=".5"/><circle cx="19" cy="20" r="1" fill="currentColor" opacity=".5"/>`
	boxPath                  = `<path fill="currentColor" d="M20.23 7.24L12 12L3.77 7.24a1.98 1.98 0 0 1 .7-.71L11 2.76c.62-.35 1.38-.35 2 0l6.53 3.77c.29.173.531.418.7.71z" opacity=".25"/><path fill="currentColor" d="M12 12v9.5a2.09 2.09 0 0 1-.91-.21L4.5 17.48a2.003 2.003 0 0 1-1-1.73v-7.5a2.06 2.06 0 0 1 .27-1.01L12 12z" opacity=".5"/><path fill="currentColor" d="M20.5 8.25v7.5a2.003 2.003 0 0 1-1 1.73l-6.62 3.82c-.275.13-.576.198-.88.2V12l8.23-4.76c.175.308.268.656.27 1.01z"/>`
	briefcasePath            = `<path fill="currentColor" d="M10 6V5h4v1h2V5a2.002 2.002 0 0 0-2-2h-4a2.002 2.002 0 0 0-2 2v1h2z"/><path fill="currentColor" d="M9 15a1 1 0 0 1-1-1v-2a1 1 0 1 1 2 0v2a1 1 0 0 1-1 1zm6 0a1 1 0 0 1-1-1v-2a1 1 0 1 1 2 0v2a1 1 0 0 1-1 1z" opacity=".25"/><path fill="currentColor" d="M20 6H4a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h4v-1a1 1 0 1 1 2 0v1h4v-1a1 1 0 1 1 2 0v1h4a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2z" opacity=".5"/><path fill="currentColor" d="M20 13h-4v1a1 1 0 1 1-2 0v-1h-4v1a1 1 0 1 1-2 0v-1H4a2 2 0 0 1-2-2v8a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-8a2 2 0 0 1-2 2z"/>`
	calenderPath             = `<path fill="currentColor" d="M22 10H2v9a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3v-9zM7 8a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v4a1 1 0 0 1-1 1zm10 0a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v4a1 1 0 0 1-1 1z" opacity=".5"/><path fill="currentColor" d="M19 4h-1v3a1 1 0 0 1-2 0V4H8v3a1 1 0 0 1-2 0V4H5a3 3 0 0 0-3 3v3h20V7a3 3 0 0 0-3-3z"/>`
	chartPath                = `<path fill="currentColor" d="M7 18a1 1 0 0 1-1-1v-4a1 1 0 0 1 2 0v4a1 1 0 0 1-1 1zm5 0a1 1 0 0 1-1-1V7a1 1 0 0 1 2 0v10a1 1 0 0 1-1 1zm5 0a1 1 0 0 1-1-1v-6a1 1 0 0 1 2 0v6a1 1 0 0 1-1 1z"/><path fill="currentColor" d="M19 2H5a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V5a3 3 0 0 0-3-3ZM8 17a1 1 0 0 1-2 0v-4a1 1 0 0 1 2 0Zm5 0a1 1 0 0 1-2 0V7a1 1 0 0 1 2 0Zm5 0a1 1 0 0 1-2 0v-6a1 1 0 0 1 2 0Z" opacity=".5"/>`
	chartPiePath             = `<path fill="currentColor" d="M12 12V2c5.523 0 10 4.477 10 10H12z" opacity=".25"/><path fill="currentColor" d="m12 12l5 8.66A10.01 10.01 0 0 0 22 12H12z" opacity=".5"/><path fill="currentColor" d="M17 20.66L12 12V2c-5.523.002-9.999 4.48-9.997 10.003c.002 5.523 4.48 9.999 10.004 9.997A10 10 0 0 0 17 20.662l.003-.005l-.004.003z"/>`
	checkPath                = `<path fill="currentColor" d="M9.84 17.08a.997.997 0 0 1-.707-.293l-3.84-3.84a1 1 0 1 1 1.414-1.414l3.133 3.133l7.453-7.453a1 1 0 0 1 1.414 1.414l-8.16 8.16a.997.997 0 0 1-.707.293Z"/>`
	checkCirclePath          = `<path fill="currentColor" d="M10.313 16.094a.997.997 0 0 1-.708-.293l-2.812-2.813a1 1 0 0 1 1.414-1.414l2.105 2.106l5.481-5.48a1 1 0 0 1 1.414 1.413l-6.188 6.188a.997.997 0 0 1-.707.293Z" opacity=".99"/><path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10.011 10.011 0 0 0 12 2Zm5.207 7.613l-6.188 6.188a1 1 0 0 1-1.414 0l-2.812-2.813a1 1 0 0 1 1.414-1.414l2.105 2.106l5.481-5.48a1 1 0 0 1 1.414 1.413Z" opacity=".5"/>`
	checkSquarePath          = `<path fill="currentColor" d="M10.2 16.4a.997.997 0 0 1-.707-.293l-3.2-3.2a1 1 0 0 1 1.414-1.414l2.493 2.493l6.093-6.093a1 1 0 0 1 1.414 1.414l-6.8 6.8a.997.997 0 0 1-.707.293Z"/><path fill="currentColor" d="M21 2H3a1 1 0 0 0-1 1v18a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1Zm-3.293 7.307l-6.8 6.8a1 1 0 0 1-1.414 0l-3.2-3.2a1 1 0 0 1 1.414-1.414l2.493 2.493l6.093-6.093a1 1 0 0 1 1.414 1.414Z" opacity=".5"/>`
	circlePath               = `<circle cx="12" cy="12" r="10" fill="currentColor"/>`
	circleLayerPath          = `<path fill="currentColor" d="M15 2a6.998 6.998 0 0 0-6.88 5.737a6 6 0 0 1 8.143 8.143A6.997 6.997 0 0 0 15 2z" opacity=".25"/><circle cx="7" cy="17" r="5" fill="currentColor"/><path fill="currentColor" d="M11 7a6 6 0 0 0-5.97 5.406a4.997 4.997 0 0 1 6.564 6.564A6 6 0 0 0 11 7z" opacity=".5"/>`
	clinicMedicalPath        = `<path fill="currentColor" d="M21 12a.996.996 0 0 1-.664-.252L12 4.338l-8.336 7.41a1 1 0 0 1-1.328-1.496l9-8a.999.999 0 0 1 1.328 0l9 8A1 1 0 0 1 21 12Z" opacity=".5"/><path fill="currentColor" d="M14 13h-1v-1a1 1 0 0 0-2 0v1h-1a1 1 0 0 0 0 2h1v1a1 1 0 0 0 2 0v-1h1a1 1 0 0 0 0-2Z"/><path fill="currentColor" d="m12 4.338l-8 7.111V21a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-9.551ZM14 15h-1v1a1 1 0 0 1-2 0v-1h-1a1 1 0 0 1 0-2h1v-1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 0 2Z" opacity=".25"/>`
	clockPath                = `<path fill="currentColor" d="M12 6a1 1 0 0 1 1 1v4.422l2.098 1.212a1 1 0 0 1-1 1.732l-2.598-1.5A1.005 1.005 0 0 1 11 12V7a1 1 0 0 1 1-1Z"/><path fill="currentColor" d="M2 12A10 10 0 1 0 12 2A10 10 0 0 0 2 12Zm9-5a1 1 0 0 1 2 0v4.422l2.098 1.212a1 1 0 0 1-1 1.732l-2.598-1.5A1.005 1.005 0 0 1 11 12Z" opacity=".5"/>`
	clockEightPath           = `<path fill="currentColor" d="M12 6a1 1 0 0 0-1 1v4.422l-2.098 1.212a1 1 0 0 0 1 1.732l2.598-1.5A1.005 1.005 0 0 0 13 12V7a1 1 0 0 0-1-1Z"/><path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm1 10a1.005 1.005 0 0 1-.5.866l-2.598 1.5a1 1 0 0 1-1-1.732L11 11.422V7a1 1 0 0 1 2 0Z" opacity=".5"/>`
	clockFivePath            = `<path fill="currentColor" d="M12 6a1.003 1.003 0 0 1 1 1v4.73l1.6 2.77a1 1 0 1 1-1.73 1l-1.69-2.93A.999.999 0 0 1 11 12V7a1.003 1.003 0 0 1 1-1Z"/><path fill="currentColor" d="M2 12A10 10 0 1 0 12 2A10 10 0 0 0 2 12Zm9-5a1 1 0 0 1 2 0v4.73l1.6 2.77a1 1 0 1 1-1.73 1l-1.69-2.93A.999.999 0 0 1 11 12Z" opacity=".5"/>`
	clockNinePath            = `<path fill="currentColor" d="M12 6a1 1 0 0 0-1 1v4H9a1 1 0 0 0 0 2h3a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1Z"/><path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm1 10a1 1 0 0 1-1 1H9a1 1 0 0 1 0-2h2V7a1 1 0 0 1 2 0Z" opacity=".5"/>`
	clockSevenPath           = `<path fill="currentColor" d="M12 6a1.003 1.003 0 0 0-1 1v4.73L9.4 14.5a1 1 0 1 0 1.73 1l1.69-2.93A.999.999 0 0 0 13 12V7a1.003 1.003 0 0 0-1-1Z"/><path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm1 10a.999.999 0 0 1-.18.57l-1.69 2.93a1 1 0 1 1-1.73-1l1.6-2.77V7a1 1 0 0 1 2 0Z" opacity=".5"/>`
	clockTenPath             = `<circle cx="12" cy="12" r="10" fill="currentColor" opacity=".5"/><path fill="currentColor" d="M13 7a1 1 0 0 0-2 0v3.268l-1.098-.634a1 1 0 0 0-1 1.732l2.598 1.5A1.014 1.014 0 0 0 13 12Z"/>`
	clockThreePath           = `<path fill="currentColor" d="M12 6a1 1 0 0 1 1 1v4h2a1 1 0 0 1 0 2h-3a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1Z"/><path fill="currentColor" d="M2 12A10 10 0 1 0 12 2A10 10 0 0 0 2 12Zm9-5a1 1 0 0 1 2 0v4h2a1 1 0 0 1 0 2h-3a1 1 0 0 1-1-1Z" opacity=".5"/>`
	clockTwoPath             = `<circle cx="12" cy="12" r="10" fill="currentColor" opacity=".5"/><path fill="currentColor" d="M11 7a1 1 0 0 1 2 0v3.268l1.098-.634a1 1 0 0 1 1 1.732l-2.598 1.5A1.014 1.014 0 0 1 11 12Z"/>`
	columnsPath              = `<path fill="currentColor" d="M11 2h2v20h-2z" opacity=".25"/><path fill="currentColor" d="M3 2h8v20H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z"/><path fill="currentColor" d="M13 2h8a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1h-8V2z" opacity=".5"/>`
	commentPath              = `<path fill="currentColor" d="M12 22H3a1 1 0 0 1-.707-1.707l1.964-1.964A10 10 0 1 1 12 22Z" opacity=".5"/>`
	commentAltPath           = `<path fill="currentColor" d="M21 22a.999.999 0 0 1-.707-.293L16.586 18H5a3.003 3.003 0 0 1-3-3V5a3.003 3.003 0 0 1 3-3h14a3.003 3.003 0 0 1 3 3v16a1 1 0 0 1-1 1Z" opacity=".5"/>`
	commentAltDotsPath       = `<path fill="currentColor" d="M19 2H5a3.003 3.003 0 0 0-3 3v10a3.003 3.003 0 0 0 3 3h11.586l3.707 3.707A1 1 0 0 0 22 21V5a3.003 3.003 0 0 0-3-3ZM8 11a1 1 0 1 1 1-1a1 1 0 0 1-1 1Zm4 0a1 1 0 1 1 1-1a1 1 0 0 1-1 1Zm4 0a1 1 0 1 1 1-1a1 1 0 0 1-1 1Z" opacity=".5"/><circle cx="8" cy="10" r="1" fill="currentColor"/><circle cx="12" cy="10" r="1" fill="currentColor"/><circle cx="16" cy="10" r="1" fill="currentColor"/>`
	commentAltMessagePath    = `<path fill="currentColor" d="M17 9H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2zm0 4H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2z"/><path fill="currentColor" d="M19 2H5a3.003 3.003 0 0 0-3 3v10a3.003 3.003 0 0 0 3 3h11.586l3.707 3.707A1 1 0 0 0 22 21V5a3.003 3.003 0 0 0-3-3Zm-2 11H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2Zm0-4H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2Z" opacity=".5"/>`
	commentAltPlusPath       = `<path fill="currentColor" d="M15 9h-2V7a1 1 0 0 0-2 0v2H9a1 1 0 0 0 0 2h2v2a1 1 0 0 0 2 0v-2h2a1 1 0 0 0 0-2Z"/><path fill="currentColor" d="M19 2H5a3.003 3.003 0 0 0-3 3v10a3.003 3.003 0 0 0 3 3h11.586l3.707 3.707A1 1 0 0 0 22 21V5a3.003 3.003 0 0 0-3-3Zm-4 9h-2v2a1 1 0 0 1-2 0v-2H9a1 1 0 0 1 0-2h2V7a1 1 0 0 1 2 0v2h2a1 1 0 0 1 0 2Z" opacity=".5"/>`
	commentDotsPath          = `<circle cx="12" cy="12" r="1" fill="currentColor"/><path fill="currentColor" d="M12 2a10 10 0 0 0-7.743 16.33l-1.964 1.963A1 1 0 0 0 3 22h9a10 10 0 0 0 0-20ZM8 13a1 1 0 1 1 1-1a1 1 0 0 1-1 1Zm4 0a1 1 0 1 1 1-1a1 1 0 0 1-1 1Zm4 0a1 1 0 1 1 1-1a1 1 0 0 1-1 1Z" opacity=".5"/><circle cx="8" cy="12" r="1" fill="currentColor"/><circle cx="16" cy="12" r="1" fill="currentColor"/>`
	commentMessagePath       = `<path fill="currentColor" d="M17 13H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2Z"/><path fill="currentColor" d="M12 2a10 10 0 0 0-7.743 16.33l-1.964 1.963A1 1 0 0 0 3 22h9a10 10 0 0 0 0-20ZM9 7h6a1 1 0 0 1 0 2H9a1 1 0 0 1 0-2Zm6 10H9a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2Zm2-4H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2Z" opacity=".5"/><path fill="currentColor" d="M15 17H9a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2zm0-8H9a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2z"/>`
	commentPlusPath          = `<path fill="currentColor" d="M15 11h-2V9a1 1 0 0 0-2 0v2H9a1 1 0 0 0 0 2h2v2a1 1 0 0 0 2 0v-2h2a1 1 0 0 0 0-2Z"/><path fill="currentColor" d="M12 2a10 10 0 0 0-7.743 16.33l-1.964 1.963A1 1 0 0 0 3 22h9a10 10 0 0 0 0-20Zm3 11h-2v2a1 1 0 0 1-2 0v-2H9a1 1 0 0 1 0-2h2V9a1 1 0 0 1 2 0v2h2a1 1 0 0 1 0 2Z" opacity=".5"/>`
	compressPath             = `<path fill="currentColor" d="M8 22a1 1 0 0 1-1-1v-4H3a1 1 0 0 1 0-2h5a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1zM8 9H3a1 1 0 0 1 0-2h4V3a1 1 0 0 1 2 0v5a1 1 0 0 1-1 1zm13 0h-5a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v4h4a1 1 0 0 1 0 2zm-5 13a1 1 0 0 1-1-1v-5a1 1 0 0 1 1-1h5a1 1 0 0 1 0 2h-4v4a1 1 0 0 1-1 1z"/>`
	cornerDownLeftPath       = `<path fill="currentColor" d="M9.942 22a.997.997 0 0 1-.707-.293l-4.628-4.628a1 1 0 0 1 0-1.414l4.628-4.63a1 1 0 0 1 1.414 1.415l-3.92 3.922l3.92 3.921A1 1 0 0 1 9.942 22Z"/><path fill="currentColor" d="M15.686 17.372H5.314a1 1 0 0 1 0-2h10.372a2.002 2.002 0 0 0 2-2V3a1 1 0 0 1 2 0v10.372a4.004 4.004 0 0 1-4 4Z"/>`
	cornerDownRightPath      = `<path fill="currentColor" d="M14.058 22a1 1 0 0 1-.707-1.707l3.92-3.921l-3.92-3.922a1 1 0 1 1 1.414-1.414l4.628 4.629a1 1 0 0 1 0 1.414l-4.628 4.628a.997.997 0 0 1-.707.293Z"/><path fill="currentColor" d="M18.686 17.372H9.314a5.006 5.006 0 0 1-5-5V3a1 1 0 0 1 2 0v9.372a3.003 3.003 0 0 0 3 3h9.372a1 1 0 0 1 0 2Z"/>`
	cornerLeftDownPath       = `<path fill="currentColor" d="M21 4.314h-9.372a5.006 5.006 0 0 0-5 5v6.957l-2.921-2.92a1 1 0 0 0-1.414 1.413l4.628 4.628a1.003 1.003 0 0 0 1.415 0l4.628-4.628a1 1 0 0 0-1.414-1.414l-2.922 2.922V9.314a3.003 3.003 0 0 1 3-3H21a1 1 0 0 0 0-2Z"/>`
	cornerRightDownPath      = `<path fill="currentColor" d="M21.707 13.35a1 1 0 0 0-1.414 0l-2.921 2.921V8.314a4.005 4.005 0 0 0-4-4H3a1 1 0 0 0 0 2h10.372a2.002 2.002 0 0 1 2 2v7.958L12.45 13.35a1 1 0 0 0-1.414 1.414l4.628 4.628a1.004 1.004 0 0 0 1.415 0l4.628-4.628a1 1 0 0 0 0-1.414Z"/>`
	cornerUpLeftPath         = `<path fill="currentColor" d="M14.686 6.628H7.729l2.92-2.921a1 1 0 0 0-1.413-1.414L4.608 6.921a1.003 1.003 0 0 0 0 1.415l4.628 4.628a1 1 0 0 0 1.414-1.414L7.728 8.628h6.958a3.003 3.003 0 0 1 3 3V21a1 1 0 0 0 2 0v-9.372a5.006 5.006 0 0 0-5-5Z"/>`
	cornerUpRightPath        = `<path fill="currentColor" d="M19.608 8.01a1.004 1.004 0 0 0-.216-1.089l-4.628-4.628a1 1 0 0 0-1.414 1.414l2.921 2.921H8.314a4.005 4.005 0 0 0-4 4V21a1 1 0 0 0 2 0V10.628a2.002 2.002 0 0 1 2-2h7.958L13.35 11.55a1 1 0 1 0 1.414 1.414l4.628-4.628a1 1 0 0 0 .216-.325Z"/>`
...
func Adobe(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(adobePath), g.Group(children))
}

func AdobeAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(adobeAltPath), g.Group(children))
}
...
func Align(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignPath), g.Group(children))
}

func AlignAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignAltPath), g.Group(children))
}
...
func AlignCenterJustify(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignCenterJustifyPath), g.Group(children))
}
...
func AlignLeftJustify(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignLeftJustifyPath), g.Group(children))
}

func AlignLetterRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignLetterRightPath), g.Group(children))
}
...
func AlignRightJustify(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(alignRightJustifyPath), g.Group(children))
}

func Amazon(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(amazonPath), g.Group(children))
}

func Analysis(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(analysisPath), g.Group(children))
}
...
func AndroidAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(androidAltPath), g.Group(children))
}
...
func AngleRightB(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(angleRightBPath), g.Group(children))
}
...
func AppleAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(appleAltPath), g.Group(children))
}
...
func Bars(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(barsPath), g.Group(children))
}

func BatteryBolt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(batteryBoltPath), g.Group(children))
}
...
func BehanceAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(behanceAltPath), g.Group(children))
}

func Bing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bingPath), g.Group(children))
}
...
func BitcoinAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bitcoinAltPath), g.Group(children))
}

func Blackberry(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(blackberryPath), g.Group(children))
}

func Blogger(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bloggerPath), g.Group(children))
}

func BloggerAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(bloggerAltPath), g.Group(children))
}
...
func BorderAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderAltPath), g.Group(children))
}
...
func BorderClear(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderClearPath), g.Group(children))
}

func BorderHorizontal(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderHorizontalPath), g.Group(children))
}
...
func BorderVertical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(borderVerticalPath), g.Group(children))
}
...
func Calender(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(calenderPath), g.Group(children))
}
...
func CircleLayer(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(circleLayerPath), g.Group(children))
}

func ClinicMedical(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(clinicMedicalPath), g.Group(children))
}
...
func CommentAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(commentAltPath), g.Group(children))
}

func CommentAltDots(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(commentAltDotsPath), g.Group(children))
}

func CommentAltMessage(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(commentAltMessagePath), g.Group(children))
}

func CommentAltPlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(commentAltPlusPath), g.Group(children))
}
...
func CommentMessage(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(commentMessagePath), g.Group(children))
}

func CommentPlus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(commentPlusPath), g.Group(children))
}
...
func Coronavirus(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(coronavirusPath), g.Group(children))
}
...
func CssThreeSimple(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(cssThreeSimplePath), g.Group(children))
}
...
func DialpadAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dialpadAltPath), g.Group(children))
}

func Direction(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(directionPath), g.Group(children))
}
...
func Docker(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(dockerPath), g.Group(children))
}

func DocumentLayoutCenter(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(documentLayoutCenterPath), g.Group(children))
}

func DocumentLayoutLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(documentLayoutLeftPath), g.Group(children))
}

func DocumentLayoutRight(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(documentLayoutRightPath), g.Group(children))
}
...
func Entry(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(entryPath), g.Group(children))
}
...
func ExclamationOctagon(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(exclamationOctagonPath), g.Group(children))
}
...
func FacebookF(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(facebookFPath), g.Group(children))
}

func FacebookMessenger(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(facebookMessengerPath), g.Group(children))
}

func FacebookMessengerAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(facebookMessengerAltPath), g.Group(children))
}

func Favorite(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(favoritePath), g.Group(children))
}

func FiveHundredPx(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(fiveHundredPxPath), g.Group(children))
}
...
func FlipHAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(flipHAltPath), g.Group(children))
}
...
func FlipVAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(flipVAltPath), g.Group(children))
}
...
func GitlabAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gitlabAltPath), g.Group(children))
}
...
func GoogleDriveAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(googleDriveAltPath), g.Group(children))
}

func GoogleHangouts(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(googleHangoutsPath), g.Group(children))
}

func GoogleHangoutsAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(googleHangoutsAltPath), g.Group(children))
}

func GooglePlay(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(googlePlayPath), g.Group(children))
}
...
func Grids(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gridsPath), g.Group(children))
}

func GripHorizontalLine(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(gripHorizontalLinePath), g.Group(children))
}

func HeadSide(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(headSidePath), g.Group(children))
}

func HeadSideCough(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(headSideCoughPath), g.Group(children))
}

func HeadSideMask(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(headSideMaskPath), g.Group(children))
}

func Hipchat(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hipchatPath), g.Group(children))
}
...
func HistoryAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(historyAltPath), g.Group(children))
}

func HorizontalAlignLeft(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(horizontalAlignLeftPath), g.Group(children))
}
...
func HospitalSquareSign(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hospitalSquareSignPath), g.Group(children))
}

func HospitalSymbol(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(hospitalSymbolPath), g.Group(children))
}

func HouseUser(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(houseUserPath), g.Group(children))
}
...
func HtmlFiveAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(htmlFiveAltPath), g.Group(children))
}

func HtmlThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(htmlThreePath), g.Group(children))
}

func HtmlThreeAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(htmlThreeAltPath), g.Group(children))
}

func ImageV(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(imageVPath), g.Group(children))
}
...
func InstagramAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(instagramAltPath), g.Group(children))
}

func Intercom(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(intercomPath), g.Group(children))
}

func IntercomAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(intercomAltPath), g.Group(children))
}
...
func KeySkeleton(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(keySkeletonPath), g.Group(children))
}

func KeySkeletonAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(keySkeletonAltPath), g.Group(children))
}

func KeyholeCircle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(keyholeCirclePath), g.Group(children))
}

func KeyholeSquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(keyholeSquarePath), g.Group(children))
}

func KeyholeSquareFull(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(keyholeSquareFullPath), g.Group(children))
}

func LayerGroup(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(layerGroupPath), g.Group(children))
}
...
func LeftIndent(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(leftIndentPath), g.Group(children))
}

func LeftIndentAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(leftIndentAltPath), g.Group(children))
}

func Line(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linePath), g.Group(children))
}

func LineSpacing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lineSpacingPath), g.Group(children))
}

func LinkH(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkHPath), g.Group(children))
}
...
func LinkedinAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(linkedinAltPath), g.Group(children))
}
...
func ListUiAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(listUiAltPath), g.Group(children))
}
...
func LockAccess(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lockAccessPath), g.Group(children))
}

func LockAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lockAltPath), g.Group(children))
}

func LockOpenAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lockOpenAltPath), g.Group(children))
}

func Lottiefiles(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(lottiefilesPath), g.Group(children))
}

func MasterCard(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(masterCardPath), g.Group(children))
}

func MediumM(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(mediumMPath), g.Group(children))
}
...
func MinusSquareFull(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(minusSquareFullPath), g.Group(children))
}
...
func ObjectGroup(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(objectGroupPath), g.Group(children))
}

func ObjectUngroup(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(objectUngroupPath), g.Group(children))
}

func Okta(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(oktaPath), g.Group(children))
}

func Opera(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(operaPath), g.Group(children))
}

func OperaAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(operaAltPath), g.Group(children))
}
...
func Pagelines(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pagelinesPath), g.Group(children))
}

func Pagerduty(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(pagerdutyPath), g.Group(children))
}
...
func Polygon(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(polygonPath), g.Group(children))
}

func Previous(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(previousPath), g.Group(children))
}

func Process(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(processPath), g.Group(children))
}

func React(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(reactPath), g.Group(children))
}

func RecordAudio(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(recordAudioPath), g.Group(children))
}

func RedditAlienAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(redditAlienAltPath), g.Group(children))
}
...
func RightIndentAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rightIndentAltPath), g.Group(children))
}
...
func RulerCombined(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(rulerCombinedPath), g.Group(children))
}

func Sanitizer(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sanitizerPath), g.Group(children))
}

func SanitizerAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sanitizerAltPath), g.Group(children))
}

func Scenery(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sceneryPath), g.Group(children))
}
...
func SignalAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(signalAltPath), g.Group(children))
}

func SignalAltThree(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(signalAltThreePath), g.Group(children))
}
...
func Skype(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(skypePath), g.Group(children))
}

func SkypeAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(skypeAltPath), g.Group(children))
}
...
func SlackAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(slackAltPath), g.Group(children))
}

func SnapchatAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(snapchatAltPath), g.Group(children))
}

func SnapchatGhost(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(snapchatGhostPath), g.Group(children))
}

func SnapchatSquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(snapchatSquarePath), g.Group(children))
}

func SocialDistancing(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(socialDistancingPath), g.Group(children))
}

func Sorting(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(sortingPath), g.Group(children))
}

func SpaceKey(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(spaceKeyPath), g.Group(children))
}
...
func SquareFull(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(squareFullPath), g.Group(children))
}

func SquareShape(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(squareShapePath), g.Group(children))
}

func SqureShape(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(squreShapePath), g.Group(children))
}
...
func StarHalfAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(starHalfAltPath), g.Group(children))
}
...
func StethoscopeAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(stethoscopeAltPath), g.Group(children))
}

func StoreSlash(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(storeSlashPath), g.Group(children))
}

func Subject(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(subjectPath), g.Group(children))
}

func Swiggy(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(swiggyPath), g.Group(children))
}

func SyncExclamation(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(syncExclamationPath), g.Group(children))
}

func SyncSlash(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(syncSlashPath), g.Group(children))
}
...
func TelegramAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(telegramAltPath), g.Group(children))
}

func ThLarge(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(thLargePath), g.Group(children))
}

func TimesCircle(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(timesCirclePath), g.Group(children))
}
...
func ToiletPaper(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(toiletPaperPath), g.Group(children))
}
...
func Tumblr(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tumblrPath), g.Group(children))
}

func TumblrAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tumblrAltPath), g.Group(children))
}

func TumblrSquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(tumblrSquarePath), g.Group(children))
}
...
func TwitterAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(twitterAltPath), g.Group(children))
}
...
func UnlockAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(unlockAltPath), g.Group(children))
}
...
func UserArrows(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(userArrowsPath), g.Group(children))
}

func UserMd(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(userMdPath), g.Group(children))
}

func UserNurse(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(userNursePath), g.Group(children))
}

func VectorSquare(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vectorSquarePath), g.Group(children))
}

func VectorSquareAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vectorSquareAltPath), g.Group(children))
}

func VirusSlash(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(virusSlashPath), g.Group(children))
}

func VisualStudio(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(visualStudioPath), g.Group(children))
}

func Vk(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vkPath), g.Group(children))
}

func VkAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vkAltPath), g.Group(children))
}
...
func VuejsAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(vuejsAltPath), g.Group(children))
}

func WebGrid(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(webGridPath), g.Group(children))
}

func WebGridAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(webGridAltPath), g.Group(children))
}

func WebSection(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(webSectionPath), g.Group(children))
}

func WebSectionAlt(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(webSectionAltPath), g.Group(children))
}

func Whatsapp(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(whatsappPath), g.Group(children))
}

func WindowGrid(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(windowGridPath), g.Group(children))
}

func WindowMaximize(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(windowMaximizePath), g.Group(children))
}

func WindowSection(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(windowSectionPath), g.Group(children))
}
...
func WordpressSimple(children ...g.Node) g.Node {
	return s.SVG(viewbox, hAttr, g.Raw(wordpressSimplePath), g.Group(children))
}
